...
function getShortcuts(type) {
  if (type==null || type=="" || type=="null") {
      ...
      this.keyArray.splice(keyArray.length-1, 0,
        ...
        new keyArrayItem("F9", "menuShowHide();executeWindowButton('buttonRefresh');", null, null, false, 'onkeydown'),
      ...
      this.keyArray.splice(keyArray.length-1, 0,
        ...
        new keyArrayItem("I", "executeWindowButton('linkButtonNew',true);", null, "ctrlKey", false, 'onkeydown'),
 ...
 *************************
 * Dropzone Tools
 * allowDrop prevents Default Action of Browser to open Files
 * drop allows to assign any js function to be used at file transfers etc preventing opening etc...
 * by DH
 *************************
*/
