...
public class ConfigureFrameWindow {
  ...
  public static String doConfigureApp(HttpSecureAppServlet servlet,VariablesSecureApp vars,  String focusfield, String breadcrumb, String name,  String toolbarId,String leftTabsMode,WindowTabs tabs,String hidden) throws Exception{
	    return doConfigureWindowModeAll(servlet,vars,focusfield,breadcrumb,name,toolbarId,leftTabsMode,tabs,"",null,hidden);
	  }
  ...
  private static String doConfigureWindowModeAll(HttpSecureAppServlet servlet,VariablesSecureApp vars,  String focusfield, String breadcrumb, String name,  String toolbarId,String leftTabsMode,WindowTabs tabs, String WindowMode, String toolbarcodehtml, String hidden) throws Exception{
