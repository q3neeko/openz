...
public class ConfigureTextbox {
  public static StringBuilder doConfigure(HttpSecureAppServlet servlet,VariablesSecureApp vars,Scripthelper script,String fieldname, int leadingemptycols,int colstotal,int maxlength,boolean required,boolean readonly,String callout,String currentvalue,String tooltip,String elementId,String style,Boolean isListBased) throws Exception{
    return doConfigureAll(servlet,vars,script,fieldname, leadingemptycols,colstotal,maxlength,required,readonly,callout,currentvalue,"", false, "",tooltip,elementId, style,isListBased,true);
    
  }
  
  public static StringBuilder doConfigureNoLabel(HttpSecureAppServlet servlet,VariablesSecureApp vars,Scripthelper script,String fieldname, int leadingemptycols,int colstotal,int maxlength,boolean required,boolean readonly,String callout,String currentvalue,String tooltip,String elementId,String style,Boolean isListBased) throws Exception{
	    return doConfigureAll(servlet,vars,script,fieldname, leadingemptycols,colstotal,maxlength,required,readonly,callout,currentvalue,"", false, "",tooltip,elementId, style,isListBased,false);
	    
	  }
  
  public static StringBuilder doConfigure(HttpSecureAppServlet servlet,VariablesSecureApp vars,Scripthelper script,String fieldname, int leadingemptycols,int colstotal,int maxlength,boolean required,boolean readonly,String callout,String currentvalue,String tooltip,String elementId,String style) throws Exception{
	    return doConfigureAll(servlet,vars,script,fieldname, leadingemptycols,colstotal,maxlength,required,readonly,callout,currentvalue,"", false, "",tooltip,elementId, style,false,true);
	    
	  }
 
  public static StringBuilder doConfigureGrid(HttpSecureAppServlet servlet,VariablesSecureApp vars,Scripthelper script,String fieldname, int colspan,int maxlength,boolean required,boolean readonly,String callout,String currentvalue,String jssettings, String tooltip,String style,Boolean isListBased) throws Exception{
    return doConfigureAll(servlet,vars,script,fieldname, 0,colspan+1,maxlength,required,readonly,callout,currentvalue,"", true,jssettings, tooltip,"", style,isListBased,false);
    
  }
  
  private static StringBuilder doConfigureAll(HttpSecureAppServlet servlet,VariablesSecureApp vars,Scripthelper script,String fieldname, int leadingemptycols,int colstotal,int maxlength,boolean required,boolean readonly,String callout,String currentvalue,String labeltext, boolean isGrid, String jssettings, String title,String elementId,String style,Boolean isListBased, Boolean isLabel) throws Exception{
    ...
    for (int i = 0; i < leadingemptycols; i++) {
      retval.append("<td class=\"leadingemptycolstext\"></td>");
    }
    if (isListBased) {
	    retval=retval.append(ConfigureListBasedEntry.doConfigure(servlet,vars,script,fieldname,elementId,currentvalue,isGrid,colstotal,callout,style));
	    return retval;
    }
    if (isLabel)
    ...
    Object template;
    if ( isGrid)
    	template=  servlet.getServletContext().getAttribute("textboxTEMPLATEGRID");
    else
    	template=  servlet.getServletContext().getAttribute("textboxTEMPLATE");
    if (template==null) {
      if ( isGrid) {
    	  template = new String(FileUtils.readFile("TextboxGRID.xml", directory + "/src-loc/design/org/openz/view/templates/"));
    	  servlet.getServletContext().setAttribute("textboxTEMPLATEGRID", template);
      } else {
