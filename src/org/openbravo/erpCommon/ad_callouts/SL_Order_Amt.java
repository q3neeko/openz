  ...
  private void printPage(HttpServletResponse response, VariablesSecureApp vars, String strChanged,
    ...
    if (strChanged.equals("QtyOrdered")) {
      ...
      priceActual = new BigDecimal(SLOrderProductData.getOffersPrice(this,dataOrder[0].dateordered,
          dataOrder[0].cBpartnerId,strProduct,OrderQTY.compareTo(BigDecimal.ZERO)==0?qtyOrdered.toString():OrderQTY.toString(), dataOrder[0].mPricelistId,strOrderUOM,strMProductPOID,strAttribute, dataOrder[0].id)).setScale(PricePrecision, BigDecimal.ROUND_HALF_UP);
      resultado.append("new Array(\"inppriceactual\", " + priceActual.toString()  + "),");
    ...
    if ((Issotrx.equals("N")&& priomes==false) && (strChanged.equals("QtyOrdered")|| strChanged.equals("inpqtyordered")||strChanged.equals("inpmProductPoId")||strChanged.equals("inpdiscount")|| strChanged.equals("inppriceactual"))) {
    	int minPurchaseval = new Integer(SLOrderAmtData.mrp_getpo_minimpositionvalue(this, strProduct, dataOrder[0].cBpartnerId,strOrderUOM,strMProductPOID));
