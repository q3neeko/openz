...
if (vars.commandIn("DEFAULT")) {
        ...
        OBError myMessage = processButton(vars, strKey, strAction2Do,strLostReason,strLostReasonText, strWindow);
  ...
  private void printPage(HttpServletResponse response, VariablesSecureApp vars, String strKey,
   ...
   try {
      ...
      // For Subscriptions...
      if (ProposalActionsData.isSubscriptionOrder(this,strKey).equals("Y")){
  ...
  private OBError   processButton(VariablesSecureApp vars, String strKey,String strAction2Do,String strLostReason,String strLostReasonText,String windowId) {
    String msg="";
    OBError myMessage = new OBError();
      try {
        ...
        if (strAction2Do.equals("WO"))
          msg=ProposalActionsData.createOrderFromOffer(this,strKey,vars.getUser());
