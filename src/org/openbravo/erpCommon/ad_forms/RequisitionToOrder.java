...
public class RequisitionToOrder extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strSelectedLines = FormatUtils.vector2sqlForm(grid.getSelectedIds(this, vars, "m_requisitionline_id"));
      updateLockedLines(vars, strOrgId);
      // Opens Popup - TODO The popup is not reimplemented yet - so old style 
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars,
      ...
      String strVendorId, String strIncludeVendor, String strOrgId,String strShowReceted) throws IOException,
      ServletException {
    ...
    try{
      ...
      StringBuilder createButton=ConfigureButton.doConfigure(this, vars,script, "create", 1, 1,false, "edit", "openServletNewWindow('OPEN_CREATE', true, 'RequisitionToOrderCreate.html', 'CreatePurchaseOrder', null, false, '600', '800');return false;", "", "");
...
//      myMessage.setType(myMessageAux.getType());
  ...
  private void removeSessionValues(VariablesSecureApp vars ){
    ...
    vars.removeSessionValue(this.getClass().getName() + "|requestor");
    vars.removeSessionValue(this.getClass().getName() + "|vendor_id");
    vars.removeSessionValue(this.getClass().getName() + "|lineswithoutvendor");
    vars.removeSessionValue(this.getClass().getName() + "|rejectedlines");
