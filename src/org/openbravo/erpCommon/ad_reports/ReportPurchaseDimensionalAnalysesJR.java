...
public class ReportPurchaseDimensionalAnalysesJR extends HttpSecureAppServlet {
  ...
  private void printPageHtml(HttpServletRequest request, HttpServletResponse response,
      ...
      String strCurrencyId, String strOutput) throws Exception {
    if (log4j.isDebugEnabled())
    ...
    if (!strConvRateErrorMsg.equals("") && strConvRateErrorMsg != null) {
      ...
      String strRepTitle=LocalizationUtils.getElementTextByElementName(this, "Report Purchase Dimensional Analyses", vars.getLanguage());
