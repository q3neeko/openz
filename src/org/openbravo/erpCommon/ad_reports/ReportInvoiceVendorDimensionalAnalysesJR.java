...
public class ReportInvoiceVendorDimensionalAnalysesJR extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (vars.commandIn("DEFAULT", "DEFAULT_COMPARATIVE")) {
      String strDateFrom = vars.getDateParameterGlobalVariable("inpDateFrom",
          "ReportInvoiceVendorDimensionalAnalysesJR|dateFrom", "",this);
      String strDateTo = vars.getDateParameterGlobalVariable("inpDateTo",
          "ReportInvoiceVendorDimensionalAnalysesJR|dateTo", "",this);
      String strDateFromRef = vars.getDateParameterGlobalVariable("inpDateFromRef",
          "ReportInvoiceVendorDimensionalAnalysesJR|dateFromRef", "",this);
      ...
      String strDateToRef = vars.getDateParameterGlobalVariable("inpDateToRef",
          "ReportSInvoiceVendorDimensionalAnalysesJR|dateToRef",this);
  ...
  private void printPageHtml(HttpServletRequest request, HttpServletResponse response,
      ...
      String strProducttype, String strCurrencyId, String strOutput) throws Exception {
    if (log4j.isDebugEnabled())
    ...
    if (!strConvRateErrorMsg.equals("") && strConvRateErrorMsg != null) {
      ...
      String strRepTitle=LocalizationUtils.getElementTextByElementName(this, "Report Vendor Dimensional Analyses", vars.getLanguage());
