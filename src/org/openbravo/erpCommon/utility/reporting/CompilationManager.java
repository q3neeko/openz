...
public class CompilationManager {
  ...
  static private JasperReport chooseCompilationProcessAndCompile(String pathToJasperFile,
	  ...
	  if(new File(pathToJasperFile).isFile()) {
		  return getMainReportFromJasperFile(pathToJasperFile, templateLocation,
				  baseDesignPath, pocDocTypeId, printoutLastUpdated, designParameters);
	  }
  ...
  private static JasperReport getMainReportFromJRXMLFile(String templateFile, 
       ...
       modifyMainReportParameters(jasperDesign.getParameters(), designParameters, templateLocation, baseDesignPath, pocDocTypeId, printoutLastUpdated);
  ...
  private static void modifyMainReportParameters(JRParameter[] newParameters,
		  HashMap<String, Object> designParameters,
		  String templateLocation, 
		  String baseDesignPath,
		  String pocDocTypeId,
       ...
       for (JRParameter curParam : newParameters) {
		 ...
		 if (tmpName.startsWith("SUBREP_")) {
			addNewSubReportToDesignParameters(tmpName, templateLocation, baseDesignPath, pocDocTypeId, printoutLastUpdated, designParameters);
		 }
       }
  }
  ...
  private static void addNewSubReportToDesignParameters(String parameterName, 
	  ...
	  String subReportFileName = transformParameterNameToFileName(templateLocation, parameterName, pocDocTypeId, printoutLastUpdated);
  ...
  private static JasperReport getMainReportFromJasperFile(String templateFile,
      ...
      modifyMainReportParameters(jasperReport.getParameters(), designParameters, templateLocation, baseDesignPathString, pocDocTypeId, printoutLastUpdated);
