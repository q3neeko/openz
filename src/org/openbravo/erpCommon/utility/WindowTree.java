...
public class WindowTree extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (vars.commandIn("DEFAULT", "TAB")) {
      ...
      if (strTabId.equals("73991C4EB5B84DB08948C4C0B9122CD1")) {
    	    	strTreeID=vars.getSessionValue("163|AD_TREE_ID");
      ...
      vars.setSessionValue("TREETOOLTREEID", strTreeID );
      if (strTreeID.equals(""))
        ...
        printPageDataSheet(response, vars, strTabId, strTreeID);
      ...
      String strTreeID = vars.getSessionValue("TREETOOLTREEID");
      String strResult = WindowTreeChecks.checkChanges(this, vars, strTabId, strTop, strLink,
          strChild.equals("Y"));
      if (Formhelper.isTabReadOnly(this, vars, strTabId) || 
         WindowAccessData.hasNoTabAccess(myPool, vars.getRole(), strTabId) ||
         WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), strTabId))
        strResult = "Das Veraendern dieser Struktur ist in Ihrer Rolle nicht moeglich";
      if (strTabId.equals("73991C4EB5B84DB08948C4C0B9122CD1") && ! WindowAccessData.hasNoTabAccess(myPool, vars.getRole(), strTabId) )
    	  strResult="";
      if (strResult.equals(""))
        changeNode(vars, strTabId, strTop, strLink, strChild,strTreeID);
      else {
   ...
   */
  private String loadNodes(VariablesSecureApp vars, String key, boolean editable, String strTabId, String TreeID)
      throws ServletException {
    String TreeType = WindowTreeUtility.getTreeType(key);
    String TreeName = "";
    String TreeDescription = "";
    StringBuffer menu = new StringBuffer();
    WindowTreeData[] data = WindowTreeData.selectTreeByID(this,TreeID );
    if (data == null || data.length == 0) {
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars,
      String TabId, String strTreeID) throws IOException, ServletException {
    if (log4j.isDebugEnabled())
    ...
    xmlDocument.setParameter("menu", loadNodes(vars, key, WindowTreeData
        .selectEditable(this, TabId).equals("Y"), TabId,strTreeID));
  ...
  private void changeNode(VariablesSecureApp vars, String strTabId, String strTop, String strLink,
      String strChild, String TreeID) throws ServletException {
    String key = WindowTreeData.selectKey(this, strTabId);
    String TreeType = WindowTreeUtility.getTreeType(key);
