...
public class BusinessPartner extends HttpSecureAppServlet {
  ...
  private static final String[] colNames = { "value", "name", "organization","pc", "city","address1","address2", "contact", "phone", "c_bpartner_id",
...
//"so_creditavailable","so_creditused","income",
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      if(strWindowId.equals("ReportSalesDimensionalAnalyzeJR") || strWindowId.equals("ReportInvoiceCustomerDimensionalAnalysesJR")) {
    	  strBpartner = "Y";
      }
      else if (strWindowId.equals("ReportPurchaseDimensionalAnalysesFilterJR") || strWindowId.equals("ReportInvoiceVendorDimensionalAnalysesJR") ||
    	strWindowId.equals("ReportMaterialDimensionalAnalysesJR")) {
    	  strBpartner = "N";
      }
      else if (strWindowId.equals("VERTICALMENU")) {
    	 strBpartner = ""; 
      }
      ...
      printPage(response, vars, strKeyValue, "%", strSelected, "paramName", ismulti); //Name<>key (DH 4/12 Sufu mit Name)
      ...
      int namc=Integer.parseInt(BusinessPartnerData.getNameCount(this, strKeyValue));
      int valc=Integer.parseInt(BusinessPartnerData.getValueCount(this, strKeyValue));
      if (valc>0) {
        if (valc==1) {
          strBPId=BusinessPartnerData.getValueID(this, strKeyValue);
        } else {
          vars.removeSessionValue("BusinessPartner.name");
          vars.setSessionValue("BusinessPartner.key", strKeyValue);
          strValSearch=strKeyValue;
        }
      }
      if (namc>0 && valc==0) {
        if (namc==1) {
          strBPId=BusinessPartnerData.getNameID(this, strKeyValue);
        } else {
          vars.removeSessionValue("BusinessPartner.key");
          vars.setSessionValue("BusinessPartner.name", strKeyValue);
          strNameSearch=strKeyValue;
        }
      }
      if (valc==0 && namc==0) {
        vars.removeSessionValue("BusinessPartner.name");
      ...
      final BusinessPartnerData[] data = BusinessPartnerData.selectKey(this, 
          ...
          strBPId );
      if (data != null && data.length == 1) { // bei mehreren gültigen Responses wird trotzdem der PageKey gedruckt? --  && data.length == 1) {
        printPageKey(response, vars, data);
      } else
        printPage(response, vars, strValSearch , strNameSearch, strSelected, "paramName", ismulti); //paramKey <> paramName (DH 4/12 Sufu mit Name)
      ...
      final String strOrgFilter = vars.getStringParameter("inpOrg");
      ...
      printGridData(response, vars, strKey, strName, strOrg, strContact, strZIP, strOrgFilter,
  ...
  private void printPage(HttpServletResponse response, VariablesSecureApp vars, String strKeyValue,
      String strNameValue, String strBpartners, String focusedId, Boolean isMulti) throws IOException,
      ServletException {
    ...
    if (strNameValue.equals("")) {
      ...
      xmlDocument.setParameter("name", strNameValue); //name<>key (DH 4/12 Sufu mit Name)
    }
    xmlDocument.setParameter("directory", "var baseDirectory = \"" + strReplaceWith + "/\";\n");
    xmlDocument.setParameter("language", "defaultLang=\"" + vars.getLanguage() + "\";");
    xmlDocument.setParameter("theme", vars.getTheme());
    xmlDocument.setParameter("key", strKeyValue); //key<>name (DH 4/12 Sufu mit Name)
    ...
    xmlDocument.setParameter("org", "0");
    ...
    try {
    FieldProvider[] data3 = SelectBoxhelper.getReferenceDataByRefName(this, vars, "ad_org_id", null,null,"0", false); 
    ComboTableDataWrapper comboTableDataOrg = new ComboTableDataWrapper(this, vars, "ad_org_id",null,"ReportDebtPayment", "0",null,null);
  ...
  private String generateSelector(BusinessPartnerData[] data) throws IOException, ServletException {
  ...
  private SQLReturnObject[] getHeaders(VariablesSecureApp vars) {
    ...
    final String[] colWidths = { "98", "172","83", "50", "83", "104", "63", "100", "80", "100", "0", "0",
        "0", "0" };
  ...
  private void printGridData(HttpServletResponse response, VariablesSecureApp vars, String strKey,
      String strName, String strOrg, String strContact, String strZIP, String strOrgFilter,
        ...
        if (strNewFilter.equals("1") || strNewFilter.equals("")) {
         ...
         pgLimit = TableSQLData.maxRowsPerGridPage + " OFFSET " + offset;
          ...
          strNumRows = BusinessPartnerData.countRows(this, rownum, 
              ...
              Utility.getContext(this, vars,"#User_Client", "BusinessPartner"), 
              Utility.getSelectorOrgs(this, vars, strOrg),strOrgFilter,
  ...
  private void clearSessionValue(VariablesSecureApp vars) {
    ...
    vars.removeSessionValue("BusinessPartner.org");
