...
public class Account extends HttpSecureAppServlet {
  ...
  private static final String[] colNames = { "ALIAS", "COMBINATION", "DESCRIPTION", "AD_ORG_ID_D",
      "ACCOUNT_ID_D", "C_VALIDCOMBINATION_ID", "ROWKEY" };
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      if (strAcctSchema.equals("")) {
          strAcctSchema = vars.getRequestGlobalVariable("inpcAcctschemaId", "Account.cAcctschemaId");
        }
      if (strAcctSchema.equals("")) {
      ...
      printGridData(response, vars, strAlias, strCombination, strOrganization, strAccount,
          strDescription, strSortCols, strSortDirs, strOffset,
  ...
  private SQLReturnObject[] getHeaders(VariablesSecureApp vars) {
    ...
    //changed  Parameter "103" into "-1" to exclude ROWKEY from Display
    String[] colWidths = { "43", "193", "151", "105", "123", "71", "-1", "43", "59", "0", "0" };
