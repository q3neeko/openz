...
public class Product extends HttpSecureAppServlet {
  ...
  ServletException {
    ...
    if (! Utility.getContext(this, vars, "C_Bpartner_ID", windowId).equals(vars.getSessionValue("Product.PersistedVendor")) &&  ! windowId.equals("")) {
       removePageSessionVariables(vars);
    ...
    if (windowId.equals("181") ||windowId.equals("E98863010C6541D5BBDEE3990B70148D")||windowId.equals("183")||tabId.equals("375773FAA7444EE08B21FB8A3DEDD131")||tabId.equals("91AD0EF6558640FCBB4A23BF66F61C91")) {//Footwaretail/Purchase Order / Purchase Invoice / Tab Vendor Service in Projects: Pre-select Product Categorys with ispurchasedefault
      if (vars.getSessionValue("Product.ProductCategory").isEmpty() && vars.getSessionValue("Product.PersistedCategory").isEmpty()) {
    ...
    if (vars.commandIn("DATA")) {
      if (vars.getStringParameter("newFilter").equals("1") ) {
        ...
        strType = vars.getRequestGlobalVariable("inpTypeofproduct", "Product.TypeOfProduct");
    ...
    // Also machines schoud not be selectable in these Windows. (Project and Production Order and Direct Sales)
    if (windowId.equals("ReportPurchaseDimensionalAnalysesFilterJR") || windowId.equals("ReportInvoiceVendorDimensionalAnalysesJR") ||
    	windowId.equals("ReportMaterialDimensionalAnalysesJR") || windowId.equals("ReportSalesDimensionalAnalyzeJR") ||
    	windowId.equals("ReportInvoiceCustomerDimensionalAnalysesJR") || 
    	windowId.equals("130") || windowId.equals("A2BEBB9B07564D2AAA372B4CB2D01165") ||
        windowId.equals("0C646E51BF1C4C95B34B5D80642C4F29") || tabId.equals("50B59804E9B3426DAEF10DC7170EEF11")) 
    {
    ...
    try{
      if (vars.commandIn("DEFAULT") || vars.commandIn("KEY")) {
        ...
        FieldProvider[] data3 = SelectBoxhelper.getReferenceDataByRefName(this, vars, "TypeOfProduct", null,null,strType, false); 
        strTableCells=strTableCells + ConfigureSelectBox.doConfigure(this,vars,script,"Typeofproduct", 0,3,false,false,"", strType, data3, "id","",true,"","");
        strTableCells=strTableCells + "</tr>" ;
        //
      ...
      if (vars.commandIn("DATA") || vars.commandIn("KEY")) {
        ...
        if (strBusinessPartnerProducts!=null)
          strNumRows = ProductData.countRowspartner(this,vars.getLanguage(),strBusinessPartnerProducts,strPriceListVersion,  strValue, strName, 
              Utility.getContext(this, vars, "#User_Client", "Product"), Utility.getSelectorOrgs(this, vars, vars.getOrg()),strCategory,strVendorProduct,strType, windowId, strRoleCategories,pgLimit);
        else
          strNumRows = ProductData.countRows(this,vars.getLanguage(),strPriceListVersion,  strValue, strName, 
            Utility.getContext(this, vars, "#User_Client", "Product"), Utility.getSelectorOrgs(
                this, vars, vars.getOrg()),isPurchase,isSold,strBpartner,strCategory,strSelectMachines,strVendorProduct,strType, windowId, strRoleCategories,pgLimit);
        if (strNumRows.equals(""))
          strNumRows="0";
        vars.setSessionValue("Product.numrows", strNumRows);
        FieldProvider[] data;
        if (strBusinessPartnerProducts!=null)
          data = ProductData.selectpartner(this,strWarehouse,strPriceListVersion,strBusinessPartnerProducts,vars.getLanguage(),strValue, strName,
            Utility.getContext(this, vars, "#User_Client", "Product"), Utility.getSelectorOrgs(this, vars,  vars.getOrg()),
            strCategory,strVendorProduct,strType, windowId,strRoleCategories,pgLimit, strOrderBy);
        else
          data = ProductData.select(this,strPriceListVersion,strWarehouse,vars.getLanguage(),strValue, strName,
              Utility.getContext(this, vars, "#User_Client", "Product"), Utility.getSelectorOrgs(
                  this, vars,  vars.getOrg()),isPurchase,isSold,strBpartner,strCategory,strSelectMachines,strVendorProduct,strType, windowId,strRoleCategories,pgLimit, strOrderBy);
        if (vars.commandIn("KEY") && data.length == 1)
        	
          // hier wird der einzelne Eintrag rausgesucht und irgendwo statisch eine Session-Variable gesetzt
