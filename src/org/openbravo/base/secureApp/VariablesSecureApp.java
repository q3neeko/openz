...
public class VariablesSecureApp extends VariablesBase {
  ...
  private void setValues() {
    ...
    if (isMultipart) {
      this.command =getMultiParameter("inpCommand", null);
  ...
  public String getDateParameter(String parameter, ConnectionProvider conn) throws ServletException {
	    String value = getStringParameter(parameter);
	    String targetvalue=value;
	    if (value.length()==10)
	    	targetvalue=DefaultSessionValuesData.selectddatevalue(conn, value, getSessionValue("#AD_SqlDateTimeFormat"), "DD-MM-YYYY");

	    return targetvalue;
  }
  
  public String getDateParameterGlobalVariable(String parameter, String sessionAttribute, ConnectionProvider conn) throws ServletException {
	  
	    String value = getGlobalVariable(parameter, sessionAttribute, true, false, false, "", null);
	    String targetvalue=value;
	    if (value.length()==10)
	    	targetvalue=DefaultSessionValuesData.selectddatevalue(conn, value, getSessionValue("#AD_SqlDateTimeFormat"), "DD-MM-YYYY");
  ...
  public String getDateParameterGlobalVariable(String parameter, String sessionAttribute, String defval,ConnectionProvider conn) throws ServletException {
	  
	    String value = getGlobalVariable(parameter, sessionAttribute, true, false, false, defval, null);
	    String targetvalue=value;
	    if (value.length()==10)
	    	targetvalue=DefaultSessionValuesData.selectddatevalue(conn, value, getSessionValue("#AD_SqlDateTimeFormat"), "DD-MM-YYYY");
        setSessionValue(sessionAttribute,targetvalue);
