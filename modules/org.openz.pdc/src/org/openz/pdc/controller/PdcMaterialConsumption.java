  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
    ...
    //setting History
      ...
      if (getLocalSessionVariable(vars, UserIDADName) == "") {
        ...
        if(PdcMaterialConsumptionData.countlower(this,GlobalConsumptionID) != null && !PdcMaterialConsumptionData.countlower(this,GlobalConsumptionID).isEmpty())       
        {
          if(PdcMaterialConsumptionData.countupper(this,GlobalConsumptionID,GlobalWorkstepID) != null && !PdcMaterialConsumptionData.countupper(this,GlobalConsumptionID,GlobalWorkstepID).isEmpty())
          {
          InfobarText = Utility.messageBD(this, "pdc_ScanProduct",vars.getLanguage());
          CurrentTrx=1;
        ...
        InfobarText = Utility.messageBD(this, "pdc_ScanNCCAc",vars.getLanguage());
