...
static Logger log4j = Logger.getLogger(BusinessPartnerData.class);
  ...
  public static BusinessPartnerData[] select(ConnectionProvider connectionProvider, String rownum, String xclients, String xvendors, String adUserClient, String adUserOrg, String org, String key, String name, String contact, String codigoPostal, String clients, String vendors, String ciudad, String orderBy, String pgLimit)    throws ServletException {
    return select(connectionProvider, rownum, xclients, xvendors, adUserClient, adUserOrg, org, key, name, contact, codigoPostal, clients, vendors, ciudad, orderBy, pgLimit, 0, 0);
  }

  public static BusinessPartnerData[] select(ConnectionProvider connectionProvider, String rownum, String xclients, String xvendors, String adUserClient, String adUserOrg, String org, String key, String name, String contact, String codigoPostal, String clients, String vendors, String ciudad, String orderBy, String pgLimit, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "      		SELECT * FROM ( SELECT ";
    ...
    strSql = strSql + 
      ") " +
      "        					        AND case when ? is null then 1=1 else bp.AD_Org_ID  in ('0',?)  end" +
      "        					        AND bp.IsSummary='N' " +
      "        					        AND bp.IsActive='Y'";
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectBusinessPartnerData.organization = UtilSql.getValue(result, "organization");
  ...
  public static String countRows(ConnectionProvider connectionProvider, String rownum, String xclients, String xvendors, String adUserClient, String adUserOrg, String org, String key, String name, String contact, String codigoPostal, String clients, String vendors, String ciudad, String pgLimit)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
  ...
  public static String getValueID(ConnectionProvider connectionProvider, String PValue)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
  ...
  public static String getNameID(ConnectionProvider connectionProvider, String PName)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        SELECT c_bpartner_id" +
      "        FROM c_bpartner" +
  ...
  public static BusinessPartnerData[] selectKey(ConnectionProvider connectionProvider, String adUserClient, String adUserOrg, String key)    throws ServletException {
    return selectKey(connectionProvider, adUserClient, adUserOrg, key, 0, 0);
  }

  public static BusinessPartnerData[] selectKey(ConnectionProvider connectionProvider, String adUserClient, String adUserOrg, String key, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "      SELECT A.* FROM (                      " +
      "                       select" +
