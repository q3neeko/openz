...
static Logger log4j = Logger.getLogger(ProjectData.class);
  ...
  public static ProjectData[] selectKey(ConnectionProvider connectionProvider, String adUserClient, String adUserOrg, String key)    throws ServletException {
    return selectKey(connectionProvider, adUserClient, adUserOrg, key, 0, 0);
  }

  public static ProjectData[] selectKey(ConnectionProvider connectionProvider, String adUserClient, String adUserOrg, String key, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
  ...
  public static ProjectData[] selectName(ConnectionProvider connectionProvider, String adUserClient, String adUserOrg, String name)    throws ServletException {
    return selectName(connectionProvider, adUserClient, adUserOrg, name, 0, 0);
  }

  public static ProjectData[] selectName(ConnectionProvider connectionProvider, String adUserClient, String adUserOrg, String name, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        SELECT P.C_PROJECT_ID, P.VALUE, P.NAME, P.C_BPARTNER_ID, " +
      "		CASE WHEN (COALESCE(P.C_BPARTNER_ID, '') = '') " +
