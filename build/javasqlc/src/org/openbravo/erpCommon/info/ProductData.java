...
static Logger log4j = Logger.getLogger(ProductData.class);
  ...
  public static ProductData[] select(ConnectionProvider connectionProvider, String priceListVersion, String warehouse, String language, String key, String name, String adUserClient, String adUserOrg, String isPurchase, String isSold, String cBpartnerId, String mProductCategoryId, String selectMachines, String vendorproductno, String TypeOfProduct, String WindwID, String userRoleProductcategories, String pgLimit, String orderBy)    throws ServletException {
    return select(connectionProvider, priceListVersion, warehouse, language, key, name, adUserClient, adUserOrg, isPurchase, isSold, cBpartnerId, mProductCategoryId, selectMachines, vendorproductno, TypeOfProduct, WindwID, userRoleProductcategories, pgLimit, orderBy, 0, 0);
  }

  public static ProductData[] select(ConnectionProvider connectionProvider, String priceListVersion, String warehouse, String language, String key, String name, String adUserClient, String adUserOrg, String isPurchase, String isSold, String cBpartnerId, String mProductCategoryId, String selectMachines, String vendorproductno, String TypeOfProduct, String WindwID, String userRoleProductcategories, String pgLimit, String orderBy, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "       SELECT A.*," +
    ...
    strSql = strSql + ((userRoleProductcategories==null || userRoleProductcategories.equals(""))?"":userRoleProductcategories);
    strSql = strSql + 
      ")" +
      "              AND 4=4     " +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      if (userRoleProductcategories != null && !(userRoleProductcategories.equals(""))) {
        }
  ...
  public static String countRows(ConnectionProvider connectionProvider, String language, String priceListVersion, String key, String name, String adUserClient, String adUserOrg, String isPurchase, String isSold, String cBpartnerId, String mProductCategoryId, String selectMachines, String vendorproductno, String TypeOfProduct, String WindwID, String userRoleProductcategories, String pgLimit)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
  ...
  public static ProductData[] selectpartner(ConnectionProvider connectionProvider, String warehouse, String priceListVersion, String bpartnerID, String language, String key, String name, String adUserClient, String adUserOrg, String mProductCategoryId, String vendorproductno, String TypeOfProduct, String WindwID, String userRoleProductcategories, String pgLimit, String orderBy)    throws ServletException {
    return selectpartner(connectionProvider, warehouse, priceListVersion, bpartnerID, language, key, name, adUserClient, adUserOrg, mProductCategoryId, vendorproductno, TypeOfProduct, WindwID, userRoleProductcategories, pgLimit, orderBy, 0, 0);
  }
  ...
  public static String countRowspartner(ConnectionProvider connectionProvider, String language, String bpartnerID, String priceListVersion, String key, String name, String adUserClient, String adUserOrg, String mProductCategoryId, String vendorproductno, String TypeOfProduct, String WindwID, String userRoleProductcategories, String pgLimit)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "      SELECT count(*) AS value FROM (" +
  ...
  public static String getRoleCategories(ConnectionProvider connectionProvider, String adRoleId)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      result = st.executeQuery();
      if(result.next()) {
        strReturn = UtilSql.getValue(result, "ad_role_pcategories");
      }
      result.close();
    } catch(SQLException e){
      log4j.error("SQL error in query: " + strSql + "Exception:"+ e);
