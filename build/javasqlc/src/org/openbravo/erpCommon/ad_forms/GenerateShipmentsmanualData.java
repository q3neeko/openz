...
static Logger log4j = Logger.getLogger(GenerateShipmentsmanualData.class);
  ...
  public static GenerateShipmentsmanualData[] select(ConnectionProvider connectionProvider, String language, String adUserClient, String adUserOrg, String parBPartner, String parDateFrom, String parDateTo, String adOrgId, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "      SELECT C_Order_ID, o.Name as adorgname, COALESCE(dttrl.Name, dt.Name) as cdoctypename, DocumentNo, bp.Name as cbpartnername, ic.DateOrdered, " +
      "      totallines as amountlines, TotalLines " +
    ...
    strSql = strSql + ((parDateFrom==null || parDateFrom.equals(""))?"":"  AND ic.DateOrdered >= TO_DATE(?::date) ");
    strSql = strSql + ((parDateTo==null || parDateTo.equals(""))?"":"  AND ic.DateOrdered < TO_DATE(?::date) ");
    strSql = strSql + 
    ...
    strSql = strSql + 
      ")" +
      "      AND ic.issotrx='Y'" +
      "      ORDER BY o.Name,bp.Name,ic.DateOrdered";
