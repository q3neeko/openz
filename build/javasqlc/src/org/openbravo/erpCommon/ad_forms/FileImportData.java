...
static Logger log4j = Logger.getLogger(FileImportData.class);
  ...
  public static String i_import_pricelist(ConnectionProvider connectionProvider, String filename, String adUserId, String Delimiter)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, Delimiter);
  ...
  public static String i_import_product(ConnectionProvider connectionProvider, String filename, String adUserId, String Delimiter)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
  ...
  public static String i_import_producttrl(ConnectionProvider connectionProvider, String filename, String adUserId, String Delimiter)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        SELECT i_import_producttrl(?,?,?) AS plresult FROM dual";
  ...
  public static String i_import_product_po(ConnectionProvider connectionProvider, String filename, String adUserId, String Delimiter)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
  ...
  public static String i_import_costing(ConnectionProvider connectionProvider, String filename, String adUserId, String Delimiter)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        SELECT i_import_costing(?,?,?) AS plresult FROM dual";
