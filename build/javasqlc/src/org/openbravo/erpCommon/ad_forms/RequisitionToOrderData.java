...
static Logger log4j = Logger.getLogger(RequisitionToOrderData.class);
  ...
  public static String selecttask(ConnectionProvider connectionProvider, String parRequisitionLines)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
  ...
  public static String selectproject(ConnectionProvider connectionProvider, String parRequisitionLines)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        SELECT c_project_id" +
      "        FROM M_REQUISITIONLINE " +
  ...
  public static int insertCOrder(Connection conn, ConnectionProvider connectionProvider, String cOrderId, String adClientId, String adOrgId, String user, String documentNo, String docStatus, String docAction, String cDoctypeId, String cDoctypetargetId, String dateordered, String datepromised, String dateacct, String cBpartnerId, String cBpartnerLocationId, String billtoId, String cCurrencyId, String paymentrule, String cPaymenttermId, String invoicerule, String deliveryrule, String freightcostrule, String deliveryviarule, String mWarehouseId, String mPricelistId, String project, String projecttask)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
