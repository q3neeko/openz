...
static Logger log4j = Logger.getLogger(CreateFromBankData.class);
  ...
  public static CreateFromBankData[] select(ConnectionProvider connectionProvider, String adLanguage, String cBankstatementID, String statementdate, String userClient, String userOrg, String cBPartnerId, String paymentrule, String planneddateFrom, String planneddateTo, String amountFrom, String amountTo, String isreceipt, String cBankaccountId, String adOrgId, String ischarge, String isapproved, String invoice, String orderNoOfBP, String pgLimit)    throws ServletException {
    return select(connectionProvider, adLanguage, cBankstatementID, statementdate, userClient, userOrg, cBPartnerId, paymentrule, planneddateFrom, planneddateTo, amountFrom, amountTo, isreceipt, cBankaccountId, adOrgId, ischarge, isapproved, invoice, orderNoOfBP, pgLimit, 0, 0);
  }

  public static CreateFromBankData[] select(ConnectionProvider connectionProvider, String adLanguage, String cBankstatementID, String statementdate, String userClient, String userOrg, String cBPartnerId, String paymentrule, String planneddateFrom, String planneddateTo, String amountFrom, String amountTo, String isreceipt, String cBankaccountId, String adOrgId, String ischarge, String isapproved, String invoice, String orderNoOfBP, String pgLimit, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        SELECT A.*," +
    ...
    strSql = strSql + ((orderNoOfBP==null || orderNoOfBP.equals(""))?"":"  AND EXISTS (SELECT 1 FROM C_INVOICE WHERE p.C_INVOICE_ID = C_INVOICE.C_INVOICE_ID AND poreference LIKE TO_CHAR(?)) ");
    strSql = strSql + 
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      if (orderNoOfBP != null && !(orderNoOfBP.equals(""))) {
        iParameter++; UtilSql.setValue(st, iParameter, 12, null, orderNoOfBP);
      }
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, adLanguage);
