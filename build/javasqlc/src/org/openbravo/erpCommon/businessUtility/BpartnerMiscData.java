...
static Logger log4j = Logger.getLogger(BpartnerMiscData.class);
  ...
  public static BpartnerMiscData[] select(ConnectionProvider connectionProvider, String cBpartnerId, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "      coalesce(p.minimumordervalue,0) as minimumordervalue, coalesce(p.minimumsurchage,'') as minimumsurchage" +
      "      FROM C_BPartner p" +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectBpartnerMiscData.cIncotermsId = UtilSql.getValue(result, "c_incoterms_id");
        ...
        objectBpartnerMiscData.minimumordervalue = UtilSql.getValue(result, "minimumordervalue");
        objectBpartnerMiscData.minimumsurchage = UtilSql.getValue(result, "minimumsurchage");
