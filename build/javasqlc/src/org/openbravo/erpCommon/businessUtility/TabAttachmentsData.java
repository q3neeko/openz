...
static Logger log4j = Logger.getLogger(TabAttachmentsData.class);
  ...
  public static TabAttachmentsData[] select(ConnectionProvider connectionProvider, String adClientId, String adOrgId, String adTableId, String recordId, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectTabAttachmentsData.created = UtilSql.getDateValue(result, "created", "dd-MM-yyyy");
        objectTabAttachmentsData.createdby = UtilSql.getValue(result, "createdby");
  ...
  public static TabAttachmentsData[] set()    throws ServletException {
    ...
    objectTabAttachmentsData[0].created = "";
    objectTabAttachmentsData[0].createdby = "";
  ...
  public static int insertDeleted(Connection conn, ConnectionProvider connectionProvider, String adUserId, String adlang, String cFileId)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        INSERT INTO c_filedeleted (C_FILEdeleted_ID, AD_CLIENT_ID, AD_ORG_ID, ISACTIVE, CREATED, CREATEDBY, " +
      "        UPDATED, UPDATEDBY, AD_TABLE_ID, AD_RECORD_ID, C_DATATYPE_ID, TEXT, NAME, SEQNO,recordidentifier)" +
      ...
      "         zssi_getIdentifierFromKey((select tablename||'_id' from ad_table where ad_table_id=f.ad_table_id),f.AD_RECORD_ID,?) as recordidentifier" +
    ...
    st = connectionProvider.getPreparedStatement(conn, strSql);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, adUserId);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, adUserId);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, adlang);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, cFileId);
  ...
  public static int restoreDeleted(Connection conn, ConnectionProvider connectionProvider, String adTableId, String adRecordId)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        INSERT INTO C_FILE (C_FILE_ID, AD_CLIENT_ID, AD_ORG_ID, ISACTIVE, CREATED, CREATEDBY, " +
      "        UPDATED, UPDATEDBY, AD_TABLE_ID, AD_RECORD_ID, C_DATATYPE_ID, TEXT, NAME, SEQNO)" +
  ...
  public static int restoreDeletedDEL(Connection conn, ConnectionProvider connectionProvider, String adTableId, String adRecordId)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
  ...
  public static String hasDeleted(ConnectionProvider connectionProvider, String adOrgId, String adTableId, String adRecordId)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
