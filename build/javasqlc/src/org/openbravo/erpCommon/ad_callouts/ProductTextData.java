...
static Logger log4j = Logger.getLogger(ProductTextData.class);
  ...
  public static String getVendorProductNoWithMFAndUOM(ConnectionProvider connectionProvider, String mProductId, String cBpartnerId, String cUomIdId, String mproductPOId)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        SELECT vendorproductno  " +
      "            FROM m_product_po " +
  ...
  public static String isManufacturerdataSpecific(ConnectionProvider connectionProvider, String mProductId, String cBpartnerId, String cUomIdId, String mproductPOId)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
  ...
  public static String getManufacturerdataSpecific(ConnectionProvider connectionProvider, String mProductId, String cBpartnerId, String cUomIdId, String mproductPOId)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
