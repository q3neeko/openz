...
static Logger log4j = Logger.getLogger(SLOrderProductData.class);
  ...
  public static String selectDefaultManufacturerPO(ConnectionProvider connectionProvider, String mProductId, String bPartnerId, String orgId)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      result = st.executeQuery();
      if(result.next()) {
        strReturn = UtilSql.getValue(result, "m_product_po_id");
      }
      result.close();
    } catch(SQLException e){
      log4j.error("SQL error in query: " + strSql + "Exception:"+ e);
  ...
  public static String selectDefault2NdUOM(ConnectionProvider connectionProvider, String mProductId, String bPartnerId, String orgId)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
  ...
  public static String getOffersPrice(ConnectionProvider connectionProvider, String dateordered, String cBpartnerId, String mProductId, String qty, String pricelist, String cUomId, String mproductPOId, String mAttributesetInstanceId, String orderid)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
