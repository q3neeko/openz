...
static Logger log4j = Logger.getLogger(MenuData.class);
  ...
  public static MenuData[] selectMenuFromRole(ConnectionProvider connectionProvider, String strRole)    throws ServletException {
    return selectMenuFromRole(connectionProvider, strRole, 0, 0);
  }

  public static MenuData[] selectMenuFromRole(ConnectionProvider connectionProvider, String strRole, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        SELECT ad_tree_menu_id  AS PARENT_ID" +
      "        FROM AD_Role" +
    ...
    try {
    st = connectionProvider.getPreparedStatement(strSql);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, strRole);
