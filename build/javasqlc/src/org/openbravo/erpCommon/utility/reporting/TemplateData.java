...
static Logger log4j = Logger.getLogger(TemplateData.class);
  ...
  public String cPrintoutConfigUpdated;
  public String id;
  public String name;
  ...
  public String getField(String fieldName) {
    ...
    else if (fieldName.equalsIgnoreCase("c_printout_config_updated") || fieldName.equals("cPrintoutConfigUpdated"))
      return cPrintoutConfigUpdated;
  ...
  public static TemplateData[] dummy(ConnectionProvider connectionProvider, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectTemplateData.cPrintoutConfigId = UtilSql.getValue(result, "c_printout_config_id");
        objectTemplateData.cPrintoutConfigUpdated = UtilSql.getValue(result, "c_printout_config_updated");
