...
static Logger log4j = Logger.getLogger(ReportGeneralLedgerData.class);
  ...
  public String getField(String fieldName) {
    if (fieldName.equalsIgnoreCase("rn1"))
      ...
      return dateacct;
    else if (fieldName.equalsIgnoreCase("strdateacct"))
      return strdateacct;
      ...
      return totalacctsub;
    else if (fieldName.equalsIgnoreCase("totalsubadded"))
      return totalsubadded;
    else if (fieldName.equalsIgnoreCase("contraaccount"))
      ...
      return pjname;
    else if (fieldName.equalsIgnoreCase("costcenterid"))
      return costcenterid;
    else if (fieldName.equalsIgnoreCase("costcentername"))
  ...
  public static ReportGeneralLedgerData[] select(ConnectionProvider connectionProvider, String rownum, String language, String groupbytext, String groupby, String parDateFrom, String parDateTo, String allaccounts, String accountFrom, String accountTo, String adUserOrg, String adUserClient, String hideMatched, String acctschema, String parDateFrom2, String parDateTo2, String AccountMatch, String org, String cBpartnerId, String mProductId, String cProjectId, String paramAmtFrom, String paramAmtTo, String accountId, String factAcctId, String cBPartner, String pgLimit, String oraLimit1, String oraLimit2, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "              MIN(DESCRIPTION) AS DESCRIPTION,FACT_ACCT_ID," +
      "              project," +
      "              costcenter, " +
    ...
    strSql = strSql + 
      "            GROUP BY groupbyname, groupbyid, VALUE, NAME, ID, DATEACCT, FACT_ACCT_GROUP_ID,project,costcenter, ISDEBIT,accounttype,FACT_ACCT_ID" +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectReportGeneralLedgerData.strdateacct = UtilSql.getValue(result, "strdateacct");
        objectReportGeneralLedgerData.accounttype = UtilSql.getValue(result, "accounttype");
        ...
        objectReportGeneralLedgerData.project = UtilSql.getValue(result, "project");
        objectReportGeneralLedgerData.costcenter = UtilSql.getValue(result, "costcenter");
        ...
        objectReportGeneralLedgerData.totalsubadded = UtilSql.getValue(result, "totalsubadded");
        objectReportGeneralLedgerData.contraaccount = UtilSql.getValue(result, "contraaccount");
        ...
        objectReportGeneralLedgerData.costcenterid = UtilSql.getValue(result, "costcenterid");
        objectReportGeneralLedgerData.costcentername = UtilSql.getValue(result, "costcentername");
  ...
  public static ReportGeneralLedgerData[] selectXLS(ConnectionProvider connectionProvider, String language, String parDateFrom, String parDateTo, String allaccounts, String accountFrom, String accountTo, String adUserOrg, String adUserClient, String hideMatched, String acctschema, String parDateFrom2, String parDateTo2, String AccountMatch, String org, String cBpartnerId, String mProductId, String cProjectId, String paramAmtFrom, String paramAmtTo)    throws ServletException {
    return selectXLS(connectionProvider, language, parDateFrom, parDateTo, allaccounts, accountFrom, accountTo, adUserOrg, adUserClient, hideMatched, acctschema, parDateFrom2, parDateTo2, AccountMatch, org, cBpartnerId, mProductId, cProjectId, paramAmtFrom, paramAmtTo, 0, 0);
  }

  public static ReportGeneralLedgerData[] selectXLS(ConnectionProvider connectionProvider, String language, String parDateFrom, String parDateTo, String allaccounts, String accountFrom, String accountTo, String adUserOrg, String adUserClient, String hideMatched, String acctschema, String parDateFrom2, String parDateTo2, String AccountMatch, String org, String cBpartnerId, String mProductId, String cProjectId, String paramAmtFrom, String paramAmtTo, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      ...
      "        (SELECT FACT_ACCT.ACCTVALUE AS VALUE, coalesce(trl.name,EV.NAME) AS NAME," +
      "            DATEACCT, AMTACCTDR, AMTACCTCR," +
      "            FACT_ACCT_GROUP_ID, FACT_ACCT.ACCOUNT_ID AS ID, FACT_ACCT.DESCRIPTION,FACT_ACCT_ID," +
    ...
    strSql = strSql + 
      ") D" +
      "        WHERE 6=6" +
      "        GROUP BY VALUE, NAME, ID, DATEACCT, FACT_ACCT_GROUP_ID, bpname, bpid, pdname, pdid, pjname, pjid,costcenterid,costcentername, ISDEBIT,FACT_ACCT_ID" +
      "        HAVING SUM(AMTACCTDR) - SUM(AMTACCTCR) <> 0" +
  ...
  public static ReportGeneralLedgerData[] set()    throws ServletException {
    ...
    objectReportGeneralLedgerData[0].strdateacct = "";
    ...
    objectReportGeneralLedgerData[0].costcenterid = "";
    objectReportGeneralLedgerData[0].costcentername = "";
    objectReportGeneralLedgerData[0].description = "";
    objectReportGeneralLedgerData[0].factAcctId = "";
    objectReportGeneralLedgerData[0].contraaccount = "";
    return objectReportGeneralLedgerData;
  }
  ...
  public static ReportGeneralLedgerData[] selectTotal(ConnectionProvider connectionProvider, String dateFrom, String dateTo, String bpartner, String product, String project, String acctschema, String account, String initialYearBalance, String dateTo2, String orgs)    throws ServletException {
    return selectTotal(connectionProvider, dateFrom, dateTo, bpartner, product, project, acctschema, account, initialYearBalance, dateTo2, orgs, 0, 0);
  }

  public static ReportGeneralLedgerData[] selectTotal(ConnectionProvider connectionProvider, String dateFrom, String dateTo, String bpartner, String product, String project, String acctschema, String account, String initialYearBalance, String dateTo2, String orgs, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
  ...
  public static String BalanceBeginDate(ConnectionProvider connectionProvider, String org, String acctid, String datefrom)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
