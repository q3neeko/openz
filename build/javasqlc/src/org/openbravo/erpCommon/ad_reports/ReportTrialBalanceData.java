...
static Logger log4j = Logger.getLogger(ReportTrialBalanceData.class);
  ...
  public String saldoInicialvj;
  public String saldoFinalvj;
  ...
  public String datefrom;
  public String dateto;
  public String datefromvgl;
  public String datetovgl;
  public String value;
  ...
  public String getField(String fieldName) {
    if (fieldName.equalsIgnoreCase("parent_id") || fieldName.equals("parentId"))
    ...
    else if (fieldName.equalsIgnoreCase("saldo_inicialvj") || fieldName.equals("saldoInicialvj"))
      return saldoInicialvj;
    else if (fieldName.equalsIgnoreCase("saldo_finalvj") || fieldName.equals("saldoFinalvj"))
      return saldoFinalvj;
      ...
      return dateto;
    else if (fieldName.equalsIgnoreCase("datefromvgl"))
      return datefromvgl;
    else if (fieldName.equalsIgnoreCase("datetovgl"))
      return datetovgl;
  ...
  public static ReportTrialBalanceData[] select(ConnectionProvider connectionProvider, String acctSchema, String dateFrom, String dateTo, String language, String treeAcct, String adorgid, String adUserClient, String adUserOrg, String parDateFrom, String parDateTo, String accountFrom, String accountTo)    throws ServletException {
    return select(connectionProvider, acctSchema, dateFrom, dateTo, language, treeAcct, adorgid, adUserClient, adUserOrg, parDateFrom, parDateTo, accountFrom, accountTo, 0, 0);
  }
  ...
  public static ReportTrialBalanceData[] select(ConnectionProvider connectionProvider, String acctSchema, String dateFrom, String dateTo, String language, String treeAcct, String adorgid, String adUserClient, String adUserOrg, String parDateFrom, String parDateTo, String accountFrom, String accountTo, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectReportTrialBalanceData.saldoInicialvj = UtilSql.getValue(result, "saldo_inicialvj");
        objectReportTrialBalanceData.saldoFinalvj = UtilSql.getValue(result, "saldo_finalvj");
        ...
        objectReportTrialBalanceData.orgname = UtilSql.getValue(result, "orgname");
        objectReportTrialBalanceData.datefrom = UtilSql.getValue(result, "datefrom");
        objectReportTrialBalanceData.dateto = UtilSql.getValue(result, "dateto");
        objectReportTrialBalanceData.datefromvgl = UtilSql.getValue(result, "datefromvgl");
        objectReportTrialBalanceData.datetovgl = UtilSql.getValue(result, "datetovgl");
        objectReportTrialBalanceData.value = UtilSql.getValue(result, "value");
        objectReportTrialBalanceData.accountsign = UtilSql.getValue(result, "accountsign");
  ...
  public static ReportTrialBalanceData[] selectComparative(ConnectionProvider connectionProvider, String adorgid, String acctSchema, String dateFrom, String dateTo, String language, String adUserOrg)    throws ServletException {
    return selectComparative(connectionProvider, adorgid, acctSchema, dateFrom, dateTo, language, adUserOrg, 0, 0);
  }

  public static ReportTrialBalanceData[] selectComparative(ConnectionProvider connectionProvider, String adorgid, String acctSchema, String dateFrom, String dateTo, String language, String adUserOrg, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "      SELECT" +
  ...
  public static ReportTrialBalanceData[] selectComparativeSorted(ConnectionProvider connectionProvider, String adorgid, String acctSchema, String dateFrom, String dateTo, String language, String adUserOrg)    throws ServletException {
    return selectComparativeSorted(connectionProvider, adorgid, acctSchema, dateFrom, dateTo, language, adUserOrg, 0, 0);
  }

  public static ReportTrialBalanceData[] selectComparativeSorted(ConnectionProvider connectionProvider, String adorgid, String acctSchema, String dateFrom, String dateTo, String language, String adUserOrg, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "      SELECT" +
      "      (select name from ad_org where ad_org_id = ?) as orgname," +
  ...
  public static ReportTrialBalanceData[] selectSorted(ConnectionProvider connectionProvider, String acctSchema, String dateFrom, String dateTo, String language, String treeAcct, String adorgid, String adUserClient, String adUserOrg, String parDateFrom, String parDateTo, String accountFrom, String accountTo)    throws ServletException {
    return selectSorted(connectionProvider, acctSchema, dateFrom, dateTo, language, treeAcct, adorgid, adUserClient, adUserOrg, parDateFrom, parDateTo, accountFrom, accountTo, 0, 0);
  }
  ...
  public static ReportTrialBalanceData[] set()    throws ServletException {
    ...
    objectReportTrialBalanceData[0].accountsign = "";
    ...
    objectReportTrialBalanceData[0].saldoInicialvj = "";
    objectReportTrialBalanceData[0].saldoFinalvj = "";
    ...
    objectReportTrialBalanceData[0].orgname = "";
    objectReportTrialBalanceData[0].datefrom = "";
    objectReportTrialBalanceData[0].dateto = "";
    objectReportTrialBalanceData[0].datefromvgl = "";
    objectReportTrialBalanceData[0].datetovgl = "";
    objectReportTrialBalanceData[0].value = "";
    return objectReportTrialBalanceData;
  }
