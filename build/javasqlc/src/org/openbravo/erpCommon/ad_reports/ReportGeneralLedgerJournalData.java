...
static Logger log4j = Logger.getLogger(ReportGeneralLedgerJournalData.class);
  ...
  public static ReportGeneralLedgerJournalData[] selectCountGroupedLines(ConnectionProvider connectionProvider, String language, String adUserClient, String adUserOrg, String parDateFrom, String parDateTo, String docbasetype, String acctschema, String acctvalue, String orgFamily, String checks, String hideMatched)    throws ServletException {
    return selectCountGroupedLines(connectionProvider, language, adUserClient, adUserOrg, parDateFrom, parDateTo, docbasetype, acctschema, acctvalue, orgFamily, checks, hideMatched, 0, 0);
  }
  ...
  public static ReportGeneralLedgerJournalData[] selectDirect(ConnectionProvider connectionProvider, String language, String adUserClient, String adUserOrg, String table, String record)    throws ServletException {
    return selectDirect(connectionProvider, language, adUserClient, adUserOrg, table, record, 0, 0);
  }

  public static ReportGeneralLedgerJournalData[] selectDirect(ConnectionProvider connectionProvider, String language, String adUserClient, String adUserOrg, String table, String record, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
  ...
  public static ReportGeneralLedgerJournalData[] selectDirect2(ConnectionProvider connectionProvider, String language, String adUserClient, String adUserOrg, String factAcctGroupId)    throws ServletException {
    return selectDirect2(connectionProvider, language, adUserClient, adUserOrg, factAcctGroupId, 0, 0);
  }

  public static ReportGeneralLedgerJournalData[] selectDirect2(ConnectionProvider connectionProvider, String language, String adUserClient, String adUserOrg, String factAcctGroupId, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "    SELECT zsse_groupcount(IDENTIFIER) as groupcounter,SCHEMA_ID, SCHEMA_NAME, IDENTIFIER, DATEACCT,zssi_strDate(DATEACCT,?) as curdate, VALUE, NAME,TEXT, ID, AD_TABLE_ID, DOCBASETYPE, SEQNO,TOTAL,DESCRIPTION,AMTACCTDR,AMTACCTCR" +
      "      FROM " +
