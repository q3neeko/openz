...
static Logger log4j = Logger.getLogger(ReportDebtPaymentData.class);
  ...
  public static String getHeader(ConnectionProvider connectionProvider, String lang, String datefrom, String dateto, String typ, String org)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      result = st.executeQuery();
      if(result.next()) {
        strReturn = UtilSql.getValue(result, "zssi_reportdebtpaymentheader");
      }
      result.close();
    } catch(SQLException e){
      log4j.error("SQL error in query: " + strSql + "Exception:"+ e);
