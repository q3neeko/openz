...
public class ProductTrlData implements FieldProvider {
static Logger log4j = Logger.getLogger(ProductTrlData.class);
  ...
  public static ProductTrlData[] insertTRL(ConnectionProvider connectionProvider, String mProductId)    throws ServletException {
    return insertTRL(connectionProvider, mProductId, 0, 0);
  }

  public static ProductTrlData[] insertTRL(ConnectionProvider connectionProvider, String mProductId, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "               select name,documentnote,description,ad_language,m_product_id from" +
      "                        m_product_trl where" +
