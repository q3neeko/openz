...
public class ProductData implements FieldProvider {
static Logger log4j = Logger.getLogger(ProductData.class);
  ...
  public static ProductData[] select(ConnectionProvider connectionProvider, String adOrgId, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "              select p.ad_client_id,p.m_product_ID,p.AD_ORG_ID, p.updated as LASTUPDATED, value," +
  ...
  public static String isExstingCategory(ConnectionProvider connectionProvider, String Name)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
  ...
  public static int insertProductCategory(ConnectionProvider connectionProvider, String adClientId, String User, String orgId, String Value, String Name, String description)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
  ...
  public static String isExstingProduct(ConnectionProvider connectionProvider, String Value)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
  ...
  public static int insertProduct(ConnectionProvider connectionProvider, String adClientId, String User, String orgId, String Value, String Name, String width, String height, String weight, String description, String documentnote, String category)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "                insert into m_product   (ad_client_id,updated,created,updatedby,createdby,isactive,ad_org_id," +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, height);
  ...
  public static int updateProduct(ConnectionProvider connectionProvider, String width, String height, String weight, String description, String documentnote, String ProductId)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
  ...
  public static int insertPPurchase(ConnectionProvider connectionProvider, String adClientId, String User, String orgId, String cBPartnerId, String Pricelist, String PricePO, String Currency, String ProductId)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
  ...
  public static int updatePPurchase(ConnectionProvider connectionProvider, String Pricelist, String PricePO, String ProductId)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
  ...
  public static int updateSPrice(ConnectionProvider connectionProvider, String pricelist, String pricestd, String ProductId)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
  ...
  public static int insertSPrice(ConnectionProvider connectionProvider, String adClientId, String User, String orgId, String CurrencyId, String pricelist, String pricestd, String ProductId)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
