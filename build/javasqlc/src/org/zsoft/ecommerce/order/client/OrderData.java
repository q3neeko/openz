...
static Logger log4j = Logger.getLogger(OrderData.class);
  ...
  public String getField(String fieldName) {
    if (fieldName.equalsIgnoreCase("ad_org_id") || fieldName.equals("adOrgId"))
      ...
      return sddami;
    else if (fieldName.equalsIgnoreCase("dorder"))
      return dorder;
    else if (fieldName.equalsIgnoreCase("torder"))
      return torder;
   else {
  ...
  public static OrderData[] select(ConnectionProvider connectionProvider, String OrderId, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "               paymentrule,deliveryviarule,description,scheddeliverydate,to_char(scheddeliverydate,'YYYY-MM-DD') as sddami,to_char(dateordered,'DDMMYYYY') as dorder ,to_char(dateordered,'hhmm') as torder from c_order" +
      "                        where c_order_id=?        ";
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectOrderData.dorder = UtilSql.getValue(result, "dorder");
        objectOrderData.torder = UtilSql.getValue(result, "torder");
