...
static Logger log4j = Logger.getLogger(CrudOperationsData.class);
  ...
  public static String isView(ConnectionProvider connectionProvider, String tabId)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        select case when count(*)=1 then 'Y' else 'N' end as ca  from INFORMATION_SCHEMA.views,ad_table,ad_tab where ad_tab.ad_table_id=ad_table.ad_table_id and INFORMATION_SCHEMA.views.table_name=ad_table.tablename and ad_tab.ad_tab_id = ?";
