...
static Logger log4j = Logger.getLogger(UtilsData.class);
  ...
  public static String selectDisplayDatevalue(ConnectionProvider connectionProvider, String strvalue, String strdbformat, String strLangFormat)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, strLangFormat);
