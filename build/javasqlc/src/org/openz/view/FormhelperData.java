...
static Logger log4j = Logger.getLogger(FormhelperData.class);
  ...
  public static FormhelperData[] select(ConnectionProvider connectionProvider, String referenceid, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectFormhelperData.defaultvalue = UtilSql.getValue(result, "defaultvalue");
  ...
  public static FormhelperData[] ad_selecttabBuscadorFields(ConnectionProvider connectionProvider, String language, String tabid, String isAudit, String isDirectFilter)    throws ServletException {
    return ad_selecttabBuscadorFields(connectionProvider, language, tabid, isAudit, isDirectFilter, 0, 0);
  }

  public static FormhelperData[] ad_selecttabBuscadorFields(ConnectionProvider connectionProvider, String language, String tabid, String isAudit, String isDirectFilter, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "               select '' as fieldgroupid,'' as ad_element_id,ptranslation as  translation,pfieldreference as fieldreference,pislinebreak as islinebreak,pAD_REF_FIELDCOLUMN_ID as AD_REF_FIELDCOLUMN_ID," +
