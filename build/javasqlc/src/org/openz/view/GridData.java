...
static Logger log4j = Logger.getLogger(GridData.class);
  ...
  public String getField(String fieldName) {
    ...
    else if (fieldName.equalsIgnoreCase("colstyle"))
      return colstyle;
    else if (fieldName.equalsIgnoreCase("groupstyle"))
      return groupstyle;
  ...
  public static GridData[] select(ConnectionProvider connectionProvider, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectGridData.dynamiccolssql = UtilSql.getValue(result, "dynamiccolssql");
        objectGridData.colstyle = UtilSql.getValue(result, "colstyle");
        objectGridData.groupstyle = UtilSql.getValue(result, "groupstyle");
        ...
        objectGridData.readonlylogic = UtilSql.getValue(result, "readonlylogic");
  ...
  public static GridData[] set()    throws ServletException {
    GridData objectGridData[] = new GridData[1];
    objectGridData[0] = new GridData();
    objectGridData[0].adRefGroupId = "";
    objectGridData[0].adClientId = "";
    objectGridData[0].adOrgId = "";
    objectGridData[0].colsvisibleoninit = "";
    objectGridData[0].createdby = "";
    objectGridData[0].updatedby = "";
    objectGridData[0].adReferenceId = "";
    objectGridData[0].idcolumn = "";
    objectGridData[0].level = "";
    objectGridData[0].leadingemptycols = "";
    objectGridData[0].headerformatbold = "";
    objectGridData[0].hasselectallbelow = "";
    objectGridData[0].hasevenodd = "";
    objectGridData[0].hasexpander = "";
    objectGridData[0].hasselectline = "";
    objectGridData[0].adRefGridcolumnId = "";
    objectGridData[0].name = "";
    objectGridData[0].headertext = "";
    objectGridData[0].template = "";
    objectGridData[0].referenceurl = "";
    objectGridData[0].colreference = "";
    objectGridData[0].adTableId = "";
    objectGridData[0].onchangeevent = "";
    objectGridData[0].colspan = "";
    objectGridData[0].maxlength = "";
    objectGridData[0].required = "";
    objectGridData[0].readonly = "";
    objectGridData[0].isinheader = "";
    objectGridData[0].issecondheader = "";
    objectGridData[0].issplitgroup = "";
    objectGridData[0].adValRuleId = "";
    objectGridData[0].includesemptyitem = "";
    objectGridData[0].dynamiccolssql = "";
    objectGridData[0].colstyle = "";
    objectGridData[0].groupstyle = "";
    objectGridData[0].isrowkey = "";
    objectGridData[0].issortable = "";
    objectGridData[0].rowkeysuffix = "";
    objectGridData[0].isdisplayed = "";
    objectGridData[0].adElementId = "";
    objectGridData[0].line = "";
    objectGridData[0].isautoheader = "";
    objectGridData[0].readonlylogic = "";
    return objectGridData;
  }
  ...
  public static String getDynSQLGromGridColumnID(ConnectionProvider connectionProvider, String adRefGridcolumnId)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      result = st.executeQuery();
      if(result.next()) {
        strReturn = UtilSql.getValue(result, "dynamiccolssql");
      }
      result.close();
    } catch(SQLException e){
      log4j.error("SQL error in query: " + strSql + "Exception:"+ e);
