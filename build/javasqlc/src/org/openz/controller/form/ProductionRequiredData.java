...
static Logger log4j = Logger.getLogger(ProductionRequiredData.class);
  ...
  public static ProductionRequiredData[] selectgrid(ConnectionProvider connectionProvider, String language, String parProduct, String parDateFrom, String parDateTo, String adOrgId, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      "       AND 2=2 " +
      "       AND 3=3";
    strSql = strSql + ((parDateFrom==null || parDateFrom.equals(""))?"":"  AND coalesce(ZSSM_PRODUCTIONREQUIRED_V.dependentstartdate,ZSSM_PRODUCTIONREQUIRED_V.lateststartdate) >= TO_DATE(?) ");
    strSql = strSql + 
      "       AND 4=4";
    strSql = strSql + ((parDateTo==null || parDateTo.equals(""))?"":"  AND coalesce(ZSSM_PRODUCTIONREQUIRED_V.dependentstartdate,ZSSM_PRODUCTIONREQUIRED_V.lateststartdate) < TO_DATE(?) ");
    strSql = strSql + 
      "       AND ad_org_id in (";
  ...
  public static int insert(Connection conn, ConnectionProvider connectionProvider, String PrunID, String adClientId, String adOrgId, String createdby, String updatedby, String qty, String startdate, String product, String pinstance, String cause, String enddate)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
    ...
    st = connectionProvider.getPreparedStatement(conn, strSql);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, PrunID);
  ...
  public static String selectdependent(ConnectionProvider connectionProvider, String pInstanceID)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
