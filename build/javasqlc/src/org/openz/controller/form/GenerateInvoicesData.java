...
static Logger log4j = Logger.getLogger(GenerateInvoicesData.class);
  ...
  public static GenerateInvoicesData[] select(ConnectionProvider connectionProvider, String language, String issotrx, String adUserClient, String adUserOrg, String parBPartner, String documentno, String parDateFrom, String parDateTo, String adOrgId)    throws ServletException {
    return select(connectionProvider, language, issotrx, adUserClient, adUserOrg, parBPartner, documentno, parDateFrom, parDateTo, adOrgId, 0, 0);
  }

  public static GenerateInvoicesData[] select(ConnectionProvider connectionProvider, String language, String issotrx, String adUserClient, String adUserOrg, String parBPartner, String documentno, String parDateFrom, String parDateTo, String adOrgId, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
    ...
    strSql = strSql + ((documentno==null || documentno.equals(""))?"":" AND icl.documentno like ? ");
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectGenerateInvoicesData.adOrgId = UtilSql.getValue(result, "ad_org_id");
        ...
        objectGenerateInvoicesData.mAttributesetinstanceId = UtilSql.getValue(result, "m_attributesetinstance_id");
  ...
  public static GenerateInvoicesData[] set()    throws ServletException {
    ...
    objectGenerateInvoicesData[0].adOrgId = "";
    ...
    objectGenerateInvoicesData[0].mAttributesetinstanceId = "";
  ...
  public static int insert(Connection conn, ConnectionProvider connectionProvider, String cGenerateinvoicemanualId, String cOrderlineId, String cOrderId, String adClientId, String adOrgId, String createdby, String updatedby, String qty, String price, String lineamt, String ignoreresidue, String mInoutlineId, String mAttributesetinstanceId, String pInstanceId)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
