...
static Logger log4j = Logger.getLogger(ProjecttaskMaterialDispositionData.class);
  ...
  public static ProjecttaskMaterialDispositionData[] select(ConnectionProvider connectionProvider, String lang, String projecttaskid, String productvalue, String productname, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectProjecttaskMaterialDispositionData.directship = UtilSql.getValue(result, "directship");
        objectProjecttaskMaterialDispositionData.cOrderlineId = UtilSql.getValue(result, "c_orderline_id");
  ...
  public static int update(Connection conn, ConnectionProvider connectionProvider, String updatedby, String locatorId, String productId, String quantity, String planreq, String returnafter, String dateplan, String bomviewId)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
