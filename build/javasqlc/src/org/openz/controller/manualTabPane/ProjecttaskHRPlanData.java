...
static Logger log4j = Logger.getLogger(ProjecttaskHRPlanData.class);
  ...
  public static ProjecttaskHRPlanData[] select(ConnectionProvider connectionProvider, String projecttaskid, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectProjecttaskHRPlanData.created = UtilSql.getDateValue(result, "created", "dd-MM-yyyy");
  ...
  public static int insert(ConnectionProvider connectionProvider, String idValue, String adOrgId, String projecttaskId, String createdby, String salcategoryId, String quantity, String userId, String overtimehours, String nighthours, String saturday, String sunday, String holiday, String specialtime1, String specialtime2, String triggeramt, String datefrom, String dateformat, String dateto, String description)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
  ...
  public static int update(ConnectionProvider connectionProvider, String updatedby, String salcategoryId, String quantity, String userId, String overtimehours, String nighthours, String saturday, String sunday, String holiday, String specialtime1, String specialtime2, String triggeramt, String datefrom, String dateformat, String dateto, String description, String planId)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
