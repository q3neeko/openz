...
static Logger log4j = Logger.getLogger(ShopProductBulkSettingsData.class);
  ...
  public static String insert(ConnectionProvider connectionProvider, String userid, String shopid, String productId, String catId, String tagId, String isorderble, String hideonnostock, String allowaordernostock, String maxstockshown, String minorderqtyn, String maxorderqty, String minstockshown)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "      select zse_bulkproductshopassignment(?,?,?,?,?,?,?,?,to_number(?),to_number(?),to_number(?),to_number(?))";
