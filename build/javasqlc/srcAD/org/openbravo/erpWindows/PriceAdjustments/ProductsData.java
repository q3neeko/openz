  ...
  public static ProductsData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String mOfferId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectProductsData.mProductPoId = UtilSql.getValue(result, "m_product_po_id");
        objectProductsData.mProductPoIdr = UtilSql.getValue(result, "m_product_po_idr");
        objectProductsData.mAttributesetinstanceId = UtilSql.getValue(result, "m_attributesetinstance_id");
        objectProductsData.mAttributesetinstanceIdr = UtilSql.getValue(result, "m_attributesetinstance_idr");
        objectProductsData.graterequal = UtilSql.getValue(result, "graterequal");
        objectProductsData.lessequal = UtilSql.getValue(result, "lessequal");
...
Create a registry
 */
  public static ProductsData[] set(String mOfferId, String adOrgId, String lessequal, String mAttributesetinstanceId, String mAttributesetinstanceIdr, String cUomId, String mOfferProductId, String mProductId, String mProductIdr, String updatedby, String updatedbyr, String createdby, String createdbyr, String adClientId, String isactive, String graterequal, String mProductPoId)    throws ServletException {
    ...
    objectProductsData[0].mProductPoId = mProductPoId;
    objectProductsData[0].mProductPoIdr = "";
    objectProductsData[0].mAttributesetinstanceId = mAttributesetinstanceId;
    objectProductsData[0].mAttributesetinstanceIdr = mAttributesetinstanceIdr;
    objectProductsData[0].graterequal = graterequal;
    objectProductsData[0].lessequal = lessequal;
 ...
 */
  public static String selectDef2384E857A8AD47BD81B4539A1E18F1F2_0(ConnectionProvider connectionProvider, String M_Attributesetinstance_IDR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectDef801152_1(ConnectionProvider connectionProvider, String M_Product_IDR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectDef801150_2(ConnectionProvider connectionProvider, String UpdatedbyR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectDef801148_3(ConnectionProvider connectionProvider, String CreatedbyR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
