...
Create a registry
 */
  public static PriceListData[] set(String mOfferId, String createdby, String createdbyr, String mOfferPricelistId, String adOrgId, String mPricelistId, String updatedby, String updatedbyr, String adClientId, String isactive)    throws ServletException {
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET M_Offer_ID = (?) , M_PriceList_ID = (?) , M_Offer_Pricelist_ID = (?) , AD_Client_ID = (?) , AD_Org_ID = (?) , IsActive = (?) , updated = now(), updatedby = ? " +
      "        WHERE M_Offer_PriceList.M_Offer_Pricelist_ID = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (M_Offer_ID, M_PriceList_ID, M_Offer_Pricelist_ID, AD_Client_ID, AD_Org_ID, IsActive, created, createdby, updated, updatedBy)" +
      "        VALUES ((?), (?), (?), (?), (?), (?), now(), ?, now(), ?)";
