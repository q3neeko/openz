 ...
 */
  public static NodeTranslationData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String adWfNodeId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN AD_WF_Node_Trl.AD_Org_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS AD_Org_IDR, " +
      "AD_WF_Node_Trl.AD_WF_Node_ID, " +
      "(CASE WHEN AD_WF_Node_Trl.AD_WF_Node_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table2.Name), ''))),'') ) END) AS AD_WF_Node_IDR, " +
      "AD_WF_Node_Trl.AD_Language, " +
      "(CASE WHEN AD_WF_Node_Trl.AD_Language IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table3.Name), ''))),'') ) END) AS AD_LanguageR, " +
      ...
      "AD_WF_Node_Trl.Help, " +
      "        ? AS LANGUAGE " +
      "        FROM AD_WF_Node_Trl left join (select AD_Org_ID, Name from AD_Org) table1 on (AD_WF_Node_Trl.AD_Org_ID = table1.AD_Org_ID) left join (select AD_WF_Node_ID, Name from AD_WF_Node) table2 on (AD_WF_Node_Trl.AD_WF_Node_ID = table2.AD_WF_Node_ID) left join (select AD_Language, Name from AD_Language) table3 on (AD_WF_Node_Trl.AD_Language =  table3.AD_Language)" +
      "        WHERE 2=2 " +
      "        AND 1=1 ";
...
Create a registry
 */
  public static NodeTranslationData[] set(String adWfNodeId, String name, String isactive, String updatedby, String updatedbyr, String adOrgId, String adClientId, String createdby, String createdbyr, String adLanguage, String istranslated, String help, String adWfNodeTrlId, String description)    throws ServletException {
