...
static Logger log4j = Logger.getLogger(Serialnumbers1BD46C67B6A54A8AB55EFF9A36B4D3B1Data.class);
  ...
  public String selectedbatchr;
  public String quantity;
  public String snrBuiltinsnr;
  public String snrBuiltinsnrr;
  ...
  public String getField(String fieldName) {
    if (fieldName.equalsIgnoreCase("created"))
      ...
      return lotnumber;
    else if (fieldName.equalsIgnoreCase("selectedbatch"))
      return selectedbatch;
    else if (fieldName.equalsIgnoreCase("selectedbatchr"))
      return selectedbatchr;
    else if (fieldName.equalsIgnoreCase("quantity"))
      return quantity;
    else if (fieldName.equalsIgnoreCase("snr_builtinsnr") || fieldName.equals("snrBuiltinsnr"))
      return snrBuiltinsnr;
    else if (fieldName.equalsIgnoreCase("snr_builtinsnrr") || fieldName.equals("snrBuiltinsnrr"))
      return snrBuiltinsnrr;
 ...
 */
  public static Serialnumbers1BD46C67B6A54A8AB55EFF9A36B4D3B1Data[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String mInternalConsumptionlineId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "snr_internal_consumptionline.Selectedbatch, " +
      "(CASE WHEN snr_internal_consumptionline.Selectedbatch IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table5.Batchnumber), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table6.Value), ''))),'') ) END) AS SelectedbatchR, " +
      "snr_internal_consumptionline.Quantity, " +
      "snr_internal_consumptionline.SNR_Builtinsnr, " +
      "(CASE WHEN snr_internal_consumptionline.SNR_Builtinsnr IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table7.Serialnumber), ''))),'') ) END) AS SNR_BuiltinsnrR, " +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectSerialnumbers1BD46C67B6A54A8AB55EFF9A36B4D3B1Data.selectedbatch = UtilSql.getValue(result, "selectedbatch");
        objectSerialnumbers1BD46C67B6A54A8AB55EFF9A36B4D3B1Data.selectedbatchr = UtilSql.getValue(result, "selectedbatchr");
        objectSerialnumbers1BD46C67B6A54A8AB55EFF9A36B4D3B1Data.quantity = UtilSql.getValue(result, "quantity");
        objectSerialnumbers1BD46C67B6A54A8AB55EFF9A36B4D3B1Data.snrBuiltinsnr = UtilSql.getValue(result, "snr_builtinsnr");
        objectSerialnumbers1BD46C67B6A54A8AB55EFF9A36B4D3B1Data.snrBuiltinsnrr = UtilSql.getValue(result, "snr_builtinsnrr");
...
Create a registry
 */
  public static Serialnumbers1BD46C67B6A54A8AB55EFF9A36B4D3B1Data[] set(String mInternalConsumptionlineId, String adClientId, String isactive, String snrBuiltinsnr, String guaranteedays, String description, String rfidnumber, String guaranteedate, String createdby, String createdbyr, String updatedby, String updatedbyr, String serialnumber, String quantity, String lotnumber, String isunavailable, String selectedbatch, String selectedbatchr, String adOrgId, String snrInternalConsumptionlineId)    throws ServletException {
    ...
    objectSerialnumbers1BD46C67B6A54A8AB55EFF9A36B4D3B1Data[0].selectedbatch = selectedbatch;
    objectSerialnumbers1BD46C67B6A54A8AB55EFF9A36B4D3B1Data[0].selectedbatchr = selectedbatchr;
    objectSerialnumbers1BD46C67B6A54A8AB55EFF9A36B4D3B1Data[0].quantity = quantity;
    objectSerialnumbers1BD46C67B6A54A8AB55EFF9A36B4D3B1Data[0].snrBuiltinsnr = snrBuiltinsnr;
    objectSerialnumbers1BD46C67B6A54A8AB55EFF9A36B4D3B1Data[0].snrBuiltinsnrr = "";
...
Select for auxiliar field
 */
  public static String selectDef6793BE1A89354002B2C6B10B56964DB4_2(ConnectionProvider connectionProvider, String SelectedbatchR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        SELECT  ( COALESCE(TO_CHAR(table1.SNR_Batchmasterdata_ID), '')  || ' - ' || COALESCE(TO_CHAR(table2.Value), '') ) as Selectedbatch FROM snr_batchlocator table1 left join M_Locator table2 on (table1.M_Locator_ID = table2.M_Locator_ID) WHERE table1.isActive='Y' AND table1.SNR_Batchlocator_ID = ?  ";
    ...
    try {
    st = connectionProvider.getPreparedStatement(strSql);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, SelectedbatchR);

      result = st.executeQuery();
      if(result.next()) {
        strReturn = UtilSql.getValue(result, "selectedbatch");
      }
      result.close();
    } catch(SQLException e){
      log4j.error("SQL error in query: " + strSql + "Exception:"+ e);
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET M_Internal_Consumptionline_ID = (?) , Serialnumber = (?) , Isunavailable = (?) , Lotnumber = (?) , Selectedbatch = (?) , Quantity = TO_NUMBER(?) , SNR_Builtinsnr = (?) , Guaranteedate = TO_DATE(?) , SNR_Internal_Consumptionline_ID = (?) , AD_Client_ID = (?) , Rfidnumber = (?) , Isactive = (?) , AD_Org_ID = (?) , Description = (?) , Guaranteedays = TO_NUMBER(?) , updated = now(), updatedby = ? " +
      "        WHERE snr_internal_consumptionline.SNR_Internal_Consumptionline_ID = ? " +
    ...
    st = connectionProvider.getPreparedStatement(conn, strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, selectedbatch);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, quantity);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, snrBuiltinsnr);
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (M_Internal_Consumptionline_ID, Serialnumber, Isunavailable, Lotnumber, Selectedbatch, Quantity, SNR_Builtinsnr, Guaranteedate, SNR_Internal_Consumptionline_ID, AD_Client_ID, Rfidnumber, Isactive, AD_Org_ID, Description, Guaranteedays, created, createdby, updated, updatedBy)" +
