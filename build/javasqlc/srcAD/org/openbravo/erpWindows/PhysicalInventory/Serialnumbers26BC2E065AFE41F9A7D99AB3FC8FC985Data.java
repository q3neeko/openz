 ...
 */
  public static Serialnumbers26BC2E065AFE41F9A7D99AB3FC8FC985Data[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String mInventorylineId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "snr_inventoryline.Selectedbatch, " +
      "(CASE WHEN snr_inventoryline.Selectedbatch IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table4.Batchnumber), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table5.Value), ''))),'') ) END) AS SelectedbatchR, " +
      ...
      "        ? AS LANGUAGE " +
      "        FROM snr_inventoryline left join (select M_Inventoryline_ID, Line, QtyCount, M_Inventory_ID, Name from M_Inventoryline) table1 on (snr_inventoryline.M_Inventoryline_ID = table1.M_Inventoryline_ID) left join (select M_Inventory_ID, Name from M_Inventory) table2 on (table1.M_Inventory_ID = table2.M_Inventory_ID) left join (select SNR_Batchlocator_ID, SNR_Batchmasterdata_ID, M_Locator_ID from snr_batchlocator) table3 on (snr_inventoryline.Selectedbatch = table3.SNR_Batchlocator_ID) left join (select SNR_Batchmasterdata_ID, Batchnumber from SNR_Batchmasterdata) table4 on (table3.SNR_Batchmasterdata_ID = table4.SNR_Batchmasterdata_ID) left join (select M_Locator_ID, Value from M_Locator) table5 on (table3.M_Locator_ID = table5.M_Locator_ID)" +
      "        WHERE 2=2 " +
      "        AND 1=1 ";
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectSerialnumbers26BC2E065AFE41F9A7D99AB3FC8FC985Data.selectedbatch = UtilSql.getValue(result, "selectedbatch");
        objectSerialnumbers26BC2E065AFE41F9A7D99AB3FC8FC985Data.selectedbatchr = UtilSql.getValue(result, "selectedbatchr");
...
Create a registry
 */
  public static Serialnumbers26BC2E065AFE41F9A7D99AB3FC8FC985Data[] set(String mInventorylineId, String serialnumber, String guaranteedate, String updatedby, String updatedbyr, String isactive, String isunavailable, String rfidnumber, String adClientId, String guaranteedays, String createdby, String createdbyr, String selectedbatch, String selectedbatchr, String description, String quantity, String snrInventorylineId, String lotnumber, String adOrgId)    throws ServletException {
    ...
    objectSerialnumbers26BC2E065AFE41F9A7D99AB3FC8FC985Data[0].selectedbatch = selectedbatch;
    objectSerialnumbers26BC2E065AFE41F9A7D99AB3FC8FC985Data[0].selectedbatchr = selectedbatchr;
...
Select for auxiliar field
 */
  public static String selectDefA17BB00B275143468277811BD1E1691C_2(ConnectionProvider connectionProvider, String SelectedbatchR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET M_Inventoryline_ID = (?) , Serialnumber = (?) , Isunavailable = (?) , Lotnumber = (?) , Selectedbatch = (?) , Quantity = TO_NUMBER(?) , AD_Org_ID = (?) , Isactive = (?) , Rfidnumber = (?) , Guaranteedate = TO_DATE(?) , AD_Client_ID = (?) , Guaranteedays = TO_NUMBER(?) , Description = (?) , SNR_Inventoryline_ID = (?) , updated = now(), updatedby = ? " +
      "        WHERE snr_inventoryline.SNR_Inventoryline_ID = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (M_Inventoryline_ID, Serialnumber, Isunavailable, Lotnumber, Selectedbatch, Quantity, AD_Org_ID, Isactive, Rfidnumber, Guaranteedate, AD_Client_ID, Guaranteedays, Description, SNR_Inventoryline_ID, created, createdby, updated, updatedBy)" +
