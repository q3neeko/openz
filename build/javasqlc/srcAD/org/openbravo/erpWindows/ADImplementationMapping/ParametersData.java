 ...
 */
  public static ParametersData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String adModelObjectId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN AD_Model_Object_Para.AD_Org_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS AD_Org_IDR, " +
      "AD_Model_Object_Para.AD_Model_Object_ID, " +
      "(CASE WHEN AD_Model_Object_Para.AD_Model_Object_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table2.Classname), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table2.Name), ''))),'') ) END) AS AD_Model_Object_IDR, " +
      ...
      "        ? AS LANGUAGE " +
      "        FROM AD_Model_Object_Para left join (select AD_Org_ID, Name from AD_Org) table1 on (AD_Model_Object_Para.AD_Org_ID = table1.AD_Org_ID) left join (select AD_Model_Object_ID, Classname, Name from AD_Model_Object) table2 on (AD_Model_Object_Para.AD_Model_Object_ID = table2.AD_Model_Object_ID)" +
      "        WHERE 2=2 " +
      "        AND 1=1 ";
...
Create a registry
 */
  public static ParametersData[] set(String adModelObjectId, String line, String name, String value, String createdby, String adClientId, String isactive, String adModelObjectParaId, String adOrgId, String updatedby)    throws ServletException {
