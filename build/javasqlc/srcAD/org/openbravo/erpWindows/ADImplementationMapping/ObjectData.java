 ...
 */
  public static ObjectData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN AD_Model_Object.AD_Module_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table2.Name), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table2.Version), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table3.Name), ''))),'') ) END) AS AD_Module_IDR, " +
...
Create a registry
 */
  public static ObjectData[] set(String adProcessId, String adTaskId, String seqno, String action, String adFormId, String adReferenceId, String adTabId, String adWorkflowId, String name, String isactive, String adClientId, String isdefault, String adCalloutId, String adModuleId, String loadonstartup, String classname, String objectType, String adModelObjectId, String adOrgId, String updatedby, String updatedbyr, String createdby, String createdbyr)    throws ServletException {
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET AD_Model_Object_ID = (?) , AD_Client_ID = (?) , AD_Org_ID = (?) , IsActive = (?) , AD_Module_ID = (?) , IsDefault = (?) , Object_Type = (?) , Name = (?) , Classname = (?) , Loadonstartup = TO_NUMBER(?) , Action = (?) , Seqno = TO_NUMBER(?) , AD_Tab_ID = (?) , AD_Task_ID = (?) , AD_Workflow_ID = (?) , AD_Process_ID = (?) , AD_Form_ID = (?) , AD_Reference_ID = (?) , AD_Callout_ID = (?) , updated = now(), updatedby = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Model_Object_ID, AD_Client_ID, AD_Org_ID, IsActive, AD_Module_ID, IsDefault, Object_Type, Name, Classname, Loadonstartup, Action, Seqno, AD_Tab_ID, AD_Task_ID, AD_Workflow_ID, AD_Process_ID, AD_Form_ID, AD_Reference_ID, AD_Callout_ID, created, createdby, updated, updatedBy)" +
