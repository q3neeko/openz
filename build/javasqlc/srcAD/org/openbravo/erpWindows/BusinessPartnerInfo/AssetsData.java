...
Select for edit
 */
  public static AssetsData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String C_BPartner_ID, String cBpartnerId, String key, String adUserClient, String adOrgClient)    throws ServletException {
...
Select for edit
 */
  public static AssetsData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String C_BPartner_ID, String cBpartnerId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      ...
      "A_Asset.A_Asset_ID, " +
      "        ? AS LANGUAGE " +
      "        FROM A_Asset left join (select AD_Org_ID, Name from AD_Org) table1 on (A_Asset.AD_Org_ID = table1.AD_Org_ID) left join (select A_Asset_Group_ID, Name from A_Asset_Group) table2 on (A_Asset.A_Asset_Group_ID = table2.A_Asset_Group_ID)" +
      "        WHERE 2=2 " +
...
Create a registry
 */
  public static AssetsData[] set(String cBpartnerId, String name, String uselifemonths, String guaranteedate, String aAssetId, String versionno, String isfullydepreciated, String adOrgId, String aAssetGroupId, String isowned, String adUserId, String help, String assetservicedate, String isactive, String locationcomment, String isdepreciated, String value, String isdisposed, String description, String lot, String updatedby, String updatedbyr, String adClientId, String cBpartnerLocationId, String assetdepreciationdate, String createdby, String createdbyr, String serno, String cLocationId, String uselifeyears, String isinposession, String assetdisposaldate, String lifeuseunits, String useunits)    throws ServletException {
