...
WAD Generated class
 */
class DeliveriesData implements FieldProvider {
static Logger log4j = Logger.getLogger(DeliveriesData.class);
...
Select for edit
 */
  public static DeliveriesData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String C_BPartner_ID, String cBpartnerId, String key, String adUserClient, String adOrgClient)    throws ServletException {
...
Select for edit
 */
  public static DeliveriesData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String C_BPartner_ID, String cBpartnerId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        countRecord++;
        DeliveriesData objectDeliveriesData = new DeliveriesData();
        objectDeliveriesData.created = UtilSql.getValue(result, "created");
        objectDeliveriesData.createdbyr = UtilSql.getValue(result, "createdbyr");
        objectDeliveriesData.updated = UtilSql.getValue(result, "updated");
        objectDeliveriesData.updatedTimeStamp = UtilSql.getValue(result, "updated_time_stamp");
        objectDeliveriesData.updatedby = UtilSql.getValue(result, "updatedby");
        objectDeliveriesData.updatedbyr = UtilSql.getValue(result, "updatedbyr");
        objectDeliveriesData.adOrgtrxId = UtilSql.getValue(result, "ad_orgtrx_id");
        objectDeliveriesData.mShipperId = UtilSql.getValue(result, "m_shipper_id");
        objectDeliveriesData.adUserId = UtilSql.getValue(result, "ad_user_id");
        objectDeliveriesData.dateprinted = UtilSql.getDateValue(result, "dateprinted", "dd-MM-yyyy");
        objectDeliveriesData.freightcostrule = UtilSql.getValue(result, "freightcostrule");
        objectDeliveriesData.pickdate = UtilSql.getDateValue(result, "pickdate", "dd-MM-yyyy");
        objectDeliveriesData.trackingno = UtilSql.getValue(result, "trackingno");
        objectDeliveriesData.qty = UtilSql.getValue(result, "qty");
        objectDeliveriesData.shipdate = UtilSql.getDateValue(result, "shipdate", "dd-MM-yyyy");
        objectDeliveriesData.user2Id = UtilSql.getValue(result, "user2_id");
        objectDeliveriesData.user1Id = UtilSql.getValue(result, "user1_id");
        objectDeliveriesData.cActivityId = UtilSql.getValue(result, "c_activity_id");
        objectDeliveriesData.cCampaignId = UtilSql.getValue(result, "c_campaign_id");
        objectDeliveriesData.cProjectId = UtilSql.getValue(result, "c_project_id");
        objectDeliveriesData.priorityrule = UtilSql.getValue(result, "priorityrule");
        objectDeliveriesData.dateacct = UtilSql.getDateValue(result, "dateacct", "dd-MM-yyyy");
        objectDeliveriesData.docaction = UtilSql.getValue(result, "docaction");
        objectDeliveriesData.posted = UtilSql.getValue(result, "posted");
        objectDeliveriesData.createfrom = UtilSql.getValue(result, "createfrom");
        objectDeliveriesData.generateto = UtilSql.getValue(result, "generateto");
        objectDeliveriesData.chargeamt = UtilSql.getValue(result, "chargeamt");
        objectDeliveriesData.dateordered = UtilSql.getDateValue(result, "dateordered", "dd-MM-yyyy");
        objectDeliveriesData.freightamt = UtilSql.getValue(result, "freightamt");
        objectDeliveriesData.cInvoiceId = UtilSql.getValue(result, "c_invoice_id");
        objectDeliveriesData.deliveryviarule = UtilSql.getValue(result, "deliveryviarule");
        objectDeliveriesData.processed = UtilSql.getValue(result, "processed");
        objectDeliveriesData.processing = UtilSql.getValue(result, "processing");
        objectDeliveriesData.cBpartnerLocationId = UtilSql.getValue(result, "c_bpartner_location_id");
        objectDeliveriesData.issotrx = UtilSql.getValue(result, "issotrx");
        objectDeliveriesData.deliveryrule = UtilSql.getValue(result, "deliveryrule");
        objectDeliveriesData.cChargeId = UtilSql.getValue(result, "c_charge_id");
        objectDeliveriesData.isactive = UtilSql.getValue(result, "isactive");
        objectDeliveriesData.cBpartnerId = UtilSql.getValue(result, "c_bpartner_id");
        objectDeliveriesData.poreference = UtilSql.getValue(result, "poreference");
        objectDeliveriesData.isprinted = UtilSql.getValue(result, "isprinted");
        objectDeliveriesData.adClientId = UtilSql.getValue(result, "ad_client_id");
        objectDeliveriesData.adOrgId = UtilSql.getValue(result, "ad_org_id");
        objectDeliveriesData.adOrgIdr = UtilSql.getValue(result, "ad_org_idr");
        objectDeliveriesData.cDoctypeId = UtilSql.getValue(result, "c_doctype_id");
        objectDeliveriesData.cDoctypeIdr = UtilSql.getValue(result, "c_doctype_idr");
        objectDeliveriesData.documentno = UtilSql.getValue(result, "documentno");
        objectDeliveriesData.docstatus = UtilSql.getValue(result, "docstatus");
        objectDeliveriesData.docstatusr = UtilSql.getValue(result, "docstatusr");
        objectDeliveriesData.movementtype = UtilSql.getValue(result, "movementtype");
        objectDeliveriesData.movementtyper = UtilSql.getValue(result, "movementtyper");
        objectDeliveriesData.movementdate = UtilSql.getDateValue(result, "movementdate", "dd-MM-yyyy");
        objectDeliveriesData.salesrepId = UtilSql.getValue(result, "salesrep_id");
        objectDeliveriesData.salesrepIdr = UtilSql.getValue(result, "salesrep_idr");
        objectDeliveriesData.description = UtilSql.getValue(result, "description");
        objectDeliveriesData.mWarehouseId = UtilSql.getValue(result, "m_warehouse_id");
        objectDeliveriesData.mWarehouseIdr = UtilSql.getValue(result, "m_warehouse_idr");
        objectDeliveriesData.cOrderId = UtilSql.getValue(result, "c_order_id");
        objectDeliveriesData.cOrderIdr = UtilSql.getValue(result, "c_order_idr");
        objectDeliveriesData.mInoutId = UtilSql.getValue(result, "m_inout_id");
        objectDeliveriesData.language = UtilSql.getValue(result, "language");
        objectDeliveriesData.adUserClient = "";
        objectDeliveriesData.adOrgClient = "";
        objectDeliveriesData.createdby = "";
        objectDeliveriesData.trBgcolor = "";
        objectDeliveriesData.totalCount = "";
        objectDeliveriesData.InitRecordNumber = Integer.toString(firstRegister);
        vector.addElement(objectDeliveriesData);
    ...
    DeliveriesData objectDeliveriesData[] = new DeliveriesData[vector.size()];
    vector.copyInto(objectDeliveriesData);
    return(objectDeliveriesData);
  }

/**
Create a registry
 */
  public static DeliveriesData[] set(String cBpartnerId, String freightamt, String poreference, String user1Id, String docaction, String generateto, String movementtype, String cProjectId, String cCampaignId, String shipdate, String docstatus, String isprinted, String mShipperId, String priorityrule, String dateacct, String mInoutId, String createfrom, String cInvoiceId, String trackingno, String updatedby, String updatedbyr, String createdby, String createdbyr, String processed, String issotrx, String dateprinted, String freightcostrule, String mWarehouseId, String adOrgtrxId, String isactive, String salesrepId, String qty, String adOrgId, String cBpartnerLocationId, String cOrderId, String cOrderIdr, String deliveryrule, String user2Id, String dateordered, String processing, String cChargeId, String adClientId, String documentno, String chargeamt, String cDoctypeId, String cActivityId, String movementdate, String pickdate, String description, String posted, String deliveryviarule, String adUserId)    throws ServletException {
    DeliveriesData objectDeliveriesData[] = new DeliveriesData[1];
    objectDeliveriesData[0] = new DeliveriesData();
    objectDeliveriesData[0].created = "";
    objectDeliveriesData[0].createdbyr = createdbyr;
    objectDeliveriesData[0].updated = "";
    objectDeliveriesData[0].updatedTimeStamp = "";
    objectDeliveriesData[0].updatedby = updatedby;
    objectDeliveriesData[0].updatedbyr = updatedbyr;
    objectDeliveriesData[0].adOrgtrxId = adOrgtrxId;
    objectDeliveriesData[0].mShipperId = mShipperId;
    objectDeliveriesData[0].adUserId = adUserId;
    objectDeliveriesData[0].dateprinted = dateprinted;
    objectDeliveriesData[0].freightcostrule = freightcostrule;
    objectDeliveriesData[0].pickdate = pickdate;
    objectDeliveriesData[0].trackingno = trackingno;
    objectDeliveriesData[0].qty = qty;
    objectDeliveriesData[0].shipdate = shipdate;
    objectDeliveriesData[0].user2Id = user2Id;
    objectDeliveriesData[0].user1Id = user1Id;
    objectDeliveriesData[0].cActivityId = cActivityId;
    objectDeliveriesData[0].cCampaignId = cCampaignId;
    objectDeliveriesData[0].cProjectId = cProjectId;
    objectDeliveriesData[0].priorityrule = priorityrule;
    objectDeliveriesData[0].dateacct = dateacct;
    objectDeliveriesData[0].docaction = docaction;
    objectDeliveriesData[0].posted = posted;
    objectDeliveriesData[0].createfrom = createfrom;
    objectDeliveriesData[0].generateto = generateto;
    objectDeliveriesData[0].chargeamt = chargeamt;
    objectDeliveriesData[0].dateordered = dateordered;
    objectDeliveriesData[0].freightamt = freightamt;
    objectDeliveriesData[0].cInvoiceId = cInvoiceId;
    objectDeliveriesData[0].deliveryviarule = deliveryviarule;
    objectDeliveriesData[0].processed = processed;
    objectDeliveriesData[0].processing = processing;
    objectDeliveriesData[0].cBpartnerLocationId = cBpartnerLocationId;
    objectDeliveriesData[0].issotrx = issotrx;
    objectDeliveriesData[0].deliveryrule = deliveryrule;
    objectDeliveriesData[0].cChargeId = cChargeId;
    objectDeliveriesData[0].isactive = isactive;
    objectDeliveriesData[0].cBpartnerId = cBpartnerId;
    objectDeliveriesData[0].poreference = poreference;
    objectDeliveriesData[0].isprinted = isprinted;
    objectDeliveriesData[0].adClientId = adClientId;
    objectDeliveriesData[0].adOrgId = adOrgId;
    objectDeliveriesData[0].adOrgIdr = "";
    objectDeliveriesData[0].cDoctypeId = cDoctypeId;
    objectDeliveriesData[0].cDoctypeIdr = "";
    objectDeliveriesData[0].documentno = documentno;
    objectDeliveriesData[0].docstatus = docstatus;
    objectDeliveriesData[0].docstatusr = "";
    objectDeliveriesData[0].movementtype = movementtype;
    objectDeliveriesData[0].movementtyper = "";
    objectDeliveriesData[0].movementdate = movementdate;
    objectDeliveriesData[0].salesrepId = salesrepId;
    objectDeliveriesData[0].salesrepIdr = "";
    objectDeliveriesData[0].description = description;
    objectDeliveriesData[0].mWarehouseId = mWarehouseId;
    objectDeliveriesData[0].mWarehouseIdr = "";
    objectDeliveriesData[0].cOrderId = cOrderId;
    objectDeliveriesData[0].cOrderIdr = cOrderIdr;
    objectDeliveriesData[0].mInoutId = mInoutId;
    objectDeliveriesData[0].language = "";
    return objectDeliveriesData;
  }
