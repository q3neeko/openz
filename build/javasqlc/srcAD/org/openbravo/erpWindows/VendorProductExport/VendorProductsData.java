...
static Logger log4j = Logger.getLogger(VendorProductsData.class);
  ...
  public String getField(String fieldName) {
    if (fieldName.equalsIgnoreCase("created"))
      ...
      return name;
    else if (fieldName.equalsIgnoreCase("bpvalue"))
      return bpvalue;
  ...
  public static VendorProductsData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectVendorProductsData.bpvalue = UtilSql.getValue(result, "bpvalue");
        objectVendorProductsData.bpname = UtilSql.getValue(result, "bpname");
...
Create a registry
 */
  public static VendorProductsData[] set(String upc, String mManufacturerId, String pricelastinv, String adOrgId, String qtystd, String vendorcategory, String discontinuedby, String orderMin, String name, String adClientId, String discontinued, String value, String ismultipleofminimumqty, String qualityrating, String createdby, String createdbyr, String iProductPoVId, String updatedby, String updatedbyr, String pricelastpo, String manufacturernumber, String bpvalue, String cUomId, String isactive, String cCurrencyId, String pricepo, String bpname, String vendorproductno, String iscurrentvendor, String pricelist, String deliverytimePromised)    throws ServletException {
    ...
    objectVendorProductsData[0].bpvalue = bpvalue;
    objectVendorProductsData[0].bpname = bpname;
 ...
 */
  public static String selectDefE38DE16FBB1E4EBFA590FF8E366F3E04_0(ConnectionProvider connectionProvider, String CreatedbyR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectDefC08F4C1B28214F76B787B93595973300_1(ConnectionProvider connectionProvider, String UpdatedbyR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(conn, strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, bpvalue);
