 ...
 */
  public static CurrencyData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN C_Currency.AD_Org_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS AD_Org_IDR, " +
      "C_Currency.ISO_Code, " +
      ...
      "        ? AS LANGUAGE " +
      "        FROM C_Currency left join (select AD_Org_ID, Name from AD_Org) table1 on (C_Currency.AD_Org_ID = table1.AD_Org_ID)" +
      "        WHERE 2=2 " +
      "        AND 1=1 " +
...
Create a registry
 */
  public static CurrencyData[] set(String adOrgId, String isactive, String issymbolrightside, String priceprecision, String description, String cCurrencyId, String cursymbol, String costingprecision, String stdprecision, String createdby, String createdbyr, String isoCode, String updatedby, String updatedbyr, String adClientId)    throws ServletException {
