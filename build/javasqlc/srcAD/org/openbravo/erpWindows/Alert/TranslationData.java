 ...
 */
  public static TranslationData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String adAlertruleId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN AD_AlertRule_Trl.AD_Org_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS AD_Org_IDR, " +
      "AD_AlertRule_Trl.AD_Language, " +
      "(CASE WHEN AD_AlertRule_Trl.AD_Language IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table2.Name), ''))),'') ) END) AS AD_LanguageR, " +
      ...
      "        ? AS LANGUAGE " +
      "        FROM AD_AlertRule_Trl left join (select AD_Org_ID, Name from AD_Org) table1 on (AD_AlertRule_Trl.AD_Org_ID = table1.AD_Org_ID) left join (select AD_Language, Name from AD_Language) table2 on (AD_AlertRule_Trl.AD_Language =  table2.AD_Language)" +
      "        WHERE 2=2 " +
      "        AND 1=1 ";
...
Create a registry
 */
  public static TranslationData[] set(String adAlertruleId, String createdby, String createdbyr, String istranslated, String updatedby, String updatedbyr, String isactive, String adAlertruleTrlId, String adClientId, String name, String adLanguage, String adOrgId)    throws ServletException {
