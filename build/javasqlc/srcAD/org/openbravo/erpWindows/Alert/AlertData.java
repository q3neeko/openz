 ...
 */
  public static AlertData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String adAlertruleId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "AD_Alert.AD_Org_ID, " +
      "(CASE WHEN AD_Alert.AD_Org_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS AD_Org_IDR, " +
      "AD_Alert.AD_AlertRule_ID, " +
      "(CASE WHEN AD_Alert.AD_AlertRule_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL2.Name IS NULL THEN TO_CHAR(table2.Name) ELSE TO_CHAR(tableTRL2.Name) END)), ''))),'') ) END) AS AD_AlertRule_IDR, " +
...
Create a registry
 */
  public static AlertData[] set(String adAlertruleId, String createdby, String createdbyr, String note, String recordId, String adRoleId, String adOrgId, String updatedby, String updatedbyr, String isfixed, String adClientId, String description, String referencekeyId, String adUserId, String mWarehouseId, String isactive, String adAlertId)    throws ServletException {
