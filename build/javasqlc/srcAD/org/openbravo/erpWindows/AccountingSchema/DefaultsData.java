 ...
 */
  public static DefaultsData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String cAcctschemaId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN C_AcctSchema_Default.AD_Org_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS AD_Org_IDR, " +
      "C_AcctSchema_Default.C_Acctschema_Default_ID, " +
      "C_AcctSchema_Default.C_AcctSchema_ID, " +
      "(CASE WHEN C_AcctSchema_Default.C_AcctSchema_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table2.Name), ''))),'') ) END) AS C_AcctSchema_IDR, " +
      "C_AcctSchema_Default.C_Receivable_Acct, " +
      "(CASE WHEN C_AcctSchema_Default.C_Receivable_Acct IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table3.Combination), ''))),'') ) END) AS C_Receivable_AcctR, " +
      ...
      "(CASE WHEN C_AcctSchema_Default.WriteOff_Acct IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table4.Combination), ''))),'') ) END) AS WriteOff_AcctR, " +
      "C_AcctSchema_Default.AR_Discount_Acct, " +
      "(CASE WHEN C_AcctSchema_Default.AR_Discount_Acct IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table5.Combination), ''))),'') ) END) AS AR_Discount_AcctR, " +
      "C_AcctSchema_Default.AP_Discount_Acct, " +
      "(CASE WHEN C_AcctSchema_Default.AP_Discount_Acct IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table6.Combination), ''))),'') ) END) AS AP_Discount_AcctR, " +
      ...
      "(CASE WHEN C_AcctSchema_Default.V_Liability_Acct IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table7.Combination), ''))),'') ) END) AS V_Liability_AcctR, " +
      ...
      "(CASE WHEN C_AcctSchema_Default.NotInvoicedReceipts_Acct IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table8.Combination), ''))),'') ) END) AS NotInvoicedReceipts_AcctR, " +
      "C_AcctSchema_Default.E_Prepayment_Acct, " +
      "C_AcctSchema_Default.E_Expense_Acct, " +
      "C_AcctSchema_Default.P_Asset_Acct, " +
      "(CASE WHEN C_AcctSchema_Default.P_Asset_Acct IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table9.Combination), ''))),'') ) END) AS P_Asset_AcctR, " +
      "C_AcctSchema_Default.P_Expense_Acct, " +
      "(CASE WHEN C_AcctSchema_Default.P_Expense_Acct IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table10.Combination), ''))),'') ) END) AS P_Expense_AcctR, " +
      "C_AcctSchema_Default.P_Revenue_Acct, " +
      "(CASE WHEN C_AcctSchema_Default.P_Revenue_Acct IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table11.Combination), ''))),'') ) END) AS P_Revenue_AcctR, " +
      "C_AcctSchema_Default.P_Cogs_Acct, " +
      "(CASE WHEN C_AcctSchema_Default.P_Cogs_Acct IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table12.Combination), ''))),'') ) END) AS P_Cogs_AcctR, " +
      "C_AcctSchema_Default.P_PurchasePriceVariance_Acct, " +
      "C_AcctSchema_Default.P_InvoicePriceVariance_Acct, " +
      "(CASE WHEN C_AcctSchema_Default.P_InvoicePriceVariance_Acct IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table13.Combination), ''))),'') ) END) AS P_InvoicePriceVariance_AcctR, " +
      ...
      "(CASE WHEN C_AcctSchema_Default.W_Inventory_Acct IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table14.Combination), ''))),'') ) END) AS W_Inventory_AcctR, " +
      "C_AcctSchema_Default.W_InvActualAdjust_Acct, " +
      "C_AcctSchema_Default.W_Differences_Acct, " +
      "(CASE WHEN C_AcctSchema_Default.W_Differences_Acct IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table15.Combination), ''))),'') ) END) AS W_Differences_AcctR, " +
      "C_AcctSchema_Default.W_Revaluation_Acct, " +
      "(CASE WHEN C_AcctSchema_Default.W_Revaluation_Acct IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table16.Combination), ''))),'') ) END) AS W_Revaluation_AcctR, " +
      "C_AcctSchema_Default.B_Asset_Acct, " +
      "(CASE WHEN C_AcctSchema_Default.B_Asset_Acct IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table17.Combination), ''))),'') ) END) AS B_Asset_AcctR, " +
      "C_AcctSchema_Default.B_InTransit_Acct, " +
      "(CASE WHEN C_AcctSchema_Default.B_InTransit_Acct IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table18.Combination), ''))),'') ) END) AS B_InTransit_AcctR, " +
      ...
      "(CASE WHEN C_AcctSchema_Default.B_PaymentSelect_Acct IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table19.Combination), ''))),'') ) END) AS B_PaymentSelect_AcctR, " +
      "C_AcctSchema_Default.B_Expense_Acct, " +
      "(CASE WHEN C_AcctSchema_Default.B_Expense_Acct IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table20.Combination), ''))),'') ) END) AS B_Expense_AcctR, " +
      ...
      "(CASE WHEN C_AcctSchema_Default.B_RevaluationGain_Acct IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table21.Combination), ''))),'') ) END) AS B_RevaluationGain_AcctR, " +
      "C_AcctSchema_Default.B_RevaluationLoss_Acct, " +
      "(CASE WHEN C_AcctSchema_Default.B_RevaluationLoss_Acct IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table22.Combination), ''))),'') ) END) AS B_RevaluationLoss_AcctR, " +
      "C_AcctSchema_Default.B_SettlementLoss_Acct, " +
      "C_AcctSchema_Default.B_SettlementGain_Acct, " +
      "C_AcctSchema_Default.T_Due_Acct, " +
      "(CASE WHEN C_AcctSchema_Default.T_Due_Acct IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table23.Combination), ''))),'') ) END) AS T_Due_AcctR, " +
      "C_AcctSchema_Default.T_Liability_Acct, " +
      "C_AcctSchema_Default.T_Credit_Acct, " +
      "(CASE WHEN C_AcctSchema_Default.T_Credit_Acct IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table24.Combination), ''))),'') ) END) AS T_Credit_AcctR, " +
      "C_AcctSchema_Default.T_Receivables_Acct, " +
      "C_AcctSchema_Default.T_Expense_Acct, " +
      "C_AcctSchema_Default.Ch_Expense_Acct, " +
      "(CASE WHEN C_AcctSchema_Default.Ch_Expense_Acct IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table25.Combination), ''))),'') ) END) AS Ch_Expense_AcctR, " +
      ...
      "(CASE WHEN C_AcctSchema_Default.CB_Asset_Acct IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table26.Combination), ''))),'') ) END) AS CB_Asset_AcctR, " +
      "C_AcctSchema_Default.CB_Differences_Acct, " +
      "(CASE WHEN C_AcctSchema_Default.CB_Differences_Acct IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table27.Combination), ''))),'') ) END) AS CB_Differences_AcctR, " +
      "C_AcctSchema_Default.CB_CashTransfer_Acct, " +
      "(CASE WHEN C_AcctSchema_Default.CB_CashTransfer_Acct IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table28.Combination), ''))),'') ) END) AS CB_CashTransfer_AcctR, " +
      "C_AcctSchema_Default.CB_Expense_Acct, " +
      "(CASE WHEN C_AcctSchema_Default.CB_Expense_Acct IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table29.Combination), ''))),'') ) END) AS CB_Expense_AcctR, " +
      "C_AcctSchema_Default.CB_Receipt_Acct, " +
      "(CASE WHEN C_AcctSchema_Default.CB_Receipt_Acct IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table30.Combination), ''))),'') ) END) AS CB_Receipt_AcctR, " +
      "C_AcctSchema_Default.A_Depreciation_Acct, " +
      "(CASE WHEN C_AcctSchema_Default.A_Depreciation_Acct IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table31.Combination), ''))),'') ) END) AS A_Depreciation_AcctR, " +
      "C_AcctSchema_Default.A_Accumdepreciation_Acct, " +
      "(CASE WHEN C_AcctSchema_Default.A_Accumdepreciation_Acct IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table32.Combination), ''))),'') ) END) AS A_Accumdepreciation_AcctR, " +
      "C_AcctSchema_Default.PJ_Asset_Acct, " +
      "(CASE WHEN C_AcctSchema_Default.PJ_Asset_Acct IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table33.Combination), ''))),'') ) END) AS PJ_Asset_AcctR, " +
      "C_AcctSchema_Default.PJ_WIP_Acct, " +
      "(CASE WHEN C_AcctSchema_Default.PJ_WIP_Acct IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table34.Combination), ''))),'') ) END) AS PJ_WIP_AcctR, " +
      "C_AcctSchema_Default.Withholding_Acct, " +
      "C_AcctSchema_Default.Processing, " +
      "COALESCE(C_AcctSchema_Default.IsActive, 'N') AS IsActive, " +
      "        ? AS LANGUAGE " +
      "        FROM C_AcctSchema_Default left join (select AD_Org_ID, Name from AD_Org) table1 on (C_AcctSchema_Default.AD_Org_ID = table1.AD_Org_ID) left join (select C_AcctSchema_ID, Name from C_AcctSchema) table2 on (C_AcctSchema_Default.C_AcctSchema_ID = table2.C_AcctSchema_ID) left join (select C_ValidCombination_ID, Combination from C_ValidCombination) table3 on (C_AcctSchema_Default.C_Receivable_Acct = table3.C_ValidCombination_ID) left join (select C_ValidCombination_ID, Combination from C_ValidCombination) table4 on (C_AcctSchema_Default.WriteOff_Acct = table4.C_ValidCombination_ID) left join (select C_ValidCombination_ID, Combination from C_ValidCombination) table5 on (C_AcctSchema_Default.AR_Discount_Acct = table5.C_ValidCombination_ID) left join (select C_ValidCombination_ID, Combination from C_ValidCombination) table6 on (C_AcctSchema_Default.AP_Discount_Acct = table6.C_ValidCombination_ID) left join (select C_ValidCombination_ID, Combination from C_ValidCombination) table7 on (C_AcctSchema_Default.V_Liability_Acct = table7.C_ValidCombination_ID) left join (select C_ValidCombination_ID, Combination from C_ValidCombination) table8 on (C_AcctSchema_Default.NotInvoicedReceipts_Acct = table8.C_ValidCombination_ID) left join (select C_ValidCombination_ID, Combination from C_ValidCombination) table9 on (C_AcctSchema_Default.P_Asset_Acct = table9.C_ValidCombination_ID) left join (select C_ValidCombination_ID, Combination from C_ValidCombination) table10 on (C_AcctSchema_Default.P_Expense_Acct = table10.C_ValidCombination_ID) left join (select C_ValidCombination_ID, Combination from C_ValidCombination) table11 on (C_AcctSchema_Default.P_Revenue_Acct = table11.C_ValidCombination_ID) left join (select C_ValidCombination_ID, Combination from C_ValidCombination) table12 on (C_AcctSchema_Default.P_Cogs_Acct = table12.C_ValidCombination_ID) left join (select C_ValidCombination_ID, Combination from C_ValidCombination) table13 on (C_AcctSchema_Default.P_InvoicePriceVariance_Acct = table13.C_ValidCombination_ID) left join (select C_ValidCombination_ID, Combination from C_ValidCombination) table14 on (C_AcctSchema_Default.W_Inventory_Acct = table14.C_ValidCombination_ID) left join (select C_ValidCombination_ID, Combination from C_ValidCombination) table15 on (C_AcctSchema_Default.W_Differences_Acct = table15.C_ValidCombination_ID) left join (select C_ValidCombination_ID, Combination from C_ValidCombination) table16 on (C_AcctSchema_Default.W_Revaluation_Acct = table16.C_ValidCombination_ID) left join (select C_ValidCombination_ID, Combination from C_ValidCombination) table17 on (C_AcctSchema_Default.B_Asset_Acct = table17.C_ValidCombination_ID) left join (select C_ValidCombination_ID, Combination from C_ValidCombination) table18 on (C_AcctSchema_Default.B_InTransit_Acct = table18.C_ValidCombination_ID) left join (select C_ValidCombination_ID, Combination from C_ValidCombination) table19 on (C_AcctSchema_Default.B_PaymentSelect_Acct = table19.C_ValidCombination_ID) left join (select C_ValidCombination_ID, Combination from C_ValidCombination) table20 on (C_AcctSchema_Default.B_Expense_Acct = table20.C_ValidCombination_ID) left join (select C_ValidCombination_ID, Combination from C_ValidCombination) table21 on (C_AcctSchema_Default.B_RevaluationGain_Acct = table21.C_ValidCombination_ID) left join (select C_ValidCombination_ID, Combination from C_ValidCombination) table22 on (C_AcctSchema_Default.B_RevaluationLoss_Acct = table22.C_ValidCombination_ID) left join (select C_ValidCombination_ID, Combination from C_ValidCombination) table23 on (C_AcctSchema_Default.T_Due_Acct = table23.C_ValidCombination_ID) left join (select C_ValidCombination_ID, Combination from C_ValidCombination) table24 on (C_AcctSchema_Default.T_Credit_Acct = table24.C_ValidCombination_ID) left join (select C_ValidCombination_ID, Combination from C_ValidCombination) table25 on (C_AcctSchema_Default.Ch_Expense_Acct = table25.C_ValidCombination_ID) left join (select C_ValidCombination_ID, Combination from C_ValidCombination) table26 on (C_AcctSchema_Default.CB_Asset_Acct = table26.C_ValidCombination_ID) left join (select C_ValidCombination_ID, Combination from C_ValidCombination) table27 on (C_AcctSchema_Default.CB_Differences_Acct = table27.C_ValidCombination_ID) left join (select C_ValidCombination_ID, Combination from C_ValidCombination) table28 on (C_AcctSchema_Default.CB_CashTransfer_Acct = table28.C_ValidCombination_ID) left join (select C_ValidCombination_ID, Combination from C_ValidCombination) table29 on (C_AcctSchema_Default.CB_Expense_Acct = table29.C_ValidCombination_ID) left join (select C_ValidCombination_ID, Combination from C_ValidCombination) table30 on (C_AcctSchema_Default.CB_Receipt_Acct = table30.C_ValidCombination_ID) left join (select C_ValidCombination_ID, Combination from C_ValidCombination) table31 on (C_AcctSchema_Default.A_Depreciation_Acct = table31.C_ValidCombination_ID) left join (select C_ValidCombination_ID, Combination from C_ValidCombination) table32 on (C_AcctSchema_Default.A_Accumdepreciation_Acct = table32.C_ValidCombination_ID) left join (select C_ValidCombination_ID, Combination from C_ValidCombination) table33 on (C_AcctSchema_Default.PJ_Asset_Acct = table33.C_ValidCombination_ID) left join (select C_ValidCombination_ID, Combination from C_ValidCombination) table34 on (C_AcctSchema_Default.PJ_WIP_Acct = table34.C_ValidCombination_ID)" +
      "        WHERE 2=2 " +
      "        AND 1=1 ";
 ...
 */
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Client_ID, AD_Org_ID, C_Acctschema_Default_ID, C_AcctSchema_ID, C_Receivable_Acct, C_Prepayment_Acct, A_Disposal_Gain, PayDiscount_Exp_Acct, A_Disposal_Loss, WriteOff_Acct, AR_Discount_Acct, AP_Discount_Acct, NotInvoicedReceivables_Acct, NotInvoicedRevenue_Acct, UnEarnedRevenue_Acct, V_Liability_Acct, V_Liability_Services_Acct, V_Prepayment_Acct, PayDiscount_Rev_Acct, NotInvoicedReceipts_Acct, E_Prepayment_Acct, E_Expense_Acct, P_Asset_Acct, P_Expense_Acct, P_Revenue_Acct, P_Cogs_Acct, P_PurchasePriceVariance_Acct, P_InvoicePriceVariance_Acct, P_TradeDiscountRec_Acct, P_TradeDiscountGrant_Acct, W_Inventory_Acct, W_InvActualAdjust_Acct, W_Differences_Acct, W_Revaluation_Acct, B_Asset_Acct, B_InTransit_Acct, B_Unidentified_Acct, B_UnallocatedCash_Acct, B_PaymentSelect_Acct, B_Expense_Acct, B_InterestExp_Acct, B_InterestRev_Acct, B_RevaluationGain_Acct, B_RevaluationLoss_Acct, B_SettlementLoss_Acct, B_SettlementGain_Acct, T_Due_Acct, T_Liability_Acct, T_Credit_Acct, T_Receivables_Acct, T_Expense_Acct, Ch_Expense_Acct, Ch_Revenue_Acct, UnrealizedGain_Acct, UnrealizedLoss_Acct, RealizedGain_Acct, RealizedLoss_Acct, CB_Asset_Acct, CB_Differences_Acct, CB_CashTransfer_Acct, CB_Expense_Acct, CB_Receipt_Acct, A_Depreciation_Acct, A_Accumdepreciation_Acct, PJ_Asset_Acct, PJ_WIP_Acct, Withholding_Acct, Processing, IsActive, created, createdby, updated, updatedBy)" +
      "        VALUES ((?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), now(), ?, now(), ?)";
