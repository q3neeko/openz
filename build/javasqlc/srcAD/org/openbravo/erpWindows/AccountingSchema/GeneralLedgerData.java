 ...
 */
  public static GeneralLedgerData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String cAcctschemaId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN C_AcctSchema_GL.AD_Org_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS AD_Org_IDR, " +
      "C_AcctSchema_GL.C_Acctschema_Gl_ID, " +
      "C_AcctSchema_GL.C_AcctSchema_ID, " +
      "(CASE WHEN C_AcctSchema_GL.C_AcctSchema_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table2.Name), ''))),'') ) END) AS C_AcctSchema_IDR, " +
      ...
      "(CASE WHEN C_AcctSchema_GL.SuspenseBalancing_Acct IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table3.Combination), ''))),'') ) END) AS SuspenseBalancing_AcctR, " +
      "COALESCE(C_AcctSchema_GL.UseSuspenseError, 'N') AS UseSuspenseError, " +
      "C_AcctSchema_GL.SuspenseError_Acct, " +
      "(CASE WHEN C_AcctSchema_GL.SuspenseError_Acct IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table4.Combination), ''))),'') ) END) AS SuspenseError_AcctR, " +
      "COALESCE(C_AcctSchema_GL.UseCurrencyBalancing, 'N') AS UseCurrencyBalancing, " +
      "C_AcctSchema_GL.CurrencyBalancing_Acct, " +
      "(CASE WHEN C_AcctSchema_GL.CurrencyBalancing_Acct IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table5.Combination), ''))),'') ) END) AS CurrencyBalancing_AcctR, " +
      "C_AcctSchema_GL.RetainedEarning_Acct, " +
      "(CASE WHEN C_AcctSchema_GL.RetainedEarning_Acct IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table6.Combination), ''))),'') ) END) AS RetainedEarning_AcctR, " +
      "C_AcctSchema_GL.IncomeSummary_Acct, " +
      "(CASE WHEN C_AcctSchema_GL.IncomeSummary_Acct IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table7.Combination), ''))),'') ) END) AS IncomeSummary_AcctR, " +
      "C_AcctSchema_GL.IntercompanyDueFrom_Acct, " +
      "C_AcctSchema_GL.IntercompanyDueTo_Acct, " +
      "        ? AS LANGUAGE " +
      "        FROM C_AcctSchema_GL left join (select AD_Org_ID, Name from AD_Org) table1 on (C_AcctSchema_GL.AD_Org_ID = table1.AD_Org_ID) left join (select C_AcctSchema_ID, Name from C_AcctSchema) table2 on (C_AcctSchema_GL.C_AcctSchema_ID = table2.C_AcctSchema_ID) left join (select C_ValidCombination_ID, Combination from C_ValidCombination) table3 on (C_AcctSchema_GL.SuspenseBalancing_Acct = table3.C_ValidCombination_ID) left join (select C_ValidCombination_ID, Combination from C_ValidCombination) table4 on (C_AcctSchema_GL.SuspenseError_Acct = table4.C_ValidCombination_ID) left join (select C_ValidCombination_ID, Combination from C_ValidCombination) table5 on (C_AcctSchema_GL.CurrencyBalancing_Acct = table5.C_ValidCombination_ID) left join (select C_ValidCombination_ID, Combination from C_ValidCombination) table6 on (C_AcctSchema_GL.RetainedEarning_Acct = table6.C_ValidCombination_ID) left join (select C_ValidCombination_ID, Combination from C_ValidCombination) table7 on (C_AcctSchema_GL.IncomeSummary_Acct = table7.C_ValidCombination_ID)" +
      "        WHERE 2=2 " +
      "        AND 1=1 ";
