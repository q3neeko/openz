 ...
 */
  public static AccountSchemaElementData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String cAcctschemaId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN C_AcctSchema_Element.AD_Org_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS AD_Org_IDR, " +
      "C_AcctSchema_Element.C_AcctSchema_ID, " +
      "(CASE WHEN C_AcctSchema_Element.C_AcctSchema_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table2.Name), ''))),'') ) END) AS C_AcctSchema_IDR, " +
      ...
      "(CASE WHEN C_AcctSchema_Element.C_Element_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table3.Name), ''))),'') ) END) AS C_Element_IDR, " +
      "C_AcctSchema_Element.SeqNo, " +
      "C_AcctSchema_Element.Org_ID, " +
      "(CASE WHEN C_AcctSchema_Element.Org_ID IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table4.Name), ''))),'') ) END) AS Org_IDR, " +
      "C_AcctSchema_Element.M_Product_ID, " +
      "(CASE WHEN C_AcctSchema_Element.M_Product_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table5.Value), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL5.Name IS NULL THEN TO_CHAR(table5.Name) ELSE TO_CHAR(tableTRL5.Name) END)), ''))),'') ) END) AS M_Product_IDR, " +
      "C_AcctSchema_Element.C_BPartner_ID, " +
      "(CASE WHEN C_AcctSchema_Element.C_BPartner_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table6.Value), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table6.Name), ''))),'') ) END) AS C_BPartner_IDR, " +
      "C_AcctSchema_Element.C_Location_ID, " +
      "(CASE WHEN C_AcctSchema_Element.C_Location_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table7.Address1), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table7.Address2), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table7.Postal), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table7.City), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table8.Name), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL9.Name IS NULL THEN TO_CHAR(table9.Name) ELSE TO_CHAR(tableTRL9.Name) END)), ''))),'') ) END) AS C_Location_IDR, " +
      "C_AcctSchema_Element.C_SalesRegion_ID, " +
      "(CASE WHEN C_AcctSchema_Element.C_SalesRegion_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table10.Name), ''))),'') ) END) AS C_SalesRegion_IDR, " +
      "C_AcctSchema_Element.C_Project_ID, " +
      "(CASE WHEN C_AcctSchema_Element.C_Project_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table11.Value), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table11.Name), ''))),'') ) END) AS C_Project_IDR, " +
      "C_AcctSchema_Element.C_Campaign_ID, " +
      "(CASE WHEN C_AcctSchema_Element.C_Campaign_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table12.Name), ''))),'') ) END) AS C_Campaign_IDR, " +
      "C_AcctSchema_Element.C_Activity_ID, " +
      "(CASE WHEN C_AcctSchema_Element.C_Activity_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table13.Name), ''))),'') ) END) AS C_Activity_IDR, " +
      ...
      "        ? AS LANGUAGE " +
      "        FROM C_AcctSchema_Element left join (select AD_Org_ID, Name from AD_Org) table1 on (C_AcctSchema_Element.AD_Org_ID = table1.AD_Org_ID) left join (select C_AcctSchema_ID, Name from C_AcctSchema) table2 on (C_AcctSchema_Element.C_AcctSchema_ID = table2.C_AcctSchema_ID) left join ad_ref_list_v list1 on (C_AcctSchema_Element.ElementType = list1.value and list1.ad_reference_id = '181' and list1.ad_language = ?)  left join (select C_Element_ID, Name from C_Element) table3 on (C_AcctSchema_Element.C_Element_ID = table3.C_Element_ID) left join (select AD_Org_ID, value, Name from AD_Org) table4 on (C_AcctSchema_Element.Org_ID =  table4.AD_Org_ID) left join (select M_Product_ID, Value, Name from M_Product) table5 on (C_AcctSchema_Element.M_Product_ID = table5.M_Product_ID) left join (select M_Product_ID,AD_Language, Name from M_Product_TRL) tableTRL5 on (table5.M_Product_ID = tableTRL5.M_Product_ID and tableTRL5.AD_Language = ?)  left join (select C_BPartner_ID, Value, Name from C_BPartner) table6 on (C_AcctSchema_Element.C_BPartner_ID = table6.C_BPartner_ID) left join (select C_Location_ID, Address1, Address2, Postal, City, C_Region_ID, C_Country_ID from C_Location) table7 on (C_AcctSchema_Element.C_Location_ID = table7.C_Location_ID) left join (select C_Region_ID, Name from C_Region) table8 on (table7.C_Region_ID = table8.C_Region_ID) left join (select C_Country_ID, Name from C_Country) table9 on (table7.C_Country_ID = table9.C_Country_ID) left join (select C_Country_ID,AD_Language, Name from C_Country_TRL) tableTRL9 on (table9.C_Country_ID = tableTRL9.C_Country_ID and tableTRL9.AD_Language = ?)  left join (select C_SalesRegion_ID, Name from C_SalesRegion) table10 on (C_AcctSchema_Element.C_SalesRegion_ID = table10.C_SalesRegion_ID) left join (select C_Project_ID, Value, Name from C_Project) table11 on (C_AcctSchema_Element.C_Project_ID = table11.C_Project_ID) left join (select C_Campaign_ID, Name from C_Campaign) table12 on (C_AcctSchema_Element.C_Campaign_ID = table12.C_Campaign_ID) left join (select C_Activity_ID, Name from C_Activity) table13 on (C_AcctSchema_Element.C_Activity_ID = table13.C_Activity_ID)" +
      "        WHERE 2=2 " +
      "        AND 1=1 ";
...
Create a registry
 */
  public static AccountSchemaElementData[] set(String cAcctschemaId, String name, String seqno, String cCampaignId, String cBpartnerId, String cBpartnerIdr, String isbalanced, String cElementvalueId, String adOrgId, String orgId, String cLocationId, String cLocationIdr, String adClientId, String isactive, String mProductId, String mProductIdr, String cActivityId, String updatedby, String updatedbyr, String ismandatory, String cAcctschemaElementId, String createdby, String createdbyr, String elementtype, String cElementId, String cProjectId, String cSalesregionId)    throws ServletException {
