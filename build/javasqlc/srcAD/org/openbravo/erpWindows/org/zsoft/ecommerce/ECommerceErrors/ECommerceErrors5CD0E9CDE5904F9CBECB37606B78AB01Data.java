  ...
  public static ECommerceErrors5CD0E9CDE5904F9CBECB37606B78AB01Data[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectECommerceErrors5CD0E9CDE5904F9CBECB37606B78AB01Data.filename = UtilSql.getValue(result, "filename");
...
Create a registry
 */
  public static ECommerceErrors5CD0E9CDE5904F9CBECB37606B78AB01Data[] set(String zseShopordererrorId, String shopoderno, String zseShopId, String isactive, String adClientId, String externalid, String message, String filename, String updatedby, String updatedbyr, String createdby, String createdbyr, String adOrgId)    throws ServletException {
    ...
    objectECommerceErrors5CD0E9CDE5904F9CBECB37606B78AB01Data[0].filename = filename;
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET ZSE_Shop_ID = (?) , Shopoderno = (?) , Externalid = (?) , Message = (?) , Filename = (?) , Isactive = (?) , AD_Org_ID = (?) , ZSE_Shopordererror_ID = (?) , AD_Client_ID = (?) , updated = now(), updatedby = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (ZSE_Shop_ID, Shopoderno, Externalid, Message, Filename, Isactive, AD_Org_ID, ZSE_Shopordererror_ID, AD_Client_ID, created, createdby, updated, updatedBy)" +
      "        VALUES ((?), (?), (?), (?), (?), (?), (?), (?), (?), now(), ?, now(), ?)";
