  ...
  public static Transactions8508B665665C49A1ABA2A74BCFF23565Data[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String snrBatchmasterdataId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectTransactions8508B665665C49A1ABA2A74BCFF23565Data.snrBuiltinsnr = UtilSql.getValue(result, "snr_builtinsnr");
        objectTransactions8508B665665C49A1ABA2A74BCFF23565Data.snrBuiltinsnrr = UtilSql.getValue(result, "snr_builtinsnrr");
        objectTransactions8508B665665C49A1ABA2A74BCFF23565Data.pnamevaluesqlfield = UtilSql.getValue(result, "pnamevaluesqlfield");
 ...
 */
  public static Transactions8508B665665C49A1ABA2A74BCFF23565Data[] set(String snrBatchmasterdataId, String assemblyProductid, String assemblyProductidr, String mInoutlineId, String mInoutlineIdr, String snrSerialnumbertrackingId, String isactive, String cProjecttaskId, String mMovementId, String description, String quantity, String mInventorylineId, String movementdate, String mInternalConsumptionlineId, String adOrgId, String lotnumber, String guaranteedate, String mMovementlineId, String createdby, String createdbyr, String movementtype, String mInternalConsumptionId, String pnamevaluesqlfield, String assemblySnr, String updatedby, String updatedbyr, String mInventoryId, String guaranteedays, String mAttributesetinstanceId, String mAttributesetinstanceIdr, String cBpartnerId, String cBpartnerIdr, String mInoutId, String mInoutIdr, String snrBuiltinsnr, String adClientId, String rfidnumber, String docstatus, String serialnumber, String mLocatorId, String mLocatorIdr, String cProjectId, String cProjectIdr, String cOrderlineId, String cOrderlineIdr, String mProductId, String mProductIdr, String aAssetId)    throws ServletException {
    ...
    objectTransactions8508B665665C49A1ABA2A74BCFF23565Data[0].snrBuiltinsnr = snrBuiltinsnr;
    objectTransactions8508B665665C49A1ABA2A74BCFF23565Data[0].snrBuiltinsnrr = "";
    objectTransactions8508B665665C49A1ABA2A74BCFF23565Data[0].pnamevaluesqlfield = pnamevaluesqlfield;
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET Lotnumber = (?) , Quantity = TO_NUMBER(?) , Serialnumber = (?) , Movementdate = TO_DATE(?) , M_Product_ID = (?) , M_Attributesetinstance_ID = (?) , M_Locator_ID = (?) , C_Bpartner_ID = (?) , C_Orderline_ID = (?) , Movementtype = (?) , M_Movement_ID = (?) , M_Inventory_ID = (?) , M_Inout_ID = (?) , M_Internal_Consumption_ID = (?) , M_Inoutline_ID = (?) , M_Movementline_ID = (?) , M_Internal_Consumptionline_ID = (?) , M_Inventoryline_ID = (?) , C_Project_ID = (?) , C_Projecttask_ID = (?) , A_Asset_ID = (?) , Assembly_Productid = (?) , Assembly_Snr = (?) , AD_Org_ID = (?) , SNR_Builtinsnr = (?) , Pnamevaluesqlfield = (?) , AD_Client_ID = (?) , SNR_Batchmasterdata_ID = (?) , Isactive = (?) , Guaranteedays = TO_NUMBER(?) , Guaranteedate = TO_DATE(?) , Rfidnumber = (?) , Description = (?) , SNR_Serialnumbertracking_ID = (?) , Docstatus = (?) , updated = now(), updatedby = ? " +
      "        WHERE snr_serialnumbertracking.SNR_Serialnumbertracking_ID = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (Lotnumber, Quantity, Serialnumber, Movementdate, M_Product_ID, M_Attributesetinstance_ID, M_Locator_ID, C_Bpartner_ID, C_Orderline_ID, Movementtype, M_Movement_ID, M_Inventory_ID, M_Inout_ID, M_Internal_Consumption_ID, M_Inoutline_ID, M_Movementline_ID, M_Internal_Consumptionline_ID, M_Inventoryline_ID, C_Project_ID, C_Projecttask_ID, A_Asset_ID, Assembly_Productid, Assembly_Snr, AD_Org_ID, SNR_Builtinsnr, Pnamevaluesqlfield, AD_Client_ID, SNR_Batchmasterdata_ID, Isactive, Guaranteedays, Guaranteedate, Rfidnumber, Description, SNR_Serialnumbertracking_ID, Docstatus, created, createdby, updated, updatedBy)" +
