  ...
  public static ECommerceOrderStatusDF5C69631DFD4461927BBC06136369FEData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectECommerceOrderStatusDF5C69631DFD4461927BBC06136369FEData.filename = UtilSql.getValue(result, "filename");
        objectECommerceOrderStatusDF5C69631DFD4461927BBC06136369FEData.trackingno = UtilSql.getValue(result, "trackingno");
        ...
        objectECommerceOrderStatusDF5C69631DFD4461927BBC06136369FEData.datedelivered = UtilSql.getDateValue(result, "datedelivered", "dd-MM-yyyy");
        ...
        objectECommerceOrderStatusDF5C69631DFD4461927BBC06136369FEData.shipper = UtilSql.getValue(result, "shipper");
...
Create a registry
 */
  public static ECommerceOrderStatusDF5C69631DFD4461927BBC06136369FEData[] set(String zseShoporderstatusId, String createdby, String createdbyr, String externalid, String shipper, String updatedby, String updatedbyr, String adOrgId, String shopoderno, String isactive, String trackingno, String datedelivered, String message, String status, String zseShopId, String cOrderId, String filename, String issotrx, String adClientId)    throws ServletException {
    ...
    objectECommerceOrderStatusDF5C69631DFD4461927BBC06136369FEData[0].filename = filename;
    objectECommerceOrderStatusDF5C69631DFD4461927BBC06136369FEData[0].trackingno = trackingno;
    ...
    objectECommerceOrderStatusDF5C69631DFD4461927BBC06136369FEData[0].datedelivered = datedelivered;
    ...
    objectECommerceOrderStatusDF5C69631DFD4461927BBC06136369FEData[0].shipper = shipper;
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET ZSE_Shop_ID = (?) , Shopoderno = (?) , C_Order_ID = (?) , Status = (?) , Message = (?) , Externalid = (?) , Filename = (?) , Trackingno = (?) , AD_Client_ID = (?) , AD_Org_ID = (?) , Datedelivered = TO_DATE(?) , Issotrx = (?) , Isactive = (?) , ZSE_Shoporderstatus_ID = (?) , Shipper = (?) , updated = now(), updatedby = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (ZSE_Shop_ID, Shopoderno, C_Order_ID, Status, Message, Externalid, Filename, Trackingno, AD_Client_ID, AD_Org_ID, Datedelivered, Issotrx, Isactive, ZSE_Shoporderstatus_ID, Shipper, created, createdby, updated, updatedBy)" +
