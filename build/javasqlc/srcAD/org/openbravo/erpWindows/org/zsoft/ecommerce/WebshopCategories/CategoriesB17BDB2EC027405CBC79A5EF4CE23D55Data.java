 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET AD_Org_ID = (?) , ZSE_Shop_ID = (?) , Isactive = (?) , Commonname = (?) , Title = (?) , Fulltitle = (?) , Description = (?) , Content = (?) , Typ = (?) , Sortorder = TO_NUMBER(?) , Externalid = (?) , Url = (?) , AD_Client_ID = (?) , ZSE_Webshopcategory_ID = (?) , updated = now(), updatedby = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Org_ID, ZSE_Shop_ID, Isactive, Commonname, Title, Fulltitle, Description, Content, Typ, Sortorder, Externalid, Url, AD_Client_ID, ZSE_Webshopcategory_ID, created, createdby, updated, updatedBy)" +
