 ...
 */
  public static MasterDataGrid220A904B66524B17B1C20FC5A238CD65Data[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN juwimm_orderstatuscomplete_v.AD_Org_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS AD_Org_IDR, " +
      ...
      "(CASE WHEN juwimm_orderstatuscomplete_v.C_DocTypeTarget_ID IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL2.Name IS NULL THEN TO_CHAR(table2.Name) ELSE TO_CHAR(tableTRL2.Name) END)), ''))),'') ) END) AS C_DocTypeTarget_IDR, " +
      "juwimm_orderstatuscomplete_v.Name, " +
      "juwimm_orderstatuscomplete_v.C_DocType_ID, " +
      "(CASE WHEN juwimm_orderstatuscomplete_v.C_DocType_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL3.Name IS NULL THEN TO_CHAR(table3.Name) ELSE TO_CHAR(tableTRL3.Name) END)), ''))),'') ) END) AS C_DocType_IDR, " +
      ...
      "(CASE WHEN juwimm_orderstatuscomplete_v.C_BPartner_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table4.Value), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table4.Name), ''))),'') ) END) AS C_BPartner_IDR, " +
      "juwimm_orderstatuscomplete_v.bpzipcode, " +
      "juwimm_orderstatuscomplete_v.BillTo_ID, " +
      "(CASE WHEN juwimm_orderstatuscomplete_v.BillTo_ID IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table5.Name), ''))),'') ) END) AS BillTo_IDR, " +
      "juwimm_orderstatuscomplete_v.C_BPartner_Location_ID, " +
      "(CASE WHEN juwimm_orderstatuscomplete_v.C_BPartner_Location_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table6.Name), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table6.Deviant_Bp_Name), ''))),'') ) END) AS C_BPartner_Location_IDR, " +
      "juwimm_orderstatuscomplete_v.AD_User_ID, " +
      "(CASE WHEN juwimm_orderstatuscomplete_v.AD_User_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table7.Name), ''))),'') ) END) AS AD_User_IDR, " +
      "juwimm_orderstatuscomplete_v.SalesRep_ID, " +
      "(CASE WHEN juwimm_orderstatuscomplete_v.SalesRep_ID IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table8.Name), ''))),'') ) END) AS SalesRep_IDR, " +
      "juwimm_orderstatuscomplete_v.M_PriceList_ID, " +
      "(CASE WHEN juwimm_orderstatuscomplete_v.M_PriceList_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table9.Name), ''))),'') ) END) AS M_PriceList_IDR, " +
      ...
      "(CASE WHEN juwimm_orderstatuscomplete_v.M_Warehouse_ID IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table10.Name), ''))),'') ) END) AS M_Warehouse_IDR, " +
      "juwimm_orderstatuscomplete_v.C_Currency_ID, " +
      "(CASE WHEN juwimm_orderstatuscomplete_v.C_Currency_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table11.ISO_Code), ''))),'') ) END) AS C_Currency_IDR, " +
      ...
      "(CASE WHEN juwimm_orderstatuscomplete_v.C_PaymentTerm_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL12.Name IS NULL THEN TO_CHAR(table12.Name) ELSE TO_CHAR(tableTRL12.Name) END)), ''))),'') ) END) AS C_PaymentTerm_IDR, " +
      "juwimm_orderstatuscomplete_v.C_Incoterms_ID, " +
      "(CASE WHEN juwimm_orderstatuscomplete_v.C_Incoterms_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table13.Name), ''))),'') ) END) AS C_Incoterms_IDR, " +
      "juwimm_orderstatuscomplete_v.Delivery_Location_ID, " +
      "(CASE WHEN juwimm_orderstatuscomplete_v.Delivery_Location_ID IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table14.Name), ''))),'') ) END) AS Delivery_Location_IDR, " +
      ...
      "(CASE WHEN juwimm_orderstatuscomplete_v.M_Shipper_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table15.Name), ''))),'') ) END) AS M_Shipper_IDR, " +
      "juwimm_orderstatuscomplete_v.Weight, " +
      "juwimm_orderstatuscomplete_v.Weight_Uom, " +
      "(CASE WHEN juwimm_orderstatuscomplete_v.Weight_Uom IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL16.Name IS NULL THEN TO_CHAR(table16.Name) ELSE TO_CHAR(tableTRL16.Name) END)), ''))),'') ) END) AS Weight_UomR, " +
      ...
      "(CASE WHEN juwimm_orderstatuscomplete_v.M_Product_ID IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL17.Name IS NULL THEN TO_CHAR(table17.Name) ELSE TO_CHAR(tableTRL17.Name) END)), ''))),'') ) END) AS M_Product_IDR, " +
      "juwimm_orderstatuscomplete_v.Qty, " +
      "juwimm_orderstatuscomplete_v.FreightAmt, " +
      "juwimm_orderstatuscomplete_v.C_Project_ID, " +
      "(CASE WHEN juwimm_orderstatuscomplete_v.C_Project_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table18.Value), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table18.Name), ''))),'') ) END) AS C_Project_IDR, " +
      "juwimm_orderstatuscomplete_v.C_Projecttask_ID, " +
      "(CASE WHEN juwimm_orderstatuscomplete_v.C_Projecttask_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table20.Value), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table20.Name), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table19.Name), ''))),'') ) END) AS C_Projecttask_IDR, " +
      "juwimm_orderstatuscomplete_v.Orderselfjoin, " +
      "(CASE WHEN juwimm_orderstatuscomplete_v.Orderselfjoin IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table21.DocumentNo), ''))),'') ) END) AS OrderselfjoinR, " +
      ...
      "(CASE WHEN juwimm_orderstatuscomplete_v.Juwimm_Team_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL22.Name IS NULL THEN TO_CHAR(table22.Name) ELSE TO_CHAR(tableTRL22.Name) END)), ''))),'') ) END) AS Juwimm_Team_IDR, " +
      ...
      "(CASE WHEN juwimm_orderstatuscomplete_v.Juwimm_Lastupdateby IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table23.Name), ''))),'') ) END) AS Juwimm_LastupdatebyR, " +
