...
static Logger log4j = Logger.getLogger(SerialNumberTransactions8607F359EB8641AF8737E2F1473EC432Data.class);
  ...
  public String pnamevaluesqlfield;
  ...
  public String getField(String fieldName) {
    ...
    else if (fieldName.equalsIgnoreCase("pnamevaluesqlfield"))
      return pnamevaluesqlfield;
 ...
 */
  public static SerialNumberTransactions8607F359EB8641AF8737E2F1473EC432Data[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "snr_serialnumbertracking.SNR_Builtinsnr, " +
      "(CASE WHEN snr_serialnumbertracking.SNR_Builtinsnr IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table27.Serialnumber), ''))),'') ) END) AS SNR_BuiltinsnrR, " +
      "COALESCE(snr_serialnumbertracking.Pnamevaluesqlfield, 'N') AS Pnamevaluesqlfield, " +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectSerialNumberTransactions8607F359EB8641AF8737E2F1473EC432Data.snrBuiltinsnr = UtilSql.getValue(result, "snr_builtinsnr");
        objectSerialNumberTransactions8607F359EB8641AF8737E2F1473EC432Data.snrBuiltinsnrr = UtilSql.getValue(result, "snr_builtinsnrr");
        objectSerialNumberTransactions8607F359EB8641AF8737E2F1473EC432Data.pnamevaluesqlfield = UtilSql.getValue(result, "pnamevaluesqlfield");
 ...
 */
  public static SerialNumberTransactions8607F359EB8641AF8737E2F1473EC432Data[] set(String mInoutlineId, String mInoutlineIdr, String assemblyProductid, String assemblyProductidr, String mMovementId, String cProjecttaskId, String snrSerialnumbertrackingId, String isactive, String description, String mInventorylineId, String quantity, String movementdate, String mInternalConsumptionlineId, String adOrgId, String guaranteedate, String lotnumber, String mMovementlineId, String createdby, String createdbyr, String movementtype, String mInternalConsumptionId, String pnamevaluesqlfield, String assemblySnr, String updatedby, String updatedbyr, String mInventoryId, String guaranteedays, String mAttributesetinstanceId, String mAttributesetinstanceIdr, String mInoutId, String mInoutIdr, String cBpartnerId, String cBpartnerIdr, String snrBuiltinsnr, String adClientId, String rfidnumber, String docstatus, String serialnumber, String mLocatorId, String mLocatorIdr, String cProjectId, String cProjectIdr, String cOrderlineId, String cOrderlineIdr, String mProductId, String mProductIdr, String aAssetId)    throws ServletException {
    ...
    objectSerialNumberTransactions8607F359EB8641AF8737E2F1473EC432Data[0].snrBuiltinsnr = snrBuiltinsnr;
    objectSerialNumberTransactions8607F359EB8641AF8737E2F1473EC432Data[0].snrBuiltinsnrr = "";
    objectSerialNumberTransactions8607F359EB8641AF8737E2F1473EC432Data[0].pnamevaluesqlfield = pnamevaluesqlfield;
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET Serialnumber = (?) , Movementdate = TO_DATE(?) , M_Product_ID = (?) , M_Attributesetinstance_ID = (?) , M_Locator_ID = (?) , C_Bpartner_ID = (?) , C_Orderline_ID = (?) , Movementtype = (?) , M_Movement_ID = (?) , M_Inventory_ID = (?) , M_Inout_ID = (?) , M_Internal_Consumption_ID = (?) , M_Inoutline_ID = (?) , M_Movementline_ID = (?) , M_Internal_Consumptionline_ID = (?) , M_Inventoryline_ID = (?) , C_Project_ID = (?) , C_Projecttask_ID = (?) , A_Asset_ID = (?) , Assembly_Productid = (?) , Assembly_Snr = (?) , AD_Org_ID = (?) , Lotnumber = (?) , Quantity = TO_NUMBER(?) , SNR_Builtinsnr = (?) , Pnamevaluesqlfield = (?) , Description = (?) , Docstatus = (?) , Guaranteedate = TO_DATE(?) , SNR_Serialnumbertracking_ID = (?) , AD_Client_ID = (?) , Guaranteedays = TO_NUMBER(?) , Rfidnumber = (?) , Isactive = (?) , updated = now(), updatedby = ? " +
    ...
    st = connectionProvider.getPreparedStatement(conn, strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, pnamevaluesqlfield);
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (Serialnumber, Movementdate, M_Product_ID, M_Attributesetinstance_ID, M_Locator_ID, C_Bpartner_ID, C_Orderline_ID, Movementtype, M_Movement_ID, M_Inventory_ID, M_Inout_ID, M_Internal_Consumption_ID, M_Inoutline_ID, M_Movementline_ID, M_Internal_Consumptionline_ID, M_Inventoryline_ID, C_Project_ID, C_Projecttask_ID, A_Asset_ID, Assembly_Productid, Assembly_Snr, AD_Org_ID, Lotnumber, Quantity, SNR_Builtinsnr, Pnamevaluesqlfield, Description, Docstatus, Guaranteedate, SNR_Serialnumbertracking_ID, AD_Client_ID, Guaranteedays, Rfidnumber, Isactive, created, createdby, updated, updatedBy)" +
