 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET ZSE_Shop_ID = (?) , Item = (?) , Qty = TO_NUMBER(?) , Executionstatus = (?) , Seqno = TO_NUMBER(?) , ZSE_Shopimportlog_ID = (?) , AD_Client_ID = (?) , AD_Org_ID = (?) , Isactive = (?) , updated = now(), updatedby = ? " +
      "        WHERE zse_shopimportlog.ZSE_Shopimportlog_ID = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (ZSE_Shop_ID, Item, Qty, Executionstatus, Seqno, ZSE_Shopimportlog_ID, AD_Client_ID, AD_Org_ID, Isactive, created, createdby, updated, updatedBy)" +
