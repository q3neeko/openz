  ...
  public static TransactionsAC6CD6D45C584FBDAECBF46A03701D8FData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String snrMasterdataId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectTransactionsAC6CD6D45C584FBDAECBF46A03701D8FData.snrBuiltinsnr = UtilSql.getValue(result, "snr_builtinsnr");
        objectTransactionsAC6CD6D45C584FBDAECBF46A03701D8FData.snrBuiltinsnrr = UtilSql.getValue(result, "snr_builtinsnrr");
        objectTransactionsAC6CD6D45C584FBDAECBF46A03701D8FData.pnamevaluesqlfield = UtilSql.getValue(result, "pnamevaluesqlfield");
 ...
 */
  public static TransactionsAC6CD6D45C584FBDAECBF46A03701D8FData[] set(String snrMasterdataId, String assemblyProductid, String assemblyProductidr, String mInoutlineId, String mInoutlineIdr, String isactive, String mMovementId, String snrSerialnumbertrackingId, String cProjecttaskId, String description, String quantity, String mInventorylineId, String movementdate, String mInternalConsumptionlineId, String adOrgId, String lotnumber, String guaranteedate, String mMovementlineId, String createdby, String createdbyr, String movementtype, String mInternalConsumptionId, String pnamevaluesqlfield, String assemblySnr, String updatedby, String updatedbyr, String mInventoryId, String guaranteedays, String mAttributesetinstanceId, String mAttributesetinstanceIdr, String mInoutId, String mInoutIdr, String cBpartnerId, String cBpartnerIdr, String snrBuiltinsnr, String adClientId, String rfidnumber, String docstatus, String mLocatorId, String mLocatorIdr, String serialnumber, String cProjectId, String cProjectIdr, String cOrderlineId, String cOrderlineIdr, String aAssetId, String mProductId, String mProductIdr)    throws ServletException {
    ...
    objectTransactionsAC6CD6D45C584FBDAECBF46A03701D8FData[0].snrBuiltinsnr = snrBuiltinsnr;
    objectTransactionsAC6CD6D45C584FBDAECBF46A03701D8FData[0].snrBuiltinsnrr = "";
    objectTransactionsAC6CD6D45C584FBDAECBF46A03701D8FData[0].pnamevaluesqlfield = pnamevaluesqlfield;
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET Serialnumber = (?) , Movementdate = TO_DATE(?) , M_Product_ID = (?) , M_Attributesetinstance_ID = (?) , M_Locator_ID = (?) , C_Bpartner_ID = (?) , C_Orderline_ID = (?) , Movementtype = (?) , M_Movement_ID = (?) , M_Inventory_ID = (?) , M_Inout_ID = (?) , M_Internal_Consumption_ID = (?) , M_Inoutline_ID = (?) , M_Movementline_ID = (?) , M_Internal_Consumptionline_ID = (?) , M_Inventoryline_ID = (?) , C_Project_ID = (?) , C_Projecttask_ID = (?) , A_Asset_ID = (?) , Assembly_Productid = (?) , Assembly_Snr = (?) , AD_Org_ID = (?) , Lotnumber = (?) , Quantity = TO_NUMBER(?) , SNR_Builtinsnr = (?) , Pnamevaluesqlfield = (?) , Rfidnumber = (?) , Isactive = (?) , SNR_Masterdata_ID = (?) , Guaranteedate = TO_DATE(?) , SNR_Serialnumbertracking_ID = (?) , Description = (?) , Docstatus = (?) , AD_Client_ID = (?) , Guaranteedays = TO_NUMBER(?) , updated = now(), updatedby = ? " +
      "        WHERE snr_serialnumbertracking.SNR_Serialnumbertracking_ID = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (Serialnumber, Movementdate, M_Product_ID, M_Attributesetinstance_ID, M_Locator_ID, C_Bpartner_ID, C_Orderline_ID, Movementtype, M_Movement_ID, M_Inventory_ID, M_Inout_ID, M_Internal_Consumption_ID, M_Inoutline_ID, M_Movementline_ID, M_Internal_Consumptionline_ID, M_Inventoryline_ID, C_Project_ID, C_Projecttask_ID, A_Asset_ID, Assembly_Productid, Assembly_Snr, AD_Org_ID, Lotnumber, Quantity, SNR_Builtinsnr, Pnamevaluesqlfield, Rfidnumber, Isactive, SNR_Masterdata_ID, Guaranteedate, SNR_Serialnumbertracking_ID, Description, Docstatus, AD_Client_ID, Guaranteedays, created, createdby, updated, updatedBy)" +
