...
Create a registry
 */
  public static BuiltinSerialsandBatches1849F6E0F2AF4E4D8715FEA00C2818B7Data[] set(String snrCurrentbomVId, String snrMasterdataId, String snrBatchmasterdataId, String adClientId, String qty, String updatedby, String updatedbyr, String adOrgId, String isactive, String snrCurrentbomSerialsId, String createdby, String createdbyr)    throws ServletException {
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET SNR_Currentbom_V_ID = (?) , SNR_Masterdata_ID = (?) , SNR_Batchmasterdata_ID = (?) , Qty = TO_NUMBER(?) , AD_Client_ID = (?) , AD_Org_ID = (?) , SNR_Currentbom_Serials_ID = (?) , Isactive = (?) , updated = now(), updatedby = ? " +
      "        WHERE snr_currentbom_serials.SNR_Currentbom_Serials_ID = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (SNR_Currentbom_V_ID, SNR_Masterdata_ID, SNR_Batchmasterdata_ID, Qty, AD_Client_ID, AD_Org_ID, SNR_Currentbom_Serials_ID, Isactive, created, createdby, updated, updatedBy)" +
