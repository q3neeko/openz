 ...
 */
  public static Teams8475B02A872E45B485B5FFB4EA912D1DData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN juwimm_team.AD_Org_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS AD_Org_IDR, " +
      "juwimm_team.Name, " +
      "juwimm_team.Description, " +
      "COALESCE(juwimm_team.Isactive, 'N') AS Isactive, " +
      "        ? AS LANGUAGE " +
      "        FROM juwimm_team left join (select AD_Org_ID, Name from AD_Org) table1 on (juwimm_team.AD_Org_ID = table1.AD_Org_ID)" +
      "        WHERE 2=2 " +
      "        AND 1=1 " +
...
Create a registry
 */
  public static Teams8475B02A872E45B485B5FFB4EA912D1DData[] set(String adClientId, String name, String juwimmTeamId, String description, String createdby, String createdbyr, String updatedby, String updatedbyr, String adOrgId, String isactive)    throws ServletException {
