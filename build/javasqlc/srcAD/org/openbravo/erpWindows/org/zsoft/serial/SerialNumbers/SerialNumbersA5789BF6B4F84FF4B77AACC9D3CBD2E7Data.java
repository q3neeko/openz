...
static Logger log4j = Logger.getLogger(SerialNumbersA5789BF6B4F84FF4B77AACC9D3CBD2E7Data.class);
  ...
  public String responsibleUserIdr;
  ...
  public String stashedIdentifier;
  ...
  public String getField(String fieldName) {
    if (fieldName.equalsIgnoreCase("created"))
      ...
      return adUserIdr;
    else if (fieldName.equalsIgnoreCase("responsible_user_id") || fieldName.equals("responsibleUserId"))
      return responsibleUserId;
    else if (fieldName.equalsIgnoreCase("responsible_user_idr") || fieldName.equals("responsibleUserIdr"))
      return responsibleUserIdr;
      ...
      return itemname;
    else if (fieldName.equalsIgnoreCase("stashed_identifier") || fieldName.equals("stashedIdentifier"))
      return stashedIdentifier;
 ...
 */
  public static SerialNumbersA5789BF6B4F84FF4B77AACC9D3CBD2E7Data[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN SNR_Masterdata.C_Projecttask_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table6.Value), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table6.Name), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table5.Name), ''))),'') ) END) AS C_Projecttask_IDR, " +
      "SNR_Masterdata.C_Bpartner_ID, " +
      "(CASE WHEN SNR_Masterdata.C_Bpartner_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table7.Value), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table7.Name), ''))),'') ) END) AS C_Bpartner_IDR, " +
      "SNR_Masterdata.C_Bpartner_Location_ID, " +
      "(CASE WHEN SNR_Masterdata.C_Bpartner_Location_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table8.Name), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table8.Deviant_Bp_Name), ''))),'') ) END) AS C_Bpartner_Location_IDR, " +
      ...
      "SNR_Masterdata.Responsible_User_ID, " +
      "(CASE WHEN SNR_Masterdata.Responsible_User_ID IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table20.Name), ''))),'') ) END) AS Responsible_User_IDR, " +
      "SNR_Masterdata.Sendmail, " +
      "SNR_Masterdata.Snrselfjoin, " +
      "(CASE WHEN SNR_Masterdata.Snrselfjoin IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table21.name), ''))),'') ) END) AS SnrselfjoinR, " +
      ...
      "SNR_Masterdata.Stashed_Identifier, " +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectSerialNumbersA5789BF6B4F84FF4B77AACC9D3CBD2E7Data.responsibleUserId = UtilSql.getValue(result, "responsible_user_id");
        objectSerialNumbersA5789BF6B4F84FF4B77AACC9D3CBD2E7Data.responsibleUserIdr = UtilSql.getValue(result, "responsible_user_idr");
        ...
        objectSerialNumbersA5789BF6B4F84FF4B77AACC9D3CBD2E7Data.stashedIdentifier = UtilSql.getValue(result, "stashed_identifier");
 ...
 */
  public static SerialNumbersA5789BF6B4F84FF4B77AACC9D3CBD2E7Data[] set(String cBpartnerLocationId, String snrMasterdataId, String responsibleUserId, String snrBatchmasterdataId, String createdby, String createdbyr, String description, String firstseen, String movementdate, String identifier3, String model, String sendmail, String mInoutlineId, String snrselfjoin, String location, String adOrgId, String mMovementlineId, String mInternalConsumptionlineId, String remark, String vendor, String orderreference, String adClientId, String adUserId, String externaltrackingno, String identifier2, String mLocatorId, String mLocatorIdr, String serialnumber, String mInventorylineId, String mProductId, String mProductIdr, String itemname, String movementtype, String cBpartnerId, String cBpartnerIdr, String guaranteedate, String isactive, String cProjecttaskId, String updatedby, String updatedbyr, String stashedIdentifier)    throws ServletException {
    ...
    objectSerialNumbersA5789BF6B4F84FF4B77AACC9D3CBD2E7Data[0].responsibleUserId = responsibleUserId;
    objectSerialNumbersA5789BF6B4F84FF4B77AACC9D3CBD2E7Data[0].responsibleUserIdr = "";
    ...
    objectSerialNumbersA5789BF6B4F84FF4B77AACC9D3CBD2E7Data[0].stashedIdentifier = stashedIdentifier;
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET AD_Org_ID = (?) , M_Product_ID = (?) , Serialnumber = (?) , Firstseen = TO_DATE(?) , SNR_Batchmasterdata_ID = (?) , Movementdate = TO_DATE(?) , Movementtype = (?) , M_Locator_ID = (?) , C_Projecttask_ID = (?) , C_Bpartner_ID = (?) , C_Bpartner_Location_ID = (?) , m_inoutline_id = (?) , m_inventoryline_id = (?) , m_internal_consumptionline_id = (?) , m_movementline_id = (?) , AD_User_ID = (?) , Responsible_User_ID = (?) , Sendmail = (?) , Snrselfjoin = (?) , Description = (?) , Guaranteedate = TO_DATE(?) , Model = (?) , Orderreference = (?) , Identifier2 = (?) , Vendor = (?) , Externaltrackingno = (?) , Identifier3 = (?) , Remark = (?) , Itemname = (?) , Stashed_Identifier = (?) , Location = (?) , Isactive = (?) , AD_Client_ID = (?) , SNR_Masterdata_ID = (?) , updated = now(), updatedby = ? " +
    ...
    st = connectionProvider.getPreparedStatement(conn, strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, responsibleUserId);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, stashedIdentifier);
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Org_ID, M_Product_ID, Serialnumber, Firstseen, SNR_Batchmasterdata_ID, Movementdate, Movementtype, M_Locator_ID, C_Projecttask_ID, C_Bpartner_ID, C_Bpartner_Location_ID, m_inoutline_id, m_inventoryline_id, m_internal_consumptionline_id, m_movementline_id, AD_User_ID, Responsible_User_ID, Sendmail, Snrselfjoin, Description, Guaranteedate, Model, Orderreference, Identifier2, Vendor, Externaltrackingno, Identifier3, Remark, Itemname, Stashed_Identifier, Location, Isactive, AD_Client_ID, SNR_Masterdata_ID, created, createdby, updated, updatedBy)" +
