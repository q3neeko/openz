...
static Logger log4j = Logger.getLogger(BulkOperations38C4689355774313A03DF4EB7A0E22F3Data.class);
  ...
  public String getField(String fieldName) {
    ...
    else if (fieldName.equalsIgnoreCase("minstockshown"))
      return minstockshown;
  ...
  public static BulkOperations38C4689355774313A03DF4EB7A0E22F3Data[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String zseProductShopId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectBulkOperations38C4689355774313A03DF4EB7A0E22F3Data.minstockshown = UtilSql.getValue(result, "minstockshown");
 ...
 */
  public static BulkOperations38C4689355774313A03DF4EB7A0E22F3Data[] set(String zseProductShopId, String createdby, String createdbyr, String externalid, String ismaster, String eccategory, String deliverytimePromised, String content, String adOrgId, String allworderonnostock, String updatedby, String updatedbyr, String isactive, String description, String ecpriority, String externalid2, String hideonnostock, String minorderqty, String fulltitle, String maxorderqty, String minstockshown, String adClientId, String zseShopId, String isorderable, String title, String mProductId, String maxstockshown)    throws ServletException {
    ...
    objectBulkOperations38C4689355774313A03DF4EB7A0E22F3Data[0].minstockshown = minstockshown;
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET Content = (?) , Ismaster = (?) , M_Product_ID = (?) , ZSE_Shop_ID = (?) , Isorderable = (?) , Hideonnostock = (?) , Allworderonnostock = (?) , Maxorderqty = TO_NUMBER(?) , Minorderqty = TO_NUMBER(?) , Maxstockshown = TO_NUMBER(?) , Minstockshown = TO_NUMBER(?) , Title = (?) , Fulltitle = (?) , Description = (?) , Externalid = (?) , AD_Org_ID = (?) , Deliverytime_Promised = TO_NUMBER(?) , ZSE_Product_Shop_ID = (?) , Ecpriority = TO_NUMBER(?) , Externalid2 = (?) , Eccategory = (?) , Isactive = (?) , AD_Client_ID = (?) , updated = now(), updatedby = ? " +
      "        WHERE zse_product_shop.ZSE_Product_Shop_ID = ? " +
      "                 AND zse_product_shop.ZSE_Product_Shop_ID = ? " +
      "        AND zse_product_shop.AD_Client_ID IN (";
    strSql = strSql + ((adUserClient==null || adUserClient.equals(""))?"":adUserClient);
    ...
    st = connectionProvider.getPreparedStatement(conn, strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, minstockshown);
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (Content, Ismaster, M_Product_ID, ZSE_Shop_ID, Isorderable, Hideonnostock, Allworderonnostock, Maxorderqty, Minorderqty, Maxstockshown, Minstockshown, Title, Fulltitle, Description, Externalid, AD_Org_ID, Deliverytime_Promised, ZSE_Product_Shop_ID, Ecpriority, Externalid2, Eccategory, Isactive, AD_Client_ID, created, createdby, updated, updatedBy)" +
