 ...
 */
  public static Receipt62314289EB0A4FFBA4ACDB985018C68BData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN ils_inoutpackage_v.partner IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table7.Value), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table7.Name), ''))),'') ) END) AS partnerR, " +
      "ils_inoutpackage_v.Description, " +
      "ils_inoutpackage_v.Shipmentcontent, " +
      "ils_inoutpackage_v.Sigmano, " +
      "ils_inoutpackage_v.orderreference, " +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectReceipt62314289EB0A4FFBA4ACDB985018C68BData.orderreference = UtilSql.getValue(result, "orderreference");
 ...
 */
  public static Receipt62314289EB0A4FFBA4ACDB985018C68BData[] set(String movementqty, String shipmentcontent, String cOrderId, String updatedby, String updatedbyr, String adClientId, String cUomId, String issotrx, String mProductId, String mProductIdr, String processed, String adOrgId, String mInoutlineId, String docstatus, String cDoctypeId, String processing, String cProjectId, String aAssetId, String employee, String description, String cOrderlineId, String directmail, String documentno, String serialnumber, String isactive, String ilsInoutpackageVId, String docaction, String docactionBtn, String snremployee, String movementtype, String cProjecttaskId, String mInoutId, String mLocatorId, String mShipperId, String sigmano, String isinvoiced, String partner, String partnerr, String islogistic, String createdby, String createdbyr, String processbutton, String mWarehouseId, String orderreference, String adUserId, String movementdate)    throws ServletException {
    ...
    objectReceipt62314289EB0A4FFBA4ACDB985018C68BData[0].orderreference = orderreference;
 ...
 */
  public static String selectDefFB1B36D4EAAE4DE798EC6CA54884BC40_2(ConnectionProvider connectionProvider, String partnerR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        SELECT  ( COALESCE(TO_CHAR(table1.Value), '')  || ' - ' || COALESCE(TO_CHAR(table1.Name), '') ) as partner FROM C_BPartner table1 WHERE table1.isActive='Y' AND table1.C_BPartner_ID = ?  ";
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      "        UPDATE ils_inoutpackage_v" +
      "        SET DocumentNo = (?) , Docstatus = (?) , Serialnumber = (?) , Employee = (?) , AD_User_ID = (?) , Movementdate = TO_DATE(?) , M_Shipper_ID = (?) , M_Warehouse_ID = (?) , M_Locator_ID = (?) , M_Product_ID = (?) , C_Uom_ID = (?) , Movementqty = TO_NUMBER(?) , partner = (?) , Description = (?) , Shipmentcontent = (?) , Sigmano = (?) , orderreference = (?) , Directmail = (?) , Snremployee = (?) , Movementtype = (?) , C_Doctype_ID = (?) , DocAction = (?) , Processbutton = (?) , Islogistic = (?) , ILS_Inoutpackage_V_ID = (?) , Processed = (?) , M_Inoutline_ID = (?) , M_Inout_ID = (?) , Issotrx = (?) , C_Project_ID = (?) , Processing = (?) , AD_Client_ID = (?) , C_Order_ID = (?) , A_Asset_ID = (?) , Isinvoiced = (?) , C_Orderline_ID = (?) , C_Projecttask_ID = (?) , AD_Org_ID = (?) , Isactive = (?) , updated = now(), updatedby = ? " +
      "        WHERE ils_inoutpackage_v.ILS_Inoutpackage_V_ID = ? " +
      "        AND ils_inoutpackage_v.AD_Client_ID IN (";
    strSql = strSql + ((adUserClient==null || adUserClient.equals(""))?"":adUserClient);
    strSql = strSql + 
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (DocumentNo, Docstatus, Serialnumber, Employee, AD_User_ID, Movementdate, M_Shipper_ID, M_Warehouse_ID, M_Locator_ID, M_Product_ID, C_Uom_ID, Movementqty, partner, Description, Shipmentcontent, Sigmano, orderreference, Directmail, Snremployee, Movementtype, C_Doctype_ID, DocAction, Processbutton, Islogistic, ILS_Inoutpackage_V_ID, Processed, M_Inoutline_ID, M_Inout_ID, Issotrx, C_Project_ID, Processing, AD_Client_ID, C_Order_ID, A_Asset_ID, Isinvoiced, C_Orderline_ID, C_Projecttask_ID, AD_Org_ID, Isactive, created, createdby, updated, updatedBy)" +
