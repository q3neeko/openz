...
static Logger log4j = Logger.getLogger(CommissionLines5955A8396FF74D51A602033C9EB64E9AData.class);
  ...
  public String highlevelcategory;
  ...
  public String getField(String fieldName) {
    if (fieldName.equalsIgnoreCase("created"))
      ...
      return isactive;
    else if (fieldName.equalsIgnoreCase("highlevelcategory"))
 ...
 */
  public static CommissionLines5955A8396FF74D51A602033C9EB64E9AData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String cCommissionId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "C_CommissionLine.Highlevelcategory, " +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectCommissionLines5955A8396FF74D51A602033C9EB64E9AData.highlevelcategory = UtilSql.getValue(result, "highlevelcategory");
...
Create a registry
 */
  public static CommissionLines5955A8396FF74D51A602033C9EB64E9AData[] set(String cCommissionId, String adOrgId, String updatedby, String updatedbyr, String convertedturnover, String isshareofturnover, String isactive, String line, String cCommissionlineId, String qtysubtract, String ispositiveonly, String commissionorders, String qtymultiplier, String amtmultiplier, String description, String adClientId, String mProductCategoryId, String amtsubtract, String salesvolumefrom, String createdby, String createdbyr, String highlevelcategory)    throws ServletException {
    ...
    objectCommissionLines5955A8396FF74D51A602033C9EB64E9AData[0].highlevelcategory = highlevelcategory;
...
Select for auxiliar field
 */
  public static String selectDef5705_1(ConnectionProvider connectionProvider, String CreatedByR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET C_Commission_ID = (?) , Line = TO_NUMBER(?) , IsActive = (?) , Highlevelcategory = (?) , M_Product_Category_ID = (?) , AmtMultiplier = TO_NUMBER(?) , Salesvolumefrom = TO_NUMBER(?) , Convertedturnover = TO_NUMBER(?) , AmtSubtract = TO_NUMBER(?) , AD_Org_ID = (?) , Description = (?) , C_CommissionLine_ID = (?) , AD_Client_ID = (?) , CommissionOrders = (?) , Isshareofturnover = (?) , QtySubtract = TO_NUMBER(?) , IsPositiveOnly = (?) , QtyMultiplier = TO_NUMBER(?) , updated = now(), updatedby = ? " +
      "        WHERE C_CommissionLine.C_CommissionLine_ID = ? " +
    ...
    st = connectionProvider.getPreparedStatement(conn, strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, highlevelcategory);
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (C_Commission_ID, Line, IsActive, Highlevelcategory, M_Product_Category_ID, AmtMultiplier, Salesvolumefrom, Convertedturnover, AmtSubtract, AD_Org_ID, Description, C_CommissionLine_ID, AD_Client_ID, CommissionOrders, Isshareofturnover, QtySubtract, IsPositiveOnly, QtyMultiplier, created, createdby, updated, updatedBy)" +
