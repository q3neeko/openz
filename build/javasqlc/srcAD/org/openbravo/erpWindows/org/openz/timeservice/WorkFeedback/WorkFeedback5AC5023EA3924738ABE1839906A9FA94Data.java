...
static Logger log4j = Logger.getLogger(WorkFeedback5AC5023EA3924738ABE1839906A9FA94Data.class);
  ...
  public String getField(String fieldName) {
    if (fieldName.equalsIgnoreCase("created"))
      ...
      return workdate;
    else if (fieldName.equalsIgnoreCase("workdate_to") || fieldName.equals("workdateTo"))
      return workdateTo;
      ...
      return breaktime;
    else if (fieldName.equalsIgnoreCase("paidbreaktime"))
    ...
    else if (fieldName.equalsIgnoreCase("specialtime3"))
      return specialtime3;
 ...
 */
  public static WorkFeedback5AC5023EA3924738ABE1839906A9FA94Data[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN tsrv_feedback_v.c_projecttask_id IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table4.Value), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table4.Name), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table3.Name), ''))),'') ) END) AS c_projecttask_idR, " +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectWorkFeedback5AC5023EA3924738ABE1839906A9FA94Data.workdateTo = UtilSql.getDateValue(result, "workdate_to", "dd-MM-yyyy");
        ...
        objectWorkFeedback5AC5023EA3924738ABE1839906A9FA94Data.paidbreaktime = UtilSql.getValue(result, "paidbreaktime");
        ...
        objectWorkFeedback5AC5023EA3924738ABE1839906A9FA94Data.specialtime3 = UtilSql.getValue(result, "specialtime3");
...
Create a registry
 */
  public static WorkFeedback5AC5023EA3924738ABE1839906A9FA94Data[] set(String tsrvFeedbackVId, String hourFrom, String adClientId, String triggeramt, String description, String nighthours, String actualcostamount, String isholiday, String issaturday, String isactive, String overtimehours, String maMachineId, String workdate, String breaktime, String cProjectId, String cProjectIdr, String cProjecttaskId, String timeunderhelmet2, String createdby, String createdbyr, String specialtime3, String hourTo, String updatedby, String updatedbyr, String paidbreaktime, String traveltime, String workdateTo, String employeeId, String adOrgId, String cSalaryCategoryId, String cCalendareventId, String hours, String issunday, String timeunderhelmet)    throws ServletException {
    ...
    objectWorkFeedback5AC5023EA3924738ABE1839906A9FA94Data[0].workdateTo = workdateTo;
    ...
    objectWorkFeedback5AC5023EA3924738ABE1839906A9FA94Data[0].paidbreaktime = paidbreaktime;
    ...
    objectWorkFeedback5AC5023EA3924738ABE1839906A9FA94Data[0].specialtime3 = specialtime3;
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET AD_Org_ID = (?) , c_project_id = (?) , c_projecttask_id = (?) , employee_id = (?) , C_Salary_Category_ID = (?) , Workdate = TO_DATE(?) , Workdate_To = TO_DATE(?) , Hour_From = TO_TIMESTAMP(?,'HH24:MI:SS') , Hour_To = TO_TIMESTAMP(?,'HH24:MI:SS') , Breaktime = TO_NUMBER(?) , Paidbreaktime = TO_NUMBER(?) , Traveltime = TO_NUMBER(?) , Timeunderhelmet = TO_NUMBER(?) , Timeunderhelmet2 = TO_NUMBER(?) , Specialtime3 = TO_NUMBER(?) , Triggeramt = TO_NUMBER(?) , Description = (?) , Hours = TO_NUMBER(?) , Actualcostamount = TO_NUMBER(?) , Issaturday = (?) , Issunday = (?) , Isholiday = (?) , Overtimehours = TO_NUMBER(?) , Nighthours = TO_NUMBER(?) , Tsrv_Feedback_V_ID = (?) , Isactive = (?) , AD_Client_ID = (?) , MA_Machine_ID = (?) , C_Calendarevent_ID = (?) , updated = now(), updatedby = ? " +
    ...
    st = connectionProvider.getPreparedStatement(conn, strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, workdateTo);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, paidbreaktime);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, specialtime3);
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Org_ID, c_project_id, c_projecttask_id, employee_id, C_Salary_Category_ID, Workdate, Workdate_To, Hour_From, Hour_To, Breaktime, Paidbreaktime, Traveltime, Timeunderhelmet, Timeunderhelmet2, Specialtime3, Triggeramt, Description, Hours, Actualcostamount, Issaturday, Issunday, Isholiday, Overtimehours, Nighthours, Tsrv_Feedback_V_ID, Isactive, AD_Client_ID, MA_Machine_ID, C_Calendarevent_ID, created, createdby, updated, updatedBy)" +
      "        VALUES ((?), (?), (?), (?), (?), TO_DATE(?), TO_DATE(?), TO_TIMESTAMP(?, 'HH24:MI:SS'), TO_TIMESTAMP(?, 'HH24:MI:SS'), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), (?), TO_NUMBER(?), TO_NUMBER(?), (?), (?), (?), TO_NUMBER(?), TO_NUMBER(?), (?), (?), (?), (?), (?), now(), ?, now(), ?)";
