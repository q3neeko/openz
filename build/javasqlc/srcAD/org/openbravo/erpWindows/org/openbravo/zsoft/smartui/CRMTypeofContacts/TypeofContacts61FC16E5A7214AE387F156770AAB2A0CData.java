 ...
 */
  public static TypeofContacts61FC16E5A7214AE387F156770AAB2A0CData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN zssi_crmactions.AD_Org_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS AD_Org_IDR, " +
      "zssi_crmactions.Name, " +
      "zssi_crmactions.Description, " +
      "COALESCE(zssi_crmactions.Isactive, 'N') AS Isactive, " +
      "        ? AS LANGUAGE " +
      "        FROM zssi_crmactions left join (select AD_Org_ID, Name from AD_Org) table1 on (zssi_crmactions.AD_Org_ID = table1.AD_Org_ID)" +
      "        WHERE 2=2 " +
      "        AND 1=1 " +
...
Create a registry
 */
  public static TypeofContacts61FC16E5A7214AE387F156770AAB2A0CData[] set(String updatedby, String updatedbyr, String description, String adOrgId, String isactive, String createdby, String createdbyr, String name, String adClientId, String zssiCrmactionsId)    throws ServletException {
