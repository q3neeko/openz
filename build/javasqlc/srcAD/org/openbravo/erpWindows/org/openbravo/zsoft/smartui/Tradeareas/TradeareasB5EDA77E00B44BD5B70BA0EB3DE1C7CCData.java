 ...
 */
  public static TradeareasB5EDA77E00B44BD5B70BA0EB3DE1C7CCData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN zssi_tradearea.AD_Org_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS AD_Org_IDR, " +
      "zssi_tradearea.Name, " +
      "zssi_tradearea.Text, " +
      ...
      "        ? AS LANGUAGE " +
      "        FROM zssi_tradearea left join (select AD_Org_ID, Name from AD_Org) table1 on (zssi_tradearea.AD_Org_ID = table1.AD_Org_ID)" +
      "        WHERE 2=2 " +
      "        AND 1=1 " +
