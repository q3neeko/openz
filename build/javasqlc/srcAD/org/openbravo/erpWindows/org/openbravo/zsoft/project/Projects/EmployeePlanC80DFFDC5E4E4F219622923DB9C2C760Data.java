 ...
 */
  public static EmployeePlanC80DFFDC5E4E4F219622923DB9C2C760Data[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String cProjecttaskId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN zspm_ptaskhrplan.C_Projecttask_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table2.Value), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table2.Name), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS C_Projecttask_IDR, " +
 ...
 */
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (C_Projecttask_ID, Isactive, C_Salary_Category_ID, Employee_ID, Datefrom, Dateto, Quantity, Overtimehours, Nighthours, Specialtime1, Specialtime2, Saturday, Sunday, Holiday, Triggeramt, Plannedamt, Planndedpercent, Costuom, AD_Client_ID, AD_Org_ID, Zspm_Ptaskhrplan_ID, Description, created, createdby, updated, updatedBy)" +
