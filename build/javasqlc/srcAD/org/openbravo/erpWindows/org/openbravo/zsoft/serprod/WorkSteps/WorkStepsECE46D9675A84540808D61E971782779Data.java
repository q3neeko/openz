 ...
 */
  public static WorkStepsECE46D9675A84540808D61E971782779Data[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "zssm_workstep_prp_v.C_Color_ID, " +
      "(CASE WHEN zssm_workstep_prp_v.C_Color_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table2.Name), ''))),'') ) END) AS C_Color_IDR, " +
      ...
      "(CASE WHEN zssm_workstep_prp_v.M_Product_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table3.Value), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL3.Name IS NULL THEN TO_CHAR(table3.Name) ELSE TO_CHAR(tableTRL3.Name) END)), ''))),'') ) END) AS M_Product_IDR, " +
      ...
      "COALESCE(zssm_workstep_prp_v.Isautocloseworkstep, 'N') AS Isautocloseworkstep, " +
      "zssm_workstep_prp_v.Receiving_Locator, " +
      "(CASE WHEN zssm_workstep_prp_v.Receiving_Locator IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table4.Value), ''))),'') ) END) AS Receiving_LocatorR, " +
      "zssm_workstep_prp_v.Issuing_Locator, " +
      "(CASE WHEN zssm_workstep_prp_v.Issuing_Locator IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table5.Value), ''))),'') ) END) AS Issuing_LocatorR, " +
      ...
      "        ? AS LANGUAGE " +
      "        FROM zssm_workstep_prp_v left join (select AD_Org_ID, Name from AD_Org) table1 on (zssm_workstep_prp_v.AD_Org_ID = table1.AD_Org_ID) left join (select C_Color_ID, Name from C_Color) table2 on (zssm_workstep_prp_v.C_Color_ID = table2.C_Color_ID) left join (select M_Product_ID, Value, Name from M_Product) table3 on (zssm_workstep_prp_v.M_Product_ID = table3.M_Product_ID) left join (select M_Product_ID,AD_Language, Name from M_Product_TRL) tableTRL3 on (table3.M_Product_ID = tableTRL3.M_Product_ID and tableTRL3.AD_Language = ?)  left join (select M_Locator_ID, Value from M_Locator) table4 on (zssm_workstep_prp_v.Receiving_Locator = table4.M_Locator_ID) left join (select M_Locator_ID, Value from M_Locator) table5 on (zssm_workstep_prp_v.Issuing_Locator = table5.M_Locator_ID)" +
      "        WHERE 2=2 " +
      "        AND 1=1 " +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectWorkStepsECE46D9675A84540808D61E971782779Data.cColorId = UtilSql.getValue(result, "c_color_id");
        objectWorkStepsECE46D9675A84540808D61E971782779Data.cColorIdr = UtilSql.getValue(result, "c_color_idr");
        ...
        objectWorkStepsECE46D9675A84540808D61E971782779Data.isautocloseworkstep = UtilSql.getValue(result, "isautocloseworkstep");
...
Create a registry
 */
  public static WorkStepsECE46D9675A84540808D61E971782779Data[] set(String help, String receivingLocator, String receivingLocatorr, String zssmWorkstepPrpVId, String value, String forcematerialscan, String isautotriggered, String createdby, String createdbyr, String seqno, String indirectcostplan, String cProjecttaskId, String isautocloseworkstep, String adClientId, String mimimumqty, String description, String isautogeneratedplan, String zssmWorkstepVId, String mProductId, String mProductIdr, String timeperpiece, String plannedcost, String materialcostplan, String machinecostplan, String isactive, String issuingLocator, String issuingLocatorr, String adOrgId, String setuptime, String servcostplan, String multipleofmimimumqty, String startonlywithcompletematerial, String cColorId, String qty, String percentrejects, String updatedby, String updatedbyr, String name, String assembly)    throws ServletException {
    ...
    objectWorkStepsECE46D9675A84540808D61E971782779Data[0].cColorId = cColorId;
    objectWorkStepsECE46D9675A84540808D61E971782779Data[0].cColorIdr = "";
    ...
    objectWorkStepsECE46D9675A84540808D61E971782779Data[0].isautocloseworkstep = isautocloseworkstep;
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET AD_Org_ID = (?) , IsActive = (?) , C_Color_ID = (?) , Value = (?) , Name = (?) , SeqNo = TO_NUMBER(?) , Description = (?) , Assembly = (?) , M_Product_ID = (?) , ForceMaterialScan = (?) , StartOnlyWithCompleteMaterial = (?) , Isautotriggered = (?) , isautogeneratedplan = (?) , Isautocloseworkstep = (?) , Receiving_Locator = (?) , Issuing_Locator = (?) , Timeperpiece = TO_NUMBER(?) , Setuptime = TO_NUMBER(?) , Mimimumqty = TO_NUMBER(?) , Multipleofmimimumqty = (?) , ServCostPlan = TO_NUMBER(?) , MachineCostPlan = TO_NUMBER(?) , MaterialCostPlan = TO_NUMBER(?) , PlannedCost = TO_NUMBER(?) , Help = (?) , Zssm_Workstep_Prp_V_ID = (?) , IndirectCostPlan = TO_NUMBER(?) , PercentRejects = TO_NUMBER(?) , C_Projecttask_ID = (?) , AD_Client_ID = (?) , Qty = TO_NUMBER(?) , Zssm_Workstep_V_ID = (?) , updated = now(), updatedby = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Org_ID, IsActive, C_Color_ID, Value, Name, SeqNo, Description, Assembly, M_Product_ID, ForceMaterialScan, StartOnlyWithCompleteMaterial, Isautotriggered, isautogeneratedplan, Isautocloseworkstep, Receiving_Locator, Issuing_Locator, Timeperpiece, Setuptime, Mimimumqty, Multipleofmimimumqty, ServCostPlan, MachineCostPlan, MaterialCostPlan, PlannedCost, Help, Zssm_Workstep_Prp_V_ID, IndirectCostPlan, PercentRejects, C_Projecttask_ID, AD_Client_ID, Qty, Zssm_Workstep_V_ID, created, createdby, updated, updatedBy)" +
