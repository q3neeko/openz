 ...
 */
  public static Header800111Data[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN MA_WorkRequirement.MA_Processplan_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table2.Name), ''))),'') ) END) AS MA_Processplan_IDR, " +
      ...
      "        ? AS LANGUAGE " +
      "        FROM MA_WorkRequirement left join (select AD_Org_ID, Name from AD_Org) table1 on (MA_WorkRequirement.AD_Org_ID = table1.AD_Org_ID) left join (select MA_Processplan_ID, Name from MA_Processplan) table2 on (MA_WorkRequirement.MA_Processplan_ID = table2.MA_Processplan_ID)" +
      "        WHERE 2=2 " +
      "        AND 1=1 " +
...
Create a registry
 */
  public static Header800111Data[] set(String adOrgId, String launchdate, String closed, String secondaryqty, String name, String maWorkrequirementId, String explodephases, String adClientId, String explote, String documentno, String updatedby, String updatedbyr, String enddate, String startdate, String isactive, String secondaryunit, String processed, String maProcessplanId, String createdby, String createdbyr, String quantity, String conversionrate)    throws ServletException {
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET AD_Client_ID = (?) , MA_Workrequirement_ID = (?) , AD_Org_ID = (?) , DocumentNo = (?) , IsActive = (?) , MA_Processplan_ID = (?) , Explodephases = (?) , Quantity = TO_NUMBER(?) , Name = (?) , Conversionrate = TO_NUMBER(?) , Secondaryqty = TO_NUMBER(?) , Secondaryunit = (?) , Launchdate = TO_DATE(?) , StartDate = TO_DATE(?) , EndDate = TO_DATE(?) , Closed = (?) , Explote = (?) , Processed = (?) , updated = now(), updatedby = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Client_ID, MA_Workrequirement_ID, AD_Org_ID, DocumentNo, IsActive, MA_Processplan_ID, Explodephases, Quantity, Name, Conversionrate, Secondaryqty, Secondaryunit, Launchdate, StartDate, EndDate, Closed, Explote, Processed, created, createdby, updated, updatedBy)" +
