 ...
 */
  public static Textmodule59716CC2118D45CBA6F5ED75BC099F54Data[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN zssi_textmodule.AD_Org_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS AD_Org_IDR, " +
      "zssi_textmodule.C_Doctype_ID, " +
      "(CASE WHEN zssi_textmodule.C_Doctype_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL2.Name IS NULL THEN TO_CHAR(table2.Name) ELSE TO_CHAR(tableTRL2.Name) END)), ''))),'') ) END) AS C_Doctype_IDR, " +
      ...
      "        ? AS LANGUAGE " +
      "        FROM zssi_textmodule left join (select AD_Org_ID, Name from AD_Org) table1 on (zssi_textmodule.AD_Org_ID = table1.AD_Org_ID) left join (select C_Doctype_ID, Name from C_Doctype) table2 on (zssi_textmodule.C_Doctype_ID = table2.C_Doctype_ID) left join (select C_DocType_ID,AD_Language, Name from C_DocType_TRL) tableTRL2 on (table2.C_DocType_ID = tableTRL2.C_DocType_ID and tableTRL2.AD_Language = ?) " +
      "        WHERE 2=2 " +
      " AND zssi_textmodule.c_bpartner_id is null" +
      "        AND 1=1 " +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectTextmodule59716CC2118D45CBA6F5ED75BC099F54Data.isautoadd = UtilSql.getValue(result, "isautoadd");
        ...
        objectTextmodule59716CC2118D45CBA6F5ED75BC099F54Data.cBpartnerId = UtilSql.getValue(result, "c_bpartner_id");
 ...
 */
  public static Textmodule59716CC2118D45CBA6F5ED75BC099F54Data[] set(String islower, String adClientId, String name, String cBpartnerId, String createdby, String createdbyr, String cDoctypeId, String text, String adOrgId, String isactive, String zssiTextmoduleId, String updatedby, String updatedbyr, String position, String isautoadd)    throws ServletException {
    ...
    objectTextmodule59716CC2118D45CBA6F5ED75BC099F54Data[0].isautoadd = isautoadd;
    ...
    objectTextmodule59716CC2118D45CBA6F5ED75BC099F54Data[0].cBpartnerId = cBpartnerId;
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET AD_Org_ID = (?) , C_Doctype_ID = (?) , Islower = (?) , Position = TO_NUMBER(?) , Name = (?) , Isautoadd = (?) , Isactive = (?) , Text = (?) , C_Bpartner_ID = (?) , AD_Client_ID = (?) , Zssi_Textmodule_ID = (?) , updated = now(), updatedby = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Org_ID, C_Doctype_ID, Islower, Position, Name, Isautoadd, Isactive, Text, C_Bpartner_ID, AD_Client_ID, Zssi_Textmodule_ID, created, createdby, updated, updatedBy)" +
