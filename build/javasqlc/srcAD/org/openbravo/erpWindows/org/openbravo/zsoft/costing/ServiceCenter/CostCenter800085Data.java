 ...
 */
  public static CostCenter800085Data[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN MA_CostCenter.AD_Org_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS AD_Org_IDR, " +
      "MA_CostCenter.Value, " +
      "MA_CostCenter.Name, " +
      ...
      "        ? AS LANGUAGE " +
      "        FROM MA_CostCenter left join (select AD_Org_ID, Name from AD_Org) table1 on (MA_CostCenter.AD_Org_ID = table1.AD_Org_ID)" +
      "        WHERE 2=2 " +
      "        AND 1=1 " +
...
Create a registry
 */
  public static CostCenter800085Data[] set(String value, String createdby, String createdbyr, String cost, String maCostcenterId, String adClientId, String isactive, String updatedby, String updatedbyr, String name, String bydefault, String adOrgId, String calculated, String costuom)    throws ServletException {
