 ...
 */
  public static Version800234Data[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String maCostcenterId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN MA_Costcenter_Version.AD_Org_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS AD_Org_IDR, " +
      "MA_Costcenter_Version.MA_Costcenter_ID, " +
      "(CASE WHEN MA_Costcenter_Version.MA_Costcenter_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table2.Name), ''))),'') ) END) AS MA_Costcenter_IDR, " +
      ...
      "        ? AS LANGUAGE " +
      "        FROM MA_Costcenter_Version left join (select AD_Org_ID, Name from AD_Org) table1 on (MA_Costcenter_Version.AD_Org_ID = table1.AD_Org_ID) left join (select MA_Costcenter_ID, Name from MA_Costcenter) table2 on (MA_Costcenter_Version.MA_Costcenter_ID = table2.MA_Costcenter_ID) left join ad_ref_list_v list1 on (MA_Costcenter_Version.Costuom = list1.value and list1.ad_reference_id = '800088' and list1.ad_language = ?) " +
      "        WHERE 2=2 " +
      "        AND 1=1 ";
...
Create a registry
 */
  public static Version800234Data[] set(String maCostcenterId, String costuom, String createdby, String createdbyr, String documentno, String validfrom, String adOrgId, String cost, String adClientId, String isactive, String maCostcenterVersionId, String updatedby, String updatedbyr)    throws ServletException {
