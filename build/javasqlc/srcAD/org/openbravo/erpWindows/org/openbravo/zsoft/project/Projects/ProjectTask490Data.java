...
static Logger log4j = Logger.getLogger(ProjectTask490Data.class);
  ...
  public String isinvoicableservice;
  ...
  public String getField(String fieldName) {
    if (fieldName.equalsIgnoreCase("created"))
      ...
      return cColorIdr;
    else if (fieldName.equalsIgnoreCase("isinvoicableservice"))
      return isinvoicableservice;
      ...
      return taskcopy;
    else if (fieldName.equalsIgnoreCase("ismobdemob"))
      return ismobdemob;
 ...
 */
  public static ProjectTask490Data[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String cProjectId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "COALESCE(C_ProjectTask.Isinvoicableservice, 'N') AS Isinvoicableservice, " +
      ...
      "COALESCE(C_ProjectTask.Ismobdemob, 'N') AS Ismobdemob, " +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectProjectTask490Data.isinvoicableservice = UtilSql.getValue(result, "isinvoicableservice");
        ...
        objectProjectTask490Data.qtyproduced = UtilSql.getValue(result, "qtyproduced");
        ...
        objectProjectTask490Data.ismobdemob = UtilSql.getValue(result, "ismobdemob");
 ...
 */
  public static ProjectTask490Data[] set(String cProjectId, String cProjectphaseId, String name, String materialcostplan, String returnmaterialtostock, String cColorId, String istaskcancelled, String externalserviceplan, String servcostplan, String expensesplan, String qty, String outsourcing, String adUserId, String invoicedamt, String schedulestatus, String indirectcostplan, String help, String taskcopy, String iscomplete, String datecontract, String machinecostplan, String cTaskId, String cProjecttaskId, String copyptask, String createbom, String servcost, String materialcost, String iscommitceiling, String priceactual, String ismobdemob, String gotopurchasing, String isinvoicableservice, String feedbackfinished, String begintask, String percentdone, String taskbegun, String endtask, String plannedcost, String mProductId, String mProductIdr, String description, String createdby, String createdbyr, String qtyproduced, String enddate, String indirectcost, String ismaterialdisposed, String machinecost, String updatedby, String updatedbyr, String planmaterial, String startdate, String expenses, String seqno, String committedamt, String value, String adClientId, String getmaterialfromstock, String isactive, String preplanmaterial, String externalservice, String canceltask, String actualcost, String unplanmaterial, String adOrgId)    throws ServletException {
    ...
    objectProjectTask490Data[0].isinvoicableservice = isinvoicableservice;
    ...
    objectProjectTask490Data[0].qtyproduced = qtyproduced;
    ...
    objectProjectTask490Data[0].ismobdemob = ismobdemob;
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET C_Project_ID = (?) , SeqNo = TO_NUMBER(?) , IsActive = (?) , AD_User_ID = (?) , Outsourcing = (?) , Name = (?) , Description = (?) , Help = (?) , C_Color_ID = (?) , Isinvoicableservice = (?) , M_Product_ID = (?) , Qty = TO_NUMBER(?) , Qtyproduced = TO_NUMBER(?) , StartDate = TO_DATE(?) , Enddate = TO_DATE(?) , Taskbegun = (?) , Iscomplete = (?) , Istaskcancelled = (?) , Feedbackfinished = (?) , Ismaterialdisposed = (?) , Expensesplan = TO_NUMBER(?) , Expenses = TO_NUMBER(?) , Externalserviceplan = TO_NUMBER(?) , Externalservice = TO_NUMBER(?) , Materialcostplan = TO_NUMBER(?) , Materialcost = TO_NUMBER(?) , Servcostplan = TO_NUMBER(?) , Servcost = TO_NUMBER(?) , Machinecostplan = TO_NUMBER(?) , Machinecost = TO_NUMBER(?) , Indirectcostplan = TO_NUMBER(?) , Indirectcost = TO_NUMBER(?) , Committedamt = TO_NUMBER(?) , Invoicedamt = TO_NUMBER(?) , Plannedcost = TO_NUMBER(?) , Actualcost = TO_NUMBER(?) , Percentdone = TO_NUMBER(?) , Schedulestatus = (?) , Preplanmaterial = (?) , Copyptask = (?) , Createbom = (?) , Planmaterial = (?) , Unplanmaterial = (?) , Getmaterialfromstock = (?) , Returnmaterialtostock = (?) , Begintask = (?) , Endtask = (?) , Canceltask = (?) , Taskcopy = (?) , Ismobdemob = (?) , C_Projectphase_ID = (?) , AD_Client_ID = (?) , AD_Org_ID = (?) , C_ProjectTask_ID = (?) , Gotopurchasing = (?) , Value = (?) , Datecontract = TO_DATE(?) , PriceActual = TO_NUMBER(?) , Iscommitceiling = (?) , C_Task_ID = (?) , updated = now(), updatedby = ? " +
      "        WHERE C_ProjectTask.C_ProjectTask_ID = ? " +
    ...
    st = connectionProvider.getPreparedStatement(conn, strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, isinvoicableservice);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, ismobdemob);
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (C_Project_ID, SeqNo, IsActive, AD_User_ID, Outsourcing, Name, Description, Help, C_Color_ID, Isinvoicableservice, M_Product_ID, Qty, Qtyproduced, StartDate, Enddate, Taskbegun, Iscomplete, Istaskcancelled, Feedbackfinished, Ismaterialdisposed, Expensesplan, Expenses, Externalserviceplan, Externalservice, Materialcostplan, Materialcost, Servcostplan, Servcost, Machinecostplan, Machinecost, Indirectcostplan, Indirectcost, Committedamt, Invoicedamt, Plannedcost, Actualcost, Percentdone, Schedulestatus, Preplanmaterial, Copyptask, Createbom, Planmaterial, Unplanmaterial, Getmaterialfromstock, Returnmaterialtostock, Begintask, Endtask, Canceltask, Taskcopy, Ismobdemob, C_Projectphase_ID, AD_Client_ID, AD_Org_ID, C_ProjectTask_ID, Gotopurchasing, Value, Datecontract, PriceActual, Iscommitceiling, C_Task_ID, created, createdby, updated, updatedBy)" +
      "        VALUES ((?), TO_NUMBER(?), (?), (?), (?), (?), (?), (?), (?), (?), (?), TO_NUMBER(?), TO_NUMBER(?), TO_DATE(?), TO_DATE(?), (?), (?), (?), (?), (?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), TO_DATE(?), TO_NUMBER(?), (?), (?), now(), ?, now(), ?)";
