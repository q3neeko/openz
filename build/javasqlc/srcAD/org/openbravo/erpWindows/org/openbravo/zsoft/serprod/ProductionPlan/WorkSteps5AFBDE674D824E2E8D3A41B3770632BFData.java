 ...
 */
  public static WorkSteps5AFBDE674D824E2E8D3A41B3770632BFData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String zssmProductionplanVId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "zssm_productionplan_task_v.Timeperpiece, " +
      "zssm_productionplan_task_v.Setuptime, " +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectWorkSteps5AFBDE674D824E2E8D3A41B3770632BFData.timeperpiece = UtilSql.getValue(result, "timeperpiece");
        objectWorkSteps5AFBDE674D824E2E8D3A41B3770632BFData.setuptime = UtilSql.getValue(result, "setuptime");
...
Create a registry
 */
  public static WorkSteps5AFBDE674D824E2E8D3A41B3770632BFData[] set(String zssmProductionplanVId, String adClientId, String forcematerialscan, String isactive, String zssmProductionplanTaskId, String setuptime, String assembly, String issuingLocator, String issuingLocatorr, String createdby, String createdbyr, String sortno, String value, String cProjecttaskId, String percentrejects, String timeperpiece, String mProductId, String mProductIdr, String receivingLocator, String receivingLocatorr, String startonlywithcompletematerial, String updatedby, String updatedbyr, String zssmProductionplanTaskVId, String adOrgId, String name, String description)    throws ServletException {
    ...
    objectWorkSteps5AFBDE674D824E2E8D3A41B3770632BFData[0].timeperpiece = timeperpiece;
    objectWorkSteps5AFBDE674D824E2E8D3A41B3770632BFData[0].setuptime = setuptime;
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET AD_Org_ID = (?) , Zssm_Productionplan_V_ID = (?) , C_Projecttask_ID = (?) , Isactive = (?) , Value = (?) , Name = (?) , SortNo = TO_NUMBER(?) , Description = (?) , Assembly = (?) , M_Product_ID = (?) , ForceMaterialScan = (?) , StartOnlyWithCompleteMaterial = (?) , PercentRejects = TO_NUMBER(?) , Receiving_Locator = (?) , Issuing_Locator = (?) , Timeperpiece = TO_NUMBER(?) , Setuptime = TO_NUMBER(?) , Zssm_Productionplan_Task_ID = (?) , AD_Client_ID = (?) , Zssm_Productionplan_Task_V_ID = (?) , updated = now(), updatedby = ? " +
      "        WHERE zssm_productionplan_task_v.Zssm_Productionplan_Task_V_ID = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Org_ID, Zssm_Productionplan_V_ID, C_Projecttask_ID, Isactive, Value, Name, SortNo, Description, Assembly, M_Product_ID, ForceMaterialScan, StartOnlyWithCompleteMaterial, PercentRejects, Receiving_Locator, Issuing_Locator, Timeperpiece, Setuptime, Zssm_Productionplan_Task_ID, AD_Client_ID, Zssm_Productionplan_Task_V_ID, created, createdby, updated, updatedBy)" +
