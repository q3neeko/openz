...
static Logger log4j = Logger.getLogger(ReportStructure4B9AA850B2334D80959C56152C32E25EData.class);
  ...
  public String addreversechargeasrevenue;
  ...
  public String getField(String fieldName) {
    ...
    else if (fieldName.equalsIgnoreCase("addreversechargeasrevenue"))
      return addreversechargeasrevenue;
 ...
 */
  public static ReportStructure4B9AA850B2334D80959C56152C32E25EData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String zsprBwaheaderId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN zspr_bwaprefs.AD_Org_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS AD_Org_IDR, " +
      "zspr_bwaprefs.Zspr_Bwaheader_ID, " +
      "(CASE WHEN zspr_bwaprefs.Zspr_Bwaheader_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table2.Name), ''))),'') ) END) AS Zspr_Bwaheader_IDR, " +
      "zspr_bwaprefs.Name, " +
      ...
      "COALESCE(zspr_bwaprefs.Addreversechargeasrevenue, 'N') AS Addreversechargeasrevenue, " +
      "COALESCE(zspr_bwaprefs.Isparent, 'N') AS Isparent, " +
      "zspr_bwaprefs.Parentpref, " +
      "(CASE WHEN zspr_bwaprefs.Parentpref IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table3.Name), ''))),'') ) END) AS ParentprefR, " +
      "COALESCE(zspr_bwaprefs.Isactive, 'N') AS Isactive, " +
      "zspr_bwaprefs.Zspr_Bwaprefs_ID, " +
      "        ? AS LANGUAGE " +
      "        FROM zspr_bwaprefs left join (select AD_Org_ID, Name from AD_Org) table1 on (zspr_bwaprefs.AD_Org_ID = table1.AD_Org_ID) left join (select Zspr_Bwaheader_ID, Name from Zspr_Bwaheader) table2 on (zspr_bwaprefs.Zspr_Bwaheader_ID = table2.Zspr_Bwaheader_ID) left join (select Zspr_Bwaprefs_ID, Name from zspr_bwaprefs) table3 on (zspr_bwaprefs.Parentpref =  table3.Zspr_Bwaprefs_ID)" +
      "        WHERE 2=2 " +
      "        AND 1=1 ";
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectReportStructure4B9AA850B2334D80959C56152C32E25EData.addreversechargeasrevenue = UtilSql.getValue(result, "addreversechargeasrevenue");
...
Create a registry
 */
  public static ReportStructure4B9AA850B2334D80959C56152C32E25EData[] set(String zsprBwaheaderId, String issuminfooter, String sumfrombeginning, String createdby, String createdbyr, String orderno, String isparent, String allwowonlypositive, String zsprBwaprefsId, String isasset, String allwowonlynegative, String name, String parentpref, String zsprBwaheaderIdr, String updatedby, String updatedbyr, String isactive, String adClientId, String addreversechargeasrevenue, String adOrgId, String dontprintdetails)    throws ServletException {
    ...
    objectReportStructure4B9AA850B2334D80959C56152C32E25EData[0].addreversechargeasrevenue = addreversechargeasrevenue;
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET AD_Client_ID = (?) , AD_Org_ID = (?) , Zspr_Bwaheader_ID = (?) , Name = (?) , Orderno = TO_NUMBER(?) , Isasset = (?) , Sumfrombeginning = (?) , Allwowonlypositive = (?) , Allwowonlynegative = (?) , Dontprintdetails = (?) , Issuminfooter = (?) , Addreversechargeasrevenue = (?) , Isparent = (?) , Parentpref = (?) , Isactive = (?) , Zspr_Bwaprefs_ID = (?) , updated = now(), updatedby = ? " +
      "        WHERE zspr_bwaprefs.Zspr_Bwaprefs_ID = ? " +
    ...
    st = connectionProvider.getPreparedStatement(conn, strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, addreversechargeasrevenue);
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Client_ID, AD_Org_ID, Zspr_Bwaheader_ID, Name, Orderno, Isasset, Sumfrombeginning, Allwowonlypositive, Allwowonlynegative, Dontprintdetails, Issuminfooter, Addreversechargeasrevenue, Isparent, Parentpref, Isactive, Zspr_Bwaprefs_ID, created, createdby, updated, updatedBy)" +
