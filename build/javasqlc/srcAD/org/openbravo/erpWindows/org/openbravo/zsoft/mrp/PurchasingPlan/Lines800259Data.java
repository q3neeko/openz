...
static Logger log4j = Logger.getLogger(Lines800259Data.class);
  ...
  public String getField(String fieldName) {
    if (fieldName.equalsIgnoreCase("created"))
      ...
      return neededqty;
    else if (fieldName.equalsIgnoreCase("thisdemand"))
      return thisdemand;
  ...
  public static Lines800259Data[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String mrpRunPurchaseId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectLines800259Data.thisdemand = UtilSql.getValue(result, "thisdemand");
        ...
        objectLines800259Data.isapproved = UtilSql.getValue(result, "isapproved");
        objectLines800259Data.mProductPoId = UtilSql.getValue(result, "m_product_po_id");
        objectLines800259Data.mProductPoIdr = UtilSql.getValue(result, "m_product_po_idr");
...
Create a registry
 */
  public static Lines800259Data[] set(String mrpRunPurchaseId, String cumqty, String mProductId, String mProductIdr, String adClientId, String neededqty, String mrpRunPurchaselineId, String mProductPoId, String adOrgId, String cOrderlineId, String iscompleted, String framecontractline, String plannedorderdate, String pricelist, String mRequisitionlineId, String cProjecttaskId, String mWarehouseId, String isactive, String mrpSalesforecastlineId, String cBpartnerId, String cBpartnerIdr, String planneddate, String qty, String totaldemand, String cUomId, String inouttrxtype, String isapproved, String isfixed, String mProductUomId, String quantityorder, String thisdemand, String updatedby, String updatedbyr, String createdby, String createdbyr)    throws ServletException {
    ...
    objectLines800259Data[0].thisdemand = thisdemand;
    ...
    objectLines800259Data[0].isapproved = isapproved;
    objectLines800259Data[0].mProductPoId = mProductPoId;
    objectLines800259Data[0].mProductPoIdr = "";
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(conn, strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, thisdemand);
