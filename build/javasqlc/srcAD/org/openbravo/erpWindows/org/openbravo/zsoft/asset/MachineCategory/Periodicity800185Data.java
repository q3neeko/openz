 ...
 */
  public static Periodicity800185Data[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String maMaintenanceId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN MA_Maint_Periodicity.AD_Org_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS AD_Org_IDR, " +
      "MA_Maint_Periodicity.MA_Maintenance_ID, " +
      "(CASE WHEN MA_Maint_Periodicity.MA_Maintenance_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table2.Name), ''))),'') ) END) AS MA_Maintenance_IDR, " +
...
Create a registry
 */
  public static Periodicity800185Data[] set(String maMaintenanceId, String adOrgId, String createdby, String createdbyr, String maMaintPeriodicityId, String adClientId, String updatedby, String updatedbyr, String periodicityType, String shift, String initdate, String monthday, String excludeweekend, String weekday, String isactive)    throws ServletException {
