 ...
 */
  public static WarehouseQuantitiesCompleteFDEE77DBDE904FE7860F134045324078Data[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN zssi_onhanqty.M_Product_Category_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table6.Name), ''))),'') ) END) AS M_Product_Category_IDR, " +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectWarehouseQuantitiesCompleteFDEE77DBDE904FE7860F134045324078Data.qtyorderedframe = UtilSql.getValue(result, "qtyorderedframe");
        objectWarehouseQuantitiesCompleteFDEE77DBDE904FE7860F134045324078Data.qtyinsale = UtilSql.getValue(result, "qtyinsale");
        objectWarehouseQuantitiesCompleteFDEE77DBDE904FE7860F134045324078Data.qtyinsaleframe = UtilSql.getValue(result, "qtyinsaleframe");
...
Create a registry
 */
  public static WarehouseQuantitiesCompleteFDEE77DBDE904FE7860F134045324078Data[] set(String qtyorderedframe, String mLocatorId, String mLocatorIdr, String mProductId, String mProductIdr, String zssiOnhanqtyOverviewId, String createdby, String createdbyr, String updatedby, String updatedbyr, String qtyinflow, String qtyordered, String qtyinsale, String mProductCategoryId, String zssiOnhanqtyId, String qtyoutflow, String mWarehouseId, String adOrgId, String isactive, String adClientId, String mAttributesetinstanceId, String mAttributesetinstanceIdr, String qtyinsaleframe, String qtyonhand, String cUomId, String qtyincomming, String qtyreserved)    throws ServletException {
    ...
    objectWarehouseQuantitiesCompleteFDEE77DBDE904FE7860F134045324078Data[0].qtyorderedframe = qtyorderedframe;
    objectWarehouseQuantitiesCompleteFDEE77DBDE904FE7860F134045324078Data[0].qtyinsale = qtyinsale;
    objectWarehouseQuantitiesCompleteFDEE77DBDE904FE7860F134045324078Data[0].qtyinsaleframe = qtyinsaleframe;
 ...
 */
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (M_Product_ID, M_Warehouse_ID, M_Locator_ID, QtyOnHand, QtyIncomming, Qtyreserved, Qtyordered, Qtyorderedframe, QtyInsale, Qtyinsaleframe, Qtyinflow, Qtyoutflow, C_Uom_ID, M_Attributesetinstance_ID, M_Product_Category_ID, Zssi_Onhanqty_ID, AD_Client_ID, Zssi_Onhanqty_Overview_ID, Isactive, AD_Org_ID, created, createdby, updated, updatedBy)" +
