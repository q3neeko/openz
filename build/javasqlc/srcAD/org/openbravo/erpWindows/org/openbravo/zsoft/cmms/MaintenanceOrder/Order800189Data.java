 ...
 */
  public static Order800189Data[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN MA_Maint_Part.AD_Org_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS AD_Org_IDR, " +
      ...
      "        ? AS LANGUAGE " +
      "        FROM MA_Maint_Part left join (select AD_Org_ID, Name from AD_Org) table1 on (MA_Maint_Part.AD_Org_ID = table1.AD_Org_ID) left join ad_ref_list_v list1 on (MA_Maint_Part.Shift = list1.value and list1.ad_reference_id = '800038' and list1.ad_language = ?) " +
      "        WHERE 2=2 " +
      "        AND 1=1 " +
...
Create a registry
 */
  public static Order800189Data[] set(String adOrgId, String partdate, String shift, String isactive, String maMaintPartId, String createmaint, String createdby, String createdbyr, String documentno, String adClientId, String updatedby, String updatedbyr)    throws ServletException {
