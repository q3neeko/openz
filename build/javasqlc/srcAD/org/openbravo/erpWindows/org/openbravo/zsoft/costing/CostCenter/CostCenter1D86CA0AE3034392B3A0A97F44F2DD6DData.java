 ...
 */
  public static CostCenter1D86CA0AE3034392B3A0A97F44F2DD6DData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN A_Asset.C_Location_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table3.Address1), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table3.Address2), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table3.Postal), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table3.City), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table4.Name), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL5.Name IS NULL THEN TO_CHAR(table5.Name) ELSE TO_CHAR(tableTRL5.Name) END)), ''))),'') ) END) AS C_Location_IDR, " +
...
Create a registry
 */
  public static CostCenter1D86CA0AE3034392B3A0A97F44F2DD6DData[] set(String name, String guaranteedate, String isfullydepreciated, String adOrgId, String isowned, String assetdisposaldate, String cCurrencyId, String assetservicedate, String depreciatedvalue, String cLocationId, String cLocationIdr, String assetschedule, String cBpartnerId, String amortizationenddate, String aAssetId, String isdisposed, String lot, String uselifemonths, String createdby, String createdbyr, String amortizationtype, String value, String serno, String amortizationvalueamt, String isinposession, String adUserId, String useunits, String acctvalueamt, String documentno, String issummary, String residualassetvalueamt, String uselifeyears, String depreciatedpreviousamt, String amortizationstartdate, String cProjectId, String depreciatedplan, String datecancelled, String amortizationcalctype, String isdepreciated, String description, String versionno, String datepurchased, String updatedby, String updatedbyr, String adClientId, String cBpartnerLocationId, String assetdepreciationdate, String locationcomment, String annualamortizationpercentage, String isactive, String processed, String aAssetGroupId, String assetvalueamt, String assettype, String iscostcenter, String help, String lifeuseunits, String profit)    throws ServletException {
