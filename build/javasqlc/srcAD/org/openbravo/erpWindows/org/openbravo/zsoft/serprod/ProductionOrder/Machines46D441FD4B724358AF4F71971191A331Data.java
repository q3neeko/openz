 ...
 */
  public static Machines46D441FD4B724358AF4F71971191A331Data[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String zssmWorkstepVId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "zssm_workstepmachines_v.Datefrom, " +
      "zssm_workstepmachines_v.Dateto, " +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectMachines46D441FD4B724358AF4F71971191A331Data.datefrom = UtilSql.getDateValue(result, "datefrom", "dd-MM-yyyy");
        objectMachines46D441FD4B724358AF4F71971191A331Data.dateto = UtilSql.getDateValue(result, "dateto", "dd-MM-yyyy");
        ...
        objectMachines46D441FD4B724358AF4F71971191A331Data.zssmWorkstepPrpVId = UtilSql.getValue(result, "zssm_workstep_prp_v_id");
...
Create a registry
 */
  public static Machines46D441FD4B724358AF4F71971191A331Data[] set(String zssmWorkstepVId, String adClientId, String quantity, String createdby, String createdbyr, String dateto, String zssmSectionId, String zssmWorkstepmachinesVId, String durationunit, String datefrom, String zssmWorkstepPrpVId, String adOrgId, String averageduration, String zspmPtaskmachineplanId, String maMachineId, String updatedby, String updatedbyr, String isactive, String costuom)    throws ServletException {
    ...
    objectMachines46D441FD4B724358AF4F71971191A331Data[0].datefrom = datefrom;
    objectMachines46D441FD4B724358AF4F71971191A331Data[0].dateto = dateto;
    ...
    objectMachines46D441FD4B724358AF4F71971191A331Data[0].zssmWorkstepPrpVId = zssmWorkstepPrpVId;
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET Zssm_Workstep_V_ID = (?) , MA_Machine_ID = (?) , Averageduration = TO_NUMBER(?) , Durationunit = (?) , Quantity = TO_NUMBER(?) , IsActive = (?) , Datefrom = TO_DATE(?) , Dateto = TO_DATE(?) , Zssm_WorkstepMachines_V_ID = (?) , zssm_section_id = (?) , AD_Client_ID = (?) , Zspm_PTaskMachineplan_ID = (?) , Zssm_Workstep_Prp_V_ID = (?) , Costuom = (?) , AD_Org_ID = (?) , updated = now(), updatedby = ? " +
      "        WHERE zssm_workstepmachines_v.Zssm_WorkstepMachines_V_ID = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (Zssm_Workstep_V_ID, MA_Machine_ID, Averageduration, Durationunit, Quantity, IsActive, Datefrom, Dateto, Zssm_WorkstepMachines_V_ID, zssm_section_id, AD_Client_ID, Zspm_PTaskMachineplan_ID, Zssm_Workstep_Prp_V_ID, Costuom, AD_Org_ID, created, createdby, updated, updatedBy)" +
      "        VALUES ((?), (?), TO_NUMBER(?), (?), TO_NUMBER(?), (?), TO_DATE(?), TO_DATE(?), (?), (?), (?), (?), (?), (?), (?), now(), ?, now(), ?)";
