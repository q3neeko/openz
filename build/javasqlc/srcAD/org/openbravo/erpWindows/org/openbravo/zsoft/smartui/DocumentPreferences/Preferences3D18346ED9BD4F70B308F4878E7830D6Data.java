 ...
 */
  public static Preferences3D18346ED9BD4F70B308F4878E7830D6Data[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN zssi_smartinvoiceprefs.AD_Org_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS AD_Org_IDR, " +
      ...
      "(CASE WHEN zssi_smartinvoiceprefs.ZSE_Shop_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table2.Value), ''))),'') ) END) AS ZSE_Shop_IDR, " +
      "zssi_smartinvoiceprefs.C_Bpartner_ID, " +
      "(CASE WHEN zssi_smartinvoiceprefs.C_Bpartner_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table3.Value), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table3.Name), ''))),'') ) END) AS C_Bpartner_IDR, " +
      "zssi_smartinvoiceprefs.C_Bpartner_Location_ID, " +
      "(CASE WHEN zssi_smartinvoiceprefs.C_Bpartner_Location_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table4.Name), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table4.Deviant_Bp_Name), ''))),'') ) END) AS C_Bpartner_Location_IDR, " +
...
Create a registry
 */
  public static Preferences3D18346ED9BD4F70B308F4878E7830D6Data[] set(String paymentrule, String adOrgId, String adClientId, String zseShopId, String deliveryrule, String cDoctypeId, String mWarehouseId, String mShipperId, String cIncotermsId, String invoicetype, String cPaymenttermId, String updatedby, String updatedbyr, String createdby, String createdbyr, String zssiSmartinvoiceprefsId, String invoicerule, String deliveryviarule, String freightcostrule, String cBpartnerLocationId, String isautoclosing, String isdefault, String weightUom, String usecustomersdefaults, String isactive, String cBpartnerId, String cBpartnerIdr, String mPricelistId)    throws ServletException {
