 ...
 */
  public static Activities714AC0CA3AB0466A953B779E536E5A20Data[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String zssmWorkstepPrpVId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "zssm_workstepactivities_v.Dateto, " +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectActivities714AC0CA3AB0466A953B779E536E5A20Data.shift = UtilSql.getValue(result, "shift");
        objectActivities714AC0CA3AB0466A953B779E536E5A20Data.zssmSectionId = UtilSql.getValue(result, "zssm_section_id");
        objectActivities714AC0CA3AB0466A953B779E536E5A20Data.specification = UtilSql.getValue(result, "specification");
        objectActivities714AC0CA3AB0466A953B779E536E5A20Data.employeeId = UtilSql.getValue(result, "employee_id");
        objectActivities714AC0CA3AB0466A953B779E536E5A20Data.datefrom = UtilSql.getDateValue(result, "datefrom", "dd-MM-yyyy");
        ...
        objectActivities714AC0CA3AB0466A953B779E536E5A20Data.zssmWorkstepVId = UtilSql.getValue(result, "zssm_workstep_v_id");
        objectActivities714AC0CA3AB0466A953B779E536E5A20Data.dateto = UtilSql.getDateValue(result, "dateto", "dd-MM-yyyy");
...
Create a registry
 */
  public static Activities714AC0CA3AB0466A953B779E536E5A20Data[] set(String zssmWorkstepPrpVId, String isactive, String updatedby, String updatedbyr, String zssmWorkstepactivitiesVId, String zssmWorkstepVId, String specification, String zssmSectionId, String quantity, String employeeId, String adOrgId, String datefrom, String zspmPtaskhrplanId, String durationunit, String costuom, String plannedQuantity, String createdby, String createdbyr, String dateto, String plannedDurationunit, String averageduration, String adClientId, String shift, String cSalaryCategoryId, String plannedAverageduration)    throws ServletException {
    ...
    objectActivities714AC0CA3AB0466A953B779E536E5A20Data[0].shift = shift;
    objectActivities714AC0CA3AB0466A953B779E536E5A20Data[0].zssmSectionId = zssmSectionId;
    objectActivities714AC0CA3AB0466A953B779E536E5A20Data[0].specification = specification;
    objectActivities714AC0CA3AB0466A953B779E536E5A20Data[0].employeeId = employeeId;
    objectActivities714AC0CA3AB0466A953B779E536E5A20Data[0].datefrom = datefrom;
    ...
    objectActivities714AC0CA3AB0466A953B779E536E5A20Data[0].zssmWorkstepVId = zssmWorkstepVId;
    objectActivities714AC0CA3AB0466A953B779E536E5A20Data[0].dateto = dateto;
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET Zssm_Workstep_Prp_V_ID = (?) , IsActive = (?) , C_Salary_Category_ID = (?) , AverageDuration = TO_NUMBER(?) , DurationUnit = (?) , Quantity = TO_NUMBER(?) , Zspm_PTaskHRPlan_ID = (?) , Shift = (?) , zssm_section_id = (?) , Specification = TO_NUMBER(?) , Employee_ID = (?) , Datefrom = TO_DATE(?) , Zssm_WorkstepActivities_V_ID = (?) , AD_Client_ID = (?) , Planned_Durationunit = (?) , Costuom = (?) , Planned_Averageduration = TO_NUMBER(?) , zssm_workstep_v_id = (?) , Dateto = TO_DATE(?) , Planned_Quantity = TO_NUMBER(?) , AD_Org_ID = (?) , updated = now(), updatedby = ? " +
      "        WHERE zssm_workstepactivities_v.Zssm_WorkstepActivities_V_ID = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (Zssm_Workstep_Prp_V_ID, IsActive, C_Salary_Category_ID, AverageDuration, DurationUnit, Quantity, Zspm_PTaskHRPlan_ID, Shift, zssm_section_id, Specification, Employee_ID, Datefrom, Zssm_WorkstepActivities_V_ID, AD_Client_ID, Planned_Durationunit, Costuom, Planned_Averageduration, zssm_workstep_v_id, Dateto, Planned_Quantity, AD_Org_ID, created, createdby, updated, updatedBy)" +
      "        VALUES ((?), (?), (?), TO_NUMBER(?), (?), TO_NUMBER(?), (?), (?), (?), TO_NUMBER(?), (?), TO_DATE(?), (?), (?), (?), (?), TO_NUMBER(?), (?), TO_DATE(?), TO_NUMBER(?), (?), now(), ?, now(), ?)";
