...
static Logger log4j = Logger.getLogger(CriticalItems2870CB3D8CD249C0A1A64926B042913AData.class);
  ...
  public String nextincomingdate;
  ...
  public String getField(String fieldName) {
    ...
    else if (fieldName.equalsIgnoreCase("nextincomingdate"))
      return nextincomingdate;
 ...
 */
  public static CriticalItems2870CB3D8CD249C0A1A64926B042913AData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "mrp_criticalitems_v.Desireddeliverydate, " +
      "COALESCE(mrp_criticalitems_v.isapproved, 'N') AS isapproved, " +
      "mrp_criticalitems_v.processing, " +
      "mrp_criticalitems_v.Documenttype, " +
      "mrp_criticalitems_v.C_Projecttask_ID, " +
      "(CASE WHEN mrp_criticalitems_v.C_Projecttask_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table3.Value), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table3.Name), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table2.Name), ''))),'') ) END) AS C_Projecttask_IDR, " +
      ...
      "mrp_criticalitems_v.Nextincomingdate, " +
      ...
      "(CASE WHEN mrp_criticalitems_v.C_Bpartner_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table7.Value), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table7.Name), ''))),'') ) END) AS C_Bpartner_IDR, " +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectCriticalItems2870CB3D8CD249C0A1A64926B042913AData.desireddeliverydate = UtilSql.getDateValue(result, "desireddeliverydate", "dd-MM-yyyy");
        objectCriticalItems2870CB3D8CD249C0A1A64926B042913AData.isapproved = UtilSql.getValue(result, "isapproved");
        objectCriticalItems2870CB3D8CD249C0A1A64926B042913AData.processing = UtilSql.getValue(result, "processing");
        ...
        objectCriticalItems2870CB3D8CD249C0A1A64926B042913AData.nextincomingdate = UtilSql.getDateValue(result, "nextincomingdate", "dd-MM-yyyy");
...
Create a registry
 */
  public static CriticalItems2870CB3D8CD249C0A1A64926B042913AData[] set(String isapproved, String updatedby, String updatedbyr, String processing, String adClientId, String isactive, String estimatedStockQty, String zssiOnhanqtyOverviewId, String mWarehouseId, String mProductId, String mProductIdr, String nextincomingdate, String cOrderlineId, String cBpartnerId, String cBpartnerIdr, String cUomId, String cProjecttaskId, String documenttype, String adOrgId, String mrpCriticalitemsVId, String mrpInoutplanVId, String mProductCategoryId, String planneddate, String createdby, String createdbyr, String movementqty, String desireddeliverydate)    throws ServletException {
    ...
    objectCriticalItems2870CB3D8CD249C0A1A64926B042913AData[0].desireddeliverydate = desireddeliverydate;
    objectCriticalItems2870CB3D8CD249C0A1A64926B042913AData[0].isapproved = isapproved;
    objectCriticalItems2870CB3D8CD249C0A1A64926B042913AData[0].processing = processing;
    ...
    objectCriticalItems2870CB3D8CD249C0A1A64926B042913AData[0].nextincomingdate = nextincomingdate;
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET M_Product_ID = (?) , Planneddate = TO_DATE(?) , Movementqty = TO_NUMBER(?) , Estimated_Stock_Qty = TO_NUMBER(?) , Desireddeliverydate = TO_DATE(?) , isapproved = (?) , processing = (?) , Documenttype = (?) , C_Projecttask_ID = (?) , C_Orderline_ID = (?) , Nextincomingdate = TO_DATE(?) , C_Uom_ID = (?) , C_Bpartner_ID = (?) , M_Product_Category_ID = (?) , M_Warehouse_ID = (?) , AD_Org_ID = (?) , MRP_Criticalitems_V_ID = (?) , Zssi_Onhanqty_Overview_ID = (?) , MRP_Inoutplan_V_ID = (?) , AD_Client_ID = (?) , isactive = (?) , updated = now(), updatedby = ? " +
    ...
    st = connectionProvider.getPreparedStatement(conn, strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, nextincomingdate);
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (M_Product_ID, Planneddate, Movementqty, Estimated_Stock_Qty, Desireddeliverydate, isapproved, processing, Documenttype, C_Projecttask_ID, C_Orderline_ID, Nextincomingdate, C_Uom_ID, C_Bpartner_ID, M_Product_Category_ID, M_Warehouse_ID, AD_Org_ID, MRP_Criticalitems_V_ID, Zssi_Onhanqty_Overview_ID, MRP_Inoutplan_V_ID, AD_Client_ID, isactive, created, createdby, updated, updatedBy)" +
      "        VALUES ((?), TO_DATE(?), TO_NUMBER(?), TO_NUMBER(?), TO_DATE(?), (?), (?), (?), (?), (?), TO_DATE(?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), now(), ?, now(), ?)";
