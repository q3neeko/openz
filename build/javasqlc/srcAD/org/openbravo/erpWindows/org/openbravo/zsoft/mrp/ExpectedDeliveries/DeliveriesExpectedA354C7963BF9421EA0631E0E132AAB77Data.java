  ...
  public static DeliveriesExpectedA354C7963BF9421EA0631E0E132AAB77Data[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectDeliveriesExpectedA354C7963BF9421EA0631E0E132AAB77Data.cBpartnerId = UtilSql.getValue(result, "c_bpartner_id");
        objectDeliveriesExpectedA354C7963BF9421EA0631E0E132AAB77Data.cBpartnerIdr = UtilSql.getValue(result, "c_bpartner_idr");
 ...
 */
  public static DeliveriesExpectedA354C7963BF9421EA0631E0E132AAB77Data[] set(String adOrgId, String isactive, String adClientId, String qtyordered, String line, String cOrderId, String overdue, String mrpDeliveriesExpectedId, String cProjectId, String cProjectIdr, String datedelivered, String updatedby, String updatedbyr, String cBpartnerId, String cBpartnerIdr, String description, String dateordered, String scheddeliverydate, String mProductId, String mProductIdr, String createdby, String createdbyr, String salesrepId, String cProjecttaskId, String qtydelivered, String datepromised, String aAssetId)    throws ServletException {
    ...
    objectDeliveriesExpectedA354C7963BF9421EA0631E0E132AAB77Data[0].cBpartnerId = cBpartnerId;
    objectDeliveriesExpectedA354C7963BF9421EA0631E0E132AAB77Data[0].cBpartnerIdr = cBpartnerIdr;
...
Select for auxiliar field
 */
  public static String selectDef2C0D738841434238958FE366271431F4_2(ConnectionProvider connectionProvider, String C_Bpartner_IDR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectDef967196860D134B87BB8A12512446251E_3(ConnectionProvider connectionProvider, String M_Product_IDR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectDef078698AD70344670950F4045C3B311D0_4(ConnectionProvider connectionProvider, String CreatedbyR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
