...
static Logger log4j = Logger.getLogger(WarehouseComplete7734B053AAB64F7D9F98370E67F61732Data.class);
  ...
  public String getField(String fieldName) {
    if (fieldName.equalsIgnoreCase("created"))
      ...
      return updatedbyr;
    else if (fieldName.equalsIgnoreCase("pcatvalue"))
      return pcatvalue;
    else if (fieldName.equalsIgnoreCase("pvalue"))
      return pvalue;
 ...
 */
  public static WarehouseComplete7734B053AAB64F7D9F98370E67F61732Data[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        zssi_onhanqty_overview.Pcatvalue, " +
      "zssi_onhanqty_overview.Pvalue, " +
      ...
      "zssi_onhanqty_overview.Qtyorderedframe, " +
      "zssi_onhanqty_overview.Qtyinsale, " +
      "zssi_onhanqty_overview.Qtyinsaleframe, " +
      ...
      "zssi_onhanqty_overview.M_Product_Category_ID, " +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectWarehouseComplete7734B053AAB64F7D9F98370E67F61732Data.pcatvalue = UtilSql.getValue(result, "pcatvalue");
        objectWarehouseComplete7734B053AAB64F7D9F98370E67F61732Data.pvalue = UtilSql.getValue(result, "pvalue");
        ...
        objectWarehouseComplete7734B053AAB64F7D9F98370E67F61732Data.qtyorderedframe = UtilSql.getValue(result, "qtyorderedframe");
        objectWarehouseComplete7734B053AAB64F7D9F98370E67F61732Data.qtyinsale = UtilSql.getValue(result, "qtyinsale");
        objectWarehouseComplete7734B053AAB64F7D9F98370E67F61732Data.qtyinsaleframe = UtilSql.getValue(result, "qtyinsaleframe");
        ...
        objectWarehouseComplete7734B053AAB64F7D9F98370E67F61732Data.mProductCategoryId = UtilSql.getValue(result, "m_product_category_id");
...
Create a registry
 */
  public static WarehouseComplete7734B053AAB64F7D9F98370E67F61732Data[] set(String qtyinsaleframe, String createdby, String createdbyr, String qtyreserved, String updatedby, String updatedbyr, String cUomId, String mProductCategoryId, String qtyorderedframe, String qtyoutflow, String adOrgId, String zssiOnhanqtyOverviewId, String pvalue, String qtyonhand, String qtyordered, String qtyinflow, String qtyinsale, String mAttributesetinstanceId, String mAttributesetinstanceIdr, String qtyincomming, String isactive, String pcatvalue, String adClientId, String mProductId, String mProductIdr, String mWarehouseId)    throws ServletException {
    ...
    objectWarehouseComplete7734B053AAB64F7D9F98370E67F61732Data[0].pcatvalue = pcatvalue;
    objectWarehouseComplete7734B053AAB64F7D9F98370E67F61732Data[0].pvalue = pvalue;
    ...
    objectWarehouseComplete7734B053AAB64F7D9F98370E67F61732Data[0].qtyorderedframe = qtyorderedframe;
    objectWarehouseComplete7734B053AAB64F7D9F98370E67F61732Data[0].qtyinsale = qtyinsale;
    objectWarehouseComplete7734B053AAB64F7D9F98370E67F61732Data[0].qtyinsaleframe = qtyinsaleframe;
    ...
    objectWarehouseComplete7734B053AAB64F7D9F98370E67F61732Data[0].mProductCategoryId = mProductCategoryId;
...
Select for auxiliar field
 */
  public static String selectDef0E3E9A242FFF48078962E13F2F28838D_1(ConnectionProvider connectionProvider, String UpdatedbyR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectDef8EBA1560E96748AC9C85E6ED41B0911C_2(ConnectionProvider connectionProvider, String M_Attributesetinstance_IDR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectDefF83F9AB95002421B9F5887FA6B62FC8B_3(ConnectionProvider connectionProvider, String M_Product_IDR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET Pcatvalue = (?) , Pvalue = (?) , M_Product_ID = (?) , M_Warehouse_ID = (?) , Qtyonhand = TO_NUMBER(?) , Qtyincomming = TO_NUMBER(?) , Qtyreserved = TO_NUMBER(?) , Qtyordered = TO_NUMBER(?) , Qtyorderedframe = TO_NUMBER(?) , Qtyinsale = TO_NUMBER(?) , Qtyinsaleframe = TO_NUMBER(?) , Qtyinflow = TO_NUMBER(?) , Qtyoutflow = TO_NUMBER(?) , C_Uom_ID = (?) , M_Attributesetinstance_ID = (?) , AD_Org_ID = (?) , Zssi_Onhanqty_Overview_ID = (?) , Isactive = (?) , M_Product_Category_ID = (?) , AD_Client_ID = (?) , updated = now(), updatedby = ? " +
    ...
    st = connectionProvider.getPreparedStatement(conn, strSql);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, pcatvalue);
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (Pcatvalue, Pvalue, M_Product_ID, M_Warehouse_ID, Qtyonhand, Qtyincomming, Qtyreserved, Qtyordered, Qtyorderedframe, Qtyinsale, Qtyinsaleframe, Qtyinflow, Qtyoutflow, C_Uom_ID, M_Attributesetinstance_ID, AD_Org_ID, Zssi_Onhanqty_Overview_ID, Isactive, M_Product_Category_ID, AD_Client_ID, created, createdby, updated, updatedBy)" +
