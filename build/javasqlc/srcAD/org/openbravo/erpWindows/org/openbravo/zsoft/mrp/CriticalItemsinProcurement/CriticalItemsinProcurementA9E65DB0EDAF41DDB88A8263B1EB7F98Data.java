  ...
  public static CriticalItemsinProcurementA9E65DB0EDAF41DDB88A8263B1EB7F98Data[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectCriticalItemsinProcurementA9E65DB0EDAF41DDB88A8263B1EB7F98Data.nextincomingdate = UtilSql.getDateValue(result, "nextincomingdate", "dd-MM-yyyy");
...
Create a registry
 */
  public static CriticalItemsinProcurementA9E65DB0EDAF41DDB88A8263B1EB7F98Data[] set(String updatedby, String updatedbyr, String adClientId, String isactive, String estimatedStockQty, String zssiOnhanqtyOverviewId, String mProductId, String mProductIdr, String mWarehouseId, String nextincomingdate, String cOrderlineId, String cUomId, String cBpartnerId, String cBpartnerIdr, String documenttype, String cProjecttaskId, String mrpInoutplanVId, String adOrgId, String mrpCriticalitemsVId, String mProductCategoryId, String planneddate, String createdby, String createdbyr, String movementqty)    throws ServletException {
    ...
    objectCriticalItemsinProcurementA9E65DB0EDAF41DDB88A8263B1EB7F98Data[0].nextincomingdate = nextincomingdate;
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET M_Product_ID = (?) , Planneddate = TO_DATE(?) , Movementqty = TO_NUMBER(?) , Estimated_Stock_Qty = TO_NUMBER(?) , Documenttype = (?) , C_Projecttask_ID = (?) , C_Orderline_ID = (?) , C_Uom_ID = (?) , Nextincomingdate = TO_DATE(?) , C_Bpartner_ID = (?) , M_Product_Category_ID = (?) , M_Warehouse_ID = (?) , AD_Org_ID = (?) , MRP_Criticalitems_V_ID = (?) , AD_Client_ID = (?) , isactive = (?) , MRP_Inoutplan_V_ID = (?) , Zssi_Onhanqty_Overview_ID = (?) , updated = now(), updatedby = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (M_Product_ID, Planneddate, Movementqty, Estimated_Stock_Qty, Documenttype, C_Projecttask_ID, C_Orderline_ID, C_Uom_ID, Nextincomingdate, C_Bpartner_ID, M_Product_Category_ID, M_Warehouse_ID, AD_Org_ID, MRP_Criticalitems_V_ID, AD_Client_ID, isactive, MRP_Inoutplan_V_ID, Zssi_Onhanqty_Overview_ID, created, createdby, updated, updatedBy)" +
