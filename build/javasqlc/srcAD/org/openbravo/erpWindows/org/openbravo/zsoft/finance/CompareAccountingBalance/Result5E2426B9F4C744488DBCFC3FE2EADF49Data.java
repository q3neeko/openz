 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET Zsfi_Susadatev_ID = (?) , C_Elementvalue_ID = (?) , Name = (?) , Beginningbalance = TO_NUMBER(?) , Credit = TO_NUMBER(?) , Debit = TO_NUMBER(?) , Endingbalance = TO_NUMBER(?) , Beginningbalancedatev = TO_NUMBER(?) , Creditdatev = TO_NUMBER(?) , Debitdatev = TO_NUMBER(?) , Endingbalancedatev = TO_NUMBER(?) , Difference = TO_NUMBER(?) , Isdifference = (?) , AD_Client_ID = (?) , AD_Org_ID = (?) , Zsfi_Susadatevaccounts_ID = (?) , Isactive = (?) , rowcolor = (?) , updated = now(), updatedby = ? " +
      "        WHERE zsfi_susadatevaccounts.Zsfi_Susadatevaccounts_ID = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (Zsfi_Susadatev_ID, C_Elementvalue_ID, Name, Beginningbalance, Credit, Debit, Endingbalance, Beginningbalancedatev, Creditdatev, Debitdatev, Endingbalancedatev, Difference, Isdifference, AD_Client_ID, AD_Org_ID, Zsfi_Susadatevaccounts_ID, Isactive, rowcolor, created, createdby, updated, updatedBy)" +
