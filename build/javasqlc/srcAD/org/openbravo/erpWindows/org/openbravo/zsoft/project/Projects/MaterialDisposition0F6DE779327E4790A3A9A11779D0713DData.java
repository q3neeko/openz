...
static Logger log4j = Logger.getLogger(MaterialDisposition0F6DE779327E4790A3A9A11779D0713DData.class);
  ...
  public String cSalesorderlineId;
  public String cSalesorderlineIdr;
  ...
  public String getField(String fieldName) {
    ...
    else if (fieldName.equalsIgnoreCase("c_salesorderline_id") || fieldName.equals("cSalesorderlineId"))
      return cSalesorderlineId;
    else if (fieldName.equalsIgnoreCase("c_salesorderline_idr") || fieldName.equals("cSalesorderlineIdr"))
      return cSalesorderlineIdr;
 ...
 */
  public static MaterialDisposition0F6DE779327E4790A3A9A11779D0713DData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String cProjecttaskId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN zspm_projecttaskbom_view.C_Projecttask_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table2.Value), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table2.Name), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS C_Projecttask_IDR, " +
      ...
      "zspm_projecttaskbom_view.C_Salesorderline_ID, " +
      "(CASE WHEN zspm_projecttaskbom_view.C_Salesorderline_ID IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table5.Line), ''))),'') ) END) AS C_Salesorderline_IDR, " +
      "COALESCE(zspm_projecttaskbom_view.Planrequisition, 'N') AS Planrequisition, " +
      "zspm_projecttaskbom_view.M_Requisitionline_ID, " +
      "(CASE WHEN zspm_projecttaskbom_view.M_Requisitionline_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table7.DocumentNo), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table8.Value), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL8.Name IS NULL THEN TO_CHAR(table8.Name) ELSE TO_CHAR(tableTRL8.Name) END)), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table6.Qty), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(table6.Needbydate, 'DD-MM-YYYY')),'') ) END) AS M_Requisitionline_IDR, " +
      "COALESCE(zspm_projecttaskbom_view.Directship, 'N') AS Directship, " +
      "zspm_projecttaskbom_view.C_Orderline_ID, " +
      "(CASE WHEN zspm_projecttaskbom_view.C_Orderline_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table10.DocumentNo), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table10.Name), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(table10.DateOrdered, 'DD-MM-YYYY')),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table10.GrandTotal), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table9.Line), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table9.LineNetAmt), ''))),'') ) END) AS C_Orderline_IDR, " +
      ...
      "        ? AS LANGUAGE " +
      "        FROM zspm_projecttaskbom_view left join (select C_Projecttask_ID, C_Project_ID, Name from C_Projecttask) table1 on (zspm_projecttaskbom_view.C_Projecttask_ID = table1.C_Projecttask_ID) left join (select C_Project_ID, Value, Name from C_Project) table2 on (table1.C_Project_ID = table2.C_Project_ID) left join (select M_Product_ID, Value, Name from M_Product) table3 on (zspm_projecttaskbom_view.M_Product_ID = table3.M_Product_ID) left join (select M_Product_ID,AD_Language, Name from M_Product_TRL) tableTRL3 on (table3.M_Product_ID = tableTRL3.M_Product_ID and tableTRL3.AD_Language = ?)  left join (select M_Locator_ID, Value from M_Locator) table4 on (zspm_projecttaskbom_view.M_Locator_ID = table4.M_Locator_ID) left join (select C_OrderLine_ID, Line from C_OrderLine) table5 on (zspm_projecttaskbom_view.C_Salesorderline_ID =  table5.C_OrderLine_ID) left join (select M_Requisitionline_ID, M_Requisition_ID, M_Product_ID, Qty, Needbydate from M_Requisitionline) table6 on (zspm_projecttaskbom_view.M_Requisitionline_ID = table6.M_Requisitionline_ID) left join (select M_Requisition_ID, DocumentNo from M_Requisition) table7 on (table6.M_Requisition_ID = table7.M_Requisition_ID) left join (select M_Product_ID, Value, Name from M_Product) table8 on (table6.M_Product_ID = table8.M_Product_ID) left join (select M_Product_ID,AD_Language, Name from M_Product_TRL) tableTRL8 on (table8.M_Product_ID = tableTRL8.M_Product_ID and tableTRL8.AD_Language = ?)  left join (select C_Orderline_ID, C_Order_ID, Line, LineNetAmt from C_Orderline) table9 on (zspm_projecttaskbom_view.C_Orderline_ID = table9.C_Orderline_ID) left join (select C_Order_ID, DocumentNo, Name, DateOrdered, GrandTotal from C_Order) table10 on (table9.C_Order_ID = table10.C_Order_ID)" +
      "        WHERE 2=2 " +
      "        AND 1=1 ";
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectMaterialDisposition0F6DE779327E4790A3A9A11779D0713DData.cSalesorderlineId = UtilSql.getValue(result, "c_salesorderline_id");
        objectMaterialDisposition0F6DE779327E4790A3A9A11779D0713DData.cSalesorderlineIdr = UtilSql.getValue(result, "c_salesorderline_idr");
        ...
        objectMaterialDisposition0F6DE779327E4790A3A9A11779D0713DData.directship = UtilSql.getValue(result, "directship");
        objectMaterialDisposition0F6DE779327E4790A3A9A11779D0713DData.cOrderlineId = UtilSql.getValue(result, "c_orderline_id");
        objectMaterialDisposition0F6DE779327E4790A3A9A11779D0713DData.cOrderlineIdr = UtilSql.getValue(result, "c_orderline_idr");
...
Create a registry
 */
  public static MaterialDisposition0F6DE779327E4790A3A9A11779D0713DData[] set(String cProjecttaskId, String qtyInstock, String isreturnafteruse, String adClientId, String constuctivemeasure, String mLocatorId, String mLocatorIdr, String cutoff, String line, String isactive, String actualcosamount, String datePlan, String qtyreceived, String cSalesorderlineId, String qtyreserved, String qtyinrequisition, String qtyOrdered, String qtyAvailable, String description, String rawmaterial, String quantity, String adOrgId, String mRequisitionlineId, String mProductId, String mProductIdr, String dateNextreceipt, String plannedamt, String updatedby, String updatedbyr, String qtyNextreceipt, String qtyInconsumption, String zspmProjecttaskbomViewId, String planrequisition, String qtyPlan, String cOrderlineId, String createdby, String createdbyr, String directship)    throws ServletException {
    ...
    objectMaterialDisposition0F6DE779327E4790A3A9A11779D0713DData[0].cSalesorderlineId = cSalesorderlineId;
    objectMaterialDisposition0F6DE779327E4790A3A9A11779D0713DData[0].cSalesorderlineIdr = "";
    ...
    objectMaterialDisposition0F6DE779327E4790A3A9A11779D0713DData[0].directship = directship;
    objectMaterialDisposition0F6DE779327E4790A3A9A11779D0713DData[0].cOrderlineId = cOrderlineId;
    objectMaterialDisposition0F6DE779327E4790A3A9A11779D0713DData[0].cOrderlineIdr = "";
 ...
 */
  public static String selectDefA6B12CC55F2040858356D4D480345AD2_0(ConnectionProvider connectionProvider, String M_Locator_IDR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectDef36D3710C11BA4C478269FA855BD6F9F1_1(ConnectionProvider connectionProvider, String M_Product_IDR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET C_Projecttask_ID = (?) , Line = TO_NUMBER(?) , M_Product_ID = (?) , Description = (?) , Constuctivemeasure = (?) , Rawmaterial = (?) , M_Locator_ID = (?) , QTY_Plan = TO_NUMBER(?) , Cutoff = TO_NUMBER(?) , Quantity = TO_NUMBER(?) , Date_Plan = TO_DATE(?) , isreturnafteruse = (?) , C_Salesorderline_ID = (?) , Planrequisition = (?) , M_Requisitionline_ID = (?) , Directship = (?) , C_Orderline_ID = (?) , Qtyreceived = TO_NUMBER(?) , QTY_Instock = TO_NUMBER(?) , QTY_Inconsumption = TO_NUMBER(?) , QTY_Available = TO_NUMBER(?) , Qtyinrequisition = TO_NUMBER(?) , QTY_Ordered = TO_NUMBER(?) , QTY_Nextreceipt = TO_NUMBER(?) , Date_Nextreceipt = TO_DATE(?) , Actualcosamount = TO_NUMBER(?) , plannedamt = TO_NUMBER(?) , Zspm_Projecttaskbom_View_ID = (?) , AD_Client_ID = (?) , AD_Org_ID = (?) , Isactive = (?) , Qtyreserved = TO_NUMBER(?) , updated = now(), updatedby = ? " +
      "        WHERE zspm_projecttaskbom_view.Zspm_Projecttaskbom_View_ID = ? " +
    ...
    st = connectionProvider.getPreparedStatement(conn, strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, cSalesorderlineId);
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (C_Projecttask_ID, Line, M_Product_ID, Description, Constuctivemeasure, Rawmaterial, M_Locator_ID, QTY_Plan, Cutoff, Quantity, Date_Plan, isreturnafteruse, C_Salesorderline_ID, Planrequisition, M_Requisitionline_ID, Directship, C_Orderline_ID, Qtyreceived, QTY_Instock, QTY_Inconsumption, QTY_Available, Qtyinrequisition, QTY_Ordered, QTY_Nextreceipt, Date_Nextreceipt, Actualcosamount, plannedamt, Zspm_Projecttaskbom_View_ID, AD_Client_ID, AD_Org_ID, Isactive, Qtyreserved, created, createdby, updated, updatedBy)" +
