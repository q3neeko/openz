 ...
 */
  public static Reportheader77515489D07B4FF3A7FA711D67F7E1DDData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN zspr_bwaheader.AD_Org_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS AD_Org_IDR, " +
      "zspr_bwaheader.Name, " +
      ...
      "        ? AS LANGUAGE " +
      "        FROM zspr_bwaheader left join (select AD_Org_ID, Name from AD_Org) table1 on (zspr_bwaheader.AD_Org_ID = table1.AD_Org_ID)" +
      "        WHERE 2=2 " +
      "        AND 1=1 " +
...
Create a registry
 */
  public static Reportheader77515489D07B4FF3A7FA711D67F7E1DDData[] set(String isactive, String updatedby, String updatedbyr, String createdby, String createdbyr, String zsprBwaheaderId, String adClientId, String btncopyto, String subheadertext, String name, String adOrgId, String footertext, String btndelete, String headertext)    throws ServletException {
