 ...
 */
  public static Header48F5831CC2A24D548535C7C31B499F92Data[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN zssi_crm_bpartner_v.C_Bpartner_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table2.Value), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table2.Name), ''))),'') ) END) AS C_Bpartner_IDR, " +
      ...
      "zssi_crm_bpartner_v.AD_Language, " +
      "(CASE WHEN zssi_crm_bpartner_v.AD_Language IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table10.Name), ''))),'') ) END) AS AD_LanguageR, " +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectHeader48F5831CC2A24D548535C7C31B499F92Data.phone2 = UtilSql.getValue(result, "phone2");
        ...
        objectHeader48F5831CC2A24D548535C7C31B499F92Data.adLanguage = UtilSql.getValue(result, "ad_language");
        objectHeader48F5831CC2A24D548535C7C31B499F92Data.adLanguager = UtilSql.getValue(result, "ad_languager");
...
Create a registry
 */
  public static Header48F5831CC2A24D548535C7C31B499F92Data[] set(String url, String phone2, String fax, String cBpartnerId, String cBpartnerIdr, String city, String interests, String iscustomer, String postal, String lastname, String adUserId, String comments, String birthday, String address1, String adOrgId, String email, String name, String phone, String adLanguage, String value, String description, String isvendor, String cBpartnerLocationId, String cBpartnerLocationIdr, String zssiCrmBpartnerVId, String updatedby, String updatedbyr, String adClientId, String cGreetingId, String cBpGroupId, String name2, String address2, String cCountryId, String isactive, String createdby, String createdbyr, String firstname)    throws ServletException {
    ...
    objectHeader48F5831CC2A24D548535C7C31B499F92Data[0].phone2 = phone2;
    ...
    objectHeader48F5831CC2A24D548535C7C31B499F92Data[0].adLanguage = adLanguage;
    objectHeader48F5831CC2A24D548535C7C31B499F92Data[0].adLanguager = "";
...
Select for auxiliar field
 */
  public static String selectDef1028B6FF6E2F48F9924C3664CF65AEDE_1(ConnectionProvider connectionProvider, String C_Bpartner_Location_IDR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectDefADEBD01B98BC4CAE906F348029B46331_2(ConnectionProvider connectionProvider, String UpdatedbyR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectDef6A1F15EE209248E4BB17A475459D8B9F_3(ConnectionProvider connectionProvider, String CreatedbyR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Org_ID, C_Bpartner_ID, Value, Name, Name2, Url, C_Bp_Group_ID, C_Bpartner_Location_ID, Address1, Address2, Postal, City, C_Country_ID, AD_User_ID, C_Greeting_ID, Firstname, Lastname, Email, Phone, Phone2, Fax, Birthday, Description, Comments, Interests, AD_Language, Iscustomer, Isvendor, Isactive, Zssi_Crm_Bpartner_V_ID, AD_Client_ID, created, createdby, updated, updatedBy)" +
