 ...
 */
  public static WarehouseQuantitiesACD5DA3B4BE44D39825D0198F7DD4317Data[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String zssiOnhanqtyOverviewId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN zssi_onhanqty.M_Attributesetinstance_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table8.Description), ''))),'') ) END) AS M_Attributesetinstance_IDR, " +
      "zssi_onhanqty.M_Product_Category_ID, " +
      "(CASE WHEN zssi_onhanqty.M_Product_Category_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table9.Name), ''))),'') ) END) AS M_Product_Category_IDR, " +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectWarehouseQuantitiesACD5DA3B4BE44D39825D0198F7DD4317Data.qtyorderedframe = UtilSql.getValue(result, "qtyorderedframe");
        objectWarehouseQuantitiesACD5DA3B4BE44D39825D0198F7DD4317Data.qtyinsale = UtilSql.getValue(result, "qtyinsale");
        objectWarehouseQuantitiesACD5DA3B4BE44D39825D0198F7DD4317Data.qtyinsaleframe = UtilSql.getValue(result, "qtyinsaleframe");
...
Create a registry
 */
  public static WarehouseQuantitiesACD5DA3B4BE44D39825D0198F7DD4317Data[] set(String zssiOnhanqtyOverviewId, String qtyorderedframe, String mLocatorId, String mLocatorIdr, String mProductId, String mProductIdr, String createdby, String createdbyr, String updatedby, String updatedbyr, String qtyinflow, String qtyordered, String qtyinsale, String mProductCategoryId, String zssiOnhanqtyId, String mWarehouseId, String qtyoutflow, String adOrgId, String isactive, String adClientId, String mAttributesetinstanceId, String mAttributesetinstanceIdr, String qtyinsaleframe, String qtyonhand, String qtyincomming, String cUomId, String qtyreserved)    throws ServletException {
    ...
    objectWarehouseQuantitiesACD5DA3B4BE44D39825D0198F7DD4317Data[0].qtyorderedframe = qtyorderedframe;
    objectWarehouseQuantitiesACD5DA3B4BE44D39825D0198F7DD4317Data[0].qtyinsale = qtyinsale;
    objectWarehouseQuantitiesACD5DA3B4BE44D39825D0198F7DD4317Data[0].qtyinsaleframe = qtyinsaleframe;
 ...
 */
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (Zssi_Onhanqty_Overview_ID, M_Product_ID, M_Warehouse_ID, M_Locator_ID, QtyOnHand, QtyIncomming, Qtyreserved, Qtyordered, Qtyorderedframe, QtyInsale, Qtyinsaleframe, Qtyinflow, Qtyoutflow, C_Uom_ID, M_Attributesetinstance_ID, M_Product_Category_ID, Zssi_Onhanqty_ID, AD_Org_ID, AD_Client_ID, Isactive, created, createdby, updated, updatedBy)" +
