 ...
 */
  public static Shift800171Data[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String maCcpGroupId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN MA_CCP_Shift.AD_Org_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS AD_Org_IDR, " +
      "MA_CCP_Shift.MA_CCP_Group_ID, " +
      "(CASE WHEN MA_CCP_Shift.MA_CCP_Group_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table2.Name), ''))),'') ) END) AS MA_CCP_Group_IDR, " +
      ...
      "        ? AS LANGUAGE " +
      "        FROM MA_CCP_Shift left join (select AD_Org_ID, Name from AD_Org) table1 on (MA_CCP_Shift.AD_Org_ID = table1.AD_Org_ID) left join (select MA_CCP_Group_ID, Name from MA_CCP_Group) table2 on (MA_CCP_Shift.MA_CCP_Group_ID = table2.MA_CCP_Group_ID) left join ad_ref_list_v list1 on (MA_CCP_Shift.Shift = list1.value and list1.ad_reference_id = '800038' and list1.ad_language = ?) " +
      "        WHERE 2=2 " +
      "        AND 1=1 ";
...
Create a registry
 */
  public static Shift800171Data[] set(String maCcpGroupId, String updatedby, String updatedbyr, String adClientId, String shift, String createdby, String createdbyr, String maCcpShiftId, String adOrgId, String starttime, String endtime, String isactive)    throws ServletException {
