 ...
 */
  public static TranslationA4B7689C80B64900ADF1DF4692E8D59DData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String zssiTradeareaId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN zssi_tradearea_trl.AD_Org_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS AD_Org_IDR, " +
      "zssi_tradearea_trl.AD_Language, " +
      "(CASE WHEN zssi_tradearea_trl.AD_Language IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table2.Name), ''))),'') ) END) AS AD_LanguageR, " +
      ...
      "        ? AS LANGUAGE " +
      "        FROM zssi_tradearea_trl left join (select AD_Org_ID, Name from AD_Org) table1 on (zssi_tradearea_trl.AD_Org_ID = table1.AD_Org_ID) left join (select AD_Language, Name from AD_Language) table2 on (zssi_tradearea_trl.AD_Language =  table2.AD_Language)" +
      "        WHERE 2=2 " +
      "        AND 1=1 ";
...
Create a registry
 */
  public static TranslationA4B7689C80B64900ADF1DF4692E8D59DData[] set(String zssiTradeareaId, String zssiTradeareaTrlId, String adLanguage, String isactive, String createdby, String createdbyr, String istranslated, String updatedby, String updatedbyr, String adOrgId, String adClientId, String text)    throws ServletException {
