 ...
 */
  public static BankAccount56F5E1D49CFE4DAA9B372DCDD0F2AAC3Data[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String cBpartnerId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN C_BP_BankAccount.C_BPartner_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Value), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS C_BPartner_IDR, " +
...
Create a registry
 */
  public static BankAccount56F5E1D49CFE4DAA9B372DCDD0F2AAC3Data[] set(String cBpartnerId, String aStreet, String text1, String cCountryId, String displayedaccount, String aEmail, String aCountry, String showaccountno, String creditcardexpmm, String aZip, String creditcardnumber, String iban, String createdby, String createdbyr, String routingno, String aCity, String bankaccounttype, String adOrgId, String aName, String creditcardtype, String cBpartnerIdr, String created, String bankName, String adUserId, String swiftcode, String showiban, String creditcardexpyy, String accountno, String rAvszip, String adClientId, String aState, String aIdentDl, String isactive, String aIdentSsn, String updatedby, String updatedbyr, String cBpBankaccountId)    throws ServletException {
