 ...
 */
  public static Maintenance800188Data[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN MA_Maint_Scheduled.MA_Maintenance_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table2.Name), ''))),'') ) END) AS MA_Maintenance_IDR, " +
      ...
      "(CASE WHEN MA_Maint_Scheduled.MA_Machine_Type_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table3.Name), ''))),'') ) END) AS MA_Machine_Type_IDR, " +
      ...
      "(CASE WHEN MA_Maint_Scheduled.MA_Maint_Operation_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table5.Name), ''))),'') ) END) AS MA_Maint_Operation_IDR, " +
      "MA_Maint_Scheduled.Description, " +
      "COALESCE(MA_Maint_Scheduled.Confirmed, 'N') AS Confirmed, " +
      "MA_Maint_Scheduled.MA_Maint_Part_ID, " +
      "(CASE WHEN MA_Maint_Scheduled.MA_Maint_Part_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table6.DocumentNo), ''))),'') ) END) AS MA_Maint_Part_IDR, " +
...
Create a registry
 */
  public static Maintenance800188Data[] set(String maMaintOperationId, String confirmed, String maMaintenanceId, String shift, String observation, String mInternalConsumptionId, String maMaintPartId, String result, String isactive, String maintenanceType, String createdby, String createdbyr, String maMaintScheduledId, String maMachineId, String adOrgId, String scheduleddate, String updatedby, String updatedbyr, String maMachineTypeId, String usedtime, String description, String adClientId)    throws ServletException {
