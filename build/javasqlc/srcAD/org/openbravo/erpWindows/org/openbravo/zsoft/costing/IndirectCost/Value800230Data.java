...
static Logger log4j = Logger.getLogger(Value800230Data.class);
  ...
  public String appliesonlytomachineandemployees;
  public String total;
  ...
  public String getField(String fieldName) {
    if (fieldName.equalsIgnoreCase("created"))
      ...
      return vendorcost;
    else if (fieldName.equalsIgnoreCase("appliesonlytomachineandemployees"))
      return appliesonlytomachineandemployees;
 ...
 */
  public static Value800230Data[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String maIndirectCostId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "COALESCE(MA_Indirect_Cost_Value.Appliesonlytomachineandemployees, 'N') AS Appliesonlytomachineandemployees, " +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectValue800230Data.appliesonlytomachineandemployees = UtilSql.getValue(result, "appliesonlytomachineandemployees");
 ...
 */
  public static Value800230Data[] set(String maIndirectCostId, String costUom, String datefrom, String empcost, String vendorcost, String materialcost, String appliesonlytomachineandemployees, String maIndirectCostValueId, String dateto, String machinecost, String createdby, String createdbyr, String updatedby, String updatedbyr, String calculated, String adOrgId, String isactive, String adClientId, String total)    throws ServletException {
    ...
    objectValue800230Data[0].appliesonlytomachineandemployees = appliesonlytomachineandemployees;
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET MA_Indirect_Cost_ID = (?) , IsActive = (?) , DateFrom = TO_DATE(?) , Cost_Uom = (?) , empCost = TO_NUMBER(?) , Machinecost = TO_NUMBER(?) , Materialcost = TO_NUMBER(?) , Vendorcost = TO_NUMBER(?) , Appliesonlytomachineandemployees = (?) , Total = TO_NUMBER(?) , AD_Client_ID = (?) , AD_Org_ID = (?) , DateTo = TO_DATE(?) , MA_Indirect_Cost_Value_ID = (?) , Calculated = (?) , updated = now(), updatedby = ? " +
      "        WHERE MA_Indirect_Cost_Value.MA_Indirect_Cost_Value_ID = ? " +
    ...
    st = connectionProvider.getPreparedStatement(conn, strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, appliesonlytomachineandemployees);
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (MA_Indirect_Cost_ID, IsActive, DateFrom, Cost_Uom, empCost, Machinecost, Materialcost, Vendorcost, Appliesonlytomachineandemployees, Total, AD_Client_ID, AD_Org_ID, DateTo, MA_Indirect_Cost_Value_ID, Calculated, created, createdby, updated, updatedBy)" +
      "        VALUES ((?), (?), TO_DATE(?), (?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), (?), TO_NUMBER(?), (?), (?), TO_DATE(?), (?), (?), now(), ?, now(), ?)";
