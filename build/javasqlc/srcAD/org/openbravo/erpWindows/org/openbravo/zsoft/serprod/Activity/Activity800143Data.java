 ...
 */
  public static Activity800143Data[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN MA_Process.MA_Costcenter_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table2.Name), ''))),'') ) END) AS MA_Costcenter_IDR, " +
      ...
      "        ? AS LANGUAGE " +
      "        FROM MA_Process left join (select AD_Org_ID, Name from AD_Org) table1 on (MA_Process.AD_Org_ID = table1.AD_Org_ID) left join (select MA_Costcenter_ID, Name from MA_Costcenter) table2 on (MA_Process.MA_Costcenter_ID = table2.MA_Costcenter_ID) left join (select MA_Workstation_ID, Name from MA_Workstation) table3 on (MA_Process.MA_Workstation_ID = table3.MA_Workstation_ID)" +
      "        WHERE 2=2 " +
      "        AND 1=1 " +
...
Create a registry
 */
  public static Activity800143Data[] set(String isactive, String maProcessId, String value, String adOrgId, String updatedby, String updatedbyr, String createdby, String createdbyr, String name, String adClientId, String maWorkstationId, String description, String maCostcenterId)    throws ServletException {
