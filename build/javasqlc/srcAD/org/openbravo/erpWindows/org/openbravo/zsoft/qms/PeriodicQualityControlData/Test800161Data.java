 ...
 */
  public static Test800161Data[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN MA_PC_Case.M_Product_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table3.Value), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL3.Name IS NULL THEN TO_CHAR(table3.Name) ELSE TO_CHAR(tableTRL3.Name) END)), ''))),'') ) END) AS M_Product_IDR, " +
...
Create a registry
 */
  public static Test800161Data[] set(String maPcCaseId, String adClientId, String mAttributesetinstanceId, String mAttributesetinstanceIdr, String isactive, String startdate, String adOrgId, String updatedby, String updatedbyr, String name, String enddate, String launched, String maPeriodicControlId, String mProductId, String mProductIdr, String createdby, String createdbyr)    throws ServletException {
