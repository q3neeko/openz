  ...
  public static Activities6F92F616B40C49FD9F2E8DE87216DD55Data[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String zssmWorkstepVId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectActivities6F92F616B40C49FD9F2E8DE87216DD55Data.dateto = UtilSql.getDateValue(result, "dateto", "dd-MM-yyyy");
        ...
        objectActivities6F92F616B40C49FD9F2E8DE87216DD55Data.zssmWorkstepPrpVId = UtilSql.getValue(result, "zssm_workstep_prp_v_id");
...
Create a registry
 */
  public static Activities6F92F616B40C49FD9F2E8DE87216DD55Data[] set(String zssmWorkstepVId, String isactive, String updatedby, String updatedbyr, String zssmWorkstepactivitiesVId, String plannedAverageduration, String shift, String zssmSectionId, String plannedQuantity, String dateto, String plannedDurationunit, String adOrgId, String durationunit, String zspmPtaskhrplanId, String costuom, String createdby, String createdbyr, String employeeId, String quantity, String datefrom, String adClientId, String averageduration, String specification, String cSalaryCategoryId, String zssmWorkstepPrpVId)    throws ServletException {
    ...
    objectActivities6F92F616B40C49FD9F2E8DE87216DD55Data[0].dateto = dateto;
    ...
    objectActivities6F92F616B40C49FD9F2E8DE87216DD55Data[0].zssmWorkstepPrpVId = zssmWorkstepPrpVId;
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET zssm_workstep_v_id = (?) , C_Salary_Category_ID = (?) , AverageDuration = TO_NUMBER(?) , DurationUnit = (?) , Quantity = TO_NUMBER(?) , Employee_ID = (?) , Shift = (?) , Datefrom = TO_DATE(?) , Dateto = TO_DATE(?) , Specification = TO_NUMBER(?) , IsActive = (?) , Planned_Averageduration = TO_NUMBER(?) , Planned_Durationunit = (?) , Planned_Quantity = TO_NUMBER(?) , Zspm_PTaskHRPlan_ID = (?) , AD_Org_ID = (?) , Costuom = (?) , Zssm_Workstep_Prp_V_ID = (?) , AD_Client_ID = (?) , zssm_section_id = (?) , Zssm_WorkstepActivities_V_ID = (?) , updated = now(), updatedby = ? " +
      "        WHERE zssm_workstepactivities_v.Zssm_WorkstepActivities_V_ID = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (zssm_workstep_v_id, C_Salary_Category_ID, AverageDuration, DurationUnit, Quantity, Employee_ID, Shift, Datefrom, Dateto, Specification, IsActive, Planned_Averageduration, Planned_Durationunit, Planned_Quantity, Zspm_PTaskHRPlan_ID, AD_Org_ID, Costuom, Zssm_Workstep_Prp_V_ID, AD_Client_ID, zssm_section_id, Zssm_WorkstepActivities_V_ID, created, createdby, updated, updatedBy)" +
      "        VALUES ((?), (?), TO_NUMBER(?), (?), TO_NUMBER(?), (?), (?), TO_DATE(?), TO_DATE(?), TO_NUMBER(?), (?), TO_NUMBER(?), (?), TO_NUMBER(?), (?), (?), (?), (?), (?), (?), (?), now(), ?, now(), ?)";
