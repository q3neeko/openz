 ...
 */
  public static OrganizationTypeData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN AD_OrgType.AD_Org_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS AD_Org_IDR, " +
      ...
      "        ? AS LANGUAGE " +
      "        FROM AD_OrgType left join (select AD_Org_ID, Name from AD_Org) table1 on (AD_OrgType.AD_Org_ID = table1.AD_Org_ID)" +
      "        WHERE 2=2 " +
      "        AND 1=1 " +
...
Create a registry
 */
  public static OrganizationTypeData[] set(String updatedby, String adOrgtypeId, String isacctlegalentity, String isdefault, String isbusinessunit, String isactive, String createdby, String islegalentity, String istransactionsallowed, String name, String description, String adClientId, String adOrgId)    throws ServletException {
