 ...
 */
  public static GoodsTransactionData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN M_Transaction.C_Projecttask_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table10.Value), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table10.Name), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table9.Name), ''))),'') ) END) AS C_Projecttask_IDR, " +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectGoodsTransactionData.snrMasterdataId = UtilSql.getValue(result, "snr_masterdata_id");
        objectGoodsTransactionData.snrMasterdataIdr = UtilSql.getValue(result, "snr_masterdata_idr");
 ...
 */
  public static GoodsTransactionData[] set(String mInventorylineId, String mProductId, String mProductIdr, String mInternalConsumptionlineId, String snrMasterdataId, String cProjectId, String mAttributesetinstanceId, String mAttributesetinstanceIdr, String movementqty, String cUomId, String cProjectissueId, String cProjecttaskId, String quantityorder, String mTransactionId, String adClientId, String movementtype, String adOrgId, String mMovementlineId, String mInoutlineId, String mInoutlineIdr, String mLocatorId, String mLocatorIdr, String createdby, String createdbyr, String cProjectphaseId, String updatedby, String updatedbyr, String mProductUomId, String isactive, String mProductionlineId, String movementdate, String aAssetId)    throws ServletException {
    ...
    objectGoodsTransactionData[0].snrMasterdataId = snrMasterdataId;
    objectGoodsTransactionData[0].snrMasterdataIdr = "";
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET AD_Org_ID = (?) , M_Locator_ID = (?) , MovementDate = TO_DATE(?) , M_Product_ID = (?) , M_AttributeSetInstance_ID = (?) , MovementType = (?) , MovementQty = TO_NUMBER(?) , C_UOM_ID = (?) , QuantityOrder = TO_NUMBER(?) , M_Product_Uom_Id = (?) , C_Project_ID = (?) , C_Projecttask_ID = (?) , A_Asset_ID = (?) , M_Internal_Consumptionline_ID = (?) , M_InOutLine_ID = (?) , M_InventoryLine_ID = (?) , M_ProductionLine_ID = (?) , M_MovementLine_ID = (?) , SNR_Masterdata_ID = (?) , AD_Client_ID = (?) , M_Transaction_ID = (?) , C_Projectphase_ID = (?) , C_ProjectIssue_ID = (?) , IsActive = (?) , updated = now(), updatedby = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Org_ID, M_Locator_ID, MovementDate, M_Product_ID, M_AttributeSetInstance_ID, MovementType, MovementQty, C_UOM_ID, QuantityOrder, M_Product_Uom_Id, C_Project_ID, C_Projecttask_ID, A_Asset_ID, M_Internal_Consumptionline_ID, M_InOutLine_ID, M_InventoryLine_ID, M_ProductionLine_ID, M_MovementLine_ID, SNR_Masterdata_ID, AD_Client_ID, M_Transaction_ID, C_Projectphase_ID, C_ProjectIssue_ID, IsActive, created, createdby, updated, updatedBy)" +
