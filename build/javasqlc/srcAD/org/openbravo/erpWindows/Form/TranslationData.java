 ...
 */
  public static TranslationData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String adFormId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN AD_Form_Trl.AD_Org_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS AD_Org_IDR, " +
      "AD_Form_Trl.AD_Form_ID, " +
      "(CASE WHEN AD_Form_Trl.AD_Form_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table2.Name), ''))),'') ) END) AS AD_Form_IDR, " +
      "AD_Form_Trl.AD_Language, " +
      "(CASE WHEN AD_Form_Trl.AD_Language IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table3.Name), ''))),'') ) END) AS AD_LanguageR, " +
      ...
      "AD_Form_Trl.Help, " +
      "        ? AS LANGUAGE " +
      "        FROM AD_Form_Trl left join (select AD_Org_ID, Name from AD_Org) table1 on (AD_Form_Trl.AD_Org_ID = table1.AD_Org_ID) left join (select AD_Form_ID, Name from AD_Form) table2 on (AD_Form_Trl.AD_Form_ID = table2.AD_Form_ID) left join (select AD_Language, Name from AD_Language) table3 on (AD_Form_Trl.AD_Language =  table3.AD_Language)" +
      "        WHERE 2=2 " +
      "        AND 1=1 ";
...
Create a registry
 */
  public static TranslationData[] set(String adFormId, String description, String updatedby, String updatedbyr, String adOrgId, String adFormTrlId, String name, String createdby, String createdbyr, String adLanguage, String adClientId, String help, String istranslated, String isactive)    throws ServletException {
