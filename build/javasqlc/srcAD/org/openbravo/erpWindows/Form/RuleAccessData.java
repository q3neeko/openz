 ...
 */
  public static RuleAccessData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String adFormId, String key, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN AD_Form_Access.AD_Form_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table2.Name), ''))),'') ) END) AS AD_Form_IDR, " +
...
Create a registry
 */
  public static RuleAccessData[] set(String adFormId, String adRoleId, String isreadwrite, String createdby, String createdbyr, String adFormAccessId, String adOrgId, String adClientId, String isactive, String updatedby, String updatedbyr)    throws ServletException {
