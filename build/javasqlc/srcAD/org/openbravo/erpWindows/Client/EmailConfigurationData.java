 ...
 */
  public static EmailConfigurationData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String AD_Client_ID, String adClientId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN C_POC_CONFIGURATION.AD_Org_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS AD_Org_IDR, " +
      ...
      "        ? AS LANGUAGE " +
      "        FROM C_POC_CONFIGURATION left join (select AD_Org_ID, Name from AD_Org) table1 on (C_POC_CONFIGURATION.AD_Org_ID = table1.AD_Org_ID)" +
      "        WHERE 2=2 " +
