 ...
 */
  public static InformationData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN AD_ClientInfo.AD_Tree_Org_ID IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS AD_Tree_Org_IDR, " +
      "AD_ClientInfo.AD_Tree_Menu_ID, " +
      "(CASE WHEN AD_ClientInfo.AD_Tree_Menu_ID IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table2.Name), ''))),'') ) END) AS AD_Tree_Menu_IDR, " +
      "AD_ClientInfo.AD_Tree_BPartner_ID, " +
      "(CASE WHEN AD_ClientInfo.AD_Tree_BPartner_ID IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table3.Name), ''))),'') ) END) AS AD_Tree_BPartner_IDR, " +
      "AD_ClientInfo.AD_Tree_Product_ID, " +
      "(CASE WHEN AD_ClientInfo.AD_Tree_Product_ID IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table4.Name), ''))),'') ) END) AS AD_Tree_Product_IDR, " +
      "AD_ClientInfo.AD_Tree_Project_ID, " +
      "(CASE WHEN AD_ClientInfo.AD_Tree_Project_ID IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table5.Name), ''))),'') ) END) AS AD_Tree_Project_IDR, " +
      "AD_ClientInfo.AD_Tree_SalesRegion_ID, " +
      "(CASE WHEN AD_ClientInfo.AD_Tree_SalesRegion_ID IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table6.Name), ''))),'') ) END) AS AD_Tree_SalesRegion_IDR, " +
      ...
      "        ? AS LANGUAGE " +
      "        FROM AD_ClientInfo left join (select AD_Tree_ID, Name from AD_Tree) table1 on (AD_ClientInfo.AD_Tree_Org_ID =  table1.AD_Tree_ID) left join (select AD_Tree_ID, Name from AD_Tree) table2 on (AD_ClientInfo.AD_Tree_Menu_ID =  table2.AD_Tree_ID) left join (select AD_Tree_ID, Name from AD_Tree) table3 on (AD_ClientInfo.AD_Tree_BPartner_ID =  table3.AD_Tree_ID) left join (select AD_Tree_ID, Name from AD_Tree) table4 on (AD_ClientInfo.AD_Tree_Product_ID =  table4.AD_Tree_ID) left join (select AD_Tree_ID, Name from AD_Tree) table5 on (AD_ClientInfo.AD_Tree_Project_ID =  table5.AD_Tree_ID) left join (select AD_Tree_ID, Name from AD_Tree) table6 on (AD_ClientInfo.AD_Tree_SalesRegion_ID =  table6.AD_Tree_ID)" +
      "        WHERE 2=2 " +
      "        AND 1=1 " +
...
Create a registry
 */
  public static InformationData[] set(String yourCompanyDocumentImage, String mProductfreightId, String yourCompanyMenuImage, String cUomWeightId, String allownegativestock, String isactive, String updatedby, String updatedbyr, String mPricelistId, String cCalendarId, String cAcctschema3Id, String adTreeMenuId, String checkorderorg, String adTreeOrgId, String isdiscountlineamt, String groupacctinvlines, String cAcctschema2Id, String acct2Active, String adTreeSalesregionId, String checkinoutorg, String acct3Active, String cUomTimeId, String cAcctschema1Id, String adTreeProductId, String adClientId, String createdby, String createdbyr, String adTreeBpartnerId, String cBpartnercashtrxId, String adOrgId, String cUomLengthId, String yourCompanyBigImage, String cUomVolumeId, String adTreeProjectId)    throws ServletException {
