 ...
 */
  public static TranslationData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String adElementId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN AD_Element_Trl.AD_Org_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS AD_Org_IDR, " +
      "AD_Element_Trl.AD_Element_ID, " +
      "(CASE WHEN AD_Element_Trl.AD_Element_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table2.ColumnName), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table2.Name), ''))),'') ) END) AS AD_Element_IDR, " +
      "AD_Element_Trl.AD_Language, " +
      "(CASE WHEN AD_Element_Trl.AD_Language IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table3.Name), ''))),'') ) END) AS AD_LanguageR, " +
      ...
      "        ? AS LANGUAGE " +
      "        FROM AD_Element_Trl left join (select AD_Org_ID, Name from AD_Org) table1 on (AD_Element_Trl.AD_Org_ID = table1.AD_Org_ID) left join (select AD_Element_ID, ColumnName, Name from AD_Element) table2 on (AD_Element_Trl.AD_Element_ID = table2.AD_Element_ID) left join (select AD_Language, Name from AD_Language) table3 on (AD_Element_Trl.AD_Language =  table3.AD_Language)" +
      "        WHERE 2=2 " +
      "        AND 1=1 ";
...
Create a registry
 */
  public static TranslationData[] set(String adElementId, String poDescription, String istranslated, String poHelp, String adClientId, String name, String adLanguage, String adOrgId, String createdby, String createdbyr, String poName, String help, String isactive, String adElementTrlId, String updatedby, String updatedbyr, String printname, String poPrintname, String description)    throws ServletException {
