 ...
 */
  public static CountryData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "C_Country.AD_Org_ID, " +
      "(CASE WHEN C_Country.AD_Org_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS AD_Org_IDR, " +
      ...
      "(CASE WHEN C_Country.AD_Language IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table2.Name), ''))),'') ) END) AS AD_LanguageR, " +
      "C_Country.C_Currency_ID, " +
      "(CASE WHEN C_Country.C_Currency_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table3.ISO_Code), ''))),'') ) END) AS C_Currency_IDR, " +
      "C_Country.IBANCountry, " +
      "C_Country.IBANNoDigits, " +
      "        ? AS LANGUAGE " +
      "        FROM C_Country left join (select AD_Org_ID, Name from AD_Org) table1 on (C_Country.AD_Org_ID = table1.AD_Org_ID) left join (select AD_Language, Name from AD_Language) table2 on (C_Country.AD_Language =  table2.AD_Language) left join (select C_Currency_ID, ISO_Code from C_Currency) table3 on (C_Country.C_Currency_ID = table3.C_Currency_ID)" +
      "        WHERE 2=2 " +
      "        AND 1=1 " +
...
Create a registry
 */
  public static CountryData[] set(String cCurrencyId, String name, String adLanguage, String hasregion, String expressionpostal, String expressionpostalAdd, String countrycode, String expressionphone, String ibannodigits, String adClientId, String description, String updatedby, String updatedbyr, String displaysequence, String ibancountry, String createdby, String createdbyr, String isactive, String isdefault, String cCountryId, String haspostalAdd, String regionname, String adOrgId)    throws ServletException {
