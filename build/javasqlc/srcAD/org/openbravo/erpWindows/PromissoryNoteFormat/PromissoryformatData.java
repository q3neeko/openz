 ...
 */
  public static PromissoryformatData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN C_PromissoryFormat.AD_Org_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS AD_Org_IDR, " +
      "C_PromissoryFormat.Name, " +
      "C_PromissoryFormat.Description, " +
      "C_PromissoryFormat.C_BankAccount_ID, " +
      "(CASE WHEN C_PromissoryFormat.C_BankAccount_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table2.DisplayedAccount), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table3.ISO_Code), ''))),'') ) END) AS C_BankAccount_IDR, " +
...
Create a registry
 */
  public static PromissoryformatData[] set(String line3top, String updatedby, String updatedbyr, String cPromissoryformatId, String param42, String line4left, String fontamount, String line4top, String param11, String param43, String fontdayplanned, String fontdaytoday, String param12, String param13, String line2left, String printbankloc, String cBankaccountId, String line1top, String name, String param41, String fontmonthtoday, String fontamounttext, String adOrgId, String fontmonthplanned, String fontyearplanned, String line2top, String line1left, String createdby, String createdbyr, String line3left, String adClientId, String isactive, String param32, String description, String fontyeartoday, String param31, String fontpartnername)    throws ServletException {
