 ...
 */
  public static TableData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "AD_Table.AD_Org_ID, " +
      "(CASE WHEN AD_Table.AD_Org_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS AD_Org_IDR, " +
      "AD_Table.SQL_Record_Identifier, " +
      "AD_Table.AD_Package_ID, " +
      "(CASE WHEN AD_Table.AD_Package_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table2.Name), ''))),'') ) END) AS AD_Package_IDR, " +
      "AD_Table.Name, " +
...
Create a registry
 */
  public static TableData[] set(String help, String adClientId, String sqlRecordIdentifier, String treetype, String classname, String developmentstatus, String name, String issecurityenabled, String accesslevel, String updatedby, String updatedbyr, String tablename, String acctclassname, String isdefaultacct, String adWindowId, String createdby, String createdbyr, String isview, String importtable, String adOrgId, String description, String isactive, String isdeleteable, String ishighvolume, String adTableId, String acctdateColumnId, String adPackageId, String ischangelog, String poWindowId)    throws ServletException {
