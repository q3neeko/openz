...
Create a registry
 */
  public static PaymentData[] set(String cInvoiceId, String cCurrencyId, String cCashlineId, String cBankstatementlineId, String isreceipt, String isactive, String ispaid, String cBpBankaccountId, String cBankaccountId, String adClientId, String discountamt, String cancelProcessed, String writeoffamt, String cDebtPaymentId, String description, String ismanual, String isvalid, String createdby, String createdbyr, String cInvoiceIdr, String cSettlementCancelId, String dateplanned, String changesettlementcancel, String cCashbookId, String adOrgId, String amount, String isautomaticgenerated, String paymentrule, String statusInitial, String generateProcessed, String cProjectId, String updatedby, String updatedbyr, String cSettlementGenerateId, String cBpartnerId, String cBpartnerIdr)    throws ServletException {
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET Amount = TO_NUMBER(?) , C_Currency_ID = (?) , WriteOffAmt = TO_NUMBER(?) , Discountamt = TO_NUMBER(?) , IsPaid = (?) , AD_Client_ID = (?) , AD_Org_ID = (?) , C_Invoice_ID = (?) , C_Settlement_Cancel_ID = (?) , PaymentRule = (?) , Dateplanned = TO_DATE(?) , C_BPartner_ID = (?) , C_Bp_Bankaccount_ID = (?) , Description = (?) , C_CashBook_ID = (?) , C_CashLine_ID = (?) , C_BankStatementLine_ID = (?) , IsAutomaticGenerated = (?) , C_Settlement_Generate_ID = (?) , IsReceipt = (?) , IsActive = (?) , C_Debt_Payment_ID = (?) , Changesettlementcancel = (?) , IsManual = (?) , IsValid = (?) , Status_Initial = (?) , C_Project_ID = (?) , Generate_Processed = (?) , C_BankAccount_ID = (?) , Cancel_Processed = (?) , updated = now(), updatedby = ? " +
      "        WHERE C_Debt_Payment.C_Debt_Payment_ID = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (Amount, C_Currency_ID, WriteOffAmt, Discountamt, IsPaid, AD_Client_ID, AD_Org_ID, C_Invoice_ID, C_Settlement_Cancel_ID, PaymentRule, Dateplanned, C_BPartner_ID, C_Bp_Bankaccount_ID, Description, C_CashBook_ID, C_CashLine_ID, C_BankStatementLine_ID, IsAutomaticGenerated, C_Settlement_Generate_ID, IsReceipt, IsActive, C_Debt_Payment_ID, Changesettlementcancel, IsManual, IsValid, Status_Initial, C_Project_ID, Generate_Processed, C_BankAccount_ID, Cancel_Processed, created, createdby, updated, updatedBy)" +
