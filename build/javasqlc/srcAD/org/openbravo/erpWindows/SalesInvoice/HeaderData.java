...
static Logger log4j = Logger.getLogger(HeaderData.class);
  ...
  public String isinvoicebyemail;
  ...
  public String getField(String fieldName) {
    ...
    else if (fieldName.equalsIgnoreCase("isinvoicebyemail"))
      return isinvoicebyemail;
 ...
 */
  public static HeaderData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "COALESCE(C_Invoice.Isinvoicebyemail, 'N') AS Isinvoicebyemail, " +
      ...
      "(CASE WHEN C_Invoice.C_Projecttask_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table14.Value), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table14.Name), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table13.Name), ''))),'') ) END) AS C_Projecttask_IDR, " +
      "C_Invoice.TotalPaid, " +
      ...
      "(CASE WHEN C_Invoice.C_Dunning_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL15.Name IS NULL THEN TO_CHAR(table15.Name) ELSE TO_CHAR(tableTRL15.Name) END)), ''))),'') ) END) AS C_Dunning_IDR, " +
      ...
      "C_Invoice.Deliverylocationtext, " +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectHeaderData.isinvoicebyemail = UtilSql.getValue(result, "isinvoicebyemail");
 ...
 */
  public static HeaderData[] set(String cDoctypetargetId, String copyfrom, String isgrossinvoice, String cProjectphaseId, String discountamt, String salesrepId, String totallines, String dueamt, String adOrgtrxId, String cInvoiceId, String daystilldue, String adClientId, String btnreinvoiceprojectexpenses, String dateinvoiced, String cBpartnerId, String cBpartnerIdr, String aAssetId, String processing, String outstandingamt, String posted, String postedBtn, String lastcalculatedondate, String isprinted, String dateordered, String ispaymentshedulesummary, String dateacct, String isdiscountprinted, String cCurrencyId, String internalnote, String cBpartnerLocationId, String adUserId, String cDunningId, String totalpaid, String cActivityId, String updatepaymentmonitor, String issotrx, String created, String cDoctypeId, String processed, String cChargeId, String isactive, String user1Id, String cPaymenttermId, String cCampaignId, String createdby, String createdbyr, String adOrgId, String transactionreference, String taxdate, String istaxincluded, String schedtransactiondate, String deliveryrule, String performanceperiodstart, String performanceperiodend, String description, String cProjectId, String cProjectIdr, String chargeamt, String transactiondate, String deliverylocationtext, String mPricelistId, String isselfservice, String docstatus, String docaction, String docactionBtn, String cProjecttaskId, String ispaid, String isinvoicebyemail, String cWithholdingId, String user2Id, String grandtotal, String poreference, String createfrom, String paymentrule, String generateto, String updatedby, String updatedbyr, String withholdingamount, String dateprinted, String documentno, String writeoffamt, String cOrderId)    throws ServletException {
    ...
    objectHeaderData[0].isinvoicebyemail = isinvoicebyemail;
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      "        UPDATE C_Invoice" +
      "        SET AD_Org_ID = (?) , C_Order_ID = (?) , DateOrdered = TO_DATE(?) , DocumentNo = (?) , POReference = (?) , Description = (?) , Internalnote = (?) , C_DocTypeTarget_ID = (?) , Isinvoicebyemail = (?) , DateInvoiced = TO_DATE(?) , DateAcct = TO_DATE(?) , PerformancePeriodStart = TO_DATE(?) , PerformancePeriodEnd = TO_DATE(?) , C_BPartner_ID = (?) , C_BPartner_Location_ID = (?) , AD_User_ID = (?) , SalesRep_ID = (?) , M_PriceList_ID = (?) , C_Currency_ID = (?) , C_Charge_ID = (?) , ChargeAmt = TO_NUMBER(?) , PaymentRule = (?) , C_PaymentTerm_ID = (?) , Deliveryrule = (?) , IsGrossInvoice = (?) , C_Project_ID = (?) , C_Projecttask_ID = (?) , TotalPaid = TO_NUMBER(?) , DiscountAmt = TO_NUMBER(?) , Writeoffamt = TO_NUMBER(?) , TransactionDate = TO_DATE(?) , SchedTransactionDate = TO_DATE(?) , IsPaid = (?) , C_Dunning_ID = (?) , TotalLines = TO_NUMBER(?) , GrandTotal = TO_NUMBER(?) , C_DocType_ID = (?) , DocStatus = (?) , CreateFrom = (?) , Btnreinvoiceprojectexpenses = (?) , DocAction = (?) , CopyFrom = (?) , Posted = (?) , GenerateTo = (?) , Transactionreference = (?) , Withholdingamount = TO_NUMBER(?) , Taxdate = TO_DATE(?) , IsSelfService = (?) , AD_OrgTrx_ID = (?) , C_Projectphase_ID = (?) , User1_ID = (?) , User2_ID = (?) , IsPaymentshedulesummary = (?) , UpdatePaymentMonitor = (?) , OutstandingAmt = TO_NUMBER(?) , Deliverylocationtext = (?) , A_Asset_ID = (?) , DaysTillDue = TO_NUMBER(?) , IsActive = (?) , DueAmt = TO_NUMBER(?) , Processed = (?) , Processing = (?) , C_Invoice_ID = (?) , DatePrinted = TO_DATE(?) , IsSOTrx = (?) , C_Campaign_ID = (?) , C_Activity_ID = (?) , LastCalculatedOnDate = TO_DATE(?) , AD_Client_ID = (?) , IsDiscountPrinted = (?) , IsPrinted = (?) , C_Withholding_ID = (?) , IsTaxIncluded = (?) , updated = now(), updatedby = ? " +
      "        WHERE C_Invoice.C_Invoice_ID = ? " +
      "        AND C_Invoice.AD_Client_ID IN (";
    strSql = strSql + ((adUserClient==null || adUserClient.equals(""))?"":adUserClient);
    strSql = strSql + 
    ...
    st = connectionProvider.getPreparedStatement(conn, strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, isinvoicebyemail);
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Org_ID, C_Order_ID, DateOrdered, DocumentNo, POReference, Description, Internalnote, C_DocTypeTarget_ID, Isinvoicebyemail, DateInvoiced, DateAcct, PerformancePeriodStart, PerformancePeriodEnd, C_BPartner_ID, C_BPartner_Location_ID, AD_User_ID, SalesRep_ID, M_PriceList_ID, C_Currency_ID, C_Charge_ID, ChargeAmt, PaymentRule, C_PaymentTerm_ID, Deliveryrule, IsGrossInvoice, C_Project_ID, C_Projecttask_ID, TotalPaid, DiscountAmt, Writeoffamt, TransactionDate, SchedTransactionDate, IsPaid, C_Dunning_ID, TotalLines, GrandTotal, C_DocType_ID, DocStatus, CreateFrom, Btnreinvoiceprojectexpenses, DocAction, CopyFrom, Posted, C_Withholding_ID, IsTaxIncluded, GenerateTo, Transactionreference, Withholdingamount, Taxdate, IsSelfService, AD_OrgTrx_ID, C_Projectphase_ID, User1_ID, User2_ID, IsPaymentshedulesummary, UpdatePaymentMonitor, OutstandingAmt, Deliverylocationtext, A_Asset_ID, DaysTillDue, DueAmt, IsActive, Processed, Processing, C_Invoice_ID, C_Campaign_ID, DatePrinted, IsSOTrx, C_Activity_ID, AD_Client_ID, LastCalculatedOnDate, IsDiscountPrinted, IsPrinted, created, createdby, updated, updatedBy)" +
      "        VALUES ((?), (?), TO_DATE(?), (?), (?), (?), (?), (?), (?), TO_DATE(?), TO_DATE(?), TO_DATE(?), TO_DATE(?), (?), (?), (?), (?), (?), (?), (?), TO_NUMBER(?), (?), (?), (?), (?), (?), (?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), TO_DATE(?), TO_DATE(?), (?), (?), TO_NUMBER(?), TO_NUMBER(?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), TO_NUMBER(?), TO_DATE(?), (?), (?), (?), (?), (?), (?), (?), TO_NUMBER(?), (?), (?), TO_NUMBER(?), TO_NUMBER(?), (?), (?), (?), (?), (?), TO_DATE(?), (?), (?), (?), TO_DATE(?), (?), (?), now(), ?, now(), ?)";
