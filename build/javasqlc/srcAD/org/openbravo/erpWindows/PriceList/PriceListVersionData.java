 ...
 */
  public static PriceListVersionData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String mPricelistId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN M_PriceList_Version.AD_Org_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS AD_Org_IDR, " +
      "M_PriceList_Version.M_PriceList_ID, " +
      "(CASE WHEN M_PriceList_Version.M_PriceList_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table2.Name), ''))),'') ) END) AS M_PriceList_IDR, " +
      ...
      "        ? AS LANGUAGE " +
      "        FROM M_PriceList_Version left join (select AD_Org_ID, Name from AD_Org) table1 on (M_PriceList_Version.AD_Org_ID = table1.AD_Org_ID) left join (select M_PriceList_ID, Name from M_PriceList) table2 on (M_PriceList_Version.M_PriceList_ID = table2.M_PriceList_ID)" +
      "        WHERE 2=2 " +
      "        AND 1=1 ";
...
Create a registry
 */
  public static PriceListVersionData[] set(String mPricelistId, String description, String isactive, String adOrgId, String mPricelistVersionBaseId, String name, String proccreate, String adClientId, String mPricelistVersionGenerate, String createdby, String createdbyr, String mPricelistVersionId, String validfrom, String updatedby, String updatedbyr, String mDiscountschemaId)    throws ServletException {
