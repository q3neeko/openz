 ...
 */
  public static InvoiceScheduleData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN C_InvoiceSchedule.AD_Org_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS AD_Org_IDR, " +
      ...
      "        ? AS LANGUAGE " +
      "        FROM C_InvoiceSchedule left join (select AD_Org_ID, Name from AD_Org) table1 on (C_InvoiceSchedule.AD_Org_ID = table1.AD_Org_ID) left join ad_ref_list_v list1 on (C_InvoiceSchedule.InvoiceFrequency = list1.value and list1.ad_reference_id = '168' and list1.ad_language = ?) " +
      "        WHERE 2=2 " +
      "        AND 1=1 " +
...
Create a registry
 */
  public static InvoiceScheduleData[] set(String invoiceweekday, String invoiceday, String name, String invoicedaycutoff, String isactive, String createdby, String createdbyr, String description, String invoicefrequency, String invoiceweekdaycutoff, String adClientId, String eveninvoiceweek, String cInvoicescheduleId, String isamount, String updatedby, String updatedbyr, String amt, String adOrgId, String isdefault)    throws ServletException {
