 ...
 */
  public static UserRolesData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String adUserId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN AD_User_Roles.AD_User_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table2.Name), ''))),'') ) END) AS AD_User_IDR, " +
...
Create a registry
 */
  public static UserRolesData[] set(String adUserId, String createdby, String createdbyr, String updatedby, String updatedbyr, String adClientId, String adUserRolesId, String adRoleId, String adOrgId, String isactive)    throws ServletException {
