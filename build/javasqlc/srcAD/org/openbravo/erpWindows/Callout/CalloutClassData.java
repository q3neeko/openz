 ...
 */
  public static CalloutClassData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String adCalloutId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN AD_Model_Object.AD_Callout_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table2.Name), ''))),'') ) END) AS AD_Callout_IDR, " +
      ...
      "        ? AS LANGUAGE " +
      "        FROM AD_Model_Object left join (select AD_Org_ID, Name from AD_Org) table1 on (AD_Model_Object.AD_Org_ID = table1.AD_Org_ID) left join (select AD_Callout_ID, Name from AD_Callout) table2 on (AD_Model_Object.AD_Callout_ID = table2.AD_Callout_ID)" +
      "        WHERE 2=2 " +
      " AND Action='C'" +
      "        AND 1=1 ";
...
Create a registry
 */
  public static CalloutClassData[] set(String adCalloutId, String adTaskId, String adProcessId, String createdby, String createdbyr, String action, String adTabId, String adWorkflowId, String adFormId, String adReferenceId, String isactive, String adClientId, String isdefault, String classname, String adModelObjectId, String adOrgId, String updatedby, String updatedbyr)    throws ServletException {
