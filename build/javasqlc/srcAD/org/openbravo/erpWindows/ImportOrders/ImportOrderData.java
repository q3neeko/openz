 ...
 */
  public static ImportOrderData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "I_Order.AD_Org_ID, " +
      "(CASE WHEN I_Order.AD_Org_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table4.Name), ''))),'') ) END) AS AD_Org_IDR, " +
      "I_Order.DocTypeName, " +
      "I_Order.C_DocType_ID, " +
      "(CASE WHEN I_Order.C_DocType_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL5.Name IS NULL THEN TO_CHAR(table5.Name) ELSE TO_CHAR(tableTRL5.Name) END)), ''))),'') ) END) AS C_DocType_IDR, " +
      "I_Order.DocumentNo, " +
      "COALESCE(I_Order.IsSOTrx, 'N') AS IsSOTrx, " +
      "I_Order.Description, " +
      "I_Order.Vendor_Upc, " +
      "I_Order.SalesRep_ID, " +
      "(CASE WHEN I_Order.SalesRep_ID IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table6.Name), ''))),'') ) END) AS SalesRep_IDR, " +
      "I_Order.Order_Referenceno, " +
      "I_Order.C_Currency_ID, " +
      "(CASE WHEN I_Order.C_Currency_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table7.ISO_Code), ''))),'') ) END) AS C_Currency_IDR, " +
      "I_Order.M_PriceList_ID, " +
      "(CASE WHEN I_Order.M_PriceList_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table8.Name), ''))),'') ) END) AS M_PriceList_IDR, " +
      "I_Order.PaymentTermValue, " +
      "I_Order.C_PaymentTerm_ID, " +
      "(CASE WHEN I_Order.C_PaymentTerm_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL9.Name IS NULL THEN TO_CHAR(table9.Name) ELSE TO_CHAR(tableTRL9.Name) END)), ''))),'') ) END) AS C_PaymentTerm_IDR, " +
      "I_Order.M_Warehouse_ID, " +
      "(CASE WHEN I_Order.M_Warehouse_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table10.Name), ''))),'') ) END) AS M_Warehouse_IDR, " +
      "I_Order.M_Shipper_ID, " +
      "(CASE WHEN I_Order.M_Shipper_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table11.Name), ''))),'') ) END) AS M_Shipper_IDR, " +
      "I_Order.DateOrdered, " +
      "I_Order.DatePromised, " +
      "I_Order.C_BPartner_ID, " +
      "(CASE WHEN I_Order.C_BPartner_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table12.Value), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table12.Name), ''))),'') ) END) AS C_BPartner_IDR, " +
      "I_Order.Bpartnerupc, " +
      "I_Order.Name, " +
      "I_Order.BPartnerValue, " +
      "I_Order.BillTo_ID, " +
      "(CASE WHEN I_Order.BillTo_ID IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table13.Name), ''))),'') ) END) AS BillTo_IDR, " +
      "I_Order.Billto_Upc, " +
      "I_Order.C_BPartner_Location_ID, " +
      "(CASE WHEN I_Order.C_BPartner_Location_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table14.Name), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table14.Deviant_Bp_Name), ''))),'') ) END) AS C_BPartner_Location_IDR, " +
      "I_Order.C_Bpartner_Location_Upc, " +
      "I_Order.C_Location_ID, " +
      "(CASE WHEN I_Order.C_Location_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table15.Address1), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table15.Address2), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table15.Postal), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table15.City), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table16.Name), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL17.Name IS NULL THEN TO_CHAR(table17.Name) ELSE TO_CHAR(tableTRL17.Name) END)), ''))),'') ) END) AS C_Location_IDR, " +
      "I_Order.Address1, " +
      "I_Order.Address2, " +
      "I_Order.City, " +
      "I_Order.Postal, " +
      "I_Order.RegionName, " +
      "I_Order.C_Region_ID, " +
      "(CASE WHEN I_Order.C_Region_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table18.Name), ''))),'') ) END) AS C_Region_IDR, " +
      "I_Order.CountryCode, " +
      "I_Order.C_Country_ID, " +
      "(CASE WHEN I_Order.C_Country_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL19.Name IS NULL THEN TO_CHAR(table19.Name) ELSE TO_CHAR(tableTRL19.Name) END)), ''))),'') ) END) AS C_Country_IDR, " +
      "I_Order.AD_User_ID, " +
      "(CASE WHEN I_Order.AD_User_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table20.Name), ''))),'') ) END) AS AD_User_IDR, " +
      "I_Order.ContactName, " +
      "I_Order.Phone, " +
      "I_Order.Email, " +
      "I_Order.M_Product_ID, " +
      "(CASE WHEN I_Order.M_Product_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table21.Value), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL21.Name IS NULL THEN TO_CHAR(table21.Name) ELSE TO_CHAR(tableTRL21.Name) END)), ''))),'') ) END) AS M_Product_IDR, " +
      "I_Order.UPC, " +
      "I_Order.ProductValue, " +
      "I_Order.SKU, " +
      "I_Order.C_UOM_ID, " +
      "(CASE WHEN I_Order.C_UOM_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL22.Name IS NULL THEN TO_CHAR(table22.Name) ELSE TO_CHAR(tableTRL22.Name) END)), ''))),'') ) END) AS C_UOM_IDR, " +
      "I_Order.QtyOrdered, " +
      "I_Order.PriceActual, " +
      "I_Order.LineDescription, " +
      "I_Order.TaxIndicator, " +
      "I_Order.C_Tax_ID, " +
      "(CASE WHEN I_Order.C_Tax_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL23.Name IS NULL THEN TO_CHAR(table23.Name) ELSE TO_CHAR(tableTRL23.Name) END)), ''))),'') ) END) AS C_Tax_IDR, " +
      "I_Order.TaxAmt, " +
      "I_Order.C_Project_ID, " +
      "(CASE WHEN I_Order.C_Project_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table24.Value), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table24.Name), ''))),'') ) END) AS C_Project_IDR, " +
      "I_Order.C_Campaign_ID, " +
      "(CASE WHEN I_Order.C_Campaign_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table25.Name), ''))),'') ) END) AS C_Campaign_IDR, " +
      "I_Order.C_Activity_ID, " +
      "(CASE WHEN I_Order.C_Activity_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table26.Name), ''))),'') ) END) AS C_Activity_IDR, " +
      "I_Order.AD_OrgTrx_ID, " +
      "(CASE WHEN I_Order.AD_OrgTrx_ID IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table27.Name), ''))),'') ) END) AS AD_OrgTrx_IDR, " +
      "I_Order.Processing, " +
      "COALESCE(I_Order.Processed, 'N') AS Processed, " +
      "        ? AS LANGUAGE " +
      "        FROM I_Order left join (select C_Order_ID, DocumentNo, Name, DateOrdered, GrandTotal from C_Order) table1 on (I_Order.C_Order_ID = table1.C_Order_ID) left join (select C_OrderLine_ID, C_Order_ID, Line, LineNetAmt from C_OrderLine) table2 on (I_Order.C_OrderLine_ID = table2.C_OrderLine_ID) left join (select C_Order_ID, DocumentNo, Name, DateOrdered, GrandTotal from C_Order) table3 on (table2.C_Order_ID = table3.C_Order_ID) left join (select AD_Org_ID, Name from AD_Org) table4 on (I_Order.AD_Org_ID = table4.AD_Org_ID) left join (select C_DocType_ID, Name from C_DocType) table5 on (I_Order.C_DocType_ID = table5.C_DocType_ID) left join (select C_DocType_ID,AD_Language, Name from C_DocType_TRL) tableTRL5 on (table5.C_DocType_ID = tableTRL5.C_DocType_ID and tableTRL5.AD_Language = ?)  left join (select AD_User_ID, Name from AD_User) table6 on (I_Order.SalesRep_ID =  table6.AD_User_ID) left join (select C_Currency_ID, ISO_Code from C_Currency) table7 on (I_Order.C_Currency_ID = table7.C_Currency_ID) left join (select M_PriceList_ID, Name from M_PriceList) table8 on (I_Order.M_PriceList_ID = table8.M_PriceList_ID) left join (select C_PaymentTerm_ID, Name from C_PaymentTerm) table9 on (I_Order.C_PaymentTerm_ID = table9.C_PaymentTerm_ID) left join (select C_PaymentTerm_ID,AD_Language, Name from C_PaymentTerm_TRL) tableTRL9 on (table9.C_PaymentTerm_ID = tableTRL9.C_PaymentTerm_ID and tableTRL9.AD_Language = ?)  left join (select M_Warehouse_ID, Name from M_Warehouse) table10 on (I_Order.M_Warehouse_ID = table10.M_Warehouse_ID) left join (select M_Shipper_ID, Name from M_Shipper) table11 on (I_Order.M_Shipper_ID = table11.M_Shipper_ID) left join (select C_BPartner_ID, Value, Name from C_BPartner) table12 on (I_Order.C_BPartner_ID = table12.C_BPartner_ID) left join (select C_BPartner_Location_ID, Name from C_BPartner_Location) table13 on (I_Order.BillTo_ID =  table13.C_BPartner_Location_ID) left join (select C_BPartner_Location_ID, Name, Deviant_Bp_Name from C_BPartner_Location) table14 on (I_Order.C_BPartner_Location_ID = table14.C_BPartner_Location_ID) left join (select C_Location_ID, Address1, Address2, Postal, City, C_Region_ID, C_Country_ID from C_Location) table15 on (I_Order.C_Location_ID = table15.C_Location_ID) left join (select C_Region_ID, Name from C_Region) table16 on (table15.C_Region_ID = table16.C_Region_ID) left join (select C_Country_ID, Name from C_Country) table17 on (table15.C_Country_ID = table17.C_Country_ID) left join (select C_Country_ID,AD_Language, Name from C_Country_TRL) tableTRL17 on (table17.C_Country_ID = tableTRL17.C_Country_ID and tableTRL17.AD_Language = ?)  left join (select C_Region_ID, Name from C_Region) table18 on (I_Order.C_Region_ID = table18.C_Region_ID) left join (select C_Country_ID, Name from C_Country) table19 on (I_Order.C_Country_ID = table19.C_Country_ID) left join (select C_Country_ID,AD_Language, Name from C_Country_TRL) tableTRL19 on (table19.C_Country_ID = tableTRL19.C_Country_ID and tableTRL19.AD_Language = ?)  left join (select AD_User_ID, Name from AD_User) table20 on (I_Order.AD_User_ID = table20.AD_User_ID) left join (select M_Product_ID, Value, Name from M_Product) table21 on (I_Order.M_Product_ID = table21.M_Product_ID) left join (select M_Product_ID,AD_Language, Name from M_Product_TRL) tableTRL21 on (table21.M_Product_ID = tableTRL21.M_Product_ID and tableTRL21.AD_Language = ?)  left join (select C_UOM_ID, Name from C_UOM) table22 on (I_Order.C_UOM_ID = table22.C_UOM_ID) left join (select C_UOM_ID,AD_Language, Name from C_UOM_TRL) tableTRL22 on (table22.C_UOM_ID = tableTRL22.C_UOM_ID and tableTRL22.AD_Language = ?)  left join (select C_Tax_ID, Name from C_Tax) table23 on (I_Order.C_Tax_ID = table23.C_Tax_ID) left join (select C_Tax_ID,AD_Language, Name from C_Tax_TRL) tableTRL23 on (table23.C_Tax_ID = tableTRL23.C_Tax_ID and tableTRL23.AD_Language = ?)  left join (select C_Project_ID, Value, Name from C_Project) table24 on (I_Order.C_Project_ID = table24.C_Project_ID) left join (select C_Campaign_ID, Name from C_Campaign) table25 on (I_Order.C_Campaign_ID = table25.C_Campaign_ID) left join (select C_Activity_ID, Name from C_Activity) table26 on (I_Order.C_Activity_ID = table26.C_Activity_ID) left join (select AD_Org_ID, value, Name from AD_Org) table27 on (I_Order.AD_OrgTrx_ID =  table27.AD_Org_ID)" +
      "        WHERE 2=2 " +
      "        AND 1=1 " +
