 ...
 */
  public static AccessData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String adTaskId, String key, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN AD_Task_Access.AD_Org_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS AD_Org_IDR, " +
      "AD_Task_Access.AD_Task_ID, " +
      "(CASE WHEN AD_Task_Access.AD_Task_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL2.Name IS NULL THEN TO_CHAR(table2.Name) ELSE TO_CHAR(tableTRL2.Name) END)), ''))),'') ) END) AS AD_Task_IDR, " +
...
Create a registry
 */
  public static AccessData[] set(String adTaskId, String adOrgId, String isactive, String adClientId, String isreadwrite, String adTaskAccessId, String adRoleId, String createdby, String createdbyr, String updatedby, String updatedbyr)    throws ServletException {
