 ...
 */
  public static ElementValueData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String cElementId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN C_ElementValue.AD_Org_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS AD_Org_IDR, " +
      "C_ElementValue.ShowValueCond, " +
      "C_ElementValue.C_Element_ID, " +
      "(CASE WHEN C_ElementValue.C_Element_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table2.Name), ''))),'') ) END) AS C_Element_IDR, " +
...
Create a registry
 */
  public static ElementValueData[] set(String cElementId, String description, String postbudget, String createdby, String createdbyr, String datevuseauto, String validto, String adClientId, String elementlevel, String isactive, String poststatistical, String postactual, String isforeigncurrency, String value, String adOrgId, String accounttype, String issummary, String cCurrencyId, String name, String nomanualacct, String isdoccontrolled, String validfrom, String showelement, String postencumbrance, String accountsign, String updatedby, String updatedbyr, String isbankaccount, String cElementvalueId, String showvaluecond)    throws ServletException {
