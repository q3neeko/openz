 ...
 */
  public static ElementData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "C_Element.AD_Org_ID, " +
      "(CASE WHEN C_Element.AD_Org_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS AD_Org_IDR, " +
      "C_Element.Name, " +
      ...
      "(CASE WHEN C_Element.AD_Tree_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table2.Name), ''))),'') ) END) AS AD_Tree_IDR, " +
      "C_Element.C_Acctschema_ID, " +
      "(CASE WHEN C_Element.C_Acctschema_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table3.Name), ''))),'') ) END) AS C_Acctschema_IDR, " +
      "C_Element.VFormat, " +
      ...
      "        ? AS LANGUAGE " +
      "        FROM C_Element left join (select AD_Org_ID, Name from AD_Org) table1 on (C_Element.AD_Org_ID = table1.AD_Org_ID) left join ad_ref_list_v list1 on (C_Element.ElementType = list1.value and list1.ad_reference_id = '116' and list1.ad_language = ?)  left join (select AD_Tree_ID, Name from AD_Tree) table2 on (C_Element.AD_Tree_ID = table2.AD_Tree_ID) left join (select C_Acctschema_ID, Name from C_Acctschema) table3 on (C_Element.C_Acctschema_ID = table3.C_Acctschema_ID)" +
      "        WHERE 2=2 " +
      "        AND 1=1 " +
...
Create a registry
 */
  public static ElementData[] set(String adOrgId, String isnaturalaccount, String isbalancing, String add2treeId, String vformat, String cAcctschemaId, String cElementId, String name, String adTreeId, String adClientId, String description, String isactive, String updatedby, String updatedbyr, String add1treeId, String elementtype, String createdby, String createdbyr)    throws ServletException {
