 ...
 */
  public static LinesData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String cBankstatementId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN C_BankStatementLine.C_Currency_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table5.ISO_Code), ''))),'') ) END) AS C_Currency_IDR, " +
      "C_BankStatementLine.Discountamt, " +
      "C_BankStatementLine.ChargeAmt, " +
      "C_BankStatementLine.Foreigncurrency, " +
      "(CASE WHEN C_BankStatementLine.Foreigncurrency IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table6.ISO_Code), ''))),'') ) END) AS ForeigncurrencyR, " +
...
Create a registry
 */
  public static LinesData[] set(String cBankstatementId, String cBankstatementlineId, String trxamt, String adClientId, String isvoided, String discountamt, String referenceno, String chargeamt, String stmtamt, String voidline, String line, String convertchargeamt, String valutadate, String foreigncurrencyamt, String cGlitemId, String cCurrencyId, String foreigncurrency, String memo, String createdby, String createdbyr, String dateacct, String cDebtPaymentId, String cDebtPaymentIdr, String cChargeId, String description, String isactive, String adOrgId, String sepaexportenabled, String foreigncurrencyrate, String cDebtPaymentCreate, String updatedby, String updatedbyr)    throws ServletException {
