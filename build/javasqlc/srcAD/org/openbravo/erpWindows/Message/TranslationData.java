 ...
 */
  public static TranslationData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String adMessageId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN AD_Message_Trl.AD_Org_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS AD_Org_IDR, " +
      "AD_Message_Trl.AD_Message_ID, " +
      "(CASE WHEN AD_Message_Trl.AD_Message_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table2.Value), ''))),'') ) END) AS AD_Message_IDR, " +
      "AD_Message_Trl.AD_Language, " +
      "(CASE WHEN AD_Message_Trl.AD_Language IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table3.Name), ''))),'') ) END) AS AD_LanguageR, " +
      ...
      "        ? AS LANGUAGE " +
      "        FROM AD_Message_Trl left join (select AD_Org_ID, Name from AD_Org) table1 on (AD_Message_Trl.AD_Org_ID = table1.AD_Org_ID) left join (select AD_Message_ID, Value from AD_Message) table2 on (AD_Message_Trl.AD_Message_ID = table2.AD_Message_ID) left join (select AD_Language, Name from AD_Language) table3 on (AD_Message_Trl.AD_Language =  table3.AD_Language)" +
      "        WHERE 2=2 " +
      "        AND 1=1 ";
...
Create a registry
 */
  public static TranslationData[] set(String adMessageId, String createdby, String createdbyr, String adMessageTrlId, String msgtext, String adLanguage, String isactive, String adOrgId, String adClientId, String msgtip, String updatedby, String updatedbyr, String istranslated)    throws ServletException {
