 ...
 */
  public static TranslationData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String cUomId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "C_UOM_Trl.AD_Org_ID, " +
      "(CASE WHEN C_UOM_Trl.AD_Org_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS AD_Org_IDR, " +
      "C_UOM_Trl.C_UOM_ID, " +
      "(CASE WHEN C_UOM_Trl.C_UOM_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL2.Name IS NULL THEN TO_CHAR(table2.Name) ELSE TO_CHAR(tableTRL2.Name) END)), ''))),'') ) END) AS C_UOM_IDR, " +
      "C_UOM_Trl.AD_Language, " +
      "(CASE WHEN C_UOM_Trl.AD_Language IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table3.Name), ''))),'') ) END) AS AD_LanguageR, " +
...
Create a registry
 */
  public static TranslationData[] set(String cUomId, String adClientId, String uomsymbol, String createdby, String createdbyr, String description, String adLanguage, String adOrgId, String istranslated, String updatedby, String updatedbyr, String cUomTrlId, String isactive, String name)    throws ServletException {
