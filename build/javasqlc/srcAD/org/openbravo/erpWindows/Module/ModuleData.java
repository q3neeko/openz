 ...
 */
  public static ModuleData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "AD_Module.AD_Org_ID, " +
      "(CASE WHEN AD_Module.AD_Org_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS AD_Org_IDR, " +
      ...
      "(CASE WHEN AD_Module.AD_Language IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table2.Name), ''))),'') ) END) AS AD_LanguageR, " +
...
Create a registry
 */
  public static ModuleData[] set(String adOrgId, String licensetype, String isactive, String adLanguage, String adClientId, String ordernumber, String name, String description, String ispartofdistribution, String referencedatainfo, String help, String haschartofaccounts, String updateinfo, String versionLabel, String adModuleId, String type, String url, String status, String versionId, String istranslationrequired, String createdby, String createdbyr, String isindevelopment, String seqno, String javapackage, String author, String version, String isdefault, String updateAvailable, String hasreferencedata, String istranslationmodule, String updateVerId, String iscommercial, String updatedby, String updatedbyr, String license)    throws ServletException {
