 ...
 */
  public static LinesData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String cInvoiceId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN C_InvoiceLine.Reinvoicedby_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table9.DocumentNo), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(table9.DateInvoiced, 'DD-MM-YYYY')),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table9.GrandTotal), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table8.Line), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table8.LineNetAmt), ''))),'') ) END) AS Reinvoicedby_IDR, " +
      "C_InvoiceLine.Line, " +
      "C_InvoiceLine.M_Product_ID, " +
      "(CASE WHEN C_InvoiceLine.M_Product_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table10.Value), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL10.Name IS NULL THEN TO_CHAR(table10.Name) ELSE TO_CHAR(tableTRL10.Name) END)), ''))),'') ) END) AS M_Product_IDR, " +
      "C_InvoiceLine.M_AttributeSetInstance_ID, " +
      "(CASE WHEN C_InvoiceLine.M_AttributeSetInstance_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table11.Description), ''))),'') ) END) AS M_AttributeSetInstance_IDR, " +
      ...
      "(CASE WHEN C_InvoiceLine.C_Projecttask_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table19.Value), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table19.Name), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table18.Name), ''))),'') ) END) AS C_Projecttask_IDR, " +
...
Create a registry
 */
  public static LinesData[] set(String cInvoiceId, String cUomId, String pricelimit, String cInvoiceIdr, String aAssetId, String quantityorder, String mOfferId, String description, String pricestd, String adOrgId, String line, String pricelist, String created, String sResourceassignmentId, String linenetamt, String mAttributesetinstanceId, String mAttributesetinstanceIdr, String linegrossamt, String cOrderlineId, String chargeamt, String cProjectphaseId, String mProductUomId, String updatedby, String updatedbyr, String excludeforwithholding, String isactive, String cChargeId, String linetaxamt, String cProjecttaskId, String cInvoicelineId, String reinvoicedbyId, String reinvoicedbyIdr, String isgrossprice, String mInoutlineId, String mInoutlineIdr, String adClientId, String cProjectId, String cProjectIdr, String isdescription, String mProductId, String mProductIdr, String taxamt, String cTaxId, String createdby, String createdbyr, String qtyinvoiced, String priceactual)    throws ServletException {
...
Select for auxiliar field
 */
  public static String selectDef51C68662912C4B0D887CBE129758FB7E_3(ConnectionProvider connectionProvider, String Reinvoicedby_IDR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectDef4251_4(ConnectionProvider connectionProvider, String M_InOutLine_IDR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectDefC5F1E0FC079F4FCBAE27B1990366A8E5_5(ConnectionProvider connectionProvider, String C_Project_IDR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectDef3840_6(ConnectionProvider connectionProvider, String M_Product_IDR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectDef3833_7(ConnectionProvider connectionProvider, String CreatedByR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET AD_Client_ID = (?) , AD_Org_ID = (?) , C_Invoice_ID = (?) , C_OrderLine_ID = (?) , M_InOutLine_ID = (?) , Reinvoicedby_ID = (?) , Line = TO_NUMBER(?) , M_Product_ID = (?) , M_AttributeSetInstance_ID = (?) , C_Charge_ID = (?) , Description = (?) , QuantityOrder = TO_NUMBER(?) , M_Product_Uom_Id = (?) , QtyInvoiced = TO_NUMBER(?) , C_UOM_ID = (?) , Isgrossprice = (?) , PriceActual = TO_NUMBER(?) , PriceList = TO_NUMBER(?) , C_Tax_ID = (?) , A_Asset_ID = (?) , C_Project_ID = (?) , C_Projecttask_ID = (?) , Linegrossamt = TO_NUMBER(?) , LineNetAmt = TO_NUMBER(?) , TaxAmt = TO_NUMBER(?) , Linetaxamt = TO_NUMBER(?) , S_ResourceAssignment_ID = (?) , C_InvoiceLine_ID = (?) , Excludeforwithholding = (?) , M_Offer_ID = (?) , PriceStd = TO_NUMBER(?) , IsDescription = (?) , C_Projectphase_ID = (?) , PriceLimit = TO_NUMBER(?) , ChargeAmt = TO_NUMBER(?) , IsActive = (?) , updated = now(), updatedby = ? " +
      "        WHERE C_InvoiceLine.C_InvoiceLine_ID = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Client_ID, AD_Org_ID, C_Invoice_ID, C_OrderLine_ID, M_InOutLine_ID, Reinvoicedby_ID, Line, M_Product_ID, M_AttributeSetInstance_ID, C_Charge_ID, Description, QuantityOrder, M_Product_Uom_Id, QtyInvoiced, C_UOM_ID, Isgrossprice, PriceActual, PriceList, C_Tax_ID, A_Asset_ID, C_Project_ID, C_Projecttask_ID, Linegrossamt, LineNetAmt, TaxAmt, PriceLimit, Linetaxamt, ChargeAmt, C_InvoiceLine_ID, Excludeforwithholding, S_ResourceAssignment_ID, PriceStd, IsDescription, C_Projectphase_ID, IsActive, M_Offer_ID, created, createdby, updated, updatedBy)" +
