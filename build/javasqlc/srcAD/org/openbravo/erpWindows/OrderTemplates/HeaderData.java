...
Create a registry
 */
  public static HeaderData[] set(String cBpartnerId, String cBpartnerIdr, String priorityrule, String dropshipLocationId, String billtoId, String cIncotermsId, String isselected, String mShipperId, String freightamt, String istaxincluded, String qty, String cProjecttaskId, String orderselfjoin, String user2Id, String cProjectphaseId, String cChargeId, String mProductId, String docaction, String totallines, String ispaid, String enddate, String weightUom, String proposalstatus, String posted, String iscompletelyinvoiced, String weight, String user1Id, String name, String closeproject, String invoicefrequence, String chargeamt, String cBpartnerLocationId, String cCampaignId, String internalnote, String btncopytemplate, String isdiscountprinted, String dropshipBpartnerId, String isrecharge, String totallinesonetime, String freightcostrule, String cBidprojectId, String copyfrom, String datepromised, String cPaymenttermId, String contractdate, String docstatus, String paymentrule, String cProjectId, String cProjectIdr, String transactiondate, String lostproposalfixedreason, String updatedby, String updatedbyr, String deliveryLocationId, String salesrepId, String poreference, String schedtransactiondate, String mWarehouseId, String copyfrompo, String cOrderId, String isdelivered, String issotrx, String deliveryrule, String isselfservice, String createdby, String createdbyr, String dateordered, String generatetemplate, String cActivityId, String monthlyDay, String documentno, String completeordervalue, String dropshipUserId, String dateacct, String cCurrencyId, String adOrgId, String totalpaid, String grandtotalonetime, String bpzipcode, String cDoctypetargetId, String invoicerule, String deliverynotes, String scheddeliverydate, String isinvoiceafterfirstcycle, String incotermsdescription, String mPricelistId, String invoicedamt, String processed, String estpropability, String deliveryviarule, String weeklyDay, String description, String isprinted, String dateprinted, String grandtotal, String isinvoiced, String lostproposalreason, String isactive, String cDoctypeId, String adOrgtrxId, String aAssetId, String adClientId, String adUserId, String quarterlyMonth, String firstschedinvoicedate, String generateproject, String processing, String yearlyMonth)    throws ServletException {
 ...
 */
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      "        INSERT INTO C_Order " +
      "        (AD_Client_ID, AD_Org_ID, DocumentNo, POReference, DateOrdered, C_DocTypeTarget_ID, Name, C_DocType_ID, DocStatus, Description, Deliverynotes, Internalnote, C_BPartner_ID, bpzipcode, BillTo_ID, C_BPartner_Location_ID, AD_User_ID, SalesRep_ID, M_PriceList_ID, IsDiscountPrinted, InvoiceRule, Estpropability, M_Warehouse_ID, C_Currency_ID, DeliveryRule, PriorityRule, PaymentRule, C_PaymentTerm_ID, C_Incoterms_ID, Delivery_Location_ID, DeliveryViaRule, M_Shipper_ID, Weight, Weight_Uom, FreightCostRule, M_Product_ID, Qty, FreightAmt, C_Project_ID, C_Projecttask_ID, Firstschedinvoicedate, DatePromised, SchedTransactionDate, TransactionDate, Contractdate, Enddate, Invoicefrequence, Isinvoiceafterfirstcycle, Quarterly_Month, Yearly_Month, Weekly_Day, Monthly_Day, Proposalstatus, Lostproposalfixedreason, Lostproposalreason, Totallinesonetime, Grandtotalonetime, TotalLines, GrandTotal, InvoicedAmt, TotalPaid, CompleteOrderValue, BtnCopyTemplate, CopyFrom, Incotermsdescription, DropShip_BPartner_ID, ChargeAmt, AD_OrgTrx_ID, IsSelected, User1_ID, User2_ID, CopyFromPO, IsSOTrx, Closeproject, Processing, Ispaid, C_Activity_ID, Generatetemplate, C_Order_ID, Generateproject, IsDelivered, DateAcct, IsSelfService, DropShip_User_ID, DropShip_Location_ID, C_Projectphase_ID, C_Bidproject_ID, Processed, C_Charge_ID, C_Campaign_ID, IsInvoiced, DatePrinted, IsTaxIncluded, Posted, IsPrinted, IsCompletelyInvoiced, SchedDeliveryDate, Orderselfjoin, IsActive, A_Asset_ID, DocAction, Isrecharge, created, createdby, updated, updatedBy)" +
      "        VALUES ((?), (?), (?), (?), TO_DATE(?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), TO_NUMBER(?), (?), (?), (?), TO_NUMBER(?), TO_NUMBER(?), (?), (?), TO_DATE(?), TO_DATE(?), TO_DATE(?), TO_DATE(?), TO_DATE(?), TO_DATE(?), (?), (?), (?), (?), (?), TO_NUMBER(?), (?), (?), (?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), (?), (?), (?), (?), TO_NUMBER(?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), TO_DATE(?), (?), (?), (?), (?), (?), (?), (?), (?), (?), TO_DATE(?), (?), (?), (?), (?), TO_DATE(?), (?), (?), (?), (?), (?), now(), ?, now(), ?)";
