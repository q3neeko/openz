...
static Logger log4j = Logger.getLogger(ConfigurationOptions4876AD1C05004DF9934B4AFE73FCC24AData.class);
  ...
  public String sortgeneratelinesbyproduct;
  public String activatepobpartnerpreselection;
  public String alloworderchangesafterdelivery;
  ...
  public String productionlocatorfromproductdata;
  public String bomissuinglocatoridentical2workstep;
  public String closeworkstepafterproduction;
  ...
  public String salesmaterialtoprojecttaskbom;
  ...
  public String mrpapprovalworkflow;
  ...
  public String poactiveafterpurchaserun;
  public String docnoreadonly;
  public String gobnodelteindocuments;
  ...
  public String directbomscanonlywithworkstep;
  ...
  public String getField(String fieldName) {
    ...
    else if (fieldName.equalsIgnoreCase("sortgeneratelinesbyproduct"))
      return sortgeneratelinesbyproduct;
    else if (fieldName.equalsIgnoreCase("activatepobpartnerpreselection"))
      return activatepobpartnerpreselection;
    else if (fieldName.equalsIgnoreCase("alloworderchangesafterdelivery"))
      return alloworderchangesafterdelivery;
    ...
    else if (fieldName.equalsIgnoreCase("productionlocatorfromproductdata"))
      return productionlocatorfromproductdata;
    else if (fieldName.equalsIgnoreCase("bomissuinglocatoridentical2workstep"))
      return bomissuinglocatoridentical2workstep;
    else if (fieldName.equalsIgnoreCase("closeworkstepafterproduction"))
      return closeworkstepafterproduction;
    ...
    else if (fieldName.equalsIgnoreCase("salesmaterialtoprojecttaskbom"))
      return salesmaterialtoprojecttaskbom;
    ...
    else if (fieldName.equalsIgnoreCase("mrpapprovalworkflow"))
      return mrpapprovalworkflow;
    ...
    else if (fieldName.equalsIgnoreCase("poactiveafterpurchaserun"))
      return poactiveafterpurchaserun;
    else if (fieldName.equalsIgnoreCase("docnoreadonly"))
      return docnoreadonly;
    else if (fieldName.equalsIgnoreCase("gobnodelteindocuments"))
      return gobnodelteindocuments;
    ...
    else if (fieldName.equalsIgnoreCase("directbomscanonlywithworkstep"))
      return directbomscanonlywithworkstep;
 ...
 */
  public static ConfigurationOptions4876AD1C05004DF9934B4AFE73FCC24AData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String ad_org_id, String adOrgId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "COALESCE(c_orgconfiguration.Sortgeneratelinesbyproduct, 'N') AS Sortgeneratelinesbyproduct, " +
      "COALESCE(c_orgconfiguration.ActivatePOBPartnerPreselection, 'N') AS ActivatePOBPartnerPreselection, " +
      "COALESCE(c_orgconfiguration.Alloworderchangesafterdelivery, 'N') AS Alloworderchangesafterdelivery, " +
      ...
      "COALESCE(c_orgconfiguration.Productionlocatorfromproductdata, 'N') AS Productionlocatorfromproductdata, " +
      "COALESCE(c_orgconfiguration.Bomissuinglocatoridentical2workstep, 'N') AS Bomissuinglocatoridentical2workstep, " +
      "COALESCE(c_orgconfiguration.Closeworkstepafterproduction, 'N') AS Closeworkstepafterproduction, " +
      ...
      "COALESCE(c_orgconfiguration.Salesmaterialtoprojecttaskbom, 'N') AS Salesmaterialtoprojecttaskbom, " +
      ...
      "COALESCE(c_orgconfiguration.Mrpapprovalworkflow, 'N') AS Mrpapprovalworkflow, " +
      ...
      "COALESCE(c_orgconfiguration.Poactiveafterpurchaserun, 'N') AS Poactiveafterpurchaserun, " +
      "COALESCE(c_orgconfiguration.Docnoreadonly, 'N') AS Docnoreadonly, " +
      "COALESCE(c_orgconfiguration.Gobnodelteindocuments, 'N') AS Gobnodelteindocuments, " +
      ...
      "COALESCE(c_orgconfiguration.Directbomscanonlywithworkstep, 'N') AS Directbomscanonlywithworkstep, " +
      "COALESCE(c_orgconfiguration.Datevexportprojasset, 'N') AS Datevexportprojasset, " +
      "c_orgconfiguration.AD_Client_ID, " +
      "        ? AS LANGUAGE " +
      "        FROM c_orgconfiguration left join (select AD_Org_ID, Name from AD_Org) table1 on (c_orgconfiguration.AD_Org_ID = table1.AD_Org_ID)" +
      "        WHERE 2=2 " +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectConfigurationOptions4876AD1C05004DF9934B4AFE73FCC24AData.sortgeneratelinesbyproduct = UtilSql.getValue(result, "sortgeneratelinesbyproduct");
        ...
        objectConfigurationOptions4876AD1C05004DF9934B4AFE73FCC24AData.alloworderchangesafterdelivery = UtilSql.getValue(result, "alloworderchangesafterdelivery");
        ...
        objectConfigurationOptions4876AD1C05004DF9934B4AFE73FCC24AData.productionlocatorfromproductdata = UtilSql.getValue(result, "productionlocatorfromproductdata");
        objectConfigurationOptions4876AD1C05004DF9934B4AFE73FCC24AData.bomissuinglocatoridentical2workstep = UtilSql.getValue(result, "bomissuinglocatoridentical2workstep");
        objectConfigurationOptions4876AD1C05004DF9934B4AFE73FCC24AData.closeworkstepafterproduction = UtilSql.getValue(result, "closeworkstepafterproduction");
        ...
        objectConfigurationOptions4876AD1C05004DF9934B4AFE73FCC24AData.salesmaterialtoprojecttaskbom = UtilSql.getValue(result, "salesmaterialtoprojecttaskbom");
        ...
        objectConfigurationOptions4876AD1C05004DF9934B4AFE73FCC24AData.mrpapprovalworkflow = UtilSql.getValue(result, "mrpapprovalworkflow");
        ...
        objectConfigurationOptions4876AD1C05004DF9934B4AFE73FCC24AData.poactiveafterpurchaserun = UtilSql.getValue(result, "poactiveafterpurchaserun");
        objectConfigurationOptions4876AD1C05004DF9934B4AFE73FCC24AData.docnoreadonly = UtilSql.getValue(result, "docnoreadonly");
        objectConfigurationOptions4876AD1C05004DF9934B4AFE73FCC24AData.gobnodelteindocuments = UtilSql.getValue(result, "gobnodelteindocuments");
        ...
        objectConfigurationOptions4876AD1C05004DF9934B4AFE73FCC24AData.directbomscanonlywithworkstep = UtilSql.getValue(result, "directbomscanonlywithworkstep");
...
Create a registry
 */
  public static ConfigurationOptions4876AD1C05004DF9934B4AFE73FCC24AData[] set(String adOrgId, String reinvoiceprojectexpenses, String activatepoinvoiceautomatically, String activatepobpartnerpreselection, String bomissuinglocatoridentical2workstep, String projectgetmatontaskstart, String activateinternalconsumptionauto, String projectmangerworkflow, String productionlocatorfromproductdata, String adClientId, String autobpartnervaluesequence, String isprojecttaskmandatory, String offerpropabilitynotnull, String updatedby, String updatedbyr, String cnrdin, String sortgeneratelinesbyproduct, String closeprojectfromso, String toolbardragndrop, String autoprojectvaluesequence, String defaultpoapprovalamt, String projectmatpanautowhengetmat, String autoselectlotnumber, String productvaluereadonly, String alloworderchangesafterdelivery, String projectvaluereadonly, String automaterial2project, String gobnodelteindocuments, String cOrgconfigurationId, String bringbackmorematerialthanreceived, String autoaddbatchandserial2delivery, String orderprojectnotnull, String mrpapprovalworkflow, String generatestdtaskfromso, String createprojectfromso, String defaultprapprovalamt, String prapprovalworkflow, String closeworkstepafterproduction, String pipurchaserdisplay, String kombibarcode, String synchronizeworkstepboms, String poprojectworkflow, String datepromisednotnull, String poactiveafterpurchaserun, String autoproductvaluesequence, String orderrequisitionrestriction, String useproductvalue2scanproducts, String datevonlycreditdebit, String directbomscanonlywithworkstep, String freightamounthint, String projectonlyapprovedproducts, String isactive, String activatereceiptautomatically, String datevexportprojasset, String bpartnervaluereadonly, String closetasksonprojectclose, String docnoreadonly, String deliveryofservices, String isstandard, String activatesoinvoiceautomatically, String createdatevaccount, String addbccemail2alerts, String refreshintervall, String autoproducteansequence, String salesmaterialtoprojecttaskbom, String activateshipmentautomatically, String createdby, String createdbyr)    throws ServletException {
    ...
    objectConfigurationOptions4876AD1C05004DF9934B4AFE73FCC24AData[0].sortgeneratelinesbyproduct = sortgeneratelinesbyproduct;
    ...
    objectConfigurationOptions4876AD1C05004DF9934B4AFE73FCC24AData[0].alloworderchangesafterdelivery = alloworderchangesafterdelivery;
    ...
    objectConfigurationOptions4876AD1C05004DF9934B4AFE73FCC24AData[0].productionlocatorfromproductdata = productionlocatorfromproductdata;
    objectConfigurationOptions4876AD1C05004DF9934B4AFE73FCC24AData[0].bomissuinglocatoridentical2workstep = bomissuinglocatoridentical2workstep;
    objectConfigurationOptions4876AD1C05004DF9934B4AFE73FCC24AData[0].closeworkstepafterproduction = closeworkstepafterproduction;
    ...
    objectConfigurationOptions4876AD1C05004DF9934B4AFE73FCC24AData[0].salesmaterialtoprojecttaskbom = salesmaterialtoprojecttaskbom;
    ...
    objectConfigurationOptions4876AD1C05004DF9934B4AFE73FCC24AData[0].mrpapprovalworkflow = mrpapprovalworkflow;
    ...
    objectConfigurationOptions4876AD1C05004DF9934B4AFE73FCC24AData[0].poactiveafterpurchaserun = poactiveafterpurchaserun;
    objectConfigurationOptions4876AD1C05004DF9934B4AFE73FCC24AData[0].docnoreadonly = docnoreadonly;
    objectConfigurationOptions4876AD1C05004DF9934B4AFE73FCC24AData[0].gobnodelteindocuments = gobnodelteindocuments;
    ...
    objectConfigurationOptions4876AD1C05004DF9934B4AFE73FCC24AData[0].directbomscanonlywithworkstep = directbomscanonlywithworkstep;
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET AD_Org_ID = (?) , Isstandard = (?) , Toolbardragndrop = (?) , Addbccemail2alerts = (?) , Datevonlycreditdebit = (?) , Sortgeneratelinesbyproduct = (?) , ActivatePOBPartnerPreselection = (?) , Alloworderchangesafterdelivery = (?) , Deliveryofservices = (?) , Autoaddbatchandserial2delivery = (?) , Autoselectlotnumber = (?) , Cnrdin = (?) , Synchronizeworkstepboms = (?) , Productionlocatorfromproductdata = (?) , Bomissuinglocatoridentical2workstep = (?) , Closeworkstepafterproduction = (?) , Automaterial2project = (?) , Activateinternalconsumptionauto = (?) , Createprojectfromso = (?) , Generatestdtaskfromso = (?) , Closeprojectfromso = (?) , Salesmaterialtoprojecttaskbom = (?) , Bringbackmorematerialthanreceived = (?) , Projectonlyapprovedproducts = (?) , Projectgetmatontaskstart = (?) , Projectmatpanautowhengetmat = (?) , Reinvoiceprojectexpenses = (?) , Autoprojectvaluesequence = (?) , Projectvaluereadonly = (?) , Closetasksonprojectclose = (?) , Projectmangerworkflow = (?) , Poprojectworkflow = (?) , Defaultpoapprovalamt = TO_NUMBER(?) , Prapprovalworkflow = (?) , Defaultprapprovalamt = TO_NUMBER(?) , Pipurchaserdisplay = (?) , Freightamounthint = TO_NUMBER(?) , Orderrequisitionrestriction = (?) , Mrpapprovalworkflow = (?) , Offerpropabilitynotnull = (?) , Orderprojectnotnull = (?) , Isprojecttaskmandatory = (?) , Datepromisednotnull = (?) , Activatepoinvoiceautomatically = (?) , Activatereceiptautomatically = (?) , Activatesoinvoiceautomatically = (?) , Activateshipmentautomatically = (?) , Poactiveafterpurchaserun = (?) , Docnoreadonly = (?) , Gobnodelteindocuments = (?) , Autoproductvaluesequence = (?) , Productvaluereadonly = (?) , Autoproducteansequence = (?) , Kombibarcode = (?) , Autobpartnervaluesequence = (?) , Bpartnervaluereadonly = (?) , Createdatevaccount = (?) , Useproductvalue2scanproducts = (?) , Refreshintervall = TO_NUMBER(?) , Isactive = (?) , c_orgconfiguration_id = (?) , Directbomscanonlywithworkstep = (?) , Datevexportprojasset = (?) , AD_Client_ID = (?) , updated = now(), updatedby = ? " +
      "        WHERE c_orgconfiguration.c_orgconfiguration_id = ? " +
      "                 AND c_orgconfiguration.AD_Org_ID = ? " +
      "        AND c_orgconfiguration.AD_Client_ID IN (";
    strSql = strSql + ((adUserClient==null || adUserClient.equals(""))?"":adUserClient);
    ...
    st = connectionProvider.getPreparedStatement(conn, strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, sortgeneratelinesbyproduct);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, activatepobpartnerpreselection);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, alloworderchangesafterdelivery);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, productionlocatorfromproductdata);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, bomissuinglocatoridentical2workstep);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, closeworkstepafterproduction);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, salesmaterialtoprojecttaskbom);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, mrpapprovalworkflow);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, poactiveafterpurchaserun);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, docnoreadonly);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, gobnodelteindocuments);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, directbomscanonlywithworkstep);
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Org_ID, Isstandard, Toolbardragndrop, Addbccemail2alerts, Datevonlycreditdebit, Sortgeneratelinesbyproduct, ActivatePOBPartnerPreselection, Alloworderchangesafterdelivery, Deliveryofservices, Autoaddbatchandserial2delivery, Autoselectlotnumber, Cnrdin, Synchronizeworkstepboms, Productionlocatorfromproductdata, Bomissuinglocatoridentical2workstep, Closeworkstepafterproduction, Automaterial2project, Activateinternalconsumptionauto, Createprojectfromso, Generatestdtaskfromso, Closeprojectfromso, Salesmaterialtoprojecttaskbom, Bringbackmorematerialthanreceived, Projectonlyapprovedproducts, Projectgetmatontaskstart, Projectmatpanautowhengetmat, Reinvoiceprojectexpenses, Autoprojectvaluesequence, Projectvaluereadonly, Closetasksonprojectclose, Projectmangerworkflow, Poprojectworkflow, Defaultpoapprovalamt, Prapprovalworkflow, Defaultprapprovalamt, Pipurchaserdisplay, Freightamounthint, Orderrequisitionrestriction, Mrpapprovalworkflow, Offerpropabilitynotnull, Orderprojectnotnull, Isprojecttaskmandatory, Datepromisednotnull, Activatepoinvoiceautomatically, Activatereceiptautomatically, Activatesoinvoiceautomatically, Activateshipmentautomatically, Poactiveafterpurchaserun, Docnoreadonly, Gobnodelteindocuments, Autoproductvaluesequence, Productvaluereadonly, Autoproducteansequence, Kombibarcode, Autobpartnervaluesequence, Bpartnervaluereadonly, Createdatevaccount, Useproductvalue2scanproducts, Refreshintervall, Isactive, c_orgconfiguration_id, Directbomscanonlywithworkstep, Datevexportprojasset, AD_Client_ID, created, createdby, updated, updatedBy)" +
