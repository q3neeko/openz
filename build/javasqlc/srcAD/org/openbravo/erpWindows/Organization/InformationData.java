 ...
 */
  public static InformationData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String adOrgId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN AD_OrgInfo.AD_Org_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS AD_Org_IDR, " +
      "AD_OrgInfo.Logo, " +
...
Create a registry
 */
  public static InformationData[] set(String adOrgId, String duns, String taxid, String logo, String adClientId, String isactive, String yourCompanyDocumentImage, String updatedby, String updatedbyr, String referenceOrder, String cLocationId, String cLocationIdr, String cBpartnerId, String createdby, String createdbyr)    throws ServletException {
