 ...
 */
  public static PeriodControlData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String adOrgId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN C_PeriodControl_V.AD_Org_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS AD_Org_IDR, " +
      "C_PeriodControl_V.C_Calendar_ID, " +
      "(CASE WHEN C_PeriodControl_V.C_Calendar_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table2.Name), ''))),'') ) END) AS C_Calendar_IDR, " +
      "COALESCE(C_PeriodControl_V.Isactive, 'N') AS Isactive, " +
      "C_PeriodControl_V.C_Period_ID, " +
      "(CASE WHEN C_PeriodControl_V.C_Period_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table3.Name), ''))),'') ) END) AS C_Period_IDR, " +
...
Create a registry
 */
  public static PeriodControlData[] set(String adOrgId, String periodstatus, String periodaction, String docbasetype, String cPeriodcontrolVId, String enddate, String startdate, String isactive, String processing, String year, String updatedby, String updatedbyr, String createdby, String createdbyr, String adClientId, String cPeriodId, String name, String cCalendarId)    throws ServletException {
