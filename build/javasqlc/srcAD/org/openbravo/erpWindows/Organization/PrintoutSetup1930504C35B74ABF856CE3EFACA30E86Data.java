 ...
 */
  public static PrintoutSetup1930504C35B74ABF856CE3EFACA30E86Data[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String ad_org_id, String adOrgId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN zspr_printinfo.AD_Org_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS AD_Org_IDR, " +
      ...
      "        ? AS LANGUAGE " +
      "        FROM zspr_printinfo left join (select AD_Org_ID, Name from AD_Org) table1 on (zspr_printinfo.AD_Org_ID = table1.AD_Org_ID)" +
      "        WHERE 2=2 " +
...
Create a registry
 */
  public static PrintoutSetup1930504C35B74ABF856CE3EFACA30E86Data[] set(String adOrgId, String address8, String isactive, String address2, String address6, String onelineadr, String updatedby, String updatedbyr, String isfootergroupstyle, String adClientId, String addressheader, String footer5, String zsprPrintinfoId, String address1, String address3, String footer1, String address7, String address9, String address4, String createdby, String createdbyr, String footer4, String footer2, String address5, String footer3)    throws ServletException {
