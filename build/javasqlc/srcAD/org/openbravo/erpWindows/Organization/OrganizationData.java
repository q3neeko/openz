 ...
 */
  public static OrganizationData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String AD_CLIENT_ID, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN AD_Org.C_Calendar_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table2.Name), ''))),'') ) END) AS C_Calendar_IDR, " +
      "COALESCE(AD_Org.IsPeriodControlAllowed, 'N') AS IsPeriodControlAllowed, " +
      "AD_Org.IsReady, " +
      "AD_Org.AD_Org_ID, " +
      "COALESCE(AD_Org.IsSummary, 'N') AS IsSummary, " +
      "        ? AS LANGUAGE " +
      "        FROM AD_Org left join (select AD_Orgtype_ID, Name from AD_Orgtype) table1 on (AD_Org.AD_Orgtype_ID = table1.AD_Orgtype_ID) left join (select C_Calendar_ID, Name from C_Calendar) table2 on (AD_Org.C_Calendar_ID = table2.C_Calendar_ID)" +
      "        WHERE 2=2 " +
...
Create a registry
 */
  public static OrganizationData[] set(String updatedby, String updatedbyr, String isready, String shortcut, String issummary, String value, String isactive, String name, String createdby, String createdbyr, String adOrgId, String isperiodcontrolallowed, String adClientId, String description, String cCalendarId, String adOrgtypeId)    throws ServletException {
