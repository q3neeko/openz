 ...
 */
  public static AreasofInterestSubscriptionData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String R_InterestArea_ID, String rInterestareaId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN R_ContactInterest.AD_Org_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS AD_Org_IDR, " +
      ...
      "(CASE WHEN R_ContactInterest.AD_User_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table3.Name), ''))),'') ) END) AS AD_User_IDR, " +
      ...
      "        ? AS LANGUAGE " +
      "        FROM R_ContactInterest left join (select AD_Org_ID, Name from AD_Org) table1 on (R_ContactInterest.AD_Org_ID = table1.AD_Org_ID) left join (select R_InterestArea_ID, Name from R_InterestArea) table2 on (R_ContactInterest.R_InterestArea_ID = table2.R_InterestArea_ID) left join (select AD_User_ID, Name from AD_User) table3 on (R_ContactInterest.AD_User_ID = table3.AD_User_ID)" +
      "        WHERE 2=2 " +
...
Create a registry
 */
  public static AreasofInterestSubscriptionData[] set(String rInterestareaId, String subscribedate, String optoutdate, String isactive, String rContactinterestId, String adClientId, String createdby, String createdbyr, String adOrgId, String updatedby, String updatedbyr, String adUserId)    throws ServletException {
