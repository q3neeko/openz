...
static Logger log4j = Logger.getLogger(TabInstanceSpecificData.class);
  ...
  public String getField(String fieldName) {
    ...
    else if (fieldName.equalsIgnoreCase("ismaxrowsparamr"))
      return ismaxrowsparamr;
  ...
  public static TabInstanceSpecificData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String adTabId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectTabInstanceSpecificData.ismaxrowsparam = UtilSql.getValue(result, "ismaxrowsparam");
        objectTabInstanceSpecificData.ismaxrowsparamr = UtilSql.getValue(result, "ismaxrowsparamr");
        objectTabInstanceSpecificData.maxrowsparam = UtilSql.getValue(result, "maxrowsparam");
...
Create a registry
 */
  public static TabInstanceSpecificData[] set(String adTabId, String adOrgId, String adTabInstanceId, String createdby, String createdbyr, String ismaxrowsparam, String adClientId, String maxrowsparam, String isactive, String updatedby, String updatedbyr)    throws ServletException {
    ...
    objectTabInstanceSpecificData[0].ismaxrowsparam = ismaxrowsparam;
    objectTabInstanceSpecificData[0].ismaxrowsparamr = "";
    objectTabInstanceSpecificData[0].maxrowsparam = maxrowsparam;
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET AD_Tab_ID = (?) , Isactive = (?) , Ismaxrowsparam = (?) , Maxrowsparam = TO_NUMBER(?) , AD_Tab_Instance_ID = (?) , AD_Org_ID = (?) , AD_Client_ID = (?) , updated = now(), updatedby = ? " +
      "        WHERE ad_tab_instance.AD_Tab_Instance_ID = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Tab_ID, Isactive, Ismaxrowsparam, Maxrowsparam, AD_Tab_Instance_ID, AD_Org_ID, AD_Client_ID, created, createdby, updated, updatedBy)" +
