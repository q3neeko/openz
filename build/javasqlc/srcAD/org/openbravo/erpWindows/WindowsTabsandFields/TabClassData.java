 ...
 */
  public static TabClassData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String adTabId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN AD_Model_Object.AD_Tab_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL2.Name IS NULL THEN TO_CHAR(table2.Name) ELSE TO_CHAR(tableTRL2.Name) END)), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL3.Name IS NULL THEN TO_CHAR(table3.Name) ELSE TO_CHAR(tableTRL3.Name) END)), ''))),'') ) END) AS AD_Tab_IDR, " +
...
Create a registry
 */
  public static TabClassData[] set(String adTabId, String adTaskId, String adProcessId, String createdby, String createdbyr, String action, String adWorkflowId, String adFormId, String adReferenceId, String isactive, String adClientId, String isdefault, String adCalloutId, String classname, String adModelObjectId, String adOrgId, String updatedby, String updatedbyr)    throws ServletException {
