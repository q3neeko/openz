 ...
 */
  public static FieldTranslationData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String adFieldVId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN AD_Field_Trl.AD_Org_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS AD_Org_IDR, " +
      "AD_Field_Trl.AD_Field_V_ID, " +
      "(CASE WHEN AD_Field_Trl.AD_Field_V_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table2.Name), ''))),'') ) END) AS AD_Field_V_IDR, " +
      "AD_Field_Trl.AD_Language, " +
      "(CASE WHEN AD_Field_Trl.AD_Language IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table3.Name), ''))),'') ) END) AS AD_LanguageR, " +
      ...
      "AD_Field_Trl.Help, " +
      "        ? AS LANGUAGE " +
      "        FROM AD_Field_Trl left join (select AD_Org_ID, Name from AD_Org) table1 on (AD_Field_Trl.AD_Org_ID = table1.AD_Org_ID) left join (select AD_Field_V_ID, Name from AD_Field_V) table2 on (AD_Field_Trl.AD_Field_V_ID = table2.AD_Field_V_ID) left join (select AD_Language, Name from AD_Language) table3 on (AD_Field_Trl.AD_Language =  table3.AD_Language)" +
      "        WHERE 2=2 " +
      "        AND 1=1 ";
...
Create a registry
 */
  public static FieldTranslationData[] set(String adFieldVId, String name, String adFieldTrlId, String adOrgId, String help, String isactive, String istranslated, String description, String adLanguage, String updatedby, String updatedbyr, String adClientId, String createdby, String createdbyr)    throws ServletException {
