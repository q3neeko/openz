 ...
 */
  public static AccessData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String adWindowId, String key, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN AD_Window_Access.AD_Org_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS AD_Org_IDR, " +
      "AD_Window_Access.AD_Window_ID, " +
      "(CASE WHEN AD_Window_Access.AD_Window_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL2.Name IS NULL THEN TO_CHAR(table2.Name) ELSE TO_CHAR(tableTRL2.Name) END)), ''))),'') ) END) AS AD_Window_IDR, " +
...
Create a registry
 */
  public static AccessData[] set(String adWindowId, String createdby, String createdbyr, String adOrgId, String isactive, String isreadwrite, String adRoleId, String adWindowAccessId, String adClientId, String updatedby, String updatedbyr)    throws ServletException {
