 ...
 */
  public static OrdersE157BADD4E594D8487B150B5F79C6B54Data[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String C_BPartner_ID, String cBpartnerId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "C_Order.DateOrdered, " +
      "C_Order.SalesRep_ID, " +
      "(CASE WHEN C_Order.SalesRep_ID IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS SalesRep_IDR, " +
      "C_Order.DateAcct, " +
      ...
      "(CASE WHEN C_Order.C_BPartner_Location_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table5.Name), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table5.Deviant_Bp_Name), ''))),'') ) END) AS C_BPartner_Location_IDR, " +
      "C_Order.BillTo_ID, " +
      ...
      "(CASE WHEN C_Order.Delivery_Location_ID IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table7.Name), ''))),'') ) END) AS Delivery_Location_IDR, " +
      "C_Order.C_Project_ID, " +
      "(CASE WHEN C_Order.C_Project_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table8.Value), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table8.Name), ''))),'') ) END) AS C_Project_IDR, " +
...
Create a registry
 */
  public static OrdersE157BADD4E594D8487B150B5F79C6B54Data[] set(String cBpartnerId, String adUserId, String cBpartnerIdr, String dropshipLocationId, String billtoId, String isselected, String istaxincluded, String user2Id, String cChargeId, String docaction, String totallines, String posted, String isactive, String user1Id, String chargeamt, String deliverynotes, String scheddeliverydate, String cBpartnerLocationId, String cCampaignId, String invoicerule, String dropshipBpartnerId, String deliveryviarule, String mPricelistId, String datepromised, String cProjectId, String cProjectIdr, String docstatus, String transactiondate, String cOrderId, String updatedby, String updatedbyr, String isdelivered, String deliveryrule, String deliveryLocationId, String dateacct, String cCurrencyId, String salesrepId, String adOrgId, String completeordervalue, String schedtransactiondate, String copyfrompo, String deliverycomplete, String issotrx, String isselfservice, String createdby, String createdbyr, String cPaymenttermId, String dateordered, String paymentrule, String generatetemplate, String cActivityId, String documentno, String poreference, String dropshipUserId, String mWarehouseId, String totalpaid, String cDoctypetargetId, String incotermsdescription, String copyfrom, String invoicedamt, String processed, String isdiscountprinted, String freightcostrule, String description, String dateprinted, String isprinted, String grandtotal, String isinvoiced, String iscompletelyinvoiced, String cDoctypeId, String adOrgtrxId, String adClientId, String cIncotermsId, String priorityrule, String processing, String mShipperId, String freightamt)    throws ServletException {
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      "        UPDATE C_Order" +
      "        SET C_Order_ID = (?) , DocumentNo = (?) , DateOrdered = TO_DATE(?) , SalesRep_ID = (?) , DateAcct = TO_DATE(?) , IsActive = (?) , C_DocType_ID = (?) , DocStatus = (?) , C_DocTypeTarget_ID = (?) , Description = (?) , C_BPartner_ID = (?) , C_BPartner_Location_ID = (?) , BillTo_ID = (?) , Delivery_Location_ID = (?) , C_Project_ID = (?) , DatePromised = TO_DATE(?) , SchedDeliveryDate = TO_DATE(?) , SchedTransactionDate = TO_DATE(?) , TransactionDate = TO_DATE(?) , TotalLines = TO_NUMBER(?) , GrandTotal = TO_NUMBER(?) , InvoicedAmt = TO_NUMBER(?) , TotalPaid = TO_NUMBER(?) , IsCompletelyInvoiced = (?) , DeliveryComplete = (?) , IsDelivered = (?) , CopyFrom = (?) , IsSelected = (?) , ChargeAmt = TO_NUMBER(?) , CopyFromPO = (?) , User2_ID = (?) , IsTaxIncluded = (?) , Generatetemplate = (?) , IsPrinted = (?) , DocAction = (?) , DropShip_BPartner_ID = (?) , C_Incoterms_ID = (?) , IsSelfService = (?) , C_Activity_ID = (?) , C_Currency_ID = (?) , PriorityRule = (?) , AD_Client_ID = (?) , C_PaymentTerm_ID = (?) , Processed = (?) , M_Shipper_ID = (?) , IsInvoiced = (?) , User1_ID = (?) , PaymentRule = (?) , CompleteOrderValue = TO_NUMBER(?) , AD_User_ID = (?) , AD_Org_ID = (?) , DeliveryRule = (?) , C_Campaign_ID = (?) , AD_OrgTrx_ID = (?) , M_Warehouse_ID = (?) , Incotermsdescription = (?) , FreightAmt = TO_NUMBER(?) , M_PriceList_ID = (?) , C_Charge_ID = (?) , DropShip_Location_ID = (?) , InvoiceRule = (?) , IsSOTrx = (?) , Processing = (?) , Deliverynotes = (?) , FreightCostRule = (?) , IsDiscountPrinted = (?) , Posted = (?) , DatePrinted = TO_DATE(?) , DropShip_User_ID = (?) , DeliveryViaRule = (?) , POReference = (?) , updated = now(), updatedby = ? " +
      "        WHERE C_Order.C_Order_ID = ? " +
      "                 AND C_Order.C_BPartner_ID = ? " +
      "        AND C_Order.AD_Client_ID IN (";
    strSql = strSql + ((adUserClient==null || adUserClient.equals(""))?"":adUserClient);
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      "        INSERT INTO C_Order " +
      "        (C_Order_ID, DocumentNo, DateOrdered, SalesRep_ID, DateAcct, IsActive, C_DocType_ID, DocStatus, C_DocTypeTarget_ID, Description, C_BPartner_ID, C_BPartner_Location_ID, BillTo_ID, Delivery_Location_ID, C_Project_ID, DatePromised, SchedDeliveryDate, SchedTransactionDate, TransactionDate, TotalLines, GrandTotal, InvoicedAmt, TotalPaid, IsCompletelyInvoiced, DeliveryComplete, IsDelivered, CopyFrom, IsSelected, ChargeAmt, CopyFromPO, User2_ID, IsTaxIncluded, Generatetemplate, IsPrinted, DocAction, DropShip_BPartner_ID, C_Incoterms_ID, IsSelfService, C_Activity_ID, C_Currency_ID, PriorityRule, AD_Client_ID, C_PaymentTerm_ID, Processed, M_Shipper_ID, IsInvoiced, User1_ID, PaymentRule, CompleteOrderValue, AD_User_ID, AD_Org_ID, DeliveryRule, C_Campaign_ID, AD_OrgTrx_ID, M_Warehouse_ID, Incotermsdescription, FreightAmt, M_PriceList_ID, C_Charge_ID, DropShip_Location_ID, InvoiceRule, IsSOTrx, Processing, Deliverynotes, FreightCostRule, IsDiscountPrinted, Posted, DatePrinted, DropShip_User_ID, DeliveryViaRule, POReference, created, createdby, updated, updatedBy)" +
