 ...
 */
  public static OpenShipments0DEB4F6FFA504C2392D17A77AF06E85AData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String cBpartnerId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN zssi_openshipment.Zssi_Openshipment_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table7.DocumentNo), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table7.Name), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(table7.DateOrdered, 'DD-MM-YYYY')),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table7.GrandTotal), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table6.Line), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table6.LineNetAmt), ''))),'') ) END) AS Zssi_Openshipment_IDR, " +
      "zssi_openshipment.SalesRep_ID, " +
      "(CASE WHEN zssi_openshipment.SalesRep_ID IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table8.Name), ''))),'') ) END) AS SalesRep_IDR, " +
...
Create a registry
 */
  public static OpenShipments0DEB4F6FFA504C2392D17A77AF06E85AData[] set(String cBpartnerId, String description, String qtydelivered, String poreference, String cUomId, String qtyordered, String adClientId, String cOrderId, String mProductId, String mProductIdr, String cBpartnerIdr, String zssiOpenshipmentId, String zssiOpenshipmentIdr, String dateordered, String documentno, String salesrepId, String updatedby, String updatedbyr, String datepromised, String isactive, String adOrgId, String scheddeliverydate, String createdby, String createdbyr, String qtyreserved, String qtyinvoiced)    throws ServletException {
