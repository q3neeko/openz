...
static Logger log4j = Logger.getLogger(LocationAddressData.class);
  ...
  public String printcontactname;
  ...
  public String getField(String fieldName) {
    ...
    else if (fieldName.equalsIgnoreCase("printcontactname"))
      return printcontactname;
 ...
 */
  public static LocationAddressData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String cBpartnerId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN C_BPartner_Location.C_BPartner_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Value), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS C_BPartner_IDR, " +
      "C_BPartner_Location.Name, " +
      "C_BPartner_Location.Deviant_Bp_Name, " +
      "COALESCE(C_BPartner_Location.Printcontactname, 'N') AS Printcontactname, " +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectLocationAddressData.printcontactname = UtilSql.getValue(result, "printcontactname");
        ...
        objectLocationAddressData.email = UtilSql.getValue(result, "email");
        objectLocationAddressData.ccemail = UtilSql.getValue(result, "ccemail");
        ...
        objectLocationAddressData.isinvoicebyemail = UtilSql.getValue(result, "isinvoicebyemail");
...
Create a registry
 */
  public static LocationAddressData[] set(String cBpartnerId, String cBpartnerIdr, String isactive, String adOrgId, String phone2, String upc, String ccemail, String isbillto, String email, String isheadquarter, String name, String uidnumber, String cLocationId, String cLocationIdr, String phone, String ispayfrom, String eoriidentification, String cTaxId, String isremitto, String createdby, String createdbyr, String cSalesregionId, String isshipto, String updatedby, String updatedbyr, String cBpartnerLocationId, String istaxlocation, String deviantBpName, String adClientId, String fax, String isinvoicebyemail, String printcontactname)    throws ServletException {
    ...
    objectLocationAddressData[0].printcontactname = printcontactname;
    ...
    objectLocationAddressData[0].email = email;
    objectLocationAddressData[0].ccemail = ccemail;
    objectLocationAddressData[0].isshipto = isshipto;
    objectLocationAddressData[0].isbillto = isbillto;
    objectLocationAddressData[0].isinvoicebyemail = isinvoicebyemail;
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET C_BPartner_ID = (?) , Name = (?) , Deviant_Bp_Name = (?) , Printcontactname = (?) , IsActive = (?) , C_Location_ID = (?) , Phone = (?) , Phone2 = (?) , Fax = (?) , Email = (?) , Ccemail = (?) , IsShipTo = (?) , IsBillTo = (?) , Isinvoicebyemail = (?) , IsHeadquarter = (?) , Uidnumber = (?) , Eoriidentification = (?) , C_Tax_ID = (?) , C_SalesRegion_ID = (?) , UPC = (?) , IsTaxLocation = (?) , C_BPartner_Location_ID = (?) , AD_Org_ID = (?) , AD_Client_ID = (?) , IsRemitTo = (?) , IsPayFrom = (?) , updated = now(), updatedby = ? " +
      "        WHERE C_BPartner_Location.C_BPartner_Location_ID = ? " +
    ...
    st = connectionProvider.getPreparedStatement(conn, strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, printcontactname);
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (C_BPartner_ID, Name, Deviant_Bp_Name, Printcontactname, IsActive, C_Location_ID, Phone, Phone2, Fax, Email, Ccemail, IsShipTo, IsBillTo, Isinvoicebyemail, IsHeadquarter, Uidnumber, Eoriidentification, C_Tax_ID, C_SalesRegion_ID, UPC, IsTaxLocation, C_BPartner_Location_ID, AD_Org_ID, AD_Client_ID, IsRemitTo, IsPayFrom, created, createdby, updated, updatedBy)" +
      "        VALUES ((?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), now(), ?, now(), ?)";
