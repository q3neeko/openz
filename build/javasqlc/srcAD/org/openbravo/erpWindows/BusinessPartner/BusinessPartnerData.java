 ...
 */
  public static BusinessPartnerData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN C_BPartner.Zssi_Groupofcompanies_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table4.Name), ''))),'') ) END) AS Zssi_Groupofcompanies_IDR, " +
      "C_BPartner.C_Lineofbusiness_ID, " +
      "(CASE WHEN C_BPartner.C_Lineofbusiness_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL5.Name IS NULL THEN TO_CHAR(table5.Name) ELSE TO_CHAR(tableTRL5.Name) END)), ''))),'') ) END) AS C_Lineofbusiness_IDR, " +
      "COALESCE(C_BPartner.IsSummary, 'N') AS IsSummary, " +
      "C_BPartner.C_Location_ID, " +
      "(CASE WHEN C_BPartner.C_Location_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table6.Address1), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table6.Address2), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table6.Postal), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table6.City), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table7.Name), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL8.Name IS NULL THEN TO_CHAR(table8.Name) ELSE TO_CHAR(tableTRL8.Name) END)), ''))),'') ) END) AS C_Location_IDR, " +
      "C_BPartner.Country, " +
      "C_BPartner.Zipcode, " +
      "C_BPartner.City, " +
      "C_BPartner.Region, " +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectBusinessPartnerData.adImageId = UtilSql.getValue(result, "ad_image_id");
        ...
        objectBusinessPartnerData.imageurl = UtilSql.getValue(result, "imageurl");
        ...
        objectBusinessPartnerData.region = UtilSql.getValue(result, "region");
...
Create a registry
 */
  public static BusinessPartnerData[] set(String iscustomer, String referenceno, String name, String soCreditused, String isactive, String isvendor, String lastDays, String owncodeatpartnersite, String updatedby, String updatedbyr, String upc, String issummary, String actuallifetimevalue, String description, String isonetime, String region, String cBpartnerId, String adClientId, String numberemployees, String country, String invoicerule, String zssiGroupofcompaniesId, String shareofcustomer, String firstsale, String city, String fiscalcode, String taxid, String adImageId, String zipcode, String value, String issaleslead, String adOrgId, String duns, String showpriceinorder, String invoicegrouping, String createdby, String createdbyr, String adLanguage, String rating, String salesvolume, String name2, String socreditstatus, String cLineofbusinessId, String url, String adForcedOrgId, String acqusitioncost, String naics, String isofiscalcode, String istaxexempt, String imageurl, String cBpGroupId, String isworker, String cLocationId, String cLocationIdr, String potentiallifetimevalue, String isprospect)    throws ServletException {
    ...
    objectBusinessPartnerData[0].adImageId = adImageId;
    ...
    objectBusinessPartnerData[0].imageurl = imageurl;
    ...
    objectBusinessPartnerData[0].region = region;
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      "        UPDATE C_BPartner" +
      "        SET AD_Org_ID = (?) , AD_Image_ID = (?) , Value = (?) , Name = (?) , Name2 = (?) , Description = (?) , Imageurl = (?) , IsActive = (?) , isSalesLead = (?) , TaxID = (?) , ReferenceNo = (?) , Rating = (?) , Owncodeatpartnersite = (?) , C_BP_Group_ID = (?) , AD_Language = (?) , Zssi_Groupofcompanies_ID = (?) , C_Lineofbusiness_ID = (?) , IsSummary = (?) , C_Location_ID = (?) , Country = (?) , Zipcode = (?) , City = (?) , Region = (?) , URL = (?) , IsProspect = (?) , PotentialLifeTimeValue = TO_NUMBER(?) , ActualLifeTimeValue = TO_NUMBER(?) , NumberEmployees = TO_NUMBER(?) , ShareOfCustomer = TO_NUMBER(?) , Last_Days = TO_NUMBER(?) , SalesVolume = TO_NUMBER(?) , FirstSale = TO_DATE(?) , AcqusitionCost = TO_NUMBER(?) , IsVendor = (?) , IsCustomer = (?) , AD_Client_ID = (?) , Fiscalcode = (?) , IsTaxExempt = (?) , AD_Forced_Org_ID = (?) , ShowPriceInOrder = (?) , UPC = (?) , SOCreditStatus = (?) , Invoicegrouping = (?) , Isworker = (?) , InvoiceRule = (?) , ISOFiscalCode = (?) , IsOneTime = (?) , SO_CreditUsed = TO_NUMBER(?) , NAICS = (?) , DUNS = (?) , C_BPartner_ID = (?) , updated = now(), updatedby = ? " +
    ...
    st = connectionProvider.getPreparedStatement(conn, strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, region);
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Org_ID, AD_Image_ID, Value, Name, Name2, Description, Imageurl, IsActive, isSalesLead, TaxID, ReferenceNo, Rating, Owncodeatpartnersite, C_BP_Group_ID, AD_Language, Zssi_Groupofcompanies_ID, C_Lineofbusiness_ID, IsSummary, C_Location_ID, Country, Zipcode, City, Region, URL, IsProspect, PotentialLifeTimeValue, ActualLifeTimeValue, NumberEmployees, ShareOfCustomer, Last_Days, SalesVolume, FirstSale, AcqusitionCost, IsVendor, IsCustomer, AD_Client_ID, Fiscalcode, IsTaxExempt, AD_Forced_Org_ID, ShowPriceInOrder, UPC, SOCreditStatus, Invoicegrouping, Isworker, InvoiceRule, ISOFiscalCode, IsOneTime, SO_CreditUsed, NAICS, DUNS, C_BPartner_ID, created, createdby, updated, updatedBy)" +
