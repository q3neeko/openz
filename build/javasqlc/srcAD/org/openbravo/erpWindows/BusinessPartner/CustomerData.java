...
static Logger log4j = Logger.getLogger(CustomerData.class);
  ...
  public String getField(String fieldName) {
    ...
    else if (fieldName.equalsIgnoreCase("shippingtype"))
      return shippingtype;
    else if (fieldName.equalsIgnoreCase("shippingtyper"))
      return shippingtyper;
 ...
 */
  public static CustomerData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String cBpartnerId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN C_BPartner.C_Incoterms_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table4.Name), ''))),'') ) END) AS C_Incoterms_IDR, " +
      "C_BPartner.shippingtype, " +
      "(CASE WHEN C_BPartner.shippingtype IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(list6.name),'') ) END) AS shippingtypeR, " +
      "C_BPartner.SalesRep_ID, " +
      "(CASE WHEN C_BPartner.SalesRep_ID IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table5.Name), ''))),'') ) END) AS SalesRep_IDR, " +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectCustomerData.cIncotermsId = UtilSql.getValue(result, "c_incoterms_id");
        objectCustomerData.cIncotermsIdr = UtilSql.getValue(result, "c_incoterms_idr");
        objectCustomerData.shippingtype = UtilSql.getValue(result, "shippingtype");
        objectCustomerData.shippingtyper = UtilSql.getValue(result, "shippingtyper");
...
Create a registry
 */
  public static CustomerData[] set(String cBpartnerId, String value, String documentcopies, String iscustomer, String fixmonthday3, String name, String invoicerule, String isactive, String createdby, String createdbyr, String isdiscountprinted, String isecommerceactive, String fixmonthday, String shippingtype, String updatedby, String updatedbyr, String soDescription, String adOrgId, String mPricelistId, String fixmonthday2, String soCreditused, String invoicegrouping, String soBankaccountId, String cPaymenttermId, String deliveryrule, String poreference, String adClientId, String cInvoicescheduleId, String salesrepId, String deliveryviarule, String cIncotermsId, String iscustomerpricelist, String soCreditlimit, String paymentrule)    throws ServletException {
    ...
    objectCustomerData[0].cIncotermsId = cIncotermsId;
    objectCustomerData[0].cIncotermsIdr = "";
    objectCustomerData[0].shippingtype = shippingtype;
    objectCustomerData[0].shippingtyper = "";
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      "        UPDATE C_BPartner" +
      "        SET Value = (?) , Name = (?) , IsActive = (?) , IsCustomer = (?) , DocumentCopies = TO_NUMBER(?) , InvoiceRule = (?) , C_InvoiceSchedule_ID = (?) , Invoicegrouping = (?) , DeliveryRule = (?) , DeliveryViaRule = (?) , M_PriceList_ID = (?) , PaymentRule = (?) , C_PaymentTerm_ID = (?) , C_Incoterms_ID = (?) , shippingtype = (?) , SalesRep_ID = (?) , IsDiscountPrinted = (?) , SO_Description = (?) , SO_CreditLimit = TO_NUMBER(?) , SO_CreditUsed = TO_NUMBER(?) , Isecommerceactive = (?) , Iscustomerpricelist = (?) , SO_Bankaccount_ID = (?) , AD_Org_ID = (?) , C_BPartner_ID = (?) , POReference = (?) , FixMonthDay = TO_NUMBER(?) , FixMonthDay2 = TO_NUMBER(?) , Fixmonthday3 = TO_NUMBER(?) , AD_Client_ID = (?) , updated = now(), updatedby = ? " +
      "        WHERE C_BPartner.C_BPartner_ID = ? " +
      "                 AND C_BPartner.C_BPartner_ID = ? " +
      "        AND C_BPartner.AD_Client_ID IN (";
    strSql = strSql + ((adUserClient==null || adUserClient.equals(""))?"":adUserClient);
    ...
    st = connectionProvider.getPreparedStatement(conn, strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, shippingtype);
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (Value, Name, IsActive, IsCustomer, DocumentCopies, InvoiceRule, C_InvoiceSchedule_ID, Invoicegrouping, DeliveryRule, DeliveryViaRule, M_PriceList_ID, PaymentRule, C_PaymentTerm_ID, C_Incoterms_ID, shippingtype, SalesRep_ID, IsDiscountPrinted, SO_Description, SO_CreditLimit, SO_CreditUsed, Isecommerceactive, Iscustomerpricelist, SO_Bankaccount_ID, AD_Org_ID, C_BPartner_ID, POReference, FixMonthDay, FixMonthDay2, Fixmonthday3, AD_Client_ID, created, createdby, updated, updatedBy)" +
