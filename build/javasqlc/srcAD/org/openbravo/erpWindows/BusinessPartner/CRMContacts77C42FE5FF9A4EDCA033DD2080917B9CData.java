 ...
 */
  public static CRMContacts77C42FE5FF9A4EDCA033DD2080917B9CData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String cBpartnerId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN zssi_notes4customer.C_Bpartner_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Value), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS C_Bpartner_IDR, " +
...
Create a registry
 */
  public static CRMContacts77C42FE5FF9A4EDCA033DD2080917B9CData[] set(String cBpartnerId, String followupDone, String dateofcontact, String followupBy, String followup, String zssiCrmactionsId, String nextAction, String cCampaignId, String adUserId, String isactive, String adClientId, String contactBy, String createdby, String createdbyr, String adOrgId, String description, String cBpartnerIdr, String updatedby, String updatedbyr, String adUseridNext, String cProjectId, String cProjectIdr, String zssiNotes4customerId, String lead2sale)    throws ServletException {
