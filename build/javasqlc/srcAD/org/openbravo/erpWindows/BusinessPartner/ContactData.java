...
static Logger log4j = Logger.getLogger(ContactData.class);
  ...
  public String getField(String fieldName) {
    if (fieldName.equalsIgnoreCase("created"))
      ...
      return email;
    else if (fieldName.equalsIgnoreCase("ccemail"))
      return ccemail;
 ...
 */
  public static ContactData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String cBpartnerId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN AD_User.C_BPartner_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Value), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS C_BPartner_IDR, " +
      ...
      "(CASE WHEN AD_User.C_BPartner_Location_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table4.Name), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table4.Deviant_Bp_Name), ''))),'') ) END) AS C_BPartner_Location_IDR, " +
      ...
      "AD_User.Pausw_Nr, " +
      "AD_User.AD_Language, " +
      "(CASE WHEN AD_User.AD_Language IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table7.Name), ''))),'') ) END) AS AD_LanguageR, " +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectContactData.ccemail = UtilSql.getValue(result, "ccemail");
        ...
        objectContactData.adLanguage = UtilSql.getValue(result, "ad_language");
        objectContactData.adLanguager = UtilSql.getValue(result, "ad_languager");
 ...
 */
  public static ContactData[] set(String cBpartnerId, String stippvisitenkunde, String adOrgtrxId, String planung, String lastname, String phone, String emailuserpw, String emailuser, String ccemail, String emarketing, String marktforschung, String abteilungbereich, String pauswBehoerde, String medwissen, String klinikkunde, String cUserPositionId, String veranstaltungsmanagement, String schluesselkontakt, String enumber, String name, String fax, String defaultMWarehouseId, String communityzugehoerigkeit, String cGreetingId, String sachgebiet, String training, String persoenlicherkontakt2010, String adUserId, String birthday, String kunde, String persoenlicherkontakt2011, String defaultAdClientId, String mailingzielgruppe, String blockbuster, String geschaeftsentwicklung, String branche, String adLanguage, String cBpartnerLocationId, String defaultAdOrgId, String description, String it, String createdby, String createdbyr, String firstname, String klinik, String presse, String unternehmenskommunikation, String persoenlicherkontakt2008, String medicaleducation, String isactive, String phone2, String supervisorId, String salutation, String lastresult, String pauswGueltigBis, String pauswAusgestellt, String username, String aussendienst, String persoenlicherkontakt2009, String email, String processing, String adOrgId, String pauswKopie, String password, String title, String nis, String einkauf, String cUserDepartmentId, String prominenter, String lastcontact, String pauswNr, String positionfunktion, String defaultAdRoleId, String defaultAdLanguage, String hobby, String geschaeftsfuehrer, String land, String adClientId, String comments, String marketing, String updatedby, String updatedbyr, String kol, String kooperation, String humanresources, String salesrepId)    throws ServletException {
    ...
    objectContactData[0].ccemail = ccemail;
    ...
    objectContactData[0].adLanguage = adLanguage;
    objectContactData[0].adLanguager = "";
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      "        UPDATE AD_User" +
      "        SET C_BPartner_ID = (?) , C_Greeting_ID = (?) , Firstname = (?) , Lastname = (?) , Name = (?) , Salutation = (?) , Birthday = TO_DATE(?) , Title = (?) , Email = (?) , Ccemail = (?) , Phone = (?) , Phone2 = (?) , Fax = (?) , C_User_Position_ID = (?) , C_BPartner_Location_ID = (?) , C_User_Department_ID = (?) , Salesrep_ID = (?) , IsActive = (?) , Description = (?) , Comments = (?) , Pausw_Nr = (?) , AD_Language = (?) , Pausw_Kopie = (?) , Pausw_Ausgestellt = TO_DATE(?) , Pausw_Gueltig_Bis = TO_DATE(?) , Pausw_Behoerde = (?) , LastContact = TO_DATE(?) , LastResult = (?) , Branche = (?) , Land = (?) , Kunde = (?) , Klinikkunde = (?) , Stippvisitenkunde = (?) , Mailingzielgruppe = (?) , Geschaeftsfuehrer = (?) , Einkauf = (?) , Marktforschung = (?) , Marketing = (?) , Blockbuster = (?) , Emarketing = (?) , Aussendienst = (?) , Klinik = (?) , It = (?) , Unternehmenskommunikation = (?) , Medicaleducation = (?) , Nis = (?) , Medwissen = (?) , Training = (?) , Humanresources = (?) , Veranstaltungsmanagement = (?) , Geschaeftsentwicklung = (?) , Presse = (?) , Prominenter = (?) , Kol = (?) , Kooperation = (?) , Schluesselkontakt = (?) , Persoenlicherkontakt2008 = (?) , Persoenlicherkontakt2009 = (?) , Persoenlicherkontakt2010 = (?) , Persoenlicherkontakt2011 = (?) , Hobby = (?) , Communityzugehoerigkeit = (?) , Planung = (?) , Positionfunktion = (?) , Abteilungbereich = (?) , Sachgebiet = (?) , Default_Ad_Role_ID = (?) , UserName = (?) , AD_OrgTrx_ID = (?) , Default_Ad_Org_ID = (?) , Supervisor_ID = (?) , Processing = (?) , AD_Client_ID = (?) , AD_User_ID = (?) , Default_M_Warehouse_ID = (?) , Default_Ad_Client_ID = (?) , AD_Org_ID = (?) , EmailUser = (?) , Default_Ad_Language = (?) , Enumber = (?) , updated = now(), updatedby = ? " +
      "        WHERE AD_User.AD_User_ID = ? " +
    ...
    st = connectionProvider.getPreparedStatement(conn, strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, ccemail);
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      "        INSERT INTO AD_User " +
      "        (C_BPartner_ID, C_Greeting_ID, Firstname, Lastname, Name, Salutation, Birthday, Title, Email, Ccemail, Phone, Phone2, Fax, C_User_Position_ID, C_BPartner_Location_ID, C_User_Department_ID, Salesrep_ID, IsActive, Description, Comments, Pausw_Nr, AD_Language, Pausw_Kopie, Pausw_Ausgestellt, Pausw_Gueltig_Bis, Pausw_Behoerde, LastContact, LastResult, Branche, Land, Kunde, Klinikkunde, Stippvisitenkunde, Mailingzielgruppe, Geschaeftsfuehrer, Einkauf, Marktforschung, Marketing, Blockbuster, Emarketing, Aussendienst, Klinik, It, Unternehmenskommunikation, Medicaleducation, Nis, Medwissen, Training, Humanresources, Veranstaltungsmanagement, Geschaeftsentwicklung, Presse, Prominenter, Kol, Kooperation, Schluesselkontakt, Persoenlicherkontakt2008, Persoenlicherkontakt2009, Persoenlicherkontakt2010, Persoenlicherkontakt2011, Hobby, Communityzugehoerigkeit, Planung, Positionfunktion, Abteilungbereich, Sachgebiet, Default_Ad_Role_ID, Default_Ad_Org_ID, Default_M_Warehouse_ID, Enumber, EmailUserPW, AD_Org_ID, AD_User_ID, AD_Client_ID, Password, Processing, Supervisor_ID, AD_OrgTrx_ID, UserName, EmailUser, Default_Ad_Client_ID, Default_Ad_Language, created, createdby, updated, updatedBy)" +
