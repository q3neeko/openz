...
static Logger log4j = Logger.getLogger(VendorCreditorData.class);
  ...
  public String getField(String fieldName) {
    ...
    else if (fieldName.equalsIgnoreCase("minimumordervalue"))
      return minimumordervalue;
    else if (fieldName.equalsIgnoreCase("minimumsurchage"))
      return minimumsurchage;
  ...
  public static VendorCreditorData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String cBpartnerId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectVendorCreditorData.cIncotermsId = UtilSql.getValue(result, "c_incoterms_id");
        objectVendorCreditorData.cIncotermsIdr = UtilSql.getValue(result, "c_incoterms_idr");
        objectVendorCreditorData.minimumordervalue = UtilSql.getValue(result, "minimumordervalue");
        objectVendorCreditorData.minimumsurchage = UtilSql.getValue(result, "minimumsurchage");
...
Create a registry
 */
  public static VendorCreditorData[] set(String cBpartnerId, String minimumsurchage, String poPricelistId, String poFixmonthday3, String value, String isdropshipper, String name, String paymentrulepo, String minimumordervalue, String iscreditcard, String isactive, String isvendor, String createdby, String createdbyr, String cIncotermsId, String adClientId, String poPaymenttermId, String updatedby, String updatedbyr, String poFixmonthday, String poFixmonthday2, String adOrgId)    throws ServletException {
    ...
    objectVendorCreditorData[0].cIncotermsId = cIncotermsId;
    objectVendorCreditorData[0].cIncotermsIdr = "";
    objectVendorCreditorData[0].minimumordervalue = minimumordervalue;
    objectVendorCreditorData[0].minimumsurchage = minimumsurchage;
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(conn, strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, minimumordervalue);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, minimumsurchage);
