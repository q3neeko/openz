 ...
 */
  public static PartialPaymentData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String cPaymenttermId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN C_Paymenttermline.AD_Org_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS AD_Org_IDR, " +
      "C_Paymenttermline.C_PaymentTerm_ID, " +
      "(CASE WHEN C_Paymenttermline.C_PaymentTerm_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL2.Name IS NULL THEN TO_CHAR(table2.Name) ELSE TO_CHAR(tableTRL2.Name) END)), ''))),'') ) END) AS C_PaymentTerm_IDR, " +
      ...
      "        ? AS LANGUAGE " +
      "        FROM C_Paymenttermline left join (select AD_Org_ID, Name from AD_Org) table1 on (C_Paymenttermline.AD_Org_ID = table1.AD_Org_ID) left join (select C_PaymentTerm_ID, Name from C_PaymentTerm) table2 on (C_Paymenttermline.C_PaymentTerm_ID = table2.C_PaymentTerm_ID) left join (select C_PaymentTerm_ID,AD_Language, Name from C_PaymentTerm_TRL) tableTRL2 on (table2.C_PaymentTerm_ID = tableTRL2.C_PaymentTerm_ID and tableTRL2.AD_Language = ?) " +
      "        WHERE 2=2 " +
      "        AND 1=1 ";
...
Create a registry
 */
  public static PartialPaymentData[] set(String cPaymenttermId, String cPaymenttermlineId, String adClientId, String isactive, String fixmonthday3, String onremainder, String fixmonthday2, String createdby, String createdbyr, String paymentrule, String fixmonthcutoff, String netday, String line, String excludetax, String netdays, String updatedby, String updatedbyr, String adOrgId, String percentage, String isnextbusinessday, String isduefixed, String fixmonthoffset, String fixmonthday)    throws ServletException {
