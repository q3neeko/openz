 ...
 */
  public static ReportProcessData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN AD_Process.AD_Org_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table3.Name), ''))),'') ) END) AS AD_Org_IDR, " +
      "AD_Process.Value, " +
      "AD_Process.Name, " +
...
Create a registry
 */
  public static ReportProcessData[] set(String isdirectservletcall, String adOrgId, String adModuleId, String isuserstartable, String name, String createdby, String createdbyr, String value, String isjasper, String manualresponse, String serviceType, String adClientId, String isbackground, String jrname, String adProcessId, String uipattern, String description, String updatedby, String updatedbyr, String help, String isexternalservice, String accesslevel, String isactive, String isreport, String isdirectprint, String procedurename, String serviceSource, String classname)    throws ServletException {
