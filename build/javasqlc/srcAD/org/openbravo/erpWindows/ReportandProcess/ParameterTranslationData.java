 ...
 */
  public static ParameterTranslationData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String adProcessParaId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN AD_Process_Para_Trl.AD_Org_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS AD_Org_IDR, " +
      "AD_Process_Para_Trl.AD_Process_Para_ID, " +
      "(CASE WHEN AD_Process_Para_Trl.AD_Process_Para_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table2.Name), ''))),'') ) END) AS AD_Process_Para_IDR, " +
      "AD_Process_Para_Trl.AD_Language, " +
      "(CASE WHEN AD_Process_Para_Trl.AD_Language IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table3.Name), ''))),'') ) END) AS AD_LanguageR, " +
      ...
      "        ? AS LANGUAGE " +
      "        FROM AD_Process_Para_Trl left join (select AD_Org_ID, Name from AD_Org) table1 on (AD_Process_Para_Trl.AD_Org_ID = table1.AD_Org_ID) left join (select AD_Process_Para_ID, Name from AD_Process_Para) table2 on (AD_Process_Para_Trl.AD_Process_Para_ID = table2.AD_Process_Para_ID) left join (select AD_Language, Name from AD_Language) table3 on (AD_Process_Para_Trl.AD_Language =  table3.AD_Language)" +
      "        WHERE 2=2 " +
      "        AND 1=1 ";
...
Create a registry
 */
  public static ParameterTranslationData[] set(String adProcessParaId, String createdby, String createdbyr, String adOrgId, String name, String adClientId, String help, String description, String isactive, String istranslated, String adProcessParaTrlId, String adLanguage, String updatedby, String updatedbyr)    throws ServletException {
