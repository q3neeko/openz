 ...
 */
  public static GoodsMovementVendorData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "M_InOut.GenerateTo, " +
      "M_InOut.A_Asset_ID, " +
      "(CASE WHEN M_InOut.A_Asset_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table9.Name), ''))),'') ) END) AS A_Asset_IDR, " +
      "M_InOut.C_Project_ID, " +
      "(CASE WHEN M_InOut.C_Project_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table10.Value), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table10.Name), ''))),'') ) END) AS C_Project_IDR, " +
      "M_InOut.C_Projecttask_ID, " +
      "(CASE WHEN M_InOut.C_Projecttask_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table12.Value), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table12.Name), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table11.Name), ''))),'') ) END) AS C_Projecttask_IDR, " +
      "M_InOut.C_Activity_ID, " +
      "(CASE WHEN M_InOut.C_Activity_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table13.Name), ''))),'') ) END) AS C_Activity_IDR, " +
      "M_InOut.C_Campaign_ID, " +
      "(CASE WHEN M_InOut.C_Campaign_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table14.Name), ''))),'') ) END) AS C_Campaign_IDR, " +
      "M_InOut.AD_OrgTrx_ID, " +
      "(CASE WHEN M_InOut.AD_OrgTrx_ID IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table15.Name), ''))),'') ) END) AS AD_OrgTrx_IDR, " +
      "M_InOut.User1_ID, " +
      "M_InOut.User2_ID, " +
      "M_InOut.DocStatus, " +
...
Create a registry
 */
  public static GoodsMovementVendorData[] set(String cActivityId, String updatelines, String deliveryLocationId, String movementtype, String posted, String postedBtn, String deliveryviarule, String shipdate, String adUserId, String aAssetId, String docstatus, String islogistic, String isprinted, String mShipperId, String deliveryrule, String qty, String cBpartnerLocationId, String cInvoiceId, String trackingno, String generatelines, String updatedby, String updatedbyr, String createdby, String createdbyr, String processed, String issotrx, String dateprinted, String freightcostrule, String user2Id, String isactive, String internalnote, String salesrepId, String cBpartnerId, String cBpartnerIdr, String createfrom, String cProjecttaskId, String adOrgId, String cOrderId, String cOrderIdr, String dateacct, String priorityrule, String mInoutId, String mWarehouseId, String adOrgtrxId, String dateordered, String processing, String adClientId, String poreference, String user1Id, String documentno, String docaction, String docactionBtn, String generateto, String cProjectId, String cProjectIdr, String cDoctypeId, String movementdate, String pickdate, String description, String cCampaignId)    throws ServletException {
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      "        UPDATE M_InOut" +
      "        SET AD_Client_ID = (?) , AD_Org_ID = (?) , C_Order_ID = (?) , DocumentNo = (?) , POReference = (?) , Description = (?) , Internalnote = (?) , C_DocType_ID = (?) , MovementDate = TO_DATE(?) , DateAcct = TO_DATE(?) , C_BPartner_ID = (?) , C_BPartner_Location_ID = (?) , AD_User_ID = (?) , Delivery_Location_ID = (?) , PriorityRule = (?) , DeliveryViaRule = (?) , SalesRep_ID = (?) , DeliveryRule = (?) , Qty = TO_NUMBER(?) , CreateFrom = (?) , GenerateTo = (?) , A_Asset_ID = (?) , C_Project_ID = (?) , C_Projecttask_ID = (?) , C_Activity_ID = (?) , C_Campaign_ID = (?) , AD_OrgTrx_ID = (?) , User1_ID = (?) , User2_ID = (?) , DocStatus = (?) , MovementType = (?) , DocAction = (?) , Posted = (?) , PickDate = TO_DATE(?) , TrackingNo = (?) , FreightCostRule = (?) , ShipDate = TO_DATE(?) , Processed = (?) , Islogistic = (?) , UpdateLines = (?) , GenerateLines = (?) , IsActive = (?) , Processing = (?) , DateOrdered = TO_DATE(?) , M_Shipper_ID = (?) , M_InOut_ID = (?) , M_Warehouse_ID = (?) , IsPrinted = (?) , C_Invoice_ID = (?) , DatePrinted = TO_DATE(?) , IsSOTrx = (?) , updated = now(), updatedby = ? " +
      "        WHERE M_InOut.M_InOut_ID = ? " +
      "        AND M_InOut.AD_Client_ID IN (";
    strSql = strSql + ((adUserClient==null || adUserClient.equals(""))?"":adUserClient);
    strSql = strSql + 
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      "        INSERT INTO M_InOut " +
      "        (AD_Client_ID, AD_Org_ID, C_Order_ID, DocumentNo, POReference, Description, Internalnote, C_DocType_ID, MovementDate, DateAcct, C_BPartner_ID, C_BPartner_Location_ID, AD_User_ID, Delivery_Location_ID, PriorityRule, DeliveryViaRule, SalesRep_ID, DeliveryRule, Qty, CreateFrom, GenerateTo, A_Asset_ID, C_Project_ID, C_Projecttask_ID, C_Activity_ID, C_Campaign_ID, AD_OrgTrx_ID, User1_ID, User2_ID, DocStatus, MovementType, DocAction, Posted, PickDate, TrackingNo, FreightCostRule, ShipDate, Processed, Islogistic, UpdateLines, GenerateLines, IsActive, Processing, DateOrdered, M_Shipper_ID, M_InOut_ID, M_Warehouse_ID, IsPrinted, C_Invoice_ID, DatePrinted, IsSOTrx, created, createdby, updated, updatedBy)" +
      "        VALUES ((?), (?), (?), (?), (?), (?), (?), (?), TO_DATE(?), TO_DATE(?), (?), (?), (?), (?), (?), (?), (?), (?), TO_NUMBER(?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), TO_DATE(?), (?), (?), TO_DATE(?), (?), (?), (?), (?), (?), (?), TO_DATE(?), (?), (?), (?), (?), (?), TO_DATE(?), (?), now(), ?, now(), ?)";
