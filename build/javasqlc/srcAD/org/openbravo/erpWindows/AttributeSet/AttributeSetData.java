...
static Logger log4j = Logger.getLogger(AttributeSetData.class);
  ...
  public String getField(String fieldName) {
    if (fieldName.equalsIgnoreCase("created"))
      ...
      return ismandatory;
    else if (fieldName.equalsIgnoreCase("isstocktracking"))
      return isstocktracking;
 ...
 */
  public static AttributeSetData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN M_AttributeSet.AD_Org_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS AD_Org_IDR, " +
      "M_AttributeSet.Name, " +
      "M_AttributeSet.Description, " +
      "COALESCE(M_AttributeSet.Ismandatory, 'N') AS Ismandatory, " +
      "COALESCE(M_AttributeSet.Isstocktracking, 'N') AS Isstocktracking, " +
      ...
      "        ? AS LANGUAGE " +
      "        FROM M_AttributeSet left join (select AD_Org_ID, Name from AD_Org) table1 on (M_AttributeSet.AD_Org_ID = table1.AD_Org_ID)" +
      "        WHERE 2=2 " +
      "        AND 1=1 " +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectAttributeSetData.ismandatory = UtilSql.getValue(result, "ismandatory");
        objectAttributeSetData.isstocktracking = UtilSql.getValue(result, "isstocktracking");
...
Create a registry
 */
  public static AttributeSetData[] set(String isstocktracking, String mAttributesetId, String islot, String createdby, String createdbyr, String adOrgId, String mSernoctlId, String mLotctlId, String islockable, String name, String updatedby, String updatedbyr, String ismandatory, String isguaranteedate, String isactive, String guaranteedays, String adClientId, String description, String isserno)    throws ServletException {
    ...
    objectAttributeSetData[0].ismandatory = ismandatory;
    objectAttributeSetData[0].isstocktracking = isstocktracking;
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET AD_Org_ID = (?) , Name = (?) , Description = (?) , Ismandatory = (?) , Isstocktracking = (?) , IsGuaranteeDate = (?) , IsSerNo = (?) , IsActive = (?) , M_AttributeSet_ID = (?) , M_LotCtl_ID = (?) , AD_Client_ID = (?) , M_SerNoCtl_ID = (?) , IsLot = (?) , GuaranteeDays = TO_NUMBER(?) , IsLockable = (?) , updated = now(), updatedby = ? " +
    ...
    st = connectionProvider.getPreparedStatement(conn, strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, isstocktracking);
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Org_ID, Name, Description, Ismandatory, Isstocktracking, IsGuaranteeDate, IsSerNo, IsActive, M_AttributeSet_ID, M_LotCtl_ID, AD_Client_ID, M_SerNoCtl_ID, IsLot, GuaranteeDays, IsLockable, created, createdby, updated, updatedBy)" +
