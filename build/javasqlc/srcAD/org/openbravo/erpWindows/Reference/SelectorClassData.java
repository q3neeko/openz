 ...
 */
  public static SelectorClassData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String adReferenceId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN AD_Model_Object.AD_Reference_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL2.Name IS NULL THEN TO_CHAR(table2.Name) ELSE TO_CHAR(tableTRL2.Name) END)), ''))),'')  || ' - ' || COALESCE(TO_CHAR(list1.name),'') ) END) AS AD_Reference_IDR, " +
...
Create a registry
 */
  public static SelectorClassData[] set(String adReferenceId, String adTaskId, String adProcessId, String createdby, String createdbyr, String action, String adTabId, String adWorkflowId, String adFormId, String isactive, String adClientId, String isdefault, String adCalloutId, String classname, String adModelObjectId, String adOrgId, String updatedby, String updatedbyr)    throws ServletException {
