...
static Logger log4j = Logger.getLogger(GridColumnsInstancespecificData.class);
  ...
  public String getField(String fieldName) {
    ...
    else if (fieldName.equalsIgnoreCase("dynamiccolssql"))
      return dynamiccolssql;
  ...
  public static GridColumnsInstancespecificData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String adRefGridcolumnId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectGridColumnsInstancespecificData.style = UtilSql.getValue(result, "style");
        ...
        objectGridColumnsInstancespecificData.dynamiccolssql = UtilSql.getValue(result, "dynamiccolssql");
...
Create a registry
 */
  public static GridColumnsInstancespecificData[] set(String adRefGridcolumnId, String onchangeevent, String issecondheader, String colspan, String issortable, String editsetting, String headertext, String style, String template, String isinheader, String isactive, String createdby, String createdbyr, String updatedby, String updatedbyr, String isrowkey, String includesemptyitem, String adValRuleId, String adTableId, String visiblesetting, String maxlength, String referenceurl, String issplitgroup, String colreference, String mandantorylogic, String adElementId, String readonlylogic, String isdisplayed, String dynamiccolssql, String name, String adRefGridcolumninstanceId, String readonly, String adClientId, String adOrgId, String defaultvalue, String line, String required, String rowkeysuffix)    throws ServletException {
    ...
    objectGridColumnsInstancespecificData[0].style = style;
    ...
    objectGridColumnsInstancespecificData[0].dynamiccolssql = dynamiccolssql;
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET AD_Ref_Gridcolumn_ID = (?) , AD_Element_ID = (?) , Isactive = (?) , Line = TO_NUMBER(?) , Visiblesetting = (?) , Colspan = TO_NUMBER(?) , Template = (?) , Issortable = (?) , Style = (?) , Referenceurl = (?) , Rowkeysuffix = (?) , Isrowkey = (?) , Maxlength = TO_NUMBER(?) , Issecondheader = (?) , Issplitgroup = (?) , Colreference = (?) , AD_Client_ID = (?) , AD_Val_Rule_ID = (?) , Isdisplayed = (?) , Mandantorylogic = (?) , Dynamiccolssql = (?) , Readonlylogic = (?) , Isinheader = (?) , Name = (?) , AD_Ref_Gridcolumninstance_ID = (?) , Readonly = (?) , Required = (?) , AD_Org_ID = (?) , Editsetting = (?) , Headertext = (?) , Defaultvalue = (?) , Includesemptyitem = (?) , AD_Table_ID = (?) , Onchangeevent = (?) , updated = now(), updatedby = ? " +
      "        WHERE ad_ref_gridcolumninstance.AD_Ref_Gridcolumninstance_ID = ? " +
    ...
    st = connectionProvider.getPreparedStatement(conn, strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, dynamiccolssql);
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Ref_Gridcolumn_ID, AD_Element_ID, Isactive, Line, Visiblesetting, Colspan, Template, Issortable, Style, Referenceurl, Rowkeysuffix, Isrowkey, Maxlength, Issecondheader, Issplitgroup, Colreference, AD_Client_ID, AD_Val_Rule_ID, Isdisplayed, Mandantorylogic, Dynamiccolssql, Readonlylogic, Isinheader, Name, AD_Ref_Gridcolumninstance_ID, Readonly, Required, AD_Org_ID, Editsetting, Headertext, Defaultvalue, Includesemptyitem, AD_Table_ID, Onchangeevent, created, createdby, updated, updatedBy)" +
