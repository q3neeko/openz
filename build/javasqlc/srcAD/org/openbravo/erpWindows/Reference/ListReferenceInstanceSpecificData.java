 ...
 */
  public static ListReferenceInstanceSpecificData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String adRefListId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "ad_ref_listinstance.Description, " +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectListReferenceInstanceSpecificData.description = UtilSql.getValue(result, "description");
...
Create a registry
 */
  public static ListReferenceInstanceSpecificData[] set(String adRefListId, String updatedby, String updatedbyr, String seqno, String adClientId, String isactive, String adTabId, String adWindowId, String adRefListinstanceId, String name, String value, String adOrgId, String adReferenceId, String description, String ishidden, String isdefault, String createdby, String createdbyr)    throws ServletException {
    ...
    objectListReferenceInstanceSpecificData[0].description = description;
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET AD_Ref_List_ID = (?) , AD_Reference_ID = (?) , Ishidden = (?) , Value = (?) , Name = (?) , Description = (?) , Seqno = TO_NUMBER(?) , Isdefault = (?) , AD_Window_ID = (?) , AD_Tab_ID = (?) , AD_Client_ID = (?) , Isactive = (?) , AD_Org_ID = (?) , AD_Ref_Listinstance_ID = (?) , updated = now(), updatedby = ? " +
      "        WHERE ad_ref_listinstance.AD_Ref_Listinstance_ID = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Ref_List_ID, AD_Reference_ID, Ishidden, Value, Name, Description, Seqno, Isdefault, AD_Window_ID, AD_Tab_ID, AD_Client_ID, Isactive, AD_Org_ID, AD_Ref_Listinstance_ID, created, createdby, updated, updatedBy)" +
