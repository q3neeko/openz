  ...
  public static EditableGridColumnsData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String adRefGroupId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectEditableGridColumnsData.dynamiccolssql = UtilSql.getValue(result, "dynamiccolssql");
        ...
        objectEditableGridColumnsData.style = UtilSql.getValue(result, "style");
...
Create a registry
 */
  public static EditableGridColumnsData[] set(String adRefGroupId, String updatedby, String updatedbyr, String adElementId, String onchangeevent, String issortable, String adClientId, String issplitgroup, String adOrgId, String dynamiccolssql, String defaultvalue, String readonlylogic, String referenceurl, String maxlength, String isdisplayed, String colreference, String name, String required, String mandantorylogic, String rowkeysuffix, String createdby, String createdbyr, String readonly, String isactive, String adTableId, String line, String includesemptyitem, String colspan, String adRefGridcolumnId, String headertext, String style, String adReferenceId, String isinheader, String issecondheader, String isrowkey, String template, String adValRuleId)    throws ServletException {
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET AD_Ref_Group_ID = (?) , Line = TO_NUMBER(?) , Name = (?) , AD_Element_ID = (?) , ReadOnly = (?) , Isdisplayed = (?) , Isactive = (?) , Colspan = TO_NUMBER(?) , Required = (?) , Issecondheader = (?) , MaxLength = TO_NUMBER(?) , Isinheader = (?) , colreference = (?) , Referenceurl = (?) , AD_Table_ID = (?) , AD_Val_Rule_ID = (?) , Includesemptyitem = (?) , Template = (?) , Issplitgroup = (?) , Dynamiccolssql = (?) , Defaultvalue = (?) , Onchangeevent = (?) , Style = (?) , Readonlylogic = (?) , AD_Ref_Gridcolumn_ID = (?) , Rowkeysuffix = (?) , Issortable = (?) , Isrowkey = (?) , Headertext = (?) , AD_Reference_ID = (?) , AD_Org_ID = (?) , AD_Client_ID = (?) , Mandantorylogic = (?) , updated = now(), updatedby = ? " +
      "        WHERE ad_ref_gridcolumn.AD_Ref_Gridcolumn_ID = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Ref_Group_ID, Line, Name, AD_Element_ID, ReadOnly, Isdisplayed, Isactive, Colspan, Required, Issecondheader, MaxLength, Isinheader, colreference, Referenceurl, AD_Table_ID, AD_Val_Rule_ID, Includesemptyitem, Template, Issplitgroup, Dynamiccolssql, Defaultvalue, Onchangeevent, Style, Readonlylogic, AD_Ref_Gridcolumn_ID, Rowkeysuffix, Issortable, Isrowkey, Headertext, AD_Reference_ID, AD_Org_ID, AD_Client_ID, Mandantorylogic, created, createdby, updated, updatedBy)" +
