...
static Logger log4j = Logger.getLogger(TranslationData.class);
  ...
  public String getField(String fieldName) {
    if (fieldName.equalsIgnoreCase("created"))
      ...
      return isactive;
    else if (fieldName.equalsIgnoreCase("ad_ref_list_trl_id") || fieldName.equals("adRefListTrlId"))
...
Select for edit
 */
  public static TranslationData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String adRefListId, String key, String adUserClient, String adOrgClient)    throws ServletException {
...
Select for edit
 */
  public static TranslationData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String adRefListId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      ...
      "(CASE WHEN AD_Ref_List_Trl.AD_Org_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS AD_Org_IDR, " +
      "AD_Ref_List_Trl.AD_Ref_List_ID, " +
      "(CASE WHEN AD_Ref_List_Trl.AD_Ref_List_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL2.Name IS NULL THEN TO_CHAR(table2.Name) ELSE TO_CHAR(tableTRL2.Name) END)), ''))),'') ) END) AS AD_Ref_List_IDR, " +
      "AD_Ref_List_Trl.AD_Language, " +
      "(CASE WHEN AD_Ref_List_Trl.AD_Language IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table3.Name), ''))),'') ) END) AS AD_LanguageR, " +
      ...
      "        ? AS LANGUAGE " +
      "        FROM AD_Ref_List_Trl left join (select AD_Org_ID, Name from AD_Org) table1 on (AD_Ref_List_Trl.AD_Org_ID = table1.AD_Org_ID) left join (select AD_Ref_List_ID, Name from AD_Ref_List) table2 on (AD_Ref_List_Trl.AD_Ref_List_ID = table2.AD_Ref_List_ID) left join (select AD_Ref_List_ID,AD_Language, Name from AD_Ref_List_TRL) tableTRL2 on (table2.AD_Ref_List_ID = tableTRL2.AD_Ref_List_ID and tableTRL2.AD_Language = ?)  left join (select AD_Language, Name from AD_Language) table3 on (AD_Ref_List_Trl.AD_Language =  table3.AD_Language)" +
      "        WHERE 2=2 " +
      "        AND 1=1 ";
    strSql = strSql + ((adRefListId==null || adRefListId.equals(""))?"":"  AND AD_Ref_List_Trl.AD_Ref_List_ID = ?  ");
    strSql = strSql + 
      "        AND AD_Ref_List_Trl.AD_Ref_List_Trl_ID = ? " +
      "        AND AD_Ref_List_Trl.AD_Client_ID IN (";
    strSql = strSql + ((adUserClient==null || adUserClient.equals(""))?"":adUserClient);
    strSql = strSql + 
      ") " +
      "           AND AD_Ref_List_Trl.AD_Org_ID IN (";
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectTranslationData.adRefListId = UtilSql.getValue(result, "ad_ref_list_id");
        objectTranslationData.adRefListIdr = UtilSql.getValue(result, "ad_ref_list_idr");
        ...
        objectTranslationData.adRefListTrlId = UtilSql.getValue(result, "ad_ref_list_trl_id");
...
Create a registry
 */
  public static TranslationData[] set(String adRefListId, String isactive, String name, String description, String updatedby, String updatedbyr, String adClientId, String adRefListTrlId, String istranslated, String adLanguage, String createdby, String createdbyr, String adOrgId)    throws ServletException {
    ...
    objectTranslationData[0].adRefListId = adRefListId;
    objectTranslationData[0].adRefListIdr = "";
    ...
    objectTranslationData[0].adRefListTrlId = adRefListTrlId;
 ...
 */
  public static String selectDef710_0(ConnectionProvider connectionProvider, String UpdatedByR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectDef708_1(ConnectionProvider connectionProvider, String CreatedByR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
 ...
 */
  public static String selectParentID(ConnectionProvider connectionProvider, String key)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        SELECT AD_Ref_List_Trl.AD_Ref_List_ID AS NAME" +
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET AD_Client_ID = (?) , AD_Org_ID = (?) , AD_Ref_List_ID = (?) , AD_Language = (?) , IsTranslated = (?) , Name = (?) , Description = (?) , IsActive = (?) , AD_Ref_List_Trl_ID = (?) , updated = now(), updatedby = ? " +
      "        WHERE AD_Ref_List_Trl.AD_Ref_List_Trl_ID = ? " +
      "                 AND AD_Ref_List_Trl.AD_Ref_List_ID = ? " +
      "        AND AD_Ref_List_Trl.AD_Client_ID IN (";
    strSql = strSql + ((adUserClient==null || adUserClient.equals(""))?"":adUserClient);
    strSql = strSql + 
      ") " +
    ...
    st = connectionProvider.getPreparedStatement(conn, strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, adRefListTrlId);
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Client_ID, AD_Org_ID, AD_Ref_List_ID, AD_Language, IsTranslated, Name, Description, IsActive, AD_Ref_List_Trl_ID, created, createdby, updated, updatedBy)" +
      "        VALUES ((?), (?), (?), (?), (?), (?), (?), (?), (?), now(), ?, now(), ?)";
