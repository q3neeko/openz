  ...
  public static EditableGridGroupsData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String adReferenceId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectEditableGridGroupsData.style = UtilSql.getValue(result, "style");
        objectEditableGridGroupsData.readonlylogic = UtilSql.getValue(result, "readonlylogic");
...
Create a registry
 */
  public static EditableGridGroupsData[] set(String adReferenceId, String readonlylogic, String colsvisibleoninit, String headerformatbold, String createdby, String createdbyr, String isactive, String level, String isautoheader, String updatedby, String updatedbyr, String adClientId, String idcolumn, String leadingemptycols, String adOrgId, String style, String adRefGroupId, String hasevenodd, String hasselectline, String hasselectallbelow, String line, String hasexpander)    throws ServletException {
    ...
    objectEditableGridGroupsData[0].style = style;
    objectEditableGridGroupsData[0].readonlylogic = readonlylogic;
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      "        UPDATE ad_ref_group" +
      "        SET AD_Reference_ID = (?) , Line = TO_NUMBER(?) , Isautoheader = (?) , Idcolumn = (?) , Hasselectline = (?) , Hasselectallbelow = (?) , Hasevenodd = (?) , Hasexpander = (?) , Headerformatbold = (?) , Colsvisibleoninit = (?) , Leadingemptycols = TO_NUMBER(?) , Level = TO_NUMBER(?) , Style = (?) , Readonlylogic = (?) , Isactive = (?) , AD_Ref_Group_ID = (?) , AD_Client_ID = (?) , AD_Org_ID = (?) , updated = now(), updatedby = ? " +
      "        WHERE ad_ref_group.AD_Ref_Group_ID = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Reference_ID, Line, Isautoheader, Idcolumn, Hasselectline, Hasselectallbelow, Hasevenodd, Hasexpander, Headerformatbold, Colsvisibleoninit, Leadingemptycols, Level, Style, Readonlylogic, Isactive, AD_Ref_Group_ID, AD_Client_ID, AD_Org_ID, created, createdby, updated, updatedBy)" +
