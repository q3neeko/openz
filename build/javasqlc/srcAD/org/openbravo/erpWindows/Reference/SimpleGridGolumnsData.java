  ...
  public static SimpleGridGolumnsData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String adReferenceId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectSimpleGridGolumnsData.style = UtilSql.getValue(result, "style");
        ...
        objectSimpleGridGolumnsData.dynamiccolssql = UtilSql.getValue(result, "dynamiccolssql");
...
Create a registry
 */
  public static SimpleGridGolumnsData[] set(String adReferenceId, String isinheader, String updatedby, String updatedbyr, String adElementId, String issecondheader, String adClientId, String headertext, String adOrgId, String adValRuleId, String isrowkey, String rowkeysuffix, String required, String adTableId, String isdisplayed, String includesemptyitem, String readonly, String name, String referenceurl, String mandantorylogic, String readonlylogic, String createdby, String createdbyr, String colreference, String isactive, String maxlength, String line, String colspan, String adRefGridcolumnId, String issortable, String style, String onchangeevent, String dynamiccolssql, String defaultvalue, String adRefGroupId, String template, String issplitgroup)    throws ServletException {
    ...
    objectSimpleGridGolumnsData[0].style = style;
    ...
    objectSimpleGridGolumnsData[0].dynamiccolssql = dynamiccolssql;
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET Isactive = (?) , Line = TO_NUMBER(?) , Name = (?) , AD_Element_ID = (?) , Colspan = TO_NUMBER(?) , Isdisplayed = (?) , Headertext = (?) , Template = (?) , Issortable = (?) , Isrowkey = (?) , Rowkeysuffix = (?) , Style = (?) , Required = (?) , colreference = (?) , AD_Val_Rule_ID = (?) , AD_Table_ID = (?) , AD_Reference_ID = (?) , Includesemptyitem = (?) , AD_Ref_Group_ID = (?) , Referenceurl = (?) , AD_Org_ID = (?) , Readonlylogic = (?) , AD_Ref_Gridcolumn_ID = (?) , Mandantorylogic = (?) , ReadOnly = (?) , Dynamiccolssql = (?) , Issecondheader = (?) , Defaultvalue = (?) , AD_Client_ID = (?) , Isinheader = (?) , MaxLength = TO_NUMBER(?) , Onchangeevent = (?) , Issplitgroup = (?) , updated = now(), updatedby = ? " +
      "        WHERE ad_ref_gridcolumn.AD_Ref_Gridcolumn_ID = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (Isactive, Line, Name, AD_Element_ID, Colspan, Isdisplayed, Headertext, Template, Issortable, Isrowkey, Rowkeysuffix, Style, Required, colreference, AD_Val_Rule_ID, AD_Table_ID, AD_Reference_ID, Includesemptyitem, AD_Ref_Group_ID, Referenceurl, AD_Org_ID, Readonlylogic, AD_Ref_Gridcolumn_ID, Mandantorylogic, ReadOnly, Dynamiccolssql, Issecondheader, Defaultvalue, AD_Client_ID, Isinheader, MaxLength, Onchangeevent, Issplitgroup, created, createdby, updated, updatedBy)" +
