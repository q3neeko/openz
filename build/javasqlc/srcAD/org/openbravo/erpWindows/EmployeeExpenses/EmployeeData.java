...
Select for edit
 */
  public static EmployeeData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient)    throws ServletException {
...
Select for edit
 */
  public static EmployeeData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectEmployeeData.created = UtilSql.getValue(result, "created");
        objectEmployeeData.createdbyr = UtilSql.getValue(result, "createdbyr");
        objectEmployeeData.updated = UtilSql.getValue(result, "updated");
        objectEmployeeData.updatedTimeStamp = UtilSql.getValue(result, "updated_time_stamp");
        objectEmployeeData.updatedby = UtilSql.getValue(result, "updatedby");
        objectEmployeeData.updatedbyr = UtilSql.getValue(result, "updatedbyr");
        objectEmployeeData.isactive = UtilSql.getValue(result, "isactive");
        objectEmployeeData.cBpartnerId = UtilSql.getValue(result, "c_bpartner_id");
        objectEmployeeData.value = UtilSql.getValue(result, "value");
        objectEmployeeData.isemployee = UtilSql.getValue(result, "isemployee");
        objectEmployeeData.name = UtilSql.getValue(result, "name");
        objectEmployeeData.name2 = UtilSql.getValue(result, "name2");
        objectEmployeeData.poPricelistId = UtilSql.getValue(result, "po_pricelist_id");
        objectEmployeeData.poPricelistIdr = UtilSql.getValue(result, "po_pricelist_idr");
        objectEmployeeData.poPaymenttermId = UtilSql.getValue(result, "po_paymentterm_id");
        objectEmployeeData.poPaymenttermIdr = UtilSql.getValue(result, "po_paymentterm_idr");
        ...
        objectEmployeeData.language = UtilSql.getValue(result, "language");
        objectEmployeeData.adUserClient = "";
        objectEmployeeData.adOrgClient = "";
        objectEmployeeData.createdby = "";
        objectEmployeeData.trBgcolor = "";
        objectEmployeeData.totalCount = "";
...
Create a registry
 */
  public static EmployeeData[] set(String poPricelistId, String adOrgId, String value, String isemployee, String name, String cBpartnerId, String createdby, String createdbyr, String adClientId, String poPaymenttermId, String name2, String isactive, String updatedby, String updatedbyr)    throws ServletException {
    EmployeeData objectEmployeeData[] = new EmployeeData[1];
    objectEmployeeData[0] = new EmployeeData();
    objectEmployeeData[0].created = "";
    objectEmployeeData[0].createdbyr = createdbyr;
    objectEmployeeData[0].updated = "";
    objectEmployeeData[0].updatedTimeStamp = "";
    objectEmployeeData[0].updatedby = updatedby;
    objectEmployeeData[0].updatedbyr = updatedbyr;
    objectEmployeeData[0].isactive = isactive;
    objectEmployeeData[0].cBpartnerId = cBpartnerId;
    objectEmployeeData[0].value = value;
    objectEmployeeData[0].isemployee = isemployee;
    objectEmployeeData[0].name = name;
    objectEmployeeData[0].name2 = name2;
    objectEmployeeData[0].poPricelistId = poPricelistId;
    objectEmployeeData[0].poPricelistIdr = "";
    objectEmployeeData[0].poPaymenttermId = poPaymenttermId;
    objectEmployeeData[0].poPaymenttermIdr = "";
    objectEmployeeData[0].adClientId = adClientId;
    objectEmployeeData[0].adOrgId = adOrgId;
    objectEmployeeData[0].language = "";
    return objectEmployeeData;
  }
