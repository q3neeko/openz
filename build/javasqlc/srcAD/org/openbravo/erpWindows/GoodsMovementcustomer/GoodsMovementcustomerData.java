...
static Logger log4j = Logger.getLogger(GoodsMovementcustomerData.class);
  ...
  public String zseShippingtype;
  public String zseShippingtyper;
  ...
  public String zseGetshippinginfo;
  ...
  public String getField(String fieldName) {
    if (fieldName.equalsIgnoreCase("created"))
      ...
      return qtyofpallets;
    else if (fieldName.equalsIgnoreCase("zse_shippingtype") || fieldName.equals("zseShippingtype"))
      return zseShippingtype;
    else if (fieldName.equalsIgnoreCase("zse_shippingtyper") || fieldName.equals("zseShippingtyper"))
      return zseShippingtyper;
      ...
      return postedBtn;
    else if (fieldName.equalsIgnoreCase("zse_getshippinginfo") || fieldName.equals("zseGetshippinginfo"))
      return zseGetshippinginfo;
 ...
 */
  public static GoodsMovementcustomerData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "M_InOut.C_Order_ID, " +
      "(CASE WHEN M_InOut.C_Order_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table2.DocumentNo), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table2.Name), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(table2.DateOrdered, 'DD-MM-YYYY')),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table2.GrandTotal), ''))),'') ) END) AS C_Order_IDR, " +
      "M_InOut.DateOrdered, " +
      "M_InOut.DocumentNo, " +
      "M_InOut.POReference, " +
      "M_InOut.Description, " +
      "M_InOut.Deliverylocationtext, " +
      ...
      "(CASE WHEN M_InOut.C_BPartner_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table4.Value), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table4.Name), ''))),'') ) END) AS C_BPartner_IDR, " +
      "M_InOut.C_BPartner_Location_ID, " +
      "(CASE WHEN M_InOut.C_BPartner_Location_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table5.Name), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table5.Deviant_Bp_Name), ''))),'') ) END) AS C_BPartner_Location_IDR, " +
      "M_InOut.AD_User_ID, " +
      "(CASE WHEN M_InOut.AD_User_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table6.Name), ''))),'') ) END) AS AD_User_IDR, " +
      "M_InOut.Delivery_Location_ID, " +
      "(CASE WHEN M_InOut.Delivery_Location_ID IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table7.Name), ''))),'') ) END) AS Delivery_Location_IDR, " +
      ...
      "M_InOut.SalesRep_ID, " +
      "(CASE WHEN M_InOut.SalesRep_ID IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table8.Name), ''))),'') ) END) AS SalesRep_IDR, " +
      "M_InOut.PickDate, " +
      "M_InOut.C_Incoterms_ID, " +
      "(CASE WHEN M_InOut.C_Incoterms_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table9.Name), ''))),'') ) END) AS C_Incoterms_IDR, " +
      "M_InOut.shippingto, " +
      ...
      "(CASE WHEN M_InOut.M_Shipper_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table10.Name), ''))),'') ) END) AS M_Shipper_IDR, " +
      "M_InOut.TrackingNo, " +
      "M_InOut.ShipDate, " +
      "M_InOut.Weight, " +
      "M_InOut.Weight_Uom, " +
      "(CASE WHEN M_InOut.Weight_Uom IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL11.Name IS NULL THEN TO_CHAR(table11.Name) ELSE TO_CHAR(tableTRL11.Name) END)), ''))),'') ) END) AS Weight_UomR, " +
      ...
      "(CASE WHEN M_InOut.M_Product_ID IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL12.Name IS NULL THEN TO_CHAR(table12.Name) ELSE TO_CHAR(tableTRL12.Name) END)), ''))),'') ) END) AS M_Product_IDR, " +
      "M_InOut.Qty, " +
      "M_InOut.FreightAmt, " +
      "M_InOut.C_Charge_ID, " +
      "(CASE WHEN M_InOut.C_Charge_ID IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table13.Name), ''))),'') ) END) AS C_Charge_IDR, " +
      "M_InOut.ChargeAmt, " +
      "M_InOut.Qtyofpallets, " +
      "M_InOut.ZSE_Shippingtype, " +
      "(CASE WHEN M_InOut.ZSE_Shippingtype IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(list5.name),'') ) END) AS ZSE_ShippingtypeR, " +
      "M_InOut.C_Project_ID, " +
      "(CASE WHEN M_InOut.C_Project_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table14.Value), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table14.Name), ''))),'') ) END) AS C_Project_IDR, " +
      "M_InOut.C_Projecttask_ID, " +
      "(CASE WHEN M_InOut.C_Projecttask_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table16.Value), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table16.Name), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table15.Name), ''))),'') ) END) AS C_Projecttask_IDR, " +
      "M_InOut.DocStatus, " +
      "(CASE WHEN M_InOut.DocStatus IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(list6.name),'') ) END) AS DocStatusR, " +
      "M_InOut.MovementType, " +
      "(CASE WHEN M_InOut.MovementType IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(list7.name),'') ) END) AS MovementTypeR, " +
      "M_InOut.CreateFrom, " +
      "M_InOut.DocAction, " +
      "list8.name as DocAction_BTN, " +
      "M_InOut.Posted, " +
      "list9.name as Posted_BTN, " +
      "M_InOut.ZSE_Getshippinginfo, " +
      "M_InOut.DatePrinted, " +
      ...
      "M_InOut.GenerateTo, " +
      "        ? AS LANGUAGE " +
      "        FROM M_InOut left join (select AD_Org_ID, Name from AD_Org) table1 on (M_InOut.AD_Org_ID = table1.AD_Org_ID) left join (select C_Order_ID, DocumentNo, Name, DateOrdered, GrandTotal from C_Order) table2 on (M_InOut.C_Order_ID = table2.C_Order_ID) left join (select C_DocType_ID, Name from C_DocType) table3 on (M_InOut.C_DocType_ID =  table3.C_DocType_ID) left join (select C_DocType_ID,AD_Language, Name from C_DocType_TRL) tableTRL3 on (table3.C_DocType_ID = tableTRL3.C_DocType_ID and tableTRL3.AD_Language = ?)  left join (select C_BPartner_ID, Value, Name from C_BPartner) table4 on (M_InOut.C_BPartner_ID = table4.C_BPartner_ID) left join (select C_BPartner_Location_ID, Name, Deviant_Bp_Name from C_BPartner_Location) table5 on (M_InOut.C_BPartner_Location_ID = table5.C_BPartner_Location_ID) left join (select AD_User_ID, Name from AD_User) table6 on (M_InOut.AD_User_ID = table6.AD_User_ID) left join (select C_BPartner_Location_ID, Name from C_BPartner_Location) table7 on (M_InOut.Delivery_Location_ID =  table7.C_BPartner_Location_ID) left join ad_ref_list_v list1 on (M_InOut.PriorityRule = list1.value and list1.ad_reference_id = '154' and list1.ad_language = ?)  left join ad_ref_list_v list2 on (M_InOut.DeliveryRule = list2.value and list2.ad_reference_id = '151' and list2.ad_language = ?)  left join (select AD_User_ID, Name from AD_User) table8 on (M_InOut.SalesRep_ID =  table8.AD_User_ID) left join (select C_Incoterms_ID, Name from C_Incoterms) table9 on (M_InOut.C_Incoterms_ID = table9.C_Incoterms_ID) left join ad_ref_list_v list3 on (M_InOut.DeliveryViaRule = list3.value and list3.ad_reference_id = '152' and list3.ad_language = ?)  left join (select M_Shipper_ID, Name from M_Shipper) table10 on (M_InOut.M_Shipper_ID = table10.M_Shipper_ID) left join (select C_UOM_ID, Name from C_UOM) table11 on (M_InOut.Weight_Uom =  table11.C_UOM_ID) left join (select C_UOM_ID,AD_Language, Name from C_UOM_TRL) tableTRL11 on (table11.C_UOM_ID = tableTRL11.C_UOM_ID and tableTRL11.AD_Language = ?)  left join ad_ref_list_v list4 on (M_InOut.FreightCostRule = list4.value and list4.ad_reference_id = '153' and list4.ad_language = ?)  left join (select M_Product_ID, value, Name from M_Product) table12 on (M_InOut.M_Product_ID =  table12.M_Product_ID) left join (select M_Product_ID,AD_Language, Name from M_Product_TRL) tableTRL12 on (table12.M_Product_ID = tableTRL12.M_Product_ID and tableTRL12.AD_Language = ?)  left join (select C_Charge_ID, Name from C_Charge) table13 on (M_InOut.C_Charge_ID =  table13.C_Charge_ID) left join ad_ref_list_v list5 on (M_InOut.ZSE_Shippingtype = list5.value and list5.ad_reference_id = '2686337EF7F14A1AA6CE3DB14DE74270' and list5.ad_language = ?)  left join (select C_Project_ID, Value, Name from C_Project) table14 on (M_InOut.C_Project_ID = table14.C_Project_ID) left join (select C_Projecttask_ID, C_Project_ID, Name from C_Projecttask) table15 on (M_InOut.C_Projecttask_ID = table15.C_Projecttask_ID) left join (select C_Project_ID, Value, Name from C_Project) table16 on (table15.C_Project_ID = table16.C_Project_ID) left join ad_ref_list_v list6 on (M_InOut.DocStatus = list6.value and list6.ad_reference_id = '131' and list6.ad_language = ?)  left join ad_ref_list_v list7 on (M_InOut.MovementType = list7.value and list7.ad_reference_id = '189' and list7.ad_language = ?)  left join ad_ref_list_v list8 on (list8.ad_reference_id = '135' and list8.ad_language = ?  AND (CASE M_InOut.DocAction WHEN '--' THEN 'CL' ELSE TO_CHAR(M_InOut.DocAction) END) = list8.value) left join ad_ref_list_v list9 on (list9.ad_reference_id = '234' and list9.ad_language = ?  AND M_InOut.Posted = TO_CHAR(list9.value))" +
      "        WHERE 2=2 " +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectGoodsMovementcustomerData.deliverylocationtext = UtilSql.getValue(result, "deliverylocationtext");
        ...
        objectGoodsMovementcustomerData.zseShippingtype = UtilSql.getValue(result, "zse_shippingtype");
        objectGoodsMovementcustomerData.zseShippingtyper = UtilSql.getValue(result, "zse_shippingtyper");
        ...
        objectGoodsMovementcustomerData.zseGetshippinginfo = UtilSql.getValue(result, "zse_getshippinginfo");
...
Create a registry
 */
  public static GoodsMovementcustomerData[] set(String updatelines, String deliveryLocationId, String generateto, String movementtype, String chargeamt, String posted, String postedBtn, String zseGetshippinginfo, String deliveryviarule, String adUserId, String docstatus, String islogistic, String pickdate, String isprinted, String cIncotermsId, String deliverylocationtext, String deliveryrule, String qty, String cBpartnerLocationId, String cInvoiceId, String generatelines, String updatedby, String updatedbyr, String zseShippingtype, String dateordered, String createdby, String createdbyr, String shippingto, String cChargeId, String processed, String weightUom, String issotrx, String dateprinted, String internalnote, String isactive, String salesrepId, String cBpartnerId, String cBpartnerIdr, String createfrom, String cProjecttaskId, String adOrgId, String trackingno, String cOrderId, String cOrderIdr, String dateacct, String priorityrule, String mInoutId, String freightcostrule, String mWarehouseId, String processing, String qtyofpallets, String adClientId, String poreference, String mProductId, String documentno, String docaction, String docactionBtn, String cProjectId, String cProjectIdr, String cDoctypeId, String freightamt, String movementdate, String description, String mShipperId, String weight, String shipdate)    throws ServletException {
    ...
    objectGoodsMovementcustomerData[0].deliverylocationtext = deliverylocationtext;
    ...
    objectGoodsMovementcustomerData[0].zseShippingtype = zseShippingtype;
    objectGoodsMovementcustomerData[0].zseShippingtyper = "";
    ...
    objectGoodsMovementcustomerData[0].zseGetshippinginfo = zseGetshippinginfo;
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      "        UPDATE M_InOut" +
      "        SET AD_Org_ID = (?) , C_Order_ID = (?) , DateOrdered = TO_DATE(?) , DocumentNo = (?) , POReference = (?) , Description = (?) , Deliverylocationtext = (?) , Internalnote = (?) , C_DocType_ID = (?) , MovementDate = TO_DATE(?) , DateAcct = TO_DATE(?) , C_BPartner_ID = (?) , C_BPartner_Location_ID = (?) , AD_User_ID = (?) , Delivery_Location_ID = (?) , PriorityRule = (?) , DeliveryRule = (?) , SalesRep_ID = (?) , PickDate = TO_DATE(?) , C_Incoterms_ID = (?) , shippingto = (?) , DeliveryViaRule = (?) , M_Shipper_ID = (?) , TrackingNo = (?) , ShipDate = TO_DATE(?) , Weight = TO_NUMBER(?) , Weight_Uom = (?) , FreightCostRule = (?) , M_Product_ID = (?) , Qty = TO_NUMBER(?) , FreightAmt = TO_NUMBER(?) , C_Charge_ID = (?) , ChargeAmt = TO_NUMBER(?) , Qtyofpallets = TO_NUMBER(?) , ZSE_Shippingtype = (?) , C_Project_ID = (?) , C_Projecttask_ID = (?) , DocStatus = (?) , MovementType = (?) , CreateFrom = (?) , DocAction = (?) , Posted = (?) , ZSE_Getshippinginfo = (?) , DatePrinted = TO_DATE(?) , Processing = (?) , Processed = (?) , IsSOTrx = (?) , UpdateLines = (?) , Islogistic = (?) , GenerateLines = (?) , IsPrinted = (?) , M_InOut_ID = (?) , IsActive = (?) , AD_Client_ID = (?) , M_Warehouse_ID = (?) , C_Invoice_ID = (?) , GenerateTo = (?) , updated = now(), updatedby = ? " +
      "        WHERE M_InOut.M_InOut_ID = ? " +
      "        AND M_InOut.AD_Client_ID IN (";
    strSql = strSql + ((adUserClient==null || adUserClient.equals(""))?"":adUserClient);
    strSql = strSql + 
    ...
    st = connectionProvider.getPreparedStatement(conn, strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, zseShippingtype);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, zseGetshippinginfo);
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      "        INSERT INTO M_InOut " +
      "        (AD_Org_ID, C_Order_ID, DateOrdered, DocumentNo, POReference, Description, Deliverylocationtext, Internalnote, C_DocType_ID, MovementDate, DateAcct, C_BPartner_ID, C_BPartner_Location_ID, AD_User_ID, Delivery_Location_ID, PriorityRule, DeliveryRule, SalesRep_ID, PickDate, C_Incoterms_ID, shippingto, DeliveryViaRule, M_Shipper_ID, TrackingNo, ShipDate, Weight, Weight_Uom, FreightCostRule, M_Product_ID, Qty, FreightAmt, C_Charge_ID, ChargeAmt, Qtyofpallets, ZSE_Shippingtype, C_Project_ID, C_Projecttask_ID, DocStatus, MovementType, CreateFrom, DocAction, Posted, ZSE_Getshippinginfo, DatePrinted, Processing, Processed, IsSOTrx, UpdateLines, Islogistic, GenerateLines, IsPrinted, M_InOut_ID, IsActive, AD_Client_ID, M_Warehouse_ID, C_Invoice_ID, GenerateTo, created, createdby, updated, updatedBy)" +
