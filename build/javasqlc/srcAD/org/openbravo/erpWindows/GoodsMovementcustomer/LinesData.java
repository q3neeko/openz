...
static Logger log4j = Logger.getLogger(LinesData.class);
  ...
  public String zseParcelweight;
  public String zseParcelqty;
  public String zseParcelno;
  ...
  public String getField(String fieldName) {
    if (fieldName.equalsIgnoreCase("created"))
      ...
      return cUomIdr;
    else if (fieldName.equalsIgnoreCase("zse_parcelweight") || fieldName.equals("zseParcelweight"))
      return zseParcelweight;
    else if (fieldName.equalsIgnoreCase("zse_parcelqty") || fieldName.equals("zseParcelqty"))
      return zseParcelqty;
    else if (fieldName.equalsIgnoreCase("zse_parcelno") || fieldName.equals("zseParcelno"))
      return zseParcelno;
 ...
 */
  public static LinesData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String mInoutId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN M_InOutLine.M_Product_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table6.Value), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL6.Name IS NULL THEN TO_CHAR(table6.Name) ELSE TO_CHAR(tableTRL6.Name) END)), ''))),'') ) END) AS M_Product_IDR, " +
      "M_InOutLine.M_AttributeSetInstance_ID, " +
      "(CASE WHEN M_InOutLine.M_AttributeSetInstance_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table7.Description), ''))),'') ) END) AS M_AttributeSetInstance_IDR, " +
      "M_InOutLine.QuantityOrder, " +
      "M_InOutLine.M_Product_Uom_Id, " +
      "(CASE WHEN M_InOutLine.M_Product_Uom_Id IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL9.Name IS NULL THEN TO_CHAR(table9.Name) ELSE TO_CHAR(tableTRL9.Name) END)), ''))),'') ) END) AS M_Product_Uom_IdR, " +
      "M_InOutLine.MovementQty, " +
      "M_InOutLine.Boxnumber, " +
      "M_InOutLine.C_UOM_ID, " +
      "(CASE WHEN M_InOutLine.C_UOM_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL10.Name IS NULL THEN TO_CHAR(table10.Name) ELSE TO_CHAR(tableTRL10.Name) END)), ''))),'') ) END) AS C_UOM_IDR, " +
      "M_InOutLine.ZSE_Parcelweight, " +
      "M_InOutLine.ZSE_Parcelqty, " +
      "M_InOutLine.ZSE_Parcelno, " +
      ...
      "(CASE WHEN M_InOutLine.C_Projecttask_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table13.Value), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table13.Name), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table12.Name), ''))),'') ) END) AS C_Projecttask_IDR, " +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectLinesData.zseParcelweight = UtilSql.getValue(result, "zse_parcelweight");
        objectLinesData.zseParcelqty = UtilSql.getValue(result, "zse_parcelqty");
        objectLinesData.zseParcelno = UtilSql.getValue(result, "zse_parcelno");
...
Create a registry
 */
  public static LinesData[] set(String mInoutId, String line, String movementqty, String mLocatorId, String mLocatorIdr, String mInoutIdr, String mInoutlineId, String cUomId, String mProductUomId, String adClientId, String updatedby, String updatedbyr, String zseParcelweight, String mProductId, String mProductIdr, String isinvoiced, String isactive, String quantityorder, String isdescription, String cProjectId, String cProjectIdr, String adOrgId, String boxnumber, String ispagebreak, String createdby, String createdbyr, String zseParcelno, String upc, String description, String zseParcelqty, String cOrderlineId, String cOrderlineIdr, String mAttributesetinstanceId, String mAttributesetinstanceIdr, String cProjecttaskId)    throws ServletException {
    ...
    objectLinesData[0].zseParcelweight = zseParcelweight;
    objectLinesData[0].zseParcelqty = zseParcelqty;
    objectLinesData[0].zseParcelno = zseParcelno;
...
Select for auxiliar field
 */
  public static String selectDef3539_3(ConnectionProvider connectionProvider, String M_Product_IDR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectDefFBFB0E5EAC68403BAA422D3D2EBF1CB8_4(ConnectionProvider connectionProvider, String C_Project_IDR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectDef3534_5(ConnectionProvider connectionProvider, String CreatedByR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectDef3811_6(ConnectionProvider connectionProvider, String C_OrderLine_IDR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectDef8772_7(ConnectionProvider connectionProvider, String M_AttributeSetInstance_IDR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      "        UPDATE M_InOutLine" +
      "        SET AD_Org_ID = (?) , M_InOut_ID = (?) , C_OrderLine_ID = (?) , Description = (?) , Line = TO_NUMBER(?) , M_Locator_ID = (?) , M_Product_ID = (?) , M_AttributeSetInstance_ID = (?) , QuantityOrder = TO_NUMBER(?) , M_Product_Uom_Id = (?) , MovementQty = TO_NUMBER(?) , Boxnumber = (?) , C_UOM_ID = (?) , ZSE_Parcelweight = TO_NUMBER(?) , ZSE_Parcelqty = TO_NUMBER(?) , ZSE_Parcelno = TO_NUMBER(?) , C_Project_ID = (?) , C_Projecttask_ID = (?) , IsDescription = (?) , AD_Client_ID = (?) , IsActive = (?) , IsInvoiced = (?) , Ispagebreak = (?) , M_InOutLine_ID = (?) , Upc = (?) , updated = now(), updatedby = ? " +
      "        WHERE M_InOutLine.M_InOutLine_ID = ? " +
    ...
    st = connectionProvider.getPreparedStatement(conn, strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, zseParcelweight);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, zseParcelqty);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, zseParcelno);
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Org_ID, M_InOut_ID, C_OrderLine_ID, Description, Line, M_Locator_ID, M_Product_ID, M_AttributeSetInstance_ID, QuantityOrder, M_Product_Uom_Id, MovementQty, Boxnumber, C_UOM_ID, ZSE_Parcelweight, ZSE_Parcelqty, ZSE_Parcelno, C_Project_ID, C_Projecttask_ID, IsDescription, AD_Client_ID, IsActive, IsInvoiced, Ispagebreak, M_InOutLine_ID, Upc, created, createdby, updated, updatedBy)" +
