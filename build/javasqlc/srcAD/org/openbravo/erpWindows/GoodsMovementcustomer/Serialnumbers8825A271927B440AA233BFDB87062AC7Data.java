 ...
 */
  public static Serialnumbers8825A271927B440AA233BFDB87062AC7Data[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String mInoutlineId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "snr_minoutline.Selectedbatch, " +
      "(CASE WHEN snr_minoutline.Selectedbatch IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table5.Batchnumber), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table6.Value), ''))),'') ) END) AS SelectedbatchR, " +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectSerialnumbers8825A271927B440AA233BFDB87062AC7Data.selectedbatch = UtilSql.getValue(result, "selectedbatch");
        objectSerialnumbers8825A271927B440AA233BFDB87062AC7Data.selectedbatchr = UtilSql.getValue(result, "selectedbatchr");
 ...
 */
  public static Serialnumbers8825A271927B440AA233BFDB87062AC7Data[] set(String mInoutlineId, String adClientId, String guaranteedate, String isunavailable, String serialnumber, String rfidnumber, String updatedby, String updatedbyr, String lotnumber, String createdby, String createdbyr, String adOrgId, String description, String snrMinoutlineId, String isactive, String selectedbatch, String selectedbatchr, String quantity, String guaranteedays)    throws ServletException {
    ...
    objectSerialnumbers8825A271927B440AA233BFDB87062AC7Data[0].selectedbatch = selectedbatch;
    objectSerialnumbers8825A271927B440AA233BFDB87062AC7Data[0].selectedbatchr = selectedbatchr;
...
Select for auxiliar field
 */
  public static String selectDef3416EED14F5946659918D08C23F30311_2(ConnectionProvider connectionProvider, String SelectedbatchR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET M_Inoutline_ID = (?) , Serialnumber = (?) , Isunavailable = (?) , Lotnumber = (?) , Selectedbatch = (?) , Quantity = TO_NUMBER(?) , Isactive = (?) , SNR_Minoutline_ID = (?) , Guaranteedate = TO_DATE(?) , Description = (?) , Guaranteedays = TO_NUMBER(?) , AD_Org_ID = (?) , AD_Client_ID = (?) , Rfidnumber = (?) , updated = now(), updatedby = ? " +
      "        WHERE snr_minoutline.SNR_Minoutline_ID = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (M_Inoutline_ID, Serialnumber, Isunavailable, Lotnumber, Selectedbatch, Quantity, Isactive, SNR_Minoutline_ID, Guaranteedate, Description, Guaranteedays, AD_Org_ID, AD_Client_ID, Rfidnumber, created, createdby, updated, updatedBy)" +
