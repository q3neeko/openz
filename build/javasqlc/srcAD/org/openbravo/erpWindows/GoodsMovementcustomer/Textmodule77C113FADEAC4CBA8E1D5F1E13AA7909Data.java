 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET M_Inout_ID = (?) , Zssi_Textmodule_ID = (?) , Line = TO_NUMBER(?) , Islower = (?) , Ismodified = (?) , Text = (?) , Isactive = (?) , AD_Org_ID = (?) , Zssi_Minout_Textmodule_ID = (?) , AD_Client_ID = (?) , updated = now(), updatedby = ? " +
      "        WHERE zssi_minout_textmodule.Zssi_Minout_Textmodule_ID = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (M_Inout_ID, Zssi_Textmodule_ID, Line, Islower, Ismodified, Text, Isactive, AD_Org_ID, Zssi_Minout_Textmodule_ID, AD_Client_ID, created, createdby, updated, updatedBy)" +
