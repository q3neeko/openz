 ...
 */
  public static AccountingData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String cCashbookId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN C_CashBook_Acct.AD_Org_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS AD_Org_IDR, " +
      "C_CashBook_Acct.C_CashBook_ID, " +
      "(CASE WHEN C_CashBook_Acct.C_CashBook_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table2.Name), ''))),'') ) END) AS C_CashBook_IDR, " +
      "C_CashBook_Acct.C_AcctSchema_ID, " +
      "(CASE WHEN C_CashBook_Acct.C_AcctSchema_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table3.Name), ''))),'') ) END) AS C_AcctSchema_IDR, " +
      "COALESCE(C_CashBook_Acct.IsActive, 'N') AS IsActive, " +
      "C_CashBook_Acct.CB_Asset_Acct, " +
      "(CASE WHEN C_CashBook_Acct.CB_Asset_Acct IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table4.Combination), ''))),'') ) END) AS CB_Asset_AcctR, " +
      "C_CashBook_Acct.CB_Differences_Acct, " +
      "(CASE WHEN C_CashBook_Acct.CB_Differences_Acct IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table5.Combination), ''))),'') ) END) AS CB_Differences_AcctR, " +
      "C_CashBook_Acct.CB_CashTransfer_Acct, " +
      "(CASE WHEN C_CashBook_Acct.CB_CashTransfer_Acct IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table6.Combination), ''))),'') ) END) AS CB_CashTransfer_AcctR, " +
      "C_CashBook_Acct.CB_Expense_Acct, " +
      "(CASE WHEN C_CashBook_Acct.CB_Expense_Acct IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table7.Combination), ''))),'') ) END) AS CB_Expense_AcctR, " +
      "C_CashBook_Acct.CB_Receipt_Acct, " +
      "(CASE WHEN C_CashBook_Acct.CB_Receipt_Acct IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table8.Combination), ''))),'') ) END) AS CB_Receipt_AcctR, " +
      "        ? AS LANGUAGE " +
      "        FROM C_CashBook_Acct left join (select AD_Org_ID, Name from AD_Org) table1 on (C_CashBook_Acct.AD_Org_ID = table1.AD_Org_ID) left join (select C_CashBook_ID, Name from C_CashBook) table2 on (C_CashBook_Acct.C_CashBook_ID = table2.C_CashBook_ID) left join (select C_AcctSchema_ID, Name from C_AcctSchema) table3 on (C_CashBook_Acct.C_AcctSchema_ID = table3.C_AcctSchema_ID) left join (select C_ValidCombination_ID, Combination from C_ValidCombination) table4 on (C_CashBook_Acct.CB_Asset_Acct = table4.C_ValidCombination_ID) left join (select C_ValidCombination_ID, Combination from C_ValidCombination) table5 on (C_CashBook_Acct.CB_Differences_Acct = table5.C_ValidCombination_ID) left join (select C_ValidCombination_ID, Combination from C_ValidCombination) table6 on (C_CashBook_Acct.CB_CashTransfer_Acct = table6.C_ValidCombination_ID) left join (select C_ValidCombination_ID, Combination from C_ValidCombination) table7 on (C_CashBook_Acct.CB_Expense_Acct = table7.C_ValidCombination_ID) left join (select C_ValidCombination_ID, Combination from C_ValidCombination) table8 on (C_CashBook_Acct.CB_Receipt_Acct = table8.C_ValidCombination_ID)" +
      "        WHERE 2=2 " +
      "        AND 1=1 ";
...
Create a registry
 */
  public static AccountingData[] set(String cCashbookId, String cbDifferencesAcct, String cbDifferencesAcctr, String cbReceiptAcct, String cbReceiptAcctr, String cbExpenseAcct, String cbExpenseAcctr, String adClientId, String cbAssetAcct, String cbAssetAcctr, String isactive, String adOrgId, String createdby, String createdbyr, String cbCashtransferAcct, String cbCashtransferAcctr, String cAcctschemaId, String cCashbookAcctId, String updatedby, String updatedbyr)    throws ServletException {
