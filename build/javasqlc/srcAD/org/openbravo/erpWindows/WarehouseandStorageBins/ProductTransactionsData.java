 ...
 */
  public static ProductTransactionsData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String M_Locator_ID, String mLocatorId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN M_Transaction.M_Product_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table6.Value), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL6.Name IS NULL THEN TO_CHAR(table6.Name) ELSE TO_CHAR(tableTRL6.Name) END)), ''))),'') ) END) AS M_Product_IDR, " +
      "M_Transaction.M_AttributeSetInstance_ID, " +
      "(CASE WHEN M_Transaction.M_AttributeSetInstance_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table7.Description), ''))),'') ) END) AS M_AttributeSetInstance_IDR, " +
      ...
      "(CASE WHEN M_Transaction.M_InOutLine_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table9.DocumentNo), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(table9.MovementDate, 'DD-MM-YYYY')),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table10.Value), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL10.Name IS NULL THEN TO_CHAR(table10.Name) ELSE TO_CHAR(tableTRL10.Name) END)), ''))),'') ) END) AS M_InOutLine_IDR, " +
      "M_Transaction.M_InventoryLine_ID, " +
      "(CASE WHEN M_Transaction.M_InventoryLine_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table11.Line), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table11.QtyCount), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table12.Name), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table11.Name), ''))),'') ) END) AS M_InventoryLine_IDR, " +
      "M_Transaction.M_MovementLine_ID, " +
      "(CASE WHEN M_Transaction.M_MovementLine_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table13.Line), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table13.MovementQty), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table14.DocumentNo), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table14.Name), ''))),'') ) END) AS M_MovementLine_IDR, " +
      "M_Transaction.M_ProductionLine_ID, " +
      "M_Transaction.M_Internal_Consumptionline_ID, " +
      "(CASE WHEN M_Transaction.M_Internal_Consumptionline_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table16.Name), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table17.Value), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL17.Name IS NULL THEN TO_CHAR(table17.Name) ELSE TO_CHAR(tableTRL17.Name) END)), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table15.MovementQty), ''))),'') ) END) AS M_Internal_Consumptionline_IDR, " +
      "M_Transaction.C_Project_ID, " +
      "(CASE WHEN M_Transaction.C_Project_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table18.Value), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table18.Name), ''))),'') ) END) AS C_Project_IDR, " +
      "M_Transaction.C_Projecttask_ID, " +
      "(CASE WHEN M_Transaction.C_Projecttask_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table20.Value), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table20.Name), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table19.Name), ''))),'') ) END) AS C_Projecttask_IDR, " +
      "M_Transaction.A_Asset_ID, " +
      "(CASE WHEN M_Transaction.A_Asset_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table21.Name), ''))),'') ) END) AS A_Asset_IDR, " +
      "M_Transaction.SNR_Masterdata_ID, " +
      "(CASE WHEN M_Transaction.SNR_Masterdata_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table23.Value), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL23.Name IS NULL THEN TO_CHAR(table23.Name) ELSE TO_CHAR(tableTRL23.Name) END)), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table22.Serialnumber), ''))),'') ) END) AS SNR_Masterdata_IDR, " +
      "M_Transaction.C_ProjectIssue_ID, " +
      "M_Transaction.M_Transaction_ID, " +
      "M_Transaction.C_Projectphase_ID, " +
      "        ? AS LANGUAGE " +
      "        FROM M_Transaction left join (select M_Product_Uom_Id, C_UOM_ID from M_Product_UOM) table1 on (M_Transaction.M_Product_Uom_Id =  table1.M_Product_Uom_Id) left join (select C_UOM_ID, Name from C_UOM) table2 on (table1.C_UOM_ID = table2.C_UOM_ID) left join (select C_UOM_ID,AD_Language, Name from C_UOM_TRL) tableTRL2 on (table2.C_UOM_ID = tableTRL2.C_UOM_ID and tableTRL2.AD_Language = ?)  left join (select C_UOM_ID, Name from C_UOM) table3 on (M_Transaction.C_UOM_ID = table3.C_UOM_ID) left join (select C_UOM_ID,AD_Language, Name from C_UOM_TRL) tableTRL3 on (table3.C_UOM_ID = tableTRL3.C_UOM_ID and tableTRL3.AD_Language = ?)  left join (select AD_Org_ID, Name from AD_Org) table4 on (M_Transaction.AD_Org_ID = table4.AD_Org_ID) left join (select M_Locator_ID, Value from M_Locator) table5 on (M_Transaction.M_Locator_ID = table5.M_Locator_ID) left join (select M_Product_ID, Value, Name from M_Product) table6 on (M_Transaction.M_Product_ID = table6.M_Product_ID) left join (select M_Product_ID,AD_Language, Name from M_Product_TRL) tableTRL6 on (table6.M_Product_ID = tableTRL6.M_Product_ID and tableTRL6.AD_Language = ?)  left join (select M_AttributeSetInstance_ID, Description from M_AttributeSetInstance) table7 on (M_Transaction.M_AttributeSetInstance_ID = table7.M_AttributeSetInstance_ID) left join ad_ref_list_v list1 on (M_Transaction.MovementType = list1.value and list1.ad_reference_id = '189' and list1.ad_language = ?)  left join (select M_InOutLine_ID, M_InOut_ID, M_Product_ID from M_InOutLine) table8 on (M_Transaction.M_InOutLine_ID = table8.M_InOutLine_ID) left join (select M_InOut_ID, DocumentNo, MovementDate from M_InOut) table9 on (table8.M_InOut_ID = table9.M_InOut_ID) left join (select M_Product_ID, Value, Name from M_Product) table10 on (table8.M_Product_ID = table10.M_Product_ID) left join (select M_Product_ID,AD_Language, Name from M_Product_TRL) tableTRL10 on (table10.M_Product_ID = tableTRL10.M_Product_ID and tableTRL10.AD_Language = ?)  left join (select M_InventoryLine_ID, Line, QtyCount, M_Inventory_ID, Name from M_InventoryLine) table11 on (M_Transaction.M_InventoryLine_ID = table11.M_InventoryLine_ID) left join (select M_Inventory_ID, Name from M_Inventory) table12 on (table11.M_Inventory_ID = table12.M_Inventory_ID) left join (select M_MovementLine_ID, Line, MovementQty, M_Movement_ID from M_MovementLine) table13 on (M_Transaction.M_MovementLine_ID = table13.M_MovementLine_ID) left join (select M_Movement_ID, DocumentNo, Name from M_Movement) table14 on (table13.M_Movement_ID = table14.M_Movement_ID) left join (select M_Internal_Consumptionline_ID, M_Internal_Consumption_ID, M_Product_ID, MovementQty from M_Internal_Consumptionline) table15 on (M_Transaction.M_Internal_Consumptionline_ID = table15.M_Internal_Consumptionline_ID) left join (select M_Internal_Consumption_ID, Name from M_Internal_Consumption) table16 on (table15.M_Internal_Consumption_ID = table16.M_Internal_Consumption_ID) left join (select M_Product_ID, Value, Name from M_Product) table17 on (table15.M_Product_ID = table17.M_Product_ID) left join (select M_Product_ID,AD_Language, Name from M_Product_TRL) tableTRL17 on (table17.M_Product_ID = tableTRL17.M_Product_ID and tableTRL17.AD_Language = ?)  left join (select C_Project_ID, Value, Name from C_Project) table18 on (M_Transaction.C_Project_ID = table18.C_Project_ID) left join (select C_Projecttask_ID, C_Project_ID, Name from C_Projecttask) table19 on (M_Transaction.C_Projecttask_ID = table19.C_Projecttask_ID) left join (select C_Project_ID, Value, Name from C_Project) table20 on (table19.C_Project_ID = table20.C_Project_ID) left join (select A_Asset_ID, Name from A_Asset) table21 on (M_Transaction.A_Asset_ID = table21.A_Asset_ID) left join (select SNR_Masterdata_ID, M_Product_ID, Serialnumber from SNR_Masterdata) table22 on (M_Transaction.SNR_Masterdata_ID = table22.SNR_Masterdata_ID) left join (select M_Product_ID, Value, Name from M_Product) table23 on (table22.M_Product_ID = table23.M_Product_ID) left join (select M_Product_ID,AD_Language, Name from M_Product_TRL) tableTRL23 on (table23.M_Product_ID = tableTRL23.M_Product_ID and tableTRL23.AD_Language = ?) " +
      "        WHERE 2=2 " +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectProductTransactionsData.snrMasterdataId = UtilSql.getValue(result, "snr_masterdata_id");
        objectProductTransactionsData.snrMasterdataIdr = UtilSql.getValue(result, "snr_masterdata_idr");
...
Create a registry
 */
  public static ProductTransactionsData[] set(String mLocatorId, String mInventorylineId, String mProductId, String mProductIdr, String mInternalConsumptionlineId, String snrMasterdataId, String cProjectId, String isactive, String mAttributesetinstanceId, String mAttributesetinstanceIdr, String movementqty, String cProjectissueId, String cUomId, String quantityorder, String cProjecttaskId, String adClientId, String mTransactionId, String movementtype, String adOrgId, String mInoutlineId, String mInoutlineIdr, String mLocatorIdr, String mMovementlineId, String createdby, String createdbyr, String cProjectphaseId, String updatedby, String updatedbyr, String mProductUomId, String mProductionlineId, String movementdate, String aAssetId)    throws ServletException {
    ...
    objectProductTransactionsData[0].snrMasterdataId = snrMasterdataId;
    objectProductTransactionsData[0].snrMasterdataIdr = "";
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET QuantityOrder = TO_NUMBER(?) , M_Product_Uom_Id = (?) , C_UOM_ID = (?) , AD_Client_ID = (?) , AD_Org_ID = (?) , M_Locator_ID = (?) , IsActive = (?) , M_Product_ID = (?) , M_AttributeSetInstance_ID = (?) , MovementQty = TO_NUMBER(?) , MovementDate = TO_DATE(?) , MovementType = (?) , M_InOutLine_ID = (?) , M_InventoryLine_ID = (?) , M_MovementLine_ID = (?) , M_ProductionLine_ID = (?) , M_Internal_Consumptionline_ID = (?) , C_Project_ID = (?) , C_Projecttask_ID = (?) , A_Asset_ID = (?) , SNR_Masterdata_ID = (?) , C_ProjectIssue_ID = (?) , M_Transaction_ID = (?) , C_Projectphase_ID = (?) , updated = now(), updatedby = ? " +
      "        WHERE M_Transaction.M_Transaction_ID = ? " +
      "                 AND M_Transaction.M_Locator_ID = ? " +
      "        AND M_Transaction.AD_Client_ID IN (";
    strSql = strSql + ((adUserClient==null || adUserClient.equals(""))?"":adUserClient);
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (QuantityOrder, M_Product_Uom_Id, C_UOM_ID, AD_Client_ID, AD_Org_ID, M_Locator_ID, IsActive, M_Product_ID, M_AttributeSetInstance_ID, MovementQty, MovementDate, MovementType, M_InOutLine_ID, M_InventoryLine_ID, M_MovementLine_ID, M_ProductionLine_ID, M_Internal_Consumptionline_ID, C_Project_ID, C_Projecttask_ID, A_Asset_ID, SNR_Masterdata_ID, C_ProjectIssue_ID, M_Transaction_ID, C_Projectphase_ID, created, createdby, updated, updatedBy)" +
