 ...
 */
  public static StorageBinData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String mWarehouseId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "M_Locator.AD_Org_ID, " +
      "(CASE WHEN M_Locator.AD_Org_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS AD_Org_IDR, " +
      "M_Locator.M_Warehouse_ID, " +
      "(CASE WHEN M_Locator.M_Warehouse_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table2.Name), ''))),'') ) END) AS M_Warehouse_IDR, " +
      "M_Locator.Value, " +
      ...
      "        ? AS LANGUAGE " +
      "        FROM M_Locator left join (select AD_Org_ID, Name from AD_Org) table1 on (M_Locator.AD_Org_ID = table1.AD_Org_ID) left join (select M_Warehouse_ID, Name from M_Warehouse) table2 on (M_Locator.M_Warehouse_ID = table2.M_Warehouse_ID)" +
      "        WHERE 2=2 " +
      "        AND 1=1 ";
...
Create a registry
 */
  public static StorageBinData[] set(String mWarehouseId, String isactive, String x, String isdefault, String islogistic, String createdby, String createdbyr, String priorityno, String adOrgId, String updatedby, String updatedbyr, String z, String mLocatorId, String y, String value, String adClientId)    throws ServletException {
