  ...
  public static WarehouseData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectWarehouseData.cSalesregionId = UtilSql.getValue(result, "c_salesregion_id");
        objectWarehouseData.cSalesregionIdr = UtilSql.getValue(result, "c_salesregion_idr");
...
Create a registry
 */
  public static WarehouseData[] set(String mWarehouseId, String createdby, String createdbyr, String isshipper, String shippercode, String value, String adClientId, String cLocationId, String cLocationIdr, String isactive, String description, String isblocked, String adOrgId, String cSalesregionId, String fromdocumentno, String separator, String todocumentno, String updatedby, String updatedbyr, String name)    throws ServletException {
    ...
    objectWarehouseData[0].cSalesregionId = cSalesregionId;
    objectWarehouseData[0].cSalesregionIdr = "";
