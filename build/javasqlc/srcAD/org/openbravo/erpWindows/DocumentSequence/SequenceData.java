 ...
 */
  public static SequenceData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN AD_Sequence.AD_Org_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS AD_Org_IDR, " +
      "AD_Sequence.Name, " +
      ...
      "        ? AS LANGUAGE " +
      "        FROM AD_Sequence left join (select AD_Org_ID, Name from AD_Org) table1 on (AD_Sequence.AD_Org_ID = table1.AD_Org_ID)" +
      "        WHERE 2=2 " +
      "        AND 1=1 " +
...
Create a registry
 */
  public static SequenceData[] set(String startno, String name, String istableid, String adOrgId, String startnewyear, String updatedby, String updatedbyr, String createdby, String createdbyr, String currentnext, String adClientId, String suffix, String vformat, String description, String isautosequence, String prefix, String incrementno, String currentnextsys, String adSequenceId, String isactive)    throws ServletException {
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      "        UPDATE AD_Sequence" +
      "        SET AD_Client_ID = (?) , AD_Org_ID = (?) , Name = (?) , Description = (?) , IsActive = (?) , IsAutoSequence = (?) , VFormat = (?) , IncrementNo = TO_NUMBER(?) , CurrentNext = TO_NUMBER(?) , StartNewYear = (?) , StartNo = TO_NUMBER(?) , Prefix = (?) , Suffix = (?) , IsTableID = (?) , CurrentNextSys = TO_NUMBER(?) , AD_Sequence_ID = (?) , updated = now(), updatedby = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Client_ID, AD_Org_ID, Name, Description, IsActive, IsAutoSequence, VFormat, IncrementNo, CurrentNext, StartNewYear, StartNo, Prefix, Suffix, IsTableID, CurrentNextSys, AD_Sequence_ID, created, createdby, updated, updatedBy)" +
