 ...
 */
  public static TransactionsData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String M_PRODUCT_ID, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN M_Transaction.SNR_Masterdata_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table21.Value), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL21.Name IS NULL THEN TO_CHAR(table21.Name) ELSE TO_CHAR(tableTRL21.Name) END)), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table20.Serialnumber), ''))),'') ) END) AS SNR_Masterdata_IDR, " +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectTransactionsData.snrMasterdataId = UtilSql.getValue(result, "snr_masterdata_id");
        objectTransactionsData.snrMasterdataIdr = UtilSql.getValue(result, "snr_masterdata_idr");
...
Create a registry
 */
  public static TransactionsData[] set(String mInventorylineId, String mProductId, String mProductIdr, String mInternalConsumptionlineId, String snrMasterdataId, String cProjectId, String mProductUomId, String isactive, String mAttributesetinstanceId, String mAttributesetinstanceIdr, String movementqty, String cUomId, String cProjectissueId, String quantityorder, String cProjecttaskId, String adClientId, String mTransactionId, String movementtype, String adOrgId, String mInoutlineId, String mInoutlineIdr, String mLocatorId, String mLocatorIdr, String mMovementlineId, String createdby, String createdbyr, String cProjectphaseId, String updatedby, String updatedbyr, String mProductionlineId, String movementdate, String aAssetId)    throws ServletException {
    ...
    objectTransactionsData[0].snrMasterdataId = snrMasterdataId;
    objectTransactionsData[0].snrMasterdataIdr = "";
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET M_Product_ID = (?) , QuantityOrder = TO_NUMBER(?) , C_UOM_ID = (?) , AD_Client_ID = (?) , AD_Org_ID = (?) , M_AttributeSetInstance_ID = (?) , IsActive = (?) , M_Locator_ID = (?) , MovementQty = TO_NUMBER(?) , MovementDate = TO_DATE(?) , MovementType = (?) , M_Internal_Consumptionline_ID = (?) , M_InOutLine_ID = (?) , M_InventoryLine_ID = (?) , M_MovementLine_ID = (?) , M_ProductionLine_ID = (?) , C_Project_ID = (?) , C_Projecttask_ID = (?) , A_Asset_ID = (?) , SNR_Masterdata_ID = (?) , C_ProjectIssue_ID = (?) , C_Projectphase_ID = (?) , M_Transaction_ID = (?) , M_Product_Uom_Id = (?) , updated = now(), updatedby = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (M_Product_ID, QuantityOrder, C_UOM_ID, AD_Client_ID, AD_Org_ID, M_AttributeSetInstance_ID, IsActive, M_Locator_ID, MovementQty, MovementDate, MovementType, M_Internal_Consumptionline_ID, M_InOutLine_ID, M_InventoryLine_ID, M_MovementLine_ID, M_ProductionLine_ID, C_Project_ID, C_Projecttask_ID, A_Asset_ID, SNR_Masterdata_ID, C_ProjectIssue_ID, C_Projectphase_ID, M_Transaction_ID, M_Product_Uom_Id, created, createdby, updated, updatedBy)" +
