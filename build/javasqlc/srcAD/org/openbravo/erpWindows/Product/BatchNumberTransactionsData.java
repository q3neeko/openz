 ...
 */
  public static BatchNumberTransactionsData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String snrBatchmasterdataId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN snr_serialnumbertracking.SNR_Builtinsnr IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table26.Serialnumber), ''))),'') ) END) AS SNR_BuiltinsnrR, " +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectBatchNumberTransactionsData.snrBuiltinsnr = UtilSql.getValue(result, "snr_builtinsnr");
        objectBatchNumberTransactionsData.snrBuiltinsnrr = UtilSql.getValue(result, "snr_builtinsnrr");
        objectBatchNumberTransactionsData.pnamevaluesqlfield = UtilSql.getValue(result, "pnamevaluesqlfield");
 ...
 */
  public static BatchNumberTransactionsData[] set(String snrBatchmasterdataId, String mInoutlineId, String mInoutlineIdr, String assemblyProductid, String assemblyProductidr, String isactive, String cProjecttaskId, String snrSerialnumbertrackingId, String mMovementId, String description, String mInventorylineId, String quantity, String movementdate, String mInternalConsumptionlineId, String guaranteedate, String lotnumber, String mMovementlineId, String createdby, String createdbyr, String movementtype, String mInternalConsumptionId, String pnamevaluesqlfield, String assemblySnr, String updatedby, String updatedbyr, String mInventoryId, String guaranteedays, String mAttributesetinstanceId, String mAttributesetinstanceIdr, String mInoutId, String mInoutIdr, String cBpartnerId, String cBpartnerIdr, String snrBuiltinsnr, String adClientId, String rfidnumber, String docstatus, String serialnumber, String mLocatorId, String mLocatorIdr, String cProjectId, String cProjectIdr, String adOrgId, String cOrderlineId, String cOrderlineIdr, String mProductId, String mProductIdr, String aAssetId)    throws ServletException {
    ...
    objectBatchNumberTransactionsData[0].snrBuiltinsnr = snrBuiltinsnr;
    objectBatchNumberTransactionsData[0].snrBuiltinsnrr = "";
    objectBatchNumberTransactionsData[0].pnamevaluesqlfield = pnamevaluesqlfield;
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET M_Product_ID = (?) , Lotnumber = (?) , Quantity = TO_NUMBER(?) , Serialnumber = (?) , Movementdate = TO_DATE(?) , M_Attributesetinstance_ID = (?) , M_Locator_ID = (?) , C_Bpartner_ID = (?) , C_Orderline_ID = (?) , Movementtype = (?) , M_Movement_ID = (?) , M_Inventory_ID = (?) , M_Inout_ID = (?) , M_Internal_Consumption_ID = (?) , M_Inoutline_ID = (?) , M_Movementline_ID = (?) , M_Internal_Consumptionline_ID = (?) , M_Inventoryline_ID = (?) , C_Project_ID = (?) , C_Projecttask_ID = (?) , A_Asset_ID = (?) , Assembly_Productid = (?) , Assembly_Snr = (?) , SNR_Builtinsnr = (?) , Pnamevaluesqlfield = (?) , AD_Org_ID = (?) , Docstatus = (?) , Isactive = (?) , Guaranteedate = TO_DATE(?) , SNR_Serialnumbertracking_ID = (?) , Description = (?) , SNR_Batchmasterdata_ID = (?) , Rfidnumber = (?) , AD_Client_ID = (?) , Guaranteedays = TO_NUMBER(?) , updated = now(), updatedby = ? " +
      "        WHERE snr_serialnumbertracking.SNR_Serialnumbertracking_ID = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (M_Product_ID, Lotnumber, Quantity, Serialnumber, Movementdate, M_Attributesetinstance_ID, M_Locator_ID, C_Bpartner_ID, C_Orderline_ID, Movementtype, M_Movement_ID, M_Inventory_ID, M_Inout_ID, M_Internal_Consumption_ID, M_Inoutline_ID, M_Movementline_ID, M_Internal_Consumptionline_ID, M_Inventoryline_ID, C_Project_ID, C_Projecttask_ID, A_Asset_ID, Assembly_Productid, Assembly_Snr, SNR_Builtinsnr, Pnamevaluesqlfield, AD_Org_ID, Docstatus, Isactive, Guaranteedate, SNR_Serialnumbertracking_ID, Description, SNR_Batchmasterdata_ID, Rfidnumber, AD_Client_ID, Guaranteedays, created, createdby, updated, updatedBy)" +
