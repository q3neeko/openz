 ...
 */
  public static WarehouseAED541A1DC524568A065EE78F41CBDE9Data[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String mProductId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN zssi_onhanqty.AD_Org_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS AD_Org_IDR, " +
      "zssi_onhanqty.M_Product_ID, " +
      "(CASE WHEN zssi_onhanqty.M_Product_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table2.Value), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL2.Name IS NULL THEN TO_CHAR(table2.Name) ELSE TO_CHAR(tableTRL2.Name) END)), ''))),'') ) END) AS M_Product_IDR, " +
      "zssi_onhanqty.M_Warehouse_ID, " +
      "(CASE WHEN zssi_onhanqty.M_Warehouse_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table3.Name), ''))),'') ) END) AS M_Warehouse_IDR, " +
      "zssi_onhanqty.M_Locator_ID, " +
      "(CASE WHEN zssi_onhanqty.M_Locator_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table4.Value), ''))),'') ) END) AS M_Locator_IDR, " +
      ...
      "(CASE WHEN zssi_onhanqty.C_Uom_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL5.Name IS NULL THEN TO_CHAR(table5.Name) ELSE TO_CHAR(tableTRL5.Name) END)), ''))),'') ) END) AS C_Uom_IDR, " +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectWarehouseAED541A1DC524568A065EE78F41CBDE9Data.qtyorderedframe = UtilSql.getValue(result, "qtyorderedframe");
        objectWarehouseAED541A1DC524568A065EE78F41CBDE9Data.qtyinsale = UtilSql.getValue(result, "qtyinsale");
        objectWarehouseAED541A1DC524568A065EE78F41CBDE9Data.qtyinsaleframe = UtilSql.getValue(result, "qtyinsaleframe");
...
Create a registry
 */
  public static WarehouseAED541A1DC524568A065EE78F41CBDE9Data[] set(String mProductId, String qtyorderedframe, String mLocatorId, String mLocatorIdr, String mProductIdr, String cUomId, String qtyincomming, String createdby, String createdbyr, String qtyreserved, String updatedby, String updatedbyr, String qtyinflow, String qtyordered, String qtyinsale, String zssiOnhanqtyId, String mWarehouseId, String qtyoutflow, String isactive, String adClientId, String adOrgId, String mAttributesetinstanceId, String mAttributesetinstanceIdr, String qtyinsaleframe, String qtyonhand)    throws ServletException {
    ...
    objectWarehouseAED541A1DC524568A065EE78F41CBDE9Data[0].qtyorderedframe = qtyorderedframe;
    objectWarehouseAED541A1DC524568A065EE78F41CBDE9Data[0].qtyinsale = qtyinsale;
    objectWarehouseAED541A1DC524568A065EE78F41CBDE9Data[0].qtyinsaleframe = qtyinsaleframe;
 ...
 */
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Org_ID, M_Product_ID, M_Warehouse_ID, M_Locator_ID, QtyOnHand, QtyIncomming, Qtyreserved, Qtyordered, Qtyorderedframe, QtyInsale, Qtyinsaleframe, Qtyinflow, Qtyoutflow, C_Uom_ID, M_Attributesetinstance_ID, Isactive, AD_Client_ID, Zssi_Onhanqty_ID, created, createdby, updated, updatedBy)" +
