  ...
  public static PriceAdjustmentData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String mProductpriceId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectPriceAdjustmentData.mAttributesetinstanceId = UtilSql.getValue(result, "m_attributesetinstance_id");
        objectPriceAdjustmentData.mAttributesetinstanceIdr = UtilSql.getValue(result, "m_attributesetinstance_idr");
        objectPriceAdjustmentData.graterequal = UtilSql.getValue(result, "graterequal");
        objectPriceAdjustmentData.lessequal = UtilSql.getValue(result, "lessequal");
...
Create a registry
 */
  public static PriceAdjustmentData[] set(String mProductpriceId, String graterequal, String addamt, String qtyTo, String directpurchasecalc, String mAttributesetinstanceId, String mAttributesetinstanceIdr, String mOfferplistVId, String isactive, String priority, String description, String qtyFrom, String dateto, String mPricelistId, String prodCatSelection, String issalesoffer, String pricelistSelection, String discount, String mProductId, String mProductIdr, String bpartnerSelection, String adOrgId, String updatedby, String updatedbyr, String createdby, String createdbyr, String bpGroupSelection, String datefrom, String cUomId, String fixed, String adClientId, String lessequal, String productSelection, String name)    throws ServletException {
    ...
    objectPriceAdjustmentData[0].mAttributesetinstanceId = mAttributesetinstanceId;
    objectPriceAdjustmentData[0].mAttributesetinstanceIdr = mAttributesetinstanceIdr;
    objectPriceAdjustmentData[0].graterequal = graterequal;
    objectPriceAdjustmentData[0].lessequal = lessequal;
 ...
 */
  public static String selectDefF3B18E3DDBB1403EA8B84CBB47EBAE4C_0(ConnectionProvider connectionProvider, String M_Attributesetinstance_IDR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectDef1961B4AE66DB41DC9AB135ADE09B3410_1(ConnectionProvider connectionProvider, String M_Product_IDR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectDefEA017F229520407281E0C871872E2C25_2(ConnectionProvider connectionProvider, String UpdatedbyR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectDef37E78F935C094F898DE19D100EA855C7_3(ConnectionProvider connectionProvider, String CreatedbyR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
