...
Create a registry
 */
  public static BatchNumbersData[] set(String auxfield1, String mProductId, String mProductIdr, String batchnumber, String description, String auxfield3, String adOrgId, String adClientId, String guaranteedate, String snrBatchmasterdataId, String updatedby, String updatedbyr, String firstseen, String auxfield2, String createdby, String createdbyr, String qtyonhand, String isactive)    throws ServletException {
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET AD_Org_ID = (?) , M_Product_ID = (?) , Batchnumber = (?) , Qtyonhand = TO_NUMBER(?) , Firstseen = TO_DATE(?) , Guaranteedate = TO_DATE(?) , Description = (?) , Auxfield3 = (?) , Isactive = (?) , Auxfield1 = (?) , SNR_Batchmasterdata_ID = (?) , AD_Client_ID = (?) , Auxfield2 = (?) , updated = now(), updatedby = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Org_ID, M_Product_ID, Batchnumber, Qtyonhand, Firstseen, Guaranteedate, Description, Auxfield3, Isactive, Auxfield1, SNR_Batchmasterdata_ID, AD_Client_ID, Auxfield2, created, createdby, updated, updatedBy)" +
