  ...
  public static SerialNumberTransactionsData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String snr_masterdata_id, String m_product_id, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectSerialNumberTransactionsData.snrBuiltinsnr = UtilSql.getValue(result, "snr_builtinsnr");
        objectSerialNumberTransactionsData.snrBuiltinsnrr = UtilSql.getValue(result, "snr_builtinsnrr");
        objectSerialNumberTransactionsData.pnamevaluesqlfield = UtilSql.getValue(result, "pnamevaluesqlfield");
 ...
 */
  public static SerialNumberTransactionsData[] set(String assemblyProductid, String assemblyProductidr, String mInoutlineId, String mInoutlineIdr, String snrSerialnumbertrackingId, String isactive, String cProjecttaskId, String mMovementId, String description, String mInventorylineId, String quantity, String movementdate, String mInternalConsumptionlineId, String adOrgId, String guaranteedate, String lotnumber, String mMovementlineId, String createdby, String createdbyr, String movementtype, String mInternalConsumptionId, String pnamevaluesqlfield, String assemblySnr, String updatedby, String updatedbyr, String mInventoryId, String guaranteedays, String mAttributesetinstanceId, String mAttributesetinstanceIdr, String mInoutId, String mInoutIdr, String cBpartnerId, String cBpartnerIdr, String snrBuiltinsnr, String adClientId, String rfidnumber, String docstatus, String mLocatorId, String mLocatorIdr, String serialnumber, String cProjectId, String cProjectIdr, String cOrderlineId, String cOrderlineIdr, String mProductId, String mProductIdr, String aAssetId)    throws ServletException {
    ...
    objectSerialNumberTransactionsData[0].snrBuiltinsnr = snrBuiltinsnr;
    objectSerialNumberTransactionsData[0].snrBuiltinsnrr = "";
    objectSerialNumberTransactionsData[0].pnamevaluesqlfield = pnamevaluesqlfield;
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET Serialnumber = (?) , Movementdate = TO_DATE(?) , M_Product_ID = (?) , M_Attributesetinstance_ID = (?) , M_Locator_ID = (?) , C_Bpartner_ID = (?) , C_Orderline_ID = (?) , Movementtype = (?) , M_Movement_ID = (?) , M_Inventory_ID = (?) , M_Inout_ID = (?) , M_Internal_Consumption_ID = (?) , M_Inoutline_ID = (?) , M_Movementline_ID = (?) , M_Internal_Consumptionline_ID = (?) , M_Inventoryline_ID = (?) , C_Project_ID = (?) , C_Projecttask_ID = (?) , A_Asset_ID = (?) , Assembly_Productid = (?) , Assembly_Snr = (?) , AD_Org_ID = (?) , Lotnumber = (?) , Quantity = TO_NUMBER(?) , SNR_Builtinsnr = (?) , Pnamevaluesqlfield = (?) , Description = (?) , SNR_Serialnumbertracking_ID = (?) , Rfidnumber = (?) , Guaranteedays = TO_NUMBER(?) , Isactive = (?) , Docstatus = (?) , AD_Client_ID = (?) , Guaranteedate = TO_DATE(?) , updated = now(), updatedby = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (Serialnumber, Movementdate, M_Product_ID, M_Attributesetinstance_ID, M_Locator_ID, C_Bpartner_ID, C_Orderline_ID, Movementtype, M_Movement_ID, M_Inventory_ID, M_Inout_ID, M_Internal_Consumption_ID, M_Inoutline_ID, M_Movementline_ID, M_Internal_Consumptionline_ID, M_Inventoryline_ID, C_Project_ID, C_Projecttask_ID, A_Asset_ID, Assembly_Productid, Assembly_Snr, AD_Org_ID, Lotnumber, Quantity, SNR_Builtinsnr, Pnamevaluesqlfield, Description, SNR_Serialnumbertracking_ID, Rfidnumber, Guaranteedays, Isactive, Docstatus, AD_Client_ID, Guaranteedate, created, createdby, updated, updatedBy)" +
