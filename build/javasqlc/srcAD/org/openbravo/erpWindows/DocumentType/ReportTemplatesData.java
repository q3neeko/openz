...
static Logger log4j = Logger.getLogger(ReportTemplatesData.class);
  ...
  public String cPrintoutConfigIdr;
  ...
  public String getField(String fieldName) {
    ...
    else if (fieldName.equalsIgnoreCase("c_printout_config_idr") || fieldName.equals("cPrintoutConfigIdr"))
      return cPrintoutConfigIdr;
  ...
  public static ReportTemplatesData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String C_DocType_ID, String cDoctypeId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectReportTemplatesData.cPrintoutConfigId = UtilSql.getValue(result, "c_printout_config_id");
        objectReportTemplatesData.cPrintoutConfigIdr = UtilSql.getValue(result, "c_printout_config_idr");
...
Create a registry
 */
  public static ReportTemplatesData[] set(String cDoctypeId, String cPrintoutConfigId, String createdby, String createdbyr, String adOrgId, String updatedby, String updatedbyr, String templatelocation, String name, String isdefault, String templatefilename, String reportfilename, String isactive, String adClientId, String cPocDoctypeTemplateId)    throws ServletException {
    ...
    objectReportTemplatesData[0].cPrintoutConfigId = cPrintoutConfigId;
    objectReportTemplatesData[0].cPrintoutConfigIdr = "";
