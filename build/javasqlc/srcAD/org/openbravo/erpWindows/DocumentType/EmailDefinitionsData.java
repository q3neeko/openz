 ...
 */
  public static EmailDefinitionsData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String cPocDoctypeTemplateId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN C_POC_EMAILDEFINITION.AD_Org_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS AD_Org_IDR, " +
      "C_POC_EMAILDEFINITION.C_Poc_Doctype_Template_ID, " +
      "(CASE WHEN C_POC_EMAILDEFINITION.C_Poc_Doctype_Template_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table2.Name), ''))),'') ) END) AS C_Poc_Doctype_Template_IDR, " +
      ...
      "(CASE WHEN C_POC_EMAILDEFINITION.AD_Language IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table3.Name), ''))),'') ) END) AS AD_LanguageR, " +
      ...
      "        ? AS LANGUAGE " +
      "        FROM C_POC_EMAILDEFINITION left join (select AD_Org_ID, Name from AD_Org) table1 on (C_POC_EMAILDEFINITION.AD_Org_ID = table1.AD_Org_ID) left join (select C_Poc_Doctype_Template_ID, Name from C_Poc_Doctype_Template) table2 on (C_POC_EMAILDEFINITION.C_Poc_Doctype_Template_ID = table2.C_Poc_Doctype_Template_ID) left join (select AD_Language, Name from AD_Language) table3 on (C_POC_EMAILDEFINITION.AD_Language =  table3.AD_Language)" +
      "        WHERE 2=2 " +
      "        AND 1=1 ";
...
Create a registry
 */
  public static EmailDefinitionsData[] set(String cPocDoctypeTemplateId, String updatedby, String updatedbyr, String isactive, String subject, String createdby, String createdbyr, String body, String adLanguage, String cPocEmaildefinitionId, String isdefault, String adClientId, String adOrgId)    throws ServletException {
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET AD_Org_ID = (?) , C_Poc_Doctype_Template_ID = (?) , Isactive = (?) , Subject = (?) , Body = (?) , AD_Language = (?) , C_Poc_Emaildefinition_ID = (?) , Isdefault = (?) , AD_Client_ID = (?) , updated = now(), updatedby = ? " +
      "        WHERE C_POC_EMAILDEFINITION.C_Poc_Emaildefinition_ID = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Org_ID, C_Poc_Doctype_Template_ID, Isactive, Subject, Body, AD_Language, C_Poc_Emaildefinition_ID, Isdefault, AD_Client_ID, created, createdby, updated, updatedBy)" +
      "        VALUES ((?), (?), (?), (?), (?), (?), (?), (?), (?), now(), ?, now(), ?)";
