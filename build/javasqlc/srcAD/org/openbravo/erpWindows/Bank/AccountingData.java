 ...
 */
  public static AccountingData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String cBankaccountId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN C_BankAccount_Acct.AD_Org_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS AD_Org_IDR, " +
      "C_BankAccount_Acct.C_BankAccount_ID, " +
      "(CASE WHEN C_BankAccount_Acct.C_BankAccount_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table2.DisplayedAccount), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table3.ISO_Code), ''))),'') ) END) AS C_BankAccount_IDR, " +
      "C_BankAccount_Acct.C_AcctSchema_ID, " +
      "(CASE WHEN C_BankAccount_Acct.C_AcctSchema_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table4.Name), ''))),'') ) END) AS C_AcctSchema_IDR, " +
      "COALESCE(C_BankAccount_Acct.IsActive, 'N') AS IsActive, " +
      "C_BankAccount_Acct.B_Asset_Acct, " +
      "(CASE WHEN C_BankAccount_Acct.B_Asset_Acct IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table5.Combination), ''))),'') ) END) AS B_Asset_AcctR, " +
      "C_BankAccount_Acct.B_InTransit_Acct, " +
      "(CASE WHEN C_BankAccount_Acct.B_InTransit_Acct IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table6.Combination), ''))),'') ) END) AS B_InTransit_AcctR, " +
      ...
      "(CASE WHEN C_BankAccount_Acct.B_Expense_Acct IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table7.Combination), ''))),'') ) END) AS B_Expense_AcctR, " +
      "C_BankAccount_Acct.B_InterestExp_Acct, " +
      "C_BankAccount_Acct.B_InterestRev_Acct, " +
      "C_BankAccount_Acct.B_RevaluationGain_Acct, " +
      "(CASE WHEN C_BankAccount_Acct.B_RevaluationGain_Acct IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table8.Combination), ''))),'') ) END) AS B_RevaluationGain_AcctR, " +
      "C_BankAccount_Acct.B_RevaluationLoss_Acct, " +
      "(CASE WHEN C_BankAccount_Acct.B_RevaluationLoss_Acct IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table9.Combination), ''))),'') ) END) AS B_RevaluationLoss_AcctR, " +
      "C_BankAccount_Acct.B_SettlementGain_Acct, " +
      "C_BankAccount_Acct.B_SettlementLoss_Acct, " +
      "        ? AS LANGUAGE " +
      "        FROM C_BankAccount_Acct left join (select AD_Org_ID, Name from AD_Org) table1 on (C_BankAccount_Acct.AD_Org_ID = table1.AD_Org_ID) left join (select C_BankAccount_ID, DisplayedAccount, C_Currency_ID from C_BankAccount) table2 on (C_BankAccount_Acct.C_BankAccount_ID = table2.C_BankAccount_ID) left join (select C_Currency_ID, ISO_Code from C_Currency) table3 on (table2.C_Currency_ID = table3.C_Currency_ID) left join (select C_AcctSchema_ID, Name from C_AcctSchema) table4 on (C_BankAccount_Acct.C_AcctSchema_ID = table4.C_AcctSchema_ID) left join (select C_ValidCombination_ID, Combination from C_ValidCombination) table5 on (C_BankAccount_Acct.B_Asset_Acct = table5.C_ValidCombination_ID) left join (select C_ValidCombination_ID, Combination from C_ValidCombination) table6 on (C_BankAccount_Acct.B_InTransit_Acct = table6.C_ValidCombination_ID) left join (select C_ValidCombination_ID, Combination from C_ValidCombination) table7 on (C_BankAccount_Acct.B_Expense_Acct = table7.C_ValidCombination_ID) left join (select C_ValidCombination_ID, Combination from C_ValidCombination) table8 on (C_BankAccount_Acct.B_RevaluationGain_Acct = table8.C_ValidCombination_ID) left join (select C_ValidCombination_ID, Combination from C_ValidCombination) table9 on (C_BankAccount_Acct.B_RevaluationLoss_Acct = table9.C_ValidCombination_ID)" +
      "        WHERE 2=2 " +
      "        AND 1=1 ";
...
Create a registry
 */
  public static AccountingData[] set(String cBankaccountId, String bSettlementlossAcct, String bSettlementlossAcctr, String cAcctschemaId, String bRevaluationgainAcct, String bRevaluationgainAcctr, String bInterestrevAcct, String bInterestrevAcctr, String bUnallocatedcashAcct, String bUnallocatedcashAcctr, String adOrgId, String bRevaluationlossAcct, String bRevaluationlossAcctr, String bUnidentifiedAcct, String bUnidentifiedAcctr, String adClientId, String bPaymentselectAcct, String bPaymentselectAcctr, String cBankaccountAcctId, String bExpenseAcct, String bExpenseAcctr, String bSettlementgainAcct, String bSettlementgainAcctr, String updatedby, String updatedbyr, String bAssetAcct, String bAssetAcctr, String bInterestexpAcct, String bInterestexpAcctr, String createdby, String createdbyr, String bIntransitAcct, String bIntransitAcctr, String isactive)    throws ServletException {
