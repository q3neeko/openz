 ...
 */
  public static ProcessRequestData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN AD_Process_Request.AD_Org_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS AD_Org_IDR, " +
      "AD_Process_Request.AD_Process_ID, " +
      "(CASE WHEN AD_Process_Request.AD_Process_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL2.Name IS NULL THEN TO_CHAR(table2.Name) ELSE TO_CHAR(tableTRL2.Name) END)), ''))),'') ) END) AS AD_Process_IDR, " +
...
Create a registry
 */
  public static ProcessRequestData[] set(String description, String adClientId, String monthlyDayOfWeek, String adProcessSetId, String adProcessRequestId, String timingOption, String params, String monthlySpecificDay, String dayTue, String createdby, String createdbyr, String adUserId, String nextFireTime, String reschedule, String obContext, String isrolesecurity, String unschedule, String isactive, String startTime, String secondlyRepetitions, String adOrgId, String dailyInterval, String status, String dayFri, String dailyOption, String frequency, String minutelyInterval, String scheduledFinish, String dayWed, String startDate, String daySun, String schedule, String dayMon, String daySat, String previousFireTime, String monthlyOption, String hourlyRepetitions, String dayThu, String finishes, String finishesDate, String minutelyRepetitions, String hourlyInterval, String adProcessId, String channel, String cron, String finishesTime, String secondlyInterval, String updatedby, String updatedbyr)    throws ServletException {
