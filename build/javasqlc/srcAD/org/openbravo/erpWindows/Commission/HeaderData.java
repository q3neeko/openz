 ...
 */
  public static HeaderData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN C_Commission.C_BPartner_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table2.Value), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table2.Name), ''))),'') ) END) AS C_BPartner_IDR, " +
...
Create a registry
 */
  public static HeaderData[] set(String createdby, String createdbyr, String frequencytype, String createfrom, String adOrgId, String cBpartnerId, String cBpartnerIdr, String docbasistype, String adClientId, String cCurrencyId, String description, String shareofturnoverpartner, String isactive, String datelastrun, String shareofturnoverpercent, String mProductId, String mProductIdr, String cCommissionId, String listdetails, String updatedby, String updatedbyr, String processing, String name)    throws ServletException {
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      "        UPDATE C_Commission" +
      "        SET AD_Client_ID = (?) , AD_Org_ID = (?) , Name = (?) , Description = (?) , IsActive = (?) , C_BPartner_ID = (?) , C_Currency_ID = (?) , M_Product_ID = (?) , DocBasisType = (?) , Shareofturnoverpartner = (?) , Shareofturnoverpercent = TO_NUMBER(?) , Processing = (?) , DateLastRun = TO_DATE(?) , C_Commission_ID = (?) , ListDetails = (?) , FrequencyType = (?) , CreateFrom = (?) , updated = now(), updatedby = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Client_ID, AD_Org_ID, Name, Description, IsActive, C_BPartner_ID, C_Currency_ID, M_Product_ID, DocBasisType, Shareofturnoverpartner, Shareofturnoverpercent, Processing, DateLastRun, C_Commission_ID, ListDetails, FrequencyType, CreateFrom, created, createdby, updated, updatedBy)" +
