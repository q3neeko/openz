 ...
 */
  public static ImportBudgetData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN I_Budgetline.AD_Org_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table4.Name), ''))),'') ) END) AS AD_Org_IDR, " +
      "COALESCE(I_Budgetline.IsActive, 'N') AS IsActive, " +
      "I_Budgetline.C_Budget_ID, " +
      "(CASE WHEN I_Budgetline.C_Budget_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table5.Name), ''))),'') ) END) AS C_Budget_IDR, " +
      "I_Budgetline.SeqNo, " +
      "I_Budgetline.Price, " +
      "I_Budgetline.C_Currency_ID, " +
      "(CASE WHEN I_Budgetline.C_Currency_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table6.ISO_Code), ''))),'') ) END) AS C_Currency_IDR, " +
      "I_Budgetline.Currencyident, " +
      "I_Budgetline.Qty, " +
      "I_Budgetline.Amount, " +
      "I_Budgetline.C_Period_ID, " +
      "(CASE WHEN I_Budgetline.C_Period_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table7.Name), ''))),'') ) END) AS C_Period_IDR, " +
      "I_Budgetline.Periodident, " +
      "I_Budgetline.C_Elementvalue_ID, " +
      "(CASE WHEN I_Budgetline.C_Elementvalue_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table8.Value), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL8.Name IS NULL THEN TO_CHAR(table8.Name) ELSE TO_CHAR(tableTRL8.Name) END)), ''))),'') ) END) AS C_Elementvalue_IDR, " +
      "I_Budgetline.Elementvalueident, " +
      "I_Budgetline.C_Acctschema_ID, " +
      "(CASE WHEN I_Budgetline.C_Acctschema_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table9.Name), ''))),'') ) END) AS C_Acctschema_IDR, " +
      "I_Budgetline.Acctschemaident, " +
      "I_Budgetline.M_Product_ID, " +
      "(CASE WHEN I_Budgetline.M_Product_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table10.Value), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL10.Name IS NULL THEN TO_CHAR(table10.Name) ELSE TO_CHAR(tableTRL10.Name) END)), ''))),'') ) END) AS M_Product_IDR, " +
      "I_Budgetline.Productident, " +
      "I_Budgetline.C_UOM_ID, " +
      "(CASE WHEN I_Budgetline.C_UOM_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL11.Name IS NULL THEN TO_CHAR(table11.Name) ELSE TO_CHAR(tableTRL11.Name) END)), ''))),'') ) END) AS C_UOM_IDR, " +
      "I_Budgetline.M_Product_Category_ID, " +
      "(CASE WHEN I_Budgetline.M_Product_Category_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table12.Name), ''))),'') ) END) AS M_Product_Category_IDR, " +
      "I_Budgetline.Prodcategoryident, " +
      "I_Budgetline.C_BPartner_ID, " +
      "(CASE WHEN I_Budgetline.C_BPartner_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table13.Value), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table13.Name), ''))),'') ) END) AS C_BPartner_IDR, " +
      "I_Budgetline.Partnerident, " +
      "I_Budgetline.C_BP_Group_ID, " +
      "(CASE WHEN I_Budgetline.C_BP_Group_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table14.Name), ''))),'') ) END) AS C_BP_Group_IDR, " +
      "I_Budgetline.Bpgroupident, " +
      "I_Budgetline.AD_OrgTrx_ID, " +
      "(CASE WHEN I_Budgetline.AD_OrgTrx_ID IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table15.Name), ''))),'') ) END) AS AD_OrgTrx_IDR, " +
      "I_Budgetline.Orgtrxident, " +
      "I_Budgetline.C_Activity_ID, " +
      "(CASE WHEN I_Budgetline.C_Activity_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table16.Name), ''))),'') ) END) AS C_Activity_IDR, " +
      "I_Budgetline.Activityident, " +
      "I_Budgetline.C_Campaign_ID, " +
      "(CASE WHEN I_Budgetline.C_Campaign_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table17.Name), ''))),'') ) END) AS C_Campaign_IDR, " +
      "I_Budgetline.Campaignident, " +
      "I_Budgetline.C_Project_ID, " +
      "(CASE WHEN I_Budgetline.C_Project_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table18.Value), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table18.Name), ''))),'') ) END) AS C_Project_IDR, " +
      "I_Budgetline.Projectident, " +
      "I_Budgetline.C_SalesRegion_ID, " +
      "(CASE WHEN I_Budgetline.C_SalesRegion_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table19.Name), ''))),'') ) END) AS C_SalesRegion_IDR, " +
      ...
      "        ? AS LANGUAGE " +
      "        FROM I_Budgetline left join (select C_Budgetline_ID, C_Period_ID, SeqNo, C_Budget_ID from C_Budgetline) table1 on (I_Budgetline.C_Budgetline_ID = table1.C_Budgetline_ID) left join (select C_Period_ID, Name from C_Period) table2 on (table1.C_Period_ID =  table2.C_Period_ID) left join (select C_Budget_ID, Name from C_Budget) table3 on (table1.C_Budget_ID = table3.C_Budget_ID) left join (select AD_Org_ID, Name from AD_Org) table4 on (I_Budgetline.AD_Org_ID = table4.AD_Org_ID) left join (select C_Budget_ID, Name from C_Budget) table5 on (I_Budgetline.C_Budget_ID = table5.C_Budget_ID) left join (select C_Currency_ID, ISO_Code from C_Currency) table6 on (I_Budgetline.C_Currency_ID = table6.C_Currency_ID) left join (select C_Period_ID, Name from C_Period) table7 on (I_Budgetline.C_Period_ID = table7.C_Period_ID) left join (select C_Elementvalue_ID, Value, Name from C_Elementvalue) table8 on (I_Budgetline.C_Elementvalue_ID = table8.C_Elementvalue_ID) left join (select C_ElementValue_ID,AD_Language, Name from C_ElementValue_TRL) tableTRL8 on (table8.C_ElementValue_ID = tableTRL8.C_ElementValue_ID and tableTRL8.AD_Language = ?)  left join (select C_Acctschema_ID, Name from C_Acctschema) table9 on (I_Budgetline.C_Acctschema_ID = table9.C_Acctschema_ID) left join (select M_Product_ID, Value, Name from M_Product) table10 on (I_Budgetline.M_Product_ID = table10.M_Product_ID) left join (select M_Product_ID,AD_Language, Name from M_Product_TRL) tableTRL10 on (table10.M_Product_ID = tableTRL10.M_Product_ID and tableTRL10.AD_Language = ?)  left join (select C_UOM_ID, Name from C_UOM) table11 on (I_Budgetline.C_UOM_ID = table11.C_UOM_ID) left join (select C_UOM_ID,AD_Language, Name from C_UOM_TRL) tableTRL11 on (table11.C_UOM_ID = tableTRL11.C_UOM_ID and tableTRL11.AD_Language = ?)  left join (select M_Product_Category_ID, Name from M_Product_Category) table12 on (I_Budgetline.M_Product_Category_ID = table12.M_Product_Category_ID) left join (select C_BPartner_ID, Value, Name from C_BPartner) table13 on (I_Budgetline.C_BPartner_ID = table13.C_BPartner_ID) left join (select C_BP_Group_ID, Name from C_BP_Group) table14 on (I_Budgetline.C_BP_Group_ID = table14.C_BP_Group_ID) left join (select AD_Org_ID, value, Name from AD_Org) table15 on (I_Budgetline.AD_OrgTrx_ID =  table15.AD_Org_ID) left join (select C_Activity_ID, Name from C_Activity) table16 on (I_Budgetline.C_Activity_ID = table16.C_Activity_ID) left join (select C_Campaign_ID, Name from C_Campaign) table17 on (I_Budgetline.C_Campaign_ID = table17.C_Campaign_ID) left join (select C_Project_ID, Value, Name from C_Project) table18 on (I_Budgetline.C_Project_ID = table18.C_Project_ID) left join (select C_SalesRegion_ID, Name from C_SalesRegion) table19 on (I_Budgetline.C_SalesRegion_ID = table19.C_SalesRegion_ID)" +
      "        WHERE 2=2 " +
      "        AND 1=1 " +
...
Create a registry
 */
  public static ImportBudgetData[] set(String seqno, String amount, String projectident, String processed, String cProjectId, String cBpartnerId, String cBpartnerIdr, String description, String qty, String activityident, String cBudgetlineId, String cAcctschemaId, String prodcategoryident, String cPeriodId, String orgtrxident, String cElementvalueId, String cCampaignId, String elementvalueident, String adClientId, String mProductId, String mProductIdr, String price, String adOrgtrxId, String iErrormsg, String cActivityId, String campaignident, String adOrgId, String salesregionident, String updatedby, String updatedbyr, String cCurrencyId, String processing, String productident, String partnerident, String iIsimported, String periodident, String cBudgetId, String cUomId, String cSalesregionId, String createdby, String createdbyr, String isactive, String bpgroupident, String acctschemaident, String currencyident, String iBudgetlineId, String cBpGroupId, String mProductCategoryId)    throws ServletException {
