 ...
 */
  public static MatchedInvoiceData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN M_MatchInv.M_Product_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table7.Value), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL7.Name IS NULL THEN TO_CHAR(table7.Name) ELSE TO_CHAR(tableTRL7.Name) END)), ''))),'') ) END) AS M_Product_IDR, " +
      "M_MatchInv.Qty, " +
      "M_MatchInv.DateTrx, " +
...
Create a registry
 */
  public static MatchedInvoiceData[] set(String adClientId, String cInvoicelineId, String cInvoicelineIdr, String mProductId, String mProductIdr, String posted, String postedBtn, String updatedby, String updatedbyr, String mInoutlineId, String mInoutlineIdr, String qty, String isactive, String datetrx, String processed, String mMatchinvId, String createdby, String createdbyr, String processing, String adOrgId)    throws ServletException {
