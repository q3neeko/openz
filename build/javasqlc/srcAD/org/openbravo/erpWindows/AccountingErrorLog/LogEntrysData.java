 ...
 */
  public static LogEntrysData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN zsfi_fact_error_Log.AD_Org_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS AD_Org_IDR, " +
      "        ? AS LANGUAGE " +
      "        FROM zsfi_fact_error_Log left join ad_ref_list_v list1 on (zsfi_fact_error_Log.Status = list1.value and list1.ad_reference_id = '234' and list1.ad_language = ?)  left join (select AD_Org_ID, Name from AD_Org) table1 on (zsfi_fact_error_Log.AD_Org_ID = table1.AD_Org_ID)" +
      "        WHERE 2=2 " +
      "        AND 1=1 " +
...
Create a registry
 */
  public static LogEntrysData[] set(String documentno, String updatedby, String updatedbyr, String zsfiFactErrorLogId, String adOrgId, String adClientId, String sourceid, String dateacct, String status, String createdby, String createdbyr, String tablename, String documenttype, String isactive)    throws ServletException {
