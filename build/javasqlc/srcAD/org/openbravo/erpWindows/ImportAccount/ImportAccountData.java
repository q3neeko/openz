 ...
 */
  public static ImportAccountData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN I_ElementValue.AD_Org_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table2.Name), ''))),'') ) END) AS AD_Org_IDR, " +
      "I_ElementValue.ElementName, " +
      "I_ElementValue.C_Element_ID, " +
      "(CASE WHEN I_ElementValue.C_Element_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table3.Name), ''))),'') ) END) AS C_Element_IDR, " +
      ...
      "(CASE WHEN I_ElementValue.ParentElementValue_ID IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL4.Name IS NULL THEN TO_CHAR(table4.Name) ELSE TO_CHAR(tableTRL4.Name) END)), ''))),'') ) END) AS ParentElementValue_IDR, " +
...
Create a registry
 */
  public static ImportAccountData[] set(String created, String poststatistical, String description, String adClientId, String iErrormsg, String value, String accountsign, String parentelementvalueId, String name, String processed, String postbudget, String isactive, String accounttype, String postactual, String iIsimported, String defaultAccount, String adOrgId, String cElementId, String iElementvalueId, String processing, String updatedby, String updatedbyr, String adColumnId, String issummary, String isdoccontrolled, String elementname, String elementlevel, String parentvalue, String createdby, String createdbyr, String postencumbrance, String cElementvalueId)    throws ServletException {
