 ...
 */
  public static PriceAdjustmentsData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String cOrderlineId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN C_OrderLine_Offer.AD_Org_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS AD_Org_IDR, " +
      "COALESCE(C_OrderLine_Offer.IsActive, 'N') AS IsActive, " +
      "C_OrderLine_Offer.M_Offer_ID, " +
      "(CASE WHEN C_OrderLine_Offer.M_Offer_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table2.Name), ''))),'') ) END) AS M_Offer_IDR, " +
      ...
      "        ? AS LANGUAGE " +
      "        FROM C_OrderLine_Offer left join (select AD_Org_ID, Name from AD_Org) table1 on (C_OrderLine_Offer.AD_Org_ID = table1.AD_Org_ID) left join (select M_Offer_ID, Name from M_Offer) table2 on (C_OrderLine_Offer.M_Offer_ID = table2.M_Offer_ID)" +
      "        WHERE 2=2 " +
      "        AND 1=1 ";
...
Create a registry
 */
  public static PriceAdjustmentsData[] set(String cOrderlineId, String adClientId, String mOfferId, String updatedby, String updatedbyr, String adOrgId, String createdby, String createdbyr, String cOrderlineOfferId, String line, String priceoffer, String isactive, String amtoffer)    throws ServletException {
