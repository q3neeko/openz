...
static Logger log4j = Logger.getLogger(LinesData.class);
  ...
  public String getField(String fieldName) {
    if (fieldName.equalsIgnoreCase("created"))
      ...
      return cOrderIdr;
    else if (fieldName.equalsIgnoreCase("ispagebreak"))
      return ispagebreak;
      ...
      return dateordered;
    else if (fieldName.equalsIgnoreCase("isoptional"))
      return isoptional;
    else if (fieldName.equalsIgnoreCase("textposition"))
      return textposition;
 ...
 */
  public static LinesData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String cOrderId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN C_OrderLine.AD_Org_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS AD_Org_IDR, " +
      "C_OrderLine.C_Order_ID, " +
      "(CASE WHEN C_OrderLine.C_Order_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table2.DocumentNo), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table2.Name), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(table2.DateOrdered, 'DD-MM-YYYY')),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table2.GrandTotal), ''))),'') ) END) AS C_Order_IDR, " +
      "COALESCE(C_OrderLine.Ispagebreak, 'N') AS Ispagebreak, " +
      "C_OrderLine.C_BPartner_ID, " +
      "(CASE WHEN C_OrderLine.C_BPartner_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table3.Value), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table3.Name), ''))),'') ) END) AS C_BPartner_IDR, " +
      "C_OrderLine.C_BPartner_Location_ID, " +
      "(CASE WHEN C_OrderLine.C_BPartner_Location_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table4.Name), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table4.Deviant_Bp_Name), ''))),'') ) END) AS C_BPartner_Location_IDR, " +
      "C_OrderLine.DateOrdered, " +
      "COALESCE(C_OrderLine.Isoptional, 'N') AS Isoptional, " +
      "C_OrderLine.Textposition, " +
      "C_OrderLine.Line, " +
      ...
      "COALESCE(C_OrderLine.Isapproved, 'N') AS Isapproved, " +
      "C_OrderLine.Calcfastestdeliverydate, " +
      "COALESCE(C_OrderLine.IsOneTimePosition, 'N') AS IsOneTimePosition, " +
      "C_OrderLine.M_Product_ID, " +
      "(CASE WHEN C_OrderLine.M_Product_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table5.Value), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL5.Name IS NULL THEN TO_CHAR(table5.Name) ELSE TO_CHAR(tableTRL5.Name) END)), ''))),'') ) END) AS M_Product_IDR, " +
      "COALESCE(C_OrderLine.Issummaryitem, 'N') AS Issummaryitem, " +
      "C_OrderLine.M_AttributeSetInstance_ID, " +
      "(CASE WHEN C_OrderLine.M_AttributeSetInstance_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table6.Description), ''))),'') ) END) AS M_AttributeSetInstance_IDR, " +
      "C_OrderLine.Description, " +
      "C_OrderLine.QuantityOrder, " +
      "C_OrderLine.M_Product_Uom_Id, " +
      "(CASE WHEN C_OrderLine.M_Product_Uom_Id IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL8.Name IS NULL THEN TO_CHAR(table8.Name) ELSE TO_CHAR(tableTRL8.Name) END)), ''))),'') ) END) AS M_Product_Uom_IdR, " +
      "C_OrderLine.QtyOrdered, " +
      "C_OrderLine.C_UOM_ID, " +
      "(CASE WHEN C_OrderLine.C_UOM_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL9.Name IS NULL THEN TO_CHAR(table9.Name) ELSE TO_CHAR(tableTRL9.Name) END)), ''))),'') ) END) AS C_UOM_IDR, " +
      ...
      "(CASE WHEN C_OrderLine.M_Shipper_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table10.Name), ''))),'') ) END) AS M_Shipper_IDR, " +
      "C_OrderLine.PriceActual, " +
      "C_OrderLine.C_Currency_ID, " +
      "(CASE WHEN C_OrderLine.C_Currency_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table11.ISO_Code), ''))),'') ) END) AS C_Currency_IDR, " +
      ...
      "(CASE WHEN C_OrderLine.C_Tax_ID IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL12.Name IS NULL THEN TO_CHAR(table12.Name) ELSE TO_CHAR(tableTRL12.Name) END)), ''))),'') ) END) AS C_Tax_IDR, " +
      ...
      "(CASE WHEN C_OrderLine.C_Projecttask_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table15.Value), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table15.Name), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table14.Name), ''))),'') ) END) AS C_Projecttask_IDR, " +
      "C_OrderLine.Orderlineselfjoin, " +
      "(CASE WHEN C_OrderLine.Orderlineselfjoin IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table17.DocumentNo), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table17.Name), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(table17.DateOrdered, 'DD-MM-YYYY')),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table17.GrandTotal), ''))),'') ) END) AS OrderlineselfjoinR, " +
      ...
      "        ? AS LANGUAGE " +
      "        FROM C_OrderLine left join (select AD_Org_ID, Name from AD_Org) table1 on (C_OrderLine.AD_Org_ID = table1.AD_Org_ID) left join (select C_Order_ID, DocumentNo, Name, DateOrdered, GrandTotal from C_Order) table2 on (C_OrderLine.C_Order_ID = table2.C_Order_ID) left join (select C_BPartner_ID, Value, Name from C_BPartner) table3 on (C_OrderLine.C_BPartner_ID = table3.C_BPartner_ID) left join (select C_BPartner_Location_ID, Name, Deviant_Bp_Name from C_BPartner_Location) table4 on (C_OrderLine.C_BPartner_Location_ID = table4.C_BPartner_Location_ID) left join (select M_Product_ID, Value, Name from M_Product) table5 on (C_OrderLine.M_Product_ID = table5.M_Product_ID) left join (select M_Product_ID,AD_Language, Name from M_Product_TRL) tableTRL5 on (table5.M_Product_ID = tableTRL5.M_Product_ID and tableTRL5.AD_Language = ?)  left join (select M_AttributeSetInstance_ID, Description from M_AttributeSetInstance) table6 on (C_OrderLine.M_AttributeSetInstance_ID = table6.M_AttributeSetInstance_ID) left join (select M_Product_Uom_Id, C_UOM_ID from M_Product_UOM) table7 on (C_OrderLine.M_Product_Uom_Id =  table7.M_Product_Uom_Id) left join (select C_UOM_ID, Name from C_UOM) table8 on (table7.C_UOM_ID = table8.C_UOM_ID) left join (select C_UOM_ID,AD_Language, Name from C_UOM_TRL) tableTRL8 on (table8.C_UOM_ID = tableTRL8.C_UOM_ID and tableTRL8.AD_Language = ?)  left join (select C_UOM_ID, Name from C_UOM) table9 on (C_OrderLine.C_UOM_ID = table9.C_UOM_ID) left join (select C_UOM_ID,AD_Language, Name from C_UOM_TRL) tableTRL9 on (table9.C_UOM_ID = tableTRL9.C_UOM_ID and tableTRL9.AD_Language = ?)  left join (select M_Shipper_ID, Name from M_Shipper) table10 on (C_OrderLine.M_Shipper_ID = table10.M_Shipper_ID) left join (select C_Currency_ID, ISO_Code from C_Currency) table11 on (C_OrderLine.C_Currency_ID = table11.C_Currency_ID) left join (select C_Tax_ID, Name from C_Tax) table12 on (C_OrderLine.C_Tax_ID =  table12.C_Tax_ID) left join (select C_Tax_ID,AD_Language, Name from C_Tax_TRL) tableTRL12 on (table12.C_Tax_ID = tableTRL12.C_Tax_ID and tableTRL12.AD_Language = ?)  left join (select C_Project_ID, Value, Name from C_Project) table13 on (C_OrderLine.C_Project_ID = table13.C_Project_ID) left join (select C_Projecttask_ID, C_Project_ID, Name from C_Projecttask) table14 on (C_OrderLine.C_Projecttask_ID = table14.C_Projecttask_ID) left join (select C_Project_ID, Value, Name from C_Project) table15 on (table14.C_Project_ID = table15.C_Project_ID) left join (select C_OrderLine_ID, C_Order_ID from C_OrderLine) table16 on (C_OrderLine.Orderlineselfjoin =  table16.C_OrderLine_ID) left join (select C_Order_ID, DocumentNo, Name, DateOrdered, GrandTotal from C_Order) table17 on (table16.C_Order_ID = table17.C_Order_ID)" +
      "        WHERE 2=2 " +
      "        AND 1=1 ";
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectLinesData.ispagebreak = UtilSql.getValue(result, "ispagebreak");
        ...
        objectLinesData.isoptional = UtilSql.getValue(result, "isoptional");
        objectLinesData.textposition = UtilSql.getValue(result, "textposition");
        ...
        objectLinesData.isapproved = UtilSql.getValue(result, "isapproved");
 ...
 */
  public static LinesData[] set(String cOrderId, String mProductUomId, String datepromised, String mWarehouseId, String isgrossprice, String qtyinvoiced, String qtyreserved, String issummaryitem, String calcfastestdeliverydate, String securityqty, String invoicedamt, String desireddeliverydate, String createdby, String createdbyr, String quantityorder, String cChargeId, String discount, String isonetimeposition, String linenetamt, String isoptional, String mOfferId, String linegrossamt, String pricelimit, String updatedby, String updatedbyr, String cOrderIdr, String qtydelivered, String qtyordered, String cProjecttaskId, String refOrderlineId, String cProjectId, String cProjectIdr, String ignoreresiduedate, String mAttributesetinstanceId, String mAttributesetinstanceIdr, String cBpartnerLocationId, String isactive, String cancelpricead, String priceactual, String isdescription, String deliverycomplete, String cOrderlineId, String mShipperId, String dateinvoiced, String cBpartnerId, String cBpartnerIdr, String cProjectphaseId, String cUomId, String directship, String scheddeliverydate, String mProductId, String mProductIdr, String adOrgId, String freightamt, String chargeamt, String orderlineselfjoin, String aAssetId, String linetaxamt, String dateordered, String pricestd, String textposition, String calloffqty, String line, String ispagebreak, String cCurrencyId, String isapproved, String datedelivered, String adClientId, String pricelist, String cTaxId, String description, String ignoreresidue)    throws ServletException {
    ...
    objectLinesData[0].ispagebreak = ispagebreak;
    ...
    objectLinesData[0].isoptional = isoptional;
    objectLinesData[0].textposition = textposition;
    ...
    objectLinesData[0].isapproved = isapproved;
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      "        UPDATE C_OrderLine" +
      "        SET AD_Org_ID = (?) , C_Order_ID = (?) , Ispagebreak = (?) , C_BPartner_ID = (?) , C_BPartner_Location_ID = (?) , DateOrdered = TO_DATE(?) , Isoptional = (?) , Textposition = (?) , Line = TO_NUMBER(?) , Desireddeliverydate = TO_DATE(?) , DatePromised = TO_DATE(?) , Scheddeliverydate = TO_DATE(?) , DirectShip = (?) , Isapproved = (?) , Calcfastestdeliverydate = (?) , IsOneTimePosition = (?) , M_Product_ID = (?) , Issummaryitem = (?) , M_AttributeSetInstance_ID = (?) , Description = (?) , QuantityOrder = TO_NUMBER(?) , M_Product_Uom_Id = (?) , QtyOrdered = TO_NUMBER(?) , C_UOM_ID = (?) , Securityqty = TO_NUMBER(?) , Calloffqty = TO_NUMBER(?) , QtyDelivered = TO_NUMBER(?) , QtyReserved = TO_NUMBER(?) , QtyInvoiced = TO_NUMBER(?) , Invoicedamt = TO_NUMBER(?) , Ignoreresidue = (?) , Deliverycomplete = (?) , M_Shipper_ID = (?) , PriceActual = TO_NUMBER(?) , C_Currency_ID = (?) , PriceStd = TO_NUMBER(?) , CANCELPRICEAD = (?) , PriceList = TO_NUMBER(?) , Discount = TO_NUMBER(?) , FreightAmt = TO_NUMBER(?) , C_Tax_ID = (?) , C_Project_ID = (?) , C_Projecttask_ID = (?) , Orderlineselfjoin = (?) , LineNetAmt = TO_NUMBER(?) , Linegrossamt = TO_NUMBER(?) , M_Offer_ID = (?) , PriceLimit = TO_NUMBER(?) , IsDescription = (?) , Linetaxamt = TO_NUMBER(?) , C_Charge_ID = (?) , A_Asset_ID = (?) , ChargeAmt = TO_NUMBER(?) , Isgrossprice = (?) , M_Warehouse_ID = (?) , Ignoreresiduedate = TO_DATE(?) , DateInvoiced = TO_DATE(?) , DateDelivered = TO_DATE(?) , IsActive = (?) , AD_Client_ID = (?) , C_Projectphase_ID = (?) , C_OrderLine_ID = (?) , Ref_OrderLine_ID = (?) , updated = now(), updatedby = ? " +
      "        WHERE C_OrderLine.C_OrderLine_ID = ? " +
    ...
    st = connectionProvider.getPreparedStatement(conn, strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, cOrderId);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, ispagebreak);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, cBpartnerId);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, cBpartnerLocationId);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, dateordered);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, isoptional);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, textposition);
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Org_ID, C_Order_ID, Ispagebreak, C_BPartner_ID, C_BPartner_Location_ID, DateOrdered, Isoptional, Textposition, Line, Desireddeliverydate, DatePromised, Scheddeliverydate, DirectShip, Isapproved, Calcfastestdeliverydate, IsOneTimePosition, M_Product_ID, Issummaryitem, M_AttributeSetInstance_ID, Description, QuantityOrder, M_Product_Uom_Id, QtyOrdered, C_UOM_ID, Securityqty, Calloffqty, QtyDelivered, QtyReserved, QtyInvoiced, Invoicedamt, Ignoreresidue, Deliverycomplete, M_Shipper_ID, PriceActual, C_Currency_ID, PriceStd, CANCELPRICEAD, PriceList, Discount, FreightAmt, C_Tax_ID, C_Project_ID, C_Projecttask_ID, Orderlineselfjoin, LineNetAmt, Linegrossamt, M_Offer_ID, PriceLimit, IsDescription, Linetaxamt, C_Charge_ID, A_Asset_ID, ChargeAmt, Isgrossprice, M_Warehouse_ID, Ignoreresiduedate, DateInvoiced, DateDelivered, IsActive, AD_Client_ID, C_Projectphase_ID, C_OrderLine_ID, Ref_OrderLine_ID, created, createdby, updated, updatedBy)" +
      "        VALUES ((?), (?), (?), (?), (?), TO_DATE(?), (?), (?), TO_NUMBER(?), TO_DATE(?), TO_DATE(?), TO_DATE(?), (?), (?), (?), (?), (?), (?), (?), (?), TO_NUMBER(?), (?), TO_NUMBER(?), (?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), (?), (?), (?), TO_NUMBER(?), (?), TO_NUMBER(?), (?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), (?), (?), (?), (?), TO_NUMBER(?), TO_NUMBER(?), (?), TO_NUMBER(?), (?), TO_NUMBER(?), (?), (?), TO_NUMBER(?), (?), (?), TO_DATE(?), TO_DATE(?), TO_DATE(?), (?), (?), (?), (?), (?), now(), ?, now(), ?)";
