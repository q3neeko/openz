...
static Logger log4j = Logger.getLogger(PaymentSchedulingData.class);
  ...
  public String getField(String fieldName) {
    if (fieldName.equalsIgnoreCase("created"))
      ...
      return description;
    else if (fieldName.equalsIgnoreCase("descriptionline"))
 ...
 */
  public static PaymentSchedulingData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String cOrderId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "c_order_paymentschedule.Descriptionline, " +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectPaymentSchedulingData.descriptionline = UtilSql.getValue(result, "descriptionline");
...
Create a registry
 */
  public static PaymentSchedulingData[] set(String cOrderId, String descriptionline, String amount, String cOrderPaymentscheduleId, String invoicedate, String updatedby, String updatedbyr, String adOrgId, String createdby, String createdbyr, String description, String adClientId, String cInvoiceId, String isactive)    throws ServletException {
    ...
    objectPaymentSchedulingData[0].descriptionline = descriptionline;
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET C_Order_ID = (?) , Isactive = (?) , Invoicedate = TO_DATE(?) , Amount = TO_NUMBER(?) , Description = (?) , Descriptionline = (?) , C_Invoice_ID = (?) , C_Order_Paymentschedule_ID = (?) , AD_Org_ID = (?) , AD_Client_ID = (?) , updated = now(), updatedby = ? " +
      "        WHERE c_order_paymentschedule.C_Order_Paymentschedule_ID = ? " +
    ...
    st = connectionProvider.getPreparedStatement(conn, strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, descriptionline);
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (C_Order_ID, Isactive, Invoicedate, Amount, Description, Descriptionline, C_Invoice_ID, C_Order_Paymentschedule_ID, AD_Org_ID, AD_Client_ID, created, createdby, updated, updatedBy)" +
