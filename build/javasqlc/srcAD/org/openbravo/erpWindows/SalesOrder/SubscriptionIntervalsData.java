 ...
 */
  public static SubscriptionIntervalsData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String cOrderId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN c_subscriptioninterval_view.AD_Org_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS AD_Org_IDR, " +
      ...
      "(CASE WHEN c_subscriptioninterval_view.C_Doctypetarget_ID IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL2.Name IS NULL THEN TO_CHAR(table2.Name) ELSE TO_CHAR(tableTRL2.Name) END)), ''))),'') ) END) AS C_Doctypetarget_IDR, " +
      "c_subscriptioninterval_view.Name, " +
      "c_subscriptioninterval_view.A_Asset_ID, " +
      "c_subscriptioninterval_view.C_Doctype_ID, " +
      "(CASE WHEN c_subscriptioninterval_view.C_Doctype_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL3.Name IS NULL THEN TO_CHAR(table3.Name) ELSE TO_CHAR(tableTRL3.Name) END)), ''))),'') ) END) AS C_Doctype_IDR, " +
      ...
      "(CASE WHEN c_subscriptioninterval_view.C_Bpartner_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table4.Value), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table4.Name), ''))),'') ) END) AS C_Bpartner_IDR, " +
      "c_subscriptioninterval_view.bpzipcode, " +
      "c_subscriptioninterval_view.Billto_ID, " +
      "(CASE WHEN c_subscriptioninterval_view.Billto_ID IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table5.Name), ''))),'') ) END) AS Billto_IDR, " +
      "c_subscriptioninterval_view.C_Bpartner_Location_ID, " +
      "(CASE WHEN c_subscriptioninterval_view.C_Bpartner_Location_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table6.Name), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table6.Deviant_Bp_Name), ''))),'') ) END) AS C_Bpartner_Location_IDR, " +
      "c_subscriptioninterval_view.AD_User_ID, " +
      "(CASE WHEN c_subscriptioninterval_view.AD_User_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table7.Name), ''))),'') ) END) AS AD_User_IDR, " +
      "c_subscriptioninterval_view.Salesrep_ID, " +
      "(CASE WHEN c_subscriptioninterval_view.Salesrep_ID IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table8.Name), ''))),'') ) END) AS Salesrep_IDR, " +
      "c_subscriptioninterval_view.M_Pricelist_ID, " +
      "(CASE WHEN c_subscriptioninterval_view.M_Pricelist_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table9.Name), ''))),'') ) END) AS M_Pricelist_IDR, " +
      ...
      "(CASE WHEN c_subscriptioninterval_view.M_Warehouse_ID IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table10.Name), ''))),'') ) END) AS M_Warehouse_IDR, " +
      "c_subscriptioninterval_view.C_Currency_ID, " +
      "(CASE WHEN c_subscriptioninterval_view.C_Currency_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table11.ISO_Code), ''))),'') ) END) AS C_Currency_IDR, " +
      ...
      "(CASE WHEN c_subscriptioninterval_view.C_Paymentterm_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL12.Name IS NULL THEN TO_CHAR(table12.Name) ELSE TO_CHAR(tableTRL12.Name) END)), ''))),'') ) END) AS C_Paymentterm_IDR, " +
      "c_subscriptioninterval_view.C_Incoterms_ID, " +
      "(CASE WHEN c_subscriptioninterval_view.C_Incoterms_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table13.Name), ''))),'') ) END) AS C_Incoterms_IDR, " +
      "c_subscriptioninterval_view.Delivery_Location_ID, " +
      "(CASE WHEN c_subscriptioninterval_view.Delivery_Location_ID IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table14.Name), ''))),'') ) END) AS Delivery_Location_IDR, " +
      ...
      "(CASE WHEN c_subscriptioninterval_view.M_Shipper_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table15.Name), ''))),'') ) END) AS M_Shipper_IDR, " +
      "c_subscriptioninterval_view.Weight, " +
      "c_subscriptioninterval_view.Weight_Uom, " +
      "(CASE WHEN c_subscriptioninterval_view.Weight_Uom IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL16.Name IS NULL THEN TO_CHAR(table16.Name) ELSE TO_CHAR(tableTRL16.Name) END)), ''))),'') ) END) AS Weight_UomR, " +
      ...
      "(CASE WHEN c_subscriptioninterval_view.M_Product_ID IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL17.Name IS NULL THEN TO_CHAR(table17.Name) ELSE TO_CHAR(tableTRL17.Name) END)), ''))),'') ) END) AS M_Product_IDR, " +
      "c_subscriptioninterval_view.Qty, " +
      "c_subscriptioninterval_view.Freightamt, " +
      "c_subscriptioninterval_view.C_Project_ID, " +
      "(CASE WHEN c_subscriptioninterval_view.C_Project_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table18.Value), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table18.Name), ''))),'') ) END) AS C_Project_IDR, " +
      "c_subscriptioninterval_view.C_Projecttask_ID, " +
      "(CASE WHEN c_subscriptioninterval_view.C_Projecttask_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table20.Value), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table20.Name), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table19.Name), ''))),'') ) END) AS C_Projecttask_IDR, " +
      "c_subscriptioninterval_view.Orderselfjoin, " +
      "(CASE WHEN c_subscriptioninterval_view.Orderselfjoin IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table21.DocumentNo), ''))),'') ) END) AS OrderselfjoinR, " +
      ...
      "        ? AS LANGUAGE " +
      "        FROM c_subscriptioninterval_view left join (select AD_Org_ID, Name from AD_Org) table1 on (c_subscriptioninterval_view.AD_Org_ID = table1.AD_Org_ID) left join (select C_DocType_ID, Name from C_DocType) table2 on (c_subscriptioninterval_view.C_Doctypetarget_ID =  table2.C_DocType_ID) left join (select C_DocType_ID,AD_Language, Name from C_DocType_TRL) tableTRL2 on (table2.C_DocType_ID = tableTRL2.C_DocType_ID and tableTRL2.AD_Language = ?)  left join (select C_Doctype_ID, Name from C_Doctype) table3 on (c_subscriptioninterval_view.C_Doctype_ID = table3.C_Doctype_ID) left join (select C_DocType_ID,AD_Language, Name from C_DocType_TRL) tableTRL3 on (table3.C_DocType_ID = tableTRL3.C_DocType_ID and tableTRL3.AD_Language = ?)  left join ad_ref_list_v list1 on (c_subscriptioninterval_view.Docstatus = list1.value and list1.ad_reference_id = '131' and list1.ad_language = ?)  left join (select C_BPartner_ID, Value, Name from C_BPartner) table4 on (c_subscriptioninterval_view.C_Bpartner_ID = table4.C_BPartner_ID) left join (select C_BPartner_Location_ID, Name from C_BPartner_Location) table5 on (c_subscriptioninterval_view.Billto_ID =  table5.C_BPartner_Location_ID) left join (select C_Bpartner_Location_ID, Name, Deviant_Bp_Name from C_Bpartner_Location) table6 on (c_subscriptioninterval_view.C_Bpartner_Location_ID = table6.C_Bpartner_Location_ID) left join (select AD_User_ID, Name from AD_User) table7 on (c_subscriptioninterval_view.AD_User_ID = table7.AD_User_ID) left join (select AD_User_ID, Name from AD_User) table8 on (c_subscriptioninterval_view.Salesrep_ID =  table8.AD_User_ID) left join (select M_Pricelist_ID, Name from M_Pricelist) table9 on (c_subscriptioninterval_view.M_Pricelist_ID = table9.M_Pricelist_ID) left join ad_ref_list_v list2 on (c_subscriptioninterval_view.Invoicerule = list2.value and list2.ad_reference_id = '150' and list2.ad_language = ?)  left join ad_ref_list_v list3 on (c_subscriptioninterval_view.Estpropability = list3.value and list3.ad_reference_id = 'DD6AA16AB1DD4DF5AD11A2665AE665BC' and list3.ad_language = ?)  left join (select M_Warehouse_ID, Name from M_Warehouse) table10 on (c_subscriptioninterval_view.M_Warehouse_ID =  table10.M_Warehouse_ID) left join (select C_Currency_ID, ISO_Code from C_Currency) table11 on (c_subscriptioninterval_view.C_Currency_ID = table11.C_Currency_ID) left join ad_ref_list_v list4 on (c_subscriptioninterval_view.Deliveryrule = list4.value and list4.ad_reference_id = '151' and list4.ad_language = ?)  left join ad_ref_list_v list5 on (c_subscriptioninterval_view.Priorityrule = list5.value and list5.ad_reference_id = '154' and list5.ad_language = ?)  left join ad_ref_list_v list6 on (c_subscriptioninterval_view.Paymentrule = list6.value and list6.ad_reference_id = '195' and list6.ad_language = ?)  left join (select C_Paymentterm_ID, Name from C_Paymentterm) table12 on (c_subscriptioninterval_view.C_Paymentterm_ID = table12.C_Paymentterm_ID) left join (select C_PaymentTerm_ID,AD_Language, Name from C_PaymentTerm_TRL) tableTRL12 on (table12.C_PaymentTerm_ID = tableTRL12.C_PaymentTerm_ID and tableTRL12.AD_Language = ?)  left join (select C_Incoterms_ID, Name from C_Incoterms) table13 on (c_subscriptioninterval_view.C_Incoterms_ID = table13.C_Incoterms_ID) left join (select C_BPartner_Location_ID, Name from C_BPartner_Location) table14 on (c_subscriptioninterval_view.Delivery_Location_ID =  table14.C_BPartner_Location_ID) left join ad_ref_list_v list7 on (c_subscriptioninterval_view.Deliveryviarule = list7.value and list7.ad_reference_id = '152' and list7.ad_language = ?)  left join (select M_Shipper_ID, Name from M_Shipper) table15 on (c_subscriptioninterval_view.M_Shipper_ID = table15.M_Shipper_ID) left join (select C_UOM_ID, Name from C_UOM) table16 on (c_subscriptioninterval_view.Weight_Uom =  table16.C_UOM_ID) left join (select C_UOM_ID,AD_Language, Name from C_UOM_TRL) tableTRL16 on (table16.C_UOM_ID = tableTRL16.C_UOM_ID and tableTRL16.AD_Language = ?)  left join ad_ref_list_v list8 on (c_subscriptioninterval_view.Freightcostrule = list8.value and list8.ad_reference_id = '153' and list8.ad_language = ?)  left join (select M_Product_ID, value, Name from M_Product) table17 on (c_subscriptioninterval_view.M_Product_ID =  table17.M_Product_ID) left join (select M_Product_ID,AD_Language, Name from M_Product_TRL) tableTRL17 on (table17.M_Product_ID = tableTRL17.M_Product_ID and tableTRL17.AD_Language = ?)  left join (select C_Project_ID, Value, Name from C_Project) table18 on (c_subscriptioninterval_view.C_Project_ID = table18.C_Project_ID) left join (select C_Projecttask_ID, C_Project_ID, Name from C_Projecttask) table19 on (c_subscriptioninterval_view.C_Projecttask_ID = table19.C_Projecttask_ID) left join (select C_Project_ID, Value, Name from C_Project) table20 on (table19.C_Project_ID = table20.C_Project_ID) left join (select C_Order_ID, DocumentNo from C_Order) table21 on (c_subscriptioninterval_view.Orderselfjoin =  table21.C_Order_ID) left join ad_ref_list_v list9 on (c_subscriptioninterval_view.Invoicefrequence = list9.value and list9.ad_reference_id = 'F17BFE71276743BBB6105EE61D9FD666' and list9.ad_language = ?)  left join ad_ref_list_v list10 on (c_subscriptioninterval_view.Quarterly_Month = list10.value and list10.ad_reference_id = '99780AA6C1644A329162A8AF74602925' and list10.ad_language = ?)  left join ad_ref_list_v list11 on (c_subscriptioninterval_view.Yearly_Month = list11.value and list11.ad_reference_id = 'B849337BE90242BEB0B230808EDC0CEE' and list11.ad_language = ?)  left join ad_ref_list_v list12 on (c_subscriptioninterval_view.Weekly_Day = list12.value and list12.ad_reference_id = '167' and list12.ad_language = ?)  left join ad_ref_list_v list13 on (c_subscriptioninterval_view.Proposalstatus = list13.value and list13.ad_reference_id = 'B00D78B6B154404A831F25F11ABD867E' and list13.ad_language = ?)  left join ad_ref_list_v list14 on (c_subscriptioninterval_view.Lostproposalfixedreason = list14.value and list14.ad_reference_id = 'B51F770E9FA84F5B8FC0FFD7B3848317' and list14.ad_language = ?)  left join ad_ref_list_v list15 on (list15.ad_reference_id = '135' and list15.ad_language = ?  AND (CASE c_subscriptioninterval_view.DocAction WHEN '--' THEN 'CL' ELSE TO_CHAR(c_subscriptioninterval_view.DocAction) END) = list15.value)" +
      "        WHERE 2=2 " +
      "        AND 1=1 ";
