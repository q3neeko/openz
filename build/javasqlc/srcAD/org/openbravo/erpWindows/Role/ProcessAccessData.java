 ...
 */
  public static ProcessAccessData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String adRoleId, String key, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN AD_Process_Access.AD_Role_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table2.Name), ''))),'') ) END) AS AD_Role_IDR, " +
...
Create a registry
 */
  public static ProcessAccessData[] set(String adRoleId, String adOrgId, String adProcessId, String isactive, String adClientId, String updatedby, String updatedbyr, String isreadwrite, String adProcessAccessId, String createdby, String createdbyr)    throws ServletException {
