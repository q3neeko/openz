 ...
 */
  public static WindowAccessData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String adRoleId, String key, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN AD_Window_Access.AD_Role_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table2.Name), ''))),'') ) END) AS AD_Role_IDR, " +
...
Create a registry
 */
  public static WindowAccessData[] set(String adRoleId, String createdby, String createdbyr, String adWindowId, String adOrgId, String isactive, String isreadwrite, String adWindowAccessId, String adClientId, String seesonlyowndata, String updatedby, String updatedbyr)    throws ServletException {
