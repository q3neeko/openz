 ...
 */
  public static TranslationData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String adTextinterfacesId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN AD_TextInterfaces_Trl.AD_Org_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Name), ''))),'') ) END) AS AD_Org_IDR, " +
      "AD_TextInterfaces_Trl.AD_Textinterfaces_ID, " +
      "(CASE WHEN AD_TextInterfaces_Trl.AD_Textinterfaces_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table2.Text), ''))),'') ) END) AS AD_Textinterfaces_IDR, " +
      "AD_TextInterfaces_Trl.AD_Language, " +
      "(CASE WHEN AD_TextInterfaces_Trl.AD_Language IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table3.Name), ''))),'') ) END) AS AD_LanguageR, " +
      ...
      "        ? AS LANGUAGE " +
      "        FROM AD_TextInterfaces_Trl left join (select AD_Org_ID, Name from AD_Org) table1 on (AD_TextInterfaces_Trl.AD_Org_ID = table1.AD_Org_ID) left join (select AD_Textinterfaces_ID, Text from AD_Textinterfaces) table2 on (AD_TextInterfaces_Trl.AD_Textinterfaces_ID = table2.AD_Textinterfaces_ID) left join (select AD_Language, Name from AD_Language) table3 on (AD_TextInterfaces_Trl.AD_Language =  table3.AD_Language)" +
      "        WHERE 2=2 " +
      "        AND 1=1 ";
...
Create a registry
 */
  public static TranslationData[] set(String adTextinterfacesId, String adLanguage, String isactive, String istranslated, String adOrgId, String adTextinterfacesTrlId, String updatedby, String updatedbyr, String createdby, String createdbyr, String adClientId, String text)    throws ServletException {
