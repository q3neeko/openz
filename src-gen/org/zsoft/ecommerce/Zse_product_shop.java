...
public class Zse_product_shop extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_GOTRIGGER = "gotrigger";
    public static final String PROPERTY_MINSTOCKSHOWN = "minstockshown";
    ...
    public Zse_product_shop() {
        ...
        setDefaultValue(PROPERTY_GOTRIGGER, true);
    ...
    public Boolean isGotrigger() {
        return (Boolean) get(PROPERTY_GOTRIGGER);
    }

    public void setGotrigger(Boolean gotrigger) {
        set(PROPERTY_GOTRIGGER, gotrigger);
    }

    public Long getMinstockshown() {
        return (Long) get(PROPERTY_MINSTOCKSHOWN);
    }

    public void setMinstockshown(Long minstockshown) {
        set(PROPERTY_MINSTOCKSHOWN, minstockshown);
    }
