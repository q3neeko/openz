...
public class Snr_internal_consumptionline extends BaseOBObject
    ...
    public static final String PROPERTY_SNRBUILTINSNR = "sNRBuiltinsnr";
    public static final String PROPERTY_SELECTEDBATCH = "selectedbatch";
    ...
    public org.zsoft.serial.snr_masterdata getSNRBuiltinsnr() {
        return (org.zsoft.serial.snr_masterdata) get(PROPERTY_SNRBUILTINSNR);
    }

    public void setSNRBuiltinsnr(org.zsoft.serial.snr_masterdata sNRBuiltinsnr) {
        set(PROPERTY_SNRBUILTINSNR, sNRBuiltinsnr);
    }

    public org.openbravo.model.materialmgmt.onhandquantity.snr_batchlocator getSelectedbatch() {
        return (org.openbravo.model.materialmgmt.onhandquantity.snr_batchlocator) get(PROPERTY_SELECTEDBATCH);
    }

    public void setSelectedbatch(
        org.openbravo.model.materialmgmt.onhandquantity.snr_batchlocator selectedbatch) {
        set(PROPERTY_SELECTEDBATCH, selectedbatch);
    }
}
