...
/**
 * Entity class for entity snr_batchcurrentbom_v (stored in table snr_batchcurrentbom_v).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class snr_batchcurrentbom_v extends BaseOBObject implements ClientEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "snr_batchcurrentbom_v";
    public static final String ENTITY_NAME = "snr_batchcurrentbom_v";
    ...
    public static final String PROPERTY_SNRBUILTINBATCHESVLIST =
        "snrBuiltinbatchesVList";
    public static final String PROPERTY_SNRCURRENTBOMSERIALSLIST =
        "snrCurrentbomSerialsList";

    public snr_batchcurrentbom_v() {
        setDefaultValue(PROPERTY_ISACTIVE, true);
        setDefaultValue(PROPERTY_SNRBUILTINBATCHESVLIST, new ArrayList<Object>());
    ...
    public List<org.zsoft.serial.snr_builtinbatches_v> getSnrBuiltinbatchesVList() {
        return (List<org.zsoft.serial.snr_builtinbatches_v>) get(PROPERTY_SNRBUILTINBATCHESVLIST);
    }

    public void setSnrBuiltinbatchesVList(
        List<org.zsoft.serial.snr_builtinbatches_v> snrBuiltinbatchesVList) {
        set(PROPERTY_SNRBUILTINBATCHESVLIST, snrBuiltinbatchesVList);
    }
