...
/**
 * Entity class for entity snr_builtinserials_v (stored in table snr_builtinserials_v).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class snr_builtinserials_v extends BaseOBObject implements ClientEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "snr_builtinserials_v";
    public static final String ENTITY_NAME = "snr_builtinserials_v";
    ...
    public org.zsoft.serial.snr_masterdata getSerial() {
        return (org.zsoft.serial.snr_masterdata) get(PROPERTY_SERIAL);
    }

    public void setSerial(org.zsoft.serial.snr_masterdata serial) {
        set(PROPERTY_SERIAL, serial);
    }
