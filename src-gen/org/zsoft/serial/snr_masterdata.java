...
public class snr_masterdata extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_SNRBATCHMASTERDATA =
        "sNRBatchmasterdata";
    public static final String PROPERTY_STASHEDIDENTIFIER = "stashedIdentifier";
    public static final String PROPERTY_RESPONSIBLEUSER = "responsibleUser";
    ...
    public String getStashedIdentifier() {
        return (String) get(PROPERTY_STASHEDIDENTIFIER);
    }

    public void setStashedIdentifier(String stashedIdentifier) {
        set(PROPERTY_STASHEDIDENTIFIER, stashedIdentifier);
    }

    public User getResponsibleUser() {
        return (User) get(PROPERTY_RESPONSIBLEUSER);
    }

    public void setResponsibleUser(User responsibleUser) {
        set(PROPERTY_RESPONSIBLEUSER, responsibleUser);
    }
