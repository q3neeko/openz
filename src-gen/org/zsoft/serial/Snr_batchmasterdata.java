...
public class Snr_batchmasterdata extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_SNRBATCHSERIALACTIONSLIST =
        "snrBatchserialactionsList";
    ...
    public Snr_batchmasterdata() {
        ...
        setDefaultValue(PROPERTY_SNRSERIALNUMBERTRACKINGLIST,
            new ArrayList<Object>());
        setDefaultValue(PROPERTY_SNRBATCHSERIALACTIONSLIST,
            new ArrayList<Object>());
    ...
    @SuppressWarnings("unchecked")
    public List<org.zsoft.serial.snr_batchserialactions> getSnrBatchserialactionsList() {
        return (List<org.zsoft.serial.snr_batchserialactions>) get(PROPERTY_SNRBATCHSERIALACTIONSLIST);
    }

    public void setSnrBatchserialactionsList(
        List<org.zsoft.serial.snr_batchserialactions> snrBatchserialactionsList) {
        set(PROPERTY_SNRBATCHSERIALACTIONSLIST, snrBatchserialactionsList);
    }
