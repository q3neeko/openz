...
public class tsrv_feedback_v extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_PAIDBREAKTIME = "paidbreaktime";
    ...
    public static final String PROPERTY_SPECIALTIME3 = "specialtime3";
    ...
    public static final String PROPERTY_WORKDATETO = "workdateTo";
    ...
    public BigDecimal getPaidbreaktime() {
        return (BigDecimal) get(PROPERTY_PAIDBREAKTIME);
    }

    public void setPaidbreaktime(BigDecimal paidbreaktime) {
        set(PROPERTY_PAIDBREAKTIME, paidbreaktime);
    }
    ...
    public BigDecimal getSpecialtime3() {
        return (BigDecimal) get(PROPERTY_SPECIALTIME3);
    }

    public void setSpecialtime3(BigDecimal specialtime3) {
        set(PROPERTY_SPECIALTIME3, specialtime3);
    }
    ...
    public Date getWorkdateTo() {
        return (Date) get(PROPERTY_WORKDATETO);
    }

    public void setWorkdateTo(Date workdateTo) {
        set(PROPERTY_WORKDATETO, workdateTo);
    }
}
