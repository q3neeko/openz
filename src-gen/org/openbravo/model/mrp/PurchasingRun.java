...
public class PurchasingRun extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_ISFIRSTNEED = "isfirstneed";
    ...
    public PurchasingRun() {
        ...
        setDefaultValue(PROPERTY_ISFIRSTNEED, false);
    ...
    public Boolean isFirstneed() {
        return (Boolean) get(PROPERTY_ISFIRSTNEED);
    }

    public void setFirstneed(Boolean isfirstneed) {
        set(PROPERTY_ISFIRSTNEED, isfirstneed);
    }
