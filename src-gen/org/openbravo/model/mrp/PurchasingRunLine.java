...
public class PurchasingRunLine extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_THISDEMAND = "thisdemand";
    ...
    public Long getThisdemand() {
        return (Long) get(PROPERTY_THISDEMAND);
    }

    public void setThisdemand(Long thisdemand) {
        set(PROPERTY_THISDEMAND, thisdemand);
    }
}
