...
public class Mrpcriticalitemsv extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_NEXTINCOMINGDATE = "nextincomingdate";
    ...
    public Date getNextincomingdate() {
        return (Date) get(PROPERTY_NEXTINCOMINGDATE);
    }

    public void setNextincomingdate(Date nextincomingdate) {
        set(PROPERTY_NEXTINCOMINGDATE, nextincomingdate);
    }
}
