...
/**
 * Entity class for entity mrp_deliveries_unneeded (stored in table mrp_deliveries_unneeded).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class mrp_deliveries_unneeded extends BaseOBObject
    implements ClientEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "mrp_deliveries_unneeded";
    public static final String ENTITY_NAME = "mrp_deliveries_unneeded";
    ...
    public mrp_deliveries_unneeded() {
