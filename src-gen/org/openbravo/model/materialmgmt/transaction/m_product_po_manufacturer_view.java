...
/**
 * Entity class for entity m_product_po_manufacturer_view (stored in table m_product_po_manufacturer_view).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class m_product_po_manufacturer_view extends BaseOBObject
    implements ClientEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "m_product_po_manufacturer_view";
    public static final String ENTITY_NAME = "m_product_po_manufacturer_view";
    ...
    public m_product_po_manufacturer_view() {
