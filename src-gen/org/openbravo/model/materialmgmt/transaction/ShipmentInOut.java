...
public class ShipmentInOut extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_ZSEGETSHIPPINGINFO =
        "zSEGetshippinginfo";
    public static final String PROPERTY_ZSESHIPPINGTYPE = "zSEShippingtype";
    ...
    public ShipmentInOut() {
        ...
        setDefaultValue(PROPERTY_ZSEGETSHIPPINGINFO, false);
    ...
    public Boolean isZSEGetshippinginfo() {
        return (Boolean) get(PROPERTY_ZSEGETSHIPPINGINFO);
    }

    public void setZSEGetshippinginfo(Boolean zSEGetshippinginfo) {
        set(PROPERTY_ZSEGETSHIPPINGINFO, zSEGetshippinginfo);
    }

    public String getZSEShippingtype() {
        return (String) get(PROPERTY_ZSESHIPPINGTYPE);
    }

    public void setZSEShippingtype(String zSEShippingtype) {
        set(PROPERTY_ZSESHIPPINGTYPE, zSEShippingtype);
    }
