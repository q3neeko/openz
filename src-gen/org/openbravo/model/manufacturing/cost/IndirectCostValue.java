...
public class IndirectCostValue extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_APPLIESONLYTOMACHINEANDEMPLOYEES =
        "appliesonlytomachineandemployees";
    ...
    public IndirectCostValue() {
        ...
        setDefaultValue(PROPERTY_APPLIESONLYTOMACHINEANDEMPLOYEES, false);
    ...
    public Boolean isAppliesonlytomachineandemployees() {
        return (Boolean) get(PROPERTY_APPLIESONLYTOMACHINEANDEMPLOYEES);
    }

    public void setAppliesonlytomachineandemployees(
        Boolean appliesonlytomachineandemployees) {
        set(PROPERTY_APPLIESONLYTOMACHINEANDEMPLOYEES,
            appliesonlytomachineandemployees);
    }
