...
public class CommissionLine extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_ISCOMMISSIONINPRICE =
        "iscommissioninprice";
    public static final String PROPERTY_HIGHLEVELCATEGORY = "highlevelcategory";
    ...
    public String getHighlevelcategory() {
        return (String) get(PROPERTY_HIGHLEVELCATEGORY);
    }

    public void setHighlevelcategory(String highlevelcategory) {
        set(PROPERTY_HIGHLEVELCATEGORY, highlevelcategory);
    }
}
