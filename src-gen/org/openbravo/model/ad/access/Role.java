...
public class Role extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_TARGETMENU = "targetmenu";
    public static final String PROPERTY_TARGETMAIN = "targetmain";
    ...
    public String getTargetmenu() {
        return (String) get(PROPERTY_TARGETMENU);
    }

    public void setTargetmenu(String targetmenu) {
        set(PROPERTY_TARGETMENU, targetmenu);
    }

    public String getTargetmain() {
        return (String) get(PROPERTY_TARGETMAIN);
    }

    public void setTargetmain(String targetmain) {
        set(PROPERTY_TARGETMAIN, targetmain);
    }
