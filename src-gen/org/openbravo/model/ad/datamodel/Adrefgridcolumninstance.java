...
public class Adrefgridcolumninstance extends BaseOBObject
    ...
    public static final String PROPERTY_DYNAMICCOLSSQL = "dynamiccolssql";
    ...
    public String getDynamiccolssql() {
        return (String) get(PROPERTY_DYNAMICCOLSSQL);
    }

    public void setDynamiccolssql(String dynamiccolssql) {
        set(PROPERTY_DYNAMICCOLSSQL, dynamiccolssql);
    }
