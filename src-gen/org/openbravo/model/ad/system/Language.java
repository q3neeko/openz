...
public class Language extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_THOUSANDSEPARATOR = "thousandseparator";
    public static final String PROPERTY_DATEFORMAT = "dateformat";
    public static final String PROPERTY_REPORTDATEFORMAT = "reportdateformat";
    public static final String PROPERTY_ISONLY4FORMAT = "isonly4format";
    public static final String PROPERTY_TRANSLATIONLANGUAGE =
        "translationlanguage";
    ...
    public Language() {
        ...
        setDefaultValue(PROPERTY_ISONLY4FORMAT, false);
    ...
    public String getThousandseparator() {
        return (String) get(PROPERTY_THOUSANDSEPARATOR);
    }

    public void setThousandseparator(String thousandseparator) {
        set(PROPERTY_THOUSANDSEPARATOR, thousandseparator);
    }
    ...
    public String getReportdateformat() {
        return (String) get(PROPERTY_REPORTDATEFORMAT);
    }

    public void setReportdateformat(String reportdateformat) {
        set(PROPERTY_REPORTDATEFORMAT, reportdateformat);
    }

    public Boolean isOnly4format() {
        return (Boolean) get(PROPERTY_ISONLY4FORMAT);
    }

    public void setOnly4format(Boolean isonly4format) {
        set(PROPERTY_ISONLY4FORMAT, isonly4format);
    }

    public String getTranslationlanguage() {
        return (String) get(PROPERTY_TRANSLATIONLANGUAGE);
    }

    public void setTranslationlanguage(String translationlanguage) {
        set(PROPERTY_TRANSLATIONLANGUAGE, translationlanguage);
    }
