...
public class Client extends BaseOBObject {
    ...
    public static final String PROPERTY_COSTINGVLIST = "costingVList";
    ...
    public Client() {
        ...
        setDefaultValue(PROPERTY_COSTINGVLIST, new ArrayList<Object>());
    ...
    public List<org.openbravo.model.dataimport.i_costing_v> getCostingVList() {
        return (List<org.openbravo.model.dataimport.i_costing_v>) get(PROPERTY_COSTINGVLIST);
    }

    public void setCostingVList(
        List<org.openbravo.model.dataimport.i_costing_v> costingVList) {
        set(PROPERTY_COSTINGVLIST, costingVList);
    }
