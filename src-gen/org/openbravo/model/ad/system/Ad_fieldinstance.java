...
public class Ad_fieldinstance extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_ISDIRECTFILTER = "isdirectfilter";
    ...
    public Ad_fieldinstance() {
        ...
        setDefaultValue(PROPERTY_ISDIRECTFILTER, "NON");
    }
    ...
    public String getIsdirectfilter() {
        return (String) get(PROPERTY_ISDIRECTFILTER);
    }

    public void setIsdirectfilter(String isdirectfilter) {
        set(PROPERTY_ISDIRECTFILTER, isdirectfilter);
    }
}
