...
public class Tab extends BaseOBObject implements ClientEnabled {
    ...
    public Tab() {
        ...
        setDefaultValue(PROPERTY_ISMAXROWSPARAM, false);
    ...
    public Boolean isMaxrowsparam() {
        return (Boolean) get(PROPERTY_ISMAXROWSPARAM);
    }

    public void setMaxrowsparam(Boolean ismaxrowsparam) {
