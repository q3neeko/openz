...
public class TaxRate extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_ISREVENUEEXPENSEFROMPRODUCT =
        "isrevenueexpensefromproduct";
    public static final String PROPERTY_ISEXPENSEFROMPRODUCT =
        "isexpensefromproduct";
    ...
    public TaxRate() {
        ...
        setDefaultValue(PROPERTY_ISREVENUEEXPENSEFROMPRODUCT, false);
        setDefaultValue(PROPERTY_ISEXPENSEFROMPRODUCT, false);
    ...
    public Boolean isRevenueexpensefromproduct() {
        return (Boolean) get(PROPERTY_ISREVENUEEXPENSEFROMPRODUCT);
    }

    public void setRevenueexpensefromproduct(
        Boolean isrevenueexpensefromproduct) {
        set(PROPERTY_ISREVENUEEXPENSEFROMPRODUCT, isrevenueexpensefromproduct);
    }

    public Boolean isExpensefromproduct() {
        return (Boolean) get(PROPERTY_ISEXPENSEFROMPRODUCT);
    }

    public void setExpensefromproduct(Boolean isexpensefromproduct) {
        set(PROPERTY_ISEXPENSEFROMPRODUCT, isexpensefromproduct);
    }
