...
public class DebtPayment extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_BPBANKACCOUNT = "bpBankaccount";
    ...
    public org.openbravo.model.common.businesspartner.BankAccount getBpBankaccount() {
        return (org.openbravo.model.common.businesspartner.BankAccount) get(PROPERTY_BPBANKACCOUNT);
    }

    public void setBpBankaccount(
        org.openbravo.model.common.businesspartner.BankAccount bpBankaccount) {
        set(PROPERTY_BPBANKACCOUNT, bpBankaccount);
    }
