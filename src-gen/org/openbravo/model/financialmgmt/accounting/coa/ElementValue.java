...
public class ElementValue extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_ZSFIBUDGETLIST = "zsfiBudgetList";
    ...
    public ElementValue() {
        ...
        setDefaultValue(PROPERTY_ZSFIBUDGETLIST, new ArrayList<Object>());
    ...
    public List<org.openbravo.zsoft.finance.zsfi_budget> getZsfiBudgetList() {
        return (List<org.openbravo.zsoft.finance.zsfi_budget>) get(PROPERTY_ZSFIBUDGETLIST);
    }

    public void setZsfiBudgetList(
        List<org.openbravo.zsoft.finance.zsfi_budget> zsfiBudgetList) {
        set(PROPERTY_ZSFIBUDGETLIST, zsfiBudgetList);
    }
