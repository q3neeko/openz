...
public class ProjectTask extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_SALESPRICE = "salesPrice";
    public static final String PROPERTY_SHIFTQTY = "shiftQty";
    public static final String PROPERTY_EMPLOYEEQTY = "employeeQty";
    public static final String PROPERTY_PRICESHIFTPERSON = "priceShiftPerson";
    public static final String PROPERTY_PRICESHIFT = "priceShift";
    public static final String PROPERTY_ISINVOICABLESERVICE =
        "isinvoicableservice";
    public static final String PROPERTY_ISMOBDEMOB = "ismobdemob";
    ...
    public ProjectTask() {
        ...
        setDefaultValue(PROPERTY_QTYPRODUCED, new BigDecimal(0));
        ...
        setDefaultValue(PROPERTY_ISINVOICABLESERVICE, false);
        setDefaultValue(PROPERTY_ISMOBDEMOB, false);
    ...
    public Long getMargin() {
        return (Long) get(PROPERTY_MARGIN);
    }
    ...
    public Long getSalesPrice() {
        return (Long) get(PROPERTY_SALESPRICE);
    }

    public void setSalesPrice(Long salesPrice) {
        set(PROPERTY_SALESPRICE, salesPrice);
    }

    public Long getShiftQty() {
        return (Long) get(PROPERTY_SHIFTQTY);
    }

    public void setShiftQty(Long shiftQty) {
        set(PROPERTY_SHIFTQTY, shiftQty);
    }

    public Long getEmployeeQty() {
        return (Long) get(PROPERTY_EMPLOYEEQTY);
    }

    public void setEmployeeQty(Long employeeQty) {
        set(PROPERTY_EMPLOYEEQTY, employeeQty);
    }

    public Long getPriceShiftPerson() {
        return (Long) get(PROPERTY_PRICESHIFTPERSON);
    }

    public void setPriceShiftPerson(Long priceShiftPerson) {
        set(PROPERTY_PRICESHIFTPERSON, priceShiftPerson);
    }

    public Long getPriceShift() {
        return (Long) get(PROPERTY_PRICESHIFT);
    }

    public void setPriceShift(Long priceShift) {
        set(PROPERTY_PRICESHIFT, priceShift);
    }

    public Boolean isInvoicableservice() {
        return (Boolean) get(PROPERTY_ISINVOICABLESERVICE);
    }

    public void setInvoicableservice(Boolean isinvoicableservice) {
        set(PROPERTY_ISINVOICABLESERVICE, isinvoicableservice);
    }

    public Boolean isMobdemob() {
        return (Boolean) get(PROPERTY_ISMOBDEMOB);
    }

    public void setMobdemob(Boolean ismobdemob) {
        set(PROPERTY_ISMOBDEMOB, ismobdemob);
    }
