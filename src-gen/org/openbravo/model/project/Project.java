...
public class Project extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_PROJECTORDEROVERVIEWLIST =
        "projectOrderOverviewList";
    ...
    public Project() {
        ...
        setDefaultValue(PROPERTY_PROJECTORDEROVERVIEWLIST,
            new ArrayList<Object>());
    }
    ...
    @SuppressWarnings("unchecked")
    public List<org.openbravo.zsoft.projects.c_project_order_overview> getProjectOrderOverviewList() {
        return (List<org.openbravo.zsoft.projects.c_project_order_overview>) get(PROPERTY_PROJECTORDEROVERVIEWLIST);
    }

    public void setProjectOrderOverviewList(
        List<org.openbravo.zsoft.projects.c_project_order_overview> projectOrderOverviewList) {
        set(PROPERTY_PROJECTORDEROVERVIEWLIST, projectOrderOverviewList);
    }
}
