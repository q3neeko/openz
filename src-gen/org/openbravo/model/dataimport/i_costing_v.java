...
/**
 * Entity class for entity i_costing_v (stored in table i_costing_v).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class i_costing_v extends BaseOBObject implements ClientEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "i_costing_v";
    public static final String ENTITY_NAME = "i_costing_v";
    ...
    public Long getCumqty() {
        return (Long) get(PROPERTY_CUMQTY);
    }
