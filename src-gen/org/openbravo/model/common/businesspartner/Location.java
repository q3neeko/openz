...
public class Location extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_PRINTCONTACTNAME = "printcontactname";
    public static final String PROPERTY_ISINVOICEBYEMAIL = "isinvoicebyemail";
    ...
    public Location() {
        ...
        setDefaultValue(PROPERTY_PRINTCONTACTNAME, false);
        setDefaultValue(PROPERTY_ISINVOICEBYEMAIL, false);
    ...
    public Boolean isPrintcontactname() {
        return (Boolean) get(PROPERTY_PRINTCONTACTNAME);
    }

    public void setPrintcontactname(Boolean printcontactname) {
        set(PROPERTY_PRINTCONTACTNAME, printcontactname);
    }

    public Boolean isInvoicebyemail() {
        return (Boolean) get(PROPERTY_ISINVOICEBYEMAIL);
    }

    public void setInvoicebyemail(Boolean isinvoicebyemail) {
        set(PROPERTY_ISINVOICEBYEMAIL, isinvoicebyemail);
    }
    ...
    public String getCcemail() {
        return (String) get(PROPERTY_CCEMAIL);
    }

    public void setCcemail(String ccemail) {
        set(PROPERTY_CCEMAIL, ccemail);
    }
