...
import org.openbravo.zsoft.smartui.Zssi_textmodule;
...
public class BusinessPartner extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_SHIPPINGTYPE = "shippingtype";
    public static final String PROPERTY_MINIMUMORDERVALUE = "minimumordervalue";
    public static final String PROPERTY_MINIMUMSURCHAGE = "minimumsurchage";
    ...
    public static final String PROPERTY_ZSSITEXTMODULELIST =
        "zssiTextmoduleList";
    ...
    public BusinessPartner() {
        ...
        setDefaultValue(PROPERTY_TIMEANDEXPENSESHEETLINELIST,
            new ArrayList<Object>());
        setDefaultValue(PROPERTY_ZSSITEXTMODULELIST, new ArrayList<Object>());
    ...
    public String getShippingtype() {
        return (String) get(PROPERTY_SHIPPINGTYPE);
    }

    public void setShippingtype(String shippingtype) {
        set(PROPERTY_SHIPPINGTYPE, shippingtype);
    }

    public Long getMinimumordervalue() {
        return (Long) get(PROPERTY_MINIMUMORDERVALUE);
    }

    public void setMinimumordervalue(Long minimumordervalue) {
        set(PROPERTY_MINIMUMORDERVALUE, minimumordervalue);
    }

    public String getMinimumsurchage() {
        return (String) get(PROPERTY_MINIMUMSURCHAGE);
    }

    public void setMinimumsurchage(String minimumsurchage) {
        set(PROPERTY_MINIMUMSURCHAGE, minimumsurchage);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<Zssi_textmodule> getZssiTextmoduleList() {
        return (List<Zssi_textmodule>) get(PROPERTY_ZSSITEXTMODULELIST);
    }

    public void setZssiTextmoduleList(List<Zssi_textmodule> zssiTextmoduleList) {
        set(PROPERTY_ZSSITEXTMODULELIST, zssiTextmoduleList);
    }
