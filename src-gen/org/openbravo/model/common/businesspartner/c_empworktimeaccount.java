...
public class c_empworktimeaccount extends BaseOBObject implements ClientEnabled {
    ...
    public BigDecimal getHolidayEntitlement() {
        return (BigDecimal) get(PROPERTY_HOLIDAYENTITLEMENT);
    }

    public void setHolidayEntitlement(BigDecimal holidayEntitlement) {
