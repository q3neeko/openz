...
public class SalaryCategoryCost extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_SPECIAL3 = "special3";
    ...
    public SalaryCategoryCost() {
        ...
        setDefaultValue(PROPERTY_SPECIAL3, new BigDecimal(0));
    }
    ...
    public BigDecimal getSpecial3() {
        return (BigDecimal) get(PROPERTY_SPECIAL3);
    }

    public void setSpecial3(BigDecimal special3) {
        set(PROPERTY_SPECIAL3, special3);
    }
}
