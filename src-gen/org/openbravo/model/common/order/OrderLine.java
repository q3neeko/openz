...
public class OrderLine extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_TEXTPOSITION = "textposition";
    ...
    public OrderLine() {
        ...
        setDefaultValue(PROPERTY_ISOPTIONAL, false);
    ...
    public Boolean isOptional() {
        return (Boolean) get(PROPERTY_ISOPTIONAL);
    }

    public void setOptional(Boolean isoptional) {
        set(PROPERTY_ISOPTIONAL, isoptional);
    }

    public String getTextposition() {
        return (String) get(PROPERTY_TEXTPOSITION);
    }

    public void setTextposition(String textposition) {
        set(PROPERTY_TEXTPOSITION, textposition);
    }
