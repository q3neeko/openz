...
public class Order extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_DISCOUNTCOUPONCODE =
        "discountcouponcode";
    ...
    public static final String PROPERTY_FRAMECALLOFFOVERVIEWLIST =
        "framecalloffoverviewList";
    ...
    public Order() {
        ...
        setDefaultValue(PROPERTY_ISSENT, false);
        ...
        setDefaultValue(PROPERTY_FINANCIALMGMTDEBTPAYMENTLIST,
            new ArrayList<Object>());
        setDefaultValue(PROPERTY_FRAMECALLOFFOVERVIEWLIST,
            new ArrayList<Object>());
    }
    ...
    public String getCopyFrom() {
        return (String) get(PROPERTY_COPYFROM);
    }
    ...
    public String getDiscountcouponcode() {
        return (String) get(PROPERTY_DISCOUNTCOUPONCODE);
    }

    public void setDiscountcouponcode(String discountcouponcode) {
        set(PROPERTY_DISCOUNTCOUPONCODE, discountcouponcode);
    }
    ...
    public Boolean isSent() {
        return (Boolean) get(PROPERTY_ISSENT);
    }

    public void setSent(Boolean issent) {
        set(PROPERTY_ISSENT, issent);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<org.openbravo.model.common.order.c_framecalloffoverview> getFramecalloffoverviewList() {
        return (List<org.openbravo.model.common.order.c_framecalloffoverview>) get(PROPERTY_FRAMECALLOFFOVERVIEWLIST);
    }

    public void setFramecalloffoverviewList(
        List<org.openbravo.model.common.order.c_framecalloffoverview> framecalloffoverviewList) {
        set(PROPERTY_FRAMECALLOFFOVERVIEWLIST, framecalloffoverviewList);
    }
}
