...
public class c_employeecalendar_v extends BaseOBObject implements ClientEnabled {
    ...
    public BigDecimal getPercentused() {
        return (BigDecimal) get(PROPERTY_PERCENTUSED);
    }
    ...
    public BigDecimal getPercentplanned() {
        return (BigDecimal) get(PROPERTY_PERCENTPLANNED);
    }

    public void setPercentplanned(BigDecimal percentplanned) {
