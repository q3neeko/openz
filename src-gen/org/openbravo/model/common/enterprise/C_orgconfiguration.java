...
public class C_orgconfiguration extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_DIRECTBOMSCANONLYWITHWORKSTEP =
    ...
    public static final String PROPERTY_CREATEDATEVACCOUNT =
        "createdatevaccount";
    public static final String PROPERTY_SALESMATERIALTOPROJECTTASKBOM =
        "salesmaterialtoprojecttaskbom";
    public static final String PROPERTY_ALLOWORDERCHANGESAFTERDELIVERY =
        "alloworderchangesafterdelivery";
    public static final String PROPERTY_SORTGENERATELINESBYPRODUCT =
        "sortgeneratelinesbyproduct";
    public static final String PROPERTY_MRPAPPROVALWORKFLOW =
        "mrpapprovalworkflow";
    public static final String PROPERTY_PRODUCTIONLOCATORFROMPRODUCTDATA =
        "productionlocatorfromproductdata";
    public static final String PROPERTY_BOMISSUINGLOCATORIDENTICAL2WORKSTEP =
        "bomissuinglocatoridentical2workstep";
    public static final String PROPERTY_CLOSEWORKSTEPAFTERPRODUCTION =
        "closeworkstepafterproduction";
    public static final String PROPERTY_POACTIVEAFTERPURCHASERUN =
        "poactiveafterpurchaserun";
    public static final String PROPERTY_GOBNODELTEINDOCUMENTS =
        "gobnodelteindocuments";
    ...
    public C_orgconfiguration() {
        ...
        setDefaultValue(PROPERTY_DIRECTBOMSCANONLYWITHWORKSTEP, false);
        ...
        setDefaultValue(PROPERTY_SALESMATERIALTOPROJECTTASKBOM, true);
        setDefaultValue(PROPERTY_ALLOWORDERCHANGESAFTERDELIVERY, true);
        setDefaultValue(PROPERTY_SORTGENERATELINESBYPRODUCT, false);
        setDefaultValue(PROPERTY_MRPAPPROVALWORKFLOW, false);
        setDefaultValue(PROPERTY_PRODUCTIONLOCATORFROMPRODUCTDATA, false);
        setDefaultValue(PROPERTY_BOMISSUINGLOCATORIDENTICAL2WORKSTEP, false);
        setDefaultValue(PROPERTY_CLOSEWORKSTEPAFTERPRODUCTION, true);
        setDefaultValue(PROPERTY_POACTIVEAFTERPURCHASERUN, true);
        setDefaultValue(PROPERTY_GOBNODELTEINDOCUMENTS, false);
    }
    ...
    public Boolean isDirectbomscanonlywithworkstep() {
        return (Boolean) get(PROPERTY_DIRECTBOMSCANONLYWITHWORKSTEP);
    }

    public void setDirectbomscanonlywithworkstep(
        Boolean directbomscanonlywithworkstep) {
        set(PROPERTY_DIRECTBOMSCANONLYWITHWORKSTEP,
            directbomscanonlywithworkstep);
    }
    ...
    public Boolean isSalesmaterialtoprojecttaskbom() {
        return (Boolean) get(PROPERTY_SALESMATERIALTOPROJECTTASKBOM);
    }

    public void setSalesmaterialtoprojecttaskbom(
        Boolean salesmaterialtoprojecttaskbom) {
        set(PROPERTY_SALESMATERIALTOPROJECTTASKBOM,
            salesmaterialtoprojecttaskbom);
    }

    public Boolean isAlloworderchangesafterdelivery() {
        return (Boolean) get(PROPERTY_ALLOWORDERCHANGESAFTERDELIVERY);
    }

    public void setAlloworderchangesafterdelivery(
        Boolean alloworderchangesafterdelivery) {
        set(PROPERTY_ALLOWORDERCHANGESAFTERDELIVERY,
            alloworderchangesafterdelivery);
    }

    public Boolean isSortgeneratelinesbyproduct() {
        return (Boolean) get(PROPERTY_SORTGENERATELINESBYPRODUCT);
    }

    public void setSortgeneratelinesbyproduct(
        Boolean sortgeneratelinesbyproduct) {
        set(PROPERTY_SORTGENERATELINESBYPRODUCT, sortgeneratelinesbyproduct);
    }

    public Boolean isMrpapprovalworkflow() {
        return (Boolean) get(PROPERTY_MRPAPPROVALWORKFLOW);
    }

    public void setMrpapprovalworkflow(Boolean mrpapprovalworkflow) {
        set(PROPERTY_MRPAPPROVALWORKFLOW, mrpapprovalworkflow);
    }

    public Boolean isProductionlocatorfromproductdata() {
        return (Boolean) get(PROPERTY_PRODUCTIONLOCATORFROMPRODUCTDATA);
    }

    public void setProductionlocatorfromproductdata(
        Boolean productionlocatorfromproductdata) {
        set(PROPERTY_PRODUCTIONLOCATORFROMPRODUCTDATA,
            productionlocatorfromproductdata);
    }

    public Boolean isBomissuinglocatoridentical2workstep() {
        return (Boolean) get(PROPERTY_BOMISSUINGLOCATORIDENTICAL2WORKSTEP);
    }

    public void setBomissuinglocatoridentical2workstep(
        Boolean bomissuinglocatoridentical2workstep) {
        set(PROPERTY_BOMISSUINGLOCATORIDENTICAL2WORKSTEP,
            bomissuinglocatoridentical2workstep);
    }

    public Boolean isCloseworkstepafterproduction() {
        return (Boolean) get(PROPERTY_CLOSEWORKSTEPAFTERPRODUCTION);
    }

    public void setCloseworkstepafterproduction(
        Boolean closeworkstepafterproduction) {
        set(PROPERTY_CLOSEWORKSTEPAFTERPRODUCTION, closeworkstepafterproduction);
    }

    public Boolean isPoactiveafterpurchaserun() {
        return (Boolean) get(PROPERTY_POACTIVEAFTERPURCHASERUN);
    }

    public void setPoactiveafterpurchaserun(Boolean poactiveafterpurchaserun) {
        set(PROPERTY_POACTIVEAFTERPURCHASERUN, poactiveafterpurchaserun);
    }

    public Boolean isGobnodelteindocuments() {
        return (Boolean) get(PROPERTY_GOBNODELTEINDOCUMENTS);
    }

    public void setGobnodelteindocuments(Boolean gobnodelteindocuments) {
        set(PROPERTY_GOBNODELTEINDOCUMENTS, gobnodelteindocuments);
    }
}
