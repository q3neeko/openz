...
/**
 * Entity class for entity DocumentTemplateTrl (stored in table C_POC_DOCTYPE_TEMPLATE_TRL).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class DocumentTemplateTrl extends BaseOBObject implements ClientEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "C_POC_DOCTYPE_TEMPLATE_TRL";
    public static final String ENTITY_NAME = "DocumentTemplateTrl";
    ...
    public static final String PROPERTY_REPORTTITLE = "reporttitle";
    public static final String PROPERTY_DOCUMENTNOTE = "documentnote";

    public DocumentTemplateTrl() {
    ...
    public String getReporttitle() {
        return (String) get(PROPERTY_REPORTTITLE);
    }

    public void setReporttitle(String reporttitle) {
        set(PROPERTY_REPORTTITLE, reporttitle);
    }
