...
public class Product extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_SNRBATCHCURRENTBOMVLIST =
        "snrBatchcurrentbomVList";
    ...
    public static final String PROPERTY_PURCHASESALESPRICEOVERVIEWLIST =
        "purchasesalespriceOverviewList";
    ...
    public Product() {
        ...
        setDefaultValue(PROPERTY_SNRBATCHCURRENTBOMVLIST,
            new ArrayList<Object>());
        ...
        setDefaultValue(PROPERTY_MATERIALMGMTSTORAGEDETAILLIST,
            new ArrayList<Object>());
        setDefaultValue(PROPERTY_PURCHASESALESPRICEOVERVIEWLIST,
            new ArrayList<Object>());
    ...
    @SuppressWarnings("unchecked")
    public List<org.zsoft.serial.snr_batchcurrentbom_v> getSnrBatchcurrentbomVList() {
        return (List<org.zsoft.serial.snr_batchcurrentbom_v>) get(PROPERTY_SNRBATCHCURRENTBOMVLIST);
    }

    public void setSnrBatchcurrentbomVList(
        List<org.zsoft.serial.snr_batchcurrentbom_v> snrBatchcurrentbomVList) {
        set(PROPERTY_SNRBATCHCURRENTBOMVLIST, snrBatchcurrentbomVList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<org.openbravo.zsoft.costing.m_purchasesalesprice_overview> getPurchasesalespriceOverviewList() {
        return (List<org.openbravo.zsoft.costing.m_purchasesalesprice_overview>) get(PROPERTY_PURCHASESALESPRICEOVERVIEWLIST);
    }

    public void setPurchasesalespriceOverviewList(
        List<org.openbravo.zsoft.costing.m_purchasesalesprice_overview> purchasesalespriceOverviewList) {
        set(PROPERTY_PURCHASESALESPRICEOVERVIEWLIST,
            purchasesalespriceOverviewList);
    }
