...
public class AttributeSet extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_ISSTOCKTRACKING = "isstocktracking";
    ...
    public AttributeSet() {
        ...
        setDefaultValue(PROPERTY_ISSTOCKTRACKING, false);
    ...
    public Boolean isStocktracking() {
        return (Boolean) get(PROPERTY_ISSTOCKTRACKING);
    }

    public void setStocktracking(Boolean isstocktracking) {
        set(PROPERTY_ISSTOCKTRACKING, isstocktracking);
    }
