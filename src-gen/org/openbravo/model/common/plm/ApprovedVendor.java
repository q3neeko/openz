...
public class ApprovedVendor extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_MINIMPOSITIONVALUE =
        "minimpositionvalue";
    public static final String PROPERTY_QTYLASTPO = "qtylastpo";
    ...
    public ApprovedVendor() {
        ...
        setDefaultValue(PROPERTY_QTYLASTPO, new BigDecimal(0));
    ...
    public Long getMinimpositionvalue() {
        return (Long) get(PROPERTY_MINIMPOSITIONVALUE);
    }

    public void setMinimpositionvalue(Long minimpositionvalue) {
        set(PROPERTY_MINIMPOSITIONVALUE, minimpositionvalue);
    }

    public BigDecimal getQtylastpo() {
        return (BigDecimal) get(PROPERTY_QTYLASTPO);
    }

    public void setQtylastpo(BigDecimal qtylastpo) {
        set(PROPERTY_QTYLASTPO, qtylastpo);
    }
