 ...
 ************************************************************************
*/
package org.openbravo.zsoft.mrp;
...
/**
 * Entity class for entity mrp_production_unneeded (stored in table mrp_production_unneeded).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class mrp_production_unneeded extends BaseOBObject
    implements ClientEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "mrp_production_unneeded";
    public static final String ENTITY_NAME = "mrp_production_unneeded";
    ...
    public Long getUnnededqty() {
        return (Long) get(PROPERTY_UNNEDEDQTY);
    }

    public void setUnnededqty(Long unnededqty) {
        set(PROPERTY_UNNEDEDQTY, unnededqty);
    }
