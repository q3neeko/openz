...
public class zssm_workstep_prp_v extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_MIMIMUMQTY = "mimimumqty";
    public static final String PROPERTY_MULTIPLEOFMIMIMUMQTY =
    ...
    public zssm_workstep_prp_v() {
        ...
        setDefaultValue(PROPERTY_MULTIPLEOFMIMIMUMQTY, false);
    ...
    public BigDecimal getMimimumqty() {
        return (BigDecimal) get(PROPERTY_MIMIMUMQTY);
    }

    public void setMimimumqty(BigDecimal mimimumqty) {
        set(PROPERTY_MIMIMUMQTY, mimimumqty);
    }

    public Boolean isMultipleofmimimumqty() {
        return (Boolean) get(PROPERTY_MULTIPLEOFMIMIMUMQTY);
    }

    public void setMultipleofmimimumqty(Boolean multipleofmimimumqty) {
        set(PROPERTY_MULTIPLEOFMIMIMUMQTY, multipleofmimimumqty);
    }
