...
public class zssm_workstep_v extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_ISAUTOCLOSEWORKSTEP =
        "isautocloseworkstep";
    ...
    public zssm_workstep_v() {
        ...
        setDefaultValue(PROPERTY_ISAUTOCLOSEWORKSTEP, false);
    ...
    public Boolean isAutocloseworkstep() {
        return (Boolean) get(PROPERTY_ISAUTOCLOSEWORKSTEP);
    }

    public void setAutocloseworkstep(Boolean isautocloseworkstep) {
        set(PROPERTY_ISAUTOCLOSEWORKSTEP, isautocloseworkstep);
    }
