 ...
 ************************************************************************
*/
package org.openbravo.zsoft.costing;
...
/**
 * Entity class for entity m_purchasesalesprice_overview (stored in table m_purchasesalesprice_overview).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class m_purchasesalesprice_overview extends BaseOBObject
    implements ClientEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "m_purchasesalesprice_overview";
    public static final String ENTITY_NAME = "m_purchasesalesprice_overview";
    ...
    public static final String PROPERTY_MARGINE = "margine";
    public static final String PROPERTY_MARGINPERCENT = "marginpercent";

    public m_purchasesalesprice_overview() {
    ...
    public BigDecimal getMargine() {
        return (BigDecimal) get(PROPERTY_MARGINE);
    }

    public void setMargine(BigDecimal margine) {
        set(PROPERTY_MARGINE, margine);
    }
