...
/**
 * Entity class for entity c_europeantrades_purchase_v (stored in table c_europeantrades_purchase_v).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class c_europeantrades_purchase_v extends BaseOBObject
    implements ClientEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "c_europeantrades_purchase_v";
    public static final String ENTITY_NAME = "c_europeantrades_purchase_v";
    ...
    public c_europeantrades_purchase_v() {
    }
    ...
    public String getIsactive() {
        return (String) get(PROPERTY_ISACTIVE);
    }
