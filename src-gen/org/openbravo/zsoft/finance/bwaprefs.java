...
public class bwaprefs extends BaseOBObject implements ClientEnabled {
    ...
    public static final String PROPERTY_OLDPREFSIDWHENCOPY =
        "oldprefsidwhencopy";
    public static final String PROPERTY_ADDREVERSECHARGEASREVENUE =
        "addreversechargeasrevenue";
    public static final String PROPERTY_ZSPRBWAPREFSTRLLIST =
        "zsprBwaprefsTrlList";
    ...
    public bwaprefs() {
        ...
        setDefaultValue(PROPERTY_ADDREVERSECHARGEASREVENUE, false);
        setDefaultValue(PROPERTY_ZSPRBWAPREFSTRLLIST, new ArrayList<Object>());
    ...
    public String getOldprefsidwhencopy() {
        return (String) get(PROPERTY_OLDPREFSIDWHENCOPY);
    }

    public void setOldprefsidwhencopy(String oldprefsidwhencopy) {
        set(PROPERTY_OLDPREFSIDWHENCOPY, oldprefsidwhencopy);
    }

    public Boolean isAddreversechargeasrevenue() {
        return (Boolean) get(PROPERTY_ADDREVERSECHARGEASREVENUE);
    }

    public void setAddreversechargeasrevenue(Boolean addreversechargeasrevenue) {
        set(PROPERTY_ADDREVERSECHARGEASREVENUE, addreversechargeasrevenue);
    }

    @SuppressWarnings("unchecked")
    public List<org.openbravo.zsoft.finance.zspr_bwaprefs_trl> getZsprBwaprefsTrlList() {
        return (List<org.openbravo.zsoft.finance.zspr_bwaprefs_trl>) get(PROPERTY_ZSPRBWAPREFSTRLLIST);
    }

    public void setZsprBwaprefsTrlList(
        List<org.openbravo.zsoft.finance.zspr_bwaprefs_trl> zsprBwaprefsTrlList) {
        set(PROPERTY_ZSPRBWAPREFSTRLLIST, zsprBwaprefsTrlList);
    }
