...
/**
 * Entity class for entity zspr_bwaheader_trl (stored in table zspr_bwaheader_trl).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class zspr_bwaheader_trl extends BaseOBObject implements ClientEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "zspr_bwaheader_trl";
    public static final String ENTITY_NAME = "zspr_bwaheader_trl";
