...
public class zssi_onhanqty_overview extends BaseOBObject
    ...
    public static final String PROPERTY_QTYINSALEFRAME = "qtyinsaleframe";
    ...
    public static final String PROPERTY_PCATVALUE = "pcatvalue";
    ...
    public BigDecimal getQtyorderedframe() {
        return (BigDecimal) get(PROPERTY_QTYORDEREDFRAME);
    }

    public void setQtyorderedframe(BigDecimal qtyorderedframe) {
    ...
    public BigDecimal getQtyinsaleframe() {
        return (BigDecimal) get(PROPERTY_QTYINSALEFRAME);
    }

    public void setQtyinsaleframe(BigDecimal qtyinsaleframe) {
        set(PROPERTY_QTYINSALEFRAME, qtyinsaleframe);
    }
    ...
    public String getPvalue() {
        return (String) get(PROPERTY_PVALUE);
    }

    public void setPvalue(String pvalue) {
        set(PROPERTY_PVALUE, pvalue);
    }

    public String getPcatvalue() {
        return (String) get(PROPERTY_PCATVALUE);
    }

    public void setPcatvalue(String pcatvalue) {
        set(PROPERTY_PCATVALUE, pcatvalue);
    }
