...
public class ActionButtonJava_Responser extends HttpSecureAppServlet {
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    } else if (vars.commandIn("BUTTON7D0EC4BCC7F04EC5AE1274A7329B4351")) {
        
        printPageButton7D0EC4BCC7F04EC5AE1274A7329B4351(response, vars, strProcessId);
    } else if (vars.commandIn("BUTTONE64FA73B3BF44C4F86EEBA093EE36044")) {
        
        printPageButtonE64FA73B3BF44C4F86EEBA093EE36044(response, vars, strProcessId);
...
params.put("importauditinfo", strimportauditinfo);
        ...
        processButtonHelper(request, response, vars, myMessage);       
    } else if (vars.commandIn("SAVE_BUTTONActionButton7D0EC4BCC7F04EC5AE1274A7329B4351")) {
...
params.put("cYearId", strcYearId);
        ...
        OBError myMessage = null;
        try {
          new org.openz.controller.businessprocess.DonloadSavedFiles().execute(pb,this,response);
          myMessage = (OBError) pb.getResult();
          myMessage.setMessage(Utility.parseTranslation(this, vars, vars.getLanguage(), myMessage.getMessage()));
          myMessage.setTitle(Utility.parseTranslation(this, vars, vars.getLanguage(), myMessage.getTitle()));
        } catch (Exception ex) {
    ...
    } else if (vars.commandIn("SAVE_BUTTONActionButtonE64FA73B3BF44C4F86EEBA093EE36044")) {
        ...
        OBError myMessage = null;
        try {
          new org.zsoft.ecommerce.logistic.LogisticClient().execute(pb);
          myMessage = (OBError) pb.getResult();
          myMessage.setMessage(Utility.parseTranslation(this, vars, vars.getLanguage(), myMessage.getMessage()));
          myMessage.setTitle(Utility.parseTranslation(this, vars, vars.getLanguage(), myMessage.getTitle()));
        } catch (Exception ex) {
...
String strdatelaterthan = vars.getDateParameter("inpdatelaterthan", this);
...
params.put("exportauditinfo", strexportauditinfo);
  ...
  void printPageFrames(HttpServletResponse response, VariablesSecureApp vars, String strProcessId) throws IOException, ServletException {
    ...
    void printPageButton7D0EC4BCC7F04EC5AE1274A7329B4351(HttpServletResponse response, VariablesSecureApp vars, String strProcessId)
    throws IOException, ServletException {
      Scripthelper script = new Scripthelper();
      Formhelper fh=new Formhelper();
    ...
    void printPageButtonE64FA73B3BF44C4F86EEBA093EE36044(HttpServletResponse response, VariablesSecureApp vars, String strProcessId)
    throws IOException, ServletException {
      Scripthelper script = new Scripthelper();
      Formhelper fh=new Formhelper();
