...
public class ActionButton_Responser extends HttpSecureAppServlet {
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    } else if (vars.commandIn("BUTTOND62965A593C14A9BA542F684D01C2722")) {
        
        printPageButtonD62965A593C14A9BA542F684D01C2722(response, vars, strProcessId);
    ...
    } else if (vars.commandIn("BUTTON75CBFE64A1494A6C9CEC0E76ED0FC2F5")) {
        
        printPageButton75CBFE64A1494A6C9CEC0E76ED0FC2F5(response, vars, strProcessId);
...
String strdateinvoiced = vars.getDateParameter("inpdateinvoiced", this);
...
String strinvoicetodate = vars.getDateParameter("inpinvoicetodate", this);
...
PInstanceProcessData.insertPInstanceParam(this, pinstance, "20", "AD_Table_ID", stradTableId, vars.getClient(), vars.getOrg(), vars.getUser());
        ...
        String strinitdate = vars.getDateParameter("inpinitdate", this);
...
PInstanceProcessData.insertPInstanceParam(this, pinstance, "20", "toshop", strtoshop, vars.getClient(), vars.getOrg(), vars.getUser());
        ...
        processButtonHelper(request, response, vars, pinstance);        
    } else if (vars.commandIn("SAVE_BUTTONActionButtonD62965A593C14A9BA542F684D01C2722")) {
        
        String strProcessing = "Y";
        String pinstance = SequenceIdData.getUUID();
        PInstanceProcessData.insertPInstance(this, pinstance, "D62965A593C14A9BA542F684D01C2722", "0", strProcessing, vars.getUser(), vars.getClient(), vars.getOrg());
        String strdateFrom = vars.getDateParameter("inpdateFrom", this);
...
String strpProductionstartdate = vars.getDateParameter("inppProductionstartdate", this);
...
String strstartdate = vars.getDateParameter("inpstartdate", this);
...
PInstanceProcessData.insertPInstanceParam(this, pinstance, "100", "ISSPAREPART", strissparepart, vars.getClient(), vars.getOrg(), vars.getUser());
        ...
        processButtonHelper(request, response, vars, pinstance);        
    } else if (vars.commandIn("SAVE_BUTTONActionButton75CBFE64A1494A6C9CEC0E76ED0FC2F5")) {
        
        String strProcessing = "Y";
        String pinstance = SequenceIdData.getUUID();
        PInstanceProcessData.insertPInstance(this, pinstance, "75CBFE64A1494A6C9CEC0E76ED0FC2F5", "0", strProcessing, vars.getUser(), vars.getClient(), vars.getOrg());
        String strmProductId = vars.getStringParameter("inpmProductId");
PInstanceProcessData.insertPInstanceParam(this, pinstance, "5", "M_PRODUCT_ID", strmProductId, vars.getClient(), vars.getOrg(), vars.getUser());
String stradOrgId = vars.getStringParameter("inpadOrgId");
PInstanceProcessData.insertPInstanceParam(this, pinstance, "10", "AD_ORG_ID", stradOrgId, vars.getClient(), vars.getOrg(), vars.getUser());
...
String stronlyonelevel = vars.getStringParameter("inponlyonelevel", "N");
PInstanceProcessData.insertPInstanceParam(this, pinstance, "50", "ONLYONELEVEL", stronlyonelevel, vars.getClient(), vars.getOrg(), vars.getUser());
...
String stronlyonelevel = vars.getStringParameter("inponlyonelevel", "N");
PInstanceProcessData.insertPInstanceParam(this, pinstance, "70", "ONLYONELEVEL", stronlyonelevel, vars.getClient(), vars.getOrg(), vars.getUser());
String stronlypurchase = vars.getStringParameter("inponlypurchase", "N");
PInstanceProcessData.insertPInstanceParam(this, pinstance, "80", "ONLYPURCHASE", stronlypurchase, vars.getClient(), vars.getOrg(), vars.getUser());
String stronlyproduction = vars.getStringParameter("inponlyproduction", "N");
PInstanceProcessData.insertPInstanceParam(this, pinstance, "90", "ONLYPRODUCTION", stronlyproduction, vars.getClient(), vars.getOrg(), vars.getUser());
String strtreestructure = vars.getStringParameter("inptreestructure", "N");
PInstanceProcessData.insertPInstanceParam(this, pinstance, "100", "TREESTRUCTURE", strtreestructure, vars.getClient(), vars.getOrg(), vars.getUser());
...
String strbudget = vars.getStringParameter("inpbudget", "N");
PInstanceProcessData.insertPInstanceParam(this, pinstance, "65", "budget", strbudget, vars.getClient(), vars.getOrg(), vars.getUser());
String stradLanguage = vars.getStringParameter("inpadLanguage");
PInstanceProcessData.insertPInstanceParam(this, pinstance, "70", "ad_language", stradLanguage, vars.getClient(), vars.getOrg(), vars.getUser());
...
PInstanceProcessData.insertPInstanceParam(this, pinstance, "20", "outputType", stroutputtype, vars.getClient(), vars.getOrg(), vars.getUser());
  ...
  void printPageFrames(HttpServletResponse response, VariablesSecureApp vars, String strProcessId) throws IOException, ServletException {
    ...
    void printPageButtonD62965A593C14A9BA542F684D01C2722(HttpServletResponse response, VariablesSecureApp vars, String strProcessId)
    throws IOException, ServletException {
      Scripthelper script = new Scripthelper();
      Formhelper fh=new Formhelper();
    ...
    void printPageButton75CBFE64A1494A6C9CEC0E76ED0FC2F5(HttpServletResponse response, VariablesSecureApp vars, String strProcessId)
    throws IOException, ServletException {
      Scripthelper script = new Scripthelper();
      Formhelper fh=new Formhelper();
