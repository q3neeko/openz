  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strC_ValidCombination_ID, TableSQLData tableSQL)
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = CombinationData.set(Utility.getDefault(this, vars, "Description", "", "153", "207", "", dataField), Utility.getDefault(this, vars, "C_Activity_ID", "", "153", "207", "", dataField), Utility.getDefault(this, vars, "Alias", "", "153", "207", "", dataField), Utility.getDefault(this, vars, "C_LocFrom_ID", "", "153", "207", "", dataField), Utility.getDefault(this, vars, "C_BPartner_ID", "", "153", "207", "", dataField), CombinationData.selectDef2754_0(this, Utility.getDefault(this, vars, "C_BPartner_ID", "", "153", "207", "", dataField)), Utility.getDefault(this, vars, "Combination", "", "153", "207", "", dataField), Utility.getDefault(this, vars, "IsFullyQualified", "", "153", "207", "N", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "153", "207", "", dataField), Utility.getDefault(this, vars, "User1_ID", "", "153", "207", "", dataField), Utility.getDefault(this, vars, "User2_ID", "", "153", "207", "", dataField), "", Utility.getDefault(this, vars, "M_Product_ID", "", "153", "207", "", dataField), CombinationData.selectDef2402_1(this, Utility.getDefault(this, vars, "M_Product_ID", "", "153", "207", "", dataField)), Utility.getDefault(this, vars, "C_AcctSchema_ID", "", "153", "207", "", dataField), Utility.getDefault(this, vars, "AD_OrgTrx_ID", "", "153", "207", "", dataField), Utility.getDefault(this, vars, "C_LocTo_ID", "", "153", "207", "", dataField), Utility.getDefault(this, vars, "C_Project_ID", "", "153", "207", "", dataField), Utility.getDefault(this, vars, "C_SalesRegion_ID", "", "153", "207", "", dataField), Utility.getDefault(this, vars, "UpdatedBy", "", "153", "207", "", dataField), CombinationData.selectDef1021_2(this, Utility.getDefault(this, vars, "UpdatedBy", "", "153", "207", "", dataField)), Utility.getDefault(this, vars, "CreatedBy", "", "153", "207", "", dataField), CombinationData.selectDef1019_3(this, Utility.getDefault(this, vars, "CreatedBy", "", "153", "207", "", dataField)), Utility.getDefault(this, vars, "Account_ID", "", "153", "207", "", dataField), "Y", Utility.getDefault(this, vars, "C_Campaign_ID", "", "153", "207", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_Org_ID@", "153", "207", "", dataField));
  ...
  private int saveRecord(VariablesSecureApp vars, OBError myError, char type) throws IOException, ServletException {
    ...
    if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        strSequence = vars.getStringParameter("inpnewdataseIdVal");
          ...
          CrudOperations.UpdateCustomFields(tabId, data.cValidcombinationId, vars, this,con);
