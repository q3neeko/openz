...
String strresponsibleId = vars.getStringParameter("inpresponsibleId");
PInstanceProcessData.insertPInstanceParam(this, pinstance, "30", "Responsible_ID", strresponsibleId, vars.getClient(), vars.getOrg(), vars.getUser());
