...
PInstanceProcessData.insertPInstanceParamDate(this, pinstance, "10", "scheddeliverydate", strscheddeliverydate, vars.getClient(), vars.getOrg(), vars.getUser());
  ...
  private LinesData getEditVariables(Connection con, VariablesSecureApp vars, String strPC_Order_ID) throws IOException,ServletException {
   ...
   private LinesData[] getRelationData(LinesData[] data) {
    if (data!=null) {
      for (int i=0;i<data.length;i++) {        data[i].adOrgId = FormatUtilities.truncate(data[i].adOrgId, 44);        data[i].cOrderId = FormatUtilities.truncate(data[i].cOrderId, 44);        data[i].cBpartnerId = FormatUtilities.truncate(data[i].cBpartnerId, 44);        data[i].cBpartnerLocationId = FormatUtilities.truncate(data[i].cBpartnerLocationId, 44);        data[i].textposition = FormatUtilities.truncate(data[i].textposition, 50);        data[i].mProductId = FormatUtilities.truncate(data[i].mProductId, 44);        data[i].mAttributesetinstanceId = FormatUtilities.truncate(data[i].mAttributesetinstanceId, 14);        data[i].description = FormatUtilities.truncate(data[i].description, 50);        data[i].mProductUomId = FormatUtilities.truncate(data[i].mProductUomId, 44);        data[i].cUomId = FormatUtilities.truncate(data[i].cUomId, 44);        data[i].mShipperId = FormatUtilities.truncate(data[i].mShipperId, 44);        data[i].cCurrencyId = FormatUtilities.truncate(data[i].cCurrencyId, 20);        data[i].cTaxId = FormatUtilities.truncate(data[i].cTaxId, 44);        data[i].cProjectId = FormatUtilities.truncate(data[i].cProjectId, 32);        data[i].cProjecttaskId = FormatUtilities.truncate(data[i].cProjecttaskId, 32);        data[i].orderlineselfjoin = FormatUtilities.truncate(data[i].orderlineselfjoin, 32);        data[i].mOfferId = FormatUtilities.truncate(data[i].mOfferId, 44);        data[i].cChargeId = FormatUtilities.truncate(data[i].cChargeId, 44);        data[i].aAssetId = FormatUtilities.truncate(data[i].aAssetId, 32);        data[i].mWarehouseId = FormatUtilities.truncate(data[i].mWarehouseId, 44);        data[i].adClientId = FormatUtilities.truncate(data[i].adClientId, 44);        data[i].cProjectphaseId = FormatUtilities.truncate(data[i].cProjectphaseId, 32);        data[i].cOrderlineId = FormatUtilities.truncate(data[i].cOrderlineId, 10);        data[i].refOrderlineId = FormatUtilities.truncate(data[i].refOrderlineId, 44);}
    }
    return data;
  }
  ...
  private void refreshParentSession(VariablesSecureApp vars, String strPC_Order_ID) throws IOException,ServletException {
      ...
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|AD_Org_ID", data[0].adOrgId);    vars.setSessionValue(windowId + "|DateOrdered", data[0].dateordered);    vars.setSessionValue(windowId + "|C_DocTypeTarget_ID", data[0].cDoctypetargetId);    vars.setSessionValue(windowId + "|C_DocType_ID", data[0].cDoctypeId);    vars.setSessionValue(windowId + "|C_BPartner_ID", data[0].cBpartnerId);    vars.setSessionValue(windowId + "|C_BPartner_Location_ID", data[0].cBpartnerLocationId);    vars.setSessionValue(windowId + "|M_PriceList_ID", data[0].mPricelistId);    vars.setSessionValue(windowId + "|M_Warehouse_ID", data[0].mWarehouseId);    vars.setSessionValue(windowId + "|C_Currency_ID", data[0].cCurrencyId);    vars.setSessionValue(windowId + "|DeliveryViaRule", data[0].deliveryviarule);    vars.setSessionValue(windowId + "|M_Shipper_ID", data[0].mShipperId);    vars.setSessionValue(windowId + "|FreightCostRule", data[0].freightcostrule);    vars.setSessionValue(windowId + "|DatePromised", data[0].datepromised);    vars.setSessionValue(windowId + "|SchedDeliveryDate", data[0].scheddeliverydate);    vars.setSessionValue(windowId + "|IsSOTrx", data[0].issotrx);    vars.setSessionValue(windowId + "|Processed", data[0].processed);    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].adClientId);    vars.setSessionValue(windowId + "|C_Order_ID", data[0].cOrderId);
...
String strParamLineNetAmt_f = vars.getSessionValue(tabId + "|paramLineNetAmt_f");
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = LinesData.set(strPC_Order_ID, Utility.getDefault(this, vars, "M_Product_Uom_Id", "", "143", "187", "", dataField), Utility.getDefault(this, vars, "DatePromised", "@DatePromised@", "143", "187", "", dataField), Utility.getDefault(this, vars, "M_Warehouse_ID", "@M_Warehouse_ID@", "143", "187", "", dataField), Utility.getDefault(this, vars, "Isgrossprice", "N", "143", "187", "N", dataField), Utility.getDefault(this, vars, "QtyInvoiced", "", "143", "187", "", dataField), Utility.getDefault(this, vars, "QtyReserved", "", "143", "187", "", dataField), Utility.getDefault(this, vars, "Issummaryitem", "N", "143", "187", "N", dataField), Utility.getDefault(this, vars, "Calcfastestdeliverydate", "N", "143", "187", "N", dataField), Utility.getDefault(this, vars, "Securityqty", "", "143", "187", "", dataField), Utility.getDefault(this, vars, "Invoicedamt", "0", "143", "187", "", dataField), Utility.getDefault(this, vars, "Desireddeliverydate", "", "143", "187", "", dataField), Utility.getDefault(this, vars, "CreatedBy", "", "143", "187", "", dataField), LinesData.selectDef2210_0(this, Utility.getDefault(this, vars, "CreatedBy", "", "143", "187", "", dataField)), Utility.getDefault(this, vars, "QuantityOrder", "", "143", "187", "", dataField), Utility.getDefault(this, vars, "C_Charge_ID", "", "143", "187", "", dataField), Utility.getDefault(this, vars, "Discount", "0", "143", "187", "", dataField), Utility.getDefault(this, vars, "IsOneTimePosition", "N", "143", "187", "N", dataField), Utility.getDefault(this, vars, "LineNetAmt", "", "143", "187", "", dataField), Utility.getDefault(this, vars, "Isoptional", "N", "143", "187", "N", dataField), Utility.getDefault(this, vars, "M_Offer_ID", "", "143", "187", "", dataField), Utility.getDefault(this, vars, "Linegrossamt", "", "143", "187", "", dataField), Utility.getDefault(this, vars, "PriceLimit", "", "143", "187", "", dataField), Utility.getDefault(this, vars, "UpdatedBy", "", "143", "187", "", dataField), LinesData.selectDef2212_1(this, Utility.getDefault(this, vars, "UpdatedBy", "", "143", "187", "", dataField)), LinesData.selectDef2213_2(this, strPC_Order_ID), Utility.getDefault(this, vars, "QtyDelivered", "", "143", "187", "", dataField), Utility.getDefault(this, vars, "QtyOrdered", "1", "143", "187", "", dataField), LinesData.selectDef6F7344EDD9904E5A94A709DE5BFE09D6(this, strPC_Order_ID), Utility.getDefault(this, vars, "Ref_OrderLine_ID", "", "143", "187", "", dataField), LinesData.selectDefA48DE71600FC4CC7A352989D54135EDD(this, strPC_Order_ID), LinesData.selectDefA48DE71600FC4CC7A352989D54135EDD_3(this, LinesData.selectDefA48DE71600FC4CC7A352989D54135EDD(this, strPC_Order_ID)), Utility.getDefault(this, vars, "Ignoreresiduedate", "", "143", "187", "", dataField), Utility.getDefault(this, vars, "M_AttributeSetInstance_ID", "", "143", "187", "", dataField), LinesData.selectDef8767_4(this, Utility.getDefault(this, vars, "M_AttributeSetInstance_ID", "", "143", "187", "", dataField)), Utility.getDefault(this, vars, "C_BPartner_Location_ID", "@C_BPartner_Location_ID@", "143", "187", "", dataField), "Y", Utility.getDefault(this, vars, "CANCELPRICEAD", "N", "143", "187", "N", dataField), Utility.getDefault(this, vars, "PriceActual", "", "143", "187", "", dataField), Utility.getDefault(this, vars, "IsDescription", "N", "143", "187", "N", dataField), Utility.getDefault(this, vars, "Deliverycomplete", "N", "143", "187", "N", dataField), "", Utility.getDefault(this, vars, "M_Shipper_ID", "@M_Shipper_ID@", "143", "187", "", dataField), Utility.getDefault(this, vars, "DateInvoiced", "", "143", "187", "", dataField), LinesData.selectDef2764(this, strPC_Order_ID), LinesData.selectDef2764_5(this, LinesData.selectDef2764(this, strPC_Order_ID)), LinesData.selectDef94A94EC8613E4F9187409A87297DEB74(this, strPC_Order_ID), Utility.getDefault(this, vars, "C_UOM_ID", "", "143", "187", "", dataField), Utility.getDefault(this, vars, "DirectShip", "", "143", "187", "N", dataField), Utility.getDefault(this, vars, "Scheddeliverydate", "@Scheddeliverydate@", "143", "187", "", dataField), Utility.getDefault(this, vars, "M_Product_ID", "", "143", "187", "", dataField), LinesData.selectDef2221_6(this, Utility.getDefault(this, vars, "M_Product_ID", "", "143", "187", "", dataField)), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_Org_ID@", "143", "187", "", dataField), Utility.getDefault(this, vars, "FreightAmt", "", "143", "187", "", dataField), Utility.getDefault(this, vars, "ChargeAmt", "0", "143", "187", "", dataField), Utility.getDefault(this, vars, "Orderlineselfjoin", "", "143", "187", "", dataField), LinesData.selectDef01D5706503CE49D6ABDE8345B5DB4642(this, strPC_Order_ID), Utility.getDefault(this, vars, "Linetaxamt", "", "143", "187", "", dataField), Utility.getDefault(this, vars, "DateOrdered", "@DateOrdered@", "143", "187", "", dataField), Utility.getDefault(this, vars, "PriceStd", "0", "143", "187", "", dataField), Utility.getDefault(this, vars, "Textposition", "", "143", "187", "", dataField), Utility.getDefault(this, vars, "Calloffqty", "", "143", "187", "", dataField), LinesData.selectDef2214(this, strPC_Order_ID), Utility.getDefault(this, vars, "Ispagebreak", "N", "143", "187", "N", dataField), Utility.getDefault(this, vars, "C_Currency_ID", "@C_Currency_ID@", "143", "187", "", dataField), Utility.getDefault(this, vars, "Isapproved", "N", "143", "187", "N", dataField), Utility.getDefault(this, vars, "DateDelivered", "", "143", "187", "", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_Client_ID@", "143", "187", "", dataField), Utility.getDefault(this, vars, "PriceList", "", "143", "187", "", dataField), Utility.getDefault(this, vars, "C_Tax_ID", "", "143", "187", "", dataField), Utility.getDefault(this, vars, "Description", "", "143", "187", "", dataField), Utility.getDefault(this, vars, "Ignoreresidue", "N", "143", "187", "N", dataField));
  ...
  private int saveRecord(VariablesSecureApp vars, OBError myError, char type, String strPC_Order_ID) throws IOException, ServletException {
    ...
    if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        strSequence = vars.getStringParameter("inpnewdataseIdVal");
          ...
          CrudOperations.UpdateCustomFields(tabId, data.cOrderlineId, vars, this,con);
