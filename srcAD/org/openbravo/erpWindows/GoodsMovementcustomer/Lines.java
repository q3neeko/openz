...
vars.getGlobalVariable("inpmInoutId", windowId + "|M_InOut_ID");
  ...
  private void refreshParentSession(VariablesSecureApp vars, String strPM_InOut_ID) throws IOException,ServletException {
      ...
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|AD_Org_ID", data[0].adOrgId);    vars.setSessionValue(windowId + "|C_DocType_ID", data[0].cDoctypeId);    vars.setSessionValue(windowId + "|C_BPartner_ID", data[0].cBpartnerId);    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].adClientId);    vars.setSessionValue(windowId + "|M_InOut_ID", data[0].mInoutId);    vars.setSessionValue(windowId + "|IsSOTrx", data[0].issotrx);    vars.setSessionValue(windowId + "|M_Warehouse_ID", data[0].mWarehouseId);
...
String strParamM_Product_ID = vars.getSessionValue(tabId + "|paramM_Product_ID");
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = LinesData.set(strPM_InOut_ID, LinesData.selectDef3810(this, strPM_InOut_ID), Utility.getDefault(this, vars, "MovementQty", "1", "169", "258", "", dataField), Utility.getDefault(this, vars, "M_Locator_ID", "@#M_Locator_ID@", "169", "258", "", dataField), LinesData.selectDef3537_0(this, Utility.getDefault(this, vars, "M_Locator_ID", "@#M_Locator_ID@", "169", "258", "", dataField)), LinesData.selectDef3538_1(this, strPM_InOut_ID), "", Utility.getDefault(this, vars, "C_UOM_ID", "", "169", "258", "", dataField), Utility.getDefault(this, vars, "M_Product_Uom_Id", "", "169", "258", "", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_Client_ID@", "169", "258", "", dataField), Utility.getDefault(this, vars, "UpdatedBy", "", "169", "258", "", dataField), LinesData.selectDef3536_2(this, Utility.getDefault(this, vars, "UpdatedBy", "", "169", "258", "", dataField)), Utility.getDefault(this, vars, "ZSE_Parcelweight", "", "169", "258", "", dataField), Utility.getDefault(this, vars, "M_Product_ID", "", "169", "258", "", dataField), LinesData.selectDef3539_3(this, Utility.getDefault(this, vars, "M_Product_ID", "", "169", "258", "", dataField)), Utility.getDefault(this, vars, "IsInvoiced", "", "169", "258", "N", dataField), "Y", Utility.getDefault(this, vars, "QuantityOrder", "", "169", "258", "", dataField), Utility.getDefault(this, vars, "IsDescription", "N", "169", "258", "N", dataField), LinesData.selectDefFBFB0E5EAC68403BAA422D3D2EBF1CB8(this, strPM_InOut_ID), LinesData.selectDefFBFB0E5EAC68403BAA422D3D2EBF1CB8_4(this, LinesData.selectDefFBFB0E5EAC68403BAA422D3D2EBF1CB8(this, strPM_InOut_ID)), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_Org_ID@", "169", "258", "", dataField), Utility.getDefault(this, vars, "Boxnumber", "", "169", "258", "", dataField), Utility.getDefault(this, vars, "Ispagebreak", "N", "169", "258", "N", dataField), Utility.getDefault(this, vars, "CreatedBy", "", "169", "258", "", dataField), LinesData.selectDef3534_5(this, Utility.getDefault(this, vars, "CreatedBy", "", "169", "258", "", dataField)), Utility.getDefault(this, vars, "ZSE_Parcelno", "", "169", "258", "", dataField), Utility.getDefault(this, vars, "Upc", "", "169", "258", "", dataField), Utility.getDefault(this, vars, "Description", "", "169", "258", "", dataField), Utility.getDefault(this, vars, "ZSE_Parcelqty", "", "169", "258", "", dataField), Utility.getDefault(this, vars, "C_OrderLine_ID", "", "169", "258", "", dataField), LinesData.selectDef3811_6(this, Utility.getDefault(this, vars, "C_OrderLine_ID", "", "169", "258", "", dataField)), Utility.getDefault(this, vars, "M_AttributeSetInstance_ID", "", "169", "258", "", dataField), LinesData.selectDef8772_7(this, Utility.getDefault(this, vars, "M_AttributeSetInstance_ID", "", "169", "258", "", dataField)), LinesData.selectDefB219CD429DB14019BD3C1F903F141CD7(this, strPM_InOut_ID));
  ...
  private int saveRecord(VariablesSecureApp vars, OBError myError, char type, String strPM_InOut_ID) throws IOException, ServletException {
    ...
    if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        strSequence = vars.getStringParameter("inpnewdataseIdVal");
          ...
          CrudOperations.UpdateCustomFields(tabId, data.mInoutlineId, vars, this,con);
