...
String stradTableId = "319";
    ...
    } else if (vars.commandIn("BUTTONZSE_GetshippinginfoE64FA73B3BF44C4F86EEBA093EE36044")) {
        vars.setSessionValue("buttonE64FA73B3BF44C4F86EEBA093EE36044.strzseGetshippinginfo", vars.getStringParameter("inpzseGetshippinginfo"));
        vars.setSessionValue("buttonE64FA73B3BF44C4F86EEBA093EE36044.strProcessing", vars.getStringParameter("inpprocessing", "Y"));
        vars.setSessionValue("buttonE64FA73B3BF44C4F86EEBA093EE36044.strOrg", vars.getStringParameter("inpadOrgId"));
        vars.setSessionValue("buttonE64FA73B3BF44C4F86EEBA093EE36044.strClient", vars.getStringParameter("inpadClientId"));
        ...
        //Save in session needed params for combos if needed
        vars.setSessionObject("buttonE64FA73B3BF44C4F86EEBA093EE36044.originalParams", FieldProviderFactory.getFieldProvider(p));
        printPageButtonFS(response, vars, "E64FA73B3BF44C4F86EEBA093EE36044", request.getServletPath());
      } else if (vars.commandIn("BUTTONE64FA73B3BF44C4F86EEBA093EE36044")) {
        String strM_InOut_ID = vars.getGlobalVariable("inpmInoutId", windowId + "|M_InOut_ID", "");
        String strzseGetshippinginfo = vars.getSessionValue("buttonE64FA73B3BF44C4F86EEBA093EE36044.strzseGetshippinginfo");
        String strProcessing = vars.getSessionValue("buttonE64FA73B3BF44C4F86EEBA093EE36044.strProcessing");
        String strOrg = vars.getSessionValue("buttonE64FA73B3BF44C4F86EEBA093EE36044.strOrg");
        String strClient = vars.getSessionValue("buttonE64FA73B3BF44C4F86EEBA093EE36044.strClient");
        ...
        if ((org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) || !(Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),strClient)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),strOrg))){
          ...
          printPageButtonZSE_GetshippinginfoE64FA73B3BF44C4F86EEBA093EE36044(response, vars, strM_InOut_ID, strzseGetshippinginfo, strProcessing);
        }
    ...
    } else if (vars.commandIn("SAVE_BUTTONZSE_GetshippinginfoE64FA73B3BF44C4F86EEBA093EE36044")) {
        String strM_InOut_ID = vars.getGlobalVariable("inpKey", windowId + "|M_InOut_ID", "");
        
        ProcessBundle pb = new ProcessBundle("E64FA73B3BF44C4F86EEBA093EE36044", vars).init(this);
...
String strParamMovementDate_f = vars.getSessionValue(tabId + "|paramMovementDate_f");
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = GoodsMovementcustomerData.set(Utility.getDefault(this, vars, "UpdateLines", "N", "169", "257", "N", dataField), Utility.getDefault(this, vars, "Delivery_Location_ID", "", "169", "257", "", dataField), Utility.getDefault(this, vars, "GenerateTo", "", "169", "257", "N", dataField), Utility.getDefault(this, vars, "MovementType", "", "169", "257", "", dataField), Utility.getDefault(this, vars, "ChargeAmt", "0", "169", "257", "", dataField), Utility.getDefault(this, vars, "Posted", "", "169", "257", "N", dataField), (vars.getLanguage().equals("en_US")?ListData.selectName(this, "234", Utility.getDefault(this, vars, "Posted", "", "169", "257", "N", dataField)):ListData.selectNameTrl(this, vars.getLanguage(), "234", Utility.getDefault(this, vars, "Posted", "", "169", "257", "N", dataField))), Utility.getDefault(this, vars, "ZSE_Getshippinginfo", "", "169", "257", "N", dataField), Utility.getDefault(this, vars, "DeliveryViaRule", "", "169", "257", "", dataField), Utility.getDefault(this, vars, "AD_User_ID", "", "169", "257", "", dataField), Utility.getDefault(this, vars, "DocStatus", "DR", "169", "257", "", dataField), Utility.getDefault(this, vars, "Islogistic", "@ISLOGISTIC@", "169", "257", "N", dataField), Utility.getDefault(this, vars, "PickDate", "", "169", "257", "", dataField), Utility.getDefault(this, vars, "IsPrinted", "", "169", "257", "N", dataField), Utility.getDefault(this, vars, "C_Incoterms_ID", "", "169", "257", "", dataField), Utility.getDefault(this, vars, "Deliverylocationtext", "", "169", "257", "", dataField), Utility.getDefault(this, vars, "DeliveryRule", "A", "169", "257", "", dataField), Utility.getDefault(this, vars, "Qty", "", "169", "257", "", dataField), Utility.getDefault(this, vars, "C_BPartner_Location_ID", "", "169", "257", "", dataField), Utility.getDefault(this, vars, "C_Invoice_ID", "", "169", "257", "", dataField), Utility.getDefault(this, vars, "GenerateLines", "N", "169", "257", "N", dataField), Utility.getDefault(this, vars, "UpdatedBy", "", "169", "257", "", dataField), GoodsMovementcustomerData.selectDef3528_0(this, Utility.getDefault(this, vars, "UpdatedBy", "", "169", "257", "", dataField)), Utility.getDefault(this, vars, "ZSE_Shippingtype", "", "169", "257", "", dataField), Utility.getDefault(this, vars, "DateOrdered", "", "169", "257", "", dataField), Utility.getDefault(this, vars, "CreatedBy", "", "169", "257", "", dataField), GoodsMovementcustomerData.selectDef3526_1(this, Utility.getDefault(this, vars, "CreatedBy", "", "169", "257", "", dataField)), Utility.getDefault(this, vars, "shippingto", "", "169", "257", "", dataField), Utility.getDefault(this, vars, "C_Charge_ID", "", "169", "257", "", dataField), Utility.getDefault(this, vars, "Processed", "", "169", "257", "N", dataField), Utility.getDefault(this, vars, "Weight_Uom", "", "169", "257", "", dataField), Utility.getDefault(this, vars, "IsSOTrx", "@IsSOTrx@", "169", "257", "N", dataField), Utility.getDefault(this, vars, "DatePrinted", "", "169", "257", "", dataField), Utility.getDefault(this, vars, "Internalnote", "", "169", "257", "", dataField), "Y", Utility.getDefault(this, vars, "SalesRep_ID", "", "169", "257", "", dataField), Utility.getDefault(this, vars, "C_BPartner_ID", "", "169", "257", "", dataField), GoodsMovementcustomerData.selectDef3795_2(this, Utility.getDefault(this, vars, "C_BPartner_ID", "", "169", "257", "", dataField)), Utility.getDefault(this, vars, "CreateFrom", "", "169", "257", "N", dataField), Utility.getDefault(this, vars, "C_Projecttask_ID", "", "169", "257", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@#AD_Org_ID@", "169", "257", "", dataField), Utility.getDefault(this, vars, "TrackingNo", "", "169", "257", "", dataField), Utility.getDefault(this, vars, "C_Order_ID", "", "169", "257", "", dataField), GoodsMovementcustomerData.selectDef3809_3(this, Utility.getDefault(this, vars, "C_Order_ID", "", "169", "257", "", dataField)), Utility.getDefault(this, vars, "DateAcct", "@#Date@", "169", "257", "", dataField), Utility.getDefault(this, vars, "PriorityRule", "5", "169", "257", "", dataField), "", Utility.getDefault(this, vars, "FreightCostRule", "I", "169", "257", "", dataField), Utility.getDefault(this, vars, "M_Warehouse_ID", "", "169", "257", "", dataField), Utility.getDefault(this, vars, "Processing", "", "169", "257", "N", dataField), Utility.getDefault(this, vars, "Qtyofpallets", "", "169", "257", "", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "169", "257", "", dataField), Utility.getDefault(this, vars, "POReference", "", "169", "257", "", dataField), Utility.getDefault(this, vars, "M_Product_ID", "", "169", "257", "", dataField), Utility.getDefault(this, vars, "DocumentNo", "", "169", "257", "", dataField), Utility.getDefault(this, vars, "DocAction", "CO", "169", "257", "N", dataField), (vars.getLanguage().equals("en_US")?ListData.selectName(this, "135", Utility.getDefault(this, vars, "DocAction", "CO", "169", "257", "N", dataField)):ListData.selectNameTrl(this, vars.getLanguage(), "135", Utility.getDefault(this, vars, "DocAction", "CO", "169", "257", "N", dataField))), Utility.getDefault(this, vars, "C_Project_ID", "", "169", "257", "", dataField), GoodsMovementcustomerData.selectDef9585_4(this, Utility.getDefault(this, vars, "C_Project_ID", "", "169", "257", "", dataField)), Utility.getDefault(this, vars, "C_DocType_ID", "", "169", "257", "", dataField), Utility.getDefault(this, vars, "FreightAmt", "0", "169", "257", "", dataField), Utility.getDefault(this, vars, "MovementDate", "@#Date@", "169", "257", "", dataField), Utility.getDefault(this, vars, "Description", "", "169", "257", "", dataField), Utility.getDefault(this, vars, "M_Shipper_ID", "", "169", "257", "", dataField), Utility.getDefault(this, vars, "Weight", "", "169", "257", "", dataField), Utility.getDefault(this, vars, "ShipDate", "", "169", "257", "", dataField));
  ...
  void printPageButtonFS(HttpServletResponse response, VariablesSecureApp vars, String strProcessId, String path) throws IOException, ServletException {
    ...
    void printPageButtonZSE_GetshippinginfoE64FA73B3BF44C4F86EEBA093EE36044(HttpServletResponse response, VariablesSecureApp vars, String strM_InOut_ID, String strzseGetshippinginfo, String strProcessing)
    throws IOException, ServletException {
    ...
    Scripthelper script = new Scripthelper();
      ...
      try {
        String name= LocalizationUtils.getProcessTitle(this, "E64FA73B3BF44C4F86EEBA093EE36044",vars.getLanguage());
        String info = LocalizationUtils.getProcessInfo(this, "E64FA73B3BF44C4F86EEBA093EE36044" ,vars.getLanguage());
        if (! info.isEmpty())
          info = ConfigureInfobar.doConfigure(this, vars, script, info, "");
        
        String strFG="<table cellspacing=\"0\" cellpadding=\"0\" class=\"Form_Table\"> <colgroup span=\"4\"></colgroup><tr><td colspan=\"4\"></td></tr><tr><td></td></tr></table>";
        
        strFG=strFG + fh.prepareProcessParameters(this, vars, script,"E64FA73B3BF44C4F86EEBA093EE36044" );
        String isDocAction=UtilsData.isProcessDocAction(this, "E64FA73B3BF44C4F86EEBA093EE36044");
        
        String strSkeleton = ConfigurePopup.doConfigure(this,vars,script,name, "buttonok");
        
            String strActionButtons= "<table cellspacing=\"0\" cellpadding=\"0\" class=\"Form_Table\"> <colgroup span=\"4\"></colgroup><tr><td colspan=\"4\"></td></tr><tr>";
        
        String isJasper=UtilsData.isProcessJasper(this, "E64FA73B3BF44C4F86EEBA093EE36044");
        if (isJasper.equals("N"))
          strActionButtons= strActionButtons + ConfigureButton.doConfigure(this,vars,script,"buttonok",1,1,false, "ok",  "submitThisPage('SAVE_BUTTONZSE_Getshippinginfo" + "E64FA73B3BF44C4F86EEBA093EE36044" + "');", "","") + "";
        else
          strActionButtons= strActionButtons + ConfigureButton.doConfigure(this,vars,script,"buttonok",1,1,false, "ok",  "submitThisPageJasper();", "","") + "";
        strActionButtons= strActionButtons + ConfigureButton.doConfigure(this,vars,script,"buttonCancel",0,1,false, "cancel", "closeThisPage();", "","");
        ...
        script.addHiddenfield("inpadProcessId", "E64FA73B3BF44C4F86EEBA093EE36044");
        script.addHiddenfield("inpKey",strM_InOut_ID);
        script.addHiddenfield("inpprocessing",strProcessing);
        OBError myMessage = vars.getMessage("E64FA73B3BF44C4F86EEBA093EE36044");
        vars.removeMessage("E64FA73B3BF44C4F86EEBA093EE36044");
        if (myMessage!=null) {
          script.addMessage(this, vars, myMessage);
        }
        strOutput = script.doScript(strOutput, "",this,vars);
