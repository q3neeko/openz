...
PInstanceProcessData.insertPInstanceParam(this, pinstance, "10", "ad_field_v_id", stradFieldVId, vars.getClient(), vars.getOrg(), vars.getUser());
  ...
  private String getParentID(VariablesSecureApp vars, String strAD_Tab_ID) throws ServletException {
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|AD_Org_ID", data[0].getField("adOrgId"));    vars.setSessionValue(windowId + "|AD_Table_ID", data[0].getField("adTableId"));    vars.setSessionValue(windowId + "|AD_Tab_ID", data[0].getField("adTabId"));    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));
    }
  ...
  private int saveRecord(VariablesSecureApp vars, OBError myError, char type, String strPAD_Window_ID) throws IOException, ServletException {
    ...
    if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        strSequence = vars.getStringParameter("inpnewdataseIdVal");
          ...
          CrudOperations.UpdateCustomFields(tabId, data.adTabId, vars, this,con);
