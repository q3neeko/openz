...
String strParamStatementDate_f = vars.getSessionValue(tabId + "|paramStatementDate_f");
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = HeaderData.set(Utility.getDefault(this, vars, "EndingBalance", "", "198", "338", "", dataField), Utility.getDefault(this, vars, "BeginningBalance", "", "198", "338", "", dataField), Utility.getDefault(this, vars, "AD_OrgTrx_ID", "", "198", "338", "", dataField), Utility.getDefault(this, vars, "C_Activity_ID", "", "198", "338", "", dataField), Utility.getDefault(this, vars, "C_Project_ID", "", "198", "338", "", dataField), Utility.getDefault(this, vars, "C_Campaign_ID", "", "198", "338", "", dataField), "", Utility.getDefault(this, vars, "Name", "@#Date@", "198", "338", "", dataField), Utility.getDefault(this, vars, "StatementDifference", "", "198", "338", "", dataField), Utility.getDefault(this, vars, "User2_ID", "", "198", "338", "", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "198", "338", "", dataField), Utility.getDefault(this, vars, "Processing", "", "198", "338", "N", dataField), Utility.getDefault(this, vars, "DateAcct", "@#Date@", "198", "338", "", dataField), Utility.getDefault(this, vars, "Posted", "N", "198", "338", "N", dataField), (vars.getLanguage().equals("en_US")?ListData.selectName(this, "234", Utility.getDefault(this, vars, "Posted", "N", "198", "338", "N", dataField)):ListData.selectNameTrl(this, vars.getLanguage(), "234", Utility.getDefault(this, vars, "Posted", "N", "198", "338", "N", dataField))), Utility.getDefault(this, vars, "Processed", "", "198", "338", "N", dataField), (vars.getLanguage().equals("en_US")?ListData.selectName(this, "800024", Utility.getDefault(this, vars, "Processed", "", "198", "338", "N", dataField)):ListData.selectNameTrl(this, vars.getLanguage(), "800024", Utility.getDefault(this, vars, "Processed", "", "198", "338", "N", dataField))), Utility.getDefault(this, vars, "StatementDate", "@#Date@", "198", "338", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@#AD_Org_ID@", "198", "338", "", dataField), Utility.getDefault(this, vars, "C_CashBook_ID", "", "198", "338", "", dataField), "Y", Utility.getDefault(this, vars, "CreatedBy", "", "198", "338", "", dataField), HeaderData.selectDef5246_0(this, Utility.getDefault(this, vars, "CreatedBy", "", "198", "338", "", dataField)), Utility.getDefault(this, vars, "Description", "", "198", "338", "", dataField), Utility.getDefault(this, vars, "UpdatedBy", "", "198", "338", "", dataField), HeaderData.selectDef5248_1(this, Utility.getDefault(this, vars, "UpdatedBy", "", "198", "338", "", dataField)), Utility.getDefault(this, vars, "User1_ID", "", "198", "338", "", dataField));
  ...
  private int saveRecord(VariablesSecureApp vars, OBError myError, char type) throws IOException, ServletException {
    ...
    if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        strSequence = vars.getStringParameter("inpnewdataseIdVal");
          ...
          CrudOperations.UpdateCustomFields(tabId, data.cCashId, vars, this,con);
