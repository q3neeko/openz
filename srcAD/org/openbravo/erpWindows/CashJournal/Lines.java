...
String strdateplanned = vars.getDateParameter("inpdateplanned", this);
...
String strParamAmount_f = vars.getSessionValue(tabId + "|paramAmount_f");
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = LinesData.set(strPC_Cash_ID, "", Utility.getDefault(this, vars, "AD_Org_ID", "@AD_Org_ID@", "198", "339", "", dataField), Utility.getDefault(this, vars, "UpdatedBy", "", "198", "339", "", dataField), LinesData.selectDef5290_0(this, Utility.getDefault(this, vars, "UpdatedBy", "", "198", "339", "", dataField)), Utility.getDefault(this, vars, "IsGenerated", "N", "198", "339", "N", dataField), Utility.getDefault(this, vars, "WriteOffAmt", "", "198", "339", "", dataField), LinesData.selectDef6673(this, Utility.getContext(this, vars, "C_CashBook_ID", "198")), Utility.getDefault(this, vars, "C_Charge_ID", "", "198", "339", "", dataField), Utility.getDefault(this, vars, "DiscountAmt", "", "198", "339", "", dataField), Utility.getDefault(this, vars, "Description", "", "198", "339", "", dataField), Utility.getDefault(this, vars, "C_Debt_Payment_ID", "", "198", "339", "", dataField), LinesData.selectDef800405_1(this, Utility.getDefault(this, vars, "C_Debt_Payment_ID", "", "198", "339", "", dataField)), Utility.getDefault(this, vars, "PayInAdvance", "", "198", "339", "N", dataField), Utility.getDefault(this, vars, "Created", "", "198", "339", "", dataField), "Y", Utility.getDefault(this, vars, "CreatedBy", "", "198", "339", "", dataField), LinesData.selectDef5288_2(this, Utility.getDefault(this, vars, "CreatedBy", "", "198", "339", "", dataField)), Utility.getDefault(this, vars, "C_Glitem_ID", "", "198", "339", "", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "198", "339", "", dataField), Utility.getDefault(this, vars, "Amount", "", "198", "339", "", dataField), Utility.getDefault(this, vars, "CashType", "E", "198", "339", "", dataField), LinesData.selectDef5292(this, strPC_Cash_ID), Utility.getDefault(this, vars, "C_Order_ID", "", "198", "339", "", dataField), LinesData.selectDef800209_3(this, Utility.getDefault(this, vars, "C_Order_ID", "", "198", "339", "", dataField)));
  ...
  private int saveRecord(VariablesSecureApp vars, OBError myError, char type, String strPC_Cash_ID) throws IOException, ServletException {
    ...
    if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        strSequence = vars.getStringParameter("inpnewdataseIdVal");
          ...
          CrudOperations.UpdateCustomFields(tabId, data.cCashlineId, vars, this,con);
