  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strC_Tax_Trl_ID, String strPC_Tax_ID, TableSQLData tableSQL)
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = TranslationData.set(strPC_Tax_ID, Utility.getDefault(this, vars, "IsTranslated", "", "137", "458", "N", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "137", "458", "", dataField), Utility.getDefault(this, vars, "CreatedBy", "", "137", "458", "", dataField), TranslationData.selectDef8207_0(this, Utility.getDefault(this, vars, "CreatedBy", "", "137", "458", "", dataField)), "Y", Utility.getDefault(this, vars, "UpdatedBy", "", "137", "458", "", dataField), TranslationData.selectDef8200_1(this, Utility.getDefault(this, vars, "UpdatedBy", "", "137", "458", "", dataField)), Utility.getDefault(this, vars, "AD_Language", "", "137", "458", "", dataField), Utility.getDefault(this, vars, "Description", "", "137", "458", "", dataField), "", Utility.getDefault(this, vars, "Name", "", "137", "458", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_Org_ID@", "137", "458", "", dataField), Utility.getDefault(this, vars, "Taxhint", "", "137", "458", "", dataField));
  ...
  private int saveRecord(VariablesSecureApp vars, OBError myError, char type, String strPC_Tax_ID) throws IOException, ServletException {
    ...
    if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        strSequence = vars.getStringParameter("inpnewdataseIdVal");
          ...
          CrudOperations.UpdateCustomFields(tabId, data.cTaxTrlId, vars, this,con);
