...
public class Tax extends HttpSecureAppServlet {
  ...
  private TaxData getEditVariables(Connection con, VariablesSecureApp vars) throws IOException,ServletException {
    ...
    try {
    data.adOrgId = vars.getRequestGlobalVariable("inpadOrgId", windowId + "|AD_Org_ID");     data.adOrgIdr = vars.getStringParameter("inpadOrgId_R");     data.name = vars.getStringParameter("inpname");     data.description = vars.getStringParameter("inpdescription");     data.taxhint = vars.getStringParameter("inptaxhint");     data.isactive = vars.getStringParameter("inpisactive", "N");     data.validfrom = vars.getDateParameter("inpvalidfrom",this);    try {   data.rate = vars.getNumericParameter("inprate");  } catch (ServletException paramEx) { ex = paramEx; }     data.reversecharge = vars.getStringParameter("inpreversecharge", "N");     data.adduid2fact = vars.getStringParameter("inpadduid2fact", "N");     data.cCountryId = vars.getStringParameter("inpcCountryId");     data.cCountryIdr = vars.getStringParameter("inpcCountryId_R");     data.datevkeyvst = vars.getStringParameter("inpdatevkeyvst");     data.datevkeyust = vars.getStringParameter("inpdatevkeyust");     data.isnotaxable = vars.getStringParameter("inpisnotaxable", "N");     data.isrevenueexpensefromproduct = vars.getStringParameter("inpisrevenueexpensefromproduct", "N");     data.isexpensefromproduct = vars.getStringParameter("inpisexpensefromproduct", "N");     data.isdefault = vars.getStringParameter("inpisdefault", "N");    try {   data.line = vars.getNumericParameter("inpline");  } catch (ServletException paramEx) { ex = paramEx; }     data.istaxexempt = vars.getStringParameter("inpistaxexempt", "N");     data.issummary = vars.getStringParameter("inpissummary", "N");     data.iswithholdingtax = vars.getStringParameter("inpiswithholdingtax", "N");     data.sopotype = vars.getStringParameter("inpsopotype");     data.cTaxId = vars.getRequestGlobalVariable("inpcTaxId", windowId + "|C_Tax_ID");     data.adClientId = vars.getRequestGlobalVariable("inpadClientId", windowId + "|AD_Client_ID");    try {   data.deducpercent = vars.getNumericParameter("inpdeducpercent");  } catch (ServletException paramEx) { ex = paramEx; }     data.isnovat = vars.getStringParameter("inpisnovat", "N");    try {   data.originalrate = vars.getNumericParameter("inporiginalrate");  } catch (ServletException paramEx) { ex = paramEx; }     data.istaxundeductable = vars.getStringParameter("inpistaxundeductable", "N");     data.cRegionId = vars.getStringParameter("inpcRegionId");     data.toCountryId = vars.getStringParameter("inptoCountryId");     data.toRegionId = vars.getStringParameter("inptoRegionId");     data.cascade = vars.getStringParameter("inpcascade", "N"); 
   ...
   private TaxData[] getRelationData(TaxData[] data) {
    if (data!=null) {
      for (int i=0;i<data.length;i++) {        data[i].adOrgId = FormatUtilities.truncate(data[i].adOrgId, 44);        data[i].name = FormatUtilities.truncate(data[i].name, 50);        data[i].description = FormatUtilities.truncate(data[i].description, 50);        data[i].taxhint = FormatUtilities.truncate(data[i].taxhint, 50);        data[i].cCountryId = FormatUtilities.truncate(data[i].cCountryId, 44);        data[i].datevkeyvst = FormatUtilities.truncate(data[i].datevkeyvst, 2);        data[i].datevkeyust = FormatUtilities.truncate(data[i].datevkeyust, 2);        data[i].sopotype = FormatUtilities.truncate(data[i].sopotype, 21);        data[i].cTaxId = FormatUtilities.truncate(data[i].cTaxId, 10);        data[i].adClientId = FormatUtilities.truncate(data[i].adClientId, 44);        data[i].cRegionId = FormatUtilities.truncate(data[i].cRegionId, 44);        data[i].toCountryId = FormatUtilities.truncate(data[i].toCountryId, 44);        data[i].toRegionId = FormatUtilities.truncate(data[i].toRegionId, 44);}
    }
    return data;
  }
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|AD_Org_ID", data[0].getField("adOrgId"));    vars.setSessionValue(windowId + "|C_Tax_ID", data[0].getField("cTaxId"));    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));
    }
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strC_Tax_ID, TableSQLData tableSQL)
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = TaxData.set(Utility.getDefault(this, vars, "IsDefault", "", "137", "174", "N", dataField), Utility.getDefault(this, vars, "Adduid2fact", "N", "137", "174", "N", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "137", "174", "", dataField), Utility.getDefault(this, vars, "C_Region_ID", "", "137", "174", "", dataField), Utility.getDefault(this, vars, "Originalrate", "", "137", "174", "", dataField), Utility.getDefault(this, vars, "Deducpercent", "", "137", "174", "", dataField), Utility.getDefault(this, vars, "Taxhint", "", "137", "174", "", dataField), Utility.getDefault(this, vars, "CreatedBy", "", "137", "174", "", dataField), TaxData.selectDef2245_0(this, Utility.getDefault(this, vars, "CreatedBy", "", "137", "174", "", dataField)), Utility.getDefault(this, vars, "Datevkeyvst", "", "137", "174", "", dataField), Utility.getDefault(this, vars, "To_Country_ID", "", "137", "174", "", dataField), Utility.getDefault(this, vars, "Isexpensefromproduct", "N", "137", "174", "N", dataField), "Y", Utility.getDefault(this, vars, "Isrevenueexpensefromproduct", "N", "137", "174", "N", dataField), Utility.getDefault(this, vars, "To_Region_ID", "", "137", "174", "", dataField), Utility.getDefault(this, vars, "IsNoTaxable", "", "137", "174", "N", dataField), Utility.getDefault(this, vars, "Reversecharge", "N", "137", "174", "N", dataField), Utility.getDefault(this, vars, "Datevkeyust", "", "137", "174", "", dataField), Utility.getDefault(this, vars, "Line", "10", "137", "174", "", dataField), Utility.getDefault(this, vars, "Rate", "", "137", "174", "", dataField), Utility.getDefault(this, vars, "Cascade", "N", "137", "174", "N", dataField), Utility.getDefault(this, vars, "ValidFrom", "", "137", "174", "", dataField), Utility.getDefault(this, vars, "IsTaxExempt", "", "137", "174", "N", dataField), Utility.getDefault(this, vars, "SOPOType", "B", "137", "174", "", dataField), "", Utility.getDefault(this, vars, "IsTaxUndeductable", "N", "137", "174", "N", dataField), Utility.getDefault(this, vars, "IsNoVAT", "N", "137", "174", "N", dataField), Utility.getDefault(this, vars, "IsSummary", "", "137", "174", "N", dataField), Utility.getDefault(this, vars, "Created", "", "137", "174", "", dataField), Utility.getDefault(this, vars, "IsWithholdingTax", "", "137", "174", "N", dataField), Utility.getDefault(this, vars, "Name", "", "137", "174", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_Org_ID@", "137", "174", "", dataField), Utility.getDefault(this, vars, "UpdatedBy", "", "137", "174", "", dataField), TaxData.selectDef2277_1(this, Utility.getDefault(this, vars, "UpdatedBy", "", "137", "174", "", dataField)), Utility.getDefault(this, vars, "Description", "", "137", "174", "", dataField), Utility.getDefault(this, vars, "C_Country_ID", "", "137", "174", "", dataField));
  ...
  private int saveRecord(VariablesSecureApp vars, OBError myError, char type) throws IOException, ServletException {
    ...
    if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        strSequence = vars.getStringParameter("inpnewdataseIdVal");
          ...
          CrudOperations.UpdateCustomFields(tabId, data.cTaxId, vars, this,con);
