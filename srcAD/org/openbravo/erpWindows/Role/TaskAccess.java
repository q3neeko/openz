  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strAD_Task_Access_ID, String strPAD_Role_ID, TableSQLData tableSQL)
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = TaskAccessData.set(strPAD_Role_ID, Utility.getDefault(this, vars, "AD_Org_ID", "@AD_Org_ID@", "111", "313", "", dataField), "Y", Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "111", "313", "", dataField), Utility.getDefault(this, vars, "IsReadWrite", "", "111", "313", "N", dataField), "", Utility.getDefault(this, vars, "CreatedBy", "", "111", "313", "", dataField), TaskAccessData.selectDef1312_0(this, Utility.getDefault(this, vars, "CreatedBy", "", "111", "313", "", dataField)), Utility.getDefault(this, vars, "AD_Task_ID", "", "111", "313", "", dataField), Utility.getDefault(this, vars, "UpdatedBy", "", "111", "313", "", dataField), TaskAccessData.selectDef1314_1(this, Utility.getDefault(this, vars, "UpdatedBy", "", "111", "313", "", dataField)));
  ...
  private int saveRecord(VariablesSecureApp vars, OBError myError, char type, String strPAD_Role_ID) throws IOException, ServletException {
    ...
    if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        strSequence = vars.getStringParameter("inpnewdataseIdVal");
          ...
          CrudOperations.UpdateCustomFields(tabId, data.adTaskAccessId, vars, this,con);
