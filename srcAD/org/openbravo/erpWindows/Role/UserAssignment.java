...
vars.getGlobalVariable("inpadRoleId", windowId + "|AD_Role_ID");
  ...
  private UserAssignmentData getEditVariables(Connection con, VariablesSecureApp vars, String strPAD_Role_ID) throws IOException,ServletException {
    ...
    try {
    data.adUserRolesId = vars.getRequestGlobalVariable("inpadUserRolesId", windowId + "|AD_User_Roles_ID");     data.adClientId = vars.getRequestGlobalVariable("inpadClientId", windowId + "|AD_Client_ID");     data.adOrgId = vars.getRequestGlobalVariable("inpadOrgId", windowId + "|AD_Org_ID");     data.adOrgIdr = vars.getStringParameter("inpadOrgId_R");     data.adRoleId = vars.getStringParameter("inpadRoleId");     data.adRoleIdr = vars.getStringParameter("inpadRoleId_R");     data.adUserId = vars.getStringParameter("inpadUserId");     data.adUserIdr = vars.getStringParameter("inpadUserId_R");     data.isactive = vars.getStringParameter("inpisactive", "N"); 
  ...
  private int saveRecord(VariablesSecureApp vars, OBError myError, char type, String strPAD_Role_ID) throws IOException, ServletException {
    ...
    if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        strSequence = vars.getStringParameter("inpnewdataseIdVal");
          ...
          CrudOperations.UpdateCustomFields(tabId, data.adUserRolesId, vars, this,con);
