...
public class AttributeValue extends HttpSecureAppServlet {
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      vars.setSessionValue(windowId + "|M_Attribute_ID", strPM_Attribute_ID);
      vars.setSessionValue("462|Attributes.view", "EDIT");
...
vars.getGlobalVariable("inpmAttributeId", windowId + "|M_Attribute_ID");
  ...
  private void refreshParentSession(VariablesSecureApp vars, String strPM_Attribute_ID) throws IOException,ServletException {
      AttributesData[] data = AttributesData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPM_Attribute_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|AD_Client_ID", data[0].adClientId);    vars.setSessionValue(windowId + "|AD_Org_ID", data[0].adOrgId);    vars.setSessionValue(windowId + "|IsList", data[0].islist);    vars.setSessionValue(windowId + "|M_Attribute_ID", data[0].mAttributeId);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strM_AttributeValue_ID, String strPM_Attribute_ID, TableSQLData tableSQL)
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = AttributeValueData.set(strPM_Attribute_ID, Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "260", "463", "", dataField), Utility.getDefault(this, vars, "Name", "", "260", "463", "", dataField), Utility.getDefault(this, vars, "CreatedBy", "", "260", "463", "", dataField), AttributeValueData.selectDef8461_0(this, Utility.getDefault(this, vars, "CreatedBy", "", "260", "463", "", dataField)), Utility.getDefault(this, vars, "Description", "", "260", "463", "", dataField), "Y", Utility.getDefault(this, vars, "UpdatedBy", "", "260", "463", "", dataField), AttributeValueData.selectDef8462_1(this, Utility.getDefault(this, vars, "UpdatedBy", "", "260", "463", "", dataField)), "", Utility.getDefault(this, vars, "AD_Org_ID", "@AD_Org_ID@", "260", "463", "", dataField), Utility.getDefault(this, vars, "Value", "", "260", "463", "", dataField));
    ...
    String currentPOrg=AttributesData.selectOrg(this, strPM_Attribute_ID);
  ...
  private int saveRecord(VariablesSecureApp vars, OBError myError, char type, String strPM_Attribute_ID) throws IOException, ServletException {
    ...
    if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        strSequence = vars.getStringParameter("inpnewdataseIdVal");
          ...
          CrudOperations.UpdateCustomFields(tabId, data.mAttributevalueId, vars, this,con);
