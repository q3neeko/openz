  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strAD_Workflow_Trl_ID, String strPAD_Workflow_ID, TableSQLData tableSQL)
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = WorkflowTranslationData.set(strPAD_Workflow_ID, Utility.getDefault(this, vars, "Help", "", "113", "149", "", dataField), Utility.getDefault(this, vars, "IsTranslated", "", "113", "149", "N", dataField), "Y", "0", Utility.getDefault(this, vars, "Description", "", "113", "149", "", dataField), Utility.getDefault(this, vars, "AD_Language", "", "113", "149", "", dataField), Utility.getDefault(this, vars, "CreatedBy", "", "113", "149", "", dataField), WorkflowTranslationData.selectDef703_0(this, Utility.getDefault(this, vars, "CreatedBy", "", "113", "149", "", dataField)), Utility.getDefault(this, vars, "Name", "", "113", "149", "", dataField), Utility.getDefault(this, vars, "UpdatedBy", "", "113", "149", "", dataField), WorkflowTranslationData.selectDef705_1(this, Utility.getDefault(this, vars, "UpdatedBy", "", "113", "149", "", dataField)), "", Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "113", "149", "", dataField));
  ...
  private int saveRecord(VariablesSecureApp vars, OBError myError, char type, String strPAD_Workflow_ID) throws IOException, ServletException {
    ...
    if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        strSequence = vars.getStringParameter("inpnewdataseIdVal");
          ...
          CrudOperations.UpdateCustomFields(tabId, data.adWorkflowTrlId, vars, this,con);
