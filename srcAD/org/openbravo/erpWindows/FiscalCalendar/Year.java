  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strC_Year_ID, String strPC_Calendar_ID, TableSQLData tableSQL)
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = YearData.set(strPC_Calendar_ID, Utility.getDefault(this, vars, "Description", "", "117", "129", "", dataField), "Y", Utility.getDefault(this, vars, "AD_Org_ID", "0", "117", "129", "", dataField), Utility.getDefault(this, vars, "Year", "", "117", "129", "", dataField), Utility.getDefault(this, vars, "Processing", "N", "117", "129", "N", dataField), Utility.getDefault(this, vars, "CreatedBy", "", "117", "129", "", dataField), YearData.selectDef1035_0(this, Utility.getDefault(this, vars, "CreatedBy", "", "117", "129", "", dataField)), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "117", "129", "", dataField), Utility.getDefault(this, vars, "UpdatedBy", "", "117", "129", "", dataField), YearData.selectDef1037_1(this, Utility.getDefault(this, vars, "UpdatedBy", "", "117", "129", "", dataField)), "");
  ...
  private int saveRecord(VariablesSecureApp vars, OBError myError, char type, String strPC_Calendar_ID) throws IOException, ServletException {
    ...
    if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        strSequence = vars.getStringParameter("inpnewdataseIdVal");
          ...
          CrudOperations.UpdateCustomFields(tabId, data.cYearId, vars, this,con);
