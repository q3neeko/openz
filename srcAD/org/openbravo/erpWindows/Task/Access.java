  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strAD_Task_Access_ID, String strPAD_Task_ID, TableSQLData tableSQL)
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = AccessData.set(strPAD_Task_ID, Utility.getDefault(this, vars, "AD_Org_ID", "@AD_Org_ID@", "114", "310", "", dataField), "Y", Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "114", "310", "", dataField), Utility.getDefault(this, vars, "IsReadWrite", "", "114", "310", "N", dataField), "", Utility.getDefault(this, vars, "AD_Role_ID", "", "114", "310", "", dataField), Utility.getDefault(this, vars, "CreatedBy", "", "114", "310", "", dataField), AccessData.selectDef1312_0(this, Utility.getDefault(this, vars, "CreatedBy", "", "114", "310", "", dataField)), Utility.getDefault(this, vars, "UpdatedBy", "", "114", "310", "", dataField), AccessData.selectDef1314_1(this, Utility.getDefault(this, vars, "UpdatedBy", "", "114", "310", "", dataField)));
