...
String strParamMovementDate_f = vars.getSessionValue(tabId + "|paramMovementDate_f");
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = HeaderData.set(Utility.getDefault(this, vars, "UpdateQty", "", "168", "255", "N", dataField), Utility.getDefault(this, vars, "CreatedBy", "", "168", "255", "", dataField), HeaderData.selectDef3547_0(this, Utility.getDefault(this, vars, "CreatedBy", "", "168", "255", "", dataField)), Utility.getDefault(this, vars, "UpdatedBy", "", "168", "255", "", dataField), HeaderData.selectDef3549_1(this, Utility.getDefault(this, vars, "UpdatedBy", "", "168", "255", "", dataField)), Utility.getDefault(this, vars, "Posted", "", "168", "255", "N", dataField), (vars.getLanguage().equals("en_US")?ListData.selectName(this, "234", Utility.getDefault(this, vars, "Posted", "", "168", "255", "N", dataField)):ListData.selectNameTrl(this, vars.getLanguage(), "234", Utility.getDefault(this, vars, "Posted", "", "168", "255", "N", dataField))), "", Utility.getDefault(this, vars, "M_PerpetualInv_ID", "", "168", "255", "", dataField), Utility.getDefault(this, vars, "GenerateList", "", "168", "255", "N", dataField), Utility.getDefault(this, vars, "Description", "", "168", "255", "", dataField), Utility.getDefault(this, vars, "User2_ID", "", "168", "255", "", dataField), Utility.getDefault(this, vars, "Processing", "", "168", "255", "N", dataField), Utility.getDefault(this, vars, "M_Warehouse_ID", "", "168", "255", "", dataField), Utility.getDefault(this, vars, "C_Activity_ID", "", "168", "255", "", dataField), Utility.getDefault(this, vars, "C_Campaign_ID", "", "168", "255", "", dataField), Utility.getDefault(this, vars, "MovementDate", "@#Date@", "168", "255", "", dataField), Utility.getDefault(this, vars, "Processed", "", "168", "255", "N", dataField), Utility.getDefault(this, vars, "AD_OrgTrx_ID", "", "168", "255", "", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "168", "255", "", dataField), Utility.getDefault(this, vars, "User1_ID", "", "168", "255", "", dataField), Utility.getDefault(this, vars, "C_Project_ID", "", "168", "255", "", dataField), HeaderData.selectDef9592_2(this, Utility.getDefault(this, vars, "C_Project_ID", "", "168", "255", "", dataField)), "Y", Utility.getDefault(this, vars, "AD_Org_ID", "@AD_Org_ID@", "168", "255", "", dataField), Utility.getDefault(this, vars, "Name", "@#Date@", "168", "255", "", dataField));
  ...
  private int saveRecord(VariablesSecureApp vars, OBError myError, char type) throws IOException, ServletException {
    ...
    if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        strSequence = vars.getStringParameter("inpnewdataseIdVal");
          ...
          CrudOperations.UpdateCustomFields(tabId, data.mInventoryId, vars, this,con);
