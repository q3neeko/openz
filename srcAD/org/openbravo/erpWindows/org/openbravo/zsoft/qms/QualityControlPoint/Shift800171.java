...
vars.getGlobalVariable("inpmaCcpGroupId", windowId + "|MA_CCP_Group_ID");
  ...
  private Shift800171Data getEditVariables(Connection con, VariablesSecureApp vars, String strPMA_CCP_Group_ID) throws IOException,ServletException {
    ...
    try {
    data.maCcpShiftId = vars.getRequestGlobalVariable("inpmaCcpShiftId", windowId + "|MA_Ccp_Shift_ID");     data.adClientId = vars.getRequestGlobalVariable("inpadClientId", windowId + "|AD_Client_ID");     data.adOrgId = vars.getRequestGlobalVariable("inpadOrgId", windowId + "|AD_Org_ID");     data.adOrgIdr = vars.getStringParameter("inpadOrgId_R");     data.maCcpGroupId = vars.getStringParameter("inpmaCcpGroupId");     data.maCcpGroupIdr = vars.getStringParameter("inpmaCcpGroupId_R");     data.isactive = vars.getStringParameter("inpisactive", "N");     data.shift = vars.getStringParameter("inpshift");     data.shiftr = vars.getStringParameter("inpshift_R");     data.starttime = vars.getDateParameter("inpstarttime",this);     data.endtime = vars.getDateParameter("inpendtime",this); 
...
String strParamShift = vars.getSessionValue(tabId + "|paramShift");
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = Shift800171Data.set(strPMA_CCP_Group_ID, Utility.getDefault(this, vars, "Updatedby", "", "800063", "800171", "", dataField), Shift800171Data.selectDef802496_0(this, Utility.getDefault(this, vars, "Updatedby", "", "800063", "800171", "", dataField)), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "800063", "800171", "", dataField), Utility.getDefault(this, vars, "Shift", "", "800063", "800171", "", dataField), Utility.getDefault(this, vars, "Createdby", "", "800063", "800171", "", dataField), Shift800171Data.selectDef802494_1(this, Utility.getDefault(this, vars, "Createdby", "", "800063", "800171", "", dataField)), "", Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "800063", "800171", "", dataField), Utility.getDefault(this, vars, "Starttime", "", "800063", "800171", "", dataField), Utility.getDefault(this, vars, "Endtime", "", "800063", "800171", "", dataField), "Y");
  ...
  private int saveRecord(VariablesSecureApp vars, OBError myError, char type, String strPMA_CCP_Group_ID) throws IOException, ServletException {
    ...
    if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        strSequence = vars.getStringParameter("inpnewdataseIdVal");
          ...
          CrudOperations.UpdateCustomFields(tabId, data.maCcpShiftId, vars, this,con);
