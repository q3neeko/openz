...
String strParamSeqNo_f = vars.getSessionValue(tabId + "|paramSeqNo_f");
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = Operation800112Data.set(strPMA_Workrequirement_ID, Utility.getDefault(this, vars, "Createdby", "", "800052", "800112", "", dataField), Operation800112Data.selectDef801569_0(this, Utility.getDefault(this, vars, "Createdby", "", "800052", "800112", "", dataField)), "", Utility.getDefault(this, vars, "Preptime", "", "800052", "800112", "", dataField), Utility.getDefault(this, vars, "Groupuse", "N", "800052", "800112", "N", dataField), Utility.getDefault(this, vars, "Name", "", "800052", "800112", "", dataField), Utility.getDefault(this, vars, "Closed", "N", "800052", "800112", "N", dataField), "Y", Utility.getDefault(this, vars, "Outsourced", "", "800052", "800112", "N", dataField), Operation800112Data.selectDef801759(this, strPMA_Workrequirement_ID), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "800052", "800112", "", dataField), Utility.getDefault(this, vars, "MA_Process_ID", "", "800052", "800112", "", dataField), Utility.getDefault(this, vars, "CostCenterUse", "", "800052", "800112", "", dataField), Utility.getDefault(this, vars, "MA_Sequence_ID", "", "800052", "800112", "", dataField), Utility.getDefault(this, vars, "Noqty", "N", "800052", "800112", "N", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "800052", "800112", "", dataField), Utility.getDefault(this, vars, "Quantity", "", "800052", "800112", "", dataField), Utility.getDefault(this, vars, "Description", "", "800052", "800112", "", dataField), Utility.getDefault(this, vars, "Donequantity", "", "800052", "800112", "", dataField), Utility.getDefault(this, vars, "Updatedby", "", "800052", "800112", "", dataField), Operation800112Data.selectDef801571_1(this, Utility.getDefault(this, vars, "Updatedby", "", "800052", "800112", "", dataField)));
  ...
  private int saveRecord(VariablesSecureApp vars, OBError myError, char type, String strPMA_Workrequirement_ID) throws IOException, ServletException {
    ...
    if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        strSequence = vars.getStringParameter("inpnewdataseIdVal");
          ...
          CrudOperations.UpdateCustomFields(tabId, data.maWrphaseId, vars, this,con);
