  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strMRP_Run_Purchase_ID, TableSQLData tableSQL)
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = Header800258Data.set(Utility.getDefault(this, vars, "Isfirstneed", "N", "800097", "800258", "N", dataField), Utility.getDefault(this, vars, "Simulate", "N", "800097", "800258", "N", dataField), Header800258Data.selectDef803659(this), Utility.getDefault(this, vars, "Updatedby", "", "800097", "800258", "", dataField), Header800258Data.selectDef803651_0(this, Utility.getDefault(this, vars, "Updatedby", "", "800097", "800258", "", dataField)), Utility.getDefault(this, vars, "Vendor_ID", "", "800097", "800258", "", dataField), Utility.getDefault(this, vars, "Description", "", "800097", "800258", "", dataField), Utility.getDefault(this, vars, "M_Product_ID", "", "800097", "800258", "", dataField), Header800258Data.selectDef803658_1(this, Utility.getDefault(this, vars, "M_Product_ID", "", "800097", "800258", "", dataField)), Utility.getDefault(this, vars, "Launchpo", "N", "800097", "800258", "N", dataField), Utility.getDefault(this, vars, "DateDoc", "@#Date@", "800097", "800258", "", dataField), Utility.getDefault(this, vars, "Createdby", "", "800097", "800258", "", dataField), Header800258Data.selectDef803649_2(this, Utility.getDefault(this, vars, "Createdby", "", "800097", "800258", "", dataField)), Utility.getDefault(this, vars, "Securitymargin", "0", "800097", "800258", "", dataField), Header800258Data.selectDef803657(this), Utility.getDefault(this, vars, "Timehorizon", "", "800097", "800258", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "800097", "800258", "", dataField), Utility.getDefault(this, vars, "MRP_Planner_ID", "", "800097", "800258", "", dataField), Utility.getDefault(this, vars, "C_BPartner_ID", "", "800097", "800258", "", dataField), Header800258Data.selectDef803660_3(this, Utility.getDefault(this, vars, "C_BPartner_ID", "", "800097", "800258", "", dataField)), "", Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "800097", "800258", "", dataField), "Y", Header800258Data.selectDefF5D6CA9B312D45F187C049EA4D5CD21D(this), Utility.getDefault(this, vars, "Name", "@#DATE@", "800097", "800258", "", dataField));
  ...
  private int saveRecord(VariablesSecureApp vars, OBError myError, char type) throws IOException, ServletException {
    ...
    if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        strSequence = vars.getStringParameter("inpnewdataseIdVal");
          ...
          CrudOperations.UpdateCustomFields(tabId, data.mrpRunPurchaseId, vars, this,con);
