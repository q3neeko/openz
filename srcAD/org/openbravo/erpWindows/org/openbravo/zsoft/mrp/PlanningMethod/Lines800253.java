...
String strParamDaysto_f = vars.getSessionValue(tabId + "|paramDaysto_f");
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = Lines800253Data.set(strPMRP_Planningmethod_ID, "", Utility.getDefault(this, vars, "Createdby", "", "800094", "800253", "", dataField), Lines800253Data.selectDef803574_0(this, Utility.getDefault(this, vars, "Createdby", "", "800094", "800253", "", dataField)), Utility.getDefault(this, vars, "Daysto", "", "800094", "800253", "", dataField), Utility.getDefault(this, vars, "Inouttrxtype", "", "800094", "800253", "", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "800094", "800253", "", dataField), Utility.getDefault(this, vars, "Updatedby", "", "800094", "800253", "", dataField), Lines800253Data.selectDef803576_1(this, Utility.getDefault(this, vars, "Updatedby", "", "800094", "800253", "", dataField)), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "800094", "800253", "", dataField), Utility.getDefault(this, vars, "Weighting", "1", "800094", "800253", "", dataField), Lines800253Data.selectDef803578(this, Utility.getContext(this, vars, "MRP_Planningmethodline_ID", "800094")), "Y", Utility.getDefault(this, vars, "Daysfrom", "", "800094", "800253", "", dataField));
  ...
  private int saveRecord(VariablesSecureApp vars, OBError myError, char type, String strPMRP_Planningmethod_ID) throws IOException, ServletException {
    ...
    if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        strSequence = vars.getStringParameter("inpnewdataseIdVal");
          ...
          CrudOperations.UpdateCustomFields(tabId, data.mrpPlanningmethodlineId, vars, this,con);
