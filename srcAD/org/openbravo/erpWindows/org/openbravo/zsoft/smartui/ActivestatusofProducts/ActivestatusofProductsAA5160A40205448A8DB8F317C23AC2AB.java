...
public class ActivestatusofProductsAA5160A40205448A8DB8F317C23AC2AB extends HttpSecureAppServlet {
  private static final long serialVersionUID = 1L;
  
  private static Logger log4j = Logger.getLogger(ActivestatusofProductsAA5160A40205448A8DB8F317C23AC2AB.class);
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strView = vars.getSessionValue(tabId + "|ActivestatusofProductsAA5160A40205448A8DB8F317C23AC2AB.view");
      if (strView.equals("")) {
      ...
      if (vars.commandIn("DIRECT")){
        vars.setSessionValue(tabId + "|ActivestatusofProductsAA5160A40205448A8DB8F317C23AC2AB.view", "EDIT");

        printPageEdit(response, request, vars, false, strM_Product_ID, tableSQL);
      }
      if (vars.commandIn("DIRECTRELATION")){
        vars.setSessionValue(tabId + "|ActivestatusofProductsAA5160A40205448A8DB8F317C23AC2AB.view", "RELATION");
      ...
      if (strView.equals("EDIT")) {
        ...
        if (strM_Product_ID.equals("")) {
          ...
          vars.setSessionValue(tabId + "|ActivestatusofProductsAA5160A40205448A8DB8F317C23AC2AB.view", strView);
        }
      }
      ...
      vars.setSessionValue(tabId + "|ActivestatusofProductsAA5160A40205448A8DB8F317C23AC2AB.initRecordNumber", "0");
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
    } else if (vars.commandIn("PREVIOUS_RELATION")) {

      String strInitRecord = vars.getSessionValue(tabId + "|ActivestatusofProductsAA5160A40205448A8DB8F317C23AC2AB.initRecordNumber");
      ...
      if (strInitRecord.equals("") || strInitRecord.equals("0")) {
        ...
        vars.setSessionValue(tabId + "|ActivestatusofProductsAA5160A40205448A8DB8F317C23AC2AB.initRecordNumber", strInitRecord);
      }
      vars.removeSessionValue(windowId + "|M_Product_ID");
      ...
      String strM_Product_ID = vars.getRequiredStringParameter("inpmProductId");
      //ActivestatusofProductsAA5160A40205448A8DB8F317C23AC2ABData data = getEditVariables(vars);
      int total = 0;
      ...
      if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        try {
          total = ActivestatusofProductsAA5160A40205448A8DB8F317C23AC2ABData.delete(this, strM_Product_ID, Utility.getContext(this, vars, "#User_Client", windowId, accesslevel), Utility.getContext(this, vars, "#User_Org", windowId, accesslevel));
  ...
  private ActivestatusofProductsAA5160A40205448A8DB8F317C23AC2ABData getEditVariables(Connection con, VariablesSecureApp vars) throws IOException,ServletException {
   ...
   private ActivestatusofProductsAA5160A40205448A8DB8F317C23AC2ABData[] getRelationData(ActivestatusofProductsAA5160A40205448A8DB8F317C23AC2ABData[] data) {
    if (data!=null) {
...
String strParamAD_Org_ID = vars.getSessionValue(tabId + "|paramAD_Org_ID");
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/org/openbravo/zsoft/smartui/ActivestatusofProducts/ActivestatusofProductsAA5160A40205448A8DB8F317C23AC2AB_Relation", discard).createXmlDocument();

    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "ActivestatusofProductsAA5160A40205448A8DB8F317C23AC2AB", false, "document.frmMain.inpmProductId", "grid", "..", "".equals("Y"), "ActivestatusofProducts", strReplaceWith, false);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "ActivestatusofProductsAA5160A40205448A8DB8F317C23AC2AB_Relation.html", "ActivestatusofProducts", "W", strReplaceWith, tabs.breadcrumb());
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "ActivestatusofProductsAA5160A40205448A8DB8F317C23AC2AB_Relation.html", strReplaceWith);
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strM_Product_ID, TableSQLData tableSQL)
    ...
    ActivestatusofProductsAA5160A40205448A8DB8F317C23AC2ABData[] data=null;
...
String strParamAD_Org_ID = vars.getSessionValue(tabId + "|paramAD_Org_ID");
    ...
    if (dataField==null) {
      if (!boolNew) {
        ...
        data = ActivestatusofProductsAA5160A40205448A8DB8F317C23AC2ABData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strM_Product_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      ...
      if (boolNew || data==null || data.length==0) {
        ...
        strCommand = "NEW";
        boolNew = true;
        data = new ActivestatusofProductsAA5160A40205448A8DB8F317C23AC2ABData[0];
      } else {
        discard[0] = new String ("newDiscard");
      }
    } else {
    ...
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "ActivestatusofProductsAA5160A40205448A8DB8F317C23AC2AB", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpmProductId", "", "..", "".equals("Y"), "ActivestatusofProducts", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strM_Product_ID));
        ...
        strSequence = vars.getStringParameter("inpnewdataseIdVal");
            ...
            if (Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),data.adClientId)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),data.adOrgId)){
		     if(type == 'I') {
		       ...
		       if (ActivestatusofProductsAA5160A40205448A8DB8F317C23AC2ABData.getCurrentDBTimestamp(this, data.mProductId).equals(
  ...
  public String getServletInfo() {
    return "Servlet ActivestatusofProductsAA5160A40205448A8DB8F317C23AC2AB. This Servlet was made by Wad constructor";
