...
vars.getGlobalVariable("inpzssiTradeareaId", windowId + "|Zssi_Tradearea_ID");
  ...
  private Countries1B88DFA301A247509076941ED292A958Data getEditVariables(Connection con, VariablesSecureApp vars, String strPZssi_Tradearea_ID) throws IOException,ServletException {
    ...
    try {
    data.zssiTradeareaCountryId = vars.getRequestGlobalVariable("inpzssiTradeareaCountryId", windowId + "|Zssi_Tradearea_Country_ID");     data.adClientId = vars.getRequestGlobalVariable("inpadClientId", windowId + "|AD_Client_ID");     data.adOrgId = vars.getRequestGlobalVariable("inpadOrgId", windowId + "|AD_Org_ID");     data.adOrgIdr = vars.getStringParameter("inpadOrgId_R");     data.zssiTradeareaId = vars.getStringParameter("inpzssiTradeareaId");     data.cCountryId = vars.getStringParameter("inpcCountryId");     data.cCountryIdr = vars.getStringParameter("inpcCountryId_R");     data.isactive = vars.getStringParameter("inpisactive", "N"); 
  ...
  private int saveRecord(VariablesSecureApp vars, OBError myError, char type, String strPZssi_Tradearea_ID) throws IOException, ServletException {
    ...
    if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        strSequence = vars.getStringParameter("inpnewdataseIdVal");
          ...
          CrudOperations.UpdateCustomFields(tabId, data.zssiTradeareaCountryId, vars, this,con);
