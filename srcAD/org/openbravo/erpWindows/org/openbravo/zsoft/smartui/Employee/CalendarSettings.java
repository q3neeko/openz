...
vars.getGlobalVariable("inpcBpartnerId", windowId + "|C_Bpartner_ID");
  ...
  private CalendarSettingsData getEditVariables(Connection con, VariablesSecureApp vars, String strPC_Bpartner_ID) throws IOException,ServletException {
    ...
    try {
    data.cBpartnerId = vars.getStringParameter("inpcBpartnerId");     data.cBpartnerIdr = vars.getStringParameter("inpcBpartnerId_R");     data.cBpartneremployeecalendarsettingsId = vars.getRequestGlobalVariable("inpcBpartneremployeecalendarsettingsId", windowId + "|C_Bpartneremployeecalendarsettings_ID");     data.validfrom = vars.getDateParameter("inpvalidfrom",this);     data.isactive = vars.getStringParameter("inpisactive", "N");    try {   data.worktimemonday = vars.getNumericParameter("inpworktimemonday");  } catch (ServletException paramEx) { ex = paramEx; }     data.workbegintimemonday = vars.getDateParameter("inpworkbegintimemonday",this);    try {   data.worktimetuesday = vars.getNumericParameter("inpworktimetuesday");  } catch (ServletException paramEx) { ex = paramEx; }     data.workbegintimetuesday = vars.getDateParameter("inpworkbegintimetuesday",this);    try {   data.worktimewednesday = vars.getNumericParameter("inpworktimewednesday");  } catch (ServletException paramEx) { ex = paramEx; }     data.workbegintimewednesday = vars.getDateParameter("inpworkbegintimewednesday",this);    try {   data.worktimethursday = vars.getNumericParameter("inpworktimethursday");  } catch (ServletException paramEx) { ex = paramEx; }     data.workbegintimethursday = vars.getDateParameter("inpworkbegintimethursday",this);    try {   data.worktimefriday = vars.getNumericParameter("inpworktimefriday");  } catch (ServletException paramEx) { ex = paramEx; }     data.workbegintimefriday = vars.getDateParameter("inpworkbegintimefriday",this);    try {   data.worktimesaturday = vars.getNumericParameter("inpworktimesaturday");  } catch (ServletException paramEx) { ex = paramEx; }     data.workbegintimesaturday = vars.getDateParameter("inpworkbegintimesaturday",this);    try {   data.worktimesunday = vars.getNumericParameter("inpworktimesunday");  } catch (ServletException paramEx) { ex = paramEx; }     data.workbegintimesunday = vars.getDateParameter("inpworkbegintimesunday",this);     data.adClientId = vars.getRequestGlobalVariable("inpadClientId", windowId + "|AD_Client_ID");     data.adOrgId = vars.getRequestGlobalVariable("inpadOrgId", windowId + "|AD_Org_ID"); 
  ...
  private int saveRecord(VariablesSecureApp vars, OBError myError, char type, String strPC_Bpartner_ID) throws IOException, ServletException {
    ...
    if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        strSequence = vars.getStringParameter("inpnewdataseIdVal");
          ...
          CrudOperations.UpdateCustomFields(tabId, data.cBpartneremployeecalendarsettingsId, vars, this,con);
