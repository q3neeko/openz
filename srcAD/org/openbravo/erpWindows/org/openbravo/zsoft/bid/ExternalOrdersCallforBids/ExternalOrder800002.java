...
String strParamDateFinish_f = vars.getSessionValue(tabId + "|paramDateFinish_f");
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = ExternalOrder800002Data.set(Utility.getDefault(this, vars, "CreatedBy", "", "800001", "800002", "", dataField), ExternalOrder800002Data.selectDef1354_0(this, Utility.getDefault(this, vars, "CreatedBy", "", "800001", "800002", "", dataField)), Utility.getDefault(this, vars, "BillTo_ID", "", "800001", "800002", "", dataField), Utility.getDefault(this, vars, "InvoicedAmt", "", "800001", "800002", "", dataField), Utility.getDefault(this, vars, "Processed", "", "800001", "800002", "N", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "800001", "800002", "", dataField), Utility.getDefault(this, vars, "Name", "", "800001", "800002", "", dataField), Utility.getDefault(this, vars, "Servrevenue", "", "800001", "800002", "", dataField), Utility.getDefault(this, vars, "Publicprivate", "", "800001", "800002", "", dataField), Utility.getDefault(this, vars, "IsCommitment", "", "800001", "800002", "N", dataField), Utility.getDefault(this, vars, "Percentdoneyet", "", "800001", "800002", "", dataField), Utility.getDefault(this, vars, "Schedulestatus", "OK", "800001", "800002", "", dataField), Utility.getDefault(this, vars, "Closeproject", "N", "800001", "800002", "N", dataField), Utility.getDefault(this, vars, "M_PriceList_ID", "", "800001", "800002", "", dataField), Utility.getDefault(this, vars, "C_BPartner_ID", "", "800001", "800002", "", dataField), ExternalOrder800002Data.selectDef3902_1(this, Utility.getDefault(this, vars, "C_BPartner_ID", "", "800001", "800002", "", dataField)), Utility.getDefault(this, vars, "A_Asset_ID", "", "800001", "800002", "", dataField), Utility.getDefault(this, vars, "SalesRep_ID", "", "800001", "800002", "", dataField), Utility.getDefault(this, vars, "C_Location_ID", "", "800001", "800002", "", dataField), ExternalOrder800002Data.selectDef800142_2(this, Utility.getDefault(this, vars, "C_Location_ID", "", "800001", "800002", "", dataField)), Utility.getDefault(this, vars, "Expreinvoicing", "", "800001", "800002", "", dataField), ExternalOrder800002Data.selectDef3901(this, Utility.getContext(this, vars, "#ad_client_ID", windowId)), Utility.getDefault(this, vars, "GenerateTo", "", "800001", "800002", "N", dataField), Utility.getDefault(this, vars, "PlannedQty", "", "800001", "800002", "", dataField), Utility.getDefault(this, vars, "POReference", "", "800001", "800002", "", dataField), Utility.getDefault(this, vars, "LastPlannedProposalDate", "", "800001", "800002", "", dataField), Utility.getDefault(this, vars, "Expexpenses", "", "800001", "800002", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_Org_ID@", "800001", "800002", "", dataField), Utility.getDefault(this, vars, "Projectstatus", "OP", "800001", "800002", "", dataField), Utility.getDefault(this, vars, "DateFinish", "", "800001", "800002", "", dataField), Utility.getDefault(this, vars, "Actualcostamount", "", "800001", "800002", "", dataField), Utility.getDefault(this, vars, "ProjectCategory", "", "800001", "800002", "", dataField), Utility.getDefault(this, vars, "C_ProjectType_ID", "", "800001", "800002", "", dataField), Utility.getDefault(this, vars, "ProjectBalanceAmt", "", "800001", "800002", "", dataField), Utility.getDefault(this, vars, "Invoice_ToProject", "", "800001", "800002", "N", dataField), Utility.getDefault(this, vars, "Expmargin", "", "800001", "800002", "", dataField), Utility.getDefault(this, vars, "UpdatedBy", "", "800001", "800002", "", dataField), ExternalOrder800002Data.selectDef1357_3(this, Utility.getDefault(this, vars, "UpdatedBy", "", "800001", "800002", "", dataField)), Utility.getDefault(this, vars, "DateContract", "", "800001", "800002", "", dataField), Utility.getDefault(this, vars, "C_Campaign_ID", "", "800001", "800002", "", dataField), "Y", Utility.getDefault(this, vars, "Createtemppricelist", "N", "800001", "800002", "N", dataField), Utility.getDefault(this, vars, "CommittedAmt", "", "800001", "800002", "", dataField), ExternalOrder800002Data.selectDef2010(this, Utility.getContext(this, vars, "AD_ORG_ID", "800001")), Utility.getDefault(this, vars, "InvoicedQty", "", "800001", "800002", "", dataField), Utility.getDefault(this, vars, "PaymentRule", "", "800001", "800002", "", dataField), Utility.getDefault(this, vars, "PlannedAmt", "", "800001", "800002", "", dataField), Utility.getDefault(this, vars, "C_ProjectPhase_ID", "", "800001", "800002", "", dataField), Utility.getDefault(this, vars, "M_PriceList_Version_ID", "", "800001", "800002", "", dataField), Utility.getDefault(this, vars, "PlannedPOAmt", "", "800001", "800002", "", dataField), Utility.getDefault(this, vars, "Note", "", "800001", "800002", "", dataField), Utility.getDefault(this, vars, "C_PaymentTerm_ID", "", "800001", "800002", "", dataField), Utility.getDefault(this, vars, "Projectkind", "", "800001", "800002", "", dataField), Utility.getDefault(this, vars, "Servcost", "", "800001", "800002", "", dataField), Utility.getDefault(this, vars, "Servmargin", "", "800001", "800002", "", dataField), Utility.getDefault(this, vars, "Projectphase", "", "800001", "800002", "", dataField), Utility.getDefault(this, vars, "Setprojecttype", "", "800001", "800002", "N", dataField), Utility.getDefault(this, vars, "AccountNo", "", "800001", "800002", "", dataField), Utility.getDefault(this, vars, "C_BPartner_Location_ID", "", "800001", "800002", "", dataField), Utility.getDefault(this, vars, "AD_User_ID", "", "800001", "800002", "", dataField), Utility.getDefault(this, vars, "C_Phase_ID", "", "800001", "800002", "", dataField), Utility.getDefault(this, vars, "Startdate", "", "800001", "800002", "", dataField), Utility.getDefault(this, vars, "CommittedQty", "", "800001", "800002", "", dataField), Utility.getDefault(this, vars, "IsCommitCeiling", "", "800001", "800002", "N", dataField), Utility.getDefault(this, vars, "Estimatedamt", "", "800001", "800002", "", dataField), Utility.getDefault(this, vars, "Document_Copies", "1", "800001", "800002", "", dataField), "", Utility.getDefault(this, vars, "Responsible_ID", "@ad_user_id@", "800001", "800002", "", dataField), Utility.getDefault(this, vars, "M_Warehouse_ID", "", "800001", "800002", "", dataField), Utility.getDefault(this, vars, "IsSummary", "", "800001", "800002", "N", dataField), Utility.getDefault(this, vars, "GenerateOrder", "", "800001", "800002", "N", dataField), Utility.getDefault(this, vars, "Description", "", "800001", "800002", "", dataField), Utility.getDefault(this, vars, "ChangeProjectStatus", "", "800001", "800002", "N", dataField), (vars.getLanguage().equals("en_US")?ListData.selectName(this, "800002", Utility.getDefault(this, vars, "ChangeProjectStatus", "", "800001", "800002", "N", dataField)):ListData.selectNameTrl(this, vars.getLanguage(), "800002", Utility.getDefault(this, vars, "ChangeProjectStatus", "", "800001", "800002", "N", dataField))), Utility.getDefault(this, vars, "CopyFrom", "", "800001", "800002", "N", dataField), Utility.getDefault(this, vars, "Created", "", "800001", "800002", "", dataField), Utility.getDefault(this, vars, "PlannedMarginAmt", "", "800001", "800002", "", dataField));
  ...
  private int saveRecord(VariablesSecureApp vars, OBError myError, char type) throws IOException, ServletException {
    ...
    if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        strSequence = vars.getStringParameter("inpnewdataseIdVal");
          ...
          CrudOperations.UpdateCustomFields(tabId, data.cProjectId, vars, this,con);
