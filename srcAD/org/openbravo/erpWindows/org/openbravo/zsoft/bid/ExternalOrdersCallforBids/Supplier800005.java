...
String strParamC_BPartner_ID = vars.getSessionValue(tabId + "|paramC_BPartner_ID");
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = Supplier800005Data.set(strPC_Project_ID, Utility.getDefault(this, vars, "Note", "", "800001", "800005", "", dataField), Utility.getDefault(this, vars, "M_PriceList_ID", "", "800001", "800005", "", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "800001", "800005", "", dataField), Utility.getDefault(this, vars, "UpdatedBy", "", "800001", "800005", "", dataField), Supplier800005Data.selectDef800084_0(this, Utility.getDefault(this, vars, "UpdatedBy", "", "800001", "800005", "", dataField)), Utility.getDefault(this, vars, "C_BPartner_ID", "", "800001", "800005", "", dataField), Supplier800005Data.selectDef800086_1(this, Utility.getDefault(this, vars, "C_BPartner_ID", "", "800001", "800005", "", dataField)), Utility.getDefault(this, vars, "Incoterms_Description", "", "800001", "800005", "", dataField), "Y", Utility.getDefault(this, vars, "M_PriceList_Version_ID", "", "800001", "800005", "", dataField), "", Utility.getDefault(this, vars, "C_Incoterms_ID", "", "800001", "800005", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "800001", "800005", "", dataField), Utility.getDefault(this, vars, "GenerateOrder", "N", "800001", "800005", "N", dataField), Utility.getDefault(this, vars, "CreatedBy", "", "800001", "800005", "", dataField), Supplier800005Data.selectDef800082_2(this, Utility.getDefault(this, vars, "CreatedBy", "", "800001", "800005", "", dataField)));
  ...
  private int saveRecord(VariablesSecureApp vars, OBError myError, char type, String strPC_Project_ID) throws IOException, ServletException {
    ...
    if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        strSequence = vars.getStringParameter("inpnewdataseIdVal");
          ...
          CrudOperations.UpdateCustomFields(tabId, data.cProjectVendorId, vars, this,con);
