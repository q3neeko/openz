...
vars.getGlobalVariable("inpsnrCurrentbomVId", windowId + "|SNR_Currentbom_V_ID");
  ...
  private BuiltinSerialsandBatches1849F6E0F2AF4E4D8715FEA00C2818B7Data getEditVariables(Connection con, VariablesSecureApp vars, String strPSNR_Currentbom_V_ID) throws IOException,ServletException {
   ...
   private BuiltinSerialsandBatches1849F6E0F2AF4E4D8715FEA00C2818B7Data[] getRelationData(BuiltinSerialsandBatches1849F6E0F2AF4E4D8715FEA00C2818B7Data[] data) {
    if (data!=null) {
      for (int i=0;i<data.length;i++) {        data[i].snrCurrentbomVId = FormatUtilities.truncate(data[i].snrCurrentbomVId, 32);        data[i].snrMasterdataId = FormatUtilities.truncate(data[i].snrMasterdataId, 32);        data[i].snrBatchmasterdataId = FormatUtilities.truncate(data[i].snrBatchmasterdataId, 32);        data[i].adClientId = FormatUtilities.truncate(data[i].adClientId, 32);        data[i].adOrgId = FormatUtilities.truncate(data[i].adOrgId, 32);        data[i].snrCurrentbomSerialsId = FormatUtilities.truncate(data[i].snrCurrentbomSerialsId, 32);}
    }
    return data;
  }
  ...
  private String getParentID(VariablesSecureApp vars, String strSNR_Currentbom_Serials_ID) throws ServletException {
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|AD_Org_ID", data[0].getField("adOrgId"));    vars.setSessionValue(windowId + "|SNR_Currentbom_Serials_ID", data[0].getField("snrCurrentbomSerialsId"));    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));
    }
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars, String strPSNR_Currentbom_V_ID, String strSNR_Currentbom_Serials_ID, TableSQLData tableSQL)
    ...
    String strParamSNR_Currentbom_V_ID = vars.getSessionValue(tabId + "|paramSNR_Currentbom_V_ID");
String strParamSNR_Masterdata_ID = vars.getSessionValue(tabId + "|paramSNR_Masterdata_ID");
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/org/zsoft/serial/SerialNumbers/BuiltinSerialsandBatches1849F6E0F2AF4E4D8715FEA00C2818B7_Relation", discard).createXmlDocument();

    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "BuiltinSerialsandBatches1849F6E0F2AF4E4D8715FEA00C2818B7", false, "document.frmMain.inpsnrCurrentbomSerialsId", "grid", "..", "".equals("Y"), "SerialNumbers", strReplaceWith, false);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "BuiltinSerialsandBatches1849F6E0F2AF4E4D8715FEA00C2818B7_Relation.html", "SerialNumbers", "W", strReplaceWith, tabs.breadcrumb());
  ...
  private int saveRecord(VariablesSecureApp vars, OBError myError, char type, String strPSNR_Currentbom_V_ID) throws IOException, ServletException {
    ...
    if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        strSequence = vars.getStringParameter("inpnewdataseIdVal");
          ...
          CrudOperations.UpdateCustomFields(tabId, data.snrCurrentbomSerialsId, vars, this,con);
