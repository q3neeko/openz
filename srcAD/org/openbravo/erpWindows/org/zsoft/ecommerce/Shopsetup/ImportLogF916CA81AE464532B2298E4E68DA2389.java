...
vars.getGlobalVariable("inpzseShopId", windowId + "|ZSE_Shop_ID");
  ...
  private ImportLogF916CA81AE464532B2298E4E68DA2389Data getEditVariables(Connection con, VariablesSecureApp vars, String strPZSE_Shop_ID) throws IOException,ServletException {
    ...
    try {
    data.zseShopId = vars.getStringParameter("inpzseShopId");     data.zseShopIdr = vars.getStringParameter("inpzseShopId_R");     data.item = vars.getStringParameter("inpitem");    try {   data.qty = vars.getNumericParameter("inpqty");  } catch (ServletException paramEx) { ex = paramEx; }     data.executionstatus = vars.getStringParameter("inpexecutionstatus");    try {   data.seqno = vars.getNumericParameter("inpseqno");  } catch (ServletException paramEx) { ex = paramEx; }     data.zseShopimportlogId = vars.getRequestGlobalVariable("inpzseShopimportlogId", windowId + "|ZSE_Shopimportlog_ID");     data.adClientId = vars.getRequestGlobalVariable("inpadClientId", windowId + "|AD_Client_ID");     data.adOrgId = vars.getRequestGlobalVariable("inpadOrgId", windowId + "|AD_Org_ID");     data.isactive = vars.getStringParameter("inpisactive", "N"); 
  ...
  private String getParentID(VariablesSecureApp vars, String strZSE_Shopimportlog_ID) throws ServletException {
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|ZSE_Shopimportlog_ID", data[0].getField("zseShopimportlogId"));    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));    vars.setSessionValue(windowId + "|AD_Org_ID", data[0].getField("adOrgId"));
    }
...
String strParamItem = vars.getSessionValue(tabId + "|paramItem");
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/org/zsoft/ecommerce/Shopsetup/ImportLogF916CA81AE464532B2298E4E68DA2389_Relation", discard).createXmlDocument();

    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "ImportLogF916CA81AE464532B2298E4E68DA2389", false, "document.frmMain.inpzseShopimportlogId", "grid", "..", "".equals("Y"), "Shopsetup", strReplaceWith, false);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "ImportLogF916CA81AE464532B2298E4E68DA2389_Relation.html", "Shopsetup", "W", strReplaceWith, tabs.breadcrumb());
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strZSE_Shopimportlog_ID, String strPZSE_Shop_ID, TableSQLData tableSQL)
    ...
    String orderClause = " zse_shopimportlog.Seqno";
  ...
  private int saveRecord(VariablesSecureApp vars, OBError myError, char type, String strPZSE_Shop_ID) throws IOException, ServletException {
    ...
    if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        strSequence = vars.getStringParameter("inpnewdataseIdVal");
          ...
          CrudOperations.UpdateCustomFields(tabId, data.zseShopimportlogId, vars, this,con);
