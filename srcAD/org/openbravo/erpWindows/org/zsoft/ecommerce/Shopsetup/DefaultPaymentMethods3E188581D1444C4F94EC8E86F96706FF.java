...
String strParamPaymentmethod = vars.getSessionValue(tabId + "|paramPaymentmethod");
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/org/zsoft/ecommerce/Shopsetup/DefaultPaymentMethods3E188581D1444C4F94EC8E86F96706FF_Relation", discard).createXmlDocument();

    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "DefaultPaymentMethods3E188581D1444C4F94EC8E86F96706FF", false, "document.frmMain.inpzseShopDefaultpaymethodId", "grid", "..", "".equals("Y"), "Shopsetup", strReplaceWith, false);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "DefaultPaymentMethods3E188581D1444C4F94EC8E86F96706FF_Relation.html", "Shopsetup", "W", strReplaceWith, tabs.breadcrumb());
...
String strParamPaymentmethod = vars.getSessionValue(tabId + "|paramPaymentmethod");
    ...
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "DefaultPaymentMethods3E188581D1444C4F94EC8E86F96706FF", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpzseShopDefaultpaymethodId", "", "..", "".equals("Y"), "Shopsetup", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strZSE_Shop_Defaultpaymethod_ID));
  ...
  private int saveRecord(VariablesSecureApp vars, OBError myError, char type, String strPZSE_Shop_ID) throws IOException, ServletException {
    ...
    if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        strSequence = vars.getStringParameter("inpnewdataseIdVal");
          ...
          CrudOperations.UpdateCustomFields(tabId, data.zseShopDefaultpaymethodId, vars, this,con);
