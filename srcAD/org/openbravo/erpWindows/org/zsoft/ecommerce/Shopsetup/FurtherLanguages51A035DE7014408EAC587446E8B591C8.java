...
public class FurtherLanguages51A035DE7014408EAC587446E8B591C8 extends HttpSecureAppServlet {
  private static final long serialVersionUID = 1L;
  
  private static Logger log4j = Logger.getLogger(FurtherLanguages51A035DE7014408EAC587446E8B591C8.class);
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strView = vars.getSessionValue(tabId + "|FurtherLanguages51A035DE7014408EAC587446E8B591C8.view");
      if (strView.equals("")) {
      ...
      if (vars.commandIn("DIRECT")){
        vars.setSessionValue(tabId + "|FurtherLanguages51A035DE7014408EAC587446E8B591C8.view", "EDIT");

        printPageEdit(response, request, vars, false, strZSE_Shop_Language_ID, strPZSE_Shop_ID, tableSQL);
      }
      if (vars.commandIn("DIRECTRELATION")){
        vars.setSessionValue(tabId + "|FurtherLanguages51A035DE7014408EAC587446E8B591C8.view", "RELATION");
      ...
      if (strView.equals("EDIT")) {
        ...
        if (strZSE_Shop_Language_ID.equals("")) {
          ...
          vars.setSessionValue(tabId + "|FurtherLanguages51A035DE7014408EAC587446E8B591C8.view", strView);
        }
      }
...
vars.getGlobalVariable("inpzseShopId", windowId + "|ZSE_Shop_ID");
      ...
      vars.setSessionValue(tabId + "|FurtherLanguages51A035DE7014408EAC587446E8B591C8.initRecordNumber", "0");
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
    } else if (vars.commandIn("PREVIOUS_RELATION")) {
      String strPZSE_Shop_ID = vars.getGlobalVariable("inpzseShopId", windowId + "|ZSE_Shop_ID");

      String strInitRecord = vars.getSessionValue(tabId + "|FurtherLanguages51A035DE7014408EAC587446E8B591C8.initRecordNumber");
      ...
      if (strInitRecord.equals("") || strInitRecord.equals("0")) {
        ...
        vars.setSessionValue(tabId + "|FurtherLanguages51A035DE7014408EAC587446E8B591C8.initRecordNumber", strInitRecord);
      }
      vars.removeSessionValue(windowId + "|ZSE_Shop_Language_ID");
      vars.setSessionValue(windowId + "|ZSE_Shop_ID", strPZSE_Shop_ID);
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
      ...
      String strZSE_Shop_Language_ID = vars.getRequiredStringParameter("inpzseShopLanguageId");
      //FurtherLanguages51A035DE7014408EAC587446E8B591C8Data data = getEditVariables(vars, strPZSE_Shop_ID);
      int total = 0;
      ...
      if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        try {
          total = FurtherLanguages51A035DE7014408EAC587446E8B591C8Data.delete(this, strZSE_Shop_Language_ID, strPZSE_Shop_ID, Utility.getContext(this, vars, "#User_Client", windowId, accesslevel), Utility.getContext(this, vars, "#User_Org", windowId, accesslevel));
  ...
  private FurtherLanguages51A035DE7014408EAC587446E8B591C8Data getEditVariables(Connection con, VariablesSecureApp vars, String strPZSE_Shop_ID) throws IOException,ServletException {
    FurtherLanguages51A035DE7014408EAC587446E8B591C8Data data = new FurtherLanguages51A035DE7014408EAC587446E8B591C8Data();
   ...
   private FurtherLanguages51A035DE7014408EAC587446E8B591C8Data[] getRelationData(FurtherLanguages51A035DE7014408EAC587446E8B591C8Data[] data) {
    if (data!=null) {
  ...
  private String getParentID(VariablesSecureApp vars, String strZSE_Shop_Language_ID) throws ServletException {
    String strPZSE_Shop_ID = FurtherLanguages51A035DE7014408EAC587446E8B591C8Data.selectParentID(this, strZSE_Shop_Language_ID);
    if (strPZSE_Shop_ID.equals("")) {
    ...
    private void refreshSessionNew(VariablesSecureApp vars, String strPZSE_Shop_ID) throws IOException,ServletException {
      FurtherLanguages51A035DE7014408EAC587446E8B591C8Data[] data = FurtherLanguages51A035DE7014408EAC587446E8B591C8Data.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPZSE_Shop_ID, vars.getStringParameter("inpzseShopLanguageId", ""), Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      if (data==null || data.length==0) return;
...
String strParamAD_Language = vars.getSessionValue(tabId + "|paramAD_Language");
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/org/zsoft/ecommerce/Shopsetup/FurtherLanguages51A035DE7014408EAC587446E8B591C8_Relation", discard).createXmlDocument();

    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "FurtherLanguages51A035DE7014408EAC587446E8B591C8", false, "document.frmMain.inpzseShopLanguageId", "grid", "..", "".equals("Y"), "Shopsetup", strReplaceWith, false);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "FurtherLanguages51A035DE7014408EAC587446E8B591C8_Relation.html", "Shopsetup", "W", strReplaceWith, tabs.breadcrumb());
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "FurtherLanguages51A035DE7014408EAC587446E8B591C8_Relation.html", strReplaceWith);
    ...
    if (vars.getLanguage().equals("en_US")) xmlDocument.setParameter("parent", FurtherLanguages51A035DE7014408EAC587446E8B591C8Data.selectParent(this, strPZSE_Shop_ID));
    else xmlDocument.setParameter("parent", FurtherLanguages51A035DE7014408EAC587446E8B591C8Data.selectParentTrl(this, strPZSE_Shop_ID));
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strZSE_Shop_Language_ID, String strPZSE_Shop_ID, TableSQLData tableSQL)
    ...
    FurtherLanguages51A035DE7014408EAC587446E8B591C8Data[] data=null;
...
String strParamAD_Language = vars.getSessionValue(tabId + "|paramAD_Language");
    ...
    if (dataField==null) {
      if (!boolNew) {
        ...
        data = FurtherLanguages51A035DE7014408EAC587446E8B591C8Data.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPZSE_Shop_ID, strZSE_Shop_Language_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      ...
      if (boolNew || data==null || data.length==0) {
        ...
        strCommand = "NEW";
        boolNew = true;
        data = new FurtherLanguages51A035DE7014408EAC587446E8B591C8Data[0];
      } else {
        discard[0] = new String ("newDiscard");
      }
    } else {
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = FurtherLanguages51A035DE7014408EAC587446E8B591C8Data.set(strPZSE_Shop_ID, Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "1E964B3926344B8A8EEA8C1C7F23189F", "51A035DE7014408EAC587446E8B591C8", "", dataField), "", Utility.getDefault(this, vars, "Updatedby", "", "1E964B3926344B8A8EEA8C1C7F23189F", "51A035DE7014408EAC587446E8B591C8", "", dataField), FurtherLanguages51A035DE7014408EAC587446E8B591C8Data.selectDef86208F39597B43CC8FF18F73E43EC90C_0(this, Utility.getDefault(this, vars, "Updatedby", "", "1E964B3926344B8A8EEA8C1C7F23189F", "51A035DE7014408EAC587446E8B591C8", "", dataField)), Utility.getDefault(this, vars, "Createdby", "", "1E964B3926344B8A8EEA8C1C7F23189F", "51A035DE7014408EAC587446E8B591C8", "", dataField), FurtherLanguages51A035DE7014408EAC587446E8B591C8Data.selectDef570AE651652344769080FDE8C9FCF52D_1(this, Utility.getDefault(this, vars, "Createdby", "", "1E964B3926344B8A8EEA8C1C7F23189F", "51A035DE7014408EAC587446E8B591C8", "", dataField)), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "1E964B3926344B8A8EEA8C1C7F23189F", "51A035DE7014408EAC587446E8B591C8", "", dataField), "Y", Utility.getDefault(this, vars, "AD_Language", "", "1E964B3926344B8A8EEA8C1C7F23189F", "51A035DE7014408EAC587446E8B591C8", "", dataField));
        
      }
    } else {
      data = new FurtherLanguages51A035DE7014408EAC587446E8B591C8Data[1];
      java.lang.Object  ref1= dataField;
      data[0]=(FurtherLanguages51A035DE7014408EAC587446E8B591C8Data) ref1;
      data[0].created="";
      data[0].updated="";
    }
    ...
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "FurtherLanguages51A035DE7014408EAC587446E8B591C8", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpzseShopLanguageId", "", "..", "".equals("Y"), "Shopsetup", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strZSE_Shop_Language_ID));
        ...
        strSequence = vars.getStringParameter("inpnewdataseIdVal");
            ...
            if (Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),data.adClientId)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),data.adOrgId)){
		     if(type == 'I') {
		       ...
		       if (FurtherLanguages51A035DE7014408EAC587446E8B591C8Data.getCurrentDBTimestamp(this, data.zseShopLanguageId).equals(
          ...
          CrudOperations.UpdateCustomFields(tabId, data.zseShopLanguageId, vars, this,con);
  ...
  public String getServletInfo() {
    return "Servlet FurtherLanguages51A035DE7014408EAC587446E8B591C8. This Servlet was made by Wad constructor";
