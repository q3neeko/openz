...
String strParamItem = vars.getSessionValue(tabId + "|paramItem");
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/org/zsoft/ecommerce/Shopsetup/ItemstodeleteinShop8B45F14C6BB141ADB0171C4F3432060A_Relation", discard).createXmlDocument();

    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "ItemstodeleteinShop8B45F14C6BB141ADB0171C4F3432060A", false, "document.frmMain.inpzseShopdeletelogId", "grid", "..", "".equals("Y"), "Shopsetup", strReplaceWith, false);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "ItemstodeleteinShop8B45F14C6BB141ADB0171C4F3432060A_Relation.html", "Shopsetup", "W", strReplaceWith, tabs.breadcrumb());
  ...
  private int saveRecord(VariablesSecureApp vars, OBError myError, char type, String strPZSE_Shop_ID) throws IOException, ServletException {
    ...
    if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        strSequence = vars.getStringParameter("inpnewdataseIdVal");
          ...
          CrudOperations.UpdateCustomFields(tabId, data.zseShopdeletelogId, vars, this,con);
