...
public class Shopsetup41A4B02E63A24CADAB580ECEE223D4F6 extends HttpSecureAppServlet {
  private static final long serialVersionUID = 1L;
  
  private static Logger log4j = Logger.getLogger(Shopsetup41A4B02E63A24CADAB580ECEE223D4F6.class);
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strView = vars.getSessionValue(tabId + "|Shopsetup41A4B02E63A24CADAB580ECEE223D4F6.view");
      if (strView.equals("")) {
      ...
      if (vars.commandIn("DIRECT")){
        vars.setSessionValue(tabId + "|Shopsetup41A4B02E63A24CADAB580ECEE223D4F6.view", "EDIT");

        printPageEdit(response, request, vars, false, strZSE_Shop_ID, tableSQL);
      }
      if (vars.commandIn("DIRECTRELATION")){
        vars.setSessionValue(tabId + "|Shopsetup41A4B02E63A24CADAB580ECEE223D4F6.view", "RELATION");
      ...
      if (strView.equals("EDIT")) {
        ...
        if (strZSE_Shop_ID.equals("")) {
          ...
          vars.setSessionValue(tabId + "|Shopsetup41A4B02E63A24CADAB580ECEE223D4F6.view", strView);
        }
      }
      ...
      vars.setSessionValue(tabId + "|Shopsetup41A4B02E63A24CADAB580ECEE223D4F6.initRecordNumber", "0");
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
    } else if (vars.commandIn("PREVIOUS_RELATION")) {

      String strInitRecord = vars.getSessionValue(tabId + "|Shopsetup41A4B02E63A24CADAB580ECEE223D4F6.initRecordNumber");
      ...
      if (strInitRecord.equals("") || strInitRecord.equals("0")) {
        ...
        vars.setSessionValue(tabId + "|Shopsetup41A4B02E63A24CADAB580ECEE223D4F6.initRecordNumber", strInitRecord);
      }
      vars.removeSessionValue(windowId + "|ZSE_Shop_ID");
      ...
      String strZSE_Shop_ID = vars.getRequiredStringParameter("inpzseShopId");
      //Shopsetup41A4B02E63A24CADAB580ECEE223D4F6Data data = getEditVariables(vars);
      int total = 0;
      ...
      if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        try {
          total = Shopsetup41A4B02E63A24CADAB580ECEE223D4F6Data.delete(this, strZSE_Shop_ID, Utility.getContext(this, vars, "#User_Client", windowId, accesslevel), Utility.getContext(this, vars, "#User_Org", windowId, accesslevel));
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars, String strZSE_Shop_ID, TableSQLData tableSQL)
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/org/zsoft/ecommerce/Shopsetup/Shopsetup41A4B02E63A24CADAB580ECEE223D4F6_Relation", discard).createXmlDocument();

    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "Shopsetup41A4B02E63A24CADAB580ECEE223D4F6", false, "document.frmMain.inpzseShopId", "grid", "..", "".equals("Y"), "Shopsetup", strReplaceWith, false);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Shopsetup41A4B02E63A24CADAB580ECEE223D4F6_Relation.html", "Shopsetup", "W", strReplaceWith, tabs.breadcrumb());
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "Shopsetup41A4B02E63A24CADAB580ECEE223D4F6_Relation.html", strReplaceWith);
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strZSE_Shop_ID, TableSQLData tableSQL)
    ...
    Shopsetup41A4B02E63A24CADAB580ECEE223D4F6Data[] data=null;
    ...
    if (dataField==null) {
      if (!boolNew) {
        ...
        data = Shopsetup41A4B02E63A24CADAB580ECEE223D4F6Data.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strZSE_Shop_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      ...
      if (boolNew || data==null || data.length==0) {
        ...
        strCommand = "NEW";
        boolNew = true;
        data = new Shopsetup41A4B02E63A24CADAB580ECEE223D4F6Data[0];
      } else {
        discard[0] = new String ("newDiscard");
      }
    } else {
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = Shopsetup41A4B02E63A24CADAB580ECEE223D4F6Data.set(Utility.getDefault(this, vars, "Api", "", "1E964B3926344B8A8EEA8C1C7F23189F", "41A4B02E63A24CADAB580ECEE223D4F6", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "1E964B3926344B8A8EEA8C1C7F23189F", "41A4B02E63A24CADAB580ECEE223D4F6", "", dataField), Utility.getDefault(this, vars, "Isstockactive", "Y", "1E964B3926344B8A8EEA8C1C7F23189F", "41A4B02E63A24CADAB580ECEE223D4F6", "N", dataField), Utility.getDefault(this, vars, "Secret2", "", "1E964B3926344B8A8EEA8C1C7F23189F", "41A4B02E63A24CADAB580ECEE223D4F6", "", dataField), Utility.getDefault(this, vars, "Apikey", "", "1E964B3926344B8A8EEA8C1C7F23189F", "41A4B02E63A24CADAB580ECEE223D4F6", "", dataField), Utility.getDefault(this, vars, "Initorderdays", "0", "1E964B3926344B8A8EEA8C1C7F23189F", "41A4B02E63A24CADAB580ECEE223D4F6", "", dataField), Utility.getDefault(this, vars, "Updatedby", "", "1E964B3926344B8A8EEA8C1C7F23189F", "41A4B02E63A24CADAB580ECEE223D4F6", "", dataField), Shopsetup41A4B02E63A24CADAB580ECEE223D4F6Data.selectDefE9C9937F834F43F18BB8C5227E96A3F2_0(this, Utility.getDefault(this, vars, "Updatedby", "", "1E964B3926344B8A8EEA8C1C7F23189F", "41A4B02E63A24CADAB580ECEE223D4F6", "", dataField)), Utility.getDefault(this, vars, "AD_User_ID", "", "1E964B3926344B8A8EEA8C1C7F23189F", "41A4B02E63A24CADAB580ECEE223D4F6", "", dataField), "", Utility.getDefault(this, vars, "Isoderactive", "Y", "1E964B3926344B8A8EEA8C1C7F23189F", "41A4B02E63A24CADAB580ECEE223D4F6", "N", dataField), "Y", Utility.getDefault(this, vars, "Url", "", "1E964B3926344B8A8EEA8C1C7F23189F", "41A4B02E63A24CADAB580ECEE223D4F6", "", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "1E964B3926344B8A8EEA8C1C7F23189F", "41A4B02E63A24CADAB580ECEE223D4F6", "", dataField), Utility.getDefault(this, vars, "AD_Language", "", "1E964B3926344B8A8EEA8C1C7F23189F", "41A4B02E63A24CADAB580ECEE223D4F6", "", dataField), Utility.getDefault(this, vars, "Createdby", "", "1E964B3926344B8A8EEA8C1C7F23189F", "41A4B02E63A24CADAB580ECEE223D4F6", "", dataField), Shopsetup41A4B02E63A24CADAB580ECEE223D4F6Data.selectDef4CE9B88A981845ABA18D64FAF89633F1_1(this, Utility.getDefault(this, vars, "Createdby", "", "1E964B3926344B8A8EEA8C1C7F23189F", "41A4B02E63A24CADAB580ECEE223D4F6", "", dataField)), Utility.getDefault(this, vars, "Secret", "", "1E964B3926344B8A8EEA8C1C7F23189F", "41A4B02E63A24CADAB580ECEE223D4F6", "", dataField), Utility.getDefault(this, vars, "Deletesecurity", "1", "1E964B3926344B8A8EEA8C1C7F23189F", "41A4B02E63A24CADAB580ECEE223D4F6", "", dataField), Utility.getDefault(this, vars, "Value", "", "1E964B3926344B8A8EEA8C1C7F23189F", "41A4B02E63A24CADAB580ECEE223D4F6", "", dataField));
        
      }
    } else {
      data = new Shopsetup41A4B02E63A24CADAB580ECEE223D4F6Data[1];
      java.lang.Object  ref1= dataField;
      data[0]=(Shopsetup41A4B02E63A24CADAB580ECEE223D4F6Data) ref1;
      data[0].created="";
      data[0].updated="";
    }
    ...
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "Shopsetup41A4B02E63A24CADAB580ECEE223D4F6", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpzseShopId", "", "..", "".equals("Y"), "Shopsetup", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strZSE_Shop_ID));
        ...
        strSequence = vars.getStringParameter("inpnewdataseIdVal");
            ...
            if (Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),data.adClientId)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),data.adOrgId)){
		     if(type == 'I') {
		       ...
		       if (Shopsetup41A4B02E63A24CADAB580ECEE223D4F6Data.getCurrentDBTimestamp(this, data.zseShopId).equals(
          ...
          CrudOperations.UpdateCustomFields(tabId, data.zseShopId, vars, this,con);
  ...
  public String getServletInfo() {
    return "Servlet Shopsetup41A4B02E63A24CADAB580ECEE223D4F6. This Servlet was made by Wad constructor";
