...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strM_Transaction_ID, String strPM_Locator_ID, TableSQLData tableSQL)
    ...
    String orderClause = "  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table5.Value), ''))),'') ),  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table6.Value), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL6.Name IS NULL THEN TO_CHAR(table6.Name) ELSE TO_CHAR(tableTRL6.Name) END)), ''))),'') ), M_Transaction.MovementDate";
...
String strParamMovementDate_f = vars.getSessionValue(tabId + "|paramMovementDate_f");
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = ProductTransactionsData.set(strPM_Locator_ID, Utility.getDefault(this, vars, "M_InventoryLine_ID", "", "139", "262", "", dataField), Utility.getDefault(this, vars, "M_Product_ID", "", "139", "262", "", dataField), ProductTransactionsData.selectDef3668_0(this, Utility.getDefault(this, vars, "M_Product_ID", "", "139", "262", "", dataField)), Utility.getDefault(this, vars, "M_Internal_Consumptionline_ID", "", "139", "262", "", dataField), Utility.getDefault(this, vars, "SNR_Masterdata_ID", "", "139", "262", "", dataField), Utility.getDefault(this, vars, "C_Project_ID", "", "139", "262", "", dataField), "Y", Utility.getDefault(this, vars, "M_AttributeSetInstance_ID", "", "139", "262", "", dataField), ProductTransactionsData.selectDef9867_1(this, Utility.getDefault(this, vars, "M_AttributeSetInstance_ID", "", "139", "262", "", dataField)), Utility.getDefault(this, vars, "MovementQty", "", "139", "262", "", dataField), Utility.getDefault(this, vars, "C_ProjectIssue_ID", "", "139", "262", "", dataField), Utility.getDefault(this, vars, "C_UOM_ID", "", "139", "262", "", dataField), Utility.getDefault(this, vars, "QuantityOrder", "", "139", "262", "", dataField), Utility.getDefault(this, vars, "C_Projecttask_ID", "", "139", "262", "", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "139", "262", "", dataField), "", Utility.getDefault(this, vars, "MovementType", "", "139", "262", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_Org_ID@", "139", "262", "", dataField), Utility.getDefault(this, vars, "M_InOutLine_ID", "", "139", "262", "", dataField), ProductTransactionsData.selectDef3673_2(this, Utility.getDefault(this, vars, "M_InOutLine_ID", "", "139", "262", "", dataField)), ProductTransactionsData.selectDef3667_3(this, strPM_Locator_ID), Utility.getDefault(this, vars, "M_MovementLine_ID", "", "139", "262", "", dataField), Utility.getDefault(this, vars, "CreatedBy", "", "139", "262", "", dataField), ProductTransactionsData.selectDef3663_4(this, Utility.getDefault(this, vars, "CreatedBy", "", "139", "262", "", dataField)), Utility.getDefault(this, vars, "C_Projectphase_ID", "", "139", "262", "", dataField), Utility.getDefault(this, vars, "UpdatedBy", "", "139", "262", "", dataField), ProductTransactionsData.selectDef3665_5(this, Utility.getDefault(this, vars, "UpdatedBy", "", "139", "262", "", dataField)), Utility.getDefault(this, vars, "M_Product_Uom_Id", "", "139", "262", "", dataField), Utility.getDefault(this, vars, "M_ProductionLine_ID", "", "139", "262", "", dataField), Utility.getDefault(this, vars, "MovementDate", "", "139", "262", "", dataField), Utility.getDefault(this, vars, "A_Asset_ID", "", "139", "262", "", dataField));
  ...
  private int saveRecord(VariablesSecureApp vars, OBError myError, char type, String strPM_Locator_ID) throws IOException, ServletException {
    ...
    if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        strSequence = vars.getStringParameter("inpnewdataseIdVal");
          ...
          CrudOperations.UpdateCustomFields(tabId, data.mTransactionId, vars, this,con);
