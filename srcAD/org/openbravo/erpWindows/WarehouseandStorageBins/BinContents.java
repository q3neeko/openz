...
vars.getGlobalVariable("inpmLocatorId", windowId + "|M_Locator_ID");
  ...
  private String getParentID(VariablesSecureApp vars, String strM_Storage_Detail_ID) throws ServletException {
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|AD_Org_ID", data[0].getField("adOrgId"));    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));    vars.setSessionValue(windowId + "|M_Storage_Detail_ID", data[0].getField("mStorageDetailId"));
    }
...
String strParamM_Locator_ID = vars.getSessionValue(tabId + "|paramM_Locator_ID");
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = BinContentsData.set(strPM_Locator_ID, Utility.getDefault(this, vars, "C_UOM_ID", "", "139", "179", "", dataField), Utility.getDefault(this, vars, "QtyOrderOnHand", "", "139", "179", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "139", "179", "", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "139", "179", "", dataField), "Y", Utility.getDefault(this, vars, "PreQtyOnHand", "", "139", "179", "", dataField), Utility.getDefault(this, vars, "DateLastInventory", "", "139", "179", "", dataField), Utility.getDefault(this, vars, "Updatedby", "", "139", "179", "", dataField), BinContentsData.selectDef800649_0(this, Utility.getDefault(this, vars, "Updatedby", "", "139", "179", "", dataField)), BinContentsData.selectDef800634_1(this, strPM_Locator_ID), Utility.getDefault(this, vars, "M_Product_Uom_Id", "", "139", "179", "", dataField), Utility.getDefault(this, vars, "Createdby", "", "139", "179", "", dataField), BinContentsData.selectDef800647_2(this, Utility.getDefault(this, vars, "Createdby", "", "139", "179", "", dataField)), Utility.getDefault(this, vars, "M_Product_ID", "", "139", "179", "", dataField), BinContentsData.selectDef800633_3(this, Utility.getDefault(this, vars, "M_Product_ID", "", "139", "179", "", dataField)), Utility.getDefault(this, vars, "QtyOnHand", "", "139", "179", "", dataField), Utility.getDefault(this, vars, "PreQtyOrderOnHand", "", "139", "179", "", dataField), Utility.getDefault(this, vars, "M_AttributeSetInstance_ID", "", "139", "179", "", dataField), BinContentsData.selectDef800635_4(this, Utility.getDefault(this, vars, "M_AttributeSetInstance_ID", "", "139", "179", "", dataField)), "");
  ...
  private int saveRecord(VariablesSecureApp vars, OBError myError, char type, String strPM_Locator_ID) throws IOException, ServletException {
    ...
    if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        strSequence = vars.getStringParameter("inpnewdataseIdVal");
          ...
          CrudOperations.UpdateCustomFields(tabId, data.mStorageDetailId, vars, this,con);
