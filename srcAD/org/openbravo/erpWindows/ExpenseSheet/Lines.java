...
String strParamLine_f = vars.getSessionValue(tabId + "|paramLine_f");
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = LinesData.set(strPS_TimeExpense_ID, Utility.getDefault(this, vars, "C_ProjectPhase_ID", "", "235", "413", "", dataField), Utility.getDefault(this, vars, "S_TimeType_ID", "", "235", "413", "", dataField), Utility.getDefault(this, vars, "C_UOM_ID", "", "235", "413", "", dataField), Utility.getDefault(this, vars, "Description", "", "235", "413", "", dataField), Utility.getDefault(this, vars, "C_ProjectTask_ID", "", "235", "413", "", dataField), Utility.getDefault(this, vars, "UpdatedBy", "", "235", "413", "", dataField), LinesData.selectDef6881_0(this, Utility.getDefault(this, vars, "UpdatedBy", "", "235", "413", "", dataField)), Utility.getDefault(this, vars, "C_Activity_ID", "", "235", "413", "", dataField), "Y", LinesData.selectDef6879(this, strPS_TimeExpense_ID), Utility.getDefault(this, vars, "Note", "", "235", "413", "", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "235", "413", "", dataField), "", Utility.getDefault(this, vars, "C_BPartner_ID", "", "235", "413", "", dataField), LinesData.selectDef6867_1(this, Utility.getDefault(this, vars, "C_BPartner_ID", "", "235", "413", "", dataField)), Utility.getDefault(this, vars, "C_Currency_ID", "@$C_Currency_ID@", "235", "413", "", dataField), Utility.getDefault(this, vars, "ConvertedAmt", "", "235", "413", "", dataField), Utility.getDefault(this, vars, "InvoicePrice", "", "235", "413", "", dataField), Utility.getDefault(this, vars, "ExpenseAmt", "", "235", "413", "", dataField), Utility.getDefault(this, vars, "DateExpense", "@DateReport@", "235", "413", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_Org_ID@", "235", "413", "", dataField), Utility.getDefault(this, vars, "C_InvoiceLine_ID", "", "235", "413", "", dataField), Utility.getDefault(this, vars, "M_Product_ID", "", "235", "413", "", dataField), Utility.getDefault(this, vars, "IsInvoiced", "", "235", "413", "N", dataField), Utility.getDefault(this, vars, "CreatedBy", "", "235", "413", "", dataField), LinesData.selectDef6883_2(this, Utility.getDefault(this, vars, "CreatedBy", "", "235", "413", "", dataField)), Utility.getDefault(this, vars, "C_Campaign_ID", "", "235", "413", "", dataField), Utility.getDefault(this, vars, "Qty", "1", "235", "413", "", dataField), Utility.getDefault(this, vars, "IsTimeReport", "", "235", "413", "N", dataField), Utility.getDefault(this, vars, "C_Project_ID", "", "235", "413", "", dataField), Utility.getDefault(this, vars, "S_ResourceAssignment_ID", "", "235", "413", "", dataField), Utility.getDefault(this, vars, "C_OrderLine_ID", "", "235", "413", "", dataField));
  ...
  private int saveRecord(VariablesSecureApp vars, OBError myError, char type, String strPS_TimeExpense_ID) throws IOException, ServletException {
    ...
    if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        strSequence = vars.getStringParameter("inpnewdataseIdVal");
          ...
          CrudOperations.UpdateCustomFields(tabId, data.sTimeexpenselineId, vars, this,con);
