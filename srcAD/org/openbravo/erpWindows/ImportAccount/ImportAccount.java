  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strI_ElementValue_ID, TableSQLData tableSQL)
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = ImportAccountData.set(Utility.getDefault(this, vars, "Created", "", "248", "443", "", dataField), Utility.getDefault(this, vars, "PostStatistical", "", "248", "443", "N", dataField), Utility.getDefault(this, vars, "Description", "", "248", "443", "", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "248", "443", "", dataField), Utility.getDefault(this, vars, "I_ErrorMsg", "", "248", "443", "", dataField), Utility.getDefault(this, vars, "Value", "", "248", "443", "", dataField), Utility.getDefault(this, vars, "AccountSign", "", "248", "443", "", dataField), Utility.getDefault(this, vars, "ParentElementValue_ID", "", "248", "443", "", dataField), Utility.getDefault(this, vars, "Name", "", "248", "443", "", dataField), Utility.getDefault(this, vars, "Processed", "", "248", "443", "N", dataField), Utility.getDefault(this, vars, "PostBudget", "", "248", "443", "N", dataField), "Y", Utility.getDefault(this, vars, "AccountType", "", "248", "443", "", dataField), Utility.getDefault(this, vars, "PostActual", "", "248", "443", "N", dataField), Utility.getDefault(this, vars, "I_IsImported", "", "248", "443", "N", dataField), Utility.getDefault(this, vars, "Default_Account", "", "248", "443", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_Org_ID@", "248", "443", "", dataField), Utility.getDefault(this, vars, "C_Element_ID", "", "248", "443", "", dataField), "", Utility.getDefault(this, vars, "Processing", "", "248", "443", "N", dataField), Utility.getDefault(this, vars, "UpdatedBy", "", "248", "443", "", dataField), ImportAccountData.selectDef7908_0(this, Utility.getDefault(this, vars, "UpdatedBy", "", "248", "443", "", dataField)), Utility.getDefault(this, vars, "AD_Column_ID", "", "248", "443", "", dataField), Utility.getDefault(this, vars, "IsSummary", "", "248", "443", "N", dataField), Utility.getDefault(this, vars, "IsDocControlled", "", "248", "443", "N", dataField), Utility.getDefault(this, vars, "ElementName", "", "248", "443", "", dataField), Utility.getDefault(this, vars, "Elementlevel", "", "248", "443", "", dataField), Utility.getDefault(this, vars, "ParentValue", "", "248", "443", "", dataField), Utility.getDefault(this, vars, "CreatedBy", "", "248", "443", "", dataField), ImportAccountData.selectDef7928_1(this, Utility.getDefault(this, vars, "CreatedBy", "", "248", "443", "", dataField)), Utility.getDefault(this, vars, "PostEncumbrance", "", "248", "443", "N", dataField), Utility.getDefault(this, vars, "C_ElementValue_ID", "", "248", "443", "", dataField));
  ...
  private int saveRecord(VariablesSecureApp vars, OBError myError, char type) throws IOException, ServletException {
    ...
    if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        strSequence = vars.getStringParameter("inpnewdataseIdVal");
          ...
          CrudOperations.UpdateCustomFields(tabId, data.iElementvalueId, vars, this,con);
