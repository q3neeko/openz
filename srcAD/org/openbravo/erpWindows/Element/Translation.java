...
String strParamDescription = vars.getSessionValue(tabId + "|paramDescription");
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = TranslationData.set(strPAD_Element_ID, Utility.getDefault(this, vars, "PO_Description", "", "151", "204", "", dataField), Utility.getDefault(this, vars, "IsTranslated", "", "151", "204", "N", dataField), Utility.getDefault(this, vars, "PO_Help", "", "151", "204", "", dataField), "0", Utility.getDefault(this, vars, "Name", "", "151", "204", "", dataField), Utility.getDefault(this, vars, "AD_Language", "", "151", "204", "", dataField), "0", Utility.getDefault(this, vars, "CreatedBy", "", "151", "204", "", dataField), TranslationData.selectDef2643_0(this, Utility.getDefault(this, vars, "CreatedBy", "", "151", "204", "", dataField)), Utility.getDefault(this, vars, "PO_Name", "", "151", "204", "", dataField), Utility.getDefault(this, vars, "Help", "", "151", "204", "", dataField), "Y", "", Utility.getDefault(this, vars, "UpdatedBy", "", "151", "204", "", dataField), TranslationData.selectDef2645_1(this, Utility.getDefault(this, vars, "UpdatedBy", "", "151", "204", "", dataField)), Utility.getDefault(this, vars, "PrintName", "", "151", "204", "", dataField), Utility.getDefault(this, vars, "PO_PrintName", "", "151", "204", "", dataField), Utility.getDefault(this, vars, "Description", "", "151", "204", "", dataField));
  ...
  private int saveRecord(VariablesSecureApp vars, OBError myError, char type, String strPAD_Element_ID) throws IOException, ServletException {
    ...
    if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        strSequence = vars.getStringParameter("inpnewdataseIdVal");
          ...
          CrudOperations.UpdateCustomFields(tabId, data.adElementTrlId, vars, this,con);
