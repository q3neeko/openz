...
vars.getGlobalVariable("inpcaAssetsstockedId", windowId + "|CA_Assetsstocked_ID");
  ...
  private String getParentID(VariablesSecureApp vars, String strCA_Assetsstockedbom_ID) throws ServletException {
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|AD_Org_ID", data[0].getField("adOrgId"));    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));    vars.setSessionValue(windowId + "|CA_Assetsstockedbom_ID", data[0].getField("caAssetsstockedbomId"));
    }
  ...
  private int saveRecord(VariablesSecureApp vars, OBError myError, char type, String strPCA_Assetsstocked_ID) throws IOException, ServletException {
    ...
    if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        strSequence = vars.getStringParameter("inpnewdataseIdVal");
          ...
          CrudOperations.UpdateCustomFields(tabId, data.caAssetsstockedbomId, vars, this,con);
