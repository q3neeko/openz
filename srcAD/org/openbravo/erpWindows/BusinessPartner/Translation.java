...
public class Translation extends HttpSecureAppServlet {
  ...
  private static final String tabId = "B6DFCC8D10904FB4AD0727000F064817";
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      vars.setSessionValue(windowId + "|Zssi_Textmodule_ID", strPZssi_Textmodule_ID);
      vars.setSessionValue("1341CBD0CAA04BEDB92614190EFDA62A|Textmodule.view", "EDIT");
      vars.removeSessionValue(windowId + "|C_Bpartner_ID");
      refreshParentSession(vars, strPZssi_Textmodule_ID);
...
vars.getGlobalVariable("inpzssiTextmoduleId", windowId + "|Zssi_Textmodule_ID");
      ...
      String strZssi_Textmodule_Trl_ID = vars.getRequiredStringParameter("inpzssiTextmoduleTrlId");
      //TranslationData data = getEditVariables(vars, strPZssi_Textmodule_ID);
      int total = 0;
      ...
      if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        try {
          total = TranslationData.delete(this, strZssi_Textmodule_Trl_ID, strPZssi_Textmodule_ID, Utility.getContext(this, vars, "#User_Client", windowId, accesslevel), Utility.getContext(this, vars, "#User_Org", windowId, accesslevel));
  ...
  private void refreshParentSession(VariablesSecureApp vars, String strPZssi_Textmodule_ID) throws IOException,ServletException {
      TextmoduleData[] data = TextmoduleData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), vars.getSessionValue(windowId + "|C_Bpartner_ID"), strPZssi_Textmodule_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|AD_Org_ID", data[0].adOrgId);    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].adClientId);    vars.setSessionValue(windowId + "|Zssi_Textmodule_ID", data[0].zssiTextmoduleId);
  ...
  private String getParentID(VariablesSecureApp vars, String strZssi_Textmodule_Trl_ID) throws ServletException {
    String strPZssi_Textmodule_ID = TranslationData.selectParentID(this, strZssi_Textmodule_Trl_ID);
    if (strPZssi_Textmodule_ID.equals("")) {
    ...
    private void refreshSessionNew(VariablesSecureApp vars, String strPZssi_Textmodule_ID) throws IOException,ServletException {
      TranslationData[] data = TranslationData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPZssi_Textmodule_ID, vars.getStringParameter("inpzssiTextmoduleTrlId", ""), Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      if (data==null || data.length==0) return;
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars, String strPZssi_Textmodule_ID, String strZssi_Textmodule_Trl_ID, TableSQLData tableSQL)
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/BusinessPartner/Translation_Relation", discard).createXmlDocument();

    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "Translation", false, "document.frmMain.inpzssiTextmoduleTrlId", "grid", "..", "".equals("Y"), "BusinessPartner", strReplaceWith, false);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Translation_Relation.html", "BusinessPartner", "W", strReplaceWith, tabs.breadcrumb());
    ...
    if (vars.getLanguage().equals("en_US")) xmlDocument.setParameter("parent", TranslationData.selectParent(this, strPZssi_Textmodule_ID));
    else xmlDocument.setParameter("parent", TranslationData.selectParentTrl(this, strPZssi_Textmodule_ID));
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strZssi_Textmodule_Trl_ID, String strPZssi_Textmodule_ID, TableSQLData tableSQL)
    ...
    if (dataField==null) {
      if (!boolNew) {
        ...
        data = TranslationData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPZssi_Textmodule_ID, strZssi_Textmodule_Trl_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = TranslationData.set(strPZssi_Textmodule_ID, Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "123", "B6DFCC8D10904FB4AD0727000F064817", "", dataField), Utility.getDefault(this, vars, "Createdby", "", "123", "B6DFCC8D10904FB4AD0727000F064817", "", dataField), TranslationData.selectDefB3A270171B96473A87B6670F108299BD_0(this, Utility.getDefault(this, vars, "Createdby", "", "123", "B6DFCC8D10904FB4AD0727000F064817", "", dataField)), Utility.getDefault(this, vars, "Text", "", "123", "B6DFCC8D10904FB4AD0727000F064817", "", dataField), Utility.getDefault(this, vars, "AD_Language", "@#ad_language@", "123", "B6DFCC8D10904FB4AD0727000F064817", "", dataField), "", "Y", Utility.getDefault(this, vars, "Updatedby", "", "123", "B6DFCC8D10904FB4AD0727000F064817", "", dataField), TranslationData.selectDef7C38D615AA944865853512AF0EE7C35C_1(this, Utility.getDefault(this, vars, "Updatedby", "", "123", "B6DFCC8D10904FB4AD0727000F064817", "", dataField)), Utility.getDefault(this, vars, "Istranslated", "N", "123", "B6DFCC8D10904FB4AD0727000F064817", "N", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "123", "B6DFCC8D10904FB4AD0727000F064817", "", dataField));
    ...
    String currentPOrg=TextmoduleData.selectOrg(this, strPZssi_Textmodule_ID);
    ...
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "Translation", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpzssiTextmoduleTrlId", "", "..", "".equals("Y"), "BusinessPartner", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strZssi_Textmodule_Trl_ID));
        ...
        strSequence = vars.getStringParameter("inpnewdataseIdVal");
            ...
            if (Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),data.adClientId)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),data.adOrgId)){
		     if(type == 'I') {
		       ...
		       if (TranslationData.getCurrentDBTimestamp(this, data.zssiTextmoduleTrlId).equals(
          ...
          CrudOperations.UpdateCustomFields(tabId, data.zssiTextmoduleTrlId, vars, this,con);
