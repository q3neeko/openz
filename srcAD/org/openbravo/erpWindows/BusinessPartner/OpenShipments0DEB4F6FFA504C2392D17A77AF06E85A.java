...
vars.getGlobalVariable("inpcBpartnerId", windowId + "|C_Bpartner_ID");
  ...
  private String getParentID(VariablesSecureApp vars, String strZssi_Openshipment_ID) throws ServletException {
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));    vars.setSessionValue(windowId + "|AD_Org_ID", data[0].getField("adOrgId"));    vars.setSessionValue(windowId + "|M_Product_ID", data[0].getField("mProductId"));    vars.setSessionValue(windowId + "|Zssi_Openshipment_ID", data[0].getField("zssiOpenshipmentId"));
    }
...
String strParamScheddeliverydate_f = vars.getSessionValue(tabId + "|paramScheddeliverydate_f");
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = OpenShipments0DEB4F6FFA504C2392D17A77AF06E85AData.set(strPC_Bpartner_ID, Utility.getDefault(this, vars, "Description", "", "123", "0DEB4F6FFA504C2392D17A77AF06E85A", "", dataField), Utility.getDefault(this, vars, "Qtydelivered", "", "123", "0DEB4F6FFA504C2392D17A77AF06E85A", "", dataField), Utility.getDefault(this, vars, "Poreference", "", "123", "0DEB4F6FFA504C2392D17A77AF06E85A", "", dataField), Utility.getDefault(this, vars, "C_Uom_ID", "", "123", "0DEB4F6FFA504C2392D17A77AF06E85A", "", dataField), Utility.getDefault(this, vars, "Qtyordered", "", "123", "0DEB4F6FFA504C2392D17A77AF06E85A", "", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "123", "0DEB4F6FFA504C2392D17A77AF06E85A", "", dataField), Utility.getDefault(this, vars, "C_Order_ID", "", "123", "0DEB4F6FFA504C2392D17A77AF06E85A", "", dataField), Utility.getDefault(this, vars, "M_Product_ID", "", "123", "0DEB4F6FFA504C2392D17A77AF06E85A", "", dataField), OpenShipments0DEB4F6FFA504C2392D17A77AF06E85AData.selectDef864D7E94D1324D1FB3ABEBE5A1318660_0(this, Utility.getDefault(this, vars, "M_Product_ID", "", "123", "0DEB4F6FFA504C2392D17A77AF06E85A", "", dataField)), OpenShipments0DEB4F6FFA504C2392D17A77AF06E85AData.selectDef2E5D3C755ABA479A8F2C83278E5EA41B_1(this, strPC_Bpartner_ID), Utility.getDefault(this, vars, "Zssi_Openshipment_ID", "", "123", "0DEB4F6FFA504C2392D17A77AF06E85A", "", dataField), OpenShipments0DEB4F6FFA504C2392D17A77AF06E85AData.selectDef457FE8F46C21417F8926E011B54CB676_2(this, Utility.getDefault(this, vars, "Zssi_Openshipment_ID", "", "123", "0DEB4F6FFA504C2392D17A77AF06E85A", "", dataField)), Utility.getDefault(this, vars, "Dateordered", "", "123", "0DEB4F6FFA504C2392D17A77AF06E85A", "", dataField), Utility.getDefault(this, vars, "Documentno", "", "123", "0DEB4F6FFA504C2392D17A77AF06E85A", "", dataField), Utility.getDefault(this, vars, "SalesRep_ID", "", "123", "0DEB4F6FFA504C2392D17A77AF06E85A", "", dataField), Utility.getDefault(this, vars, "Updatedby", "", "123", "0DEB4F6FFA504C2392D17A77AF06E85A", "", dataField), OpenShipments0DEB4F6FFA504C2392D17A77AF06E85AData.selectDef76F388667AF44F80A269285C512318D2_3(this, Utility.getDefault(this, vars, "Updatedby", "", "123", "0DEB4F6FFA504C2392D17A77AF06E85A", "", dataField)), Utility.getDefault(this, vars, "Datepromised", "", "123", "0DEB4F6FFA504C2392D17A77AF06E85A", "", dataField), "Y", Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "123", "0DEB4F6FFA504C2392D17A77AF06E85A", "", dataField), Utility.getDefault(this, vars, "Scheddeliverydate", "", "123", "0DEB4F6FFA504C2392D17A77AF06E85A", "", dataField), Utility.getDefault(this, vars, "Createdby", "", "123", "0DEB4F6FFA504C2392D17A77AF06E85A", "", dataField), OpenShipments0DEB4F6FFA504C2392D17A77AF06E85AData.selectDefC55FDBC1AC4F40B990488377703B80A6_4(this, Utility.getDefault(this, vars, "Createdby", "", "123", "0DEB4F6FFA504C2392D17A77AF06E85A", "", dataField)), Utility.getDefault(this, vars, "Qtyreserved", "", "123", "0DEB4F6FFA504C2392D17A77AF06E85A", "", dataField), Utility.getDefault(this, vars, "Qtyinvoiced", "", "123", "0DEB4F6FFA504C2392D17A77AF06E85A", "", dataField));
  ...
  private int saveRecord(VariablesSecureApp vars, OBError myError, char type, String strPC_Bpartner_ID) throws IOException, ServletException {
    ...
    if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        strSequence = vars.getStringParameter("inpnewdataseIdVal");
          ...
          CrudOperations.UpdateCustomFields(tabId, data.zssiOpenshipmentId, vars, this,con);
