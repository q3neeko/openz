...
String strParamMovementDate_f = vars.getSessionValue(tabId + "|paramMovementDate_f");
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = HeaderData.set(Utility.getDefault(this, vars, "AD_Org_ID", "@AD_Org_ID@", "170", "259", "", dataField), Utility.getDefault(this, vars, "Description", "", "170", "259", "", dataField), Utility.getDefault(this, vars, "User2_ID", "", "170", "259", "", dataField), Utility.getDefault(this, vars, "C_Campaign_ID", "", "170", "259", "", dataField), Utility.getDefault(this, vars, "Posted", "", "170", "259", "N", dataField), (vars.getLanguage().equals("en_US")?ListData.selectName(this, "234", Utility.getDefault(this, vars, "Posted", "", "170", "259", "N", dataField)):ListData.selectNameTrl(this, vars.getLanguage(), "234", Utility.getDefault(this, vars, "Posted", "", "170", "259", "N", dataField))), Utility.getDefault(this, vars, "Processed", "", "170", "259", "N", dataField), Utility.getDefault(this, vars, "AD_OrgTrx_ID", "", "170", "259", "", dataField), Utility.getDefault(this, vars, "Move_FromTo_Locator", "N", "170", "259", "N", dataField), "", Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "170", "259", "", dataField), "Y", Utility.getDefault(this, vars, "Processing", "", "170", "259", "N", dataField), Utility.getDefault(this, vars, "UpdatedBy", "", "170", "259", "", dataField), HeaderData.selectDef3575_0(this, Utility.getDefault(this, vars, "UpdatedBy", "", "170", "259", "", dataField)), Utility.getDefault(this, vars, "C_Project_ID", "", "170", "259", "", dataField), HeaderData.selectDef9548_1(this, Utility.getDefault(this, vars, "C_Project_ID", "", "170", "259", "", dataField)), Utility.getDefault(this, vars, "CreatedBy", "", "170", "259", "", dataField), HeaderData.selectDef3574_2(this, Utility.getDefault(this, vars, "CreatedBy", "", "170", "259", "", dataField)), Utility.getDefault(this, vars, "MovementDate", "@#Date@", "170", "259", "", dataField), Utility.getDefault(this, vars, "DocumentNo", "", "170", "259", "", dataField), Utility.getDefault(this, vars, "Name", "@#Date@", "170", "259", "", dataField), Utility.getDefault(this, vars, "C_Activity_ID", "", "170", "259", "", dataField), Utility.getDefault(this, vars, "User1_ID", "", "170", "259", "", dataField));
  ...
  private int saveRecord(VariablesSecureApp vars, OBError myError, char type) throws IOException, ServletException {
    ...
    if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        strSequence = vars.getStringParameter("inpnewdataseIdVal");
          ...
          CrudOperations.UpdateCustomFields(tabId, data.mMovementId, vars, this,con);
