...
String strParamC_Currency_ID = vars.getSessionValue(tabId + "|paramC_Currency_ID");
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = BankAccountData.set(strPC_Bank_ID, Utility.getDefault(this, vars, "CurrentBalance", "", "158", "228", "", dataField), Utility.getDefault(this, vars, "C_Currency_ID", "", "158", "228", "", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_Client_ID@", "158", "228", "", dataField), Utility.getDefault(this, vars, "AccountNo", "", "158", "228", "", dataField), Utility.getDefault(this, vars, "Codeaccount", "", "158", "228", "", dataField), Utility.getDefault(this, vars, "Digitcontrol", "", "158", "228", "", dataField), Utility.getDefault(this, vars, "GenericAccount", "", "158", "228", "", dataField), Utility.getDefault(this, vars, "Iban", "", "158", "228", "", dataField), Utility.getDefault(this, vars, "CdtrSchmeIdent", "", "158", "228", "", dataField), Utility.getDefault(this, vars, "ShowIBAN", "", "158", "228", "N", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_Org_ID@", "158", "228", "", dataField), Utility.getDefault(this, vars, "IsDefault", "", "158", "228", "N", dataField), Utility.getDefault(this, vars, "UpdatedBy", "", "158", "228", "", dataField), BankAccountData.selectDef3071_0(this, Utility.getDefault(this, vars, "UpdatedBy", "", "158", "228", "", dataField)), Utility.getDefault(this, vars, "Created", "", "158", "228", "", dataField), Utility.getDefault(this, vars, "ShowGeneric", "", "158", "228", "N", dataField), Utility.getDefault(this, vars, "ShowSpanish", "", "158", "228", "N", dataField), Utility.getDefault(this, vars, "CreditLimit", "", "158", "228", "", dataField), "Y", Utility.getDefault(this, vars, "BankAccountType", "", "158", "228", "", dataField), Utility.getDefault(this, vars, "DisplayedAccount", "", "158", "228", "", dataField), "", Utility.getDefault(this, vars, "CreatedBy", "", "158", "228", "", dataField), BankAccountData.selectDef3069_1(this, Utility.getDefault(this, vars, "CreatedBy", "", "158", "228", "", dataField)));
  ...
  private int saveRecord(VariablesSecureApp vars, OBError myError, char type, String strPC_Bank_ID) throws IOException, ServletException {
    ...
    if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        strSequence = vars.getStringParameter("inpnewdataseIdVal");
          ...
          CrudOperations.UpdateCustomFields(tabId, data.cBankaccountId, vars, this,con);
