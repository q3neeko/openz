...
public class EmployeeCalendarOverview extends HttpSecureAppServlet {
  private static final long serialVersionUID = 1L;
  
  private static Logger log4j = Logger.getLogger(EmployeeCalendarOverview.class);
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strView = vars.getSessionValue(tabId + "|EmployeeCalendarOverview.view");
      if (strView.equals("")) {
      ...
      if (vars.commandIn("DIRECT")){
        vars.setSessionValue(tabId + "|EmployeeCalendarOverview.view", "EDIT");

        printPageEdit(response, request, vars, false, strC_Bpartneremployeeevent_ID, tableSQL);
      }
      if (vars.commandIn("DIRECTRELATION")){
        vars.setSessionValue(tabId + "|EmployeeCalendarOverview.view", "RELATION");
      ...
      if (strView.equals("EDIT")) {
        ...
        if (strC_Bpartneremployeeevent_ID.equals("")) {
          ...
          vars.setSessionValue(tabId + "|EmployeeCalendarOverview.view", strView);
        }
      }
      ...
      vars.setSessionValue(tabId + "|EmployeeCalendarOverview.initRecordNumber", "0");
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
    } else if (vars.commandIn("PREVIOUS_RELATION")) {

      String strInitRecord = vars.getSessionValue(tabId + "|EmployeeCalendarOverview.initRecordNumber");
      ...
      if (strInitRecord.equals("") || strInitRecord.equals("0")) {
        ...
        vars.setSessionValue(tabId + "|EmployeeCalendarOverview.initRecordNumber", strInitRecord);
      }
      vars.removeSessionValue(windowId + "|C_Bpartneremployeeevent_ID");
      ...
      String strC_Bpartneremployeeevent_ID = vars.getRequiredStringParameter("inpcBpartneremployeeeventId");
      //EmployeeCalendarOverviewData data = getEditVariables(vars);
      int total = 0;
      ...
      if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        try {
          total = EmployeeCalendarOverviewData.delete(this, strC_Bpartneremployeeevent_ID, Utility.getContext(this, vars, "#User_Client", windowId, accesslevel), Utility.getContext(this, vars, "#User_Org", windowId, accesslevel));
  ...
  private EmployeeCalendarOverviewData getEditVariables(Connection con, VariablesSecureApp vars) throws IOException,ServletException {
   ...
   private EmployeeCalendarOverviewData[] getRelationData(EmployeeCalendarOverviewData[] data) {
    if (data!=null) {
    ...
    private void refreshSessionNew(VariablesSecureApp vars) throws IOException,ServletException {
      EmployeeCalendarOverviewData[] data = EmployeeCalendarOverviewData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), vars.getStringParameter("inpcBpartneremployeeeventId", ""), Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      if (data==null || data.length==0) return;
...
String strParamDateto_f = vars.getSessionValue(tabId + "|paramDateto_f");
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/EmployeeCalendarEvents/EmployeeCalendarOverview_Relation", discard).createXmlDocument();

    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "EmployeeCalendarOverview", false, "document.frmMain.inpcBpartneremployeeeventId", "grid", "..", "".equals("Y"), "EmployeeCalendarEvents", strReplaceWith, false);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "EmployeeCalendarOverview_Relation.html", "EmployeeCalendarEvents", "W", strReplaceWith, tabs.breadcrumb());
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "EmployeeCalendarOverview_Relation.html", strReplaceWith);
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strC_Bpartneremployeeevent_ID, TableSQLData tableSQL)
    ...
    EmployeeCalendarOverviewData[] data=null;
...
String strParamDateto_f = vars.getSessionValue(tabId + "|paramDateto_f");
    ...
    if (dataField==null) {
      if (!boolNew) {
        ...
        data = EmployeeCalendarOverviewData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strC_Bpartneremployeeevent_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      ...
      if (boolNew || data==null || data.length==0) {
        ...
        strCommand = "NEW";
        boolNew = true;
        data = new EmployeeCalendarOverviewData[0];
      } else {
        discard[0] = new String ("newDiscard");
      }
    } else {
    ...
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "EmployeeCalendarOverview", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpcBpartneremployeeeventId", "", "..", "".equals("Y"), "EmployeeCalendarEvents", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strC_Bpartneremployeeevent_ID));
        ...
        strSequence = vars.getStringParameter("inpnewdataseIdVal");
            ...
            if (Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),data.adClientId)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),data.adOrgId)){
		     if(type == 'I') {
		       ...
		       if (EmployeeCalendarOverviewData.getCurrentDBTimestamp(this, data.cBpartneremployeeeventId).equals(
          ...
          CrudOperations.UpdateCustomFields(tabId, data.cBpartneremployeeeventId, vars, this,con);
  ...
  public String getServletInfo() {
    return "Servlet EmployeeCalendarOverview. This Servlet was made by Wad constructor";
