...
vars.getGlobalVariable("inpcInvoiceId", windowId + "|C_Invoice_ID");
  ...
  private PaymentData getEditVariables(Connection con, VariablesSecureApp vars, String strPC_Invoice_ID) throws IOException,ServletException {
   ...
   private PaymentData[] getRelationData(PaymentData[] data) {
    if (data!=null) {
      for (int i=0;i<data.length;i++) {        data[i].cCurrencyId = FormatUtilities.truncate(data[i].cCurrencyId, 44);        data[i].adClientId = FormatUtilities.truncate(data[i].adClientId, 44);        data[i].adOrgId = FormatUtilities.truncate(data[i].adOrgId, 44);        data[i].cInvoiceId = FormatUtilities.truncate(data[i].cInvoiceId, 44);        data[i].cSettlementCancelId = FormatUtilities.truncate(data[i].cSettlementCancelId, 44);        data[i].paymentrule = FormatUtilities.truncate(data[i].paymentrule, 21);        data[i].cBpartnerId = FormatUtilities.truncate(data[i].cBpartnerId, 44);        data[i].cBpBankaccountId = FormatUtilities.truncate(data[i].cBpBankaccountId, 32);        data[i].description = FormatUtilities.truncate(data[i].description, 50);        data[i].cCashbookId = FormatUtilities.truncate(data[i].cCashbookId, 44);        data[i].cCashlineId = FormatUtilities.truncate(data[i].cCashlineId, 44);        data[i].cBankstatementlineId = FormatUtilities.truncate(data[i].cBankstatementlineId, 44);        data[i].statusInitial = FormatUtilities.truncate(data[i].statusInitial, 21);        data[i].cProjectId = FormatUtilities.truncate(data[i].cProjectId, 44);        data[i].cWithholdingId = FormatUtilities.truncate(data[i].cWithholdingId, 12);        data[i].cDebtPaymentId = FormatUtilities.truncate(data[i].cDebtPaymentId, 10);        data[i].cSettlementGenerateId = FormatUtilities.truncate(data[i].cSettlementGenerateId, 44);        data[i].cBankaccountId = FormatUtilities.truncate(data[i].cBankaccountId, 44);        data[i].cGlitemId = FormatUtilities.truncate(data[i].cGlitemId, 12);        data[i].cOrderId = FormatUtilities.truncate(data[i].cOrderId, 50);        data[i].status = FormatUtilities.truncate(data[i].status, 50);}
    }
    return data;
  }
  ...
  private String getParentID(VariablesSecureApp vars, String strC_Debt_Payment_ID) throws ServletException {
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));    vars.setSessionValue(windowId + "|AD_Org_ID", data[0].getField("adOrgId"));    vars.setSessionValue(windowId + "|C_Debt_Payment_ID", data[0].getField("cDebtPaymentId"));
    }
...
String strParamAmount_f = vars.getSessionValue(tabId + "|paramAmount_f");
    ...
    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "Payment", false, "document.frmMain.inpcDebtPaymentId", "grid", "..", "".equals("Y"), "PurchaseInvoice", strReplaceWith, false);
...
String strParamAmount_f = vars.getSessionValue(tabId + "|paramAmount_f");
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = PaymentData.set(strPC_Invoice_ID, Utility.getDefault(this, vars, "C_BankStatementLine_ID", "", "183", "800036", "", dataField), Utility.getDefault(this, vars, "IsReceipt", "@IsSOTrx@", "183", "800036", "N", dataField), Utility.getDefault(this, vars, "C_Bp_Bankaccount_ID", "", "183", "800036", "", dataField), Utility.getDefault(this, vars, "IsPaid", "", "183", "800036", "N", dataField), Utility.getDefault(this, vars, "C_BankAccount_ID", "", "183", "800036", "", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "183", "800036", "", dataField), Utility.getDefault(this, vars, "Cancel_Processed", "N", "183", "800036", "N", dataField), Utility.getDefault(this, vars, "Isdirectposting", "N", "183", "800036", "N", dataField), Utility.getDefault(this, vars, "Description", "", "183", "800036", "", dataField), Utility.getDefault(this, vars, "IsValid", "", "183", "800036", "N", dataField), Utility.getDefault(this, vars, "CreatedBy", "", "183", "800036", "", dataField), PaymentData.selectDef800304_0(this, Utility.getDefault(this, vars, "CreatedBy", "", "183", "800036", "", dataField)), Utility.getDefault(this, vars, "C_Settlement_Cancel_ID", "", "183", "800036", "", dataField), Utility.getDefault(this, vars, "Dateplanned", "", "183", "800036", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "183", "800036", "", dataField), Utility.getDefault(this, vars, "Amount", "0", "183", "800036", "", dataField), Utility.getDefault(this, vars, "IsAutomaticGenerated", "", "183", "800036", "N", dataField), Utility.getDefault(this, vars, "Status_Initial", "DE", "183", "800036", "", dataField), Utility.getDefault(this, vars, "C_Project_ID", "", "183", "800036", "", dataField), Utility.getDefault(this, vars, "C_Settlement_Generate_ID", "", "183", "800036", "", dataField), Utility.getDefault(this, vars, "C_Currency_ID", "", "183", "800036", "", dataField), Utility.getDefault(this, vars, "C_CashLine_ID", "", "183", "800036", "", dataField), "Y", Utility.getDefault(this, vars, "Discountamt", "0", "183", "800036", "", dataField), Utility.getDefault(this, vars, "WriteOffAmt", "0", "183", "800036", "", dataField), "", Utility.getDefault(this, vars, "Created", "@#Date@", "183", "800036", "", dataField), Utility.getDefault(this, vars, "Isapproved", "N", "183", "800036", "N", dataField), Utility.getDefault(this, vars, "C_Glitem_ID", "", "183", "800036", "", dataField), Utility.getDefault(this, vars, "IsManual", "", "183", "800036", "N", dataField), PaymentData.selectDef800311_1(this, strPC_Invoice_ID), Utility.getDefault(this, vars, "Changesettlementcancel", "N", "183", "800036", "N", dataField), Utility.getDefault(this, vars, "Status", "DE", "183", "800036", "", dataField), Utility.getDefault(this, vars, "C_CashBook_ID", "", "183", "800036", "", dataField), Utility.getDefault(this, vars, "PaymentRule", "", "183", "800036", "", dataField), Utility.getDefault(this, vars, "Generate_Processed", "N", "183", "800036", "N", dataField), Utility.getDefault(this, vars, "C_Order_ID", "", "183", "800036", "", dataField), Utility.getDefault(this, vars, "Withholdingamount", "0", "183", "800036", "", dataField), Utility.getDefault(this, vars, "C_Withholding_ID", "", "183", "800036", "", dataField), Utility.getDefault(this, vars, "UpdatedBy", "", "183", "800036", "", dataField), PaymentData.selectDef800306_2(this, Utility.getDefault(this, vars, "UpdatedBy", "", "183", "800036", "", dataField)), Utility.getDefault(this, vars, "C_BPartner_ID", "@C_BPartner_ID@", "183", "800036", "", dataField), PaymentData.selectDef800312_3(this, Utility.getDefault(this, vars, "C_BPartner_ID", "@C_BPartner_ID@", "183", "800036", "", dataField)), Utility.getDefault(this, vars, "GLItemAmt", "0", "183", "800036", "", dataField));
    ...
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "Payment", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpcDebtPaymentId", "", "..", "".equals("Y"), "PurchaseInvoice", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strC_Debt_Payment_ID));
  ...
  private int saveRecord(VariablesSecureApp vars, OBError myError, char type, String strPC_Invoice_ID) throws IOException, ServletException {
    ...
    if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        strSequence = vars.getStringParameter("inpnewdataseIdVal");
          ...
          CrudOperations.UpdateCustomFields(tabId, data.cDebtPaymentId, vars, this,con);
