...
public class Menuarrangement extends HttpSecureAppServlet {
  private static final long serialVersionUID = 1L;
  
  private static Logger log4j = Logger.getLogger(Menuarrangement.class);
  
  private static final String windowId = "163";
  private static final String tabId = "73991C4EB5B84DB08948C4C0B9122CD1";
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strView = vars.getSessionValue(tabId + "|Menuarrangement.view");
      if (strView.equals("")) {
      ...
      if (vars.commandIn("DIRECT")){
        vars.setSessionValue(tabId + "|Menuarrangement.view", "EDIT");

        printPageEdit(response, request, vars, false, strAD_Menu_ID, tableSQL);
      }
      if (vars.commandIn("DIRECTRELATION")){
        vars.setSessionValue(tabId + "|Menuarrangement.view", "RELATION");
      ...
      if (strView.equals("EDIT")) {
        ...
        if (strAD_Menu_ID.equals("")) {
          ...
          vars.setSessionValue(tabId + "|Menuarrangement.view", strView);
        }
      }
      ...
      vars.setSessionValue(tabId + "|Menuarrangement.initRecordNumber", "0");
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
    } else if (vars.commandIn("PREVIOUS_RELATION")) {

      String strInitRecord = vars.getSessionValue(tabId + "|Menuarrangement.initRecordNumber");
      ...
      if (strInitRecord.equals("") || strInitRecord.equals("0")) {
        ...
        vars.setSessionValue(tabId + "|Menuarrangement.initRecordNumber", strInitRecord);
      }
      vars.removeSessionValue(windowId + "|AD_Menu_ID");
      ...
      String strAD_Menu_ID = vars.getRequiredStringParameter("inpadMenuId");
      //MenuarrangementData data = getEditVariables(vars);
      int total = 0;
      ...
      if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        try {
          total = MenuarrangementData.delete(this, strAD_Menu_ID, Utility.getContext(this, vars, "#User_Client", windowId, accesslevel), Utility.getContext(this, vars, "#User_Org", windowId, accesslevel));
  ...
  private MenuarrangementData getEditVariables(Connection con, VariablesSecureApp vars) throws IOException,ServletException {
    MenuarrangementData data = new MenuarrangementData();
   ...
   private MenuarrangementData[] getRelationData(MenuarrangementData[] data) {
    if (data!=null) {
    ...
    private void refreshSessionNew(VariablesSecureApp vars) throws IOException,ServletException {
      MenuarrangementData[] data = MenuarrangementData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), Utility.getContext(this, vars, "ad_tree_id", windowId), vars.getStringParameter("inpadMenuId", ""), Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      if (data==null || data.length==0) return;
...
String strParamIsActive = vars.getSessionValue(tabId + "|paramIsActive");
    ...
    if (vars.getSessionValue(windowId +  "|AD_Tree_ID").isEmpty()) vars.setSessionValue(windowId + "|AD_Tree_ID", vars.getStringParameter("inpadTreeId"));
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/TreeandNodeImage/Menuarrangement_Relation", discard).createXmlDocument();

    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "Menuarrangement", false, "document.frmMain.inpadMenuId", "grid", "..", "".equals("Y"), "TreeandNodeImage", strReplaceWith, false);
    toolbar.prepareRelationTemplate("Y".equals("Y"), hasSearchCondition, !vars.getSessionValue("#ShowTest", "N").equals("Y"), true, Utility.getContext(this, vars, "ShowAudit", windowId).equals("Y"));
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Menuarrangement_Relation.html", "TreeandNodeImage", "W", strReplaceWith, tabs.breadcrumb());
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "Menuarrangement_Relation.html", strReplaceWith);
...
String strParamIsActive = vars.getSessionValue(tabId + "|paramIsActive");
    ...
    if (dataField==null) {
      if (!boolNew) {
        ...
        data = MenuarrangementData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), Utility.getContext(this, vars, "ad_tree_id", windowId), strAD_Menu_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      ...
      if (boolNew || data==null || data.length==0) {
        ...
        strCommand = "NEW";
        boolNew = true;
        data = new MenuarrangementData[0];
      } else {
        discard[0] = new String ("newDiscard");
      }
    } else {
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = MenuarrangementData.set("0", "Y", Utility.getDefault(this, vars, "AD_Task_ID", "", "163", "73991C4EB5B84DB08948C4C0B9122CD1", "", dataField), Utility.getDefault(this, vars, "UpdatedBy", "", "163", "73991C4EB5B84DB08948C4C0B9122CD1", "", dataField), MenuarrangementData.selectDef602_0(this, Utility.getDefault(this, vars, "UpdatedBy", "", "163", "73991C4EB5B84DB08948C4C0B9122CD1", "", dataField)), Utility.getDefault(this, vars, "Description", "", "163", "73991C4EB5B84DB08948C4C0B9122CD1", "", dataField), Utility.getDefault(this, vars, "AD_Window_ID", "", "163", "73991C4EB5B84DB08948C4C0B9122CD1", "", dataField), "", Utility.getDefault(this, vars, "AD_Form_ID", "", "163", "73991C4EB5B84DB08948C4C0B9122CD1", "", dataField), Utility.getDefault(this, vars, "Action", "", "163", "73991C4EB5B84DB08948C4C0B9122CD1", "", dataField), Utility.getDefault(this, vars, "URL", "", "163", "73991C4EB5B84DB08948C4C0B9122CD1", "", dataField), Utility.getDefault(this, vars, "IsSummary", "", "163", "73991C4EB5B84DB08948C4C0B9122CD1", "N", dataField), Utility.getDefault(this, vars, "Name", "", "163", "73991C4EB5B84DB08948C4C0B9122CD1", "", dataField), MenuarrangementData.selectDef5661DEEC430EFC21E040007F01004C04(this), Utility.getDefault(this, vars, "CreatedBy", "", "163", "73991C4EB5B84DB08948C4C0B9122CD1", "", dataField), MenuarrangementData.selectDef600_1(this, Utility.getDefault(this, vars, "CreatedBy", "", "163", "73991C4EB5B84DB08948C4C0B9122CD1", "", dataField)), "0", Utility.getDefault(this, vars, "AD_Workflow_ID", "", "163", "73991C4EB5B84DB08948C4C0B9122CD1", "", dataField), Utility.getDefault(this, vars, "AD_Process_ID", "", "163", "73991C4EB5B84DB08948C4C0B9122CD1", "", dataField));
        
      }
    } else {
      data = new MenuarrangementData[1];
      java.lang.Object  ref1= dataField;
      data[0]=(MenuarrangementData) ref1;
      data[0].created="";
      data[0].updated="";
    }
    ...
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "Menuarrangement", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpadMenuId", "", "..", "".equals("Y"), "TreeandNodeImage", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strAD_Menu_ID));
    toolbar.prepareEditionTemplate("Y".equals("Y"), hasSearchCondition, vars.getSessionValue("#ShowTest", "N").equals("Y"), "RO", Utility.getContext(this, vars, "ShowAudit", windowId).equals("Y"));
        ...
        strSequence = vars.getStringParameter("inpnewdataseIdVal");
            ...
            if (Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),data.adClientId)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),data.adOrgId)){
		     if(type == 'I') {
		       ...
		       if (MenuarrangementData.getCurrentDBTimestamp(this, data.adMenuId).equals(
          ...
          CrudOperations.UpdateCustomFields(tabId, data.adMenuId, vars, this,con);
  ...
  public String getServletInfo() {
    return "Servlet Menuarrangement. This Servlet was made by Wad constructor";
