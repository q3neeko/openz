...
vars.getGlobalVariable("inpadReferenceId", windowId + "|AD_Reference_ID");
  ...
  private SimpleGridGolumnsData getEditVariables(Connection con, VariablesSecureApp vars, String strPAD_Reference_ID) throws IOException,ServletException {
    ...
    try {
    data.isactive = vars.getStringParameter("inpisactive", "N");    try {   data.line = vars.getNumericParameter("inpline");  } catch (ServletException paramEx) { ex = paramEx; }     data.name = vars.getStringParameter("inpname");     data.adElementId = vars.getStringParameter("inpadElementId");     data.adElementIdr = vars.getStringParameter("inpadElementId_R");    try {   data.colspan = vars.getNumericParameter("inpcolspan");  } catch (ServletException paramEx) { ex = paramEx; }     data.isdisplayed = vars.getStringParameter("inpisdisplayed", "N");     data.headertext = vars.getStringParameter("inpheadertext");     data.template = vars.getStringParameter("inptemplate");     data.templater = vars.getStringParameter("inptemplate_R");     data.issortable = vars.getStringParameter("inpissortable", "N");     data.isrowkey = vars.getStringParameter("inpisrowkey", "N");     data.rowkeysuffix = vars.getStringParameter("inprowkeysuffix");     data.style = vars.getStringParameter("inpstyle");     data.required = vars.getStringParameter("inprequired", "N");     data.colreference = vars.getStringParameter("inpcolreference");     data.adValRuleId = vars.getStringParameter("inpadValRuleId");     data.adTableId = vars.getStringParameter("inpadTableId");     data.adReferenceId = vars.getStringParameter("inpadReferenceId");     data.includesemptyitem = vars.getStringParameter("inpincludesemptyitem", "N");     data.adRefGroupId = vars.getStringParameter("inpadRefGroupId");     data.referenceurl = vars.getStringParameter("inpreferenceurl");     data.adOrgId = vars.getRequestGlobalVariable("inpadOrgId", windowId + "|AD_Org_ID");     data.readonlylogic = vars.getStringParameter("inpreadonlylogic");     data.adRefGridcolumnId = vars.getRequestGlobalVariable("inpadRefGridcolumnId", windowId + "|AD_Ref_Gridcolumn_ID");     data.mandantorylogic = vars.getStringParameter("inpmandantorylogic");     data.readonly = vars.getStringParameter("inpreadonly", "N");     data.dynamiccolssql = vars.getStringParameter("inpdynamiccolssql");     data.issecondheader = vars.getStringParameter("inpissecondheader", "N");     data.defaultvalue = vars.getStringParameter("inpdefaultvalue");     data.adClientId = vars.getRequestGlobalVariable("inpadClientId", windowId + "|AD_Client_ID");     data.isinheader = vars.getStringParameter("inpisinheader", "N");    try {   data.maxlength = vars.getNumericParameter("inpmaxlength");  } catch (ServletException paramEx) { ex = paramEx; }     data.onchangeevent = vars.getStringParameter("inponchangeevent");     data.issplitgroup = vars.getStringParameter("inpissplitgroup", "N"); 
   ...
   private SimpleGridGolumnsData[] getRelationData(SimpleGridGolumnsData[] data) {
    if (data!=null) {
      for (int i=0;i<data.length;i++) {        data[i].name = FormatUtilities.truncate(data[i].name, 50);        data[i].adElementId = FormatUtilities.truncate(data[i].adElementId, 32);        data[i].headertext = FormatUtilities.truncate(data[i].headertext, 50);        data[i].template = FormatUtilities.truncate(data[i].template, 50);        data[i].rowkeysuffix = FormatUtilities.truncate(data[i].rowkeysuffix, 20);        data[i].style = FormatUtilities.truncate(data[i].style, 50);        data[i].colreference = FormatUtilities.truncate(data[i].colreference, 32);        data[i].adValRuleId = FormatUtilities.truncate(data[i].adValRuleId, 32);        data[i].adTableId = FormatUtilities.truncate(data[i].adTableId, 32);        data[i].adReferenceId = FormatUtilities.truncate(data[i].adReferenceId, 32);        data[i].adRefGroupId = FormatUtilities.truncate(data[i].adRefGroupId, 32);        data[i].referenceurl = FormatUtilities.truncate(data[i].referenceurl, 50);        data[i].adOrgId = FormatUtilities.truncate(data[i].adOrgId, 32);        data[i].readonlylogic = FormatUtilities.truncate(data[i].readonlylogic, 50);        data[i].adRefGridcolumnId = FormatUtilities.truncate(data[i].adRefGridcolumnId, 32);        data[i].mandantorylogic = FormatUtilities.truncate(data[i].mandantorylogic, 50);        data[i].dynamiccolssql = FormatUtilities.truncate(data[i].dynamiccolssql, 50);        data[i].defaultvalue = FormatUtilities.truncate(data[i].defaultvalue, 50);        data[i].adClientId = FormatUtilities.truncate(data[i].adClientId, 32);        data[i].onchangeevent = FormatUtilities.truncate(data[i].onchangeevent, 50);}
    }
    return data;
  }
  ...
  private String getParentID(VariablesSecureApp vars, String strAD_Ref_Gridcolumn_ID) throws ServletException {
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|AD_Org_ID", data[0].getField("adOrgId"));    vars.setSessionValue(windowId + "|AD_Ref_Gridcolumn_ID", data[0].getField("adRefGridcolumnId"));    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));
    }
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strAD_Ref_Gridcolumn_ID, String strPAD_Reference_ID, TableSQLData tableSQL)
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = SimpleGridGolumnsData.set(strPAD_Reference_ID, Utility.getDefault(this, vars, "Isinheader", "N", "101", "E55966B29F8D426E85F56C1EF7456A2C", "N", dataField), Utility.getDefault(this, vars, "Updatedby", "", "101", "E55966B29F8D426E85F56C1EF7456A2C", "", dataField), SimpleGridGolumnsData.selectDef80B39AFB5F564DDAA7D2333503751AD7_0(this, Utility.getDefault(this, vars, "Updatedby", "", "101", "E55966B29F8D426E85F56C1EF7456A2C", "", dataField)), Utility.getDefault(this, vars, "AD_Element_ID", "", "101", "E55966B29F8D426E85F56C1EF7456A2C", "", dataField), Utility.getDefault(this, vars, "Issecondheader", "N", "101", "E55966B29F8D426E85F56C1EF7456A2C", "N", dataField), "0", Utility.getDefault(this, vars, "Headertext", "", "101", "E55966B29F8D426E85F56C1EF7456A2C", "", dataField), "0", Utility.getDefault(this, vars, "AD_Val_Rule_ID", "", "101", "E55966B29F8D426E85F56C1EF7456A2C", "", dataField), Utility.getDefault(this, vars, "Isrowkey", "N", "101", "E55966B29F8D426E85F56C1EF7456A2C", "N", dataField), Utility.getDefault(this, vars, "Rowkeysuffix", "", "101", "E55966B29F8D426E85F56C1EF7456A2C", "", dataField), Utility.getDefault(this, vars, "Required", "N", "101", "E55966B29F8D426E85F56C1EF7456A2C", "N", dataField), Utility.getDefault(this, vars, "AD_Table_ID", "", "101", "E55966B29F8D426E85F56C1EF7456A2C", "", dataField), Utility.getDefault(this, vars, "Isdisplayed", "Y", "101", "E55966B29F8D426E85F56C1EF7456A2C", "N", dataField), Utility.getDefault(this, vars, "Includesemptyitem", "N", "101", "E55966B29F8D426E85F56C1EF7456A2C", "N", dataField), Utility.getDefault(this, vars, "ReadOnly", "N", "101", "E55966B29F8D426E85F56C1EF7456A2C", "N", dataField), Utility.getDefault(this, vars, "Name", "", "101", "E55966B29F8D426E85F56C1EF7456A2C", "", dataField), Utility.getDefault(this, vars, "Referenceurl", "", "101", "E55966B29F8D426E85F56C1EF7456A2C", "", dataField), Utility.getDefault(this, vars, "Mandantorylogic", "", "101", "E55966B29F8D426E85F56C1EF7456A2C", "", dataField), Utility.getDefault(this, vars, "Readonlylogic", "", "101", "E55966B29F8D426E85F56C1EF7456A2C", "", dataField), Utility.getDefault(this, vars, "Createdby", "", "101", "E55966B29F8D426E85F56C1EF7456A2C", "", dataField), SimpleGridGolumnsData.selectDefC531C9F2EC594BD280D6D97AFD0A60CC_1(this, Utility.getDefault(this, vars, "Createdby", "", "101", "E55966B29F8D426E85F56C1EF7456A2C", "", dataField)), Utility.getDefault(this, vars, "colreference", "", "101", "E55966B29F8D426E85F56C1EF7456A2C", "", dataField), "Y", Utility.getDefault(this, vars, "MaxLength", "0", "101", "E55966B29F8D426E85F56C1EF7456A2C", "", dataField), SimpleGridGolumnsData.selectDef8C68026A92AE4C2FAE5001D12D74C6BE(this, Utility.getContext(this, vars, "ad_ref_group_id", "101")), Utility.getDefault(this, vars, "Colspan", "0", "101", "E55966B29F8D426E85F56C1EF7456A2C", "", dataField), "", Utility.getDefault(this, vars, "Issortable", "Y", "101", "E55966B29F8D426E85F56C1EF7456A2C", "N", dataField), Utility.getDefault(this, vars, "Style", "", "101", "E55966B29F8D426E85F56C1EF7456A2C", "", dataField), Utility.getDefault(this, vars, "Onchangeevent", "", "101", "E55966B29F8D426E85F56C1EF7456A2C", "", dataField), Utility.getDefault(this, vars, "Dynamiccolssql", "", "101", "E55966B29F8D426E85F56C1EF7456A2C", "", dataField), Utility.getDefault(this, vars, "Defaultvalue", "", "101", "E55966B29F8D426E85F56C1EF7456A2C", "", dataField), Utility.getDefault(this, vars, "AD_Ref_Group_ID", "", "101", "E55966B29F8D426E85F56C1EF7456A2C", "", dataField), Utility.getDefault(this, vars, "Template", "", "101", "E55966B29F8D426E85F56C1EF7456A2C", "", dataField), Utility.getDefault(this, vars, "Issplitgroup", "N", "101", "E55966B29F8D426E85F56C1EF7456A2C", "N", dataField));
