...
public class PartialPayment extends HttpSecureAppServlet {
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      vars.setSessionValue(windowId + "|C_PaymentTerm_ID", strPC_PaymentTerm_ID);
      vars.setSessionValue("184|Payment Terms.view", "EDIT");
...
vars.getGlobalVariable("inpcPaymenttermId", windowId + "|C_PaymentTerm_ID");
  ...
  private void refreshParentSession(VariablesSecureApp vars, String strPC_PaymentTerm_ID) throws IOException,ServletException {
      PaymentTermsData[] data = PaymentTermsData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPC_PaymentTerm_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
...
String strParamLine_f = vars.getSessionValue(tabId + "|paramLine_f");
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = PartialPaymentData.set(strPC_PaymentTerm_ID, "", Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "141", "800074", "", dataField), "Y", Utility.getDefault(this, vars, "Fixmonthday3", "", "141", "800074", "", dataField), Utility.getDefault(this, vars, "Onremainder", "Y", "141", "800074", "N", dataField), Utility.getDefault(this, vars, "FixMonthDay2", "", "141", "800074", "", dataField), Utility.getDefault(this, vars, "Createdby", "", "141", "800074", "", dataField), PartialPaymentData.selectDef801024_0(this, Utility.getDefault(this, vars, "Createdby", "", "141", "800074", "", dataField)), Utility.getDefault(this, vars, "PaymentRule", "", "141", "800074", "", dataField), Utility.getDefault(this, vars, "FixMonthCutoff", "", "141", "800074", "", dataField), Utility.getDefault(this, vars, "NetDay", "", "141", "800074", "", dataField), PartialPaymentData.selectDef801028(this, strPC_PaymentTerm_ID), Utility.getDefault(this, vars, "Excludetax", "N", "141", "800074", "N", dataField), Utility.getDefault(this, vars, "NetDays", "", "141", "800074", "", dataField), Utility.getDefault(this, vars, "Updatedby", "", "141", "800074", "", dataField), PartialPaymentData.selectDef801026_1(this, Utility.getDefault(this, vars, "Updatedby", "", "141", "800074", "", dataField)), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "141", "800074", "", dataField), Utility.getDefault(this, vars, "Percentage", "100", "141", "800074", "", dataField), Utility.getDefault(this, vars, "IsNextBusinessDay", "Y", "141", "800074", "N", dataField), Utility.getDefault(this, vars, "IsDueFixed", "N", "141", "800074", "N", dataField), Utility.getDefault(this, vars, "FixMonthOffset", "", "141", "800074", "", dataField), Utility.getDefault(this, vars, "FixMonthDay", "", "141", "800074", "", dataField));
    ...
    String currentPOrg=PaymentTermsData.selectOrg(this, strPC_PaymentTerm_ID);
  ...
  private int saveRecord(VariablesSecureApp vars, OBError myError, char type, String strPC_PaymentTerm_ID) throws IOException, ServletException {
    ...
    if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        strSequence = vars.getStringParameter("inpnewdataseIdVal");
          ...
          CrudOperations.UpdateCustomFields(tabId, data.cPaymenttermlineId, vars, this,con);
