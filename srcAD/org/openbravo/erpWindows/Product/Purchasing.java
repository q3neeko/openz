...
String strParamC_BPartner_ID = vars.getSessionValue(tabId + "|paramC_BPartner_ID");
    ...
    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "Purchasing", false, "document.frmMain.inpmProductPoId", "grid", "../purchasesubtab/print.html", "N".equals("Y"), "Product", strReplaceWith, false);
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strM_Product_PO_ID, String strPM_Product_ID, TableSQLData tableSQL)
    ...
    String orderClause = "  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table3.Value), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table3.Name), ''))),'') )";
...
String strParamC_BPartner_ID = vars.getSessionValue(tabId + "|paramC_BPartner_ID");
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = PurchasingData.set(strPM_Product_ID, Utility.getDefault(this, vars, "CreatedBy", "", "140", "239", "", dataField), PurchasingData.selectDef2314_0(this, Utility.getDefault(this, vars, "CreatedBy", "", "140", "239", "", dataField)), Utility.getDefault(this, vars, "CostPerOrder", "", "140", "239", "", dataField), PurchasingData.selectDef1420_1(this, strPM_Product_ID), Utility.getDefault(this, vars, "VendorCategory", "", "140", "239", "", dataField), Utility.getDefault(this, vars, "PriceLastInv", "", "140", "239", "", dataField), Utility.getDefault(this, vars, "DeliveryTime_Actual", "", "140", "239", "", dataField), "Y", Utility.getDefault(this, vars, "UpdatedBy", "", "140", "239", "", dataField), PurchasingData.selectDef2316_2(this, Utility.getDefault(this, vars, "UpdatedBy", "", "140", "239", "", dataField)), Utility.getDefault(this, vars, "Qtylastpo", "0", "140", "239", "", dataField), Utility.getDefault(this, vars, "ismultipleofminimumqty", "'N'", "140", "239", "N", dataField), Utility.getDefault(this, vars, "UPC", "", "140", "239", "", dataField), Utility.getDefault(this, vars, "QualityRating", "", "140", "239", "", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "140", "239", "", dataField), Utility.getDefault(this, vars, "Capacity", "", "140", "239", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_Org_ID@", "140", "239", "", dataField), Utility.getDefault(this, vars, "manufacturernumber", "", "140", "239", "", dataField), Utility.getDefault(this, vars, "C_BPartner_ID", "", "140", "239", "", dataField), PurchasingData.selectDef2705_3(this, Utility.getDefault(this, vars, "C_BPartner_ID", "", "140", "239", "", dataField)), Utility.getDefault(this, vars, "C_UOM_ID", "", "140", "239", "", dataField), Utility.getDefault(this, vars, "DiscontinuedBy", "", "140", "239", "", dataField), Utility.getDefault(this, vars, "Minimpositionvalue", "", "140", "239", "", dataField), Utility.getDefault(this, vars, "Order_Min", "", "140", "239", "", dataField), Utility.getDefault(this, vars, "IsCurrentVendor", "Y", "140", "239", "N", dataField), "", Utility.getDefault(this, vars, "PriceEffective", "", "140", "239", "", dataField), Utility.getDefault(this, vars, "PriceList", "", "140", "239", "", dataField), Utility.getDefault(this, vars, "PricePO", "", "140", "239", "", dataField), Utility.getDefault(this, vars, "Discontinued", "", "140", "239", "N", dataField), Utility.getDefault(this, vars, "Order_Pack", "", "140", "239", "", dataField), Utility.getDefault(this, vars, "M_Manufacturer_ID", "", "140", "239", "", dataField), Utility.getDefault(this, vars, "PriceLastPO", "", "140", "239", "", dataField), Utility.getDefault(this, vars, "VendorProductNo", "@Value@", "140", "239", "", dataField), Utility.getDefault(this, vars, "C_Currency_ID", "", "140", "239", "", dataField), Utility.getDefault(this, vars, "Qtystd", "", "140", "239", "", dataField), Utility.getDefault(this, vars, "RoyaltyAmt", "", "140", "239", "", dataField), Utility.getDefault(this, vars, "DeliveryTime_Promised", "", "140", "239", "", dataField));
    ...
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "Purchasing", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpmProductPoId", "", "../purchasesubtab/print.html", "N".equals("Y"), "Product", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strM_Product_PO_ID));
  ...
  private int saveRecord(VariablesSecureApp vars, OBError myError, char type, String strPM_Product_ID) throws IOException, ServletException {
    ...
    if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        strSequence = vars.getStringParameter("inpnewdataseIdVal");
          ...
          CrudOperations.UpdateCustomFields(tabId, data.mProductPoId, vars, this,con);
