...
public class Product extends HttpSecureAppServlet {
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
     ...
     } else if (vars.commandIn("BUTTONGenerateorder744F145CB414442C9AE94CD0E0306A3A")) {
        vars.setSessionValue("button744F145CB414442C9AE94CD0E0306A3A.strgenerateorder", vars.getStringParameter("inpgenerateorder"));
        vars.setSessionValue("button744F145CB414442C9AE94CD0E0306A3A.strProcessing", vars.getStringParameter("inpprocessing", "Y"));
        vars.setSessionValue("button744F145CB414442C9AE94CD0E0306A3A.strOrg", vars.getStringParameter("inpadOrgId"));
        vars.setSessionValue("button744F145CB414442C9AE94CD0E0306A3A.strClient", vars.getStringParameter("inpadClientId"));
        
        
        HashMap<String, String> p = new HashMap<String, String>();
        p.put("AD_Client_ID", vars.getStringParameter("inpadClientId"));
p.put("m_product_id", vars.getStringParameter("inpmProductId"));

        
        //Save in session needed params for combos if needed
        vars.setSessionObject("button744F145CB414442C9AE94CD0E0306A3A.originalParams", FieldProviderFactory.getFieldProvider(p));
        printPageButtonFS(response, vars, "744F145CB414442C9AE94CD0E0306A3A", request.getServletPath());    
     } else if (vars.commandIn("BUTTON744F145CB414442C9AE94CD0E0306A3A")) {
        String strM_Product_ID = vars.getGlobalVariable("inpmProductId", windowId + "|M_Product_ID", "");
        String strgenerateorder = vars.getSessionValue("button744F145CB414442C9AE94CD0E0306A3A.strgenerateorder");
        String strProcessing = vars.getSessionValue("button744F145CB414442C9AE94CD0E0306A3A.strProcessing");
        String strOrg = vars.getSessionValue("button744F145CB414442C9AE94CD0E0306A3A.strOrg");
        String strClient = vars.getSessionValue("button744F145CB414442C9AE94CD0E0306A3A.strClient");
        ...
        if ((org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) || !(Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),strClient)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),strOrg))){
          ...
          printPageButtonGenerateorder744F145CB414442C9AE94CD0E0306A3A(response, vars, strM_Product_ID, strgenerateorder, strProcessing);
        }
    ...
    } else if (vars.commandIn("SAVE_BUTTONGenerateorder744F145CB414442C9AE94CD0E0306A3A")) {
        ...
        try {
          ...
          PInstanceProcessData.insertPInstance(this, pinstance, "744F145CB414442C9AE94CD0E0306A3A", (("M_Product_ID".equalsIgnoreCase("AD_Language"))?"0":strM_Product_ID), strProcessing, vars.getUser(), vars.getClient(), vars.getOrg());
...
PInstanceProcessData.insertPInstanceParam(this, pinstance, "10", "ordertype", strordertype, vars.getClient(), vars.getOrg(), vars.getUser());
String strmProductPoId = vars.getStringParameter("inpmProductPoId");
PInstanceProcessData.insertPInstanceParam(this, pinstance, "20", "m_product_po_id", strmProductPoId, vars.getClient(), vars.getOrg(), vars.getUser());
String strqtyordered = vars.getNumericParameter("inpqtyordered");
PInstanceProcessData.insertPInstanceParamNumber(this, pinstance, "30", "qtyordered", strqtyordered, vars.getClient(), vars.getOrg(), vars.getUser());
...
String strParamAD_Org_ID = vars.getSessionValue(tabId + "|paramAD_Org_ID");
    ...
    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "Product", false, "document.frmMain.inpmProductId", "grid", "../products/print.html", "N".equals("Y"), "Product", strReplaceWith, false);
...
String strParamAD_Org_ID = vars.getSessionValue(tabId + "|paramAD_Org_ID");
    ...
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "Product", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpmProductId", "", "../products/print.html", "N".equals("Y"), "Product", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strM_Product_ID));
  ...
  void printPageButtonFS(HttpServletResponse response, VariablesSecureApp vars, String strProcessId, String path) throws IOException, ServletException {
    ...
    void printPageButtonGenerateorder744F145CB414442C9AE94CD0E0306A3A(HttpServletResponse response, VariablesSecureApp vars, String strM_Product_ID, String strgenerateorder, String strProcessing)
    throws IOException, ServletException {
    ...
    Scripthelper script = new Scripthelper();
      ...
      try {
        String name= LocalizationUtils.getProcessTitle(this, "744F145CB414442C9AE94CD0E0306A3A",vars.getLanguage());
        String info = LocalizationUtils.getProcessInfo(this, "744F145CB414442C9AE94CD0E0306A3A" ,vars.getLanguage());
        if (! info.isEmpty())
        ...
        strFG=strFG + fh.prepareProcessParameters(this, vars, script,"744F145CB414442C9AE94CD0E0306A3A" );
        String isDocAction=UtilsData.isProcessDocAction(this, "744F145CB414442C9AE94CD0E0306A3A");
        ...
        String isJasper=UtilsData.isProcessJasper(this, "744F145CB414442C9AE94CD0E0306A3A");
        if (isJasper.equals("N"))
          strActionButtons= strActionButtons + ConfigureButton.doConfigure(this,vars,script,"buttonok",1,1,false, "ok",  "submitThisPage('SAVE_BUTTONGenerateorder" + "744F145CB414442C9AE94CD0E0306A3A" + "');", "","") + "";
        else
        ...
        script.addHiddenfield("inpadProcessId", "744F145CB414442C9AE94CD0E0306A3A");
        script.addHiddenfield("inpKey",strM_Product_ID);
        script.addHiddenfield("inpprocessing",strProcessing);
        OBError myMessage = vars.getMessage("744F145CB414442C9AE94CD0E0306A3A");
        vars.removeMessage("744F145CB414442C9AE94CD0E0306A3A");
        if (myMessage!=null) {
