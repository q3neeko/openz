...
vars.getGlobalVariable("inpmProductPoId", windowId + "|M_Product_Po_ID");
  ...
  private PriceHistoryData getEditVariables(Connection con, VariablesSecureApp vars, String strPM_Product_Po_ID) throws IOException,ServletException {
    ...
    try {
    data.mProductPoId = vars.getStringParameter("inpmProductPoId");     data.mProductPoIdr = vars.getStringParameter("inpmProductPoId_R");    try {   data.pricelist = vars.getNumericParameter("inppricelist");  } catch (ServletException paramEx) { ex = paramEx; }    try {   data.pricepo = vars.getNumericParameter("inppricepo");  } catch (ServletException paramEx) { ex = paramEx; }    try {   data.pricelastpo = vars.getNumericParameter("inppricelastpo");  } catch (ServletException paramEx) { ex = paramEx; }    try {   data.qtypo = vars.getNumericParameter("inpqtypo");  } catch (ServletException paramEx) { ex = paramEx; }     data.validfrom = vars.getDateParameter("inpvalidfrom",this);    try {   data.qualityrating = vars.getNumericParameter("inpqualityrating");  } catch (ServletException paramEx) { ex = paramEx; }     data.cBpartnerId = vars.getStringParameter("inpcBpartnerId");     data.adOrgId = vars.getRequestGlobalVariable("inpadOrgId", windowId + "|AD_Org_ID");     data.isactive = vars.getStringParameter("inpisactive", "N");     data.mProductPoHistoryId = vars.getRequestGlobalVariable("inpmProductPoHistoryId", windowId + "|M_Product_Po_History_ID");     data.adClientId = vars.getRequestGlobalVariable("inpadClientId", windowId + "|AD_Client_ID");     data.mProductId = vars.getStringParameter("inpmProductId"); 
   ...
   private PriceHistoryData[] getRelationData(PriceHistoryData[] data) {
    if (data!=null) {
      for (int i=0;i<data.length;i++) {        data[i].mProductPoId = FormatUtilities.truncate(data[i].mProductPoId, 32);        data[i].cBpartnerId = FormatUtilities.truncate(data[i].cBpartnerId, 32);        data[i].adOrgId = FormatUtilities.truncate(data[i].adOrgId, 32);        data[i].mProductPoHistoryId = FormatUtilities.truncate(data[i].mProductPoHistoryId, 32);        data[i].adClientId = FormatUtilities.truncate(data[i].adClientId, 32);        data[i].mProductId = FormatUtilities.truncate(data[i].mProductId, 32);}
    }
    return data;
  }
...
String strParamValidfrom_f = vars.getSessionValue(tabId + "|paramValidfrom_f");
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = PriceHistoryData.set(strPM_Product_Po_ID, Utility.getDefault(this, vars, "Validfrom", "", "140", "5E1C30D049254B4DAFF5D8B9DD5EDBF9", "", dataField), Utility.getDefault(this, vars, "Updatedby", "", "140", "5E1C30D049254B4DAFF5D8B9DD5EDBF9", "", dataField), PriceHistoryData.selectDef7E75B50B662B4C628C5960F16D3DEC22_0(this, Utility.getDefault(this, vars, "Updatedby", "", "140", "5E1C30D049254B4DAFF5D8B9DD5EDBF9", "", dataField)), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "140", "5E1C30D049254B4DAFF5D8B9DD5EDBF9", "", dataField), Utility.getDefault(this, vars, "Pricelist", "0", "140", "5E1C30D049254B4DAFF5D8B9DD5EDBF9", "", dataField), Utility.getDefault(this, vars, "M_Product_ID", "", "140", "5E1C30D049254B4DAFF5D8B9DD5EDBF9", "", dataField), Utility.getDefault(this, vars, "Createdby", "", "140", "5E1C30D049254B4DAFF5D8B9DD5EDBF9", "", dataField), PriceHistoryData.selectDef0159BAE1C67F4700B8AF3F96579AB04C_1(this, Utility.getDefault(this, vars, "Createdby", "", "140", "5E1C30D049254B4DAFF5D8B9DD5EDBF9", "", dataField)), Utility.getDefault(this, vars, "Pricepo", "0", "140", "5E1C30D049254B4DAFF5D8B9DD5EDBF9", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "140", "5E1C30D049254B4DAFF5D8B9DD5EDBF9", "", dataField), Utility.getDefault(this, vars, "C_Bpartner_ID", "", "140", "5E1C30D049254B4DAFF5D8B9DD5EDBF9", "", dataField), Utility.getDefault(this, vars, "Qtypo", "0", "140", "5E1C30D049254B4DAFF5D8B9DD5EDBF9", "", dataField), "", Utility.getDefault(this, vars, "Pricelastpo", "0", "140", "5E1C30D049254B4DAFF5D8B9DD5EDBF9", "", dataField), "Y", Utility.getDefault(this, vars, "Qualityrating", "", "140", "5E1C30D049254B4DAFF5D8B9DD5EDBF9", "", dataField));
  ...
  private int saveRecord(VariablesSecureApp vars, OBError myError, char type, String strPM_Product_Po_ID) throws IOException, ServletException {
    ...
    if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        strSequence = vars.getStringParameter("inpnewdataseIdVal");
          ...
          CrudOperations.UpdateCustomFields(tabId, data.mProductPoHistoryId, vars, this,con);
