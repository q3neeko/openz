...
String strParamM_PriceList_Version_ID = vars.getSessionValue(tabId + "|paramM_PriceList_Version_ID");
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = PriceData.set(strPM_Product_ID, PriceData.selectDef2064_0(this, strPM_Product_ID), Utility.getDefault(this, vars, "PriceList", "", "140", "183", "", dataField), Utility.getDefault(this, vars, "C_Uom_ID", "", "140", "183", "", dataField), Utility.getDefault(this, vars, "PriceStd", "", "140", "183", "", dataField), "Y", Utility.getDefault(this, vars, "PriceLimit", "", "140", "183", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_Org_ID@", "140", "183", "", dataField), Utility.getDefault(this, vars, "CreatedBy", "", "140", "183", "", dataField), PriceData.selectDef2060_1(this, Utility.getDefault(this, vars, "CreatedBy", "", "140", "183", "", dataField)), Utility.getDefault(this, vars, "M_PriceList_Version_ID", "", "140", "183", "", dataField), "", Utility.getDefault(this, vars, "AD_Client_ID", "@AD_Client_ID@", "140", "183", "", dataField), Utility.getDefault(this, vars, "UpdatedBy", "", "140", "183", "", dataField), PriceData.selectDef2062_2(this, Utility.getDefault(this, vars, "UpdatedBy", "", "140", "183", "", dataField)));
  ...
  private int saveRecord(VariablesSecureApp vars, OBError myError, char type, String strPM_Product_ID) throws IOException, ServletException {
    ...
    if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        strSequence = vars.getStringParameter("inpnewdataseIdVal");
          ...
          CrudOperations.UpdateCustomFields(tabId, data.mProductpriceId, vars, this,con);
