...
vars.getGlobalVariable("inpmProductpriceId", windowId + "|M_Productprice_ID");
  ...
  private PriceAdjustmentData getEditVariables(Connection con, VariablesSecureApp vars, String strPM_Productprice_ID) throws IOException,ServletException {
   ...
   private PriceAdjustmentData[] getRelationData(PriceAdjustmentData[] data) {
    if (data!=null) {
      for (int i=0;i<data.length;i++) {        data[i].mProductId = FormatUtilities.truncate(data[i].mProductId, 32);        data[i].name = FormatUtilities.truncate(data[i].name, 50);        data[i].cUomId = FormatUtilities.truncate(data[i].cUomId, 32);        data[i].mAttributesetinstanceId = FormatUtilities.truncate(data[i].mAttributesetinstanceId, 32);        data[i].productSelection = FormatUtilities.truncate(data[i].productSelection, 50);        data[i].adOrgId = FormatUtilities.truncate(data[i].adOrgId, 32);        data[i].prodCatSelection = FormatUtilities.truncate(data[i].prodCatSelection, 50);        data[i].mPricelistId = FormatUtilities.truncate(data[i].mPricelistId, 32);        data[i].description = FormatUtilities.truncate(data[i].description, 50);        data[i].bpGroupSelection = FormatUtilities.truncate(data[i].bpGroupSelection, 50);        data[i].pricelistSelection = FormatUtilities.truncate(data[i].pricelistSelection, 50);        data[i].bpartnerSelection = FormatUtilities.truncate(data[i].bpartnerSelection, 50);        data[i].adClientId = FormatUtilities.truncate(data[i].adClientId, 32);        data[i].mProductpriceId = FormatUtilities.truncate(data[i].mProductpriceId, 32);        data[i].mOfferplistVId = FormatUtilities.truncate(data[i].mOfferplistVId, 32);}
    }
    return data;
  }
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strM_Offerplist_V_ID, String strPM_Productprice_ID, TableSQLData tableSQL)
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = PriceAdjustmentData.set(strPM_Productprice_ID, Utility.getDefault(this, vars, "Graterequal", "", "140", "DF7C54CBA32C44D3A0BDB7D78A03220B", "N", dataField), Utility.getDefault(this, vars, "Addamt", "", "140", "DF7C54CBA32C44D3A0BDB7D78A03220B", "", dataField), Utility.getDefault(this, vars, "QTY_To", "", "140", "DF7C54CBA32C44D3A0BDB7D78A03220B", "", dataField), Utility.getDefault(this, vars, "Directpurchasecalc", "", "140", "DF7C54CBA32C44D3A0BDB7D78A03220B", "N", dataField), Utility.getDefault(this, vars, "M_Attributesetinstance_ID", "", "140", "DF7C54CBA32C44D3A0BDB7D78A03220B", "", dataField), PriceAdjustmentData.selectDefF3B18E3DDBB1403EA8B84CBB47EBAE4C_0(this, Utility.getDefault(this, vars, "M_Attributesetinstance_ID", "", "140", "DF7C54CBA32C44D3A0BDB7D78A03220B", "", dataField)), "", "Y", Utility.getDefault(this, vars, "Priority", "", "140", "DF7C54CBA32C44D3A0BDB7D78A03220B", "", dataField), Utility.getDefault(this, vars, "Description", "", "140", "DF7C54CBA32C44D3A0BDB7D78A03220B", "", dataField), Utility.getDefault(this, vars, "QTY_From", "", "140", "DF7C54CBA32C44D3A0BDB7D78A03220B", "", dataField), Utility.getDefault(this, vars, "Dateto", "", "140", "DF7C54CBA32C44D3A0BDB7D78A03220B", "", dataField), Utility.getDefault(this, vars, "M_Pricelist_ID", "", "140", "DF7C54CBA32C44D3A0BDB7D78A03220B", "", dataField), Utility.getDefault(this, vars, "Prod_Cat_Selection", "", "140", "DF7C54CBA32C44D3A0BDB7D78A03220B", "", dataField), Utility.getDefault(this, vars, "Issalesoffer", "", "140", "DF7C54CBA32C44D3A0BDB7D78A03220B", "N", dataField), Utility.getDefault(this, vars, "Pricelist_Selection", "", "140", "DF7C54CBA32C44D3A0BDB7D78A03220B", "", dataField), Utility.getDefault(this, vars, "Discount", "", "140", "DF7C54CBA32C44D3A0BDB7D78A03220B", "", dataField), Utility.getDefault(this, vars, "M_Product_ID", "", "140", "DF7C54CBA32C44D3A0BDB7D78A03220B", "", dataField), PriceAdjustmentData.selectDef1961B4AE66DB41DC9AB135ADE09B3410_1(this, Utility.getDefault(this, vars, "M_Product_ID", "", "140", "DF7C54CBA32C44D3A0BDB7D78A03220B", "", dataField)), Utility.getDefault(this, vars, "Bpartner_Selection", "", "140", "DF7C54CBA32C44D3A0BDB7D78A03220B", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "140", "DF7C54CBA32C44D3A0BDB7D78A03220B", "", dataField), Utility.getDefault(this, vars, "Updatedby", "", "140", "DF7C54CBA32C44D3A0BDB7D78A03220B", "", dataField), PriceAdjustmentData.selectDefEA017F229520407281E0C871872E2C25_2(this, Utility.getDefault(this, vars, "Updatedby", "", "140", "DF7C54CBA32C44D3A0BDB7D78A03220B", "", dataField)), Utility.getDefault(this, vars, "Createdby", "", "140", "DF7C54CBA32C44D3A0BDB7D78A03220B", "", dataField), PriceAdjustmentData.selectDef37E78F935C094F898DE19D100EA855C7_3(this, Utility.getDefault(this, vars, "Createdby", "", "140", "DF7C54CBA32C44D3A0BDB7D78A03220B", "", dataField)), Utility.getDefault(this, vars, "BP_Group_Selection", "", "140", "DF7C54CBA32C44D3A0BDB7D78A03220B", "", dataField), Utility.getDefault(this, vars, "Datefrom", "", "140", "DF7C54CBA32C44D3A0BDB7D78A03220B", "", dataField), Utility.getDefault(this, vars, "C_Uom_ID", "", "140", "DF7C54CBA32C44D3A0BDB7D78A03220B", "", dataField), Utility.getDefault(this, vars, "Fixed", "", "140", "DF7C54CBA32C44D3A0BDB7D78A03220B", "", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "140", "DF7C54CBA32C44D3A0BDB7D78A03220B", "", dataField), Utility.getDefault(this, vars, "Lessequal", "", "140", "DF7C54CBA32C44D3A0BDB7D78A03220B", "N", dataField), Utility.getDefault(this, vars, "Product_Selection", "", "140", "DF7C54CBA32C44D3A0BDB7D78A03220B", "", dataField), Utility.getDefault(this, vars, "Name", "", "140", "DF7C54CBA32C44D3A0BDB7D78A03220B", "", dataField));
  ...
  private int saveRecord(VariablesSecureApp vars, OBError myError, char type, String strPM_Productprice_ID) throws IOException, ServletException {
    ...
    if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        strSequence = vars.getStringParameter("inpnewdataseIdVal");
          ...
          CrudOperations.UpdateCustomFields(tabId, data.mOfferplistVId, vars, this,con);
