...
public class CallOffs extends HttpSecureAppServlet {
  ...
  private static final String tabId = "2B5A2463E3174EADBEAAD5DF8B799FBF";
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      vars.setSessionValue(windowId + "|C_Framecontractoverview_ID", strPC_Framecontractoverview_ID);
      vars.setSessionValue("424A86FA6EBC4AA1B0AA739385BCF588|Frame Contracts Sales.view", "EDIT");
...
vars.getGlobalVariable("inpcFramecontractoverviewId", windowId + "|C_Framecontractoverview_ID");
  ...
  private CallOffsData getEditVariables(Connection con, VariablesSecureApp vars, String strPC_Framecontractoverview_ID) throws IOException,ServletException {
   ...
   private CallOffsData[] getRelationData(CallOffsData[] data) {
    if (data!=null) {
      for (int i=0;i<data.length;i++) {        data[i].cFramecontractoverviewId = FormatUtilities.truncate(data[i].cFramecontractoverviewId, 32);        data[i].cOrderId = FormatUtilities.truncate(data[i].cOrderId, 32);        data[i].documentno = FormatUtilities.truncate(data[i].documentno, 30);        data[i].mProductId = FormatUtilities.truncate(data[i].mProductId, 32);        data[i].docstatus = FormatUtilities.truncate(data[i].docstatus, 50);        data[i].cProjectId = FormatUtilities.truncate(data[i].cProjectId, 32);        data[i].cProjecttaskId = FormatUtilities.truncate(data[i].cProjecttaskId, 32);        data[i].aAssetId = FormatUtilities.truncate(data[i].aAssetId, 32);        data[i].adClientId = FormatUtilities.truncate(data[i].adClientId, 32);        data[i].adOrgId = FormatUtilities.truncate(data[i].adOrgId, 32);        data[i].cUomId = FormatUtilities.truncate(data[i].cUomId, 32);        data[i].mWarehouseId = FormatUtilities.truncate(data[i].mWarehouseId, 32);        data[i].cOrderlineId = FormatUtilities.truncate(data[i].cOrderlineId, 32);        data[i].cFramecalloffoverviewId = FormatUtilities.truncate(data[i].cFramecalloffoverviewId, 32);}
    }
    return data;
  }
  ...
  private void refreshParentSession(VariablesSecureApp vars, String strPC_Framecontractoverview_ID) throws IOException,ServletException {
      FrameContractsSalesData[] data = FrameContractsSalesData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPC_Framecontractoverview_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|AD_Org_ID", data[0].adOrgId);    vars.setSessionValue(windowId + "|C_Framecontractoverview_ID", data[0].cFramecontractoverviewId);    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].adClientId);
  ...
  private String getParentID(VariablesSecureApp vars, String strC_Framecalloffoverview_ID) throws ServletException {
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));    vars.setSessionValue(windowId + "|AD_Org_ID", data[0].getField("adOrgId"));    vars.setSessionValue(windowId + "|C_Framecalloffoverview_ID", data[0].getField("cFramecalloffoverviewId"));
    }
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars, String strPC_Framecontractoverview_ID, String strC_Framecalloffoverview_ID, TableSQLData tableSQL)
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/FrameContractOverview/CallOffs_Relation", discard).createXmlDocument();

    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "CallOffs", false, "document.frmMain.inpcFramecalloffoverviewId", "grid", "..", "".equals("Y"), "FrameContractOverview", strReplaceWith, false);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "CallOffs_Relation.html", "FrameContractOverview", "W", strReplaceWith, tabs.breadcrumb());
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strC_Framecalloffoverview_ID, String strPC_Framecontractoverview_ID, TableSQLData tableSQL)
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = CallOffsData.set(strPC_Framecontractoverview_ID, "Y", Utility.getDefault(this, vars, "C_Orderline_ID", "", "BEE6D919FC9B44C096DA60CB08F43494", "2B5A2463E3174EADBEAAD5DF8B799FBF", "", dataField), Utility.getDefault(this, vars, "C_Project_ID", "", "BEE6D919FC9B44C096DA60CB08F43494", "2B5A2463E3174EADBEAAD5DF8B799FBF", "", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "BEE6D919FC9B44C096DA60CB08F43494", "2B5A2463E3174EADBEAAD5DF8B799FBF", "", dataField), Utility.getDefault(this, vars, "C_Order_ID", "", "BEE6D919FC9B44C096DA60CB08F43494", "2B5A2463E3174EADBEAAD5DF8B799FBF", "", dataField), Utility.getDefault(this, vars, "A_Asset_ID", "", "BEE6D919FC9B44C096DA60CB08F43494", "2B5A2463E3174EADBEAAD5DF8B799FBF", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "BEE6D919FC9B44C096DA60CB08F43494", "2B5A2463E3174EADBEAAD5DF8B799FBF", "", dataField), Utility.getDefault(this, vars, "C_Projecttask_ID", "", "BEE6D919FC9B44C096DA60CB08F43494", "2B5A2463E3174EADBEAAD5DF8B799FBF", "", dataField), Utility.getDefault(this, vars, "Linenetamt", "", "BEE6D919FC9B44C096DA60CB08F43494", "2B5A2463E3174EADBEAAD5DF8B799FBF", "", dataField), Utility.getDefault(this, vars, "Calloffqty", "", "BEE6D919FC9B44C096DA60CB08F43494", "2B5A2463E3174EADBEAAD5DF8B799FBF", "", dataField), Utility.getDefault(this, vars, "Line", "", "BEE6D919FC9B44C096DA60CB08F43494", "2B5A2463E3174EADBEAAD5DF8B799FBF", "", dataField), Utility.getDefault(this, vars, "Dateordered", "", "BEE6D919FC9B44C096DA60CB08F43494", "2B5A2463E3174EADBEAAD5DF8B799FBF", "", dataField), Utility.getDefault(this, vars, "C_Uom_ID", "", "BEE6D919FC9B44C096DA60CB08F43494", "2B5A2463E3174EADBEAAD5DF8B799FBF", "", dataField), Utility.getDefault(this, vars, "Documentno", "", "BEE6D919FC9B44C096DA60CB08F43494", "2B5A2463E3174EADBEAAD5DF8B799FBF", "", dataField), Utility.getDefault(this, vars, "M_Warehouse_ID", "", "BEE6D919FC9B44C096DA60CB08F43494", "2B5A2463E3174EADBEAAD5DF8B799FBF", "", dataField), Utility.getDefault(this, vars, "Updatedby", "", "BEE6D919FC9B44C096DA60CB08F43494", "2B5A2463E3174EADBEAAD5DF8B799FBF", "", dataField), CallOffsData.selectDef2D227E4671AB4ED78BB31AF6B309EE00_0(this, Utility.getDefault(this, vars, "Updatedby", "", "BEE6D919FC9B44C096DA60CB08F43494", "2B5A2463E3174EADBEAAD5DF8B799FBF", "", dataField)), Utility.getDefault(this, vars, "Createdby", "", "BEE6D919FC9B44C096DA60CB08F43494", "2B5A2463E3174EADBEAAD5DF8B799FBF", "", dataField), CallOffsData.selectDefF73F9E8286274EECB8B46FCD74FCB421_1(this, Utility.getDefault(this, vars, "Createdby", "", "BEE6D919FC9B44C096DA60CB08F43494", "2B5A2463E3174EADBEAAD5DF8B799FBF", "", dataField)), Utility.getDefault(this, vars, "Deliverycomplete", "", "BEE6D919FC9B44C096DA60CB08F43494", "2B5A2463E3174EADBEAAD5DF8B799FBF", "N", dataField), Utility.getDefault(this, vars, "Issotrx", "", "BEE6D919FC9B44C096DA60CB08F43494", "2B5A2463E3174EADBEAAD5DF8B799FBF", "N", dataField), Utility.getDefault(this, vars, "Qtyordered", "", "BEE6D919FC9B44C096DA60CB08F43494", "2B5A2463E3174EADBEAAD5DF8B799FBF", "", dataField), Utility.getDefault(this, vars, "M_Product_ID", "", "BEE6D919FC9B44C096DA60CB08F43494", "2B5A2463E3174EADBEAAD5DF8B799FBF", "", dataField), CallOffsData.selectDefA2F77C66ADAA446CB48FD520FE4FC8CA_2(this, Utility.getDefault(this, vars, "M_Product_ID", "", "BEE6D919FC9B44C096DA60CB08F43494", "2B5A2463E3174EADBEAAD5DF8B799FBF", "", dataField)), Utility.getDefault(this, vars, "Priceactual", "", "BEE6D919FC9B44C096DA60CB08F43494", "2B5A2463E3174EADBEAAD5DF8B799FBF", "", dataField), Utility.getDefault(this, vars, "Docstatus", "", "BEE6D919FC9B44C096DA60CB08F43494", "2B5A2463E3174EADBEAAD5DF8B799FBF", "", dataField), "", Utility.getDefault(this, vars, "Scheddeliverydate", "", "BEE6D919FC9B44C096DA60CB08F43494", "2B5A2463E3174EADBEAAD5DF8B799FBF", "", dataField));
    ...
    String currentPOrg=FrameContractsSalesData.selectOrg(this, strPC_Framecontractoverview_ID);
    ...
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "CallOffs", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpcFramecalloffoverviewId", "", "..", "".equals("Y"), "FrameContractOverview", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strC_Framecalloffoverview_ID));
