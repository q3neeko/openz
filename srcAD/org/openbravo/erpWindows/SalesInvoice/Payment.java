...
vars.getGlobalVariable("inpcInvoiceId", windowId + "|C_Invoice_ID");
  ...
  private void refreshParentSession(VariablesSecureApp vars, String strPC_Invoice_ID) throws IOException,ServletException {
      ...
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|AD_Org_ID", data[0].adOrgId);    vars.setSessionValue(windowId + "|C_DocTypeTarget_ID", data[0].cDoctypetargetId);    vars.setSessionValue(windowId + "|DateInvoiced", data[0].dateinvoiced);    vars.setSessionValue(windowId + "|C_BPartner_ID", data[0].cBpartnerId);    vars.setSessionValue(windowId + "|M_PriceList_ID", data[0].mPricelistId);    vars.setSessionValue(windowId + "|C_Currency_ID", data[0].cCurrencyId);    vars.setSessionValue(windowId + "|IsPaid", data[0].ispaid);    vars.setSessionValue(windowId + "|C_DocType_ID", data[0].cDoctypeId);    vars.setSessionValue(windowId + "|Processed", data[0].processed);    vars.setSessionValue(windowId + "|C_Invoice_ID", data[0].cInvoiceId);    vars.setSessionValue(windowId + "|IsSOTrx", data[0].issotrx);    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].adClientId);
...
String strParamAmount_f = vars.getSessionValue(tabId + "|paramAmount_f");
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = PaymentData.set(strPC_Invoice_ID, Utility.getDefault(this, vars, "C_Currency_ID", "", "167", "800028", "", dataField), Utility.getDefault(this, vars, "C_CashLine_ID", "", "167", "800028", "", dataField), Utility.getDefault(this, vars, "C_BankStatementLine_ID", "", "167", "800028", "", dataField), Utility.getDefault(this, vars, "IsReceipt", "@IsSOTrx@", "167", "800028", "N", dataField), "Y", Utility.getDefault(this, vars, "IsPaid", "", "167", "800028", "N", dataField), Utility.getDefault(this, vars, "C_Bp_Bankaccount_ID", "", "167", "800028", "", dataField), Utility.getDefault(this, vars, "C_BankAccount_ID", "", "167", "800028", "", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "167", "800028", "", dataField), Utility.getDefault(this, vars, "Discountamt", "0", "167", "800028", "", dataField), Utility.getDefault(this, vars, "Cancel_Processed", "N", "167", "800028", "N", dataField), Utility.getDefault(this, vars, "WriteOffAmt", "0", "167", "800028", "", dataField), "", Utility.getDefault(this, vars, "Description", "", "167", "800028", "", dataField), Utility.getDefault(this, vars, "IsManual", "", "167", "800028", "N", dataField), Utility.getDefault(this, vars, "IsValid", "", "167", "800028", "N", dataField), Utility.getDefault(this, vars, "CreatedBy", "", "167", "800028", "", dataField), PaymentData.selectDef800304_0(this, Utility.getDefault(this, vars, "CreatedBy", "", "167", "800028", "", dataField)), PaymentData.selectDef800311_1(this, strPC_Invoice_ID), Utility.getDefault(this, vars, "C_Settlement_Cancel_ID", "", "167", "800028", "", dataField), Utility.getDefault(this, vars, "Dateplanned", "", "167", "800028", "", dataField), Utility.getDefault(this, vars, "Changesettlementcancel", "N", "167", "800028", "N", dataField), Utility.getDefault(this, vars, "C_CashBook_ID", "", "167", "800028", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "167", "800028", "", dataField), Utility.getDefault(this, vars, "Amount", "0", "167", "800028", "", dataField), Utility.getDefault(this, vars, "IsAutomaticGenerated", "", "167", "800028", "N", dataField), Utility.getDefault(this, vars, "PaymentRule", "", "167", "800028", "", dataField), Utility.getDefault(this, vars, "Status_Initial", "DE", "167", "800028", "", dataField), Utility.getDefault(this, vars, "Generate_Processed", "N", "167", "800028", "N", dataField), Utility.getDefault(this, vars, "C_Project_ID", "", "167", "800028", "", dataField), Utility.getDefault(this, vars, "UpdatedBy", "", "167", "800028", "", dataField), PaymentData.selectDef800306_2(this, Utility.getDefault(this, vars, "UpdatedBy", "", "167", "800028", "", dataField)), Utility.getDefault(this, vars, "C_Settlement_Generate_ID", "", "167", "800028", "", dataField), Utility.getDefault(this, vars, "C_BPartner_ID", "@C_BPartner_ID@", "167", "800028", "", dataField), PaymentData.selectDef800312_3(this, Utility.getDefault(this, vars, "C_BPartner_ID", "@C_BPartner_ID@", "167", "800028", "", dataField)));
