...
public class Deliveries extends HttpSecureAppServlet {
  private static final long serialVersionUID = 1L;
  
  private static Logger log4j = Logger.getLogger(Deliveries.class);
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strView = vars.getSessionValue(tabId + "|Deliveries.view");
      if (strView.equals("")) {
      ...
      if (vars.commandIn("DIRECT")){
        vars.setSessionValue(tabId + "|Deliveries.view", "EDIT");

        printPageEdit(response, request, vars, false, strM_InOut_ID, strPC_BPartner_ID, tableSQL);
      }
      if (vars.commandIn("DIRECTRELATION")){
        vars.setSessionValue(tabId + "|Deliveries.view", "RELATION");
      ...
      if (strView.equals("EDIT")) {
        ...
        if (strM_InOut_ID.equals("")) {
          ...
          vars.setSessionValue(tabId + "|Deliveries.view", strView);
        }
      }
...
vars.getGlobalVariable("inpcBpartnerId", windowId + "|C_BPartner_ID");
      ...
      vars.setSessionValue(tabId + "|Deliveries.initRecordNumber", "0");
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
    } else if (vars.commandIn("PREVIOUS_RELATION")) {
      String strPC_BPartner_ID = vars.getGlobalVariable("inpcBpartnerId", windowId + "|C_BPartner_ID");

      String strInitRecord = vars.getSessionValue(tabId + "|Deliveries.initRecordNumber");
      ...
      if (strInitRecord.equals("") || strInitRecord.equals("0")) {
        ...
        vars.setSessionValue(tabId + "|Deliveries.initRecordNumber", strInitRecord);
      }
      vars.removeSessionValue(windowId + "|M_InOut_ID");
      vars.setSessionValue(windowId + "|C_BPartner_ID", strPC_BPartner_ID);
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
      ...
      String strM_InOut_ID = vars.getRequiredStringParameter("inpmInoutId");
      //DeliveriesData data = getEditVariables(vars, strPC_BPartner_ID);
      int total = 0;
      ...
      if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        try {
          total = DeliveriesData.delete(this, strM_InOut_ID, strPC_BPartner_ID, Utility.getContext(this, vars, "#User_Client", windowId, accesslevel), Utility.getContext(this, vars, "#User_Org", windowId, accesslevel));
  ...
  private String getParentID(VariablesSecureApp vars, String strM_InOut_ID) throws ServletException {
    String strPC_BPartner_ID = DeliveriesData.selectParentID(this, strM_InOut_ID);
    if (strPC_BPartner_ID.equals("")) {
    ...
    private void refreshSessionNew(VariablesSecureApp vars, String strPC_BPartner_ID) throws IOException,ServletException {
      DeliveriesData[] data = DeliveriesData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), Utility.getContext(this, vars, "C_BPartner_ID", windowId), strPC_BPartner_ID, vars.getStringParameter("inpmInoutId", ""), Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      if (data==null || data.length==0) return;
...
String strParamMovementDate_f = vars.getSessionValue(tabId + "|paramMovementDate_f");
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/BusinessPartnerInfo/Deliveries_Relation", discard).createXmlDocument();

    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "Deliveries", false, "document.frmMain.inpmInoutId", "grid", "..", "".equals("Y"), "BusinessPartnerInfo", strReplaceWith, false);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Deliveries_Relation.html", "BusinessPartnerInfo", "W", strReplaceWith, tabs.breadcrumb());
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "Deliveries_Relation.html", strReplaceWith);
    ...
    if (vars.getLanguage().equals("en_US")) xmlDocument.setParameter("parent", DeliveriesData.selectParent(this, strPC_BPartner_ID));
    else xmlDocument.setParameter("parent", DeliveriesData.selectParentTrl(this, strPC_BPartner_ID));
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strM_InOut_ID, String strPC_BPartner_ID, TableSQLData tableSQL)
    ...
    String orderClause = "  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL2.Name IS NULL THEN TO_CHAR(table2.Name) ELSE TO_CHAR(tableTRL2.Name) END)), ''))),'') ), M_InOut.DocumentNo DESC";
...
String strParamMovementDate_f = vars.getSessionValue(tabId + "|paramMovementDate_f");
    ...
    if (dataField==null) {
      if (!boolNew) {
        ...
        data = DeliveriesData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), Utility.getContext(this, vars, "C_BPartner_ID", windowId), strPC_BPartner_ID, strM_InOut_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = DeliveriesData.set(strPC_BPartner_ID, Utility.getDefault(this, vars, "FreightAmt", "0", "291", "552", "", dataField), Utility.getDefault(this, vars, "POReference", "", "291", "552", "", dataField), Utility.getDefault(this, vars, "User1_ID", "", "291", "552", "", dataField), Utility.getDefault(this, vars, "DocAction", "CO", "291", "552", "N", dataField), Utility.getDefault(this, vars, "GenerateTo", "", "291", "552", "N", dataField), Utility.getDefault(this, vars, "MovementType", "", "291", "552", "", dataField), Utility.getDefault(this, vars, "C_Project_ID", "", "291", "552", "", dataField), Utility.getDefault(this, vars, "C_Campaign_ID", "", "291", "552", "", dataField), Utility.getDefault(this, vars, "ShipDate", "", "291", "552", "", dataField), Utility.getDefault(this, vars, "DocStatus", "DR", "291", "552", "", dataField), Utility.getDefault(this, vars, "IsPrinted", "", "291", "552", "N", dataField), Utility.getDefault(this, vars, "M_Shipper_ID", "", "291", "552", "", dataField), Utility.getDefault(this, vars, "PriorityRule", "5", "291", "552", "", dataField), Utility.getDefault(this, vars, "DateAcct", "@#Date@", "291", "552", "", dataField), "", Utility.getDefault(this, vars, "CreateFrom", "", "291", "552", "N", dataField), Utility.getDefault(this, vars, "C_Invoice_ID", "", "291", "552", "", dataField), Utility.getDefault(this, vars, "TrackingNo", "", "291", "552", "", dataField), Utility.getDefault(this, vars, "UpdatedBy", "", "291", "552", "", dataField), DeliveriesData.selectDef3528_0(this, Utility.getDefault(this, vars, "UpdatedBy", "", "291", "552", "", dataField)), Utility.getDefault(this, vars, "CreatedBy", "", "291", "552", "", dataField), DeliveriesData.selectDef3526_1(this, Utility.getDefault(this, vars, "CreatedBy", "", "291", "552", "", dataField)), Utility.getDefault(this, vars, "Processed", "", "291", "552", "N", dataField), Utility.getDefault(this, vars, "IsSOTrx", "@IsSOTrx@", "291", "552", "N", dataField), Utility.getDefault(this, vars, "DatePrinted", "", "291", "552", "", dataField), Utility.getDefault(this, vars, "FreightCostRule", "I", "291", "552", "", dataField), Utility.getDefault(this, vars, "M_Warehouse_ID", "", "291", "552", "", dataField), Utility.getDefault(this, vars, "AD_OrgTrx_ID", "", "291", "552", "", dataField), "Y", Utility.getDefault(this, vars, "SalesRep_ID", "", "291", "552", "", dataField), Utility.getDefault(this, vars, "Qty", "", "291", "552", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@#AD_Org_ID@", "291", "552", "", dataField), Utility.getDefault(this, vars, "C_BPartner_Location_ID", "", "291", "552", "", dataField), Utility.getDefault(this, vars, "C_Order_ID", "", "291", "552", "", dataField), DeliveriesData.selectDef3809_2(this, Utility.getDefault(this, vars, "C_Order_ID", "", "291", "552", "", dataField)), Utility.getDefault(this, vars, "DeliveryRule", "A", "291", "552", "", dataField), Utility.getDefault(this, vars, "User2_ID", "", "291", "552", "", dataField), Utility.getDefault(this, vars, "DateOrdered", "", "291", "552", "", dataField), Utility.getDefault(this, vars, "Processing", "", "291", "552", "N", dataField), Utility.getDefault(this, vars, "C_Charge_ID", "", "291", "552", "", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "291", "552", "", dataField), Utility.getDefault(this, vars, "DocumentNo", "", "291", "552", "", dataField), Utility.getDefault(this, vars, "ChargeAmt", "0", "291", "552", "", dataField), Utility.getDefault(this, vars, "C_DocType_ID", "", "291", "552", "", dataField), Utility.getDefault(this, vars, "C_Activity_ID", "", "291", "552", "", dataField), Utility.getDefault(this, vars, "MovementDate", "@#Date@", "291", "552", "", dataField), Utility.getDefault(this, vars, "PickDate", "", "291", "552", "", dataField), Utility.getDefault(this, vars, "Description", "", "291", "552", "", dataField), Utility.getDefault(this, vars, "Posted", "", "291", "552", "N", dataField), Utility.getDefault(this, vars, "DeliveryViaRule", "", "291", "552", "", dataField), Utility.getDefault(this, vars, "AD_User_ID", "", "291", "552", "", dataField));
      ...
      data = new DeliveriesData[1];
      java.lang.Object  ref1= dataField;
      data[0]=(DeliveriesData) ref1;
      data[0].created="";
      data[0].updated="";
    }
    ...
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "Deliveries", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpmInoutId", "", "..", "".equals("Y"), "BusinessPartnerInfo", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strM_InOut_ID));
        ...
        strSequence = vars.getStringParameter("inpnewdataseIdVal");
            ...
            if (Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),data.adClientId)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),data.adOrgId)){
		     if(type == 'I') {
		       ...
		       if (DeliveriesData.getCurrentDBTimestamp(this, data.mInoutId).equals(
          ...
          CrudOperations.UpdateCustomFields(tabId, data.mInoutId, vars, this,con);
  ...
  public String getServletInfo() {
    return "Servlet Deliveries. This Servlet was made by Wad constructor";
