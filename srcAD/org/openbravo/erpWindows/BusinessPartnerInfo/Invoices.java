...
public class Invoices extends HttpSecureAppServlet {
  private static final long serialVersionUID = 1L;
  
  private static Logger log4j = Logger.getLogger(Invoices.class);
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strView = vars.getSessionValue(tabId + "|Invoices.view");
      if (strView.equals("")) {
      ...
      vars.setSessionValue(windowId + "|C_BPartner_ID", strPC_BPartner_ID);
      vars.setSessionValue("550|Business Partner Info.view", "EDIT");

      refreshParentSession(vars, strPC_BPartner_ID);

      if (vars.commandIn("DIRECT")){
        vars.setSessionValue(tabId + "|Invoices.view", "EDIT");

        printPageEdit(response, request, vars, false, strC_Invoice_ID, strPC_BPartner_ID, tableSQL);
      }
      if (vars.commandIn("DIRECTRELATION")){
        vars.setSessionValue(tabId + "|Invoices.view", "RELATION");
      ...
      if (strView.equals("EDIT")) {
        ...
        if (strC_Invoice_ID.equals("")) {
          ...
          vars.setSessionValue(tabId + "|Invoices.view", strView);
        }
      }
...
vars.getGlobalVariable("inpcBpartnerId", windowId + "|C_BPartner_ID");
      ...
      vars.setSessionValue(tabId + "|Invoices.initRecordNumber", "0");
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
    } else if (vars.commandIn("PREVIOUS_RELATION")) {
      String strPC_BPartner_ID = vars.getGlobalVariable("inpcBpartnerId", windowId + "|C_BPartner_ID");

      String strInitRecord = vars.getSessionValue(tabId + "|Invoices.initRecordNumber");
      ...
      if (strInitRecord.equals("") || strInitRecord.equals("0")) {
        ...
        vars.setSessionValue(tabId + "|Invoices.initRecordNumber", strInitRecord);
      }
      vars.removeSessionValue(windowId + "|C_Invoice_ID");
      vars.setSessionValue(windowId + "|C_BPartner_ID", strPC_BPartner_ID);
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
      ...
      String strC_Invoice_ID = vars.getRequiredStringParameter("inpcInvoiceId");
      //InvoicesData data = getEditVariables(vars, strPC_BPartner_ID);
      int total = 0;
      ...
      if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        try {
          total = InvoicesData.delete(this, strC_Invoice_ID, strPC_BPartner_ID, Utility.getContext(this, vars, "#User_Client", windowId, accesslevel), Utility.getContext(this, vars, "#User_Org", windowId, accesslevel));
  ...
  private String getParentID(VariablesSecureApp vars, String strC_Invoice_ID) throws ServletException {
    String strPC_BPartner_ID = InvoicesData.selectParentID(this, strC_Invoice_ID);
    if (strPC_BPartner_ID.equals("")) {
...
String strParamGrandTotal_f = vars.getSessionValue(tabId + "|paramGrandTotal_f");
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/BusinessPartnerInfo/Invoices_Relation", discard).createXmlDocument();

    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "Invoices", false, "document.frmMain.inpcInvoiceId", "grid", "..", "".equals("Y"), "BusinessPartnerInfo", strReplaceWith, false);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Invoices_Relation.html", "BusinessPartnerInfo", "W", strReplaceWith, tabs.breadcrumb());
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "Invoices_Relation.html", strReplaceWith);
    ...
    if (vars.getLanguage().equals("en_US")) xmlDocument.setParameter("parent", InvoicesData.selectParent(this, strPC_BPartner_ID));
    else xmlDocument.setParameter("parent", InvoicesData.selectParentTrl(this, strPC_BPartner_ID));
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strC_Invoice_ID, String strPC_BPartner_ID, TableSQLData tableSQL)
    ...
    String orderClause = "  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL2.Name IS NULL THEN TO_CHAR(table2.Name) ELSE TO_CHAR(tableTRL2.Name) END)), ''))),'') ), C_Invoice.DocumentNo DESC";
...
String strParamGrandTotal_f = vars.getSessionValue(tabId + "|paramGrandTotal_f");
    ...
    if (dataField==null) {
      if (!boolNew) {
        ...
        data = InvoicesData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), Utility.getContext(this, vars, "C_BPartner_ID", windowId), strPC_BPartner_ID, strC_Invoice_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = InvoicesData.set(strPC_BPartner_ID, "Y", Utility.getDefault(this, vars, "PaymentRule", "P", "291", "553", "", dataField), Utility.getDefault(this, vars, "User1_ID", "", "291", "553", "", dataField), Utility.getDefault(this, vars, "CreateFrom", "", "291", "553", "N", dataField), Utility.getDefault(this, vars, "C_Campaign_ID", "", "291", "553", "", dataField), Utility.getDefault(this, vars, "SalesRep_ID", "", "291", "553", "", dataField), Utility.getDefault(this, vars, "CreatedBy", "", "291", "553", "", dataField), InvoicesData.selectDef3489_0(this, Utility.getDefault(this, vars, "CreatedBy", "", "291", "553", "", dataField)), Utility.getDefault(this, vars, "AD_OrgTrx_ID", "", "291", "553", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@#AD_Org_ID@", "291", "553", "", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "291", "553", "", dataField), Utility.getDefault(this, vars, "DateInvoiced", "@#Date@", "291", "553", "", dataField), Utility.getDefault(this, vars, "C_Charge_ID", "", "291", "553", "", dataField), Utility.getDefault(this, vars, "IsTaxIncluded", "", "291", "553", "N", dataField), Utility.getDefault(this, vars, "C_BPartner_Location_ID", "", "291", "553", "", dataField), Utility.getDefault(this, vars, "DateAcct", "@#Date@", "291", "553", "", dataField), Utility.getDefault(this, vars, "M_PriceList_ID", "", "291", "553", "", dataField), Utility.getDefault(this, vars, "Processing", "", "291", "553", "N", dataField), Utility.getDefault(this, vars, "Description", "", "291", "553", "", dataField), Utility.getDefault(this, vars, "POReference", "", "291", "553", "", dataField), Utility.getDefault(this, vars, "AD_User_ID", "", "291", "553", "", dataField), Utility.getDefault(this, vars, "DocAction", "CO", "291", "553", "N", dataField), Utility.getDefault(this, vars, "IsPrinted", "", "291", "553", "N", dataField), Utility.getDefault(this, vars, "IsSelfService", "", "291", "553", "N", dataField), Utility.getDefault(this, vars, "DocStatus", "DR", "291", "553", "", dataField), Utility.getDefault(this, vars, "IsDiscountPrinted", "", "291", "553", "N", dataField), Utility.getDefault(this, vars, "C_Currency_ID", "@C_Currency_ID@", "291", "553", "", dataField), Utility.getDefault(this, vars, "DateOrdered", "", "291", "553", "", dataField), Utility.getDefault(this, vars, "ChargeAmt", "", "291", "553", "", dataField), Utility.getDefault(this, vars, "Posted", "N", "291", "553", "N", dataField), Utility.getDefault(this, vars, "User2_ID", "", "291", "553", "", dataField), Utility.getDefault(this, vars, "GrandTotal", "", "291", "553", "", dataField), Utility.getDefault(this, vars, "C_Project_ID", "", "291", "553", "", dataField), Utility.getDefault(this, vars, "C_Activity_ID", "", "291", "553", "", dataField), Utility.getDefault(this, vars, "C_PaymentTerm_ID", "", "291", "553", "", dataField), Utility.getDefault(this, vars, "C_DocTypeTarget_ID", "", "291", "553", "", dataField), Utility.getDefault(this, vars, "CopyFrom", "", "291", "553", "N", dataField), Utility.getDefault(this, vars, "IsSOTrx", "@IsSOTrx@", "291", "553", "N", dataField), Utility.getDefault(this, vars, "GenerateTo", "", "291", "553", "N", dataField), Utility.getDefault(this, vars, "UpdatedBy", "", "291", "553", "", dataField), InvoicesData.selectDef3491_1(this, Utility.getDefault(this, vars, "UpdatedBy", "", "291", "553", "", dataField)), Utility.getDefault(this, vars, "C_DocType_ID", "0", "291", "553", "", dataField), Utility.getDefault(this, vars, "Processed", "", "291", "553", "N", dataField), Utility.getDefault(this, vars, "DatePrinted", "", "291", "553", "", dataField), Utility.getDefault(this, vars, "DocumentNo", "", "291", "553", "", dataField), Utility.getDefault(this, vars, "TotalLines", "", "291", "553", "", dataField), "", Utility.getDefault(this, vars, "C_Order_ID", "", "291", "553", "", dataField));
      ...
      data = new InvoicesData[1];
      java.lang.Object  ref1= dataField;
      data[0]=(InvoicesData) ref1;
      data[0].created="";
      data[0].updated="";
    }
    ...
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "Invoices", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpcInvoiceId", "", "..", "".equals("Y"), "BusinessPartnerInfo", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strC_Invoice_ID));
        ...
        strSequence = vars.getStringParameter("inpnewdataseIdVal");
            ...
            if (Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),data.adClientId)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),data.adOrgId)){
		     if(type == 'I') {
		       ...
		       if (InvoicesData.getCurrentDBTimestamp(this, data.cInvoiceId).equals(
  ...
  public String getServletInfo() {
    return "Servlet Invoices. This Servlet was made by Wad constructor";
