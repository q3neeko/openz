...
vars.getGlobalVariable("inpcBpartnerId", windowId + "|C_BPartner_ID");
      ...
      String strA_Asset_ID = vars.getRequiredStringParameter("inpaAssetId");
      //AssetsData data = getEditVariables(vars, strPC_BPartner_ID);
      int total = 0;
      ...
      if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        try {
          total = AssetsData.delete(this, strA_Asset_ID, strPC_BPartner_ID, Utility.getContext(this, vars, "#User_Client", windowId, accesslevel), Utility.getContext(this, vars, "#User_Org", windowId, accesslevel));
  ...
  private AssetsData getEditVariables(Connection con, VariablesSecureApp vars, String strPC_BPartner_ID) throws IOException,ServletException {
   ...
   private AssetsData[] getRelationData(AssetsData[] data) {
    if (data!=null) {
  ...
  private String getParentID(VariablesSecureApp vars, String strA_Asset_ID) throws ServletException {
    String strPC_BPartner_ID = AssetsData.selectParentID(this, strA_Asset_ID);
    if (strPC_BPartner_ID.equals("")) {
    ...
    private void refreshSessionNew(VariablesSecureApp vars, String strPC_BPartner_ID) throws IOException,ServletException {
      AssetsData[] data = AssetsData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), Utility.getContext(this, vars, "C_BPartner_ID", windowId), strPC_BPartner_ID, vars.getStringParameter("inpaAssetId", ""), Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      if (data==null || data.length==0) return;
...
String strParamA_Asset_Group_ID = vars.getSessionValue(tabId + "|paramA_Asset_Group_ID");
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/BusinessPartnerInfo/Assets_Relation", discard).createXmlDocument();

    ToolBar toolbar = new ToolBar(this, vars.getLanguage(), "Assets", false, "document.frmMain.inpaAssetId", "grid", "..", "".equals("Y"), "BusinessPartnerInfo", strReplaceWith, false);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Assets_Relation.html", "BusinessPartnerInfo", "W", strReplaceWith, tabs.breadcrumb());
    ...
    if (vars.getLanguage().equals("en_US")) xmlDocument.setParameter("parent", AssetsData.selectParent(this, strPC_BPartner_ID));
    else xmlDocument.setParameter("parent", AssetsData.selectParentTrl(this, strPC_BPartner_ID));
...
String strParamA_Asset_Group_ID = vars.getSessionValue(tabId + "|paramA_Asset_Group_ID");
    ...
    if (dataField==null) {
      if (!boolNew) {
        ...
        data = AssetsData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), Utility.getContext(this, vars, "C_BPartner_ID", windowId), strPC_BPartner_ID, strA_Asset_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
    ...
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "Assets", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpaAssetId", "", "..", "".equals("Y"), "BusinessPartnerInfo", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strA_Asset_ID));
