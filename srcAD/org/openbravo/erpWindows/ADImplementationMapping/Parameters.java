  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strAD_Model_Object_Para_ID, String strPAD_Model_Object_ID, TableSQLData tableSQL)
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = ParametersData.set(strPAD_Model_Object_ID, ParametersData.selectDef1E2EDCC0A13111DDB2632F951DE8183B(this, strPAD_Model_Object_ID), Utility.getDefault(this, vars, "Name", "", "08F09D2A7C774585B014C06C0F44F591", "4A00053300254EBC8868ABADEBD95525", "", dataField), Utility.getDefault(this, vars, "Value", "", "08F09D2A7C774585B014C06C0F44F591", "4A00053300254EBC8868ABADEBD95525", "", dataField), Utility.getDefault(this, vars, "Createdby", "", "08F09D2A7C774585B014C06C0F44F591", "4A00053300254EBC8868ABADEBD95525", "", dataField), "0", "Y", "", "0", Utility.getDefault(this, vars, "Updatedby", "", "08F09D2A7C774585B014C06C0F44F591", "4A00053300254EBC8868ABADEBD95525", "", dataField));
  ...
  private int saveRecord(VariablesSecureApp vars, OBError myError, char type, String strPAD_Model_Object_ID) throws IOException, ServletException {
    ...
    if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        strSequence = vars.getStringParameter("inpnewdataseIdVal");
          ...
          CrudOperations.UpdateCustomFields(tabId, data.adModelObjectParaId, vars, this,con);
