...
select
  ...
  from  (select ad_client_id,issotrx,c_invoice_id,null as zsfi_macctline_id,c_bpartner_id,c_bpartner_location_id,m_pricelist_id,ispaid,c_doctype_id,
                ...
                (select ix.documentno||string_agg((case when ilx.description is not null then '-'||ilx.description when ilx.description is null and ix.description is not null then '-'||ix.description else '' end),'-') from c_invoice ix,c_invoiceline ilx where 
                 ix.c_invoice_id=ilx.c_invoice_id and ilx.c_project_id=a.c_project_id and ix.c_invoice_id=a.c_invoice_id group by ix.documentno limit 1) as documentnote
        from
            (select i.ad_client_id,i.issotrx,i.c_invoice_id,i.c_bpartner_id,i.c_bpartner_location_id,i.m_pricelist_id,i.ispaid,i.c_doctype_id,
                    ...
                    i.isactive,
                     case when i.totalpaid>0 and i.grandtotal>0 then   c_currency_convert(i.totalpaid,i.c_currency_id,act.c_currency_id,i.dateacct) / c_currency_convert(i.grandtotal,i.c_currency_id,act.c_currency_id,i.dateacct) else 0 end as totalpaidquot,
                    i.description,i.ad_org_id,i.created,
                    i.createdby,i.updated,i.updatedby,il.c_project_id
...
select
      ...
      group by ol.c_orderline_id,o.c_order_id,o.ad_client_id,o.ad_org_id,ol.isactive,ol.created,ol.createdby,ol.updated,ol.updatedby,o.billto_id,
               ...
               o.ad_user_id,o.salesrep_id,p.m_product_category_id,p.typeofproduct,p.c_uom_id,ol.m_product_id,ol.qtyordered,ol.qtydelivered,   
...
from fact_acct f,c_elementvalue v,ad_orginfo i left join c_location l on l.c_location_id=i.c_location_id 
     ...
     and (case when v.c_element_id='C76385D3874B4775B28CEC5ECBCE1E5B' then v.value like '14%' else v.value like '12%' end or (length(v.value)=5 and v.value like '1%'))    
...
from fact_acct f,c_elementvalue v,ad_orginfo i left join c_location l on l.c_location_id=i.c_location_id 
     ...
     and f.uidnumber is not null 
     and coalesce(c.countrycode,'DE')!=substr(f.uidnumber,1,2)
     and (case when v.c_element_id='C76385D3874B4775B28CEC5ECBCE1E5B' then v.value like '16%' else v.value like '33%' end or (length(v.value)=5 and v.value like '7%'))
     group by f.ad_client_id,f.ad_org_id,f.acctvalue,f.uidnumber,f.c_bpartner_id,f.c_period_id;
